...
ms:assetid: 'ms10-006'
ms:contentKeyID: 61234060
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-006(v=Security.10)'
---
...
Esta atualização de segurança elimina duas vulnerabilidades relatadas em particular no Microsoft Windows. As vulnerabilidades podem permitir a execução remota de código se um invasor enviar uma resposta SMB especialmente criada para uma solicitação SMB iniciada pelo cliente. Para explorar estas vulnerabilidades, o invasor precisa convencer o usuário a iniciar uma conexão SMB com um servidor SMB mal-intencionado.

Esta atualização de segurança foi classificada como Crítica para o Microsoft Windows 2000, Windows XP, Windows Server 2003, Windows 7 e Windows Server 2008 R2, e como Importante para o Windows Vista e Windows Server 2008. Para obter mais informações, consulte a subseção **Software afetado e não afetado**, nesta seção.

A atualização de segurança elimina as vulnerabilidades corrigindo a maneira como o cliente SMB valida respostas. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=80b49bab-6c2f-48a8-a901-ca3f76e4fe6b)                                | Execução Remota de Código  | Crítica                         | [MS06-030](http://technet.microsoft.com/security/bulletin/ms06-030) |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=f6c4472e-385c-4412-bda9-c2e615e50713)                | Execução Remota de Código  | Crítica                         | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=63e15ff0-73b3-46c9-96f8-c18977d35a10)                   | Execução Remota de Código  | Crítica                         | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=feb8c145-7c30-45fa-a6f0-8b6453ddd521)                                   | Execução Remota de Código  | Crítica                         | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Microsoft Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=36d88c1b-814c-4371-9ed2-d4576f419fc3)             | Execução Remota de Código  | Crítica                         | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=622442b0-cffe-4fc2-94a8-edff9d71ecd3)        | Execução Remota de Código  | Crítica                         | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Vista e Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1902fc93-0f4b-4261-9da3-17d1931daf2e)                         | Elevação de privilégio     | Importante                      | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1902fc93-0f4b-4261-9da3-17d1931daf2e)                                         | Elevação de privilégio     | Importante                      | Nenhuma                                                             |
| [Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7c2f89b5-a3b3-42cd-857d-923fe8b8f1da) | Elevação de privilégio     | Importante                      | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c2f89b5-a3b3-42cd-857d-923fe8b8f1da)                             | Elevação de privilégio     | Importante                      | Nenhuma                                                             |
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=09e19263-18ba-495e-bcf7-719e957204a7)\*                       | Elevação de privilégio     | Importante                      | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=09e19263-18ba-495e-bcf7-719e957204a7)\*        | Elevação de privilégio     | Importante                      | Nenhuma                                                             |
| [Windows Server 2008 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=180c2313-5e3e-4d84-87cd-64048f51e0f6)\*                  | Elevação de privilégio     | Importante                      | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=180c2313-5e3e-4d84-87cd-64048f51e0f6)\*   | Elevação de privilégio     | Importante                      | Nenhuma                                                             |
| [Windows Server 2008 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=614eaf7e-95aa-4f8f-910c-1980e1f14d11)                | Elevação de privilégio     | Importante                      | [MS08-068](http://technet.microsoft.com/security/bulletin/ms08-068) |
| [Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=614eaf7e-95aa-4f8f-910c-1980e1f14d11) | Elevação de privilégio     | Importante                      | Nenhuma                                                             |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=a589431a-93dc-42cd-a74e-d9c1e3452fef)                                   | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=3c1edcf8-d304-45c4-9818-1cd86383b3fe)                              | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=ecb06350-47a7-48eb-825f-3e8f89c5ca8e)\*               | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=badd6cab-7738-4401-a68c-c15414388601)             | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
...
**Esta atualização de segurança está relacionada ao boletim MS10-012, lançado no dia 9 de fevereiro de 2010?**  
Não. O Boletim de Segurança da Microsoft [MS10-012](http://technet.microsoft.com/security/bulletin/ms10-012), "Vulnerabilidades no servidor SMB podem permitir a execução remota de código", aborda diferentes componentes SMB. Esta atualização de segurança pode ser aplicada independentemente de qualquer outra atualização.

**Se eu tiver instalado a atualização MS10-012, ainda preciso instalar esta atualização? **
Sim. Esta atualização de boletim de segurança elimina vulnerabilidades em componentes do Cliente SMB do Windows, enquanto o [MS10-012](http://technet.microsoft.com/security/bulletin/ms10-012) elimina vulnerabilidades em componentes do Servidor SMB do Windows.
...
<th style="border:1px solid black;" >Vulnerabilidade de corrupção de pool do cliente SMB - CVE-2010-0016</th>
<th style="border:1px solid black;" >Vulnerabilidade de condição de corrida do cliente SMB - CVE-2010-0017</th>
...
Vulnerabilidade de corrupção de pool do cliente SMB - CVE-2010-0016  
-------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade não autenticada de execução remota de código na maneira como o software de protocolo SMB (Server Message Block) da Microsoft manipula respostas SMB especialmente criadas. Uma tentativa de explorar a vulnerabilidade não requer autenticação, o que permite a um invasor explorar a vulnerabilidade enviando uma resposta SMB especialmente criada a uma solicitação SMB iniciada pelo cliente. Um invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total do sistema.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0016](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0016).
  
#### Fatores atenuantes da Vulnerabilidade de corrupção de pool do cliente SMB - CVE-2010-0016
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Esta é uma vulnerabilidade do cliente SMB. Para explorar esta vulnerabilidade, o invasor precisa convencer o usuário a iniciar uma conexão SMB com um servidor SMB mal-intencionado. As práticas recomendadas para firewall e as configurações de firewall padrão podem ajudar a proteger as redes contra ataques com origem externa ao perímetro da empresa. Essas práticas também recomendam que os sistemas conectados à Internet tenham um número mínimo de portas expostas. Nesse caso, as portas SMB devem ser impedidas de acessar a Internet.
  
#### Soluções alternativas para a Vulnerabilidade de corrupção de pool do cliente SMB - CVE-2010-0016
...
#### Perguntas frequentes sobre a Vulnerabilidade de corrupção de pool do cliente SMB - CVE-2010-0016
...
A vulnerabilidade é causada pela validação incorreta dos campos na resposta SMB pela implementação do protocolo SMB da Microsoft. Isto pode levar a um problema de corrupção de pool e à execução de código com privilégios de nível de sistema.
...
A atualização elimina a vulnerabilidade corrigindo a maneira como os campos na resposta SMB são validados.
...
Vulnerabilidade de condição de corrida do cliente SMB - CVE-2010-0017  
---------------------------------------------------------------------
...
No Windows Vista e Windows Server 2008, esta vulnerabilidade pode resultar em uma vulnerabilidade de elevação de privilégio, devido à maneira como o software do Protocolo SMB da Microsoft manipula respostas SMB de negociação especialmente criadas. Um invasor que explore com êxito essa vulnerabilidade pode executar código arbitrário com privilégios de nível de sistema. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para elevar seus privilégios dessa maneira.
  
Esta vulnerabilidade também pode resultar em uma negação de serviço. Uma tentativa de explorar a vulnerabilidade dessa maneira não requer autenticação, o que permite a um invasor explorar a vulnerabilidade enviando uma resposta SMB especialmente criada a uma solicitação SMB iniciada pelo cliente. O invasor que explorar com êxito esta vulnerabilidade poderá fazer com que o computador pare de responder até que seja reiniciado.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0017](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0017).
  
#### Fatores atenuantes da Vulnerabilidade de condição de corrida do cliente SMB - CVE-2010-0017
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   No Windows Vista e Windows Server 2008, um invasor precisa ter credenciais de logon válidas e deve ser capaz de fazer logon localmente para explorar essa vulnerabilidade. A vulnerabilidade de elevação de privilégio não pode ser explorada de maneira remota nem por usuários anônimos nessas plataformas. As práticas recomendadas para firewall e as configurações de firewall padrão podem ajudar a proteger as redes contra ataques com origem externa ao perímetro da empresa. Essas práticas também recomendam que os sistemas conectados à Internet tenham um número mínimo de portas expostas.
  
#### Soluções alternativas para a Vulnerabilidade de condição de corrida do cliente SMB - CVE-2010-0017
...
#### Perguntas frequentes sobre a Vulnerabilidade de condição de corrida do cliente SMB - CVE-2010-0017
...
No Windows Vista e Windows Server 2008, esta é uma vulnerabilidade de elevação de privilégio. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para todas as plataformas afetadas, esta vulnerabilidade também pode resultar em uma negação de serviço. Nesse caso, o invasor que explorar essa vulnerabilidade pode fazer com que o sistema afetado pare de responder até que seja reiniciado manualmente. Observe que a vulnerabilidade de negação de serviço não permite que o invasor execute códigos nem eleve seus direitos de usuário, mas pode fazer o sistema afetado parar de aceitar solicitações.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada pela manipulação incorreta, pela implementação do cliente SMB da Microsoft, de uma condição de corrida que pode ocorrer ao lidar com respostas de negociação.
  
**O que é o protocolo SMB (Server Message Block) da Microsoft? **  
O protocolo SMB (Server Message Block) da Microsoft é um protocolo de compartilhamento de arquivos de rede da Microsoft usado no Microsoft Windows. Para obter mais informações sobre o SMB, consulte [Visão geral do Protocolo SMB e Protocolo CIFS da Microsoft](http://msdn.microsoft.com/en-us/library/aa365233(vs.85).aspx).
  
**Para que um invasor pode usar a vulnerabilidade?**    
O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. No Windows Vista e Windows Server 2008, um invasor que explore com êxito esta vulnerabilidade pode executar código arbitrário com privilégios de nível de sistema. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
O invasor que explorar esta vulnerabilidade com êxito levando a uma negação de serviço poderá fazer com que o sistema do usuário pare de responder até ser reiniciado manualmente.
  
**De que forma o invasor pode explorar a vulnerabilidade?**    
Para explorar esta vulnerabilidade e causar a execução remota de código ou uma negação de serviço, o invasor pode hospedar um servidor SMB mal-intencionado projetado para explorar esta vulnerabilidade e, então, convencer um usuário a iniciar uma conexão SMB com ele. Além disso, um invasor na rede local pode executar um ataque por interceptação para responder a uma solicitação SMB legítima com uma resposta SMB mal-intencionada.
  
Para explorar esta vulnerabilidade para elevar privilégios, primeiro o invasor precisa fazer logon no sistema. Em seguida, ele precisa executar um aplicativo especialmente criado capaz de explorar a vulnerabilidade e assumir o controle total do sistema afetado.
...
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade corrigindo a maneira como o cliente SMB manipula a condição de corrida que pode ocorrer ao manipular respostas SMB de negociação.
...
| **Implantação**                       |                                                                                                                                                                       |  
| Instalar sem intervenção do usuário   | Windows2000-KB978251-x86-enu /quiet                                                                                                                                   |  
| Instalar sem reinicializar            | Windows2000-KB978251-x86-enu /norestart                                                                                                                               |  
| Arquivo de log de atualização         | KB978251.log                                                                                                                                                          |  
...
| **Informações sobre remoção**         | Use a ferramenta **Adicionar ou Remover Programas** no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB978251$\\Spuninst |  
| **Informações sobre o arquivo**       | Consulte o [Artigo 978251 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/978251)                                                            |  
| **Verificação da Chave do Registro**  | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB978251\\Filelist                                                                             |
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB978251$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/978251">Artigo 978251 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Laurent Gaffié, da [stratsec](http://www.stratsec.net/), por relatar a Vulnerabilidade de corrupção de pool do cliente SMB (CVE-2010-0016) e a Vulnerabilidade de condição de corrida do cliente SMB (CVE-2010-0017)
...
-   V1.1 (10 de fevereiro de 2010): Foram alteradas as entradas na tabela do **Systems Management Server** para o SMS 2003 com ITMU para Windows 7 e Windows Server 2008 R2. Esta é apenas uma alteração informativa. Não houve nenhuma alteração à lógica de detecção ou aos arquivos da atualização de segurança.
