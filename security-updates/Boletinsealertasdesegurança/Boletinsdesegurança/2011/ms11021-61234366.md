...
ms:assetid: 'ms11-021'
ms:contentKeyID: 61234366
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-021(v=Security.10)'
---
...
Vulnerabilidades no Microsoft Excel podem permitir a execução remota de código (2489279)
----------------------------------------------------------------------------------------
...
A atualização elimina as vulnerabilidades, corrigindo a menira como o Microsoft Excel gerencia estruturas de dados ,valida as informações de registro, inicializa variáveis usadas em operações de memória e aloca espaço em buffer ao analisar um arquivo especialmente criado. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
<td style="border:1px solid black;">
[MS10-087](http://technet.microsoft.com/pt-br/security/bulletin/ms10-087)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
Sim. As atualizações para Microsoft Excel 2003 Service Pack 3 (KB2502786) e Microsoft Excel 2007 Service Pack 2 (KB2464583), junto com a atualização oferecida no boletim [MS11-023](http://technet.microsoft.com/pt-br/security/bulletin/ms11-023), fornecem suporte para o recurso de Validação de Arquivo do Office. Para obter mais informações sobre o recurso de Validação de Arquivo de Office, consulte o [Comunicado de Segurança da Microsoft 2501584](http://technet.microsoft.com/security/advisory/2501584).

**Como esta atualização de segurança se relaciona com os boletins MS10-087 e MS10-088?**  
A atualização do Microsoft Office 2004 for Mac (KB2505924) oferecida nesta boletim também aborda as vulnerabilidades descritas nos boletins de segurança [MS10-087](http://technet.microsoft.com/pt-br/security/bulletin/ms10-087) e [MS10-088](http://technet.microsoft.com/pt-br/security/bulletin/ms10-088).

**Os boletins MS11-022 e MS11-023 também descrevem as vulnerabilidades no Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac e Open XML File Format Converter for Mac.** **O boletim MS11-022 também descreve as vulnerabilidades no Microsoft Office for Mac 2011. Como os boletins MS11-022 e MS11-023 se relacionam com este boletim (MS11-021)?**  
Os pacotes de atualização de segurança para Microsoft Office 2004 for Mac (KB2505924), Microsoft Office 2008 for Mac (KB2505927) e Open XML File Format Converter for Mac (KB2505935) oferecidos neste boletim também eliminam as vulnerabilidades descritas nos boletins de segurança [MS11-022](http://technet.microsoft.com/pt-br/security/bulletin/ms11-022) e [MS11-023](http://technet.microsoft.com/pt-br/security/bulletin/ms11-023). O pacote de atualização de segurança para Microsoft Office for Mac 2011 (KB2525412) oferecido neste boletim também elimina as vulnerabilidades descritas no boletim [MS11-022](http://technet.microsoft.com/pt-br/security/bulletin/ms11-022). Os usuários com Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac, Open XML File Format Converter for Mac ou Microsoft Office for Mac 2011 instalado só precisam instalar esses pacotes de atualização de segurança uma vez.
...
<th style="border:1px solid black;" >
Vulnerabilidade de saturação de número inteiro do Excel - CVE-2011-0097
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de estouro de heap do Excel - CVE-2011-0098
</th>
<th style="border:1px solid black;" >
Vulnerabilidade WriteAV de análise de registro do Excel - CVE-2011-0101
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de corrupção de memória do Excel - CVE-2011-0103
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de sobregravação de buffer do Excel - CVE-2011-0104
</th>
</tr>
<tr>
<th colspan="6">
...
<th style="border:1px solid black;" >
Vulnerabilidade de inicialização de dados do Excel - CVE-2011-0105
</th>
<th colspan="2">
Vulnerabilidade de indexação de matriz do Excel - CVE-2011-0978
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de corrupção de lista vinculada do Excel - CVE-2011-0979
</th>
<th colspan="2">
Vulnerabilidade de ponteiro de suspensão do Excel - CVE-2011-0980
</th>
<th colspan="2">
Avaliação de gravidade agregada
</th>
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0097](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0097).

#### Fatores atenuantes da Vulnerabilidade de saturação de número inteiro do Excel - CVE-2011-0097
...
#### Soluções alternativas para a Vulnerabilidade de saturação de número inteiro do Excel - CVE-2011-0097
...
#### Perguntas frequentes sobre a Vulnerabilidade de saturação de número inteiro do Excel - CVE-2011-0097
...
A vulnerabilidade existe quando o Microsoft Excel não aloca corretamente espaço no buffer ao analisar informações de registro em um arquivo do Excel especialmente criado.
...
A atualização elimina a vulnerabilidade, modificando a maneira como o Microsoft Excel aloca espaço no buffer ao analisar um arquivo especialmente criado.
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0098](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0098).

#### Fatores atenuantes da Vulnerabilidade de estouro de heap do Excel - CVE-2011-0098
...
#### Soluções alternativas para a Vulnerabilidade de estouro de heap do Excel - CVE-2011-0098
...
#### Perguntas frequentes sobre a Vulnerabilidade de estouro de heap do Excel - CVE-2011-0098
...
**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando o Microsoft Excel encontra um erro de manuseio de memória durante a validação das informações de registro ao analisar um arquivo do Excel especialmente criado, corrompendo a memória do sistema de tal forma que um invasor possa executar código arbitrário.
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0101](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0101).

#### Fatores atenuantes da Vulnerabilidade WriteAV de análise de registro do Excel - CVE-2011-0101
...
#### Soluções alternativas para a Vulnerabilidade WriteAV de análise de registro do Excel - CVE-2011-0101
...
#### Perguntas frequentes sobre a Vulnerabilidade WriteAV de análise de registro do Excel - CVE-2011-0101
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0103](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0103).

#### Fatores atenuantes da Vulnerabilidade de corrupção de memória do Excel - CVE-2011-0103
...
#### Soluções alternativas da Vulnerabilidade de corrupção de memória do Excel - CVE-2011-0103
...
#### Perguntas frequentes sobre a Vulnerabilidade de corrupção de memória do Excel - CVE-2011-0103
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0104](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0104).

#### Fatores atenuantes da Vulnerabilidade de sobregravação de buffer do Excel - CVE-2011-0104
...
#### Soluções alternativas para a Vulnerabilidade de sobregravação de buffer do Excel - CVE-2011-0104
...
#### Perguntas frequentes sobre a Vulnerabilidade de sobregravação de buffer do Excel - CVE-2011-0104
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0105](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0105).

#### Fatores atenuantes da Vulnerabilidade de inicialização de dados do Excel - CVE-2011-0105
...
#### Soluções alternativas para a Vulnerabilidade de inicialização de dados do Excel - CVE-2011-0105
...
#### Perguntas frequentes sobre a Vulnerabilidade de inicialização de dados do Excel - CVE-2011-0105

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas ou exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando o Microsoft Excel não inicializa corretamente uma variável usada como comprimento de uma operação memcpy ao analisar um arquivo do Excel especialmente criado. Essa condição pode ser explorada para causar um estouro de buffer que leve à execução do código sob o contexto de segurança do usuário conectado.
...
**O que a atualização faz?**  
A atualização elimina a vulnerabilidade, corrigindo a maneira como o Microsoft Excel inicializa variáveis usadas em operações de memória.
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0978](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0978).

#### Fatores atenuantes da Vulnerabilidade de indexação de matriz do Excel - CVE-2011-0978
...
#### Soluções alternativas para a Vulnerabilidade de indexação de matriz do Excel - CVE-2011-0978
...
#### Perguntas frequentes sobre a Vulnerabilidade de indexação de matriz do Excel - CVE-2011-0978
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0979](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0979).

#### Fatores atenuantes da Vulnerabilidade de corrupção da lista vinculada do Excel - CVE-2011-0979
...
#### Soluções alternativas para a Vulnerabilidade de corrupção da lista vinculada do Excel - CVE-2011-0979
...
#### Perguntas frequentes sobre a Vulnerabilidade de corrupção da lista vinculada do Excel - CVE-2011-0979

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas ou exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando o Microsoft Excel não gerencia corretamente os membros de uma estrutura de dados ao analisar um arquivo do Excel especialmente criado.
...
**O que a atualização faz?**  
A atualização elimina a vulnerabilidade, corrigindo a maneira como o Microsoft Excel gerencia as estruturas de dados.
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0980](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0980).

#### Fatores atenuantes da Vulnerabilidade de ponteiro de suspensão do Excel - CVE-2011-0980
...
#### Soluções alternativas para a Vulnerabilidade de ponteiro de suspensão do Excel - CVE-2011-0980
...
#### Perguntas frequentes sobre a Vulnerabilidade de ponteiro de suspensão do Excel - CVE-2011-0980

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas ou exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando o Microsoft Excel não gerencia corretamente as estruturas de dados ao analisar um arquivo do Excel especialmente criado.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2466169">Artigo 2466169 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2502786">Artigo 2502786 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Para Microsoft Excel 2007, consulte o <a href="http://support.microsoft.com/kb/2464583">Artigo 2464583 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft Excel Viewer, consulte o <a href="http://support.microsoft.com/kb/2466158">Artigo 2466158 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Pacote de Compatibilidade do Microsoft Office para formatos de arquivo Word, Excel e PowerPoint 2007, consulte o <a href="http://support.microsoft.com/kb/2466156">Artigo 2466156 (em inglês) do Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2466146">Artigo 2466146 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
-   Alin Rad Pop, da [Secunia Research](http://secunia.com/), por relatar a Vulnerabilidade de saturação de número inteiro do Excel (CVE-2011-0097)  
-   Alin Rad Pop, da [Secunia Research](http://secunia.com/), por relatar a Vulnerabilidade de saturação de heap do Excel (CVE-2011-0098)  
-   Muhammad Junaid Bohio, da [Telus Security Labs](http://www.telussecuritylabs.com), por relatar a Vulnerabilidade WriteAV de análide de registro do Excel (CVE-2011-0101)  
-   Aniway, que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por relatar a Vulnerabilidade WriteAV de análise de registros do Excel (CVE-2011-0101)  
-   Um pesquisador anônimo, que trabalha na [VeriSign iDefense Labs](http://labs.idefense.com/), por relatar a Vulnerabilidade de corrupção de memória no Excel (CVE-2011-0103)  
-   Rodrigo Rubira Branco, da [Check Point Vulnerability Discovery Team](http://www.checkpoint.com/) (VDT), por relatar a Vulnerabilidade de sobregravação de buffer do Excel (CVE-2011-0104)  
-   Aniway, que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por relatar a Vulnerabilidade de inicialização de dados do Excel (CVE-2011-0105)  
-   Aniway, que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por relatar a Vulnerabilidade de indexação de matriz do Excel (CVE-2011-0978)  
-   Um pesquisador anônimo, que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por relatar a Vulnerabilidade de corrupção da lista vinculada do Excel (CVE-2011-0979)  
-   Um pesquisador anônimo, que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por relatar a Vulnerabilidade de ponteiro de suspensão do Excel (CVE-2011-0979)
