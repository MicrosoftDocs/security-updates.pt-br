---
TOCTitle: 'MS16-036'
Title: 'Boletim de Segurança da Microsoft MS16-036 – Crítico'
ms:assetid: 'ms16-036'
ms:contentKeyID: 72464180
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms16-036(v=Security.10)'
---

Boletim de Segurança da Microsoft MS16-036 – Crítico
====================================================

Atualização de segurança para o Adobe Flash Player (3144756)
------------------------------------------------------------
...
Para obter mais informações sobre essa atualização, consulte o [artigo 3144756 da Base de Dados de Conhecimento da Microsoft](https://support.microsoft.com/pt-br/kb/3144756).

Informações sobre a vulnerabilidade
-----------------------------------

<span id="sectionToggle1"></span>
Esta atualização de segurança corrige as seguintes vulnerabilidades, descritas no Boletim de Segurança da Adobe [APSB16-08](https://helpx.adobe.com/br/security/products/flash-player/apsb16-08.html):
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/pt-br/download/details.aspx?id=51482)  
(3144756)
...
<td style="border:1px solid black;">
3135782 no [MS16-022](https://technet.microsoft.com/pt-br/library/security/ms16-022)
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/pt-br/download/details.aspx?id=51481)  
(3144756)
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/pt-br/download/details.aspx?id=51483)  
(3144756)
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/pt-br/download/details.aspx?id=51480)  
(3144756)
...
<sup>[2]</sup>As atualizações do Adobe FlashPlayer para as atualizações do Windows 10 estão disponíveis no [Windows Update](http://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=pt-br) ou por meio do [Catálogo do Microsoft Update](http://catalog.update.microsoft.com/v7/site/home.aspx).

**Nota** O Windows Server Technical Preview 4 é afetado; a classificação de gravidade agregada é Crítica e o impacto é Moderado, execução remota de código. Recomenda-se que os clientes que estiverem executando esses sistemas operacionais apliquem a atualização, que está disponível no [Windows Update](http://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=pt-br). 
...
-   **Adicione sites confiáveis à zona Sites confiáveis do Internet Explorer**
    ...
    **Observação** Adicione os sites que você tem certeza de que não realizarão ações mal-intencionadas em seu sistema. Dois sites específicos que você deve adicionar são **\*.windowsupdate.microsoft.com** e **\*.update.microsoft.com**. Esses sites hospedam a atualização e exigem um controle ActiveX para instalá-la.
...
-   V1.0 (10 de março de 2016): Boletim publicado.

*Página gerada em 10/03/2016 às 13:50-08:00.*