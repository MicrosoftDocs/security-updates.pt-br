---
TOCTitle: 'MS16-128'
Title: 'Boletim de Segurança da Microsoft MS16-128 - Crítica'
ms:assetid: 'ms16-128'
ms:contentKeyID: 74199298
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms16-128(v=Security.10)'
---

Modelo do MSRC ppDocument

Boletim de Segurança da Microsoft MS16-128 - Crítica
====================================================

Atualização de segurança para o Adobe Flash Player (3201860)
------------------------------------------------------------
...
Esta atualização de segurança resolve uma vulnerabilidade no Adobe Flash Player quando instalado em todas as edições com suporte do Windows 8.1, do Windows Server 2012, do Windows Server 2012 R2, do Windows RT 8.1 e do Windows 10.
...
Para obter mais informações sobre essa atualização, consulte o [artigo 3201860 da Base de Dados de Conhecimento da Microsoft](https://support.microsoft.com/pt-br/kb/3201860).

Informações sobre a vulnerabilidade
-----------------------------------

<span id="sectionToggle1"></span>
Esta atualização de segurança corrige as seguintes vulnerabilidades, descritas no Boletim de Segurança da Adobe [APSB16-36](http://helpx.adobe.com/br/security/products/flash-player/apsb16-36.html):
...
<td style="border:1px solid black;">
[Adobe Flash Player](http://www.microsoft.com/downloads/pt-br/details.aspx?familyid=ca4b800b-a5b8-4ece-8766-d7529f98a0b4)  
(3201860)
...
<td style="border:1px solid black;">
3194343 em [MS16-127](http://go.microsoft.com/fwlink/?linkid=829053)
...
<td style="border:1px solid black;">
[Adobe Flash Player](http://www.microsoft.com/downloads/pt-br/details.aspx?familyid=480f1e78-caad-4d1a-a7e1-808b349ff642)  
(3201860)
...
<td style="border:1px solid black;">
[Adobe Flash Player](http://www.microsoft.com/downloads/pt-br/details.aspx?familyid=4c9178f1-12ba-4537-a564-2d56717b96dc)  
(3201860)
...
<td style="border:1px solid black;">
[Adobe Flash Player](http://www.microsoft.com/downloads/pt-br/details.aspx?familyid=272bca5f-05b6-47be-bc20-513d2d3abb4b)  
(3201860)
...
-   V1.0 (26 de outubro de 2016): Boletim publicado.

*Página gerada em 27/10/2016 9:10Z-07:00.*
