---
TOCTitle: 'MS17-003'
Title: 'Boletim de Segurança da Microsoft MS17-003 – Crítico'
ms:assetid: 'ms17-003'
ms:contentKeyID: 74294037
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms17-003(v=Security.10)'
---
...
Para obter mais informações sobre essa atualização, consulte o [artigo 3214628 da Base de Dados de Conhecimento da Microsoft](https://support.microsoft.com/pt-br/kb/3214628).

Informações sobre a vulnerabilidade
-----------------------------------

<span id="sectionToggle1"></span>
Esta atualização de segurança corrige as seguintes vulnerabilidades, descritas no Boletim de Segurança da Adobe [APSB17-02](http://helpx.adobe.com/br/security/products/flash-player/apsb17-02.html):
...
<td style="border:1px solid black;">
3209498 em [MS16-154](https://go.microsoft.com/fwlink/?linkid=834443)
