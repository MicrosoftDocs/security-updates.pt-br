---
TOCTitle: 'MS17-005'
Title: 'Boletim de Segurança da Microsoft MS17-005 – Crítico'
ms:assetid: 'ms17-005'
ms:contentKeyID: 74419903
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms17-005(v=Security.10)'
---

Modelo do MSRC ppDocument

Boletim de Segurança da Microsoft MS17-005 – Crítico
====================================================

Atualização de segurança para o Adobe Flash Player (4010250)
------------------------------------------------------------
...
Para obter mais informações sobre essa atualização, consulte o [artigo 4010250 da Base de Dados de Conhecimento da Microsoft](https://support.microsoft.com/pt-br/kb/4010250).

Informações sobre a vulnerabilidade
-----------------------------------

<span id="sectionToggle1"></span>
Esta atualização de segurança corrige as seguintes vulnerabilidades, descritas no Boletim de Segurança da Adobe [APSB17-04](http://helpx.adobe.com/br/security/products/flash-player/apsb17-04.html):
...
<td style="border:1px solid black;">
3214628 em [MS17-003](https://go.microsoft.com/fwlink/?linkid=838351)
...
-   V1.0 (21 de fevereiro de 2017): Boletim publicado.

*Página gerada em 2017-02-08 10:22-08:00.*
