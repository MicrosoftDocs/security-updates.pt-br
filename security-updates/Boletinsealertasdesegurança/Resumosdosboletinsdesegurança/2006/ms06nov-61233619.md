---
TOCTitle: 'MS06-NOV'
Title: Resumo do Boletim de Segurança da Microsoft de novembro 2006
ms:assetid: 'ms06-nov'
ms:contentKeyID: 61233619
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms06-nov(v=Security.10)'
---

Security Bulletin Summary

Resumo do Boletim de Segurança da Microsoft de novembro 2006
============================================================
...
**serviço de Notificação de Segurança Microsoft:** Para receber notificações automáticas por email sempre que um boletim de segurança da Microsoft for publicado, inscreva-se no [serviço de Notificação de Segurança Microsoft](http://www.microsoft.com/brasil/security/alertas.mspx) (site em inglês).

#### Resumo

Foram incluídas, neste comunicado, atualizações de vulnerabilidades descobertas recentemente. As vulnerabilidades, classificadas de acordo com a gravidade, são:
...
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-067                                                                                |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Atualização de segurança cumulativa para o Internet Explorer (922760)**](http://go.microsoft.com/fwlink/?linkid=78172) |
...
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-068                                                                                                           |
|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no Microsoft Agent pode permitir a execução remota de código (920213)**](http://technet.microsoft.com/security/bulletin/ms06-068) |
...
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-069                                                                                                                   |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidades no Macromedia Flash Player da Adobe podem permitir a execução remota de código (923789)**](http://go.microsoft.com/fwlink/?linkid=78174) |
| **Sinopse**                           | Esta atualização elimina vulnerabilidades no Macromedia Flash Player da Adobe que podem permitir a execução remota de código.                                |
| **Classificação máxima de gravidade** | [Crítica](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                     |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                                    |
| **Software afetado**                  | **Windows** Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                                         |

| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-070                                                                                                                       |
|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no serviço Estação de Trabalho pode permitir a execução remota de código (924270)**](http://technet.microsoft.com/security/bulletin/ms06-070) |
| **Sinopse**                           | Esta atualização elimina uma vulnerabilidade no serviço Estação de Trabalho que pode permitir a execução remota de código.                                       |
| **Classificação máxima de gravidade** | [Crítica](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                         |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                                        |
| **Software afetado**                  | **Windows** Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                                             |

| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-071                                                                                                                       |
|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no Microsoft XML Core Services pode permitir a execução remota de código (928088)**](http://technet.microsoft.com/security/bulletin/ms06-071) |
| **Sinopse**                           | Esta atualização elimina uma vulnerabilidade no Microsoft XML Core Services que pode permitir a execução remota de código.                                       |
| **Classificação máxima de gravidade** | [Crítica](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                         |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                                        |
| **Software afetado**                  | **Windows** Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                                             |
...
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-066                                                                                                                                                                                                   |
|---------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no serviço de cliente para Netware pode permitir a execução remota de código (923980)**](http://technet.microsoft.com/security/bulletin/ms06-066)                                                                         |
| **Sinopse**                           | Esta atualização elimina vulnerabilidades no serviço de cliente para Netware que podem permitir a execução remota de código. Por padrão, o serviço de cliente para NetWare não é instalado em nenhuma versão de sistema operacional afetada. |
...
<tr class="even">
<td style="border:1px solid black;">Internet Explorer 6 Service Pack 1 para Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"></td>
...
-   Peter Winter-Smith, da [NGS Software](http://www.ngssoftware.com/index.htm), por relatar um problema descrito no boletim [MS06-066](http://technet.microsoft.com/security/bulletin/ms06-066).  
-   Sam Arun Raj, da [McAfee](http://www.mcafee.com/), por reportar um problema descrito no boletim [MS06-066](http://technet.microsoft.com/security/bulletin/ms06-066).  
-   Sam Thomas, que trabalha na [TippingPoint](http://www.tippingpoint.com/) e na [Zero Day Initiative](http://www.zerodayinitiative.com/), por relatar um problema descrito no boletim [MS06-067](http://go.microsoft.com/fwlink/?linkid=78172).  
-   Stuart Pearson, da [Computer Terrorism](http://www.computerterrorism.com/), por trabalhar conosco em um problema descrito no boletim [MS06-069](http://go.microsoft.com/fwlink/?linkid=78174).  
-   [eEye](http://www.eeye.com/) por relatar um problema descrito no boletim [MS06-070](http://technet.microsoft.com/security/bulletin/ms06-070).  
-   Robert Freeman, da [ISS](http://www.iss.net/), por trabalhar conosco em um problema descrito no boletim [MS06-071](http://technet.microsoft.com/security/bulletin/ms06-071).  
-   Dror Shalev e Moti Jospeh, da [Check Point](http://www.checkpoint.com), por trabalharem conosco em um problema descrito no boletim [MS06-071](http://technet.microsoft.com/security/bulletin/ms06-071).
