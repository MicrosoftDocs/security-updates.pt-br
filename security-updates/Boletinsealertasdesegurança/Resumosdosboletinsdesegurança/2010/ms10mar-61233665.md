---
TOCTitle: 'MS10-MAR'
Title: Resumo do Boletim de Segurança da Microsoft de março 2010
ms:assetid: 'ms10-mar'
ms:contentKeyID: 61233665
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-mar(v=Security.10)'
---

Security Bulletin Summary

Resumo do Boletim de Segurança da Microsoft de março 2010
=========================================================
...
Este resumo de boletins lista os boletins de segurança lançados em março de 2010.

Com o lançamento dos boletins de março de 2010, este resumo de boletins substitui a notificação antecipada do boletim emitida originalmente em 4 de março de 2010. Para obter mais informações sobre o serviço de notificação antecipada de boletim, consulte [Notificação antecipada dos boletins de segurança da Microsoft](http://technet.microsoft.com/security/bulletin/advance).

Para obter informações sobre como receber notificações automáticas sempre que os boletins de segurança da Microsoft são emitidos, consulte as [notificações de segurança técnica da Microsoft](http://go.microsoft.com/fwlink/?linkid=21163).

A Microsoft realizará um webcast para solucionar dúvidas dos clientes sobre esses boletins no dia 10 de março de 2010, às 11 horas - Hora do Pacífico (EUA e Canadá). [Registre-se agora para participar do Webcast do boletim de segurança de março](http://msevents.microsoft.com/cui/webcasteventdetails.aspx?eventid=1032427711&eventcategory=4&culture=en-us&countrycode=us). Depois dessa data, este webcast estará disponível sob demanda. Para obter mais informações, consulte [Webcasts e resumos dos boletins de segurança da Microsoft.](http://technet.microsoft.com/security/bulletin/summary)

No caso do boletim de segurança desvinculado adicionado à Versão 2.0 deste resumo dos boletins, MS10-018, a Microsoft estará hospedando um webcast para solucionar as dúvidas dos clientes sobre esse boletim em 30 de março de 2010 às 13h00, Horário do Pacífico (EUA e Canadá). [Registre-se agora para participar do webcast em 30 de março, às 13h00](https://msevents.microsoft.com/cui/eventdetail.aspx?eventid=1032448112&culture=en-us). Depois dessa data, este webcast estará disponível sob demanda. Para obter mais informações, consulte [Webcasts e resumos dos boletins de segurança da Microsoft.](http://technet.microsoft.com/security/bulletin/summary)
...
<td style="border:1px solid black;"><strong>Atualização de segurança cumulativa para o Internet Explorer (980182)</strong> <br />
<br />
...
<td style="border:1px solid black;"><strong>Vulnerabilidade no Windows Movie Maker pode permitir a execução remota de código (975561)</strong><br />
<br />
Esta atualização de segurança aborda uma vulnerabilidade relatada em particular no Windows Movie Maker e no Microsoft Producer 2003. O Windows Live Movie Maker, que está disponível para Windows Vista e Windows 7, não é afetado por esta vulnerabilidade. A vulnerabilidade poderá permitir a execução remota de código se um invasor enviar um arquivo de projeto do Movie Maker ou do Microsoft Producer especialmente criado e convencer o usuário a abrir o arquivo especialmente criado. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.</td>
...
<td style="border:1px solid black;"><strong>Vulnerabilidades no Microsoft Office Excel podem permitir a execução remota de código (980150)</strong><br />
<br />
...
|---------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|  
| [MS10-017](http://technet.microsoft.com/security/bulletin/ms10-017) | Vulnerabilidade de corrupção de memória de registro do Microsoft Office Excel                 | [CVE-2010-0257](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0257) | [**1**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Possível código de exploração consistente        | (Nenhum)                                                                             |  
| [MS10-017](http://technet.microsoft.com/security/bulletin/ms10-017) | Vulnerabilidade de estouro de heap de registro MDXTUPLE do Microsoft Office Excel             | [CVE-2010-0260](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0260) | [**1**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Possível código de exploração consistente        | (Nenhum)                                                                             |  
| [MS10-017](http://technet.microsoft.com/security/bulletin/ms10-017) | Vulnerabilidade de estouro de heap de registro MDXSET do Microsoft Office Excel               | [CVE-2010-0261](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0261) | [**1**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Possível código de exploração consistente        | (Nenhum)                                                                             |  
| [MS10-017](http://technet.microsoft.com/security/bulletin/ms10-017) | Vulnerabilidade de execução de códigos de análise de arquivo XLSX do Microsoft Office Excel   | [CVE-2010-0263](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0263) | [**1**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Possível código de exploração consistente        | (Nenhum)                                                                             |  
| [MS10-017](http://technet.microsoft.com/security/bulletin/ms10-017) | Vulnerabilidade de análise de registro DbOrParamQry do Microsoft Office Excel                 | [CVE-2010-0264](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0264) | [**1**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Possível código de exploração consistente        | (Nenhum)                                                                             |  
| [MS10-016](http://technet.microsoft.com/security/bulletin/ms10-016) | Vulnerabilidade de saturação de buffer do Movie Maker e Producer                              | [CVE-2010-0265](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0265) | [**1**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Possível código de exploração consistente        | (Nenhum)                                                                             |  
| [MS10-018](http://technet.microsoft.com/security/bulletin/ms10-018) | Vulnerabilidade de corrupção de memória de objeto HTML                                        | [CVE-2010-0491](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0491) | [**1**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Possível código de exploração consistente        | (Nenhum)                                                                             |  
| [MS10-018](http://technet.microsoft.com/security/bulletin/ms10-018) | Vulnerabilidade de corrupção de memória de objeto HTML                                        | [CVE-2010-0492](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0492) | [**1**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Possível código de exploração consistente        | (Nenhum)                                                                             |  
| [MS10-018](http://technet.microsoft.com/security/bulletin/ms10-018) | Vulnerabilidade entre domínios de elementos HTML                                              | [CVE-2010-0494](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0494) | [**1**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Possível código de exploração consistente        | A execução de códigos é possível somente no Windows 2000                             |  
| [MS10-018](http://technet.microsoft.com/security/bulletin/ms10-018) | Vulnerabilidade de corrupção de memória não inicializada                                      | [CVE-2010-0806](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806) | [**1**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Possível código de exploração consistente        | **No momento, esta vulnerabilidade está sendo explorada no ecossistema da Internet** |  
| [MS10-018](http://technet.microsoft.com/security/bulletin/ms10-018) | Vulnerabilidade de corrupção de memória de processamento de HTML                              | [CVE-2010-0807](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0807) | [**1**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Possível código de exploração consistente        | (Nenhum)                                                                             |  
| [MS10-017](http://technet.microsoft.com/security/bulletin/ms10-017) | Vulnerabilidade de confusão de tipo de objeto de folha do Microsoft Office Excel              | [CVE-2010-0258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0258) | [**2**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Possível código de exploração inconsistente      | (Nenhum)                                                                             |  
| [MS10-017](http://technet.microsoft.com/security/bulletin/ms10-017) | Vulnerabilidade de memória não inicializada de registro FNGROUPNAME do Microsoft Office Excel | [CVE-2010-0262](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0262) | [**2**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Possível código de exploração inconsistente      | (Nenhum)                                                                             |  
| [MS10-018](http://technet.microsoft.com/security/bulletin/ms10-018) | Vulnerabilidade de corrupção de memória de condição de corrida                                | [CVE-2010-0489](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0489) | [**2**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Possível código de exploração inconsistente      | (Nenhum)                                                                             |  
| [MS10-018](http://technet.microsoft.com/security/bulletin/ms10-018) | Vulnerabilidade de corrupção de memória                                                       | [CVE-2010-0805](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0805) | [**2**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Possível código de exploração inconsistente      | (Nenhum)                                                                             |  
| [MS10-018](http://technet.microsoft.com/security/bulletin/ms10-018) | Vulnerabilidade de corrupção de memória não inicializada                                      | [CVE-2010-0267](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0267) | [**3**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Código de exploração de funcionamento improvável | (Nenhum)                                                                             |  
| [MS10-018](http://technet.microsoft.com/security/bulletin/ms10-018) | Vulnerabilidade de divulgação de informações pós-codificação                                  | [CVE-2010-0488](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0488) | [**3**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Código de exploração de funcionamento improvável | (Nenhum)                                                                             |  
| [MS10-018](http://technet.microsoft.com/security/bulletin/ms10-018) | Vulnerabilidade de corrupção de memória não inicializada                                      | [CVE-2010-0490](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0490) | [**3**](http://technet.microsoft.com/en-us/security/cc998259.aspx) - Código de exploração de funcionamento improvável | (Nenhum)                                                                             |
...
**Observações para o boletim MS10-016**
...
**Observações para o boletim MS10-017**
...
-   Damián Frizza, da [Core Security Technologies](http://www.coresecurity.com/), por relatar um problema descrito no boletim MS10-016
-   Nicolas Joly, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar um problema descrito no boletim MS10-017
-   Sean Larsson, da [VeriSign iDefense Labs](http://labs.idefense.com/), por relatar quatro problemas descritos no boletim MS10-017
-   Um pesquisador anônimo, que trabalha na [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por relatar um problema descrito no boletim MS10-017
-   Damián Frizza, da [Core Security Technologies](http://www.coresecurity.com/), por relatar um problema descrito no boletim MS10-017
-   [Secunia](http://secunia.com) por trabalhar conosco em um problema descrito no boletim MS10-018
-   Daiki Fukumori, da [Cyber Defense Institute Inc.](http://www.cyberdefense.jp/), por relatar um problema descrito no boletim MS10-018
-   Alexander Kornbrust, da [Red Database Security](http://www.red-database-security.com/), por relatar um problema descrito no boletim MS10-018
-   Ivan Fratric, da [iSIGHT Partners](http://www.isightpartners.com/) Global Vulnerability Partnership, por relatar um problema descrito no boletim MS10-018
-   Wushi, da [team509](http://www.team509.com/), que trabalha com a [VeriSign iDefense Labs](http://labs.idefense.com/), por relatar um problema descrito no boletim MS10-018
-   Simon Zuckerbraun, que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por relatar um problema descrito no boletim MS10-018
-   Paul Stone, da [Context Information Security](http://www.contextis.co.uk/), por relatar um problema descrito no boletim MS10-018
-   Um pesquisador anônimo, que trabalha na [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por relatar um problema descrito no boletim MS10-018
-   ADLab, da [VenusTech](http://www.venustech.com.cn/), por relatar dois problemas descritos no boletim MS10-018
...
-   V1.0 (9 de março de 2010): Resumo de boletins publicado.
-   V2.0 (30 de março de 2010): Foi adicionada uma atualização cumulativa para Internet Explorer ao Boletim de Segurança da Microsoft MS10-018 (980182). Também foi adicionado o link ao webcast para este boletim de segurança desvinculado.
-   V3.0 (3 de maio de 2010): Foi anunciada a disponibilidade do download do Microsoft Producer associado ao boletim MS10-016.
-   V3.1 (11 de agosto de 2010): O Windows Movie Maker 2.6 foi removido da lista de componentes afetados no Windows 7 para o boletim MS10-016.
