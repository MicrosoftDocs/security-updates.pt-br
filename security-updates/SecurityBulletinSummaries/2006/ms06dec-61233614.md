---
TOCTitle: 'MS06-DEC'
Title: Resumo do Boletim de Segurança da Microsoft de dezembro 2006
ms:assetid: 'ms06-dec'
ms:contentKeyID: 61233614
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms06-dec(v=Security.10)'
---

Security Bulletin Summary

Resumo do Boletim de Segurança da Microsoft de dezembro 2006
============================================================
...
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-072                                                                                           |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Atualização de segurança cumulativa para o Internet Explorer (925454)**](http://technet.microsoft.com/security/bulletin/ms06-072) |
...
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-073                                                                                                              |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no Visual Studio 2005 pode permitir a execução remota de código (925674)**](http://technet.microsoft.com/security/bulletin/ms06-073) |
| **Sinopse**                           | Esta atualização elimina uma vulnerabilidade no Visual Studio 2005 que pode permitir a execução remota de código.                                       |
| **Classificação máxima de gravidade** | [Crítica](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                               |
| **Software afetado**                  | **Visual Studio 2005**. Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                        |

| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-078                                                                                                                |
|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no Windows Media Format pode permitir a execução remota de código (923689)**](http://technet.microsoft.com/security/bulletin/ms06-078) |
| **Sinopse**                           | Esta atualização elimina uma vulnerabilidade no Windows Media Player que pode permitir a execução remota de código.                                       |
| **Classificação máxima de gravidade** | [Crítica](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                  |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                                 |
...
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-074                                                                                                                                                                                 |
|---------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no SNMP pode permitir a execução remota de código (926247)**](http://technet.microsoft.com/security/bulletin/ms06-074)                                                                                  |
| **Sinopse**                           | Esta atualização elimina uma vulnerabilidade no SNMP (Simple Network Management Protocol) que pode permitir a execução remota de código. O serviço SNMP não é instalado por padrão em nenhuma versão suportada do Windows. |
| **Classificação máxima de gravidade** | [Importante](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                                                                                |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                                                                                                  |
| **Software afetado**                  | **Windows** Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                                                                                                       |

| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-075                                                                                                                                                                                    |
|---------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no Windows pode permitir a elevação de privilégio (926255)**](http://technet.microsoft.com/security/bulletin/ms06-075)                                                                                     |
| **Sinopse**                           | Existe uma vulnerabilidade no Windows que pode permitir a elevação de privilégio em um sistema afetado. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. |
| **Classificação máxima de gravidade** | [Importante](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                                                                                   |
| **Impacto da vulnerabilidade**        | Elevação de privilégio                                                                                                                                                                                                        |
| **Software afetado**                  | **Windows** Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                                                                                                          |

| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-076                                                                                                                                                           |
|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Atualização de segurança cumulativa para o Outlook Express (923694)**](http://technet.microsoft.com/security/bulletin/ms06-076)                                                                   |
| **Sinopse**                           | Esta atualização elimina uma vulnerabilidade no Outlook Express que pode permitir a execução remota de código A interação do usuário é obrigatória para que um invasor explore esta vulnerabilidade. |
| **Classificação máxima de gravidade** | [Importante](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                                                          |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                                                                            |
...
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-077                                                                                                                          |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no Serviço de Instalação Remota pode permitir a execução remota de código (926121)**](http://technet.microsoft.com/security/bulletin/ms06-077)   |
| **Sinopse**                           | Esta atualização resolve uma vulnerabilidade no Serviço de Instalação Remota (RIS) que pode permitir a execução remota de código. O RIS não é instalado por padrão. |
| **Classificação máxima de gravidade** | [Importante](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                         |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                                           |
| **Software afetado**                  | **Windows** Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                                                |
...
**Softwares afetados e locais de download do MS06-072 a MS06-074**
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/brasil/security/boletins/rating.mspx">Crítica</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Plataformas e Ferramentas de Desenvolvimento .NET Framework afetadas:</strong></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
...
**Softwares afetados e locais de download do MS06-075 a MS06-078**
...
<tr class="odd">
<td style="border:1px solid black;">Outlook Express 5.5 Service Pack 2 para Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;">Outlook Express 6 Service Pack 1 quando instalado no Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Outlook Express 6 no Windows Server 2003 ou no Windows Server 2003 com Service Pack 1</td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;">Outlook Express 6 no Windows Server 2003 para sistemas baseados no Itanium e no Windows Server 2003 com SP1 para sistemas baseados no Itanium</td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;">Tempo de Execução do Windows Media Format 9.5 Series no Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Tempo de Execução do Windows Media Format 9.5 Series no Windows XP Service Pack 2</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;">Tempo de Execução do Windows Media Format 9.5 Series no Windows XP Professional x64 Edition</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Tempo de Execução do Windows Media Format 9.5 Series no Windows Server 2003 ou no Windows Server 2003 Service Pack 1</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;">Tempo de Execução do Windows Media Format 9.5 Series no Windows Server 2003 X64 Edition</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=?">Crítica</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Tempo de Execução do Windows Media Format 9.5 Series x64 Edition no Windows XP Professional x64 Edition</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;">Tempo de Execução do Windows Media Format 9.5 Series x64 Edition no Windows Server 2003 x64 Edition</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c5ece3cd-ac7b-46b4-99dc-74a6b0f323d0">Crítica</a></td>
...
-   Jakob Balle e Carsten Eiram, da [Secunia Research](http://secunia.com/), por relatar um problema descrito no [MS06-072](http://technet.microsoft.com/security/bulletin/ms06-072)  
-   Sam Thomas, que trabalha na [TippingPoint](http://www.tippingpoint.com/) e na [Zero Day Initiative](http://www.zerodayinitiative.com/), por relatar um problema descrito no boletim [MS06-072](http://technet.microsoft.com/security/bulletin/ms06-072)  
-   Yorick Koster, da [ITsec Security Services](http://www.itsec-ss.nl/), por relatar um problema descrito no [MS06-072](http://technet.microsoft.com/security/bulletin/ms06-072)  
-   [TippingPoint](http://www.tippingpoint.com/) e [Zero Day Initiative](http://www.zerodayinitiative.com/) por relatar um problema descrito em [MS06-074](http://technet.microsoft.com/security/bulletin/ms06-073)  
-   Kostya Kortchinsky, da [The European Aeronautic Defense and Space Company](http://www.eads.com/), por relatar um problema descrito em [MS06-075](http://technet.microsoft.com/security/bulletin/ms06-074)  
-   Nicolas Ruff por relatar um problema descrito em [MS06-078](http://technet.microsoft.com/security/bulletin/ms06-077)
