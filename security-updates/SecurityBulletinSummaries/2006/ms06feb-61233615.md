---
TOCTitle: 'MS06-FEB'
Title: Resumo do Boletim de Segurança da Microsoft de fevereiro 2006
ms:assetid: 'ms06-feb'
ms:contentKeyID: 61233615
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms06-feb(v=Security.10)'
---

Security Bulletin Summary

Resumo do Boletim de Segurança da Microsoft de fevereiro 2006
=============================================================
...
**Serviço de Notificação de Segurança Microsoft:** Para receber notificações automáticas por e-mail sempre que um boletim de segurança da Microsoft for publicado, inscreva-se no [Serviço de Notificação de Segurança Microsoft](http://www.microsoft.com/brasil/security/alertas.mspx) (site em inglês).
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-004                                                                                         |
|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Atualização de segurança cumulativa para Internet Explorer (910620)**](http://technet.microsoft.com/security/bulletin/ms06-004) |
...
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-005                                                                                                 |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | **Vulnerabilidade no Windows Media Player pode permitir a execução de código remoto (911565)**                                             |
| **Sinopse**                           | Existe uma vulnerabilidade no modo como o Windows Media Player processa determinados arquivos pode permitir uma execução remota de código. |
| **Classificação máxima de gravidade** | [Crítica](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                   |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                  |
| **Softwares afetados**                | **Windows** Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                       |
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-006                                                                                                                                                          |
|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | **Vulnerabilidade no Plug-in do Windows Media Player com Navegadores de Internet que não sejam da Microsoft pode Permitir a Execução Remota de Código. (911564)**                                   |
| **Sinopse**                           | Existe uma vulnerabilidade de execução remota de código no plug-in do Windows Media Player para navegadores de Internet que não sejam da Microsoft que pode permitir uma execução remota de código. |
...
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-007                                                                                                                |
|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no TCP/IP pode permitir negação de serviço (913446)**](http://technet.microsoft.com/security/bulletin/ms06-007)                        |
| **Sinopse**                           | Existe uma vulnerabilidade que pode permitir que um invasor envie um IGMP especialmente criado que pode fazer com que o sistema afetado pare de responder |
| **Classificação máxima de gravidade** | [Importante](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                               |
| **Impacto da vulnerabilidade**        | Negação de Serviço                                                                                                                                        |
| **Software afetado**                  | **Windows.** Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                                     |

| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-008                                                                                                                                                                                                        |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no serviço Cliente da Web pode permitir a execução remota de códigos (911927)**](http://technet.microsoft.com/security/bulletin/ms06-008)                                                                                      |
| **Sinopse**                           | Uma vulnerabilidade existente no Windows Web Client pode permitir que um invasor controle completamente um sistema afetado. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. |
| **Classificação máxima de gravidade** | [Importante](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                                                                                                       |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                                                                                                                         |
| **Software afetado**                  | **Windows.** Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                                                                                                                             |

| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-009                                                                                                                                                                                                                                   |
|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no Editor do método de entrada coreano permite a elevação de privilégio (901190)**](http://technet.microsoft.com/security/bulletin/ms06-009)                                                                                                              |
| **Sinopse**                           | Existe uma vulnerabilidade no Windows e no Editor do método de entrada coreano que pode permitir que um invasor controle totalmente o sistema afetado. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. |
| **Classificação máxima de gravidade** | [Importante](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                                                                                                                                  |
| **Impacto da vulnerabilidade**        | Elevação de privilégio                                                                                                                                                                                                                                                       |
| **Software afetado**                  | **Windows e Office.** Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                                                                                                                                               |

| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-010                                                           |
|---------------------------------------|------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | **Vulnerabilidade no PowerPoint 2000 pode permitir a divulgação de informações (889167)**            |
| **Sinopse**                           | Existe uma vulnerabilidade no PowerPoint que pode permitir a divulgação não autorizada de informação |
| **Classificação máxima de gravidade** | [Importante](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                          |
...
#### Softwares afetados e locais de download do MS06-004 a MS06-007
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Componentes do Sistema Operacional do Windows Afetados:</strong></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Media Player 9 quando instalado no Windows 98, 98 SE, ME, Windows 2000 Service Pack 4, Windows XP Service Pack 1</td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;">Windows Media Player 9 no Windows XP Service Pack 2 ou Windows Server 2003</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8f9eef16-04f7-4da8-a0ef-1797b52d0b4b">Crítica</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
#### Softwares afetados e locais de download do MS06-008 a MS06-010
...
<tr class="odd">
<td style="border:1px solid black;">Pacotes Multilingual User Interface do Project 2003</td>
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/pt-BR/library///www.microsoft.com/downloads/details.aspx?familyid=8e6f16e9-cd73-47d5-887e-616db9b09591(v=Security.10)">Importante</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/pt-BR/library///www.microsoft.com/downloads/details.aspx?familyid=e51b27c8-2f31-4e99-b868-ce626fed5b7d(v=Security.10)">Importante</a></td>
</tr>
</tbody>
</table>
...
**<sup>[1]</sup>** Há uma atualização de segurança disponível para esse sistema operacional. Para obter mais detalhes, consulte o componente afetado, Microsoft Internet Explorer ou Windows Media Player, na tabela e o boletim de segurança adequado.
...
-   Marc Maiffret da eEye por relatar o problema descrito no [MS06-005](http://technet.microsoft.com/security/bulletin/ms06-005).  
-   John Cobb da iDefense por relatar o problema descrito no [MS06-006](http://technet.microsoft.com/security/bulletin/ms06-006).  
-   Douglas Nascimento da Datacom por relatar o problema descrito no [MS06-007](http://technet.microsoft.com/security/bulletin/ms06-007).  
-   Kostya Kortchinsky da [EADS/CRC](http://www.eads.net/) por relatar o problema descrito no [MS06-008](http://technet.microsoft.com/security/bulletin/ms06-008).  
-   [Ryan Lee](mailto:newrun@gmail.com) por relatar o problema descrito no [MS06-009](http://technet.microsoft.com/security/bulletin/ms06-009).  
-   Andreas Sandblad por relatar o problema descrito no [MS06-010.](http://technet.microsoft.com/security/bulletin/ms06-010)  
-   Yorick Koster da ITsec Security Services por relatar um problema descrito no [MS06-010](http://technet.microsoft.com/security/bulletin/ms06-010).  
-   **Obtendo outras atualizações de segurança:**
    ...
    -   Você pode obter as atualizações de segurança oferecidas no Windows Update este mês no arquivo de imagem ISO January 2006 Security and Critical Releases; para obter mais informações, consulte o [artigo 913086 da Base de Conhecimento Microsoft](http://support.microsoft.com/kb/913086).
