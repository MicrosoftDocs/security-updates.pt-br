---
TOCTitle: 'MS06-MAR'
Title: Resumo do Boletim de Segurança da Microsoft de março 2006
ms:assetid: 'ms06-mar'
ms:contentKeyID: 61233618
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms06-mar(v=Security.10)'
---

Security Bulletin Summary

Resumo do Boletim de Segurança da Microsoft de março 2006
=========================================================
...
**Serviço de Notificação de Segurança Microsoft:** Para receber notificações automáticas por e-mail sempre que um boletim de segurança da Microsoft for publicado, inscreva-se no [Serviço de Notificação de Segurança Microsoft](http://www.microsoft.com/brasil/security/alertas.mspx).
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-012                                                                                                             |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidades no Microsoft Office pode permitir a execução remota de código (905413)**](http://technet.microsoft.com/security/bulletin/ms06-012) |
| **Sinopse**                           | Existem vulnerabilidades no Microsoft Office que podem permitir a execução remota de código.                                                           |
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-011                                                                                                                    |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**DACLs permissivas de Serviços Windows podem causar elevação de privilégios (914798)**](http://technet.microsoft.com/security/bulletin/ms06-011)            |
| **Sinopse**                           | Existe uma vulnerabilidade de elevação de privilégios que poderá permitir que um usuário com credenciais de logon válidas assuma o controle total do sistema. |
...
Por exemplo, o boletim de segurança **MS06-012** fornece diversas atualizações de segurança que podem ser necessárias dependendo dos softwares e dos componentes afetados que você instalou.
...
-   Andres Tarasco da [SIA Group](http://www.siainternational.com/) por trabalhar conosco em um problema descrito em [MS06-011](http://technet.microsoft.com/security/bulletin/ms06-011).  
-   Ollie Whitehouse da [Symantec](http://symantec.com/) por informar um problema descrito no [MS06-012](http://technet.microsoft.com/security/bulletin/ms06-012).  
-   [FelicioX](mailto:feliciox@gmail.com) por trabalhar conosco em um problema descrito em [MS06-012](http://technet.microsoft.com/security/bulletin/ms06-012).  
-   Peter Winter-Smith da [NGS Software](http://www.ngssoftware.com/index.htm) por relatar um problema descrito em [MS06-012](http://technet.microsoft.com/security/bulletin/ms06-012).  
-   Dejun da [Fortinet Security Response Team](http://www.fortinet.com/) por relatar um problema descrito em [MS06-012](http://technet.microsoft.com/security/bulletin/ms06-012).  
-   [TippingPoint](http://www.tippingpoint.com/) e [Zero Day Initiative](http://www.zerodayinitiative.com/) por relatar um problema descrito em [MS06-012](http://technet.microsoft.com/security/bulletin/ms06-012).  
-   Eyas da [XFOCUS Security Team](http://www.xfocus.org/) por relatar um problema descrito em [MS06-012](http://technet.microsoft.com/security/bulletin/ms06-012).
...
-   Catálogo do Windows Update: Para obter mais informações sobre o Catálogo do Windows Update, consulte o artigo [323166](http://support.microsoft.com/default.aspx?scid=kb;pt-br;323166) (em inglês) da Base de Conhecimento Microsoft.  
