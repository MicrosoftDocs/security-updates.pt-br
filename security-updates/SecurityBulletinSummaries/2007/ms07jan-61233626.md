---
TOCTitle: 'MS07-JAN'
Title: Resumo do Boletim de Segurança da Microsoft de janeiro 2007
ms:assetid: 'ms07-jan'
ms:contentKeyID: 61233626
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms07-jan(v=Security.10)'
---

Security Bulletin Summary

Resumo do Boletim de Segurança da Microsoft de janeiro 2007
===========================================================
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS07-002                                                                                                             |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidades no Microsoft Excel podem permitir a execução remota de código (927198)**](http://technet.microsoft.com/security/bulletin/ms07-002) |
...
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS07-003                                                                                                               |
|---------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidades no Microsoft Outlook podem permitir a execução remota de código (925938)**](http://technet.microsoft.com/security/bulletin/ms07-003) |
| **Sinopse**                           | Esta atualização elimina vulnerabilidades no Outlook que podem permitir a execução remota de código.                                                     |
| **Classificação máxima de gravidade** | [Crítica](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                 |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                                |
| **Software afetado**                  | **Office**. Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                                     |

| Identificador do Boletim              | Boletim de Segurança da Microsoft MS07-004                                                                                                                        |
|---------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade na VML (Vector Markup Language) pode permitir a execução remota de código (929969)**](http://technet.microsoft.com/security/bulletin/ms07-004) |
...
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS07-001                                                                                                                                                                   |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no verificador gramatical para português (Brasil) do Microsoft Office 2003 pode permitir a execução remota de código (921585)**](http://technet.microsoft.com/security/bulletin/ms07-001) |
| **Sinopse**                           | Esta atualização elimina vulnerabilidades no Office que podem permitir a execução remota de código. A interação do usuário é obrigatória para que um invasor explore estas vulnerabilidades.                 |
...
**Softwares afetados e locais de download do MS07-001 a MS07-004**
...
<tr class="even">
<td style="border:1px solid black;">Internet Explorer 7 no Windows Server 2003 e no Windows Server 2003 Service Pack 1</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;">Internet Explorer 7 no Windows Server 2003 para sistemas baseados no Itanium e no Windows Server 2003 com SP1 para sistemas baseados no Itanium</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Works Suite 2004 e 2005</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ee7278ea-3aee-4994-9657-66019961d63c">Crítica</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;">Office 2003 Service Pack 2 (Versão em português (Brasil))</td>
...
<tr class="odd">
<td style="border:1px solid black;">Interface de Usuário Multilíngüe do Microsoft Office 2003 Service Pack 2</td>
...
<tr class="even">
<td style="border:1px solid black;">Interface de Usuário Multilíngüe do Microsoft Project 2003 Service Pack 2</td>
...
<tr class="odd">
<td style="border:1px solid black;">Interface de Usuário Multilíngüe do Microsoft Visio 2003 Service Pack 2</td>
...
<tr class="even">
<td style="border:1px solid black;">Revisores de Texto do Microsoft Office 2003 Service Pack 2</td>
...
-   Jeff Gennari da [CERT](https://www.securecoding.cert.org/confluence/display/seccode/cert+secure+coding+standards), Jie Ma do [Fortinet Security Research Team](http://www.fortinet.com/), [NSFocus Security Team](http://www.nsfocus.com/) e Greg MacManus da [IDefense Labs](http://labs.idefense.com/) por relatarem um problema descrito no boletim [MS07-002](http://technet.microsoft.com/security/bulletin/ms07-002).  
-   Lurene Grenier da [Sourcefire](http://www.sourcefire.com/) e Stuart Pearson da [Computer Terrorism](http://www.computerterrorism.com/) por relatarem um problema descrito no boletim [MS07-003](http://technet.microsoft.com/security/bulletin/ms07-003).
