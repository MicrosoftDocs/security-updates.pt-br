---
TOCTitle: 'MS11-FEB'
Title: Resumo do Boletim de Segurança da Microsoft de fevereiro 2011
ms:assetid: 'ms11-feb'
ms:contentKeyID: 61233673
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-feb(v=Security.10)'
---

Security Bulletin Summary

Resumo do Boletim de Segurança da Microsoft de fevereiro 2011
=============================================================
...
Este resumo de boletins lista os boletins de segurança lançados em fevereiro de 2011.

Com o lançamento dos boletins de fevereiro de 2011, este resumo de boletins substitui a notificação antecipada do boletim emitida originalmente em 3 de fevereiro de 2011. Para obter mais informações sobre o serviço de notificação antecipada de boletim, consulte [Notificação antecipada dos boletins de segurança da Microsoft](http://technet.microsoft.com/security/bulletin/advance).

Para obter informações sobre como receber notificações automáticas sempre que os boletins de segurança da Microsoft são emitidos, consulte as [notificações de segurança técnica da Microsoft](http://go.microsoft.com/fwlink/?linkid=21163).

A Microsoft realizará um webcast para solucionar dúvidas dos clientes sobre esses boletins em 9 de fevereiro de 2011, às 11 horas - Hora do Pacífico (EUA e Canadá). [Registre-se agora para participar do Webcast do boletim de segurança de fevereiro](https://msevents.microsoft.com/cui/webcasteventdetails.aspx?eventid=1032455047&eventcategory=4). Depois dessa data, este webcast estará disponível sob demanda. Para obter mais informações, consulte [Webcasts e resumos dos boletins de segurança da Microsoft.](http://technet.microsoft.com/security/bulletin/summary)
...
<td style="border:1px solid black;"><strong>Atualização de segurança cumulativa para o Internet Explorer (2482017)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Vulnerabilidade no Windows Shell Graphics Processing poderia permitir execução remota de código (2483185)</strong><br />
<br />
Esta atualização de segurança elimina uma vulnerabilidade divulgada publicamente no processador de gráficos de Windows Shell. A vulnerabilidade pode permitir a execução remota de código caso um usuário tenha exibido uma imagem em miniatura especialmente criada. O invasor que explorar com êxito a vulnerabilidade poderá obter os mesmos direitos que o usuário conectado. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/brasil/security/boletins/rating.mspx">Crítica</a><br />
Execução Remota de Código</td>
<td style="border:1px solid black;">Exige reinicialização</td>
...
<td style="border:1px solid black;"><strong>Vulnerabilidade no driver CFF (Compact Font Format) OpenType pode permitir execução remota de código (2485376)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Vulnerabilidade no serviço de FTP do IIS poderia permitir a execução remota de código (2489256)</strong><br />
<br />
Esta atualização de segurança elimina uma vulnerabilidade publicamente divulgada no Serviço de FTP dos Serviços de Informações da Internet (IIS) da Microsoft. A vulnerabilidade pode permitir a execução remota de código se um servidor FTP receber um comando de FTP especialmente criado. O Serviço de FTP não está instalado por padrão no IIS.</td>
...
<td style="border:1px solid black;"><strong>Vulnerabilidade no Active Directory pode permitir a negação de serviço (2478953)</strong><br />
<br />
Esta atualização de segurança elimina uma vulnerabilidade divulgada publicamente no Active Directory. A vulnerabilidade pode permitir negação de serviço se um invasor enviar um pacote especialmente criado para um servidor afetado de Active Directory. O invasor deve ter privilégios válidos de administrador local no computador de domínios para explorar esta vulnerabilidade.</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/brasil/security/boletins/rating.mspx">Importante</a><br />
...
<td style="border:1px solid black;"><strong>Vulnerabilidades no Microsoft Visio podem permitir a execução remota de código (2451879)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Vulnerabilidade em JScript e Mecanismos de Scripting de VBScript poderiam permitir divulgação não autorizada de informação (2475792)</strong><br />
<br />
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular nos mecanismos de script VBScript e JScript. A vulnerabilidade pode permitir a divulgação não autorizada de informações se um usuário visitou um site especialmente criado. Não há como o invasor forçar os usuários a visitarem esses sites. Em vez disso, o invasor teria que convencer os usuários a visitar o site, geralmente fazendo com que eles cliquem em um link em um email ou mensagem do Instant Messenger que leva o usuário ao site do invasor.</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/brasil/security/boletins/rating.mspx">Importante</a><br />
...
<td style="border:1px solid black;"><strong>Vulnerabilidade no Windows Client/Server Runtime Subsystem poderia permitir elevação de privilégio (2476687)</strong><br />
<br />
Esta atualização de segurança elimina uma vulnerabilidade em particular relatada no Microsoft Windows Client/Server Run-time Subsystem (CSRSS) no Windows XP e Windows Server 2003.<br />
<br />
A vulnerabilidade pode permitir a elevação de privilégio se um invasor fizer logon em um sistema do usuário e iniciar um aplicativo especialmente criado que continua em execução depois que o invasor fizer logoff para obter as credenciais de logon de usuários subsequentes. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/brasil/security/boletins/rating.mspx">Importante</a><br />
...
<td style="border:1px solid black;"><strong>Vulnerabilidades no kernel do Windows podem permitir a elevação de privilégio (2393802)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Vulnerabilidades em drivers do modo kernel do Windows podem permitir a elevação de privilégio (2479628)</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Vulnerabilidade no LSASS (Local Security Authority Subsystem Service) poderia permitir a elevação de privilégio (2478960)</strong><br />
<br />
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular no LSASS (Local Security Authority Subsystem Service) no Windows XP e Windows Server 2003.<br />
<br />
A vulnerabilidade pode permitir elevação de privilégio se um invasor fizer logon em um sistema e executar um aplicativo especialmente criado. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/brasil/security/boletins/rating.mspx">Importante</a><br />
Elevação de privilégio</td>
<td style="border:1px solid black;">Exige reinicialização</td>
<td style="border:1px solid black;">Microsoft Windows</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-006">MS11-006</a></td>
<td style="border:1px solid black;">Vulnerabilidade de saturação de processamento gráfico do Windows Shell</td>
...
<td style="border:1px solid black;"><strong>Esta vulnerabilidade foi divulgada publicamente, e o código de exploração está disponível em</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-003">MS11-003</a></td>
<td style="border:1px solid black;">Vulnerabilidade de corrupção de memória da CSS</td>
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3971">CVE-2010-3971</a></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/cc998259.aspx">1</a> - Possível código de exploração consistente</td>
<td style="border:1px solid black;"><strong>Esta vulnerabilidade foi divulgada publicamente e está sendo explorada no ecossistema da Internet</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-011">MS11-011</a></td>
<td style="border:1px solid black;">Vulnerabilidade de interação imprópria do driver com Kernel do Windows</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-010">MS11-010</a></td>
<td style="border:1px solid black;">Vulnerabilidade de elevação de privilégio do CSRSS</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-014">MS11-014</a></td>
<td style="border:1px solid black;">Vulnerabilidade de Validação de Comprimento de LSASS</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-013">MS11-013</a></td>
<td style="border:1px solid black;">Vulnerabilidade de soma de verificação sem chave do Kerberos</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-011">MS11-011</a></td>
<td style="border:1px solid black;">Vulnerabilidade de truncamento de número inteiro de Kernel do Windows</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-012">MS11-012</a></td>
<td style="border:1px solid black;">Vulnerabilidade de validação de entrada de usuário imprópria do Win32k</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-012">MS11-012</a></td>
<td style="border:1px solid black;">Vulnerabilidade de validação de entrada de usuário insuficiente do Win32k</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-012">MS11-012</a></td>
<td style="border:1px solid black;">Vulnerabilidade de confusão de ponteiros de classe de janelas do Win32k</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-012">MS11-012</a></td>
<td style="border:1px solid black;">Vulnerabilidade de validação de ponteiro imprópria da classe de janelas do Win32k</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-012">MS11-012</a></td>
<td style="border:1px solid black;">Vulnerabilidade de corrupção de memória do Win32k</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-008">MS11-008</a></td>
<td style="border:1px solid black;">Vulnerabilidade de corrupção de memória de objeto Visio</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-004">MS11-004</a></td>
<td style="border:1px solid black;">Vulnerabilidade de saturação de buffer de estouro de serviço do FTP do IIS</td>
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3972">CVE-2010-3972</a></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/cc998259.aspx">2</a> - Possível código de exploração consistente</td>
<td style="border:1px solid black;"><strong>Esta vulnerabilidade foi divulgada publicamente, e o código de POC pode estar disponível em</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-007">MS11-007</a></td>
<td style="border:1px solid black;">Vulnerabilidade de caractere codificado por fonte OpenType</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-009">MS11-009</a></td>
<td style="border:1px solid black;">Vulnerabilidade de divulgação de informações de mecanismos de scripting</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-005">MS11-005</a></td>
<td style="border:1px solid black;">Vulnerabilidade de Validação de SPN do Active Directory</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-013">MS11-013</a></td>
<td style="border:1px solid black;">Vulnerabilidade de falsificação de Kerberos</td>
<td style="border:1px solid black;"><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0091">CVE-2011-0091</a></td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/cc998259.aspx">3</a> – Código de exploração de funcionamento improvável</td>
<td style="border:1px solid black;">Essa é uma vulnerabilidade apenas de falsificação</td>
</tr>
</tbody>
</table>
...
<td style="border:1px solid black;">
[Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a4f9ec46-35b2-44c9-abf6-647f7a474b99)  
(Crítica)
</td>
<td style="border:1px solid black;">
[Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid
  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=01737933-e7de-451b-b02f-b7ca24693965)  
(KB2425227)  
(Importante)
</td>
<td style="border:1px solid black;">
...
**Observação para o boletim MS11-004**
...
-   Yuki Chen, da [Trend Micro](http://www.trendmicro.com), por relatar um problema descrito em MS11-003
-   SkyLined, da [Google Inc.](http://www.google.com/), por relatar um problema descrito no boletim MS11-003
-   Haifei Li, da [Fortinet's FortiGuard Labs](http://www.fortiguard.com/), por relatar um problema descrito no boletim MS11-003
-   Kobi Pariente e Yaniv Miron, trabalhando, que trabalham com a [VeriSign iDefense Labs](http://labs.idefense.com/), por relatarem um problema descrito em MS11-006
-   Procyun, que trabalha com a [Zero Day Initiative](http://www.tippingpoint.com/)[da TippingPoint](http://www.zerodayinitiative.com/), por relatar um problema descrito no boletim MS11-008
-   Xin Ouyang, da [Palo Alto Networks](http://www.paloaltonetworks.com/), por relatar dois problemas descritos no boletim MS11-008
-   Yamata Li, da [Palo Alto Networks](http://www.paloaltonetworks.com/), por relatar um problema descrito no boletim MS11-009
-   Sihan Qing (Professor), Weiping Wen (Professor adjunto), Liang Yin e Husheng Zhou (alunos graduados), do [Departamento de Segurança da Informação, da Universidade de Pequim](http://www.ss.pku.edu.cn/en/), por relatarem um problema descrito no MS11-010
-   Zhengwenbin, da [360safe,](http://www.360.cn) por relatar um problema descrito em MS11-011
-   Guo Bojun por relatar um problema descrito no boletim MS11-011
-   Wei Zhang, por relatar um problema descrito no boletim MS11-011
-   Marco Giuliani, da [PrevX](http://www.prevx.com/), por trabalhar conosco em um problema descrito no boletim MS11-011
-   std\_logic, que trabalha com a [Zero Day Initiative](http://www.tippingpoint.com/)[da TippingPoint,](http://www.zerodayinitiative.com/) por relatar um problema descrito no boletim MS11-011
-   Tarjei Mandt, da [Norman,](http://www.norman.com) por reportar cinco problemas descritos no MS11-012
-   [A equipe de Kerberos do MIT](http://web.mit.edu/kerberos) por relatar um problema descrito no boletim MS11-013
-   Scott Stender, da [iSEC Partners](http://www.isecpartners.com/), por relatar um problema descrito em MS11-013
-   O verificador de segurança Jorge Moura da Primavera BSS por relatar um problema descrito em MS11-014
...
-   V1.0 (8 de fevereiro de 2011): Resumo de boletins publicado.
-   V1.1 (9 de fevereiro de 2011): Para o MS11-013, corrigida a Avaliação do índice de exploração do CVE-2011-0091 a “3 – Código de exploração de funcionamento improvável". Esta é apenas uma alteração informativa.
-   V2.0 (8 de março de 2011): Esclarecido que o software afetado inclui o Windows 7 para sistemas Service Pack 1 de 32 bits, Windows 7 para sistemas Service Pack 1 de 64 bits, Windows Server 2008 R2 para sistemas Service Pack 1 de 64 bits e Windows Server 2008 R2 para sistemas Service Pack 1 baseados em Itanium para MS11-003, MS11-004, MS11-007 e MS11-009. Consulte as Perguntas frequentes de atualização destes boletins para obter mais informações.
-   V3.0 (16 de março de 2011): Esclarecido que o software afetado inclui o Windows 7 para sistemas Service Pack 1 de 32 bits, Windows 7 para sistemas Service Pack 1 de 64 bits, Windows Server 2008 R2 para sistemas Service Pack 1 de 64 bits e Windows Server 2008 R2 para sistemas Service Pack 1 baseados em Itanium para MS11-013. Consulte as Perguntas frequentes de atualização deste boletim para obter mais informações.
-   V4.0 (18 de março de 2011) : Esclarecido que o software afetado inclui o Windows 7 para sistemas Service Pack 1 de 32 bits, Windows 7 para sistemas Service Pack 1 de 64 bits, Windows Server 2008 R2 para sistemas Service Pack 1 de 64 bits e Windows Server 2008 R2 para sistemas Service Pack 1 baseados em Itanium para MS11-012. Consulte as Perguntas frequentes de atualização deste boletim para obter mais informações.
