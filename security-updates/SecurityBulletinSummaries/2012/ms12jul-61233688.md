---
TOCTitle: 'MS12-JUL'
Title: Resumo do Boletim de Segurança da Microsoft de julho 2012
ms:assetid: 'ms12-jul'
ms:contentKeyID: 61233688
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-jul(v=Security.10)'
---
...
Publicado: terça-feira, 10 de julho de 2012 | Atualizado: quarta-feira, 12 de dezembro de 2012

**Versão:** 5.1

Este resumo de boletins lista os boletins de segurança lançados em julho de 2012.

Com o lançamento dos boletins de segurança de julho de 2012, este resumo de boletins substitui a notificação antecipada do boletim emitida originalmente em 5 de julho de 2012. Para obter mais informações sobre o serviço de notificação antecipada de boletim, consulte [Notificação antecipada dos boletins de segurança da Microsoft](http://go.microsoft.com/fwlink/?linkid=217213).

Para obter informações sobre como receber notificações automáticas sempre que os boletins de segurança da Microsoft são emitidos, consulte as [Notificações de segurança técnica da Microsoft](http://go.microsoft.com/fwlink/?linkid=21163).

A Microsoft realizará um webcast para solucionar dúvidas dos clientes sobre esses boletins em 11 de julho de 2012, às 11 horas - Hora do Pacífico (EUA e Canadá). [Registre-se agora para participar do Webcast do boletim de segurança de julho](https://msevents.microsoft.com/cui/eventdetail.aspx?eventid=1032518600). Depois dessa data, este webcast estará disponível sob demanda. Para obter mais informações, consulte [Webcasts e resumos dos boletins de segurança da Microsoft.](http://go.microsoft.com/fwlink/?linkid=217214)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-043"><strong>MS12-043</strong></a></td>
<td style="border:1px solid black;"><strong>Vulnerabilidade no Microsoft XML Core Services pode permitir a execução remota de código (2722479)</strong> <br />
<br />
Esta atualização de segurança elimina uma vulnerabilidade relatada publicamente no Microsoft XML Core Services. A vulnerabilidade pode permitir a execução remota de código se um usuário visualizar uma página da Web especialmente criada no Internet Explorer. Não há como o invasor forçar os usuários a visitarem o site mal-intencionado. Em vez disso, o invasor precisa persuadir os usuários a visitar o site, geralmente fazendo com que eles cliquem em um link em um email ou mensagem do Instant Messenger que leva o usuário ao site do invasor.</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-044"><strong>MS12-044</strong></a></td>
<td style="border:1px solid black;"><strong>Atualização de segurança cumulativa para</strong> <strong>o Internet Explorer (2719177)</strong> <br />
<br />
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-045"><strong>MS12-045</strong></a></td>
<td style="border:1px solid black;"><strong>Vulnerabilidade no Microsoft DataAccess</strong> <strong>Components</strong> <strong>pode permitir a execução remota de código (2698365)</strong> <br />
<br />
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular no Microsoft Windows. A vulnerabilidade pode permitir a execução remota de código caso um usuário exiba uma página da Web especialmente criada. O invasor que explorar com êxito essa vulnerabilidade poderá obter os mesmos direitos que o usuário atual. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/brasil/security/boletins/rating.mspx">Crítica</a> <br />
Execução remota de código</td>
<td style="border:1px solid black;">Pode exigir reinicialização</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-046"><strong>MS12-046</strong></a></td>
<td style="border:1px solid black;"><strong>Vulnerabilidade no Visual Basic</strong> <strong>forApplications</strong> <strong>pode permitir a execução remota de código (2707960)</strong> <br />
<br />
Esta atualização de segurança elimina uma vulnerabilidade divulgada publicamente no Microsoft Visual Basic for Applications. A vulnerabilidade pode permitir a execução remota de código se um invasor convencer um usuário a abrir um arquivo legítimo do Microsoft Office (como um arquivo .docx) localizado no mesmo diretório que um arquivo de biblioteca de link dinâmico (DLL) especialmente criado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Se um usuário estiver conectado com direitos administrativos, o invasor poderá assumir o controle total do sistema afetado. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-047"><strong>MS12-047</strong></a></td>
<td style="border:1px solid black;"><strong>Vulnerabilidades nos drivers do modo</strong> <strong>kernel</strong> <strong>do Windows podem permitir a elevação de privilégio (2718523)</strong> <br />
<br />
Esta atualização de segurança resolve uma vulnerabilidade divulgada publicamente e uma vulnerabilidade relatada em particular no Microsoft Windows. As vulnerabilidades podem permitir elevação de privilégio se um invasor faz logon no sistema e executar um aplicativo especialmente criado. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/brasil/security/boletins/rating.mspx">Importante</a> <br />
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-048"><strong>MS12-048</strong></a></td>
<td style="border:1px solid black;"><strong>Vulnerabilidade no Shell do Windows pode permitir a execução remota de código (2691442)</strong> <br />
<br />
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular no Microsoft Windows. A vulnerabilidade pode permitir a execução remota de código se um usuário abrir um arquivo ou diretório com nome especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá obter os mesmos direitos que o usuário atual. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/brasil/security/boletins/rating.mspx">Importante</a> <br />
Execução remota de código</td>
<td style="border:1px solid black;">Exige reinicialização</td>
<td style="border:1px solid black;">Microsoft Windows</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-049"><strong>MS12-049</strong></a></td>
<td style="border:1px solid black;"><strong>Vulnerabilidade no TLS pode permitir divulgação de informações (2655992)</strong> <br />
<br />
Esta atualização de segurança resolve uma vulnerabilidade divulgada publicamente no TLS. A vulnerabilidade pode permitir a divulgação não autorizada de informações se um invasor interceptar tráfego da web criptografado servido de um sistema afetado. Todos os pacotes de criptografia que não usam o modo CBC não são afetados.</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/brasil/security/boletins/rating.mspx">Importante</a> <br />
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-050"><strong>MS12-050</strong></a></td>
<td style="border:1px solid black;"><strong>Vulnerabilidades no SharePoint podem permitir a elevação de privilégio (2695502)</strong> <br />
<br />
Esta atualização de segurança elimina uma vulnerabilidade divulgada publicamente e cinco vulnerabilidades relatadas em particular no Microsoft SharePoint e no Windows SharePoint Services. As vulnerabilidades mais graves podem permitir elevação de privilégio se um usuário clicar em uma URL especialmente criada que o leve ao site afetado do SharePoint.</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/brasil/security/boletins/rating.mspx">Importante</a> <br />
Elevação de privilégio</td>
<td style="border:1px solid black;">Pode exigir reinicialização</td>
<td style="border:1px solid black;">Microsoft Office,<br />
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-051"><strong>MS12-051</strong></a></td>
<td style="border:1px solid black;"><strong>Vulnerabilidade no Microsoft Office for Mac pode permitir a elevação de privilégio (2721015)</strong> <br />
<br />
Esta atualização de segurança elimina uma vulnerabilidade divulgada publicamente no Microsoft Office for Mac. A vulnerabilidade pode permitir elevação de privilégio se um executável mal-intencionado é colocado num sistema afetado por um invasor, e então outro usuário efetua login posteriormente e executa o arquivo mal-intencionado. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/brasil/security/boletins/rating.mspx">Importante</a> <br />
Elevação de privilégio</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-043"><strong>MS12-043</strong></a></td>
<td style="border:1px solid black;">Vulnerabilidade de corrupção de memória não inicializada de MSXML</td>
...
<br />
A Microsoft está ciente dos ataques direcionados que tentam explorar a vulnerabilidade.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-044"><strong>MS12-044</strong></a></td>
<td style="border:1px solid black;">Vulnerabilidade de execução remota de código de objeto em cache</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-044"><strong>MS12-044</strong></a></td>
<td style="border:1px solid black;">Vulnerabilidade de execução remota de código de remoção de atributo</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-045"><strong>MS12-045</strong></a></td>
<td style="border:1px solid black;">Vulnerabilidade de RCE de estouro de heap de tamanho de cache ADO</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-046"><strong>MS12-046</strong></a></td>
<td style="border:1px solid black;">Vulnerabilidade de carregamento não seguro de bibliotecas do Visual Basic for Applications</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-047"><strong>MS12-047</strong></a></td>
<td style="border:1px solid black;">Vulnerabilidade de layout de teclado</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-047"><strong>MS12-047</strong></a></td>
<td style="border:1px solid black;">Vulnerabilidade de controle de tipo incorreto do Win32k</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-048"><strong>MS12-048</strong></a></td>
<td style="border:1px solid black;">Vulnerabilidade de injeção de comando</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-049"><strong>MS12-049</strong></a></td>
<td style="border:1px solid black;">Vulnerabilidade de protocolo TLS</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-050"><strong>MS12-050</strong></a></td>
<td style="border:1px solid black;">Vulnerabilidade scriptresx.ashx em XSS</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-050"><strong>MS12-050</strong></a></td>
<td style="border:1px solid black;">Vulnerabilidade de script do SharePoint em nome de usuário</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-050"><strong>MS12-050</strong></a></td>
<td style="border:1px solid black;">Vulnerabilidade de reflexão de parâmetros de lista no SharePoint</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-051"><strong>MS12-051</strong></a></td>
<td style="border:1px solid black;">Vulnerabilidade de permissões de pasta imprópria no Office for Mac</td>
...
<td style="border:1px solid black;">
[**MS12-043**](http://technet.microsoft.com/pt-br/security/bulletin/ms12-043)
</td>
<td style="border:1px solid black;">
[**MS12-044**](http://technet.microsoft.com/pt-br/security/bulletin/ms12-044)
</td>
<td style="border:1px solid black;">
[**MS12-045**](http://technet.microsoft.com/pt-br/security/bulletin/ms12-045)
</td>
<td style="border:1px solid black;">
[**MS12-047**](http://technet.microsoft.com/pt-br/security/bulletin/ms12-047)
</td>
<td style="border:1px solid black;">
[**MS12-048**](http://technet.microsoft.com/pt-br/security/bulletin/ms12-048)
</td>
<td style="border:1px solid black;">
[**MS12-049**](http://technet.microsoft.com/pt-br/security/bulletin/ms12-049)
</td>
</tr>
...
<td style="border:1px solid black;">
[Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=60c57c8b-6d56-42de-ab1e-e4e3258c7818)  
(KB2718523)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=563399b3-cb19-40e9-ba9d-0079032c8cee)  
(KB2691442)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=b91df558-5446-4858-92af-50cfbab27ff5)  
(KB2655992)  
(Importante)
</td>
</tr>
...
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8e1a27c9-6495-4030-8a46-264afd78a5a1)  
(KB2718523)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d49e3e7e-910a-4069-b0b0-0987bb9fdde2)  
(KB2691442)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8a5f6e84-5e5b-42c3-a5b7-65defdb0665f)  
(KB2655992)  
(Importante)
</td>
</tr>
...
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=76f640b8-5aab-4880-9d74-22e2a5086342)  
(KB2718523)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ca890b4d-124f-4293-b8d0-69f6302b5189)  
(KB2691442)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e886c5f4-7f38-4c90-905b-a682e6a8ffd0)  
(KB2655992)  
(Importante)
</td>
</tr>
...
<td style="border:1px solid black;">
[Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=3efb0de1-252b-4b72-86f3-e747f8fa2229)  
(KB2718523)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=f518f273-b3b9-4cbf-b820-05a1adc79342)  
(KB2691442)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=07518fb7-031f-4fa0-836c-8f33c247868b)  
(KB2655992)  
(Importante)
</td>
</tr>
...
<td style="border:1px solid black;">
[Windows 7 para Sistemas Service Pack 1 baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=3efb0de1-252b-4b72-86f3-e747f8fa2229)  
(KB2718523)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows 7 para Sistemas Service Pack 1 baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=f518f273-b3b9-4cbf-b820-05a1adc79342)  
(KB2691442)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows 7 para Sistemas Service Pack 1 baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=07518fb7-031f-4fa0-836c-8f33c247868b)  
(KB2655992)  
(Importante)
</td>
</tr>
...
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087)  
(KB2718523)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=d16fa6b9-43aa-4d0f-a230-52664e972ab9)  
(KB2691442)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=c9ef728f-abef-4076-bb13-7488af471aa4)  
(KB2655992)  
(Importante)
</td>
</tr>
...
<td style="border:1px solid black;">
[Windows Server 2008 R2 para Sistemas Service Pack 1 baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087)  
(KB2718523)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para Sistemas Service Pack 1 baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=d16fa6b9-43aa-4d0f-a230-52664e972ab9)  
(KB2691442)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para Sistemas Service Pack 1 baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=c9ef728f-abef-4076-bb13-7488af471aa4)  
(KB2655992)  
(Importante)
</td>
</tr>
...
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=772f2975-065d-44f3-adf8-82188bd43196)  
(KB2718523)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=c9c3b471-4a81-4a44-93ad-674650454c53)  
(KB2691442)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=49e182b5-4499-42a1-8180-9bb920e154cb)  
(KB2655992)  
(Importante)
</td>
</tr>
...
<td style="border:1px solid black;">
[Windows Server 2008 R2 para Sistemas Service Pack 1 baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=772f2975-065d-44f3-adf8-82188bd43196)  
(KB2718523)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para Sistemas Service Pack 1 baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=c9c3b471-4a81-4a44-93ad-674650454c53)  
(KB2691442)  
(Importante)
</td>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para Sistemas Service Pack 1 baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=49e182b5-4499-42a1-8180-9bb920e154cb)  
(KB2655992)  
(Importante)
</td>
</tr>
...
<td style="border:1px solid black;">
[**MS12-046**](http://technet.microsoft.com/pt-br/security/bulletin/ms12-046)
</td>
<td style="border:1px solid black;">
[**MS12-050**](http://technet.microsoft.com/pt-br/security/bulletin/ms12-050)
</td>
<td style="border:1px solid black;">
[**MS12-051**](http://technet.microsoft.com/pt-br/security/bulletin/ms12-051)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Office 2010 (edições de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=a7cc8fdc-1c64-434f-87a6-72ddcc356654)  
(KB2598243)  
(Importante)  
[Microsoft Office 2010 (edições de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=3050c06c-3cfc-4ce7-83cd-017d0922d597)  
(KB2553447)  
(Importante)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Office 2010 Service Pack 1 (edições de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=a7cc8fdc-1c64-434f-87a6-72ddcc356654)  
(KB2598243)  
(Importante)  
[Microsoft Office 2010 Service Pack 1 (edições de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=3050c06c-3cfc-4ce7-83cd-017d0922d597)  
(KB2553447)  
(Importante)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Office 2010 (64-bit editions)](http://www.microsoft.com/downloads/details.aspx?familyid=ab442918-8184-4c7c-84b0-5a3635fdb005)  
(KB2598243)  
(Importante)  
[Microsoft Office 2010 (64-bit editions)](http://www.microsoft.com/downloads/details.aspx?familyid=0a8af868-abf7-4aeb-813a-418a04b31608)  
(KB2553447)  
(Importante)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Office 2010 Service Pack 1 (edições de 64 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=ab442918-8184-4c7c-84b0-5a3635fdb005)  
(KB2598243)  
(Importante)  
[Microsoft Office 2010 Service Pack 1 (edições de 64 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=0a8af868-abf7-4aeb-813a-418a04b31608)  
(KB2553447)  
(Importante)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft InfoPath 2010 (edições de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=698e6369-253b-4dbe-b6cd-7ea5ea09e043)  
(KB2553431)  
(Importante)  
[Microsoft InfoPath 2010 (edições de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=036b2482-0fb4-46f0-9c38-8bae6d0d669b)  
(KB2553322)  
(Importante)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft InfoPath 2010 Service Pack 1 (edições de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=698e6369-253b-4dbe-b6cd-7ea5ea09e043)  
(KB2553431)  
(Importante)  
[Microsoft InfoPath 2010 Service Pack 1 (edições de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=036b2482-0fb4-46f0-9c38-8bae6d0d669b)  
(KB2553322)  
(Importante)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft InfoPath 2010 (edições de 64 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=3bf373aa-b4ad-4e1a-9578-800485ece148)  
(KB2553431)  
(Importante)  
[Microsoft InfoPath 2010 (edições de 64 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=e24337cb-83b4-424f-bc4d-0d43437228a2)  
(KB2553322)  
(Importante)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft InfoPath 2010 Service Pack 1 (edições de 64 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=3bf373aa-b4ad-4e1a-9578-800485ece148)  
(KB2553431)  
(Importante)  
[Microsoft InfoPath 2010 Service Pack 1 (edições de 64 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=e24337cb-83b4-424f-bc4d-0d43437228a2)  
(KB2553322)  
(Importante)
</td>
<td style="border:1px solid black;">
...
**Observações para o MS12-046**

Consulte também outras categorias de software nesta seção, **Softwares afetados e locais de download**, para obter mais arquivos de atualização com o mesmo identificador de boletim. Este boletim abrange mais de uma categoria de software.

<sup>[1]</sup>Estas atualizações para o Microsoft Office aplicam-se a todos os Microsoft Office Suites com suporte e outros softwares Microsoft Office que contenham o componente Office compartilhado vulnerável. Incluem, sem limitação, versões com suporte do Microsoft Visio e Microsoft Project.

**Observação para o MS12-050**
...
(KB2596663)  
(Importante)  
[Microsoft Office SharePoint Server 2007 Service Pack 2 (xlsrvwfe) (edições de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=d9091923-67c7-4535-b44c-40a5292a94d9)<sup>[1]</sup>
(KB2596942)  
(Importante)
</td>
</tr>
...
(KB2596663)  
(Importante)  
[Microsoft Office SharePoint Server 2007 Service Pack 3 (xlsrvwfe) (edições de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=d9091923-67c7-4535-b44c-40a5292a94d9)<sup>[1]</sup>
(KB2596942)  
(Importante)
</td>
</tr>
...
(KB2596663)  
(Importante)  
[Microsoft Office SharePoint Server 2007 Service Pack 2 (xlsrvwfe) (edições de 64 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=723a5553-8610-49bf-99c0-bd94926bdc0b)<sup>[1]</sup>
(KB2596942)  
(Importante)
</td>
</tr>
...
**Observação para oMS12-043**

Consulte também outras categorias de software nesta seção, **Softwares afetados e locais de download**, para obter mais arquivos de atualização com o mesmo identificador de boletim. Este boletim abrange mais de uma categoria de software.

**Observações para o MS12-050**
...
<sup>[3]</sup>A versão atualizada do Visual Basic for Applications SDK que elimina a vulnerabilidade descrita neste boletim está disponível para fornecedores de software independentes (ISVs) junto à Summit Software Company.
...
-   A [Google Security Team](http://www.google.com/), por trabalhar conosco em um problema descrito no boletim MS12-043.
-   [Qihoo 360 Security Center](http://www.360.cn/)
-   por relatar um problema descrito no MS12-043
-   Jose A. Vazquez, do spa-s3c.blogspot.com, que trabalha com a [VeriSign iDefense Labs](http://labs.idefense.com/), por relatar um problema descrito no MS12-044
-   Omair, que trabalha com a [VeriSign iDefense Labs](http://labs.idefense.com/), por relatar um problema descrito no boletim MS12-044
-   Um pesquisador anônimo, que trabalha na [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/), por relatar um problema descrito no boletim MS12-045
-   Bai Haowen da [Huawei Security Labs](http://www.huawei.com), por relatar um problema descrito no MS12-046
-   Nicolas Economou, da [Core Security Technologies](http://www.coresecurity.com/), por relatar um problema descrito no boletim MS12-047
-   [Qihoo 360 Security Center](http://www.360.cn/)
-   por relatar um problema descrito no MS12-047
-   Lufeng Li, da Neusoft Corporation, que trabalha em parceria com a [Secunia Research](http://secunia.com/), por relatar um problema descrito no boletim MS12-047
-   Adi Cohen, da [IBM Security Systems - Application Security](http://blog.watchfire.com/), por relatar um problema descrito no MS12-048
-   Adi Cohen, da [IBM Security Systems - Application Security](http://blog.watchfire.com/), por relatar um problema descrito no MS12-050
-   Yang Yang da [Equipe de segurança de produto do Salesforce.com](https://trust.salesforce.com/), por relatar um problema descrito no MS12-050
...
-   V1.0 (10 de julho de 2012): Resumo de boletins publicado.
-   V1.1 (10 de julho de 2012): Removido o CVE-2012-1860 do índice de exploração porque a vulnerabilidade tem uma classificação de gravidade Moderada. Só são incluídas no índice de exploração as vulnerabilidades com uma classificação de gravidade Crítica ou Importante nos boletins.
-   V2.0 (15 de agosto de 2012): Para MS12-043, adicionados links para download do Microsoft XML Core Services 5.0.
-   V3.0 (9 de outubro de 2012): No MS12-043, em relação a softwares afetados, adicionado o Microsoft XML Core Services 4.0, quando instalado nas edições suportadas do Windows 8 e Windows Server 2012. Consulte o boletim MS12-043 para obter informações detalhadas.
-   V4.0 (13 de novembro de 2012): Para o MS12-046, substituída a atualização KB2598361 pela atualização KB2687626 no Microsoft Office 2003 Service Pack 3. Consulte o boletim MS12-046 para detalhes.
-   V5.0 (11 de dezembro de 2012): No MS12-043, atualização do KB2687324 substituída pela do KB2687627 no Microsoft XML Core Services 5.0 quando instalado no Microsoft Office 2003 Service Pack 3, e KB2596679 substituída pela do KB2687497 no Microsoft XML Core Services 5.0 quando instalado com todas as edições afetadas do Microsoft Groove 2007, Microsoft Groove Server 2007 e Microsoft Office SharePoint Server 2007. Confira o boletim MS12-043 para obter detalhes.
-   V5.1 (12 de dezembro de 2012): Referente ao MS12-050, revisado o resumo do boletim para anunciar a disponibilidade de uma atualização para o Microsoft Windows SharePoint Services 2.0. Essa atualização está disponível somente no Centro de Download da Microsoft.
