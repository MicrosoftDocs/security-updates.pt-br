...
<a href="https://support.microsoft.com/pt-br/kb/3097877">3097877</a></td>
<td style="border:1px solid black;">Microsoft Windows</td>
</tr>
<tr class="even">
...
</strong>Esta atualização de segurança resolve uma vulnerabilidade no Microsoft Windows. A vulnerabilidade poderá permitir a elevação de privilégio se um atacante se conectar a um sistema destino e executar código especialmente criado para explorar a vulnerabilidade.</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/gg309177.aspx">Importante</a> <br />
Elevação de privilégio</td>
<td style="border:1px solid black;">Exige reinicialização</td>
<td style="border:1px solid black;">---------</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/pt-br/library/security/ms15-114">MS15-114</a></td>
<td style="border:1px solid black;">Vulnerabilidade de Estouro de Heap de Diário do Windows</td>
...
<td style="border:1px solid black;">
[**MS15-116**](https://technet.microsoft.com/pt-br/library/security/ms15-116)
...
(3085552)  
(Importante)  
Service Pack 3 do Microsoft Office 2007 IME (japonês)  
(2899473)  
(Importante)
...
(3085594)  
(Importante)  
Microsoft Project 2010 Service Pack 2 (edições de 32 bits)  
(3085614)  
(Importante)  
...
(3085594)  
(Importante)  
Microsoft Project 2010 Service Pack 2 (edições de 64 bits)  
(3085614)  
(Importante)  
...
(3101360)  
(Importante)  
Microsoft Access 2013 Service Pack 1 (edições de 32 bits)  
(3085584)  
(Importante)  
...
(3101359)  
(Importante)  
Microsoft Project 2013 Service Pack 1 (edições de 32 bits)  
(3101506)  
(Importante)  
Microsoft Publisher 2013 Service Pack 1 (edições de 32 bits)  
(3085561)  
(Importante)  
...
(3101360)  
(Importante)  
Microsoft Access 2013 Service Pack 1 (edições de 64 bits)  
(3085584)  
(Importante)  
...
(3101359)  
(Importante)  
Microsoft Project 2013 Service Pack 1 (edições de 64 bits)  
(3101506)  
(Importante)  
Microsoft Publisher 2013 Service Pack 1 (edições de 64 bits)  
(3085561)  
(Importante)  
...
(3101514)  
(Importante)  
Microsoft Access 2016 (edição de 32 bits)  
(2910978)  
(Importante)  
...
(3101509)  
(Importante)  
Microsoft Project 2016 (Edição de 32 bits)  
(2920698)  
(Importante)  
Microsoft Publisher 2016 (edição de 32 bits)  
(2920680)  
(Importante)  
...
(3101514)  
(Importante)  
Microsoft Access 2016 (edição de 64 bits)  
(2910978)  
(Importante)  
...
(3101509)  
(Importante)  
Microsoft Project 2016 (Edição de 64 bits)  
(2920698)  
(Importante)  
Microsoft Publisher 2016 (edição de 64 bits)  
(2920680)  
(Importante)  
...
<tr>
<td style="border:1px solid black;" colspan="3">
**Sistema de Sala Inteligente Microsoft Lync**
...
<td style="border:1px solid black;">
[**MS15-123**](https://technet.microsoft.com/pt-br/library/security/ms15-123)
...
-   V1.0 (10 de novembro de 2015): Resumo do boletim publicado.
-   V1.1 (11.11.15): Para o MS15-115, adicionado um problema conhecido para KB3097877. A Microsoft está analisando os relatórios de falhas de alguns clientes que ocorrem quando eles visualizam alguns e-mails depois que a atualização de segurança do Windows 3097877 é instalada. Uma revisão imediata está em andamento.
-   V2.0 (9 de dezembro de 2015): Para MS15-115, o [Artigo 3097877 da Base de Dados de Conhecimento Microsoft](https://support.microsoft.com/pt-br/kb/3097877) foi atualizado para informar aos clientes que a atualização 3097877 para Windows 7 e Windows Server 2008 R2 foi relançada para corrigir um problema na atualização original que poderia fazer com que alguns aplicativos terminassem inesperadamente. Os clientes que já instalaram a atualização nos sistemas Windows 7 ou Windows Server 2008 R2 devem reinstalar a atualização.
-   V2.1 (9 de dezembro de 2015): Para MS15-122, Sinopse revisada para remover a referência ao requisito de que um atacante tenha acesso físico à máquina alvo para explorar o CVE-2015-6095. Esta alteração é somente para fins de informação. Não há mais nenhuma ação para os clientes que já instalaram esta atualização com êxito.
-   V2.2 (17/12/2015): Resumo do boletim revisado para incluir um problema conhecido na tabela Sinopse para MS15-116 e MS15-123. Depois que você instala a atualização de segurança 3101496, o "Lync" é exibido na barra de títulos da lista Contatos. Esse problema ocorre se você configura a interface de usuário do Skype for Business para ser exibida no cliente do Lync 2013 (Skype for Business). A Microsoft está pesquisando esse problema e publicará mais informações neste artigo assim que elas estiverem disponíveis.
-   V3.0 (9 de fevereiro de 2016): Para o MS15-118, Resumo de Boletim revisado para anunciar o relançamento da atualização 3098785 para tratar os problemas conhecidos discutidos no [artigo 3318750 da Base de Dados de Conhecimento da Microsoft](https://support.microsoft.com/pt-br/kb/3318750), que clientes que estejam executando o Windows 8.1, o Windows RT ou o Windows Server 2012 R2 possam ter experimentado após a instalação do .NET Framework 4.6 em um computador que já tenha uma versão totalmente atualizada do .NET Framework 4.5.x. A Microsoft recomenda que os clientes busquem novas atualizações para download e instalem a atualização 3098785 relançada. Para saber mais, veja o [artigo 3318750 da Base de Dados de Conhecimento da Microsoft](https://support.microsoft.com/pt-br/kb/3318750).

*Página gerada em 08-02-2016 17:24-08:00.*
