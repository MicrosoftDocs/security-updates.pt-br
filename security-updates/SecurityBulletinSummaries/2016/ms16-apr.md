...
-   V4.0 (12 de setembro de 2017): Para a MS16-039, revisão da tabela de softwares afetados de Sistemas Operacionais e Componentes Windows para incluir o Windows 10 Versão 1703 para sistemas de 32 bits e o Windows 10 Versão 1703 para sistemas com base em x64, pois eles são afetados pela CVE-2016-0165. A Microsoft recomenda que os clientes que executam o Windows 10 Versão 1703 instalem a atualização 4038788 para ficarem protegidos contra essa vulnerabilidade.
