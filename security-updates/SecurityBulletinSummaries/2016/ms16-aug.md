...
<td style="border:1px solid black;"><strong>Atualização de segurança para biblioteca de PDF do Microsoft Windows (3182248)</strong><br />
...
<tr>
<td style="border:1px solid black;" colspan="5">
[**MS16-101: Atualização de segurança para métodos de autenticação do Windows (3178465)**](http://go.microsoft.com/fwlink/?linkid=821576)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;" colspan="5">
[**MS16-103: Atualização de segurança para ActiveSyncProvider (3182332)**](http://go.microsoft.com/fwlink/?linkid=823241)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   V1.0 ([terça-feira, 9 de agosto de 2016](https://technet.microsoft.com/pt-BR/library/bulletin+summary_publisheddate(v=Security.10))): Resumo do boletim publicado.
-   V1.1 ([10 de agosto de 2016](https://technet.microsoft.com/pt-BR/library/bulletin+summary_publisheddate(v=Security.10))): Para o MS16-101, Resumo de Boletins revisado para corrigir o impacto de segurança da CVE-2016-3237 de elevação de privilégio para bypass de recurso de segurança. Esta é apenas uma alteração informativa. Não há mais nenhuma ação para os clientes que já instalaram esta atualização com êxito.
-   V1.2 (11 de agosto de 2016): Para o MS16-102, Resumo de Boletins revisado para remover o Windows Server 2012 R2 (instalação Server Core) da tabela de softwares afetados, pois a versão Server Core do Windows Server 2012 R2 não foi afetada. Estas são alterações apenas para fins informativos. Não há mais nenhuma ação para os clientes que já instalaram esta atualização com êxito.
-   V1.3 (12 de agosto de 2016): Para o MS16-102, Resumo de Boletins revisado para remover o Windows 10 versão 1607 da tabela de softwares afetados, pois ele não foi afetado. Esta é apenas uma alteração informativa. Não há mais nenhuma ação para os clientes que já instalaram esta atualização com êxito.
-   V1.4 (18 de agosto de 2016): Para o MS16-095, o MS16-096, o MS16-097, o MS16-098, o MS16-101, o MS16-102 e o MS16-103, Resumo de Boletins revisado para adicionar referências de Problemas conhecidos à tabela de Resumos Executivos. Veja os artigos relevantes da Base de Dados de Conhecimento para obter mais informações.
...
-   V3.0 (12 de setembro de 2017): Para a MS16-095, revisão da tabela de softwares afetados de Sistemas Operacionais e Componentes Windows para incluir o Internet Explorer 11 instalado no Windows 10 Versão 1703 para sistemas de 32 bits e o Internet Explorer 11 instalado no Windows 10 Versão 1703 para sistemas com base em x64, pois eles são afetados pela CVE-2016-3326. A Microsoft recomenda que os clientes que executam o Internet Explorer no Windows 10 Versão 1703 instalem a atualização 4038788 para ficarem protegidos contra essa vulnerabilidade.


*Página gerada em 2017-06-15 15:52-07:00.*
