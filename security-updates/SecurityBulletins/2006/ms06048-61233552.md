---
TOCTitle: 'MS06-048'
Title: 'Microsoft  MS06-048 - Crítica'
ms:assetid: 'ms06-048'
ms:contentKeyID: 61233552
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms06-048(v=Security.10)'
---



Microsoft  MS06-048 - Crítica
==============================================

Vulnerabilidades no Microsoft Office podem permitir a execução remota de código (922968)
----------------------------------------------------------------------------------------

Publicado: terça-feira, 8 de agosto de 2006 | Atualizado: quarta-feira, 11 de outubro de 2006
...
-   Microsoft Office 2000 Service Pack 3 – [Baixar a atualização (KB921568)](http://www.microsoft.com/downloads/details.aspx?familyid=b7b5615b-7c20-4c49-892f-7f4ccc2d6006)
    -   Microsoft PowerPoint 2000
-   Microsoft Office XP Service Pack 3 – [Baixar a atualização (KB921567)](http://www.microsoft.com/downloads/details.aspx?familyid=a9c7e43b-a0a6-4c81-87ed-3f4ded78eaea)
    -   Microsoft PowerPoint 2002
-   Microsoft Office 2003 Service Pack 1 ou Service Pack 2 - [Baixar a atualização (KB921566)](http://www.microsoft.com/downloads/details.aspx?familyid=de1cb2a7-5d4c-44b8-bc40-7e0a88cc3081)
    -   O Microsoft Office PowerPoint 2003
-   Microsoft Office 2004 para Mac - [Baixar a atualização (KB923151)](http://www.microsoft.com/mac)
    -   PowerPoint 2004 para Mac
-   Microsoft Office v. X para Mac - [Baixar a atualização (KB923148)](http://www.microsoft.com/mac)
...
<span></span>
Esta atualização elimina duas vulnerabilidades públicas descobertas recentemente e reportadas em particular. Cada vulnerabilidade está documentada neste boletim em sua própria seção “Detalhes da vulnerabilidade”.
...
| Identificadores de Vulnerabilidade                                                                                                                  | Impacto da Vulnerabilidade | Microsoft PowerPoint 2000 | Microsoft PowerPoint XP | Microsoft PowerPoint 2003 | Microsoft PowerPoint 2004 para Mac ou Microsoft PowerPoint v. X para Mac |
|-----------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------|-------------------------|---------------------------|--------------------------------------------------------------------------|
| Vulnerabilidade de Mso.DLL do Microsoft PowerPoint - [CVE-2006-3590](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3590)               | Execução Remota de Código  | Crítica                   | Importante              | Importante                | Importante                                                               |
| Vulnerabilidade de Registros malformados no Microsoft PowerPoint - [CVE-2006-3449](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3449) | Execução Remota de Código  | Crítica                   | Importante              | Importante                | Importante                                                               |
...
<span></span>
**O boletim é intitulado “Vulnerabilidade no Microsoft Office pode permitir a execução remota de código”, mas a seção “Software afetado” apresenta somente o PowerPoint. Por quê?**  
A vulnerabilidade existe em um binário compartilhado por vários produtos do Office. No entanto, o problema é específico sobre como o Powerpoint usa o binário compartilhado.
...
| ID do Boletim                                                           | Microsoft PowerPoint 2000 | Microsoft PowerPoint XP | Microsoft PowerPoint 2003 | Microsoft PowerPoint 2004 para Mac ou Microsoft PowerPoint v. X para Mac |
|-------------------------------------------------------------------------|---------------------------|-------------------------|---------------------------|--------------------------------------------------------------------------|
...
<span></span>
#### Vulnerabilidade de Mso.DLL do Microsoft PowerPoint - CVE-2006-3590

Existe uma vulnerabilidade de execução remota de código no Powerpoint que pode ser explorada quando o PowerPoint analisa um arquivo que contém um recipiente de forma malformado. É possível incluir tal arquivo em um anexo de email ou hospedá-lo em um site mal-intencionado. Um invasor pode explorar essa vulnerabilidade criando um arquivo do PowerPoint especialmente desenvolvido para permitir a execução remota de código.
...
#### Fatores atenuantes da vulnerabilidade do Microsoft PowerPoint Mso.dll - CVE-2006-3590
...
**Observação** Os arquivos do PowerPoint 2000 não solicitam que o usuário responda com **Abrir**, **Salvar** ou **Cancelar** antes de abrir um documento.

#### Soluções alternativas para a vulnerabilidade do Microsoft PowerPoint Mso.dll - CVE-2006-3590:
...
#### Perguntas freqüentes sobre a vulnerabilidade do Microsoft PowerPoint Mso.dll - CVE-2006-3590:
...
A vulnerabilidade ocorre quando o Powerpoint abre um arquivo do Powerpoint especialmente criado e analisa uma forma malformada.
...
A atualização elimina a vulnerabilidade por alterar o modo como o PowerPoint analisa o tamanho de um registro antes de transmitir a mensagem para o buffer alocado.
...
Sim. Esta atualização de segurança aborda a vulnerabilidade. A vulnerabilidade tratada recebeu o número CAN-2006-3590 da lista Common Vulnerability and Exposure, tendo sido descrita anteriormente no Comunicado de Segurança da Microsoft [922970](http://technet.microsoft.com/security/advisory/922970).

#### Vulnerabilidade de registros malformados no Microsoft PowerPoint - CVE-2006-3449

Existe uma vulnerabilidade de execução remota de código no Powerpoint que pode ser explorada quando o PowerPoint analisa um arquivo que contém um registro malformado. É possível incluir tal arquivo em um anexo de email ou hospedá-lo em um site mal-intencionado. Um invasor pode explorar essa vulnerabilidade criando um arquivo do PowerPoint especialmente desenvolvido para permitir a execução remota de código.

Se um usuário tiver feito logon com direitos administrativos, o invasor que explorar com êxito essa vulnerabilidade poderá obter o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

#### Fatores atenuantes da vulnerabilidade de um registro malformado do PowerPoint - CVE-2006-3449

-   O invasor que explorar com êxito a vulnerabilidade poderá obter os mesmos direitos que o usuário local. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
-   No Outlook 2002 e no Outlook 2003, a vulnerabilidade não pode ser explorada automaticamente por email. Um usuário teria que clicar em um anexo, admitir um aviso e aceitar uma solicitação para **Abrir** o anexo, antes da vulnerabilidade poder ser explorada.
-   No cenário de ataque na Web, o invasor terá que hospedar um site contendo uma página da Web usada para explorar essa vulnerabilidade. Além disso, sites comprometidos e sites que aceitem ou hospedem conteúdo fornecido pelo usuário ou anúncios pode conter conteúdo especialmente desenvolvido que pode explorar esta vulnerabilidade. Em todos os casos, entretanto, um invasor não teria como forçar os usuários a visitarem os sites. Em vez disso, um invasor teria que persuadir os usuários a visitar o site, geralmente fazendo com que eles cliquem em um link em um email ou por um pedido pelo Instant Messenger que leva os usuários ao site do invasor.

**Observação** Os arquivos do Office 2000 não solicitam que o usuário responda com **Abrir**, **Salvar** ou **Cancelar** antes de abrir um documento.

#### Soluções alternativas para a vulnerabilidade de um registro malformado do PowerPoint - CVE-2006-3449:
...
#### Perguntas freqüentes sobre a vulnerabilidade de um registro malformado do PowerPoint - CVE-2006-3449:
...
**O que provoca a vulnerabilidade?**  
A vulnerabilidade ocorre quando o Powerpoint abre um arquivo do Powerpoint especialmente criado e analisa um registro malformado.
...
1.  Baixar a atualização de segurança.
...
| Mso.dll         | 11.0.8036.0 | 15 de julho de 2006 | 02:02 | 12.256.008 |
...
| Produto           | Recurso      |
|-------------------|--------------|
| O PowerPoint 2003 | ProductFiles |
...
1.  Baixe esta atualização de segurança para o Office XP.
2.  Clique em **Salvar este programa em disco** e, em seguida, clique em **OK**.
3.  Clique em **Salvar**.
4.  Usando o Windows Explorer, navegue até a pasta que contém o arquivo salvo e clique duas vezes nele.
5.  Se for solicitada a instalação da atualização, clique em **Sim**.
...
| Mso.dll         | 10.0.6811.0 | 15 de julho de 2006    | 03:20 | 9.816.840 |
...
1.  Baixe esta atualização de segurança para Office 2000.
2.  Clique em **Salvar este programa em disco** e, em seguida, clique em **OK**.
3.  Clique em **Salvar**.
4.  Usando o Windows Explorer, navegue até a pasta que contém o arquivo salvo e clique duas vezes nele.
5.  Se for solicitada a instalação da atualização, clique em **Sim**.
...
| Nome do arquivo | Versão     | Data                | Hora  | Tamanho   |
|-----------------|------------|---------------------|-------|-----------|
| Mso9.dll        | 9.0.0.8948 | 20 de julho de 2006 | 10:25 | 5.595.185 |
...
2.  Abra o volume **Microsoft Office 2004 for Mac 11.2.6 Security Update** na área de trabalho. Esta etapa pode ter sido executada para você.
3.  Para começar o processo de atualização, na janela do volume **Microsoft Office 2004 for Mac 11.2.6 Security Update**, clique duas vezes no aplicativo **Microsoft Office 2004 for Mac 11.2.6 Security Update** e siga as instruções na tela.
4.  Se a instalação tiver êxito, você poderá remover o instalador da atualização de seu disco rígido. Para verificar se a instalação foi concluída com êxito, consulte a seção “Verificando a instalação da atualização”. Para remover o instalador da atualização, arraste o volume **Microsoft Office 2004 for Mac 11.2.6 Security Update** para a Lixeira e arraste também o arquivo que você baixou para a Lixeira.
...
Se o número da versão for **11.2.6**, a atualização foi instalada com sucesso.
...
2.  Abra o volume **Microsoft Office v. X for Mac 10.1.8 Security Update** na área de trabalho. Esta etapa pode ter sido executada para você.
...
2.  Selecione o arquivo **Microsoft Office X**.
3.  No menu **Arquivo**, clique em **Obter Informações** ou em **Mostrar Informações**.

Se o número da versão for **10.0.0 (060718)**, a atualização foi instalada com sucesso.
...
-   Elia Florio da [Symantec](http://www.symantec.com/index.htm) por relatar a vulnerabilidade de Mso.dll do Microsoft PowerPoint - [CVE-2006- 3590](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3590)
-   Dejun Meng do Fortinet Security Research Team por relatar a vulnerabilidade de Mso.dll do Microsoft PowerPoint - [CVE-2006-3590](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3590)
-   Shih-hao Weng do [Information & Communication Security Technology Center](http://www.icst.org.tw/) por relatar a vulnerabilidade de Mso.dll do Microsoft PowerPoint - [CVE-2006- 3590](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3590)
-   SoWhat do [Nevis Labs](http://www.nevisnetworks.com) por relatar a vulnerabilidade de registros malformados no Microsoft PowerPoint - [CVE-2006-3449](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3449)
...
-   V1.1 (11 de outubro de 2006): Boletim atualizado para oferecer esclarecimento adicional sobre “Verificando a instalação da atualização” para Office 2004 para Mac e Office v. X para Mac na seção “Informações de atualização de segurança”.
