...
ms:assetid: 'ms06-059'
ms:contentKeyID: 61233563
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms06-059(v=Security.10)'
---
...
Publicado: terça-feira, 10 de outubro de 2006 | Atualizado: terça-feira, 12 de dezembro de 2006
...
-   Microsoft Office 2000 Service Pack 3
    -   Microsoft Excel 2000 - [Fazer o download da atualização (KB923090)](http://www.microsoft.com/downloads/details.aspx?familyid=a4b2a672-481b-4af6-89fe-de8d321d99e0)
-   Microsoft Office XP Service Pack 3
    -   Microsoft Excel 2002 - [Fazer o download da atualização (KB923089)](http://www.microsoft.com/downloads/details.aspx?familyid=d86620e8-c77a-45a9-9ff3-0a6aaf308984)
-   Microsoft Office 2003 Service Pack 1 ou Service Pack 2
    -   Microsoft Excel 2003 - [Fazer o download da atualização (KB923088)](http://www.microsoft.com/downloads/details.aspx?familyid=a81a8537-e2b0-4629-8973-40c4f32d9728)
    -   Microsoft Office Excel Viewer 2003 - [Fazer o download da atualização (KB923275)](http://www.microsoft.com/downloads/details.aspx?familyid=74c72657-634d-4c31-a366-c68043fe3b34)
-   Microsoft Office 2004 para Mac
    -   Microsoft Excel 2004 para Mac - [Fazer o download da atualização (KB924999)](http://www.microsoft.com/mac/)
-   Microsoft Office v. X para Mac
    -   Microsoft Excel v. X para Mac - [Fazer o download da atualização (KB924998)](http://www.microsoft.com/mac/)
-   Microsoft Works Suites:
    -   Microsoft Works Suite 2004 - [Fazer o download da atualização (KB923089)](http://www.microsoft.com/downloads/details.aspx?familyid=d86620e8-c77a-45a9-9ff3-0a6aaf308984) (idêntica à atualização do Microsoft Excel 2002)
    -   Microsoft Works Suite 2005 - [Fazer o download da atualização (KB923089)](http://www.microsoft.com/downloads/details.aspx?familyid=d86620e8-c77a-45a9-9ff3-0a6aaf308984) (idêntica à atualização do Microsoft Excel 2002)
    -   Microsoft Works Suite 2006 - [Fazer o download da atualização (KB923089)](http://www.microsoft.com/downloads/details.aspx?familyid=d86620e8-c77a-45a9-9ff3-0a6aaf308984) (idêntica à atualização do Microsoft Excel 2002)
...
|------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------|----------------------|------------------------------------------|----------------------------------------------------|
| Vulnerabilidade de registro DATETIME malformado do Excel - [CVE-2006-2387](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2387)          | Execução Remota de Código  | Crítica              | Importante           | Importante                               | Importante                                         |
| Vulnerabilidade de registro STYLE malformado do Excel - [CVE-2006-3431](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3431)             | Execução Remota de Código  | Crítica              | Importante           | Importante                               | Importante                                         |
| Vulnerabilidade da manipulação de arquivos Lotus 1-2-3 pelo Excel - [CVE-2006-3867](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3867) | Execução Remota de Código  | Crítica              | Importante           | Importante                               | Importante                                         |
| Vulnerabilidade de registro COLINFO malformado do Excel - [CVE-2006-3875](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3875)           | Execução Remota de Código  | Crítica              | Importante           | Importante                               | Importante                                         |
...
A Microsoft atualizou este boletim e as atualizações de segurança associadas a fim de abordar os problemas identificados no [Artigo 924164 (em inglês) da Base de Conhecimento Microsoft](http://support.microsoft.com/kb/924164) que afetam o Microsoft Excel 2002.
...
|------------------------------------------------------------------------------------------|----------------------|----------------------|------------------------------------------|----------------------------------------------------|
| [**MS06-037**](http://www.microsoft.com/brasil/technet/seguranca/bulletin/ms06-037.mspx) | Substituído          | Substituído          | Substituído                              | Substituído                                        |
...
Para obter informações mais detalhadas sobre as diretrizes para detecção e implantação, consulte o [Artigo 910723 da Base de Conhecimento Microsoft](http://support.microsoft.com/kb/910723).
...
-   Não abra nem salve arquivos do Microsoft Excel recebidos de fontes não confiáveis ou recebidos inesperadamente de fontes confiáveis. Essa vulnerabilidade pode ser explorada quando o usuário abre um arquivo especialmente criado.
-   Baixe e execute a [ferramenta "Office 2003 Add-in: Desktop Language Settings"](http://www.microsoft.com/downloads/details.aspx?familyid=cc37e08c-1019-4ae8-a258-0d5412876dec&displaylang=en&hash=d46v6q7) para altear as configurações de idioma definidas para o Office.
-   **Modifique o valor de "InstallLanguage" para caracteres que não sejam de dois bytes (DBCS)**
    ...
    **Observação** Anote as permissões que estão relacionadas na caixa de diálogo para que possa restaurá-las aos seus valores originais mais tarde
    ...
    2.  Expanda **HKEY\_CURRENT\_USER** e as seguintes subchaves: **Software, Microsoft, Office**, **11.0, Comum**.
    ...
    **Observação** Para obter uma lista de outros IDs de idiomas, consulte o [Artigo 324097 (em inglês) da Knowledge Base](http://support.microsoft.com/?id=324097).
...
1.  [Baixe a atualização de segurança para Excel 2000](http://download.microsoft.com/download/3/6/d/36d75630-5526-404e-aea4-24fb5c8cce1f/office2000-kb923090-fullfile-enu.exe).
...
1.  [Baixe a atualização de segurança para Excel 2002](http://download.microsoft.com/download/6/e/4/6e483fd2-420f-45e2-9d21-e725f461c097/officexp-kb923089-v2-fullfile-enu.exe).
2.  Clique em **Salvar este programa em disco** e, em seguida, clique em **OK**.
3.  Clique em **Salvar**.
4.  Usando o Windows Explorer, navegue até a pasta que contém o arquivo salvo e clique duas vezes nele.
5.  Se for solicitada a instalação da atualização, clique em **Sim**.
...
1.  [Baixe a atualização de segurança para Excel 2003](http://download.microsoft.com/download/b/a/d/bada0a94-ed11-48ae-b2e2-1d52f6796370/office2003-kb923088-fullfile-enu.exe) e/ou [baixe a atualização de segurança para Excel 2003 Viewer](http://download.microsoft.com/download/2/2/e/22e6365d-2a66-4a8c-8867-06a723dc53cc/office2003-kb923275-fullfile-enu.exe)
2.  Clique em **Salvar este programa em disco** e, em seguida, clique em **OK**.
3.  Clique em **Salvar**.
4.  Usando o Windows Explorer, navegue até a pasta que contém o arquivo salvo e clique duas vezes nele.
5.  Se for solicitada a instalação da atualização, clique em **Sim**.
...
-   Manuel Santamarina Suarez, que trabalha na [Zero Day Initiative (ZDI)](http://www.zerodayinitiative.com/) e na [TippingPoint](http://www.tippingpoint.com/) por relatar a vulnerabilidade de saturação de análise do formato de arquivo do Excel - CVE-2006-2387.
-   [NSFocus Security Team](http://www.nsfocus.com/) por relatar a vulnerabilidade de registro COLINFO malformado do Excel - [CVE-2006-3875](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3875).
...
-   V2.0 (12 de dezembro de 2006): O boletim atualizado foi revisado e relançado para Microsoft Excel 2002 para abordar problemas identificados no [artigo 924164 (em inglês) da Base de Conhecimento Microsoft](http://support.microsoft.com/kb/924164).
