...
| Windows Vista e Windows Vista Service Pack 1                                                                                  | Consulte **Observação para WindowsVistae Windows Server 2008** abaixo |  
...
| Windows Vista para sistemas baseados no Itanium e Windows Vista para sistemas baseados no Itanium Service Pack 1              | Não     | Não                | Consulte **Observação para WindowsVistae Windows Server 2008** abaixo | Sim       |  
| Windows Server 2008                                                                                                           | Não     | Não                | Consulte **Observação para WindowsVistae Windows Server 2008** abaixo | Sim       |
