...
ms:assetid: 'ms08-034'
ms:contentKeyID: 61233777
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms08-034(v=Security.10)'
---
...
Vulnerabilidade no WINS pode permitir elevação de privilégio (948745)
---------------------------------------------------------------------
...
Esta atualização de segurança resolve uma vulnerabilidade relatada em particular no Serviço de Cadastramento na Internet do Windows (WINS) que pode permitir a elevação de privilégio. O invasor local que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. Um invasor poderá instalar programas, visualizar, alterar ou excluir dados, ou ainda criar novas contas.

Esta é uma atualização de segurança classificada como Importante para todas as versões com suporte do Microsoft Windows 2000 Server e Windows Server 2003. Para obter mais informações, consulte a subseção **Software afetado e não afetado** nesta seção.

A atualização elimina a vulnerabilidade, validando as estruturas de dados de pacotes de rede processados por WINS. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Server Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=aa8aa79f-c2cc-440c-9e5c-089143e6f814)                                                                                  | Elevação de privilégio     | Importante                      | [MS04-045](http://technet.microsoft.com/security/bulletin/ms04-045) |
| [Windows Server 2003 Service Pack 1 e Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=08fc90d5-23aa-4327-8aef-16bc5170769d)                                                       | Elevação de privilégio     | Importante                      | Nenhuma                                                             |
| [Windows Server 2003 x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=71675ae8-d60a-4834-b358-2d8e761e62fc)                                                                                               | Elevação de privilégio     | Importante                      | [MS04-045](http://technet.microsoft.com/security/bulletin/ms04-045) |
| [Microsoft Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=71675ae8-d60a-4834-b358-2d8e761e62fc)                                                                      | Elevação de privilégio     | Importante                      | Nenhuma                                                             |
| [Windows Server 2003 com SP1 para sistemas baseados no Itanium e Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=87affdc9-d9fe-413c-af30-f3d3b671ec72) | Elevação de privilégio     | Importante                      | Nenhuma                                                             |
...
Informações detalhadas sobre o arquivo podem ser encontradas no [Artigo 948745 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/948745).
...
<th style="border:1px solid black;" >Vulnerabilidade na sobregravação de memória - CVE-2008-1451</th>
...
Vulnerabilidade na sobregravação de memória - CVE-2008-1451  
-----------------------------------------------------------
  

Existe uma vulnerabilidade de elevação de privilégio no Serviço de Cadastramento na Internet do Windows (WINS) na maneira que o WINS valida suficientemente as estruturas de dados nos pacotes de rede do WINS especialmente criados. A vulnerabilidade pode permitir que um invasor local execute código com privilégios elevados. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. Um invasor poderá instalar programas, visualizar, alterar ou excluir data ou ainda criar novas contas.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-1451](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1451).
  
#### Fatores atenuantes da vulnerabilidade de sobregravação de memória - CVE-2008-1451
...
#### Soluções alternativas para a vulnerabilidade de sobregravação de memória - CVE-2008-1451
  
A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:
  
-   A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas freqüentes sobre a vulnerabilidade de sobregravação de memória - CVE-2008-1451
  
**Qual é o escopo da vulnerabilidade?**    
Existe uma vulnerabilidade de elevação de privilégio no WINS. Um invasor que explorar com êxito essa vulnerabilidade pode executar código com privilégios elevados. Um invasor pode então assumir o controle total de um sistema afetado. Leia o artigo da Technet sobre o [WINS](http://technet2.microsoft.com/windowsserver/en/library/ea41036e-5cbf-427b-a34f-9e4d1d1519581033.mspx?mfr=true) para obter mais informações.
  
**O que provoca a vulnerabilidade?**    
O WINS não valida corretamente as estruturas de dados nos pacotes de rede do WINS especificamente criados.
  
**O que é WINS?**    
WINS é um serviço que converte nomes do NetBIOS em endereços em uma rede de TCP/IP. Embora o NetBIOS e os nomes de NetBIOS possam ser usados com protocolos de rede diferentes do TCP/IP, o Windows Internet Naming Service (WINS) foi projetado especificamente para oferecer suporte ao NetBIOS sobre TCP/IP (NetBT). O WINS é exigido para qualquer ambiente no qual os usuários acessam recursos que têm nomes de NetBIOS. Se você não usar o WINS em tal rede, não poderá se conectar a um recurso de rede remoto usando seu nome de NetBIOS a menos que cada sistema inclua os próprios arquivos Lmhosts. Talvez você não consiga estabelecer conexões de compartilhamento de arquivos e impressão.
...
Para explorar esta vulnerabilidade, um invasor local teria que enviar um pacote especificamente criado para o serviço afetado do WINS.
  
**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**    
Os servidores WINS do Windows correm risco com essa vulnerabilidade.
  
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade, validando as estruturas de dados de pacotes de rede processados por WINS.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Server Service Pack 4:<br />
Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB948745$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/948745">Artigo 948745 (em inglês) da Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB948745$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/948745">Artigo 948745 (em inglês) da Microsoft Knowledge Base</a>.</td>
