...
ms:assetid: 'ms08-046'
ms:contentKeyID: 61233789
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms08-046(v=Security.10)'
---

Microsoft Security Bulletin MS08-046 - Crítica
==============================================

Vulnerabilidade no Sistema de Gerenciamento de Cores de Imagem do Microsoft Windows pode permitir a execução remota de código (952954)
--------------------------------------------------------------------------------------------------------------------------------------
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=db455d17-435f-46d7-b2dd-5babb5a1eeb3)                                                                                         | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=d313f42c-f43f-48ea-82ef-3bc33077c7fa)                                                                         | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3150c6b8-f50b-4b84-a7ce-c8daf77c080c)                                      | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows Server 2003 Service Pack 1 e Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=828d8fdc-8534-4621-85a5-08aec255496f)                                                       | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows Server 2003 x64 Edition e Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0a13776f-d543-41df-b904-d51e368c81cc)                                              | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows Server 2003 com SP1 para sistemas baseados no Itanium e Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=9566493f-4260-4072-947a-527887d2cd63) | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
...
Informações detalhadas sobre o arquivo podem ser encontradas no [Artigo 952954 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/952954).
...
<th style="border:1px solid black;" >Vulnerabilidade no Sistema de Gerenciamento de Cores da Microsoft - CVE-2008-2245</th>
...
Vulnerabilidade no Sistema de Gerenciamento de Cores da Microsoft - CVE-2008-2245  
---------------------------------------------------------------------------------
  

Existe uma vulnerabilidade de execução remota de código no modo como o módulo Sistema de Gerenciamento de Cores da Microsoft (MSCMS) do componente Gerenciamento de Cores de Imagem (ICM) da Microsoft manipula a alocação de memória. A vulnerabilidade pode permitir a execução remota de código se um usuário abrir um arquivo de imagem especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. Um invasor poderá instalar programas, visualizar, alterar ou excluir dados, ou ainda criar novas contas.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-2245](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2245).
  
#### Fatores atenuantes da vulnerabilidade no Sistema de Gerenciamento de Cores da Microsoft - CVE-2008-2245
...
#### Soluções alternativas para a vulnerabilidade no Sistema de Gerenciamento de Cores da Microsoft - CVE-2008-2245
...
-   **Desligue o processamento de metarquivo modificando o Registro**  
    Os clientes que aplicaram o MS07-017 podem desativar o processamento de metarquivos modificando o Registro. Esta configuração ajudará a proteger o sistema afetado contra tentativas de exploração desta vulnerabilidade.
...
-   Alguns cenários que envolvem o processamento de OLE podem apresentar falhas. Isso ocorre com mais freqüência quando o Servidor de Objeto não está ativo.
    ...
    **Como desfazer a solução alternativa.**
    ...
    2.  Localize e clique na seguinte subchave do Registro:  
        HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\GRE\_Initialize  
    3.  Exclua o valor de "DisableMetaFiles"
...
#### Perguntas freqüentes sobre a vulnerabilidade no Sistema de Gerenciamento de Cores da Microsoft - CVE-2008-2245:
...
A vulnerabilidade é causada por um estouro de heap quando o módulo Sistema de Gerenciamento de Cores da Microsoft (MSCMS) do componente Gerenciamento de Cores de Imagem (ICM) da Microsoft aloca memória incorretamente para um arquivo de imagem especialmente criado.
  
**O que é ICM?**    
A Gerenciamento de Cores de Imagem (ICM) é um sistema de gerenciamento de cores que analisa e usa dados em perfis de ICC para executar operações de tradução de cor. A consistência de cores em vários formatos de exibição e tipos de saída pode ser um problema para os editores de conteúdo. Por exemplo, na indústria de publicação, a consistência de cores em todo o processo de publicação comercial economiza tanto tempo como dinheiro. Os designers querem ter certeza de que o material impresso de seus clientes terá os mesmos resultados quando o trabalho for passado ao escritório de serviços, lojas e impressoras e que também terá uma excelente aparência quando for disponibilizado na Internet. As diferenças em espaço de cor, intervalo de gama, e curva de gama são inevitáveis na maioria de casos, por causa das limitações dos dispositivos ou mídia em questão. No entanto, estas diferenças podem ser testadas e registradas num perfil de ICC usando um dos vários produtos de software e hardware atualmente disponíveis no mercado. Estes perfis de ICC são então usados para comunicação no restante do sistema de ICM para garantir que as cores sejam representadas com precisão aos usuários, independentemente do dispositivo usado. Para obter mais informações sobre ICM, visite o seguinte [site da Microsoft](http://www.microsoft.com/whdc/archive/icmwp.mspx).
  
**O que é o ICC (International Color Consortium)?**    
O ICC é uma organização que tem por objetivo estabelecer um padrão através do qual os fornecedores podem implementar o gerenciamento de cores para assegurar a compatibilidade entre os vários fornecedores. Para obter informações adicionais sobre o ICC (International Color Consortium), visite este [site](http://www.color.org/)
...
A atualização de segurança elimina esta vulnerabilidade modificando o modo como o Sistema de Gerenciamento de Cores da Microsoft (MSCMS) aloca memória a arquivos de imagem em processamento.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB952954$Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/952954">Artigo 952954 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB952954$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/952954">Artigo 952954 (em inglês) da Microsoft Knowledge Base</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB952954$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/952954">Artigo 952954 (em inglês) da Microsoft Knowledge Base</a></td>
...
-   Jun Mao, da [VeriSign iDefense Labs](http://labs.idefense.com/), por relatar a vulnerabilidade no Sistema de Gerenciamento de Cores da Microsoft (CVE-2008-2245)
