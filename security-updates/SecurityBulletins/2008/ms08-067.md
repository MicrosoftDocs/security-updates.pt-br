...
ms:assetid: 'ms08-067'
ms:contentKeyID: 61233970
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms08-067(v=Security.10)'
---
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=e22eb3ae-1295-4fe2-9775-6f43c5c2aed3)                                | Execução Remota de Código  | Crítica                         | [MS06-040](http://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0d5f9b6e-9265-44b9-a376-2067b73d6a03)                                            | Execução Remota de Código  | Crítica                         | [MS06-040](http://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=0d5f9b6e-9265-44b9-a376-2067b73d6a03)                                            | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows XP Professional x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=4c16a372-7bf8-4571-b982-dac6b2992b25)                                  | Execução Remota de Código  | Crítica                         | [MS06-040](http://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4c16a372-7bf8-4571-b982-dac6b2992b25)                   | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Server 2003 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f26d395d-2459-4e40-8c92-3de1c52c390d)                                   | Execução Remota de Código  | Crítica                         | [MS06-040](http://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f26d395d-2459-4e40-8c92-3de1c52c390d)                                   | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Server 2003 x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=c04d2afb-f9d0-4e42-9e1f-4b944a2de400)                                      | Execução Remota de Código  | Crítica                         | [MS06-040](http://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c04d2afb-f9d0-4e42-9e1f-4b944a2de400)                       | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Server 2003 com SP1 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ab590756-f11f-43c9-9dcc-a85a43077acf)        | Execução Remota de Código  | Crítica                         | [MS06-040](http://technet.microsoft.com/security/bulletin/ms06-040) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ab590756-f11f-43c9-9dcc-a85a43077acf)        | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Vista e Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=18fdff67-c723-42bd-ac5c-cac7d8713b21)                         | Execução Remota de Código  | Importante                      | Nenhuma                                                             |
| [Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=a976999d-264f-4e6a-9bd6-3ad9d214a4bd) | Execução Remota de Código  | Importante                      | Nenhuma                                                             |
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=25c17b07-1efe-43d7-9b01-3dfdf1ce0bd7)\*                       | Execução Remota de Código  | Importante                      | Nenhuma                                                             |
| [Windows Server 2008 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=7b12018e-0cc1-4136-a68c-be4e1633c8df)\*                  | Execução Remota de Código  | Importante                      | Nenhuma                                                             |
| [Windows Server 2008 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=2bcf89ef-6446-406c-9c53-222e0f0baf7a)                | Execução Remota de Código  | Importante                      | Nenhuma                                                             |
...
Informações detalhadas sobre o arquivo podem ser encontradas no [Artigo 958644 (em inglês) da Base de Conhecimento Microsoft](http://support.microsoft.com/kb/958644).
...
<th style="border:1px solid black;" >Vulnerabilidade do serviço Servidor - CVE-2008-4250</th>
...
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-4250](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4250).
...
-   **Desabilite os serviços de Servidor e Pesquisador de Computadores**
    ...
    **Como desfazer a solução alternativa.** Você pode habilitar esses serviços executando as seguintes etapas:
    ...
    2.  Clique duas vezes em **Ferramentas Administrativas**.  
    3.  Clique duas vezes em **Serviços**.  
    4.  Clique duas vezes em **Serviço Pesquisador de Computadores**.  
    5.  Na lista de tipo de Inicialização, clique em **Automático**.  
    6.  Clique em **Iniciar** e, em seguida, clique em **OK**.  
    7.  Repita as etapas de 4 a 6 para o serviço **Servidor**.
  
-   **No WindowsVista, Windows Server 2008, filtre o identificador de RPC afetado**
    ...
    Uma vez no ambiente de netsh, digite os seguintes comandos:
    ...
    A tecla de Filtragem é um UUID gerado aleatoriamente específico a cada sistema. Para confirmar que o filtro está posicionado, execute o seguinte comando a partir de um prompt de comando elevado:
  
    `netsh rpc filter show filter`
  
    Se os comandos forem executados com êxito, o sistema exibirá a seguinte informação:
  
    `Listing all RPC Filters.---------------------------------filterKey: xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxxdisplayData.name: RPCFilterdisplayData.description: RPC FilterfilterId: 0x12f79layerKey: umweight: Tipo: FWP_EMPTY Value: Emptyaction.type: blocknumFilterConditions: 1`
  
    Onde **filterkey:*Xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx* equivale ao UUID gerado aleatoriamente relevante ao seu sistema.
...
Sim. Essa atualização de segurança elimina a vulnerabilidade que está sendo explorada atualmente. A vulnerabilidade eliminada recebeu o número [CVE-2008-4250](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4250) da lista Common Vulnerability and Exposure.
...
Usando o WSUS (Windows Server Update Services), os administradores podem implantar as atualizações críticas mais recentes e atualizações de segurança para os sistemas operacionais Microsoft Windows 2000 e posterior, Office XP e posterior, Exchange Server 2003 e SQL Server 2000. Para obter mais informações sobre como implantar esta atualização de segurança usando o Windows Server Update Services, visite o [site do Windows Server Update Services](http://www.microsoft.com/brasil/technet/seguranca/wsus/default.mspx).
...
| Windows Vista e Windows Vista Service Pack 1                                                                                  | Não     | Não                | Consulte a **Observação para WindowsVista, Windows Server 2008** a seguir | Sim                        |  
| Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1                                                          | Não     | Não                | Consulte a **Observação para WindowsVista, Windows Server 2008** a seguir | Sim                        |  
| Windows Server 2008 para sistemas de 32 bits                                                                                  | Não     | Não                | Consulte a **Observação para WindowsVista, Windows Server 2008** a seguir | Sim                        |  
| Windows Server 2008 para sistemas baseados no Itanium                                                                         | Não     | Não                | Consulte a **Observação para WindowsVista, Windows Server 2008** a seguir | Sim                        |  
| Windows Server 2008 para sistemas baseados no Itanium                                                                         | Não     | Não                | Consulte a **Observação para WindowsVista, Windows Server 2008** a seguir | Sim                        |
...
**Observação para WindowsVista, Windows Server 2008** O Microsoft Systems Management Server 2003 com Service Pack 3 inclui suporte a capacidade de gerenciamento do Windows Vista e Windows Server 2008.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB958644$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/958644">Artigo 958644 (em inglês) da Base de Conhecimento Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB958644$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/958644">Artigo 958644 (em inglês) da Base de Conhecimento Microsoft</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB958644$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/958644">Artigo 958644 (em inglês) da Base de Conhecimento Microsoft</a></td>
