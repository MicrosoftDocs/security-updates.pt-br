...
#### Soluções alternativas para a Vulnerabilidade de corrupção de memória da matriz global do Excel - CVE-2008-4266
...
-   Joshua J. Drake da [VeriSign iDefense Labs](http://labs.idefense.com/) por relatar a Vulnerabilidade de análise de formato de arquivo (CVE-2008-4265)  
-   Claes M Nyberg da [signedness.org](http://www.signedness.org/) por relatar a vulnerabilidade de análise de formato de arquivo (CVE-2008-4264)  
-   Dyon Balding da [Secunia](http://secunia.com/) por relatar a vulnerabilidade de corrupção de memória da matriz global do Excel (CVE-2008-4266)
