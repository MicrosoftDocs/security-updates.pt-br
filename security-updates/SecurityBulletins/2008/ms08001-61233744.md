...
| Windows Vista                                                                                                                 | Não     | Consulte a **Observação para Windows** **Vista** a seguir | Sim       |  
| Windows Vista x64 Edition                                                                                                     | Não     | Consulte a **Observação para Windows** **Vista** a seguir | Sim       |
