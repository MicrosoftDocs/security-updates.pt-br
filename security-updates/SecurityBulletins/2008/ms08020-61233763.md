...
| Windows Vista                                                                                                                 | Não     | Não                | Veja **Observação para Windows** **Vista** a seguir | Sim       |  
| Windows Vista x64 Edition                                                                                                     | Não     | Não                | Veja **Observação para Windows** **Vista** a seguir | Sim       |
