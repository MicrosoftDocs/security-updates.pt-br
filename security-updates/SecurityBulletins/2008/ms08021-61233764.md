...
ms:assetid: 'ms08-021'
ms:contentKeyID: 61233764
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms08-021(v=Security.10)'
---
...
Vulnerabilidade no GDI pode permitir a execução remota de código (948590)
-------------------------------------------------------------------------
...
Esta é uma atualização de segurança crítica para Microsoft Windows 2000 Service Pack 4 e para todas as versões com suporte de Windows XP, Windows Server 2003, Window Vista e Windows Server 2008. Para obter mais informações, consulte a subseção **Software afetado e não afetado**, nesta seção.

Esta atualização de segurança aborda a vulnerabilidade modificando a maneira como o GDI manipula cálculos de números inteiros e parâmetros de seqüência de caracteres. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.

**Recomendação.**  A Microsoft recomenda que os clientes apliquem a atualização imediatamente

**Problemas conhecidos.** O [Artigo 948590 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/948590) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao desinstalar esta atualização de segurança.
...
| [Windows Server 2003 com SP1 para sistemas baseados no Itanium e Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=7886a802-f2b5-489c-b14b-631f4c4c0742) | Execução Remota de Código  | Crítica                         | [MS07-046](http://technet.microsoft.com/security/bulletin/ms07-046) |
| [Windows Vista e Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=9b51deb8-3873-4146-977f-7e3d0840a4c5)                                                                                  | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4ad6dcd1-6ea5-43bf-8bee-a5f507beadc6)                                                          | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=006d5c47-53e6-4ee1-932c-497611804938)                                                                                  | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Server 2008 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=8909f144-655b-4f07-916f-fd967f1efb2b)                                                                         | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Server 2008 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=b7771a4a-4e4f-48d1-8551-bb8b778ca5a7)                                                                         | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
...
O [Artigo 948590 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/948590) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao desinstalar esta atualização de segurança. Há binários que são compartilhados entre as atualizações de segurança oferecidas pelo MS08-025 (Kernel) e MS08-021 (GDI). Se você instalar as atualizações de segurança oferecidas pelo boletim MS08-025 (Kernel) seguidas pelas do MS08-021 (GDI) e depois desinstalar a atualização oferecida pelo MS08-025 (Kernel), a atualização que é oferecida pelo MS08-021 (GDI) poderá ser revertida para a versão vulnerável, o que fará com que a atualização do MS08-021 (GDI) seja oferecida novamente ao sistema vulnerável.

**Onde estão os detalhes das informações sobre o arquivo?**  
Os detalhes de informações sobre o arquivo podem ser encontrados no [Artigo 948590 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/948590).
...
<th style="border:1px solid black;" >Vulnerabilidade de estouro de heap do GDI - CVE-2008-1083</th>
<th style="border:1px solid black;" >Vulnerabilidade de estouro de pilha do GDI - CVE-2008-1087</th>
...
Vulnerabilidade de estouro de heap do GDI - CVE-2008-1083  
---------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o GDI manipula cálculos de número inteiro. A vulnerabilidade pode permitir a execução remota de código se um usuário abrir um arquivo de imagem EMF ou WMF especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. Um invasor poderá instalar programas, visualizar, alterar ou excluir dados, ou ainda criar novas contas.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-1083](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1083).
  
#### Fatores atenuantes da vulnerabilidade de estouro de heap do GDI - CVE-2008-1083
...
#### Soluções alternativas para a vulnerabilidade de estouro de heap do GDI - CVE-2008-1083
...
-   Desligue o processamento de metarquivo modificando o Registro  
    ...
    **Aviso importante sobre as informações de solução alternativa.**
  
    As informações de solução alternativa fornecidas neste documento constituem SOMENTE uma solução interina (ou seja, de emergência) para uma vulnerabilidade de segurança oculta. Quando a Microsoft fornece uma atualização de segurança ou fornece informações de solução alternativa mais detalhadas em um boletim de segurança, você não deve continuar a usar ou contar com essa solução alternativa, e você deve aplicar prontamente qualquer atualização de segurança e/ou informações atualizadas de solução alternativa fornecidas posteriormente pela Microsoft. Caso essa Solução alternativa aplique-se a uma versão de software da Microsoft para a qual nenhuma atualização de segurança esteja disponível, e uma versão mais recente de software da Microsoft aborde a vulnerabilidade de segurança subjacente, você não deverá contar com essa solução alternativa como uma solução permanente e deve instalar a versão mais recente desse software da Microsoft e atualizações de segurança o mais cedo possível.
  
#### Perguntas freqüentes sobre a vulnerabilidade de estouro de heap do GDI - CVE-2008-1083
...
Para obter mais informações sobre os tipos e formatos de imagem, consulte o [artigo 320314 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/default.aspx?scid=kb;en-us;320314). Informações adicionais sobre esses formatos de arquivo também estão disponíveis no site do [MSDN Library](http://msdn2.microsoft.com/en-us/library/ms536391.aspx)(em inglês).
...
Essa vulnerabilidade exige que um usuário abra um arquivo de imagem especialmente criado.
  
Em um cenário de ataque por email, um invasor pode explorar a vulnerabilidade enviando ao usuário um arquivo de imagem EMF ou WMF especialmente criado ou um documento do Office com um arquivo de imagem EMF ou WMF especialmente criado incorporado nele e convencer o usuário a abrir o documento ou exibir o email que contém o arquivo de imagem especialmente criado.
  
Em um cenário de ataque com base na Web, um invasor terá que hospedar um site que contenha o arquivo de imagem EMF ou WMF usado para tentar explorar essa vulnerabilidade. Além disso, sites comprometidos e sites que aceitem ou hospedem conteúdo fornecido pelo usuário podem conter conteúdo especialmente desenvolvido que pode explorar esta vulnerabilidade. Não há como um invasor forçar usuários a visitar o site especialmente criado. Em vez disso, o invasor teria que convencê-los a visitar o site, geralmente fazendo com que eles cliquem em um link em um email ou mensagem do Instant Messenger que leva os usuários ao site do invasor.
  
**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**    
Todos os sistemas Windows atualmente com suporte estão em risco.
  
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade modificando a maneira como o GDI executa cálculos de número inteiro para evitar uma condição de estouro de heap.
...
Vulnerabilidade de estouro de pilha do GDI - CVE-2008-1087  
----------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o GDI manipula parâmetros de nome de arquivo em arquivos EMF. A vulnerabilidade pode permitir a execução remota de código se um usuário abrir um arquivo de imagem EMF especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. Um invasor poderá instalar programas, visualizar, alterar ou excluir dados, ou ainda criar novas contas.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-1087](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1087).
  
#### Fatores atenuantes da vulnerabilidade de estouro de pilha do GDI - CVE-2008-1087
...
#### Soluções alternativas para a vulnerabilidade de estouro de pilha do GDI - CVE-2008-1087
...
#### Perguntas freqüentes sobre a vulnerabilidade de estouro de pilha do GDI - CVE-2008-1087
  
**Qual é o escopo da vulnerabilidade?**    
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada por um estouro de pilha quando o GDI processa impropriamente um parâmetro de nome de arquivo malformado em um arquivo de imagem EMF especialmente criado.
  
**O que é GDI?**    
A GDI (Graphics Device Interface) do Microsoft Windows permite que aplicativos usem elementos gráficos e texto formatado tanto na exposição de vídeo quanto na impressora. Os aplicativos baseados no Windows não acessam o hardware para elementos gráficos diretamente. Em vez disso, a GDI interage com os drivers dos dispositivos em nome dos aplicativos. Para obter mais informações sobre GDI, visite a [página inicial do Windows GDI](http://msdn2.microsoft.com/en-us/library/ms536795.aspx).
  
**O que é o formato de imagem Windows Enhanced Metafile (EMF)?**  
Uma imagem EMF é um metarquivo de 32 bits que pode conter informações sobre vetores e sobre bitmap. Esse formato é um aprimoramento do formato Metarquivo do Windows e contém mais recursos.
...
Em um cenário de ataque com base na Web, um invasor terá que hospedar um site que contenha o arquivo de imagem EMF usado para tentar explorar essa vulnerabilidade. Além disso, sites comprometidos e sites que aceitem ou hospedem conteúdo fornecido pelo usuário podem conter conteúdo especialmente desenvolvido que pode explorar esta vulnerabilidade. Não há como um invasor forçar usuários a visitar o site especialmente criado. Em vez disso, o invasor teria que convencê-los a visitar o site, geralmente fazendo com que eles cliquem em um link em um email ou mensagem do Instant Messenger que leva os usuários ao site do invasor.
  
**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**    
Todos os sistemas Windows atualmente com suporte estão em risco.
  
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade modificando a maneira como o GDI manipula os parâmetros de nome de arquivo para evitar uma condição de estouro de pilha.
...
| Windows Vista e Windows Vista Service Pack 1                                                                                  | Consulte **Observação para WindowsVista** **e Windows Server 2008** abaixo |  
| Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1                                                          | Consulte **Observação para WindowsVista** **e Windows Server 2008** abaixo |  
| Windows Server 2008                                                                                                           | Consulte **Observação para WindowsVista** **e Windows Server 2008** abaixo |
  
**Observação para o Windows** **Vista** **e Windows Server 2008** A Microsoft não oferece suporte à instalação do MBSA 2.0.1 em computadores que executam Windows Vista e Windows Server 2008, mas você pode instalar o MBSA 2.0.1 em um sistema operacional com suporte e então verificar o computador com Windows Vista e Windows Server 2008 remotamente. Para obter informações adicionais sobre o suporte do MBSA ao Windows Vista, visite o [site do MBSA](http://go.microsoft.com/fwlink/?linkid=21134): Consulte também o [Artigo 931943 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/931943): Suporte do MBSA (Microsoft Baseline Security Analyzer) para Windows Vista.
...
| Windows Vista para sistemas baseados no Itanium e Windows Vista para sistemas baseados no Itanium Service Pack 1              | Não     | Não                | Consulte **Observação para WindowsVista** **e Windows Server 2008** abaixo | Sim       |  
| Windows Server 2008                                                                                                           | Não     | Não                | Consulte **Observação para WindowsVista** **e Windows Server 2008** abaixo | Sim       |
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe localizado na pasta %Windir%\$NTUninstallKB948590$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/948590">Artigo 948590 (em inglês) da Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe localizado na pasta %Windir%\$NTUninstallKB948590$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/948590">Artigo 948590 (em inglês) da Microsoft Knowledge Base</a>.</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe localizado na pasta %Windir%\$NTUninstallKB948590$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/948590">Artigo 948590 (em inglês) da Microsoft Knowledge Base</a>.</td>
...
-   Jun Mao da [iDefense Labs](http://labs.idefense.com/) por reportar a vulnerabilidade de estouro de heap do GDI (CVE-2008-1083).  
-   Sebastian Apelt da [Zero Day Initiative](http://www.zerodayinitiative.com/) por reportar a vulnerabilidade de estouro de heap do GDI (CVE-2008-1083).  
-   Thomas Garnier da [SkyRecon](http://www.skyrecon.com/) por reportar a vulnerabilidade de estouro de heap do GDI (CVE-2008-1083).  
-   Yamata Li da [Palo Alto Networks](http://www.paloaltonetworks.com/) por relatar as Vulnerabilidades de estouro de pilha e de heap do GDI (CVE-2008-1087 e CVE-2008-1083).
...
-   V1.1 (9 de abril de 2008): Boletim atualizado para adicionar um link para Problemas conhecidos ao Artigo 948590 (em inglês) da Microsoft Knowledge Base, adicionar uma seção de Problemas conhecidos às Perguntas freqüentes, atualizar o caminho do Registro de desinstalação e atualizar os Agradecimentos.  
-   V1.2 (11 de abril de 2008): Boletim atualizado para remover uma referência a software não suportado nas Perguntas freqüentes sobre vulnerabilidade.
