...
ms:assetid: 'ms08-025'
ms:contentKeyID: 61233768
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms08-025(v=Security.10)'
---
...
Vulnerabilidade no Kernel do Windows pode permitir a elevação de privilégio (941693)
------------------------------------------------------------------------------------
...
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular no kernel do Windows. O invasor local que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. Um invasor poderá instalar programas, visualizar, alterar ou excluir dados, ou ainda criar novas contas.

Esta é uma atualização de segurança importante para todas as edições do Windows 2000, Windows XP, Windows Server 2003, Windows Vista e Windows Server 2008 com suporte. Para obter mais informações, consulte a subseção **Software afetado e não afetado** nesta seção.

Esta atualização de segurança elimina a vulnerabilidade, modificando a maneira como o Kernel do Windows valida as entradas transmitidas do modo do usuário. Para obter mais informações sobre essa vulnerabilidade, consulte a subseção Perguntas freqüentes na próxima seção, **Informações da vulnerabilidade**.

**Recomendação.**  A Microsoft recomenda que os clientes instalem a atualização o mais rápido possível.

**Problemas conhecidos.** O [Artigo 941693 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/941693) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao desinstalar esta atualização de segurança.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=8db9f328-da0e-4fb8-96c4-6d368b47c224)                                                                                         | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0e937f65-abd0-46dd-8883-5bfd70ea1178)                                                                                                     | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a29bbd13-761f-44fa-8948-e1a8c244bd7a)                                      | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2003 Service Pack 1 e Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d3b855a6-4648-4771-826d-11a151828eac)                                                       | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2003 x64 Edition e Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=320fd100-35e1-4345-9399-796393235cbc)                                              | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2003 com SP1 para sistemas baseados no Itanium e Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=126426a7-be38-4327-89db-02d99d76589d) | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Vista e Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=9640cd8b-d749-4ddd-8af9-b298cebed969)                                                                                  | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d56bb4fe-304e-45e0-95f2-fde2f47b2a04)                                                          | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=4497333c-9418-4b91-83dc-0155735421c0)                                                                                  | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=5aefc7a6-79a4-45a2-b534-35d0ec400dda)                                                                         | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3080c26b-7456-41ef-8668-28f15bc7b8ce)                                                                         | Elevação de privilégio     | Importante                      | Nenhuma                                    |
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-1084](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1084).
  
#### Fatores atenuantes da vulnerabilidade no Kernel do Windows - CVE-2008-1084
...
#### Perguntas freqüentes sobre a vulnerabilidade no Kernel do Windows - CVE-2008-1084
...
O Kernel do Windows validando incorretamente a entrada transmitida do modo do usuário para o Kernel.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe localizado na pasta %Windir%\$NTUninstallKB9461693Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/941693">Artigo 941693 (em inglês) da Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe localizado na pasta %Windir%\$NTUninstallKB941693$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/941693">Artigo 941693 (em inglês) da Microsoft Knowledge Base</a>.</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe localizado na pasta %Windir%\$NTUninstallKB941693$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/941693">Artigo 941693 (em inglês) da Microsoft Knowledge Base</a>.</td>
...
-   Thomas Garnier por relatar a vulnerabilidade no Kernel do Windows (CVE-2008-1084).
...
-   V1.1 (9 de abril de 2008): Boletim atualizado para esclarecer a seção de Problemas conhecidos das Perguntas freqüentes.  
