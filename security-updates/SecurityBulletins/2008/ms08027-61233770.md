...
ms:assetid: 'ms08-027'
ms:contentKeyID: 61233770
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms08-027(v=Security.10)'
---
...
Vulnerabilidade no Microsoft Publisher pode permitir a execução remota de código (951208)
-----------------------------------------------------------------------------------------

Publicado: terça-feira, 13 de maio de 2008 | Atualizado: quarta-feira, 4 de junho de 2008
...
Esta atualização de segurança é classificada como crítica para o Microsoft Office Publisher 2000 Service Pack 3 e como importante para versões com suporte do Microsoft Office Publisher 2002, Microsoft Office Publisher 2003 e Microsoft Office Publisher 2007. Para obter mais informações, consulte a subseção **Software afetado e não afetado**, nesta seção.
...
Os detalhes de informações sobre o arquivo podem ser encontrados no [Artigo 951208 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/951208).
  
**O componente do Microsoft Office abordado neste artigo faz parte do Office Suite que eu tenho instalado no meu sistema. No entanto, não optei por instalar este componente específico. Esta atualização será oferecida a mim?**    
Sim, se a versão do Microsoft Office Suite instalada no seu sistema foi enviada com o componente abordado neste boletim, serão oferecidas atualizações ao sistema quer o componente esteja instalado ou não. A lógica de detecção usada para verificar os sistemas afetados foi projetada para procurar atualizações para todos os componentes enviados com o Microsoft Office Suite em questão e oferecê-las ao sistema. Os usuários que optam por não aplicar uma atualização para um componente que não esteja instalado, mas que está incluído na versão do Microsoft Office Suite, não aumentarão o risco de segurança desse sistema. No entanto, os usuários que optarem por instalar a atualização não sofrerão um impacto negativo na segurança nem no desempenho de um sistema. Para obter mais informações sobre esse problema, consulte o [Artigo 830335 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/830335).
...
<th style="border:1px solid black;" >Vulnerabilidade na validação do manipulador de objetos do Publisher - CVE-2008-0119</th>
<th style="border:1px solid black;" >Avaliação de gravidade agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade na validação do manipulador de objetos do Publisher - CVE-2008-0119  
-----------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Office Publisher valida os dados de cabeçalho do objeto. Um invasor pode explorar a vulnerabilidade, enviando um arquivo do Publisher especialmente criado que pode ser incluído como um anexo de email ou hospedado em um site comprometido ou especialmente criado.
...
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-0119](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0119).
  
#### Fatores atenuantes da vulnerabilidade de validação do manipulador de objetos do Publisher - CVE-2008-0119
...
-   Os usuários que instalaram e usam o Office Document Open Confirmation Tool para Office 2000 receberão as opções Abrir, Salvar ou Cancelar antes de abrir um documento. Os recursos da [Office Document Open Confirmation Tool](http://www.microsoft.com/downloads/details.aspx?familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f) estão incorporados no Office XP e em edições posteriores do Office.
  
#### Soluções alternativas para a vulnerabilidade de validação do manipulador de objetos do Publisher - CVE-2008-0119
...
#### Perguntas freqüentes sobre a vulnerabilidade de validação do manipulador de objetos do Publisher - CVE-2008-0119
...
**O que é manipulador de objetos e o que ele faz?**    
Um manipulador de objetos é uma biblioteca de vínculo dinâmico (DLL) para um aplicativo de servidor OLE. Essa DLL age como um intermediário entre o cliente e os aplicativos de servidor; por exemplo, para melhorar o desempenho quando é necessário desenhar novamente um objeto na janela do aplicativo cliente.
...
Os sistemas nos quais o Microsoft Office Publisher é usado são os que correm mais risco. Os servidores correm mais riscos se os administradores permitirem que os usuários façam logon em servidores e executem programas. Entretanto, as práticas recomendadas não recomendam esse procedimento.
  
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade, validando corretamente os dados do manipulador de objetos ao abrir arquivos do Publisher.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/951208">Artigo 951208 (em inglês) da Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
| **Implantação**                       |                                                                                                                                                                                                          |  
| Instalar sem intervenção do usuário   | publisher2007-kb950114-fullfile-x86-glb /passive                                                                                                                                                         |  
| Instalar sem reinicializar            | publisher2007-kb950114-fullfile-x86-glb /norestart                                                                                                                                                       |  
| Arquivo de log de atualização         | Os usuários podem habilitar o registro extenso usando a chave /log. Consulte o [Artigo 912203 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/912203) para obter mais detalhes. |  
...
| **Informações sobre o arquivo**       | Consulte o [Artigo 951208 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/951208).                                                                                              |  
...
-   Cocoruder da [Fortinet Security Research](http://www.fortinet.com/) por relatar a vulnerabilidade de validação do manipulador de objetos do Publisher - CVE-2008-0119.
...
-   V1.1 4 de junho de 2008: Um link para o artigo 951208 (em inglês) da Microsoft Knowledge Base foi adicionado à seção Problemas conhecidos, na Sinopse.
