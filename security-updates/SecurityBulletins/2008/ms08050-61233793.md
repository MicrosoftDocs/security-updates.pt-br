...
**Por que a atualização para Windows Messenger 4.7 no Windows XP está disponível no Windows Update enquanto a atualização para Windows Messenger 4.7 no Windows Server 2003 só está disponível através do** **Centro de Download?**
