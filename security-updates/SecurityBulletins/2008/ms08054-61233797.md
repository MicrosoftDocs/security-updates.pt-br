...
ms:assetid: 'ms08-054'
ms:contentKeyID: 61233797
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms08-054(v=Security.10)'
---
...
Vulnerabilidade no Windows Media Player pode permitir a execução remota de código (954154)
------------------------------------------------------------------------------------------
...
|------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| Windows XP Service Pack 2 e Windows XP Service Pack 3                                    | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=d5891180-5dd1-49ec-bcc6-3030a544202c) | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2 | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=caf8a45e-a9f8-4e91-98fd-87eddbeae64c) | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| Windows Vista e Windows Vista Service Pack 1                                             | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=2f4118fd-1ffb-46da-b922-cd4ca4f9d84e) | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1                     | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=334352e7-d41f-494f-866d-f1f1745ffd17) | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| Windows Server 2008 para sistemas de 32 bits\*                                           | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=72fc6028-6af4-44ec-8d2a-28c53807d6bc) | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| Windows Server 2008 para sistemas baseados em x64\*                                      | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=3906512b-26db-473e-b522-3883ff34a21c) | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
...
| Windows Server 2003 com SP1 para sistemas baseados no Itanium e Windows Server 2003 com SP2 para sistemas baseados no Itanium | N/D                      |
| Windows Server 2008 para sistemas baseados no Itanium                                                                         | N/D                      |
...
A Microsoft revisou este boletim para comunicar o relançamento da atualização no idioma norueguês do Windows Media Player 11 em todas as edições do Windows XP de 32 bits com suporte para corrigir um problema de qualidade que causaria falha na instalação. Os clientes que baixaram e tentaram instalar a atualização no idioma norueguês precisam baixar e instalar a atualização relançada para ficarem protegidos contra a vulnerabilidade descrita neste boletim. Nenhuma outra atualização ou local são afetados por este relançamento. A Microsoft também removeu uma referência incorreta sobre o Windows Media Player 10 como um componente do Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1 da tabela de softwares não afetados porque essa não é uma configuração com suporte.

**Onde estão os detalhes das informações sobre o arquivo?**  
Informações detalhadas sobre o arquivo podem ser encontradas no [Artigo 954154 (em inglês) da Base de Conhecimento Microsoft](http://support.microsoft.com/kb/954154).
...
<tr class="even">
<td style="border:1px solid black;">Windows Media Player 11 no Windows XP Professional x64 Edition e no Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Crítica</strong><br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
...
<tr class="even">
<td style="border:1px solid black;">Windows Media Player 11 no Windows Vista x64 Edition e no Windows Vista x64 Edition Service Pack 1</td>
<td style="border:1px solid black;"><strong>Crítica</strong><br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Crítica</strong></td>
</tr>
...
<span></span>
Existe uma vulnerabilidade de execução remota de código no Windows Media Player 11. Um invasor pode explorar a vulnerabilidade, criando um arquivo de áudio especialmente criado que pode permitir a execução remota de código quando executado em um servidor Windows Media usando o Windows Media Player 11. Um invasor que explorar com êxito esta vulnerabilidade pode assumir o controle total de um sistema afetado.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-2253](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2253).
  
#### Fatores atenuantes para a vulnerabilidade na taxa de amostragem do Windows Media Player - CVE-2008-2253
...
-   **Cancelar o registro de wmpeffects.dll**  
    ...
    -   **Impacto da solução alternativa:** As visualizações não serão exibidas na tela Em Execução do Windows Media Player.  
...
#### Perguntas freqüentes sobre a vulnerabilidade na taxa de amostragem do Windows Media Player - CVE-2008-2253
...
O Windows Media Player 11 manipula incorretamente os arquivos somente de áudio especialmente criados executados de um Windows Media Server em uma lista de reprodução do lado do servidor (SSPL).
  
**O que é uma lista de reprodução do lado do servidor (SSPL)?**    
Uma SSPL é uma lista que identifica qual conteúdo é reproduzido para um cliente, o momento em que é reproduzido e a ordem na qual é reproduzido. O SSPL para um servidor Windows Media é um documento XML. Para obter mais informações sobre SSPL, consulte as [Listas de reprodução do lado do servidor](http://msdn.microsoft.com/en-us/library/ms753585(vs.85).aspx).
...
Esta vulnerabilidade requer que um usuário abra um arquivo de áudio especialmente criado a partir de um Windows Media Server.
  
Em um cenário de ataque pela Web, o invasor terá que hospedar um Windows Media Server que contenha um arquivo de áudio especialmente criado usado para tentar explorar esta vulnerabilidade. Não há como um invasor forçar usuários a visitar o site especialmente criado. Em vez disso, o invasor teria que convencê-los a visitar o site, geralmente fazendo com que eles cliquem em um link em um email ou mensagem do Instant Messenger que leva os usuários ao site do invasor.
...
A atualização elimina a vulnerabilidade, corrigindo a maneira como o Windows Media Player 11 manipula arquivos de áudio executados de uma SSPL.
...
<td style="border:1px solid black;">Para Windows Media Player 11 em todas as edições de 32 bits do Windows XP com suporte:<br />
WindowsMedia11-KB954154-X86-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows Media Player 11 em todas as edições x64 do Windows XP com suporte:<br />
...
<td style="border:1px solid black;">Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB954154_WM11$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/954154">Artigo 954154 (em inglês) da Base de Conhecimento Microsoft</a></td>
</tr>
<tr class="even">
...
<br />
Para Windows Media Player 11 em todas as edições x64 do Windows XP com suporte:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para todas as edições de 32 bits com suporte do Windows Server 2008 com Experiência Desktop:<br />
Windows6.0-KB954154-x86 /quiet<br />
<br />
Para todas as edições baseadas em x64 com suporte do Windows Server 2008 com Experiência Desktop:<br />
Windows6.0-KB954154-x64 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalar sem reinicializar</td>
...
<tr class="odd">
<td style="border:1px solid black;">Mais informações</td>
<td style="border:1px solid black;">Para obter mais informações sobre a Experiência Desktop no Windows Server 2008, consulte o artigo da Technet, Windows Mail, Windows Media Player e Outros recursos na Experiência Desktop no Windows Server 2008.<br />
<br />
Para obter detalhes sobre como instalar esta atualização, consulte a subseção, <strong>Orientação e ferramentas de detecção e implantação.</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Necessidade de Reinicialização</strong></td>
<td style="border:1px solid black;"></td>
...
-   V1.1 (10 de setembro de 2008): Entrada incorreta removida de **Fatores atenuantes para a vulnerabilidade na taxa de amostragem do Windows Media Player - CVE-2008-2253**.  
-   V2.0 (15 de setembro de 2008): Entrada adicionada à seção **Perguntas freqüentes relacionada a esta seção de atualização de segurança** para comunicar o relançamento da atualização no idioma norueguês do Windows Media Player 11 em todas as edições do Windows XP de 32 bits com suporte. Os clientes que requerem as atualizações no idioma norueguês precisam baixar e instalar as atualizações relançadas. Também foi removida uma entrada incorreta da tabela de softwares não afetados.
