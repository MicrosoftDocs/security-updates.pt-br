...
| Windows Vista e Windows Vista Service Pack 1                                                                                  | Não     | Não                | Consulte **Observação para Windows** **Vista** **e Windows Server 2008** a seguir | Sim                        |  
| Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1                                                          | Não     | Não                | Consulte **Observação para Windows** **Vista** **e Windows Server 2008** a seguir | Sim                        |  
| Windows Server 2008 (todas as edições com suporte)                                                                            | Não     | Não                | Consulte **Observação para Windows** **Vista** **e Windows Server 2008** a seguir | Sim                        |
