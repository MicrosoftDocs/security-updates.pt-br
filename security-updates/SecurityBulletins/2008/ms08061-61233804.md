...
ms:assetid: 'ms08-061'
ms:contentKeyID: 61233804
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms08-061(v=Security.10)'
---
...
Publicado: terça-feira, 14 de outubro de 2008
...
A atualização de segurança soluciona as vulnerabilidades, corrigindo a validação de propriedade de janelas transmitida durante o processo de criação de novas janelas, corrigindo a maneira pela qual as chamadas do sistema de múltiplos segmentos são manipuladas e corrigindo a validação de parâmetros transmitidos ao Kernel através do Windows a partir do modo de usuário. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.

**Recomendação.** A Microsoft recomenda que os clientes instalem a atualização o mais rápido possível.

**Problemas conhecidos.** O [Artigo 954211 (em inglês) da Base de Conhecimento Microsoft](http://support.microsoft.com/kb/954211) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=3a6165a6-d7e7-4526-9291-290caf0639b4)                                                                                         | Elevação de privilégio     | Importante                      | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7718bf14-c26c-43f3-be67-4c79ab5b2607)                                                                                                     | Elevação de privilégio     | Importante                      | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=7718bf14-c26c-43f3-be67-4c79ab5b2607)                                                                                                     | Elevação de privilégio     | Importante                      | Nenhuma                                                             |
| [Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b06d3a02-b6e4-4d40-913a-3759a31f20f3)                                      | Elevação de privilégio     | Importante                      | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2003 Service Pack 1 e Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6e696762-d652-4a8f-ab8f-622f9746c320)                                                       | Elevação de privilégio     | Importante                      | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2003 x64 Edition e Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=57ca28ea-e5e1-4191-a3d6-84aa90a3d668)                                              | Elevação de privilégio     | Importante                      | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2003 com SP1 para sistemas baseados no Itanium e Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=1e6c3f81-85bb-48e6-a5af-635a7e540c93) | Elevação de privilégio     | Importante                      | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Vista e Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=3483b400-cedc-441f-ba8e-594e3df89190)                                                                                  | Elevação de privilégio     | Importante                      | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=905ab030-14a5-4a3d-aa11-e8f957f6a1ea)                                                          | Elevação de privilégio     | Importante                      | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=8b97114a-71aa-47a2-b9e7-f4e158c18c80)\*                                                                                | Elevação de privilégio     | Importante                      | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2008 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=6e641db2-90c8-458f-9795-3e46b70a5203)\*                                                                           | Elevação de privilégio     | Importante                      | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
| [Windows Server 2008 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=b6546e1c-bf7b-4354-8574-6c16fa707de0)                                                                         | Elevação de privilégio     | Importante                      | [MS08-025](http://technet.microsoft.com/security/bulletin/ms08-025) |
...
Informações detalhadas sobre o arquivo podem ser encontradas no [Artigo 954211 (em inglês) da Base de Conhecimento Microsoft](http://support.microsoft.com/kb/954211).
...
O [Artigo 954211 (em inglês) da Base de Conhecimento Microsoft](http://support.microsoft.com/kb/954211) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
<th style="border:1px solid black;" >Vulnerabilidade na criação de janelas do Kernel do Windows - CVE-2008-2250</th>
<th style="border:1px solid black;" >Vulnerabilidade na exceção não tratada do Kernel do Windows - CVE-2008-2251</th>
<th style="border:1px solid black;" >Vulnerabilidade na corrupção de memória do Kernel do Windows - CVE-2008-2252</th>
...
Vulnerabilidade na criação de janelas do Kernel do Windows - CVE-2008-2250  
--------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios uma vez que o Kernel do Windows não valida corretamente as propriedades de uma janela transmitida durante o processo de criação de novas janelas. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-2250](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2250).
  
#### Fatores atenuantes da vulnerabilidade de criação de janelas do Kernel do Windows - CVE-2008-2250
...
#### Soluções alternativas para a vulnerabilidade de criação de janelas do Kernel do Windows - CVE-2008-2250
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas freqüentes sobre a vulnerabilidade de criação de janelas do Kernel do Windows - CVE-2008-2250
...
O kernel do Windows processa incorretamente a entrada transmitida de uma janela pai a uma janela filha quando uma nova janela é criada.
...
A atualização elimina a vulnerabilidade, validando corretamente as propriedades de janelas transmitidas durante o processo de criação de novas janelas.
...
Vulnerabilidade na exceção não tratada do Kernel do Windows - CVE-2008-2251  
---------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios devido a uma possível condição "liberação dupla" no kernel do Windows. A vulnerabilidade pode permitir que um invasor execute código com privilégios elevados. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-2251](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2251).
  
#### Fatores atenuantes da vulnerabilidade na exceção não tratada do Kernel do Windows - CVE-2008-2251
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Um invasor deve ter credenciais válidas de logon e ser capaz de se conectar localmente a um sistema vulnerável para explorar esta vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade na exceção não tratada do Kernel do Windows - CVE-2008-2251
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas freqüentes sobre a vulnerabilidade na exceção não tratada do Kernel do Windows - CVE-2008-2251
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada porque o kernel do Windows não manipula corretamente determinadas chamadas do sistema de múltiplos segmentos.
...
Um invasor pode fazer com que um sistema afetado, durante o processamento de um programa especialmente criado, tente liberar memória que tenha sido reservada para ser usada várias vezes. Liberar uma memória que já foi liberada pode danificá-la. O invasor pode adicionar à memória um código arbitrário que será executado quando a memória for corrompida. Esse código poderá então ser executado em um nível privilegiado do sistema.
...
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade, corrigindo a maneira pela qual as chamadas do sistema de múltiplos segmentos são manipuladas.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Esta vulnerabilidade foi relatada publicamente quando esse boletim de segurança foi originalmente emitido. Ela recebeu o número [CVE-2008-2251](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2251) da lista Common Vulnerability and Exposure.
  
**Quando este boletim de segurança foi lançado, a Microsoft tinha recebido algum relatório informando que essa vulnerabilidade estava sendo explorada?**    
Não. A Microsoft não recebeu nenhuma informação indicando que essa vulnerabilidade tenha sido usada publicamente para atacar clientes e não testemunhou nenhum exemplo de publicação de código de verificação de conceito, quando este boletim de segurança foi lançado pela primeira vez.
  
Vulnerabilidade na corrupção de memória do Kernel do Windows - CVE-2008-2252  
----------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégio uma vez que o kernel do Windows valida incorretamente a entrada transmitida do modo do usuário para o kernel. A vulnerabilidade pode permitir que um invasor execute código com privilégios elevados. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-2252](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2252).
  
#### Fatores atenuantes da vulnerabilidade na corrupção de memória do Kernel do Windows - CVE-2008-2252
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Um invasor deve ter credenciais válidas de logon e ser capaz de se conectar localmente a um sistema vulnerável para explorar esta vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade na corrupção de memória do Kernel do Windows - CVE-2008-2252
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas freqüentes sobre a vulnerabilidade na corrupção de memória do Kernel do Windows - CVE-2008-2252
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade ocorre porque o kernel do Windows valida incorretamente a entrada transmitida do modo de usuário ao Kernel.
...
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade, validando corretamente os parâmetros transmitidos ao Kernel do Windows pelos retornos de chamada do modo do usuário.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB954211$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/954211">Artigo 954211 (em inglês) da Base de Conhecimento Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB954211$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/954211">Artigo 954211 (em inglês) da Base de Conhecimento Microsoft</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB954211$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/954211">Artigo 954211 (em inglês) da Base de Conhecimento Microsoft</a></td>
...
-   Paul Caton da [iShadow](http://www.ishadow.com/) por relatar a Vulnerabilidade na criação de janelas do Kernel do Windows - (CVE-2008-2250)  
-   Thomas Garnier da [SkyRecon](http://www.skyrecon.com/) por relatar a Vulnerabilidade de corrupção de memória do Kernel do Windows - (CVE-2008-2252)
