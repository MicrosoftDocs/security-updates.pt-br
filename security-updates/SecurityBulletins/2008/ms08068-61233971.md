...
ms:assetid: 'ms08-068'
ms:contentKeyID: 61233971
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms08-068(v=Security.10)'
---
...
Vulnerabilidade no SMB pode permitir a execução remota de código (957097)
-------------------------------------------------------------------------

Publicado: terça-feira, 11 de novembro de 2008 | Atualizado: quarta-feira, 10 de dezembro de 2008
...
A atualização de segurança elimina a vulnerabilidade, modificando a maneira que essas respostas de autenticação SMB são validadas para evitar a repetição de credenciais. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.

**Recomendação.** A Microsoft recomenda que os clientes instalem a atualização o mais rápido possível.

**Problemas conhecidos.** O [Artigo 957097 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/957097) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=44c971e6-96fc-4bba-8f4a-f9d46bda2b6c)                                                                                         | Execução Remota de Código  | Importante                      | [MS06-030](http://technet.microsoft.com/security/bulletin/ms06-030) |
...
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6f8ae0aa-fd68-4156-9016-bba00149793c)                                                                                                     | Execução Remota de Código  | Importante                      | Nenhuma                                                             |
| [Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9501b33b-d639-43e7-ad5a-9e76ed66effd)                                      | Execução Remota de Código  | Importante                      | Nenhuma                                                             |
| [Windows Server 2003 Service Pack 1 e Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=57a0606d-ea7a-4e5b-8b8b-7b77a444ef75)                                                       | Execução Remota de Código  | Importante                      | Nenhuma                                                             |
| [Windows Server 2003 x64 Edition e Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=915e001f-9aa0-4fb0-9c2a-0f0c72b4f056)                                              | Execução Remota de Código  | Importante                      | Nenhuma                                                             |
| [Windows Server 2003 com SP1 para sistemas baseados no Itanium e Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=6abf7ba9-825f-4ee2-a2fe-6b1cd9fab622) | Execução Remota de Código  | Importante                      | Nenhuma                                                             |
| [Windows Vista e Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=5612815f-8685-45d2-af4a-164c298a0869)                                                                                  | Execução Remota de Código  | Moderada                        | Nenhuma                                                             |
| [Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=727ce9b6-827f-4350-b4ff-c08e8ac541a6)                                                          | Execução Remota de Código  | Moderada                        | Nenhuma                                                             |
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=b305e894-61ec-46b4-91ee-4c9ac59bc47e)\*                                                                                | Execução Remota de Código  | Moderada                        | Nenhuma                                                             |
| [Windows Server 2008 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=e8d26dfd-b347-4f10-b5b6-27dfff5e4f47)\*                                                                           | Execução Remota de Código  | Moderada                        | Nenhuma                                                             |
| [Windows Server 2008 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=d565467d-e10f-4ddc-a278-3f81a3798686)                                                                         | Execução Remota de Código  | Moderada                        | Nenhuma                                                             |
...
Depois da instalação desta atualização, aplicativos como o SQL ou o IIS podem falhar ao fazer solicitações de autenticação NTLM locais devido à maneira como o NTLM trata diferentes convenções de nomenclatura como entidades remotas, em vez de entidades locais. NTLM é um protocolo de autenticação com base em um mecanismo de consulta/resposta usado para determinar a autenticidade das credenciais fornecidas. Uma falha de autenticação local pode ocorrer quando o cliente calcula e armazena em cache a resposta correta ao desafio NTLM (enviado pelo servidor) na memória "LSASS" local antes de enviar a resposta de volta ao servidor. Quando o código de servidor do NTLM localiza a resposta recebida no cache "LSASS" local, nega a solicitação de autenticação, tratando-a como um ataque de repetição. Isso leva à falha da autenticação local. Desabilitar a proteção contra reflexão é necessário para que a autenticação desses sistemas seja feita corretamente. Para obter informações adicionais sobre problemas de autenticação e convenções de nomenclatura, consulte o [Artigo 896861 da Microsoft Knowledge Base](http://support.microsoft.com/kb/896861), o [Artigo 887993 da Microsoft Knowledge Base](http://support.microsoft.com/kb/887993) e o [Artigo 926642 da Microsoft Knowledge Base](http://support.microsoft.com/kb/926642) (em inglês). Para obter informações adicionais sobre esse problema de instalação, inclusive etapas detalhadas para a desabilitação da proteção contra reflexão, consulte o [Artigo 957097 da Microsoft Knowledge Base](http://support.microsoft.com/kb/957097) (em inglês).

**Onde estão os detalhes das informações sobre o arquivo?**  
Informações detalhadas sobre o arquivo podem ser encontradas no [Artigo 957097 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/957097).
...
<th style="border:1px solid black;" >Vulnerabilidade na reflexão da credencial de SMB - CVE-2008-4037</th>
...
Vulnerabilidade na reflexão da credencial de SMB - CVE-2008-4037  
----------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o Protocolo SMB (Server Message Block) da Microsoft manipula as credenciais de NTLM quando um usuário se conecta a um servidor SMB do invasor. Essa vulnerabilidade permite que um invasor reproduza novamente as credenciais do usuário de volta para ele e execute o código no contexto do usuário conectado. Se um usuário tiver feito logon com direitos administrativos, o invasor que explorar com êxito essa vulnerabilidade poderá ter o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-4037](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4037).
  
#### Fatores atenuantes da Vulnerabilidade de reflexão da credencial de SMB - CVE-2008-4037
...
-   Todas as edições com suporte do Windows Vista e Windows Server 2008 possuem compartilhamento de arquivos desativado por padrão, reduzindo a exposição dessas plataformas a esta vulnerabilidade. Esta configuração padrão, que é uma alteração das plataformas anteriores, resulta em uma área de ataque reduzida para o Windows Vista e o Windows Server 2008 e cria uma nova classificação de gravidade para essas plataformas, como Moderada, para essa vulnerabilidade.
  
#### Soluções alternativas para a Vulnerabilidade de reflexão da credencial de SMB - CVE-2008-4037
...
-   **Habilitar a assinatura de SMB**
    ...
    Habilitar a assinatura de SMB impede que o invasor execute código no contexto do usuário conectado. A Microsoft recomenda usar Diretivas de Grupo para configurar a assinatura de SMB. Para obter instruções detalhadas sobre como usar as Diretivas de Grupo para habilitar e desabilitar a assinatura de SMB para o Microsoft Windows 2000, Windows XP e Windows Server 2003, consulte o [Artigo 887429 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/887429). As instruções contidas no [Artigo 887429 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/887429) para Windows XP e Windows Server 2003 também se aplicam ao Windows Vista e AO Windows Server 2008.
...
#### Perguntas freqüentes sobre a Vulnerabilidade de reflexão da credencial de SMB - CVE-2008-4037
...
O protocolo SMB não opta corretamente pela ativação de NTLM para garantir que as credenciais de um usuário não sejam refletidas novamente e usadas contra o usuário.
...
Esta vulnerabilidade requer que um usuário com uma versão afetada de SMB acesse um servidor mal-intencionado. Um invasor teria que hospedar um site ou um compartilhamento do servidor especialmente criado. Não há como um invasor forçar usuários a visitar um site ou compartilhamento de servidor especialmente criado. Em vez disso, o invasor teria que convencê-los a visitar o site ou o compartilhamento de servidor, geralmente fazendo com que eles cliquem em um link em um email ou mensagem do Instant Messenger que leva os usuários ao site do invasor.
  
**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**    
Todos os sistemas Windows atualmente com suporte estão em risco.
  
**O que a atualização faz?**    
A atualização de segurança elimina a vulnerabilidade, modificando a maneira que essas respostas de autenticação SMB são validadas para evitar a repetição de credenciais.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2008-4037](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4037) da lista Common Vulnerability and Exposure.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB957097$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/957097">Artigo 957097 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB957097$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/957097">Artigo 957097 (em inglês) da Microsoft Knowledge Base</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB957097$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/957097">Artigo 957097 (em inglês) da Microsoft Knowledge Base</a></td>
...
-   V1.1 (12 de novembro de 2008): Entrada corrigida nas **Perguntas freqüentes sobre a Vulnerabilidade de reflexão da credencial de SMB - CVE-2008-4037** para esclarecer relatórios de código de verificação de conceito publicado. A Microsoft não recebeu relatórios diretos que indiquem que esta vulnerabilidade tenha sido usada publicamente para atacar clientes.  
-   V1.2 (10 de dezembro de 2008): Um link para o Artigo 957097 da Microsoft Knowledge Base foi adicionado aos **Problemas conhecidos** na **Sinopse** e uma entrada de problemas conhecidos foi adicionada à seção **Perguntas freqüentes relacionadas a esta atualização de segurança**.
