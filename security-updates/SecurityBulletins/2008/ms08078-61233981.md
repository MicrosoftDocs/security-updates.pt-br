...
**Como o Modo Protegido no Internet Explorer 7 e no Internet Explorer 8 Beta 2 no Windows** **Vista** **e em sistemas posteriores me protegerá desta vulnerabilidade?**
...
| Windows Server 2008 para sistemas de 32 bits                                                                                  | Não     | Não                | Consulte **Observação para Windows** **Vista** **e Windows Server 2008** a seguir | Sim                        |
| Windows Server 2008 para sistemas baseados no Itanium                                                                         | Não     | Não                | Consulte **Observação para Windows** **Vista** **e Windows Server 2008** a seguir | Sim                        |
| Windows Server 2008 para sistemas baseados no Itanium                                                                         | Não     | Não                | Consulte **Observação para Windows** **Vista** **e Windows Server 2008** a seguir | Sim                        |
