...
ms:assetid: 'ms09-002'
ms:contentKeyID: 61233983
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-002(v=Security.10)'
---
Microsoft Security Bulletin MS09-002 - Crítica
==============================================

Atualização de segurança cumulativa para Internet Explorer (961260)
-------------------------------------------------------------------

Publicado: terça-feira, 10 de fevereiro de 2009 | Atualizado: segunda-feira, 16 de fevereiro de 2009
...
Esta atualização de segurança é classificada como Crítica para o Internet Explorer 7 executando em edições do Windows XP e Windows Vista com suporte. Para o Internet Explorer 7 executando em edições do Windows Server 2003 e Windows Server 2008 com suporte, esta atualização de segurança é classificada como Moderada. Para obter mais informação, consulte a subseção **Software afetado e não afetado** nesta seção.

A atualização elimina as vulnerabilidades ao modificar o modo como o Internet Explorer lida com o erro que resulta na condição de vulnerabilidade. Para obter mais informações sobre as vulnerabilidades, consulte a subseção Perguntas frequentes na próxima seção, **Informações sobre a vulnerabilidade**.
...
| Windows Server 2003 com SP1 para sistemas baseados no Itanium e Windows Server 2003 com SP2 para sistemas baseados no Itanium | Microsoft Internet Explorer 6                   |
...
Informações detalhadas sobre o arquivo podem ser encontradas no [Artigo 961260 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/961260).
...
<th style="border:1px solid black;" >
Vulnerabilidade de Corrupção de Memória do CSS - CVE-2009-0076
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-0075](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0075).

#### Fatores atenuantes da vulnerabilidade de corrupção de memória não inicializada - CVE-2009-0075
...
-   Esta vulnerabilidade afeta somente o Windows Internet Explorer 7. Ela não afeta versões com suporte do Microsoft Internet Explorer 5 e Microsoft Internet Explorer 6.
...
#### Perguntas frequentes sobre a vulnerabilidade de corrupção de memória não inicializada - CVE-2009-0075
...
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer lida com CSS (Cascading Style Sheets). Um invasor pode explorar a vulnerabilidade criando uma página da Web especialmente desenvolvida. Se um usuário exibir a página da Web, a vulnerabilidade poderá permitir a execução remota de código. O invasor que explorar com êxito a vulnerabilidade poderá obter os mesmos direitos de um usuário conectado.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-0076](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0076).

#### Fatores atenuantes da vulnerabilidade de corrupção de memória do CSS - CVE-2009-0076
...
#### Soluções alternativas para a vulnerabilidade de corrupção de memória do CSS - CVE-2009-0076
...
#### Perguntas frequentes sobre a vulnerabilidade de corrupção de memória do CSS - CVE-2009-0076
...
**O que provoca a vulnerabilidade?**  
Quando o Internet Explorer exibe uma página da Web que contém certos estilos de CSS, a memória pode ser corrompida de tal maneira que um invasor pode executar código arbitrário no contexto do usuário conectado.
...
**O que a atualização faz?**  
A atualização modifica a maneira como o Internet Explorer manipula CSS (Cascading Style Sheets).
...
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições do Windows XP com suporte:<br />
Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\ie7updates\KB961260-IE7\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/961260">Artigo 961260 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   [TippingPoint](http://www.tippingpoint.com/) e [Zero Day Initiative](http://www.zerodayinitiative.com/) por reportarem a vulnerabilidade de corrupção de memória não inicializada – (CVE-2009-0075).  
-   SAM Thomas ([http://eshu.co.uk](http://eshu.co.uk/)/), que trabalha com a [TippingPoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), por relatar a vulnerabilidade de corrupção de memória de CSS (CVE-2009-0076)
...
-   V1.1 (16 de fevereiro de 2009): Um link para o artigo 961260 (em inglês) da Microsoft Knowledge Base foi adicionado à seção Problemas conhecidos, na **Sinopse**.
