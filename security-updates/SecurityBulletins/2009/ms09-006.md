...
ms:assetid: 'ms09-006'
ms:contentKeyID: 61233987
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-006(v=Security.10)'
---

Microsoft Security Bulletin MS09-006 - Crítica
==============================================

Vulnerabilidades no kernel do Windows podem permitir a execução remota de código (958690)
-----------------------------------------------------------------------------------------
...
Esta atualização de segurança elimina várias vulnerabilidades relatadas em particular no kernel do Windows. A vulnerabilidade mais grave pode permitir execução remota de código se um usuário visualizar um arquivo de imagem EMF ou WMF especialmente criado em um sistema afetado.
...
A atualização de segurança soluciona as vulnerabilidades, validando a entrada transmitida do modo do usuário através do componente GDI do kernel, corrigindo a maneira como o kernel valida manipulações e modificando a maneira como o kernel do Windows lida com ponteiros inválidos especialmente criados. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=98bb7d40-89a0-470a-8eb7-06f15072a635)                                                                                         | Execução Remota de Código  | Crítica                         | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=e09641ba-6cbe-4095-82b5-703d3a7dc33b)                                                                         | Execução Remota de Código  | Crítica                         | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d0d704c6-48c2-4907-b6c3-2455d7cf21c8)                                      | Execução Remota de Código  | Crítica                         | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2003 Service Pack 1 e Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f5cfb8da-e7cc-4183-8631-507c2a406500)                                                       | Execução Remota de Código  | Crítica                         | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2003 x64 Edition e Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ecf75c70-8489-41ad-9759-3a07e13957be)                                              | Execução Remota de Código  | Crítica                         | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2003 com SP1 para sistemas baseados no Itanium e Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=04be3d7e-7dda-4dca-887a-e7a8156ede1c) | Execução Remota de Código  | Crítica                         | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Vista e Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4b1aaaba-f355-4265-83c0-50b901856ced)                                                                                  | Execução Remota de Código  | Crítica                         | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0fcac480-d6db-4a94-8c7d-b7319282cf56)                                                          | Execução Remota de Código  | Crítica                         | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=38851df2-4fb5-4d28-9d15-181c260cf8cf)\*                                                                                | Execução Remota de Código  | Crítica                         | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2008 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=ec15acc4-3e0f-4414-9383-61c122ff1382)\*                                                                           | Execução Remota de Código  | Crítica                         | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
| [Windows Server 2008 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=eead6f93-10fd-4492-8137-481d9876a5fe)                                                                         | Execução Remota de Código  | Crítica                         | [MS08-061](http://technet.microsoft.com/security/bulletin/ms08-061) |
...
Informações detalhadas sobre o arquivo podem ser encontradas no [Artigo 958690 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/958690).
...
<th style="border:1px solid black;" >Vulnerabilidade na validação de entrada do kernel do Windows - CVE-2009-0081</th>
<th style="border:1px solid black;" >Vulnerabilidade na validação do manipulador do kernel do Windows - CVE-2009-0082</th>
<th style="border:1px solid black;" >Vulnerabilidade em ponteiro inválido no kernel do Windows - CVE-2009-0083</th>
...
Vulnerabilidade na validação de entrada do kernel do Windows - CVE-2009-0081  
----------------------------------------------------------------------------
  

Existe uma vulnerabilidade de execução remota de código no kernel do Windows decorrente da validação imprópria de entrada transmitida do modo do usuário através do componente GDI do kernel. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-0081](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0081).
  
#### Fatores atenuantes da vulnerabilidade na validação de entrada do kernel do Windows - CVE-2009-0081
...
#### Soluções alternativas para a vulnerabilidade na validação de entrada do kernel do Windows - CVE-2009-0081
...
-   **Desligue o processamento de metarquivo modificando o Registro**  
    Os clientes que aplicaram a atualização de segurança associada ao Boletim de Segurança da Microsoft MS07-017 ou os clientes que usam o Windows Vista ou o Windows Server 2008 podem desabilitar o processamento de metarquivos modificando o Registro. Esta configuração ajudará a proteger o sistema afetado contra tentativas de exploração desta vulnerabilidade.
...
#### Perguntas frequentes sobre a vulnerabilidade na validação de entrada do kernel do Windows - CVE-2009-0081
...
O kernel do Windows não valida corretamente a entrada transmitida do modo do usuário através do componente GDI do kernel.
...
Para obter mais informações sobre os tipos e formatos de imagem, consulte o [artigo 320314 do Microsoft Knowledge Base](http://support.microsoft.com/kb/320314). Informações adicionais sobre esses formatos de arquivo também estão disponíveis no [site MSDN Library](http://msdn2.microsoft.com/en-us/library/ms536391.aspx).
...
Para execução remota de código, essa vulnerabilidade exige que um usuário visualize um arquivo de imagem especialmente criado. Esta vulnerabilidade também pode ser explorada por um invasor conectado ao sistema local. Em seguida, ele precisa executar um aplicativo especialmente criado capaz de explorar a vulnerabilidade e assumir o controle total do sistema afetado.
  
Em um cenário de ataque de email, um invasor pode explorar a vulnerabilidade, enviando ao usuário um email com um arquivo de imagem EMF ou WMF especialmente criado incorporado a ele e convencendo o usuário a visualizar ou pré-visualizar o email. Um invasor também pode incorporar um arquivo de imagem EMF ou WMF especialmente criado a um documento do Office e convencer o usuário a abrir o arquivo.
...
Vulnerabilidade na validação do manipulador do kernel do Windows - CVE-2009-0082  
--------------------------------------------------------------------------------
  

Existe uma vulnerabilidade de elevação de privilégio no kernel do Windows decorrente da maneira como o kernel valida manipulações. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-0082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0082).
  
#### Fatores atenuantes da vulnerabilidade na validação do manipulador do kernel do Windows - CVE-2009-0082
...
#### Soluções alternativas para a vulnerabilidade na validação do manipulador do kernel do Windows - CVE-2009-0082
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade na validação do manipulador do kernel do Windows - CVE-2009-0082
...
**O que provoca a vulnerabilidade?**    
O kernel do Windows não valida corretamente manipulações quando executa certas ações.
...
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade, corrigindo a maneira como o kernel valida manipulações.
...
Vulnerabilidade em ponteiro inválido no kernel do Windows - CVE-2009-0083  
-------------------------------------------------------------------------
  

Existe uma vulnerabilidade de elevação de privilégio no kernel do Windows decorrente da manipulação incorreta de um ponteiro inválido especialmente criado. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-0083](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0083).
  
#### Fatores atenuantes da vulnerabilidade de ponteiro inválido no kernel do Windows - CVE-2009-0083
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Um invasor deve ter credenciais válidas de logon e ser capaz de se conectar localmente a um sistema vulnerável para explorar esta vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade de ponteiro inválido no kernel do Windows - CVE-2009-0083
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de ponteiro inválido no kernel do Windows - CVE-2009-0083
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**    
O kernel do Windows não manipula corretamente ponteiros inválidos especialmente criados.
...
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade, mudando a maneira como o kernel do Windows manipula ponteiros inválidos especialmente criados.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Use a ferramenta Adicionar ou Remover Programas, no Painel de Controle, ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB958690$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/958690">Artigo 958690 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta Adicionar ou Remover Programas, no Painel de Controle, ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB958690$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/958690">Artigo 958690 (em inglês) da Microsoft Knowledge Base</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong>, no Painel de Controle, ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB958690$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/958690">Artigo 958690 (em inglês) da Microsoft Knowledge Base</a></td>
...
-   Helmut Buhler ([http://home.arcor.de/clipboarder](http://home.arcor.de/clipboarder/)/) por relatar a vulnerabilidade na validação de entrada do kernel do Windows (CVE-2009-0081)  
-   Thomas Garnier da [SkyRecon](http://www.skyrecon.com/) por relatar a vulnerabilidade na validação do manipulador do kernel do Windows (CVE-2008-0082).
