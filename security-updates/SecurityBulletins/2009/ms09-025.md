...
ms:assetid: 'ms09-025'
ms:contentKeyID: 61234006
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-025(v=Security.10)'
---
Microsoft Security Bulletin MS09-025 - Importante
=================================================

Vulnerabilidades do kernel do Windows podem permitir elevação de privilégio (968537)
------------------------------------------------------------------------------------
...
Esta atualização de segurança resolve duas vulnerabilidades divulgadas publicamente e duas relatadas em particular no kernel do Windows que podem permitir a elevação de privilégio. Um invasor que explorar com êxito uma dessas vulnerabilidades poderá causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essas vulnerabilidades. Essas vulnerabilidades não podem ser exploradas remotamente ou por usuários anônimos.
...
A atualização de segurança elimina essas vulnerabilidades, corrigindo os métodos usados para validar uma alteração em objetos específicos do kernel, a entrada transmitida do modo de usuário ao kernel e o argumento transmitido à chamada do sistema. A atualização de segurança também aborda uma vulnerabilidade, garantindo que o kernel do Windows limpe os ponteiros sob condições de erro. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=79b0481d-a3d7-477b-928a-a98cc79374af)                                | Elevação de privilégio     | Importante                      | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6349e046-a3f8-4ae5-b8c3-c9879cc99e8f)                | Elevação de privilégio     | Importante                      | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3769800e-af93-4a44-8a1e-b30cc54b226f)                   | Elevação de privilégio     | Importante                      | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9356404c-d89a-4de0-b9b4-f6e1bdadf745)                                   | Elevação de privilégio     | Importante                      | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5a3123af-173d-49eb-9997-14e82e764aee)                       | Elevação de privilégio     | Importante                      | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=13b50993-410f-4e7a-a33a-6d9b48dbb4d1)        | Elevação de privilégio     | Importante                      | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Vista e Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c31b36f8-330c-4a0c-9a3d-7cbe9a1ab8c8)                         | Elevação de privilégio     | Importante                      | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c31b36f8-330c-4a0c-9a3d-7cbe9a1ab8c8)                                         | Elevação de privilégio     | Importante                      | Nenhuma                                                             |
| [Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7d70a65f-07ce-4992-8bec-28fefd7587bc) | Elevação de privilégio     | Importante                      | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7d70a65f-07ce-4992-8bec-28fefd7587bc)                             | Elevação de privilégio     | Importante                      | Nenhuma                                                             |
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=98ba52b2-da1a-4939-a10e-d43b3a7e7ed4)\*                       | Elevação de privilégio     | Importante                      | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=98ba52b2-da1a-4939-a10e-d43b3a7e7ed4)\*        | Elevação de privilégio     | Importante                      | Nenhuma                                                             |
| [Windows Server 2008 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=dbaa5a72-c267-4907-a207-525c2803d7b9)\*                  | Elevação de privilégio     | Importante                      | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dbaa5a72-c267-4907-a207-525c2803d7b9)\*   | Elevação de privilégio     | Importante                      | Nenhuma                                                             |
| [Windows Server 2008 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=e0e3ad56-a363-44ba-af4d-b7f551c88afd)                | Elevação de privilégio     | Importante                      | [MS09-006](http://technet.microsoft.com/security/bulletin/ms09-006) |
| [Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e0e3ad56-a363-44ba-af4d-b7f551c88afd) | Elevação de privilégio     | Importante                      | Nenhuma                                                             |
...
As classificações de gravidade a seguir pressupõem o impacto máximo possível da vulnerabilidade. Para obter informações referentes à probabilidade de exploração da vulnerabilidade em relação à sua classificação de gravidade e ao impacto à segurança, dentro de 30 dias a partir do lançamento deste boletim de segurança, consulte o Índice de exploração no [resumo de boletins de junho](http://technet.microsoft.com/security/bulletin/ms09-jun). Para obter mais informações, consulte o [Índice de exploração da Microsoft](http://technet.microsoft.com/en-us/security/cc998259.aspx).
...
<th style="border:1px solid black;" >Vulnerabilidade na área de trabalho do kernel do Windows - CVE-2009-1123</th>
<th style="border:1px solid black;" >Vulnerabilidade de validação do ponteiro do kernel do Windows - CVE-2009-1124</th>
<th style="border:1px solid black;" >Vulnerabilidade de registro de classes de driver do Windows - CVE-2009-1125</th>
<th style="border:1px solid black;" >Vulnerabilidade de edição de parâmetros da área de trabalho do Windows - CVE-2009-1126</th>
...
Vulnerabilidade na área de trabalho do kernel do Windows - CVE-2009-1123  
------------------------------------------------------------------------
  

Existe uma vulnerabilidade de elevação de privilégio na maneira como o kernel do Windows não valida corretamente as alterações em determinados objetos do kernel. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-1123](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1123).
  
#### Fatores atenuantes da vulnerabilidade de área de trabalho do kernel do Windows - CVE-2009-1123
...
#### Soluções alternativas para a vulnerabilidade de área de trabalho do kernel do Windows - CVE-2009-1123
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de área de trabalho do kernel do Windows - CVE-2009-1123
...
O kernel do Windows não valida corretamente as alterações em determinados objetos de kernel.
...
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2009-1123](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1123) da lista Common Vulnerability and Exposure.
  
**Quando este boletim de segurança foi lançado, a Microsoft tinha recebido algum relatório informando que essa vulnerabilidade estava sendo explorada?**    
Não. A Microsoft viu exemplos de código de verificação de conceito divulgados publicamente, mas não recebeu nenhum relatório direto indicando que essa vulnerabilidade tenha sido usada publicamente para atacar clientes quando este boletim de segurança foi originalmente lançado.
  
Vulnerabilidade de validação do ponteiro do kernel do Windows - CVE-2009-1124  
-----------------------------------------------------------------------------
...
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-1124](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1124).
  
#### Fatores atenuantes da vulnerabilidade de validação do ponteiro do kernel do Windows - CVE-2009-1124
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade de validação do ponteiro do kernel do Windows - CVE-2009-1124
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de validação do ponteiro do kernel do Windows - CVE-2009-1124
...
Vulnerabilidade de registro de classes de driver do Windows - CVE-2009-1125  
---------------------------------------------------------------------------
...
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-1125](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1125).
  
#### Fatores atenuantes da vulnerabilidade de registro de classes de driver do Windows - CVE-2009-1125
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade de registro de classes de driver do Windows - CVE-2009-1125
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de registro de classes de driver do Windows - CVE-2009-1125
...
Vulnerabilidade de edição de parâmetros da área de trabalho do Windows - CVE-2009-1126  
--------------------------------------------------------------------------------------
  

Existe uma vulnerabilidade de elevação de privilégio quando o kernel do Windows valida incorretamente a entrada transmitida do modo do usuário para o kernel ao editar um parâmetro específico da área de trabalho. A vulnerabilidade pode permitir que um invasor execute código com privilégios elevados. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-1126](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1126).
  
#### Fatores atenuantes da vulnerabilidade de edição do parâmetro da área de trabalho do Windows - CVE-2009-1126
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade de edição do parâmetro da área de trabalho do Windows - CVE-2009-1126
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de edição do parâmetro da área de trabalho do Windows - CVE-2009-1126
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**    
O kernel do Windows não valida corretamente a entrada transmitida do modo de usuário ao kernel ao editar um parâmetro específico da área de trabalho.
...
**O que a atualização faz?**    
A atualização elimina essa vulnerabilidade, corrigindo o método usado para validar a entrada transmitida do modo de usuário ao kernel ao configurar um parâmetro específico da área de trabalho.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2009-1126](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1126) da lista Common Vulnerability and Exposure.
...
| **Implantação**                       |                                                                                                                                                                         |  
| Instalar sem intervenção do usuário   | Windows2000-KB968537-x86-ENU /quiet                                                                                                                                     |  
| Instalar sem reinicializar            | Windows2000-KB968537-x86-ENU /norestart                                                                                                                                 |  
| Arquivo de log de atualização         | kb968537.log                                                                                                                                                            |  
...
| **Informações sobre remoção**         | Use a ferramenta **Adicionar ou Remover Programas**, no Painel de Controle, ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB968537$\\Spuninst |  
| **Informações sobre o arquivo**       | Consulte o [Artigo 968537 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/968537)                                                              |  
| **Verificação da chave do Registro**  | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB968537\\Filelist                                                                               |
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong>, no Painel de Controle, ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB968537$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/968537">Artigo 968537 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Thomas Garnier por relatar a vulnerabilidade de validação do ponteiro do kernel do Windows (CVE-2009-1124) e a vulnerabilidade de registro de classes de driver do Windows (CVE-2009-1125)
