...
ms:assetid: 'ms09-026'
ms:contentKeyID: 61234007
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-026(v=Security.10)'
---
Microsoft Security Bulletin MS09-026 - Importante
=================================================

Vulnerabilidade no RPC pode permitir elevação de privilégio (970238)
--------------------------------------------------------------------
...
Esta atualização de segurança resolve uma vulnerabilidade divulgada publicamente no recurso RPC (Chamada de Procedimento Remoto) do Windows no qual o Mecanismo de Organização de RPC não atualiza seu estado interno corretamente. A vulnerabilidade pode permitir que um invasor execute código arbitrário e assuma o controle total de um sistema afetado. As edições com suporte do Microsoft Windows não são fornecidas com os servidores RPC nem clientes que estão sujeitos à exploração desta vulnerabilidade. Em uma configuração padrão, os usuários não podem ser atacados pela exploração desta vulnerabilidade. No entanto, a vulnerabilidade está presente no tempo de execução de RPC do Microsoft Windows e pode afetar aplicativos de RPC de terceiros.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=155a79c1-e5e4-4f62-b4b0-53aca59f20ac)                                                                                        | Elevação de privilégio     | Importante                      | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f033fa78-c451-44f8-aa6c-a49622c37f40)                                                                                                    | Elevação de privilégio     | Importante                      | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=f033fa78-c451-44f8-aa6c-a49622c37f40)                                                                                                    | Elevação de privilégio     | Importante                      | Nenhuma                                                  |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=20734b70-37f1-47dd-bc09-d56f93577a55)                                                                           | Elevação de privilégio     | Importante                      | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=62bb9e22-4f4b-4ffc-ba76-f626e94c79d5)                                                                                           | Elevação de privilégio     | Importante                      | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Microsoft Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=888b8dd8-d76c-42f5-a377-1f1750d3cf56)                                                                     | Elevação de privilégio     | Importante                      | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3084f46e-02b9-4d99-a7a1-033817f9bd9f)                                                                | Elevação de privilégio     | Importante                      | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Windows Vista](http://www.microsoft.com/downloads/details.aspx?familyid=5ca227c0-f2dd-429c-a542-e08e93527214)                                                                                                                | Elevação de privilégio     | Importante                      | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ca227c0-f2dd-429c-a542-e08e93527214)                                                                  | Elevação de privilégio     | Importante                      | Nenhuma                                                  |
| [Windows Vista x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=188adafe-1feb-46ad-b237-a88d35104dcd)                                                                                                    | Elevação de privilégio     | Importante                      | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=188adafe-1feb-46ad-b237-a88d35104dcd)                                          | Elevação de privilégio     | Importante                      | Nenhuma                                                  |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=eaa26c6c-5bf7-4099-bb21-1e03de3a25ca)\*                 | Elevação de privilégio     | Importante                      | Nenhuma                                                  |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=447aaa4f-946b-4f23-b151-dcf46ea9f80e)\*       | Elevação de privilégio     | Importante                      | Nenhuma                                                  |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f33012b9-5d5b-4f72-8d49-a8e1c8bc1337) | Elevação de privilégio     | Importante                      | Nenhuma                                                  |
...
<th style="border:1px solid black;" >Vulnerabilidade no Mecanismo de Organização de RPC - CVE-2009-0568</th>
...
Vulnerabilidade no Mecanismo de Organização de RPC - CVE-2009-0568  
------------------------------------------------------------------
  

Existe uma vulnerabilidade de elevação de privilégio no recurso RPC (Chamada de Procedimento Remoto) do Windows no qual o Mecanismo de Organização de RPM não atualiza seu estado interno corretamente. A falha na atualização do estado interno pode levar a um ponteiro que está sendo lido a partir de um local incorreto. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-0568](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0568).
  
#### Fatores atenuantes da vulnerabilidade do Mecanismo de Organização de RPC - CVE-2009-0568
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   As edições com suporte do Microsoft Windows não são fornecidas com os servidores RPC nem clientes que estão sujeitos à exploração desta vulnerabilidade. Em uma configuração padrão, os usuários não podem ser atacados pela exploração desta vulnerabilidade. No entanto, a vulnerabilidade existe no tempo de execução de RPC do Microsoft Windows e pode afetar aplicativos de RPC de terceiros.
  
#### Soluções alternativas para a vulnerabilidade do Mecanismo de Organização de RPC - CVE-2009-0568
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade do Mecanismo de Organização de RPC - CVE-2009-0568
...
A vulnerabilidade é causada quando o Mecanismo de Organização de RPC (Chamada de Procedimento Remoto) não atualiza seu estado interno de maneira adequada. Esta falha na atualização pode levar a um ponteiro que está sendo lido a partir de um local incorreto. Somente as interfaces que usam a linguagem IDL (Interface Definition Language) que contêm uma matriz de variação em não conformidade podem ser afetadas por esse problema.
  
**Quais aplicativos do RPC podem ser afetados por esta vulnerabilidade?**    
Para determinar se um aplicativo é afetado por este problema, os usuários devem ter acesso ao arquivo de IDL usado para compilar o aplicativo cliente ou servidor. Os aplicativos de RPC podem estar vulneráveis à exploração dessa vulnerabilidade se o stub resultante contiver um FC\_SMVARRAY ou FC\_LGVARRAY seguido por FC\_VARIABLE REPEAT e FC\_VARIABLE\_OFFSET.
  
**O que é o RPC (Chamada de procedimento remoto)?**    
O RPC (Chamada de Procedimento Remoto) da Microsoft é um mecanismo de comunicação entre processos que permite a troca de dados e a invocação de recursos que residem em um processo diferente. Esse processo pode estar no mesmo computador, na rede local (LAN) ou na Internet. O mecanismo RPC da Microsoft usa outros mecanismos de IPC, tais como pipes nomeados, NetBIOS ou Winsock, para estabelecer comunicações entre o cliente e o servidor. Com o RPC, a lógica essencial do programa e o código de procedimento relacionado podem existir em computadores diferentes, o que é importante para aplicativos distribuídos. Para obter mais informações, consulte o artigo da Technet, [O que é RPC? (em inglês)](http://technet.microsoft.com/en-us/library/cc787851(ws.10).aspx)
  
**O que é o Mecanismo de Organização de RPC?**    
O Mecanismo de Organização de RPC, também conhecido como NDR, fornece uma interface de RPC comum entre clientes e servidores de RPC. O NDR20 é usado em uma arquitetura de 32 bits e o NDR64 é otimizado para uma arquitetura de 64 bits. O mesmo mecanismo de organização é usado tanto no lado do cliente quanto no do servidor, independentemente da arquitetura do programa. O cliente e o servidor negociam qual mecanismo de organização é usado para a comunicação.
  
**O que são arquivos de IDL (Interface Definition Language) e ACF (Arquivos de configuração do aplicativo)?**    
O arquivo de IDL (Interface Definition Language) contém uma descrição da interface entre os programas do cliente e do servidor. Os aplicativos de RPC usam o ACF (Arquivo de configuração do aplicativo) para descrever as características da interface específicas ao hardware e sistema operacional que compõem um ambiente operacional específico. O objetivo de dividir essas informações em dois arquivos é manter a interface do software separada das características que afetam somente o ambiente operacional.
  
O arquivo de IDL especifica um contrato de rede para o que é transmitido entre o cliente e o servidor. Manter essas informações separadas das informações sobre o ambiente operacional torna o arquivo de IDL portátil para outros ambientes. O arquivo de IDL é composto por duas partes: um [cabeçalho de interface](http://msdn.microsoft.com/en-us/library/aa378711(vs.85).aspx) e um [corpo de interface](http://msdn.microsoft.com/en-us/library/aa378710(vs.85).aspx).
  
O ACF especifica atributos que afetam somente o desempenho local em vez do contrato de rede. O RPC da Microsoft permite combinar os atributos de ACF e IDL em um único arquivo de IDL. Você também pode combinar várias interfaces em um único arquivo de IDL (e seu ACF). Para obter mais informações, consulte o artigo do MSDN, [Arquivos IDL e ACF](http://msdn.microsoft.com/en-us/library/aa378708(vs.85).aspx) (em inglês).
  
**O que é IPC (Comunicação Entre Processos)?**    
O sistema operacional Microsoft Windows fornece mecanismos para facilitar a comunicação e o compartilhamento de dados entre aplicativos. Coletivamente, as atividades habilitadas por esses mecanismos são chamadas de IPC (comunicação entre processos). Algumas formas de IPC facilitam a divisão do trabalho entre vários processos especializados. Outras formas de IPC facilitam a divisão do trabalho entre computadores em uma rede. Para obter mais informações, consulte o artigo do MSDN, [Comunicação entreprocessos](http://msdn.microsoft.com/en-us/library/aa365574(vs.85).aspx) (em inglês).
  
**Para que um invasor pode usar a vulnerabilidade?**    
Um invasor que explorar com êxito essa vulnerabilidade pode executar código arbitrário com permissões elevadas. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**De que forma o invasor pode explorar a vulnerabilidade?**    
Um invasor pode explorar a vulnerabilidade, criando uma mensagem de RPC especialmente criada e enviando a mensagem a um sistema afetado pela porta afetada TCP ou UDP. A mensagem pode permitir que o cliente grave dados arbitrários na memória no espaço para endereço do servidor de RPC. Somente as interfaces de IDL que contêm uma matriz de variação em não conformidade são afetadas por esse problema.
...
A atualização elimina a vulnerabilidade, corrigindo a maneira como o Mecanismo de Organização de RPC atualiza seu estado interno.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2009-0568](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0568) da lista Common Vulnerability and Exposure.
...
<td style="border:1px solid black;">Para Microsoft Windows 2000 Service Pack 4:<br />
Use a ferramenta <strong>Adicionar ou remover programas</strong>, no Painel de controle, ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB970238$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/970238">Artigo 970238 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou remover programas</strong>, no Painel de controle, ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB970238$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/??????">Artigo 970238 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave do Registro</strong></td>
