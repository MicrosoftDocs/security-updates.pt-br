...
ms:assetid: 'ms09-027'
ms:contentKeyID: 61234008
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-027(v=Security.10)'
---
Microsoft Security Bulletin MS09-027 - Crítica
==============================================

Vulnerabilidades no Microsoft Office Word podem permitir a execução remota de código (969514)
---------------------------------------------------------------------------------------------
...
Esta atualização de segurança elimina duas vulnerabilidades relatadas em particular que podem permitir a execução remota de código se um usuário abrir um arquivo do Word especialmente criado. O invasor que explorar com êxito uma dessas vulnerabilidades poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.

Esta atualização de segurança é classificada como Crítica para todas as edições do Microsoft Office Word 2000 com suporte. Para todas as edições com suporte do Microsoft Office Word 2002, Microsoft Office Word 2003, Microsoft Office Word 2007, Microsoft Office 2004 for Mac e Microsoft Office 2008 for Mac e para todas as versões com suporte do Open XML File Format Converter for Mac, Pacote de Compatibilidade do Microsoft Office e Microsoft Office Word Viewers, esta atualização de segurança é classificada como Importante. Para obter mais informações, consulte a subseção **Software afetado e não afetado** nesta seção

A atualização elimina a vulnerabilidade, modificando a forma como o Word abre e analisar os arquivos. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.

**Recomendação.** A Microsoft recomenda que os clientes apliquem a atualização imediatamente.

**Problemas conhecidos.** O [Artigo 969514 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/969514) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas. Quando problemas atualmente conhecidos e soluções recomendadas pertencem somente a lançamentos específicos deste software, este artigo fornece links para outros artigos.
...
<tr>
<td style="border:1px solid black;">
[Pacote de compatibilidade do Microsoft Office para formatos de arquivos do Word, Excel e PowerPoint 2007 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=63bd8f14-e736-46ce-af66-d30f17461e5a)  
(KB969613)
</td>
<td style="border:1px solid black;">
Não Aplicável
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Pacote de compatibilidade do Microsoft Office para formatos de arquivos do Word, Excel e PowerPoint 2007 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=63bd8f14-e736-46ce-af66-d30f17461e5a)  
(KB969613)
</td>
<td style="border:1px solid black;">
Não Aplicável
...
O [Artigo 969514 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/969514) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas. Quando problemas atualmente conhecidos e soluções recomendadas pertencem somente a lançamentos específicos deste software, este artigo fornece links para outros artigos.

**Os boletins MS09-017 e MS09-021 também descrevem as vulnerabilidades no Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac e Open XML File Format Converter for Mac. Como os boletins MS09-017 e MS09-021 estão relacionados a este boletim (MS09-027)?** 
 Os pacotes de atualização de segurança neste boletim, MS09-027, para Microsoft Office 2004 for Mac (KB969661), Microsoft Office 2008 for Mac (KB971822) e Open XML File Format Converter for Mac (KB971824) também abordam as vulnerabilidades descritas nos boletins [MS09-017](http://go.microsoft.com/fwlink/?linkid=141704) e [MS09-021](http://go.microsoft.com/fwlink/?linkid=147294). Os usuários com Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac ou Open XML File Format Converter for Mac instalado terão que instalar esta atualização segurança, mas somente precisarão instalá-la uma vez.
...
<th style="border:1px solid black;" >
Vulnerabilidade de saturação de buffer do Word - CVE-2009-0563
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de saturação de buffer do Word - CVE-2009-0565
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-0563](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0563).

#### Fatores atenuantes da vulnerabilidade de saturação do buffer do Word - CVE-2009-0563
...
#### Soluções alternativas para a vulnerabilidade de saturação do buffer do Word - CVE-2009-0563
...
#### Perguntas frequentes sobre a vulnerabilidade de saturação do buffer do Word - CVE-2009-0563
...
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-0565](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0565).

#### Fatores atenuantes da vulnerabilidade de saturação do buffer do Word - CVE-2009-0565
...
#### Soluções alternativas para a vulnerabilidade de saturação do buffer do Word - CVE-2009-0565
...
#### Perguntas frequentes sobre a vulnerabilidade de saturação do buffer do Word - CVE-2009-0565
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/969600">Artigo 969600 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/969602">Artigo 969602 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Para Word 2003:<br />
Consulte o <a href="http://support.microsoft.com/kb/969603">Artigo 969603 (em inglês) da Microsoft Knowledge Base</a><br />
<br />
Para Word Viewer 2003 e Word Viewer:<br />
Consulte o <a href="http://support.microsoft.com/kb/969614">Artigo 969614 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
#### Word 2007 (todas as edições) e Pacote de compatibilidade do Microsoft Office para formatos de arquivos do Word, Excel e PowerPoint 2007
...
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Para Word 2007:<br />
Consulte o <a href="http://support.microsoft.com/kb/969604">Artigo 969604 (em inglês) da Microsoft Knowledge Base</a><br />
<br />
Para Pacote de compatibilidade do Microsoft Office para formatos de arquivo do Word, Excel e PowerPoint 2007:<br />
Consulte o <a href="http://support.microsoft.com/kb/969613">Artigo 969613 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
-   Wushi da [team509](http://www.team509.com/), que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/), por relatar a vulnerabilidade de saturação de buffer do Word (CVE-2009-0563)  
-   Nicolas Joly da [VUPEN Security](http://www.vupen.com/) por relatar a vulnerabilidade de saturação de buffer do Word (CVE-2009-0565)
