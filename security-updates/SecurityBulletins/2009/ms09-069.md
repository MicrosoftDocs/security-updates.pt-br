...
ms:assetid: 'ms09-069'
ms:contentKeyID: 61234049
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-069(v=Security.10)'
---

Microsoft Security Bulletin MS09-069 - Importante
=================================================

Vulnerabilidade no LSASS (Local Security Authority Subsystem Service) pode permitir negação de serviço (974392)
---------------------------------------------------------------------------------------------------------------
...
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular no Microsoft Windows. A vulnerabilidade poderá permitir a negação de serviço se um invasor autenticado remoto enviar uma mensagem ISAKMP ao se comunicar por meio do protocolo IPsec para LSASS em um sistema afetado.

Esta atualização de segurança foi classificada como Importante para todas as edições com suporte do Microsoft Windows 2000, Windows XP e Windows Server 2003. Para obter mais informações, consulte a subseção **Software afetado e não afetado** nesta seção.

A atualização de segurança elimina a vulnerabilidade, mudando o modo como o LSASS administra as solicitações especialmente criadas. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=560e01db-5f59-4ef1-9406-f5d7e0fd4128)                         | Negação de Serviço         | Importante                      | [MS06-025](http://technet.microsoft.com/security/bulletin/ms06-025) |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=5448b168-6bf7-4bae-9627-b88d76c4d5c5)         | Negação de Serviço         | Importante                      | Nenhuma                                                             |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c2bbf515-f81a-436b-947b-cbf2db85fdd9)            | Negação de Serviço         | Importante                      | Nenhuma                                                             |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a779aae1-7724-4458-94fb-a2343356ecae)                            | Negação de Serviço         | Importante                      | Nenhuma                                                             |
| [Microsoft Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a8a9bf12-4ad6-49fd-b2b7-f379dc3309d2)      | Negação de Serviço         | Importante                      | Nenhuma                                                             |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=f5b003ad-af25-488a-91fb-98835a0bfeac) | Negação de Serviço         | Importante                      | Nenhuma                                                             |
...
<th style="border:1px solid black;" >
Vulnerabilidade de esgotamento de recursos no serviço LSASS - CVE-2009-3675
</th>
<th style="border:1px solid black;" >
...
Existe uma vulnerabilidade de negação de serviço no Microsoft Windows devido à maneira que o LSASS (Local Security Authority Subsystem Service) manipula incorretamente as mensagens de ISAKMP especialmente criadas ao se comunicar por IPsec.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-3675](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3675).

#### Fatores atenuantes para a Vulnerabilidade de esgotamento de recursos no LSASS - CVE-2009-3675

A Microsoft não identificou nenhum fator atenuante para essa vulnerabilidade.

#### Soluções alternativas sobre a Vulnerabilidade de esgotamento de recursos no LSASS - CVE-2009-3675

A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:

-   Desabilite o serviço IPsec

    Você pode desabilitar o serviço IPsec se não estiver em uso.
    ...
    **Observação:** o uso incorreto do Editor do Registro pode causar problemas sérios e pode ser necessário reinstalar o sistema operacional. A Microsoft não garante que os problemas resultantes do uso incorreto do Editor do Registro possam ser solucionados. Você é responsável pelo uso do Editor do Registro. Para obter informações sobre como editar o Registro, consulte o tópico da Ajuda "Alterar chaves e valores" do Editor do Registro (Regedit.exe) ou exiba os tópicos da Ajuda "Adicionar e excluir informações no Registro" e "Editar informações do Registro" no Regedt32.exe.
    ...
    -   **Usando o método interativo**
        ...
        3.  Expanda **Sistema**, **CurrentControlSet** e **Serviços**.
        4.  Clique na chave **PolicyAgent**
        5.  Crie um backup da chave do Registro, fazendo o seguinte:
            No menu Arquivo, clique em **Exportar**.
            Na caixa de diálogo Exportar Arquivo do Registro, digite **PolicyAgent\_configuration\_backup.reg** e clique em **Salvar**.
        6.  Na chave **PolicyAgent**, clique duas vezes no valor chamado **Iniciar**.
        7.  Mude o campo **Dados do valor** para **4**.
        8.  Clique em **OK**.
        9.  Como administrador, execute o comando a seguir a partir de um prompt de comando:
    ...
    -   **Usando um script de implantação gerenciado**
        ...
        2.  Salve o seguinte em um arquivo com extensão .REG (por exemplo: Disable\_PolicyAgent.reg):
        ...
        5.  Crie um backup da chave do Registro, fazendo o seguinte:
            No menu Arquivo, clique em **Exportar**.
            Na caixa de diálogo Exportar Arquivo do Registro, digite **PolicyAgent\_configuration\_backup.reg** e clique em **Salvar**.
        6.  Execute o script de Registro criado na etapa 2 no sistema de destino com o seguinte comando:
            Regedit /s Disable\_PolicyAgent.reg
        7.  Mude o campo **Dados do valor** para **4**.
        8.  Clique em **OK**.
        9.  Execute o seguinte comando em um prompt que esteja executando como um administrador no sistema de destino:
            net stop PolicyAgent

    **Impacto da solução alternativa.** O computador específico não poderá usar IPsec.
...
-   **Usando o método interativo**
    ...
    3.  Na caixa de diálogo Importar Arquivo do Registro, selecione **PolicyAgent\_configuration\_backup.reg** e clique em **Abrir**.
...
#### Perguntas frequentes sobre a Vulnerabilidade de esgotamento de recursos no LSASS - CVE-2009-3675

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de negação de serviço (site em inglês). Um invasor autenticado remoto poderia enviar uma mensagem de ISAKMP especialmente criada ao se comunicar por IPsec com o servidor, o que faria com que o arquivo LSASS.exe consumisse recursos do sistema, resultando em uma negação de serviço que poderia persistir até o servidor ser reinicializado.

**O que provoca a vulnerabilidade?**  
Existe uma vulnerabilidade porque LSASS não manipula corretamente mensagens de ISAKMP especialmente criadas com pacotes malformados.

**O que é IPsec?**  
IPsec (Internet Protocol Security) é uma estrutura de padrões abertos para proteger comunicações seguras e privadas por redes IP pelo uso de serviços criptográficos de segurança. O IPsec oferece suporte à autenticação ponto a ponto em nível de rede, autenticação de origem de dados, integridade de dados, confidencialidade de dados (criptografia) e proteção de repetição. A implementação do IPsec pela Microsoft é baseada em padrões desenvolvidos pelo grupo de trabalho Internet Engineering Task Force (IETF).
...
**O que é IKE?**  
IKE é um padrão de Internet, definido no RFC 2409, que descreve um mecanismo para estabelecer IPSec SAs (Security Associations). Uma SA é uma combinação de chaves e de diretiva mutuamente acordadas que define os serviços de segurança e mecanismos que ajudam a proteger a comunicação entre os mesmos níveis IPsec. Especificamente, o IKE combina o protocolo ISAKMP no RFC 2408 e o Protocolo de Determinação de Chaves Oakley no RFC 2412
O IKE usa o protocolo Oakley para gerar material de chave secreto para comunicações protegidas. O IKE usa ISAKMP para negociar SAs.

**O que é uma mensagem de ISAKMP?**  
ISAKMP é uma estrutura para negociar a comunicação protegida independente dos protocolos de troca de chave específica, criptografia e algoritmos de integridade e métodos de autenticação. O ISAKMP inclui instalações para identificar e autenticar níveis, gerenciar SAs e trocar material de chave.

**Para que um invasor pode usar a vulnerabilidade?**  
Um invasor que explorar com êxito esta vulnerabilidade pode fazer com que um sistema afetado consuma os recursos de CPU e pare de responder até o reinício.

**De que forma o invasor pode explorar a vulnerabilidade?**  
Um invasor pode explorar essa vulnerabilidade, enviando uma mensagem de ISAKMP especialmente criada enquanto está conectado e autenticado em um servidor LSASS sobre IPsec.

**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**  
Os servidores que solicitam ou exigem comunicação de IPsec com clientes são os que estão mais expostos à vulnerabilidade.

**O que a atualização faz?**  
Esta atualização muda a maneira como o LSASS manipula solicitações de ISAKMP especialmente criadas.
...
| **Implantação**                       |                                                                                                                                                                       |
| Instalar sem intervenção do usuário   | Windows2000-KB974392-x86-ENU /quiet                                                                                                                                   |
| Instalar sem reinicializar            | Windows2000-KB974392-x86-ENU /norestart                                                                                                                               |
| Arquivo de log de atualização         | KB974392.log                                                                                                                                                          |
...
| **Informações sobre remoção**         | Use a ferramenta **Adicionar ou Remover Programas** no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB974392$\\Spuninst |
| **Informações sobre o arquivo**       | Consulte o [Artigo 974392 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/974392)                                                            |
| **Verificação da Chave do Registro**  | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB974392\\Filelist                                                                             |
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB974392$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/974392">Artigo 974392 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
