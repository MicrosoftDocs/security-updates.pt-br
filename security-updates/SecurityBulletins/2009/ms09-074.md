...
ms:assetid: 'ms09-074'
ms:contentKeyID: 61234054
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-074(v=Security.10)'
---

Microsoft Security Bulletin MS09-074 - Crítica
==============================================

Vulnerabilidade no Microsoft Office Project pode permitir a execução remota de código (967183)
----------------------------------------------------------------------------------------------
...
Esta atualização de segurança é classificada como Crítica para o Microsoft Project 2000 Service Release 1 e como Importante para o Microsoft Project 2002 Service Pack 1 e Microsoft Office Project 2003 Service Pack 3. Para obter mais informações, consulte a subseção Softwares afetados e não afetados, nesta seção.

A atualização elimina a vulnerabilidade, modificando a maneira como o Microsoft Office Project valida as alocações de memória ao abrir arquivos do Project do disco para a memória. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
<th style="border:1px solid black;" >
Vulnerabilidade de validação de memória do Project - CVE-2009-0102  
</th>
<th style="border:1px solid black;" >
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Office Project lida com arquivos do Project especialmente criados. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-0102](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0102).

#### Fatores atenuantes da vulnerabilidade de validação de memória do Project - CVE-2009-0102
...
#### Soluções alternativas para a vulnerabilidade de validação de memória do Project - CVE-2009-0102

A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:

-   Não abra arquivos do Project (tais como arquivos com uma extensão .mpp) recebidos de fontes não confiáveis ou que você receba inesperadamente de fontes confiáveis. Essa vulnerabilidade pode ser explorada quando o usuário abre um arquivo especialmente criado.

#### Perguntas frequentes sobre a vulnerabilidade de validação de memória do Project - CVE-2009-0102
...
O Microsoft Office Project não valida corretamente as alocações de recurso da memória ao abrir arquivos do Project.
...
Essa vulnerabilidade requer que um usuário abra um arquivo malformado do Project com uma versão afetada do Microsoft Office Project.
...
Em um cenário de ataque com base na Web, um invasor deve hospedar um site que contenha um arquivo do Project usado para tentar explorar essa vulnerabilidade. Além disso, sites comprometidos e sites que aceitem ou hospedem conteúdo fornecido pelo usuário podem conter conteúdo especialmente desenvolvido que pode explorar esta vulnerabilidade. Não há como um invasor forçar usuários a visitar o site especialmente criado. Em vez disso, o invasor terá que convencê-los a visitar o site, normalmente fazendo com que cliquem em um link que leve para o site do invasor.

**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**  
Os sistemas, tais como estações de trabalho e servidores de terminal, nos quais as versões afetadas do Project do Microsoft Office são usadas são os que mais correm risco. Os servidores correm mais riscos se os administradores permitirem que os usuários façam logon em servidores e executem programas. Entretanto, as práticas recomendadas não recomendam esse procedimento.

**O que a atualização faz?**  
A atualização elimina a vulnerabilidade, modificando a maneira como o Microsoft Office Project valida as alocações de memória ao abrir arquivos do Project especialmente criados.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/961083">Artigo 961083 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/961079">Artigo 961079 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/961082">Artigo 961082 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
-   Bing Liu, da [Fortinet's FortiGuard Labs](http://www.fortiguard.com), por relatar a vulnerabilidade de validação de memória do Project (CVE-2009-0102)
