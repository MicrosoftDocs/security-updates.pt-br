...
ms:assetid: 'ms09-001'
ms:contentKeyID: 61233982
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-001(v=Security.10)'
---

Microsoft Security Bulletin MS09-001 - Crítica
==============================================

Vulnerabilidades no SMB podem permitir a execução remota de código (958687)
---------------------------------------------------------------------------
...
Esta atualização de segurança é classificada como Crítica para todas as edições com suporte do Microsoft Windows 2000, Windows XP e Windows Server 2003 e como Moderada para todas as edições com suporte do Windows Vista e do Windows Server 2008. Para obter mais informações, consulte a subseção **Software afetado e não afetado**, nesta seção.

A atualização de segurança corrige as vulnerabilidades validando os campos dentro dos pacotes SMB. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=e0678d14-c1b5-457a-8222-8e7682760ed4)                                                                                         | Execução Remota de Código  | Crítica                         | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=eeafcdc5-df39-4b29-b6f1-7d32b64761e1)                                                                         | Execução Remota de Código  | Crítica                         | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=26898401-f669-4542-ad93-199ed1fe9a2a)                                      | Execução Remota de Código  | Crítica                         | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Server 2003 Service Pack 1 e Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=588ca8e8-38a9-47ed-9c41-09aaf1022e49)                                                       | Execução Remota de Código  | Crítica                         | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Server 2003 x64 Edition e Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ee59441c-1e8f-4425-ae8d-dec14e7f13fb)                                              | Execução Remota de Código  | Crítica                         | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Server 2003 com SP1 para sistemas baseados no Itanium e Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=caec9321-fa5b-42f0-9f26-61f673fe6eef) | Execução Remota de Código  | Crítica                         | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Vista e Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=9179c463-c10a-452a-990f-b7e37cdd889b)                                                                                  | Execução Remota de Código  | Moderada                        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Vista x64 Edition e Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6b26952e-b59d-4b0f-a52d-025e45ecd233)                                                          | Execução Remota de Código  | Moderada                        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=7245b411-7c9e-41e5-9841-4c586336086c)\*                                                                                | Execução Remota de Código  | Moderada                        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Server 2008 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=a241eaad-95a0-442b-978f-f21a6f0c7db4)\*                                                                           | Execução Remota de Código  | Moderada                        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
| [Windows Server 2008 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ab7c7015-20bb-4a0c-977a-969f4e2a5189)                                                                         | Execução Remota de Código  | Moderada                        | [MS08-063](http://technet.microsoft.com/security/bulletin/ms08-063) |
...
Informações detalhadas sobre o arquivo podem ser encontradas no [Artigo 958687 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/958687).
...
<th style="border:1px solid black;" >Vulnerabilidade de execução remota de código de saturação de buffer do SMB - CVE-2008-4834</th>
<th style="border:1px solid black;" >Vulnerabilidade de execução remota de código de validação do SMB - CVE-2008-4835</th>
<th style="border:1px solid black;" >Vulnerabilidade de negação de serviço de validação do SMB - CVE-2008-4114</th>
...
Vulnerabilidade de execução remota de código de saturação de buffer do SMB - CVE-2008-4834  
------------------------------------------------------------------------------------------
  

Uma vulnerabilidade não-autenticada de execução remota de código existe na maneira como esse software de protocolo SMB (Server Message Block) da Microsoft manipula pacotes SMB especialmente criados. Uma tentativa de explorar a vulnerabilidade não requereria autenticação, permitindo a um invasor explorar a vulnerabilidade enviando uma mensagem de rede especialmente criada a um computador executando o serviço Servidor. Um invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total do sistema. A maioria das tentativas de exploração dessa vulnerabilidade resultaria em uma condição de negação de serviço do sistema, entretanto a execução remota de código é teoricamente possível.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-4834](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4834).
  
#### Fatores atenuantes da vulnerabilidade de execução remota de código de saturação de buffer do SMB - CVE-2008-4834
...
-   O Windows Vista e Windows Server 2008 não são afetados por esta vulnerabilidade.
  
#### Soluções alternativas para a vulnerabilidade de execução remota de código de saturação de buffer do SMB - CVE-2008-4834
...
#### Perguntas freqüentes sobre a vulnerabilidade de execução remota de código de saturação de buffer do SMB - CVE-2008-4834
...
A vulnerabilidade é causada pela validação insuficiente do tamanho do buffer antes de gravá-lo feita pelo software de protocolo SMB (Server Message Block) da Microsoft.
...
Todos os sistemas com serviço de servidor SMB são afetados por essa vulnerabilidade. Os controladores de domínio correm mais risco com essa vulnerabilidade do que estações de trabalho ou outros servidores.
  
**O que a atualização faz?**    
A atualização de segurança corrige as vulnerabilidades validando os campos dentro dos pacotes SMB.
...
Vulnerabilidade de execução remota de código de validação do SMB - CVE-2008-4835  
--------------------------------------------------------------------------------
  

Uma vulnerabilidade não-autenticada de execução remota de código existe na maneira como esse software de protocolo SMB (Server Message Block) da Microsoft manipula pacotes SMB especialmente criados. Uma tentativa de explorar a vulnerabilidade não requereria autenticação, permitindo a um invasor explorar a vulnerabilidade enviando uma mensagem de rede especialmente criada a um computador executando o serviço Servidor. Um invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total do sistema afetado. A maioria das tentativas de exploração dessa vulnerabilidade resultaria em uma condição de negação de serviço do sistema, entretanto a execução remota de código é teoricamente possível.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-4835](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4835).
  
#### Fatores atenuantes da vulnerabilidade de execução remota de código de validação do SMB - CVE-2008-4835
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   As práticas recomendadas para firewall e as configurações de firewall padrão podem ajudar a proteger as redes contra ataques com origem externa ao perímetro da empresa. Essas práticas também recomendam que os sistemas conectados à Internet tenham um número mínimo de portas expostas. Nesse caso, as portas SMB devem ser impedidas de acessar a Internet.  
-   Todas as edições com suporte do Windows Vista e Windows Server 2008 possuem compartilhamento de arquivos desativado por padrão, reduzindo a exposição dessas plataformas a esta vulnerabilidade. Esta configuração padrão, que é uma alteração das plataformas anteriores, resulta em uma área de ataque reduzida para o Windows Vista e o Windows Server 2008 e reduz a classificação de gravidade nessas plataformas como Moderada para essa vulnerabilidade.
  
#### Soluções alternativas para a vulnerabilidade de execução remota de código de validação do SMB - CVE-2008-4835
...
#### Perguntas freqüentes sobre a vulnerabilidade de execução remota de código de validação do SMB - CVE-2008-4835
...
**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**    
Todos os sistemas com serviço de servidor SMB são afetados por essa vulnerabilidade. Os controladores de domínio correm mais risco com essa vulnerabilidade.
...
Vulnerabilidade de negação de serviço de validação do SMB - CVE-2008-4114  
-------------------------------------------------------------------------
  

Uma vulnerabilidade de negação de serviço existe na maneira como esse software de protocolo SMB (Server Message Block) da Microsoft manipula pacotes SMB especialmente criados. Uma tentativa de explorar a vulnerabilidade não requereria autenticação, permitindo a um invasor explorar a vulnerabilidade enviando uma mensagem de rede especialmente criada a um computador executando o serviço Servidor. O invasor que explorar com êxito essa vulnerabilidade poderá fazer com que o computador pare de responder e reinicie.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-4114](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4114).
  
#### Fatores atenuantes da vulnerabilidade de negação de serviço de validação do SMB - CVE-2008-4114
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   As práticas recomendadas para firewall e as configurações de firewall padrão podem ajudar a proteger as redes contra ataques com origem externa ao perímetro da empresa. Essas práticas também recomendam que os sistemas conectados à Internet tenham um número mínimo de portas expostas. Nesse caso, as portas SMB devem ser impedidas de acessar a Internet.  
-   Todas as edições com suporte do Windows Vista e Windows Server 2008 possuem compartilhamento de arquivos desativado por padrão, reduzindo a exposição dessas plataformas a esta vulnerabilidade. Esta configuração padrão, que é uma alteração das plataformas anteriores, resulta em uma área de ataque reduzida para o Windows Vista e o Windows Server 2008.
  
#### Soluções alternativas para a vulnerabilidade de negação de serviço de validação do SMB - CVE-2008-4114
...
#### Perguntas freqüentes sobre a vulnerabilidade de negação de serviço de validação do SMB - CVE-2008-4114
...
**Para que um invasor pode usar a vulnerabilidade?**    
O invasor que explorar essa vulnerabilidade com êxito poderá fazer com que o sistema afetado pare de responder e reinicie.
...
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2008-4114](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4114) da lista Common Vulnerability and Exposure.
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB958687$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/958687">artigo 958687 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB958687$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/958687">artigo 958687 (em inglês) da Microsoft Knowledge Base</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB958687$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/958687">artigo 958687 (em inglês) da Microsoft Knowledge Base</a></td>
...
-   Um pesquisador anônimo, que trabalha com a [TippingPoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), por relatar a vulnerabilidade de execução remota de código de saturação de buffer do SMB (CVE-2008-4834)  
-   Um pesquisador anônimo, que trabalha com a [TippingPoint](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/), por relatar a vulnerabilidade de execução remota de código de validação do SMB (CVE-2008-4835)
