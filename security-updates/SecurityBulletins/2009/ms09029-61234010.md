...
ms:assetid: 'ms09-029'
ms:contentKeyID: 61234010
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-029(v=Security.10)'
---
...
As vulnerabilidades no Mecanismo de Fonte OpenType Incorporada podem permitir a execução remota de código (961371)
------------------------------------------------------------------------------------------------------------------

Publicado: terça-feira, 14 de julho de 2009 | Atualizado: terça-feira, 25 de agosto de 2009
...
Esta atualização de segurança elimina duas vulnerabilidades relatadas em particular no componente do Microsoft Windows, Mecanismo de Fonte OpenType Incorporada (EOT). Essas vulnerabilidades podem permitir a execução remota de código. O invasor que explorar com êxito qualquer uma dessas vulnerabilidades poderá obter remotamente o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
...
**Problemas conhecidos.** O [Artigo 961371 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/961371) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=1efbbd95-cd72-43df-b1ce-7e2b0c0cb9e2)                                                                                        | Execução Remota de Código  | Crítica                         | [MS06-002](http://technet.microsoft.com/security/bulletin/ms06-002) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6914167b-6961-480c-a4d4-808cd58a035b)                                                                                                    | Execução Remota de Código  | Crítica                         | [MS06-002](http://technet.microsoft.com/security/bulletin/ms06-002) |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6914167b-6961-480c-a4d4-808cd58a035b)                                                                                                    | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3b8b019e-e6d8-4ce2-8f1f-3a6399b252d1)                                                                           | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=018ef53d-f78e-4084-940d-7c86bf59d83c)                                                                                           | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Microsoft Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7f5fc902-f5d8-4a87-a73f-68632f9a0935)                                                                     | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=7df0fce2-543c-4e82-85e6-012bfc8bf130)                                                                | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Vista, Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c67d85c4-25c5-4821-8db9-91764888f893)                                                   | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3f8ae651-59f7-48e1-9e8c-8e07c6806964)               | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=91f6ee68-0e39-4ec3-b4cd-45f05404e2fb)\*                 | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5cdc3014-97b3-47b5-a6b7-cd0e12ec60e4)\*       | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=03330a14-9cfa-4146-a3d3-4b7a76975d2d) | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
...
<span></span>
**Por que este boletim foi revisado em 25 de agosto de 2009?**
A Microsoft revisou este boletim para comunicar o relançamento da atualização no idioma japonês para todas as edições com suporte do Windows XP para corrigir um problema de qualidade que pode fazer com que o spooler de impressão pare de responder. Os clientes que instalaram a atualização no idioma japonês para Windows XP Service Pack 2, Windows XP Service Pack 3 ou Windows XP Professional x64 Edition Service Pack 2 precisam instalar a atualização, que volta a ser oferecida automaticamente, para corrigir o problema de spooler descrito acima e para manter a correção da vulnerabilidade descrita neste boletim. Nenhuma outra atualização ou local são afetados por este relançamento.

**Por que este boletim foi relançado em 11 de agosto de 2009?**
A Microsoft relançou este boletim para oferecer novamente atualizações para as seguintes plataformas:
...
As atualizações de segurança revisadas corrigem um problema nas atualizações de segurança originais que podiam fazer com que o spooler de impressão parasse de responder em determinadas situações. As atualizações revisadas estão disponíveis pelos mesmos canais de distribuição das atualizações originais, incluindo as Atualizações Automáticas, Windows Update e Windows Server Update Services. No entanto, as atualizações revisadas não serão oferecidas automaticamente aos clientes do Windows XP que já instalaram as atualizações originais, sendo necessário instalar as atualizações novas manualmente do Centro de Download da Microsoft. As novas atualizações serão oferecidas automaticamente aos clientes do Microsoft Windows 2000 e Windows Server 2003, mesmo se eles tiverem instalado anteriormente as atualizações originais. Os clientes que estão executando alguma das plataformas de software afetadas podem baixar e instalar as atualizações novas manualmente. A Microsoft recomenda que os clientes apliquem a atualização imediatamente.

Para obter mais informações sobre esse problema, consulte o [Artigo 961371 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/961371).
...
**A versão Beta do Windows 7 é afetada por esta vulnerabilidade?**  
Sim. Esta vulnerabilidade foi reportada depois do lançamento do Windows 7 Beta. Recomendamos que os clientes que estejam executando essa plataforma baixem e apliquem a atualização a seus sistemas.

As atualizações de segurança estão disponíveis no Microsoft Update e no Windows Update.
...
<th style="border:1px solid black;" >Vulnerabilidade de estouro de heap da Fonte OpenType Incorporada - CVE-2009-0231</th>
<th style="border:1px solid black;" >Vulnerabilidade de estouro de número inteiro da Fonte OpenType Incorporada - CVE-2009-0232</th>
...
Vulnerabilidade de estouro de heap da Fonte OpenType Incorporada - CVE-2009-0231  
--------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como a tecnologia de Fonte OpenType Incorporada (EOT) do Microsoft Windows analisa registros de dados em fontes incorporadas especialmente criadas. Se um usuário tiver feito logon com direitos administrativos, o invasor que explorar com êxito essa vulnerabilidade poderá ter o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-0231](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0231).
  
#### Fatores atenuantes da Vulnerabilidade de estouro de heap da Fonte OpenType Incorporada - CVE-2009-0231
...
#### Soluções alternativas para a Vulnerabilidade de estouro de heap da Fonte OpenType Incorporada - CVE-2009-0231
...
-   [Ferramentas e configurações principais da Diretiva de Grupo](http://technet2.microsoft.com/windowsserver/en/library/e926577a-5619-4912-b5d9-e73d4bdc94911033.mspx?mfr=true)
    ...
    7.  Pressione **OK** para retornar à caixa de diálogo Propriedades da Internet.  
    8.  Repita estas etapas para a zona **Intranet Local**.  
    9.  Pressione **OK** três vezes para retornar ao console de gerenciamento de Diretiva de Grupo.  
...
#### Perguntas frequentes sobre a Vulnerabilidade de estouro de heap da Fonte OpenType Incorporada - CVE-2009-0231
...
A vulnerabilidade é causada por um estouro do buffer quando o componente do Microsoft Windows, Mecanismo de Fonte OpenType Incorporada, analisa tabelas de nomes dentro de arquivos e conteúdos especialmente criados que contêm fontes incorporadas.
...
Em um cenário de ataque por email, um invasor pode explorar a vulnerabilidade enviando um email com um arquivo do Microsoft Word ou PowerPoint que contém fonte EOT especialmente criada incorporada ao documento e convencendo o usuário a abrir ou visualizar o arquivo.
...
Vulnerabilidade de estouro de número inteiro da Fonte OpenType Incorporada - CVE-2009-0232  
------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como a tecnologia de Fonte OpenType Incorporada (EOT) do Microsoft Windows analisa tabelas de nomes em fontes incorporadas especialmente criadas. Se um usuário tiver feito logon com direitos administrativos, o invasor que explorar com êxito essa vulnerabilidade poderá ter o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-0232](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0232).
  
#### Fatores atenuantes da Vulnerabilidade de estouro de número inteiro da Fonte OpenType Incorporada - CVE-2009-0232
...
#### Soluções alternativas para a Vulnerabilidade de estouro de número inteiro da Fonte OpenType Incorporada - CVE-2009-0232
...
#### Perguntas frequentes sobre a Vulnerabilidade de estouro de número inteiro da Fonte OpenType Incorporada - CVE-2009-0232
  
**Qual é o escopo da vulnerabilidade?**    
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito essa vulnerabilidade poderá assumir remotamente o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada por um estouro de número inteiro quando o componente do Microsoft Windows, Mecanismo de Fonte OpenType Incorporada, analisa tabelas de nomes dentro de arquivos e conteúdos especialmente criados com fontes incorporadas.
...
Em um cenário de ataque por email, um invasor pode explorar a vulnerabilidade enviando um email com um arquivo do Microsoft Word ou PowerPoint que contém fonte EOT especialmente criada anexada e convencendo o usuário a abrir ou visualizar o arquivo.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong>, no Painel de Controle, ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB961371$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/961371">Artigo 961371 (em inglês) da Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   [VeriSign iDefense Labs](http://labs.idefense.com/), por reportar a vulnerabilidade de estouro de heap da Fonte OpenType Incorporada (CVE-2009-0231)  
-   Thomas Garnier por reportar a Vulnerabilidade de estouro de número inteiro da Fonte OpenType Incorporada (CVE-2009-0232)
...
-   V1.1 (15 de julho de 2009): Foram atualizadas as descrições de requisito de reinicialização para todas as atualizações na seção **Informações da atualização** para esclarecer que, em alguns casos, esta atualização não exige reinicialização.  
-   V1.2 (4 de agosto de 2009): Foi adicionado um link para o Artigo 961371 (em inglês) da Microsoft Knowledge Base em Problemas conhecidos, na Sinopse, e referências à solução "Fix it" foram removidas das seções de soluções alternativas de ambas as vulnerabilidades.  
-   V2.0 (11 de agosto de 2009): O boletim relançou para oferecer novamente as atualizações para todas as edições com suporte do Microsoft Windows 2000, Windows XP e Windows Server 2003. O objetivo é eliminar um problema conhecido nas atualizações originais para essas plataformas. A Microsoft recomenda que os clientes apliquem a atualização imediatamente.  
-   V2.1 (13 de agosto de 2009): O boletim foi revisado para esclarecer a entrada "Por que este boletim foi relançado em 11 de agosto de 2009?" na seção **Perguntas frequentes relacionadas a esta atualização de segurança**, e corrigir os nomes de arquivo das atualizações relançadas na seção **Implantação de atualização de segurança**.  
-   V3.0 (25 de agosto de 2009): Uma entrada foi adicionada à seção, **Perguntas frequentes relacionadas a esta atualização de segurança** para comunicar o relançamento da atualização no idioma japonês para Windows XP Service Pack 2, Windows XP Service Pack 3 e Windows XP Professional x64 Edition Service Pack 2. Os clientes que requerem a atualização no idioma japonês precisam instalar a atualização relançada. Nenhuma outra atualização ou local são afetados por este relançamento.
