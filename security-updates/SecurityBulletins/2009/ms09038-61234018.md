...
ms:assetid: 'ms09-038'
ms:contentKeyID: 61234018
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-038(v=Security.10)'
---

Microsoft Security Bulletin MS09-038 - Crítica
==============================================

Vulnerabilidades no processamento de arquivos do Windows Media podem permitir a execução remota de código (971557)
------------------------------------------------------------------------------------------------------------------
...
A atualização de segurança elimina as vulnerabilidades, corrigindo a maneira como os cabeçalhos AVI são processados e corrigindo como os dados AVI são validados. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=5f80bf0b-898c-46ca-b20c-21e0e729c332)                                                                                        | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=2e8a68ee-eb24-424c-b084-450636ccaeec)                                                                        | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a1ff2ace-b9dc-4cf3-a151-ac6959bcb3a6)                                                                           | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cba78658-899c-428f-8b04-cfe14ce3c255)                                                                                           | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Microsoft Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=58a7c8d9-ec36-46a6-a89b-d8dfd989fda4)                                                                     | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=187b02bd-73d6-4f72-81d1-d9477d495499)                                                                | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows Vista, Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=81fce7bd-f33c-4586-949d-ac40d415f755)                                                   | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a6cea61a-4ad9-4e18-bf18-348ae4ae51c4)               | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fdc96a07-ed79-4798-8077-b2e9ca64cd0f)\*                 | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8e3afba4-6761-4b3d-98bb-4b4145e27b7f)\*       | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aa1bb13a-5905-48c4-8e74-a41104593046) | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
...
<th style="border:1px solid black;" >Vulnerabilidade em cabeçalho AVI malformado - CVE-2009-1545</th>
<th style="border:1px solid black;" >Vulnerabilidade de estouro de número inteiro de AVI - CVE-2009-1546</th>
...
Vulnerabilidade em cabeçalho AVI malformado - CVE-2009-1545  
-----------------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Windows lida com arquivos no formato AVI especialmente criados. Essa vulnerabilidade pode permitir a execução de código quando um usuário abre um arquivo AVI especialmente criado. Se um usuário tiver feito logon com direitos administrativos, o invasor que explorar com êxito essa vulnerabilidade poderá ter o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-1545](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1545).
  
#### Fatores atenuantes da Vulnerabilidade de cabeçalho AVI malformado - CVE-2009-1545
...
#### Soluções alternativas para a Vulnerabilidade de cabeçalho AVI malformado - CVE-2009-1545
...
**Impacto da solução alternativa:** Os aplicativos que contam com a API AVIFile falharão ao renderizar o conteúdo do vídeo AVI corretamente
...
-   **Remova HKEY\_CLASSES\_ROOT\\CLSID\\{40C3D757-D6E4-4b49-BB41-0E5BBEA28817}**
  
A remoção deste Registro impedirá que o Windows Explorer visualize os arquivos AVI.
...
4.Na caixa de diálogo Exportar Arquivo do Registro, digite **Video\_Media\_Properties\_Handler\_Backup.reg** e clique em **Salvar**.  
...
4.Na caixa de diálogo Exportar Arquivo do Registro, digite **Video\_Media\_Properties\_Handler\_Backup1.reg** e clique em **Salvar**.  
**Observação** Isso criará um backup desta chave do Registro na pasta Meus Documentos por padrão.
  
5.Pressione a tecla **Delete** no teclado para excluir a chave do Registro. Quando solicitado a excluir a chave do Registro pela caixa de diálogo Confirmar Exclusão da Chave, clique **Sim**.
  
6.Clique em **Iniciar**, em **Executar**, digite **Regedit** na caixa **Abrir** e clique em **OK**.
...
9.Na caixa de diálogo Exportar Arquivo do Registro, digite **Video\_Media\_Properties\_Handler\_Backup2.reg** e clique em **Salvar**.  
**Observação** Isso criará um backup desta chave do Registro na pasta Meus Documentos por padrão.
...
**Impacto da solução alternativa:** O Windows Explorer não fornecerá uma imagem de visualização para arquivos AVI.
...
2.Depois, salve o seguinte em um arquivo com a extensão .REG como, por exemplo, Disable\_Video\_Media\_Properties\_handler.reg:  
**Para sistemas baseados em Windows de 32 bits:**  
...
#### Perguntas frequentes sobre a Vulnerabilidade de cabeçalho AVI malformado - CVE-2009-1545
...
O componente Windows responsável pelo processamento de arquivos AVI não trata arquivos AVI especialmente criados corretamente com cabeçalhos malformados.
  
**O que é um arquivo Audio Visual Interleave (AVI)?**  
AVI (Audio Video Interleave) é um caso especial do RIFF (Resource Interchange File Format). O formato de arquivo .avi é o formato de contêiner mais comum para dados de áudio e vídeo em um computador. Esse tipo de arquivo é usado com aplicativos que capturam, editam e reproduzem novamente as sequências de áudio e vídeo. Em general, arquivos AVI contêm vários fluxos de tipos de dados diferentes. A maioria de sequências de AVI usa fluxos de áudio e de vídeo. Uma variação simples para uma sequência de AVI usa os dados de vídeo e não exige um fluxo de áudio.
  
**O Windows Media Player é afetado por esta vulnerabilidade?**  
Não. O componente afetado é independente da versão do Windows Media Player instalado no sistema.
...
A exploração desta vulnerabilidade exige que um usuário abra um arquivo AVI especialmente criado ou receba conteúdo de fluxo especialmente criado de um site ou de qualquer aplicativo que forneça conteúdo da Web.
...
No Windows Vista e Windows Server 2008, um invasor pode explorar a vulnerabilidade, colocando um arquivo AVI especialmente criado em um sistema de arquivos e convencendo-o a navegar até o local do arquivo. Nessas plataformas, o Windows Explorer carrega a DLL afetada para fornecer uma miniatura e visualizar informações para arquivos AVI.
...
A atualização elimina a vulnerabilidade, corrigindo a maneira como os cabeçalhos AVI são processados.
...
Vulnerabilidade de estouro de número inteiro de AVI - CVE-2009-1546  
-------------------------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Windows lida com arquivos no formato AVI especialmente criados. Essa vulnerabilidade pode permitir a execução de código quando um usuário abre um arquivo AVI especialmente criado. Se um usuário tiver feito logon com direitos administrativos, o invasor que explorar com êxito essa vulnerabilidade poderá ter o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-1546](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1546).
  
#### Fatores atenuantes da Vulnerabilidade de estouro de número inteiro de AVI - CVE-2009-1546
...
#### Soluções alternativas para a Vulnerabilidade de estouro de número inteiro de AVI - CVE-2009-1546
...
#### Perguntas frequentes sobre a Vulnerabilidade de estouro de número inteiro de AVI - CVE-2009-1546
  
**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito essa vulnerabilidade poderá assumir remotamente o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**  
O componente Windows para processar arquivos AVI não valida dados corretamente em arquivos AVI especialmente criados.
...
**O que a atualização faz?**  
A atualização elimina a vulnerabilidade, corrigindo a maneira como os dados AVI são validados.
...
| **Implantação**                       |                                                                                                                                                                       |  
| Instalar sem intervenção do usuário   | Windows2000-kb971557-x86-enu /quiet                                                                                                                                   |  
| Instalar sem reinicializar            | Windows2000-kb971557-x86-enu /norestart                                                                                                                               |  
| Arquivo de log de atualização         | kb971557.log                                                                                                                                                          |  
...
| **Informações sobre remoção**         | Use a ferramenta **Adicionar ou Remover Programas** no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB971557$\\Spuninst |  
| **Informações sobre o arquivo**       | Consulte o [Artigo 971557 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/971557)                                                            |  
| **Verificação da Chave do Registro**  | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB971557\\Filelist                                                                             |
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB971557$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/971557">Artigo 971557 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Vinay Anantharaman da [Adobe Systems, Inc.](http://www.adobe.com/) por relatar a Vulnerabilidade de cabeçalho AVI malformado (CVE-2009-1545)  
-   Vinay Anantharaman da [Adobe Systems, Inc.](http://www.adobe.com/) por relatar a Vulnerabilidade de estouro de número inteiro AVI (CVE-2009-1546)
