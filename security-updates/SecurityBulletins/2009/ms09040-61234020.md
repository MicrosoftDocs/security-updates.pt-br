...
ms:assetid: 'ms09-040'
ms:contentKeyID: 61234020
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-040(v=Security.10)'
---
...
Vulnerabilidade no serviço de Enfileiramento de Mensagens pode permitir a elevação de privilégio (971032)
---------------------------------------------------------------------------------------------------------

Publicado: terça-feira, 11 de agosto de 2009 | Atualizado: quarta-feira, 30 de junho de 2010
...
**Problemas Conhecidos.** O [Artigo da Base de Conhecimento Microsoft 971032 (em inglês)](http://support.microsoft.com/kb/971032) documenta os problemas conhecidos até o momento que os clientes podem experimentar ao instalar esta atualização de segurança. O artigo também recomenda soluções para estes problemas.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=8ed8bad7-2885-452c-9c34-3982cd498be8)                         | Importante                 | Elevação de privilégio          | [MS08-065](http://technet.microsoft.com/security/bulletin/ms08-065) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=93490aa7-9985-4658-b0d7-88fb3f27ada0)                                     | Importante                 | Elevação de privilégio          | [MS07-065](http://technet.microsoft.com/security/bulletin/ms07-065) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=12e6be68-dc87-450e-927b-3c9b6873eb13)            | Importante                 | Elevação de privilégio          | Nenhuma                                                             |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=52f59c56-2aba-4626-a90e-311e0e73c813)                            | Importante                 | Elevação de privilégio          | Nenhuma                                                             |
| [Microsoft Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2f77ef7b-54f8-4260-b6a6-d62a0f85ef45)      | Importante                 | Elevação de privilégio          | Nenhuma                                                             |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ad55c653-ee6b-4c92-b7f4-3923bb916546) | Importante                 | Elevação de privilégio          | Nenhuma                                                             |
| [Windows Vista](http://www.microsoft.com/downloads/details.aspx?familyid=00afd94c-b483-4155-884f-b617acca6e7d)                                                 | Importante                 | Elevação de privilégio          | Nenhuma                                                             |
| [Windows Vista x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=a0c698aa-a913-4981-8798-6bbb8cacfb86)                                     | Importante                 | Elevação de privilégio          | Nenhuma                                                             |
...
<th style="border:1px solid black;" >Vulnerabilidade de ponteiro nulo do MSMQ - CVE-2009-1922</th>
...
Vulnerabilidade de ponteiro nulo do MSMQ - CVE-2009-1922  
--------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégio no serviço de Enfileiramento de Mensagens do Windows (MSMQ), devido a um defeito específico na análise de uma solicitação IOCTL ao serviço de Enfileiramento de Mensagens. O serviço MSMQ verifica incorretamente os dados de entrada antes de transmiti-los ao buffer. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-1922](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1922).
  
#### Fatores atenuantes da Vulnerabilidade de cadeia de caracteres nula da MSMQ - CVE-2009-1922
...
#### Soluções alternativas para a Vulnerabilidade de ponteiro nulo do MSMQ - CVE-2009-1922
...
-   **Desabilite o Serviço de Enfileiramento de Mensagens:**
    ...
    -   Interativamente  
        ...
        1. Clique em **Iniciar** e, em seguida, em **Painel de Controle**. Como alternativa, aponte para **Configurações** e clique em **Painel de Controle**.  
        ...
        5. Na lista **Tipo de inicialização**, clique em **Desabilitado**.  
...
#### Perguntas frequentes sobre a Vulnerabilidade de ponteiro nulo do MSMQ - CVE-2009-1922
...
O serviço MSMQ não valida corretamente os dados passados do modo de usuário para o modo de kernel, o que permite a um invasor executar código arbitrário no contexto do SISTEMA LOCAL.
...
Um invasor pode explorar esta vulnerabilidade, enviando uma solicitação IOCTL especialmente criada ao serviço MSMQ. A exploração bem-sucedida desta vulnerabilidade pode permitir acesso total ao sistema afetado no contexto SISTEMA LOCAL.
...
A atualização elimina a vulnerabilidade modificando o modo como o serviço MSMQ valida os dados de entrada antes de transmiti-los ao buffer alocado.
...
| Windows Vista                                                 | Não     | Não               | Consulte a **Observação para Windows Vista** a seguir | Sim                        |  
| Windows Vista x64 Edition                                     | Não     | Não               | Consulte a **Observação para Windows Vista** a seguir | Sim                        |
...
**Observação para o Windows** **Vista** O Microsoft Systems Management Server 2003 com Service Pack 3 inclui suporte para Windows Vista.
...
| **Implantação**                       |                                                                                                                                                                       |  
| Instalar sem intervenção do usuário   | Windows2000-kb971032-x86-enu /quiet                                                                                                                                   |  
| Instalar sem reinicializar            | Windows2000-kb971032-x86-enu /norestart                                                                                                                               |  
| Arquivo de log de atualização         | kb971032.log                                                                                                                                                          |  
...
| **Informações sobre remoção**         | Use a ferramenta **Adicionar ou Remover Programas** no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB971032$\\Spuninst |  
| **Informações sobre o arquivo**       | Consulte o [Artigo 971032 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/971032)                                                            |  
| **Verificação da Chave do Registro**  | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB971032\\Filelist                                                                             |
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB971032$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/971032">Artigo 971032 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para Window Vista:<br />
...
-   Nikita Tarakanov, da [Positive Technologies Research Team](http://en.securitylab.ru/lab/), por relatar a Vulnerabilidade de ponteiro nulo do MSMQ (CVE-2009-1922)
...
-   V1.1 (30 de Junho de 2010): Incluído link para o Artigo da Base de Conhecimento Microsoft 971032 na seção Problemas Conhecidos do Sumário Executivo.
