...
ms:assetid: 'ms09-041'
ms:contentKeyID: 61234021
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-041(v=Security.10)'
---
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=9c0e5bff-c248-4e87-a83b-82ba52f5299d)                                                                        | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7b64a454-d383-47e3-b469-b87e2b3c1a9f)                                                                           | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9cb0477f-0656-47f5-bd35-5716e0572fbd)                                                                                           | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Microsoft Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=96fbf65f-1db2-432d-92a0-6669d8abaeb0)                                                                     | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=11321f48-8997-4b99-982a-3ba4ad3f5992)                                                                | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Vista, Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=979ac9da-940f-49e7-91a2-b12db3708076)                                                   | Negação de Serviço         | Moderada                        | Nenhuma                                    |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b9aa04cc-a5c5-47ae-bf0f-250cff275d26)               | Negação de Serviço         | Moderada                        | Nenhuma                                    |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=24c77c27-0b7d-4a35-a871-b453f90e5913)\*                 | Negação de Serviço         | Moderada                        | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=48d0432e-704a-4bbb-b0a1-cd14069a8e93)\*       | Negação de Serviço         | Moderada                        | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c119223c-f4e0-449b-8e7b-a6bf11c98f94) | Negação de Serviço         | Moderada                        | Nenhuma                                    |
...
<th style="border:1px solid black;" >Vulnerabilidade de corrupção de memória do serviço Estação de Trabalho - CVE-2009-1544</th>
...
Vulnerabilidade de corrupção de memória do serviço Estação de Trabalho - CVE-2009-1544  
--------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégio no Serviço Estação de Trabalho do Windows devido a uma possível condição "liberação dupla" que ocorre no serviço. Um invasor que explore com êxito essa vulnerabilidade pode executar código arbitrário com privilégios elevados. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-1544](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1544).
  
#### Fatores atenuantes da vulnerabilidade de corrupção de memória do serviço Estação de Trabalho - CVE-2009-1544
...
-   Um invasor precisa ter credenciais de logon válidas para o sistema vulnerável para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade de corrupção de memória do serviço Estação de Trabalho - CVE-2009-1544
...
#### Perguntas frequentes sobre a vulnerabilidade de corrupção de memória do serviço Estação de Trabalho - CVE-2009-1544
...
O serviço Estação de Trabalho do Windows não aloca e libera corretamente a memória ao receber mensagens de RPC especialmente criadas.
  
**O que é o serviço Estação de Trabalho?**    
O serviço Estação de Trabalho é um componente do Windows que oferece suporte ao roteamento de arquivo remoto e solicitações do recurso de impressão de rede. Tanto as solicitações de sistema de arquivos local quanto as solicitações de rede de arquivo ou impressão remotos são roteadas pelo serviço Estação de Trabalho. Esse serviço determina em que lugar o recurso está localizado e, em seguida, encaminha a solicitação ao sistema de arquivos local ou aos componentes de rede. Quando o serviço Estação de Trabalho é interrompido, todas as solicitações são consideradas locais.
...
O RPC (Chamada de Procedimento Remoto) da Microsoft é um mecanismo de comunicação entre processos que permite a troca de dados e a invocação de recursos que residem em um processo diferente. Esse processo pode estar no mesmo computador, na rede local (LAN) ou na Internet. O mecanismo RPC da Microsoft usa outros mecanismos de IPC, tais como pipes nomeados, NetBIOS ou Winsock, para estabelecer comunicações entre o cliente e o servidor. Com o RPC, a lógica essencial do programa e o código de procedimento relacionado podem existir em computadores diferentes, o que é importante para aplicativos distribuídos. Para obter mais informações, consulte o artigo da Technet, O que é RPC? (em inglês)
  
**Posso desabilitar o serviço Estação de Trabalho para impedir que este ataque continue?**    
A desabilitação do serviço Estação de Trabalho não é recomendada como uma solução alternativa para esta vulnerabilidade. se o serviço Estação de Trabalho for desabilitado, o sistema não poderá conectar-se a nenhum recurso de arquivo ou de impressão compartilhado em uma rede. Use essa solução alternativa somente em sistemas autônomos (como é caso de vários sistemas domésticos) que não se conectam a nenhuma rede. Se o serviço Estação de Trabalho for desabilitado, qualquer serviço que dependa explicitamente dele não será iniciado e uma mensagem de erro será registrada no log de eventos do sistema. Os seguintes serviços dependem do serviço Estação de Trabalho:
...
Esses serviços são necessários para acessar recursos em uma rede e para fazer autenticações de domínio. A conectividade e a pesquisa na Internet para sistemas autônomos, como os de usuários em conexões dial-up, conexões DSL ou conexões de modem a cabo, não devem ser afetadas se esses serviços forem desabilitados.
  
**Observação:** O Microsoft Baseline Security Analyzer não funcionará se o serviço Estação de Trabalho estiver desabilitado.
...
Um invasor pode tentar explorar a vulnerabilidade, criando uma mensagem de RPC especialmente criada e enviando-a ao sistema afetado. A mensagem pode permitir que o cliente autenticado grave dados arbitrários na memória no espaço para endereço do serviço Estação de Trabalho.
  
**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**    
Todos os sistemas com o serviço Estação de Trabalho habilitado correm risco.
  
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade, corrigindo a maneira como o serviço Estação de Trabalho aloca e libera memória.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB971657$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/971657">Artigo 971657 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Cody Pierce da [TippingPoint DVLabs](http://dvlabs.tippingpoint.com/) por relatar a Vulnerabilidade de corrupção de memória do serviço Estação de Trabalho (CVE-2009-1544)
