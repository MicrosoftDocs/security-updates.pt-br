...
ms:assetid: 'ms09-047'
ms:contentKeyID: 61234027
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-047(v=Security.10)'
---
...
Vulnerabilidades no Windows Media Format podem permitir a execução remota de código (973812)
--------------------------------------------------------------------------------------------

Publicado: terça-feira, 8 de setembro de 2009
...
Esta atualização de segurança é classificada como Crítica para Tempo de Execução do Windows Media Format 9.0, Tempo de Execução do Windows Media Format 9.5, Tempo de Execução do Windows Media Format 11, Microsoft Media Foundation, Windows Media Services 9.1 e Windows Media Services 2008. Para obter mais informações, consulte a subseção **Software afetado e não afetado**, nesta seção.

A atualização de segurança aborda as vulnerabilidades, modificando a maneira como o Tempo de Execução do Windows Media Format analisa arquivos ASF (Advanced Systems Format) e MP3 (MPEG-1 Audio Layer 3). Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Problemas conhecidos.** O [Artigo 973812 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/973812) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
O Microsoft Media Foundation é um componente padrão incluído no Windows Vista e sistemas operacionais posteriores que permite a aplicativos reproduzir ou capturar mídia digital.
...
<th style="border:1px solid black;" >
Vulnerabilidade de liberação inválida de análise de cabeçalho do Windows Media - CVE-2009-2498
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de corrupção de memória de reprodução do Windows Media - CVE-2009-2499
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
<tr>
<td style="border:1px solid black;">
Tempo de Execução do Windows Media Format 9.0 quando instalado no Microsoft Windows 2000 Service Pack 4
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Tempo de Execução do Windows Media Format 9.0 no Windows XP Service Pack 2 e no Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Tempo de Execução do Windows Media Format 9.5 e Tempo de Execução do Windows Media Format 11 quando instalados no Windows XP Service Pack 2 e no Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Tempo de Execução do Windows Media Format 9.5 no Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Tempo de Execução do Windows Media Format 9.5 x64 Edition e Tempo de Execução do Windows Media Format 11 quando instalados no Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Tempo de Execução do Windows Media Format 9.5 no Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Tempo de Execução do Windows Media Format 9.5 no Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Tempo de Execução do Windows Media Format 9.5 x64 Edition quando instalado no Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Tempo de Execução do Windows Media Format 11 no Windows Vista, Windows Vista Service Pack 1 e Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Tempo de Execução do Windows Media Format 11 no Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Tempo de Execução do Windows Media Format 11 no Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Tempo de Execução do Windows Media Format 11 no Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Crítica**  
Execução Remota de Código
...
-   O Windows Media Services é um componente opcional em todas as plataformas do Windows, não sendo instalado por padrão.

#### Soluções alternativas para a vulnerabilidade de liberação inválida de análise de cabeçalho do Windows Media - CVE-2009-2498

A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:

**Restringir o acesso ao arquivo wmvcore.dll**
...
**Impacto da solução alternativa.** Você não poderá reproduzir arquivos de mídia no Windows Explorer nem no Windows Media Player.
...
**Para todas as edições de 32 bits com suporte do Windows** **Vista** **e Windows Servidor 2008:**
...
**Impacto da solução alternativa.** Você não poderá reproduzir arquivos de mídia no Windows Explorer nem no Windows Media Player. O Windows Media Player sai com um erro.
...
**Para todas as edições baseadas em x64 com suporte do Windows** **Vista** **e Windows Servidor 2008:**
...
#### Perguntas frequentes sobre a vulnerabilidade de liberação inválida de análise de cabeçalho do Windows Media - CVE-2009-2498
...
O componente do Windows responsável pelo processamento de arquivos ASF não trata corretamente arquivos ASF especialmente criados com cabeçalhos malformados.
...
A exploração desta vulnerabilidade exige que um usuário abra um arquivo ASF especialmente criado ou receba conteúdo de fluxo especialmente criado de um site ou de qualquer aplicativo que forneça conteúdo da Web.

**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**  
Esta vulnerabilidade exige que um usuário esteja conectado e abra o arquivo ASF mal-intencionado em qualquer aplicativo baseado no Tempo de Execução do Windows Media Format para que qualquer ação mal-intencionada ocorra. Portanto, qualquer sistema no qual o Tempo de Execução do Windows Media Format ou o Windows Media Server for usado frequentemente, como estações de trabalho ou servidores de terminal, corre maior risco com essa vulnerabilidade.
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Windows lida com arquivos de mídia MP3. Essa vulnerabilidade pode permitir a execução remota de código se o usuário abrir um arquivo especialmente criado. Se um usuário tiver feito logon com direitos administrativos, o invasor que explorar com êxito essa vulnerabilidade poderá ter o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-2499](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2499).

#### Fatores atenuantes da vulnerabilidade de corrupção de memória de reprodução do Windows Media - CVE-2009-2499
...
#### Soluções alternativas para a vulnerabilidade de corrupção de memória de reprodução do Windows Media - CVE-2009-2499

A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:

**Restringir o acesso a wmvcore.dll e mf.dll**
...
#### Perguntas frequentes sobre a vulnerabilidade de corrupção de memória de reprodução do Windows Media - CVE-2009-2499

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito essa vulnerabilidade poderá assumir remotamente o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.

**O que provoca a vulnerabilidade?**  
O componente do Windows responsável pelo processamento de arquivos MP3 não lida corretamente com metadados especialmente criados.

**O que é Tempo de Execução do Windows Media Format?**  
O Tempo de Execução do Microsoft Windows Media Format fornece informações e ferramentas para aplicativos que usam o conteúdo do Windows Media.

**O que é MP3 (MPEG-1 Audio Layer 3)?**  
MP3 é um formato de arquivo que usa uma compactação que ocasiona perdas para compactar informações de áudio. A compactação com perda é uma técnica em que os dados descompactados podem ser diferentes dos dados inicialmente compactados, mas suficientemente semelhantes para serem analisados e representados. É comum em aplicativos de áudio, como mídia de fluxo contínuo.

**Para que um invasor pode usar a vulnerabilidade?**  
Se um usuário tiver feito logon com direitos administrativos, o invasor que explorar com êxito essa vulnerabilidade poderá ter o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

**De que forma o invasor pode explorar a vulnerabilidade?**  
A exploração desta vulnerabilidade exige que um usuário abra um arquivo MP3 especialmente criado ou receba conteúdo de fluxo especialmente criado de um site ou de qualquer aplicativo que forneça conteúdo da Web.

**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**  
Esta vulnerabilidade exige que um usuário esteja conectado e abra, em qualquer aplicativo baseado no Tempo de Execução do Windows Media Format, o arquivo MP3 especialmente criado para que qualquer ação mal-intencionada ocorra. Portanto, os sistemas nos quais o Tempo de Execução do Windows Media Format é usado com freqüência, como em estações de trabalho ou servidores de terminal, estão mais expostos a essa vulnerabilidade.

**Estou executando o Internet Explorer para Windows Server 2003 ou Windows Server 2008. Isso atenua essa vulnerabilidade?**  
Sim. Por padrão, o Internet Explorer no Windows Server 2003 e no Windows Server 2008 é executado em um modo restrito, conhecido como [Configuração de Segurança Reforçada](http://go.microsoft.com/fwlink/?linkid=92039). A Configuração de Segurança Reforçada é um grupo de configurações predefinidas do Internet Explorer que reduz a probabilidade de um usuário ou administrador baixar e executar um conteúdo da Web especialmente criado em um servidor. Este é um fator atenuante para sites que não tenham sido adicionados à zona Sites confiáveis do Internet Explorer. Consulte também [Gerenciamento de Configurações de Segurança Avançadas do Internet Explorer](http://go.microsoft.com/fwlink/?linkid=92055)

**O que a atualização faz?**  
A atualização elimina a vulnerabilidade, modificando a maneira como esse Tempo de Execução do Windows Media Format analisa arquivos MP3 (MPEG-1 Audio Layer 3).
...
<td style="border:1px solid black;">Para Tempo de Execução do Windows Media Format 9.0 quando instalado no Microsoft Windows 2000 Service Pack 4:<br />
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB968816_WM9$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/968816">Artigo 968816 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">
Modo de instalação autônomo. Não é necessária a interação do usuário, mas o status da desinstalação é exibido. Se a reinicialização for necessária no fim da instalação, uma caixa de diálogo será apresentada para o usuário com um timer avisando que o computador será reiniciado em 30 segundos.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Não reinicia quando a desinstalação é concluída.
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
Reinicia o computador após a desinstalação e força o fechamento de outros aplicativos no desligamento sem antes salvar os arquivos abertos.
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para Tempo de Execução do Windows Media Format 9.0 no Windows XP Service Pack 2 e Tempo de Execução do Windows Media Format 9.5 e Tempo de Execução do Windows Media Format 11 quando instalados no Windows XP Service Pack 2:<br />
WindowsXP-SP2-WindowsMedia-KB968816-x86-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Tempo de Execução do Windows Media Format 9.0 no Windows XP Service Pack 3 e Tempo de Execução do Windows Media Format 9.5 e Tempo de Execução do Windows Media Format 11 quando instalados no Windows XP Service Pack 3:<br />
WindowsXP-WindowsMedia-KB968816-x86-ENU /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Tempo de Execução do Windows Media Format 9.5 no Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB968816-x64-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Tempo de Execução do Windows Media Format 9.5 x64 Edition quando instalado no Windows XP Professional x64 Edition Service Pack 2:<br />
WindowsMedia10-KB968816-x64-ENU /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Tempo de Execução do Windows Media Format 11 quando instalado no Windows XP Professional x64 Edition Service Pack 2:<br />
...
<br />
Para Tempo de Execução do Windows Media Format 9.0 no Windows XP Service Pack 2 e no Windows XP Service Pack 3 e Tempo de Execução do Windows Media Format 9.5 e Tempo de Execução do Windows Media Format 11 quando instalados no Windows XP Service Pack 2 e no Windows XP Service Pack 3:<br />
%Windir%\$NTUninstallKB968816_WM9$\Spuninst<br />
<br />
Para Tempo de Execução do Windows Media Format 9.5 no Windows XP Professional x64 Edition Service Pack 2:<br />
%Windir%\$NTUninstallKB968816$\Spuninst<br />
<br />
Para Tempo de Execução do Windows Media Format 9.5 x64 Edition quando instalado no Windows XP Professional x64 Edition Service Pack 2:<br />
%Windir%\$NTUninstallKB968816_WM10Lx64$\Spuninst<br />
<br />
Para Tempo de Execução do Windows Media Format 11 quando instalado no Windows XP Professional x64 Edition Service Pack 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave do Registro</strong></td>
<td style="border:1px solid black;">Para Tempo de Execução do Windows Media Format 9.0 no Windows XP Service Pack 2 e no Windows XP Service Pack 3 e Tempo de Execução do Windows Media Format 9.5 e Tempo de Execução do Windows Media Format 11 quando instalados no Windows XP Service Pack 2 e no Windows XP Service Pack 3:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para Tempo de Execução do Windows Media Format 9.5 no Windows Server 2003 Service Pack 2:<br />
WindowsServer2003-KB968816-x86-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Tempo de Execução do Windows Media Format 9.5 no Windows Server 2003 x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB968816-x64-ENU /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Tempo de Execução do Windows Media Format 9.5 x64 Edition quando instalado no Windows Server 2003 x64 Edition Service Pack 2:<br />
WindowsMedia10-KB968816-x64-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows Media Services 9.1 no Windows Server 2003 Service Pack 2:<br />
WindowsServer2003-KB972554-x86-ENU /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows Media Services 9.1 no Windows Server 2003 x64 Edition Service Pack 2:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Arquivo de log de atualização</td>
<td style="border:1px solid black;">Para Tempo de Execução do Windows Media Format:<br />
KB968816.log<br />
<br />
Para Windows Media Services:<br />
KB972554.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Mais informações</td>
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado nas seguintes pastas:<br />
<br />
Para Tempo de Execução do Windows Media Format 9.5 no Windows Server 2003 Service Pack 2 e no Windows Server 2003 x64 Edition Service Pack 2:<br />
%Windir%\$NTUninstallKB968816$\Spuninst<br />
<br />
Para Tempo de Execução do Windows Media Format 9.5 x64 Edition quando instalado no Windows Server 2003 x64 Edition Service Pack 2:<br />
%Windir%\$NTUninstallKB968816_WM10Lx64$\Spuninst<br />
<br />
Para Windows Media Services 9.1 no Windows Server 2003 Service Pack 2 e no Windows Server 2003 x64 Edition Service Pack 2:<br />
%Windir%\$NTUninstallKB972554$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Para Tempo de Execução do Windows Media Format:<br />
Consulte o <a href="http://support.microsoft.com/kb/968816">Artigo 968816 (em inglês) da Microsoft Knowledge Base</a><br />
<br />
Para Windows Media Services:<br />
Consulte o <a href="http://support.microsoft.com/kb/972554">Artigo 972554 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave do Registro</strong></td>
<td style="border:1px solid black;">Para Tempo de Execução do Windows Media Format 9.5 no Windows Server 2003 Service Pack 2 e no Windows Server 2003 x64 Edition Service Pack 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows Media Services 9.1 no Windows Server 2003 Service Pack 2 e no Windows Server 2003 x64 Edition Service Pack 2:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para Tempo de Execução do Windows Media Format 11 e Microsoft Media Foundation no Windows Server 2008 para sistemas de 32 bits e no Windows Server 2008 para sistemas de 32 bits Service Pack 2:<br />
Windows6.0-KB968816-x86 /quiet<br />
<br />
Para Tempo de Execução do Windows Media Format 11 e Microsoft Media Foundation no Windows Server 2008 para sistemas baseados em x64 e no Windows Server 2008 para sistemas baseados em x64 Service Pack 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Para Tempo de Execução do Windows Media Format e Microsoft Media Foundation:<br />
Consulte o <a href="http://support.microsoft.com/kb/968816">Artigo 968816 (em inglês) da Microsoft Knowledge Base</a><br />
<br />
Para Windows Media Services:<br />
Consulte o <a href="http://support.microsoft.com/kb/972554">Artigo 972554 (em inglês) da Microsoft Knowledge Base</a></td>
...
-   Peter Winter-Smith, da [NGS Software](http://www.ngssoftware.com/), por relatar a vulnerabilidade de liberação inválida de análise de cabeçalho do Windows Media (CVE-2009-2498)  
-   Hiroshi Noguchi, do fã-clube de Alice Carroll, por relatar a vulnerabilidade de corrupção de memória de reprodução do Windows Media (CVE-2009-2499)
...
-   V1.1 (16 de Setembro de 2009): Corrigida a lista de boletins substituídos por esta atualização para o Windows Media Format Runtime, no Microsoft Windwos 2000, Windows XP e Windows Server 2003.
