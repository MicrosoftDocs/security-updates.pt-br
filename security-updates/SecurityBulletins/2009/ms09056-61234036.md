...
ms:assetid: 'ms09-056'
ms:contentKeyID: 61234036
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-056(v=Security.10)'
---

Microsoft Security Bulletin MS09-056 - Importante
=================================================

Vulnerabilidades no Windows CryptoAPI podem permitir falsificação (974571)
--------------------------------------------------------------------------
...
Esta atualização de segurança elimina dois vulnerabilidades divulgadas publicamente no Microsoft Windows. As vulnerabilidades podem permitir falsificação se um invasor conseguir obter acesso ao certificado usado pelo usuário final para autenticação.

Esta atualização de segurança foi classificada como Importante para todas as edições com suporte do Microsoft Windows 2000, Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008 e Windows 7. Para obter mais informações, consulte a subseção **Software afetado e não afetado**, nesta seção.

A atualização de segurança elimina as vulnerabilidades modificando a CryptoAPI de modo a rejeitar nomes de certificado que contenham terminadores nulos e a validar corretamente identificadores de objeto ASN.1. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=52b9198d-b65f-467a-a5ab-141e23d64a86)                                                                                        | Falsificação               | Importante                      | [MS04-007](http://go.microsoft.com/fwlink/?linkid=20067) |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=9c5ab624-e37b-418a-a919-d8f652b15679)                                                                        | Falsificação               | Importante                      | Nenhuma                                                  |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ad29696d-4611-4a12-9dfa-74fa6866b759)                                                                           | Falsificação               | Importante                      | Nenhuma                                                  |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=49e9cc53-cf17-4bc7-aaaa-92213167e1a9)                                                                                           | Falsificação               | Importante                      | Nenhuma                                                  |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d170cef9-f5d2-4fcd-997b-e778ad5a6797)                                                                               | Falsificação               | Importante                      | Nenhuma                                                  |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=2ede1eb9-7f5f-411d-bbc3-5db46d80e0bb)                                                                | Falsificação               | Importante                      | Nenhuma                                                  |
| [Windows Vista, Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8b5a9a95-9439-40c8-acef-000b919daa04)                                                   | Falsificação               | Importante                      | Nenhuma                                                  |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4a60f789-1a4a-49a8-8d13-fda989ed40be)               | Falsificação               | Importante                      | Nenhuma                                                  |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f9b487af-fe73-42a8-b240-d59c4321f95b)\*                 | Falsificação               | Importante                      | Nenhuma                                                  |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0d8a2a3e-d7d4-47fb-8364-16fce28e4d38)\*       | Falsificação               | Importante                      | Nenhuma                                                  |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8962f0b6-f346-4e88-9d83-4d15b699dd9d) | Falsificação               | Importante                      | Nenhuma                                                  |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=ad6f06d5-27db-445d-a8b2-c42adc90afc0)                                                                                           | Falsificação               | Importante                      | Nenhuma                                                  |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=70cd0270-77e9-492a-82d9-798364640c10)                                                                                      | Falsificação               | Importante                      | Nenhuma                                                  |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=ce78c019-ec08-4ec6-abec-334f5ec5cb76)\*                                                                       | Falsificação               | Importante                      | Nenhuma                                                  |
| [Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=6442a77a-3c0d-4beb-b2d2-2885376c2135)                                                                     | Falsificação               | Importante                      | Nenhuma                                                  |
...
<th style="border:1px solid black;" >Vulnerabilidade de truncamento nulo no nome comum X.509 - CVE-2009-2510</th>
<th style="border:1px solid black;" >Vulnerabilidade de estouro de número inteiro nos identificadores de objeto X.509 - CVE-2009-2511</th>
...
Vulnerabilidade de truncamento nulo no nome comum X.509 - CVE-2009-2510  
-----------------------------------------------------------------------
  
Existe uma vulnerabilidade de falsificação no componente CryptoAPI do Microsoft Windows, durante a análise de informações de ASN.1 de certificados X.509. Um invasor que explore esta vulnerabilidade com êxito pode representar outro usuário ou sistema.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-2510](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2510).
  
#### Fatores atenuantes da Vulnerabilidade de truncamento nulo no nome comum X.509 - CVE-2009-2510
  
A Microsoft não identificou nenhum fator atenuante para essa vulnerabilidade.
  
#### Soluções alternativas para a Vulnerabilidade de truncamento nulo no nome comum X.509 - CVE-2009-2510
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade de truncamento nulo no nome comum X.509 - CVE-2009-2510
  
**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de falsificação. Quando combinado com outros ataques específicos, como falsificação de DNS, isso pode permitir a um invasor falsificar o certificado digital de um site para qualquer aplicativo que use o CryptoAPI.
  
**O que provoca a vulnerabilidade?**  
O Windows CryptoAPI analisa incorretamente um terminador nulo como o fim de quaisquer valores identificados por um identificador de objeto (OID). Isso faz com que o CryptoAPI analise somente parte do valor real. Quando esse valor parcial tem significado para o usuário final, isso pode levar a uma situação em que o invasor pode representar outro usuário ou sistema.
  
**O que é o Windows CryptoAPI?**  
O CryptoAPI fornece serviços que permitem aos desenvolvedores de aplicativos adicionar criptografia/descriptografia de dados, autenticação com certificados digitais e codificação e decodificação de ASN.1 (Abstract Syntax Notation One) a seus aplicativos baseados no Windows. Os desenvolvedores de aplicativos podem usar as funções no CryptoAPI sem conhecer os detalhes da implementação subjacente, do mesmo modo como podem usar uma biblioteca gráfica, sem o conhecimento da configuração específica do hardware de gráficos. O CryptoAPI funciona com vários Provedores de Serviços de Criptografia que executam as funções criptográficas propriamente ditas.
  
**O que é o ASN.1?**  
O ASN.1 (Abstract Syntax Notation 1) é um padrão de dados usado em muitos aplicativos e dispositivos do setor tecnológico para permitir a normalização e o entendimento dos dados em várias plataformas. Ele não tem relação direta com nenhum padrão específico, método de codificação, linguagem de programação ou plataforma de hardware. É simplesmente uma linguagem para definir padrões; padrões são escritos em ASN.1.
  
Mais informações sobre o ASN.1 podem ser encontradas no [artigo 252648 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/252648).
  
**O que é o padrão X.509?**  
A especificação X.509 define um padrão para gerenciar chaves públicas por meio de uma Infraestrutura de Chave Pública (PKI). As chaves públicas são mantidas em certificados X.509, que são documentos digitais que relacionam as reivindicações de identidade de um indivíduo a uma chave pública de um par de chaves assimétricas pública/privada. Normalmente, as reivindicações de identidade são compreensíveis por seres humanos, como o nome completo de uma pessoa ou seu endereço de email, ou um nome de host de máquina ou nome de domínio. Os certificados X.509 são endossados e emitidos por um terceiro confiável, conhecido como Autoridade de Certificação (CA).
  
**O que é um Identificador de Objeto ou OID?**  
Identificadores de Objeto (OIDs) são valores numéricos emitidos por várias autoridades emissoras para identificar com exclusividade elementos de dados, sintaxes e outras partes de aplicativos distribuídos. OIDs são encontrados em aplicativos OSI, Diretórios X.500, SNMP e outros aplicativos onde a exclusividade é importante. Os OIDs se baseiam em uma estrutura em árvore, em que uma autoridade emissora superior, como a ISO, aloca uma ramificação da árvore a uma subautoridade que, por sua vez, pode alocar sub-ramificações.
  
**O que é um terminador NULL?**  
Um terminador nulo é um caractere com o valor zero. Em certas linguagens de programação, como C, ele é usado como um caractere reservado para significar o fim de uma cadeia de caracteres.
  
**Para que um invasor pode usar a vulnerabilidade?**  
Um invasor pode representar outro usuário ou sistema. Os aplicativos que usam o CryptoAPI para analisar este dados podem retornar informações ao usuário que podem levar o usuário a tomar decisões de confiança incorretas.
  
**De que forma o invasor pode explorar a vulnerabilidade?**  
Um invasor pode abusar desta vulnerabilidade convencendo uma Autoridade de Certificação em quem o cliente confia a assinar um certificado que contenha um terminador nulo no campo Nome Comum (CN). O invasor pode então configurar um site não autorizado que sirva esse certificado a um computador com o Windows. O computador analisaria incorretamente o campo Nome Comum e ofereceria informações de confiança incorretas ao usuário.
  
**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**  
Os clientes que navegam por sites HTTPS ou usam X.509 para certificados, por exemplo para proteger conversas por email, são os que mais correm risco com essa vulnerabilidade.
  
**O que a atualização faz?**  
Esta atualização de segurança elimina a vulnerabilidade modificando o CryptoAPI de modo a rejeitar Nomes de Certificado que contenham terminadores nulos.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2009-2510](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2510) da lista Common Vulnerability and Exposure.
  
**Quando este boletim de segurança foi lançado, a Microsoft tinha recebido algum relatório informando que essa vulnerabilidade estava sendo explorada?**  
A Microsoft está ciente do código de verificação de conceito que foi publicado e que pede permitir a um invasor explorar esta vulnerabilidade em cenários limitados. No entanto, a Microsoft não recebeu nenhuma informação que indique que esta vulnerabilidade tenha sido usada publicamente para atacar clientes.
  
Vulnerabilidade de estouro de número inteiro nos identificadores de objeto X.509 - CVE-2009-2511  
------------------------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de falsificação no componente Microsoft Windows CryptoAPI, durante a análise de identificadores de objeto ASN.1 de certificados X.509. Um invasor que explore esta vulnerabilidade com êxito pode representar outro usuário ou sistema.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-2511](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2511).
  
#### Fatores atenuantes da Vulnerabilidade de estouro de número inteiro nos identificadores de objeto X.509 - CVE-2009-2511
  
A Microsoft não identificou nenhum fator atenuante para essa vulnerabilidade.
  
#### Soluções alternativas para a Vulnerabilidade de estouro de número inteiro nos identificadores de objeto X.509 - CVE-2009-2511
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade de estouro de número inteiro nos identificadores de objeto X.509 - CVE-2009-2511
  
**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de falsificação. Quando combinado com outros ataques específicos, como falsificação de DNS, isso pode permitir a um invasor falsificar o certificado digital de um site para qualquer aplicativo que use o CryptoAPI.
  
**O que provoca a vulnerabilidade?**  
O Windows CryptoAPI tem um estouro de número inteiro quando analisa identificadores de objeto ASN.1 de certificados X.509, como o Nome Comum (CN). Um invasor pode gerar um certificado mal-intencionado que seria analisado incorretamente pelo Windows CryptoAPI, permitindo ao invasor representar outro usuário ou sistema.
...
**O que é um Identificador de Objeto ou OID?**  
Identificadores de Objeto (OIDs) são valores numéricos exclusivos emitidos por várias autoridades emissoras para identificar com exclusividade elementos de dados, sintaxes e outras partes de aplicativos distribuídos. OIDs são encontrados em aplicativos OSI, Diretórios X.500, SNMP e outros aplicativos onde a exclusividade é importante. Os OIDs se baseiam em uma estrutura em árvore, em que uma autoridade emissora superior, como a ISO, aloca uma ramificação da árvore a uma subautoridade que, por sua vez, pode alocar sub-ramificações.
  
**Para que um invasor pode usar a vulnerabilidade?**  
Um invasor pode representar outro usuário ou sistema. Os aplicativos que usam o CryptoAPI para analisar este dados podem retornar informações ao usuário que podem levar o usuário a tomar decisões de confiança incorretas.
  
**De que forma o invasor pode explorar a vulnerabilidade?**  
Um invasor pode abusar desta vulnerabilidade convencendo uma Autoridade de Certificação em quem o cliente confia a assinar um certificado que contenha um Identificador de Objeto malformado. O invasor pode então configurar um site não autorizado que sirva esse certificado a um cliente com o Windows. Esse aplicativo cliente analisaria incorretamente o campo Nome Comum e ofereceria informações de confiança incorretas ao usuário.
  
**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**  
Os aplicativos cliente que navegam por sites HTTPS ou usam X.509 para certificados, por exemplo para proteger conversas por email, são os que mais correm risco com essa vulnerabilidade.
  
**O que a atualização faz?**  
Esta atualização de segurança elimina a vulnerabilidade fazendo com que o CryptoAPI valide corretamente os Identificadores de Objeto ASN.1.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2009-2511](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2511) da lista Common Vulnerability and Exposure.
...
| **Implantação**                       |                                                                                                                                                                       |  
| Instalar sem intervenção do usuário   | Windows2000-kb974571-x86-enu /quiet                                                                                                                                   |  
| Instalar sem reinicializar            | Windows2000-kb974571-x86-enu /norestart                                                                                                                               |  
| Arquivo de log de atualização         | kb974571.log                                                                                                                                                          |  
...
| **Informações sobre remoção**         | Use a ferramenta **Adicionar ou Remover Programas** no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB974571$\\Spuninst |  
| **Informações sobre o arquivo**       | Consulte o [Artigo 974571 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/974571)                                                            |  
| **Verificação da chave do Registro**  | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB974571\\Filelist                                                                             |
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB974571$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/974571">Artigo 974571 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<br />
Para todas as edições baseadas em x64 com suporte do Windows 7:<br />
...
-   Ian Wright e Jean-Luc Giraud, da [Citrix](http://www.citrix.com/), por trabalharem conosco na Vulnerabilidade de truncamento nulo no nome comum X.509 (CVE-2009-2510)  
-   Dan Kaminsky, da [IOActive](http://www.ioactive.com/), por relatar a Vulnerabilidade de truncamento nulo no nome comum X.509 (CVE-2009-2510) e a Vulnerabilidade de estouro de número inteiro nos identificadores de objeto X.509 (CVE-2009-2511)
...
-   V1.1 (14 de outubro de 2009): Um link para o artigo 974571 (em inglês) da Microsoft Knowledge Base foi adicionado à seção Problemas conhecidos, na Sinopse.
