...
ms:assetid: 'ms09-059'
ms:contentKeyID: 61234039
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-059(v=Security.10)'
---
...
Vulnerabilidade no LSASS (Local Security Authority Subsystem Service) pode permitir negação de serviço (975467)
---------------------------------------------------------------------------------------------------------------
...
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular no Microsoft Windows. A vulnerabilidade pode permitir negação de serviço se um invasor enviar um pacote criado com intuito de ser mal-intencionado durante o processo de autenticação de NTLM.

Esta atualização de segurança foi classificada como Importante para todas as edições com suporte do Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008 e Windows 7. Edições com suporte do Windows XP e Windows Server 2003 são afetadas somente se a atualização não relacionada a segurança descrita em KB968389 tiver sido instalada previamente. Para obter mais informações, consulte a subseção **Software afetado e não afetado**, nesta seção.

A atualização de segurança elimina a vulnerabilidade implementando uma validação adicional de conjuntos específicos de valores usados no processo de autenticação. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Problemas conhecidos.** O [Artigo 975467 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/975467) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=e997ea40-668e-40df-bd50-0ca53437b375)\*                                                                      | Negação de Serviço         | Importante                      | Nenhuma                                    |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=17008892-7950-44c4-850d-002c8d73495f)\*                                                                         | Negação de Serviço         | Importante                      | Nenhuma                                    |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9dff4662-7771-4bdc-87ec-7899d79b3a55)\*                                                                                         | Negação de Serviço         | Importante                      | Nenhuma                                    |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8df7a2d9-2f97-4f18-84e8-415a1632cf09)\*                                                                             | Negação de Serviço         | Importante                      | Nenhuma                                    |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=83c77015-7f96-4c0d-bd56-60aef90ea2f8)\*                                                              | Negação de Serviço         | Importante                      | Nenhuma                                    |
| [Windows Vista, Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=04ae306b-0d0d-4767-ab54-cc11aec477ed)                                                   | Negação de Serviço         | Importante                      | Nenhuma                                    |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=58c995ca-f308-4e07-8e60-2e542384d95d)               | Negação de Serviço         | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f2f617c2-f149-4e9b-bfdd-08ed0f3f99db)\*\*               | Negação de Serviço         | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=deb84cb8-2ba3-47e3-9185-2bbc5b0a7e18)\*\*     | Negação de Serviço         | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=abc94857-37d8-4bb8-ad9e-46e687fca40e) | Negação de Serviço         | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=35b85783-90df-4f67-a3cb-02351432133e)                                                                                           | Negação de Serviço         | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=97010f2c-6c10-4fda-84fd-6c8749968db5)                                                                                      | Negação de Serviço         | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=597ac3a7-e02d-49a5-9b8e-d097e867acea)\*\*                                                                     | Negação de Serviço         | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=4aac0e3e-9b49-4a4a-ab17-707ff03b4d9b)                                                                     | Negação de Serviço         | Importante                      | Nenhuma                                    |

**\***Este sistema operacional é afetado somente quando o KB968389, Proteção Estendida para Autenticação (consulte [Comunicado de Segurança da Microsoft 973811](http://support.microsoft.com/kb/973811)) tiver sido instalado. Para obter mais informações, consulte a entrada em **Perguntas frequentes relacionadas a esta atualização de segurança**.
...
Esta vulnerabilidade afeta sistemas do Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2. Além disso, ela também afeta sistemas do Windows XP e do Windows Server 2003 em que o KB968389, uma atualização não relacionada à segurança, tenha sido instalada para implementar a Proteção Estendida.

**Meu computador está vulnerável se eu não tiver instalado o KB968389?**  
As edições com suporte do Windows XP e do Windows Server 2003 que não têm o KB968389 instalado não estão vulneráveis. As edições com suporte do Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2 que não têm o KB968389 instalado estão vulneráveis.

**Por que estou recebendo o KB968389 somente do Windows Update ou do Microsoft Update?**  
Se você obtiver o KB968389 através do Windows Update ou do Microsoft Update depois do lançamento desta atualização de segurança, a atualização de segurança KB975467 será instalada automaticamente. Com a instalação bem-sucedida do KB968389, ambos o KB968389 e a atualização de segurança KB975467, correspondente do boletim MS09-059, serão listados como software instalado.

Se você tiver instalado o KB968389 antes do lançamento desta atualização de segurança, o Windows Update e o Microsoft Update oferecerão a atualização de segurança KB975467 para eliminar a vulnerabilidade.
...
<th style="border:1px solid black;" >Vulnerabilidade de estouro de número inteiro no serviço LSASS - CVE-2009-2524</th>
...
Vulnerabilidade de estouro de número inteiro no serviço LSASS - CVE-2009-2524  
-----------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de negação de serviço no serviço LSASS (Local Security Authority Subsystem Service) do Microsoft Windows, devido à manipulação inadequada de pacotes malformados durante a autenticação NTLM. Um invasor pode criar solicitações anônimas de autenticação NTLM especialmente criadas que façam com que o serviço LSASS pare de responder e, subsequentemente, requeiram a reinicialização do computador.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-2524](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2524).
  
#### Fatores atenuantes da Vulnerabilidade de estouro de número inteiro no serviço LSASS - CVE-2009-2524
  
A Microsoft não identificou nenhum fator atenuante para essa vulnerabilidade.
  
#### Soluções alternativas para a Vulnerabilidade de estouro de número inteiro no serviço LSASS - CVE-2009-2524
  
A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:
  
-   **Desinstalar o KB968389 de computadores com o Windows XP ou com o Windows Server 2003**
  
    1.  Clique em **Iniciar**, em **Painel de Controle** e, em seguida, em **Adicionar ou Remover Programas**.  
    2.  Selecione **KB968389** e, em seguida, clique em **Desinstalar**.
  
    **Impacto da solução alternativa.**Computadores com o Windows XP ou o Windows Server 2003 não se beneficiarão da Proteção Estendida para Autenticação enquanto este KB estiver desabilitado.
  
    **Como desfazer a solução alternativa.**Instale o KB968389 baixando o pacote de instalação apropriado ao sistema operacional a partir do [Artigo 936389 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/default.aspx/kb/968389?wa=wsignin1.0).
...
#### Perguntas frequentes sobre a Vulnerabilidade de estouro de número inteiro no serviço LSASS - CVE-2009-2524
  
**Qual é o escopo da vulnerabilidade?**    
Essa é uma vulnerabilidade de negação de serviço (site em inglês). Um quadro de autenticação especialmente criado pode permitir a um invasor não autenticado fazer com que o processo LSASS no servidor pare de responder e o computador seja reiniciado.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade está presente porque a implementação de NTLM do Windows no LSASS não lida corretamente com pacotes malformados específicos durante o processo de autenticação. Um pacote malformado específico pode resultar em um estouro negativo de número inteiro no processo LSASS.
...
O invasor que explorar com êxito esta vulnerabilidade pode fazer com que o sistema afetado seja reinicializado automaticamente.
  
**De que forma o invasor pode explorar a vulnerabilidade?**    
Um invasor pode explorar esta vulnerabilidade enviando um pacote mal-intencionado durante o processo de autenticação NTLM.
  
**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**    
Servidores que permitem aos clientes se autenticar usando NTLM estão correndo risco.
  
**O que a atualização faz?**    
A atualização assegura que o LSASS manipule corretamente os valores específicos usados no processo de autenticação.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB975467$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/975467">Artigo 975467 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<strong>Observação</strong> Uma reinicialização de sistema pode ser evitada no Windows Server 2003 interrompendo o serviço LSASS, instalando a atualização e, em seguida, reiniciando o serviço LSASS. Se o serviço LSASS não for interrompido antes da instalação da atualização, a reinicialização do sistema ainda será necessária.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">HotPatching</td>
...
<br />
Para todas as edições baseadas em Itanium com suporte do Windows Server 2008 R2:<br />
...
-   V1.1 (14 de outubro de 2009): A descrição introdutória do CVE-2009-2524 foi corrigida na seção de informações sobre a vulnerabilidade.
