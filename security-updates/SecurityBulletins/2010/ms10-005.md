...
ms:assetid: 'ms10-005'
ms:contentKeyID: 61234059
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-005(v=Security.10)'
---
...
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular no Microsoft Paint. A vulnerabilidade pode permitir a execução remota de código caso o usuário exiba um arquivo de imagem JPEG especialmente criado usando o Microsoft Paint. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Esta atualização de segurança foi classificada como Moderada para o Microsoft Windows 2000, Windows XP e Windows Server 2003. Para obter mais informações, consulte a subseção **Software afetado e não afetado** nesta seção.

A atualização de segurança aborda a vulnerabilidade modificando a maneira como o Microsoft Paint decodifica arquivos de imagem JPEG. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=e5861705-8f49-45cb-8a92-cf052ccf4134)                         | Execução Remota de Código  | Moderada                        | Nenhuma                                    |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b2e70df6-7728-4fc3-8df7-8ddb9ba5202f)         | Execução Remota de Código  | Moderada                        | Nenhuma                                    |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f8c4acc8-c2f4-41f7-9b32-e7bd791e0155)            | Execução Remota de Código  | Moderada                        | Nenhuma                                    |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c1efbe73-fc87-4e6a-8b36-81f125a27aec)                            | Execução Remota de Código  | Moderada                        | Nenhuma                                    |
| [Microsoft Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9143e435-f0d6-464b-9273-4d1f38f8ff3a)      | Execução Remota de Código  | Moderada                        | Nenhuma                                    |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ee603435-26af-4ab9-9f22-92734346dc0a) | Execução Remota de Código  | Moderada                        | Nenhuma                                    |
...
<th style="border:1px solid black;" >Vulnerabilidade de estouro de número inteiro do MS Paint - CVE-2010-0028</th>
...
Vulnerabilidade de estouro de número inteiro do MS Paint - CVE-2010-0028  
------------------------------------------------------------------------
  
<span></span>
Há uma vulnerabilidade de execução remota de código na maneira como o Microsoft Paint decodifica imagens JPEG. A vulnerabilidade pode permitir a execução remota de código caso o usuário abra um arquivo de imagem JPEG especialmente criado usando o Microsoft Paint. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. Um invasor poderá instalar programas, visualizar, alterar ou excluir dados, ou ainda criar novas contas.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0028](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0028).
  
#### Fatores atenuantes para a vulnerabilidade de estouro de número inteiro do MS Paint - CVE-2010-0028
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Por padrão, quando um usuário clica duas vezes em um arquivo JPEG, o arquivo é aberto no Visualizador de imagens e fax do Windows. Para explorar a vulnerabilidade, o invasor deve convencer o usuário a abrir o arquivo especialmente criado no Microsoft Paint.  
-   O invasor pode enviar o arquivo especialmente criado como um anexo de email, mas tem de convencer o usuário a abrir o anexo no Microsoft Paint para explorar a vulnerabilidade.  
-   O invasor que explorar com êxito a vulnerabilidade poderá obter os mesmos direitos que o usuário local. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
#### Soluções alternativas para a vulnerabilidade de estouro de número inteiro do MS Paint - CVE-2010-0028
  
A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:
  
-   **Desabilite o Microsoft Paint**
  
    No Windows de 32 bits, execute o seguinte comando a partir de um prompt de comando:
  
    ```
    cacls %SystemRoot%\system32\mspaint.exe /E /P everyone:N
    ```
  
    No Windows de 64 bits, execute o seguinte comando a partir de um prompt de comando:
  
    ```
    cacls %SystemRoot%\SysWOW64\mspaint.exe /E /P everyone:N
    ```
  
    **Impacto da solução alternativa.** Os usuários não poderão executar o Microsoft Paint.
...
-   **No Windows XP e no Windows Server 2003, remova o Microsoft Paint**
  
    1.  No **Painel de Controle**, abra **Adicionar ou Remover Programas**.  
    2.  Clique em **Adicionar/Remover Componentes do Windows**.  
    3.  No **Assistente de Componentes do Windows**, selecione **Acessórios e Utilitários** e clique em **Detalhes**.  
    4.  Selecione **Acessórios** e clique em **Detalhes**.  
    5.  Clique para limpar a caixa de seleção do **Paint** e depois clique duas vezes em **OK**.  
    6.  No **Assistente de Componentes do Windows**, verifique se a caixa de seleção **Acessórios e Utilitários** está acinzentada e clique em **Avançar**.  
    7.  Quando a remoção de arquivos terminar, clique em **Concluir** para sair do assistente.
  
    **Impacto da solução alternativa.** Os usuários não poderão executar o Microsoft Paint.
  
    **Como desfazer a solução alternativa.** Reinstale o Microsoft Paint usando o Assistente de Componentes do Windows em Adicionar ou Remover Programas.
  
#### Perguntas frequentes sobre a vulnerabilidade de estouro de número inteiro do MS Paint - CVE-2010-0028
...
Esta vulnerabilidade é causada por corrupção de memória ao decodificar imagens JPEG processadas pelo Microsoft Paint.
  
**O que é o Microsoft Paint?**    
O Microsoft Paint é uma ferramenta usada para criar desenhos simples ou elaborados. Além disso, o Microsoft Paint pode ser usado para exibir e editar fotos digitalizadas.
...
Essa vulnerabilidade exige que um usuário abra ou exiba um arquivo de imagem especialmente criado. O invasor precisa enviar um arquivo de imagem JPEG especialmente criado ao usuário e convencê-lo a abrir o arquivo com o Microsoft Paint.
  
**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**    
Esta vulnerabilidade requer que o usuário esteja conectado e usando o Microsoft Paint para editar ou exibir imagens JPEG para que as ações mal-intencionadas ocorram. Portanto, qualquer sistema em que mensagens de email sejam lidas, onde o Internet Explorer seja usado com frequência ou em que os usuários tenham acesso a compartilhamentos de rede, como estações de trabalho ou servidores de terminal, corre mais riscos com essa vulnerabilidade.
  
**O que a atualização faz?**    
A atualização remove a vulnerabilidade modificando a maneira como o Microsoft Paint decodifica arquivos de imagem JPEG.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB978706$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/978706">Artigo 978706 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Tielei Wang, da ICST-ERCIS (Engineering Research Center of Info Security, Institute of Computer Science & Technology, Peking University/China), que trabalha com a [Secunia](http://secunia.com/), por relatar a vulnerabilidade de estouro de número inteiro do MS Paint (CVE-2010-0028)
...
-   V1.1 (10 de fevereiro de 2010): Foram corrigidas as subseções de **Implantação de atualização de segurança** para indicar que, em alguns casos, a atualização não requer uma reinicialização. Foi corrigida a chave do Registro de verificação para todas as edições com suporte baseadas em x64 do Windows XP. Elas são alterações para fins informativos apenas. Os clientes que já atualizaram seus sistemas com êxito não precisam fazer mais nada.
