...
ms:assetid: 'ms10-021'
ms:contentKeyID: 61234148
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-021(v=Security.10)'
---

Microsoft Security Bulletin MS10-021 - Importante
=================================================

Vulnerabilidades no kernel do Windows podem permitir a elevação de privilégio (979683)
--------------------------------------------------------------------------------------
...
Esta atualização de segurança é classificada como Importante para todas as edições com suporte do Microsoft Windows 2000, Windows XP, Windows Server 2003 e a versão de lançamento original do Windows Vista. Esta atualização de segurança é classificada como Moderada para todas as versões com suporte do Windows Vista Service Pack 1 e Windows Vista Service Pack 2, Windows Server 2008, Windows 7 e Windows Server 2008 R2. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança elimina as vulnerabilidades ao corrigir validações, a criação de links simbólicos, a resolução de caminhos virtuais de chave do Registro e a manipulação de exceções. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Problemas conhecidos.** O [Artigo 979683 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/979683) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=c5f4577e-7546-40e9-8bcd-be11c1b260a6)                                                                                        | Elevação de privilégio     | Importante                      | [MS10-015](http://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=142710fd-9cd4-4dd0-aaba-2aace03c008f)                                                                        | Elevação de privilégio     | Importante                      | [MS10-015](http://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3c0cb02e-3484-4cdf-8c64-c697ad3e2889)                                                                           | Elevação de privilégio     | Importante                      | [MS10-015](http://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0a7ea2d0-61ce-4b68-ad82-d917b1a56f9d)                                                                                           | Elevação de privilégio     | Importante                      | [MS10-015](http://technet.microsoft.com/security/bulletin/ms10-015) |
| [Microsoft Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1fc66f54-260a-4219-a0b4-056ba9dd0abe)                                                                     | Elevação de privilégio     | Importante                      | [MS10-015](http://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=8dcb8be8-fb78-4518-aa7e-f8b17f7dfb86)                                                                | Elevação de privilégio     | Importante                      | [MS10-015](http://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Vista](http://www.microsoft.com/downloads/details.aspx?familyid=86d7b054-af4f-4d8a-9873-cb5246466374)                                                                                                                | Elevação de privilégio     | Importante                      | [MS10-015](http://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=86d7b054-af4f-4d8a-9873-cb5246466374)                                                                  | Negação de Serviço         | Moderada                        | [MS10-015](http://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Vista x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=7c84aa24-6331-427a-969c-27f7d39db3d7)                                                                                                    | Elevação de privilégio     | Importante                      | [MS10-015](http://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c84aa24-6331-427a-969c-27f7d39db3d7)                                          | Negação de Serviço         | Moderada                        | [MS10-015](http://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=25e3ce7f-53a0-4049-a65c-011d2143c4c2)\*                 | Negação de Serviço         | Moderada                        | [MS10-015](http://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8b99e54d-955b-4a06-9a04-b2f4596efd72)\*       | Negação de Serviço         | Moderada                        | [MS10-015](http://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b1f9746d-61a2-406f-b707-60646bd5b5bb) | Negação de Serviço         | Moderada                        | [MS10-015](http://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=ff58d80c-33ce-4d9e-aaa5-0b1841458931)                                                                                           | Negação de Serviço         | Moderada                        | [MS10-015](http://technet.microsoft.com/security/bulletin/ms10-015) |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=7f1dc055-2ec9-407a-9e69-da12338587e3)                                                                                      | Negação de Serviço         | Moderada                        | Nenhuma                                                             |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=28389c1d-2a12-4bef-a59b-726bb6449c8b)\*                                                                       | Negação de Serviço         | Moderada                        | Nenhuma                                                             |
| [Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=d4ea3984-5183-47f1-814e-29cb6c90ae06)                                                                     | Negação de Serviço         | Moderada                        | Nenhuma                                                             |
...
**Esta atualização contém a mesma lógica de instalação de pacotes que foi incluída na atualização de segurança do boletim MS10-015?**  
Sim. Esta atualização de segurança inclui a lógica de detecção de pacotes, que evitará a instalação da atualização de segurança se houver certas condições anormais em sistemas de 32 bits. Essas condições anormais em um sistema podem ser o resultado de infecção por um vírus de computador que modifique alguns arquivos do sistema operacional, fazendo com que o computador infectado fique incompatível com a atualização de kernel. Para obter mais informações sobre este problema, consulte a página de Segurança da Microsoft, [Obter ajuda com a mensagem de incompatibilidade do Boletim de Segurança da Microsoft MS10-015](http://www.microsoft.com/security/updates/015).
...
<th style="border:1px solid black;" >Vulnerabilidade de ponteiro nulo do kernel do Windows - CVE-2010-0234</th>
<th style="border:1px solid black;" >Vulnerabilidade de valor de link simbólico do kernel do Windows - CVE-2010-0235</th>
<th style="border:1px solid black;" >Vulnerabilidade de alocação de memória do kernel do Windows - CVE-2010-0236</th>
<th style="border:1px solid black;" >Vulnerabilidade de criação de link simbólico do kernel do Windows - CVE-2010-0237</th>
<th style="border:1px solid black;" >Vulnerabilidade da chave do Registro do kernel do Windows - CVE-2010-0238</th>
<th style="border:1px solid black;" >Vulnerabilidade de análise de caminho virtual do Windows - CVE-2010-0481</th>
<th style="border:1px solid black;" >Vulnerabilidade de imagem malformada do kernel do Windows - CVE-2010-0482</th>
<th style="border:1px solid black;" >Vulnerabilidade no manipulador de exceções do kernel do Windows - CVE-2010-0810</th>
...
Vulnerabilidade de ponteiro nulo do kernel do Windows - CVE-2010-0234  
---------------------------------------------------------------------
  
Existe uma vulnerabilidade de negação de serviço no kernel do Windows devido à validação insuficiente de chaves do Registro transmitidas para uma chamada de sistema do kernel do Windows. O invasor pode explorar a vulnerabilidade executando um aplicativo especialmente criado, fazendo com que o sistema pare de responder e seja reiniciado automaticamente.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0234](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0234).
  
#### Fatores atenuantes da vulnerabilidade de ponteiro nulo do kernel do Windows - CVE-2010-0234
...
#### Soluções alternativas para a vulnerabilidade de ponteiro nulo do kernel do Windows - CVE-2010-0234
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de ponteiro nulo do kernel do Windows - CVE-2010-0234
...
Para explorar essa vulnerabilidade, primeiro o invasor precisa fazer logon no sistema. Em seguida, ele precisa executar um aplicativo especialmente criado capaz de explorar a vulnerabilidade e fazer o sistema parar de responder e ser reinicializado automaticamente.
...
Vulnerabilidade de valor de link simbólico do kernel do Windows - CVE-2010-0235  
-------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de negação de serviço no kernel do Windows devido à maneira como o kernel processa os valores de links simbólicos. O invasor pode explorar a vulnerabilidade executando um aplicativo especialmente criado, fazendo com que o sistema pare de responder e seja reiniciado automaticamente.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0235](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0235).
  
#### Fatores atenuantes da vulnerabilidade de valor de link simbólico do kernel do Windows - CVE-2010-0235
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade de valor de link simbólico do kernel do Windows - CVE-2010-0235
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de valor de link simbólico do kernel do Windows - CVE-2010-0235
  
**Qual é o escopo da vulnerabilidade?**    
Essa é uma vulnerabilidade de negação de serviço (site em inglês). O invasor que explorar essa vulnerabilidade poderá fazer com que o sistema afetado pare de responder e reinicie automaticamente. Observe que a vulnerabilidade de negação de serviço não permite que o invasor execute códigos nem eleve seus direitos de usuário, mas pode fazer o sistema afetado parar de aceitar solicitações.
  
**O que provoca a vulnerabilidade?**    
O kernel do Windows não manipula adequadamente certos links simbólicos especialmente criados.
...
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade assegurando que o kernel do Windows valide adequadamente os valores de link simbólico antes que o link simbólico possa ser criado.
...
Vulnerabilidade de alocação de memória do kernel do Windows - CVE-2010-0236  
---------------------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio no kernel do Windows devido à maneira como a memória é alocada ao extrair um link simbólico de uma chave do Registro. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0236](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0236).
  
#### Fatores atenuantes da vulnerabilidade de alocação de memória do kernel do Windows - CVE-2010-0236
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade de alocação de memória do kernel do Windows - CVE-2010-0236
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de alocação de memória do kernel do Windows - CVE-2010-0236
...
**O que provoca a vulnerabilidade?**    
O kernel do Windows não aloca memória corretamente ao extrair a chave de destino de uma chave do Registro do tipo link simbólico.
...
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade assegurando que o kernel do Windows valide adequadamente o valor de link simbólico antes que o link simbólico possa ser criado.
...
Vulnerabilidade de criação de link simbólico do kernel do Windows - CVE-2010-0237  
---------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio quando o kernel do Windows não restringe adequadamente a criação de link simbólico entre seções não confiáveis e confiáveis do Registro. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0237](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0237).
  
#### Fatores atenuantes da vulnerabilidade de criação de link simbólico do kernel do Windows - CVE-2010-0237
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Esta vulnerabilidade permite que um usuário sem privilégios em um computador execute código arbitrário no contexto de um usuário que faça logon posteriormente no mesmo computador. O invasor não pode escolher qual usuário será representado.  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade de criação de link simbólico do kernel do Windows - CVE-2010-0237
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de criação de link simbólico do kernel do Windows - CVE-2010-0237
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**    
O kernel do Windows não restringe adequadamente a criação de link simbólico entre seções não confiáveis e confiáveis do Registro.
...
**O que a atualização faz?**    
A atualização elimina esta vulnerabilidade bloqueando corretamente a transposição de links simbólicos de seções não confiáveis para seções confiáveis.
...
Vulnerabilidade da chave do Registro do kernel do Windows - CVE-2010-0238  
-------------------------------------------------------------------------
  
Existe uma vulnerabilidade de negação de serviço na maneira como o kernel do Windows valida chaves do Registro. O invasor pode explorar a vulnerabilidade executando um aplicativo especialmente criado, fazendo com que o sistema pare de responder e seja reiniciado automaticamente.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0238](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0238).
  
#### Fatores atenuantes da vulnerabilidade da chave do Registro do kernel do Windows - CVE-2010-0238
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade da chave do Registro do kernel do Windows - CVE-2010-0238
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade da chave do Registro do kernel do Windows - CVE-2010-0238
  
**Qual é o escopo da vulnerabilidade?**    
Essa é uma vulnerabilidade de negação de serviço (site em inglês). O invasor que explorar essa vulnerabilidade poderá fazer com que o sistema afetado pare de responder e reinicie automaticamente. Observe que a vulnerabilidade de negação de serviço não permite que o invasor execute códigos nem eleve seus direitos de usuário, mas pode fazer o sistema afetado parar de aceitar solicitações.
  
**O que provoca a vulnerabilidade?**    
O kernel do Windows não valida chaves do Registro adequadamente.
...
**O que a atualização faz?**    
A atualização elimina esta vulnerabilidade corrigindo a maneira como o kernel do Windows valida chaves do Registro.
...
Vulnerabilidade de análise de caminho virtual do Windows - CVE-2010-0481  
------------------------------------------------------------------------
  
Existe uma vulnerabilidade de negação de serviço no kernel do Windows devido à maneira como o kernel resolve o caminho real para uma chave do Registro a partir do seu caminho virtual. O invasor pode explorar a vulnerabilidade executando um aplicativo especialmente criado, fazendo com que o sistema pare de responder e seja reiniciado automaticamente.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0481](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0481).
  
#### Fatores atenuantes da vulnerabilidade de análise de caminho virtual do Windows - CVE-2010-0481
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade de análise de caminho virtual do Windows - CVE-2010-0481
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de análise de caminho virtual do Windows - CVE-2010-0481
  
**Qual é o escopo da vulnerabilidade?**    
Essa é uma vulnerabilidade de negação de serviço (site em inglês). O invasor que explorar essa vulnerabilidade poderá fazer com que o sistema afetado pare de responder e reinicie automaticamente. Observe que a vulnerabilidade de negação de serviço não permite que o invasor execute códigos nem eleve seus direitos de usuário, mas pode fazer o sistema afetado parar de aceitar solicitações.
  
**O que provoca a vulnerabilidade?**    
O kernel do Windows não valida um caminho virtual suficientemente para assegurar que seja válido.
...
**O que a atualização faz?**    
A atualização elimina esta vulnerabilidade corrigindo a maneira como o kernel do Windows resolve caminhos virtuais de chave do Registro.
...
Vulnerabilidade de imagem malformada do kernel do Windows - CVE-2010-0482  
-------------------------------------------------------------------------
  
Existe uma vulnerabilidade de negação de serviço no kernel do Windows devido à validação imprópria de arquivos de imagem especialmente criados. O invasor pode explorar a vulnerabilidade executando um aplicativo especialmente criado, fazendo com que o sistema pare de responder e seja reiniciado automaticamente.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0482](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0482).
  
#### Fatores atenuantes da vulnerabilidade de imagem malformada do kernel do Windows - CVE-2010-0482
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade de imagem malformada do kernel do Windows - CVE-2010-0482
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de imagem malformada do kernel do Windows - CVE-2010-0482
  
**Qual é o escopo da vulnerabilidade?**    
Essa é uma vulnerabilidade de negação de serviço (site em inglês). O invasor que explorar essa vulnerabilidade poderá fazer com que o sistema afetado pare de responder e reinicie automaticamente. Observe que a vulnerabilidade de negação de serviço não permite que o invasor execute códigos nem eleve seus direitos de usuário, mas pode fazer o sistema afetado parar de aceitar solicitações.
  
**O que provoca a vulnerabilidade?**    
O kernel do Windows não valida adequadamente a seção de mudança de arquivos de imagem especialmente criados.
...
**O que a atualização faz?**    
A atualização elimina esta vulnerabilidade corrigindo a maneira como o kernel do Windows valida a seção de mudança de arquivos de imagem especialmente criados.
...
Vulnerabilidade no manipulador de exceções do kernel do Windows - CVE-2010-0810  
-------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de negação de serviço no kernel do Windows devido à maneira como o kernel manipula determinadas exceções. O invasor pode explorar a vulnerabilidade executando um aplicativo especialmente criado, fazendo com que o sistema pare de responder e seja reiniciado automaticamente.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0810](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0810).
  
#### Fatores atenuantes da vulnerabilidade no manipulador de exceções do kernel do Windows - CVE-2010-0810
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade no manipulador de exceções do kernel do Windows - CVE-2010-0810
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade no manipulador de exceções do kernel do Windows - CVE-2010-0810
...
**O que a atualização faz?**    
A atualização elimina esta vulnerabilidade, garantindo que o kernel do Windows manipule a exceção corretamente.
...
| **Implantação**                       |                                                                                                                                                                       |  
| Instalar sem intervenção do usuário   | Windows2000-KB979683-x86-enu /quiet                                                                                                                                   |  
| Instalar sem reinicializar            | Windows2000-KB979683-x86-enu /norestart                                                                                                                               |  
| Arquivo de log de atualização         | KB979683.log                                                                                                                                                          |  
...
| **Informações sobre remoção**         | Use a ferramenta **Adicionar ou Remover Programas** no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB979683$\\Spuninst |  
| **Informações sobre o arquivo**       | Consulte o [Artigo 979683 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/979683)                                                            |  
| **Verificação da Chave do Registro**  | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB979683\\Filelist                                                                             |
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB979683$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/979683">Artigo 979683 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Matthew ‘j00ru' Jurczyk e Gynvael Coldwind, da [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/), por relatar a vulnerabilidade de ponteiro nulo do kernel do Windows (CVE-2010-0234)  
-   Matthew ‘j00ru' Jurczyk e Gynvael Coldwind, da [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/), por relatar a vulnerabilidade de valor de link simbólico do kernel do Windows (CVE-2010-0235)  
-   Matthew ‘j00ru' Jurczyk e Gynvael Coldwind, da [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/), por relatar a vulnerabilidade de alocação de memória do kernel do Windows (CVE-2010-0236)  
-   Gynvael Coldwind e Matthew ‘j00ru' Jurczyk, da [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/), por relatar a vulnerabilidade de criação de link simbólico do kernel do Windows (CVE-2010-0237)  
-   Matthew ‘j00ru' Jurczyk e Gynvael Coldwind, da [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/), por relatar a vulnerabilidade da chave do Registro do kernel do Windows (CVE-2010-0238)  
-   Tavis Ormandy, da [Google, Inc.](http://www.google.com/), por relatar a vulnerabilidade de análise de caminho virtual do Windows (CVE-2010-0481)  
-   Martin Tofall, da [Obsidium Software](http://www.obsidium.de/), por relatar a vulnerabilidade de imagem malformada do kernel do Windows (CVE-2010-0482)  
-   Tavis Ormandy, da [Google Inc.](http://www.google.com/), por relatar a vulnerabilidade no manipulador de exceções do kernel do Windows (CVE-2010-0810)
