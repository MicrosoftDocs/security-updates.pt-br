...
ms:assetid: 'ms10-073'
ms:contentKeyID: 61234211
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-073(v=Security.10)'
---

Microsoft Security Bulletin MS10-073 - Importante
=================================================

Vulnerabilidades nos drivers do modo kernel do Windows podem permitir a elevação de privilégio (981957)
-------------------------------------------------------------------------------------------------------
...
Esta atualização de segurança resolve várias vulnerabilidades divulgadas publicamente nos drivers do modo kernel do Windows. A mais severa destas vulnerabilidades poderá permitir a elevação de privilégio se um invasor se conectar a um sistema afetado e executar um aplicativo especialmente criado. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
...
A atualização de segurança aborda as vulnerabilidades, corrigindo a maneira como os drivers do modo kernel do Windows mantêm a contagem de referência para um objeto, indexam uma tabela de ponteiros de função ao carregarem um layout de teclado do disco e validam dados de classe de janelas. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=3966d754-d298-4e4a-9ce6-8205accd2215)                                                                                                    | Elevação de privilégio     | Importante                      | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7fd7c675-0675-4a87-a709-edc47a30f1e2)                                                                           | Elevação de privilégio     | Importante                      | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8ef4378e-21ff-4290-96ba-e00a60f372d1)                                                                                           | Elevação de privilégio     | Importante                      | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4a95c74b-cfd8-45b5-8887-777429d21745)                                                                               | Elevação de privilégio     | Importante                      | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=21637cd8-c75c-43b4-9948-be7be54af6bf)                                                                | Elevação de privilégio     | Importante                      | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e9f735ab-d995-4209-b2dc-197f53fdee0f)                                                                  | Elevação de privilégio     | Importante                      | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=738c8f70-b46a-4a59-bea6-078074a9c4db)                                          | Elevação de privilégio     | Importante                      | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4dff0ebe-ccba-4675-98ca-9903f1cb6763)\*                 | Elevação de privilégio     | Importante                      | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=da7905a9-9587-4184-8fca-ecc636a3b67e)\*       | Elevação de privilégio     | Importante                      | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b9096046-8c7a-450c-b8c5-6e9fb001e6cd) | Elevação de privilégio     | Importante                      | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=b5b31499-d242-42bf-ac78-b787ffb4d602)                                                                                           | Elevação de privilégio     | Importante                      | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=c47e8b74-8cfe-42d9-9362-8786687c88ad)                                                                                      | Elevação de privilégio     | Importante                      | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=98e0c6ac-c30b-4d39-8ed9-1fe69e7644e5)\*                                                                       | Elevação de privilégio     | Importante                      | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=44080c75-036e-4bd0-914a-74ab72189ee3)                                                                     | Elevação de privilégio     | Importante                      | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
...
<th style="border:1px solid black;" >Vulnerabilidade de contagem de referência do Win32k - CVE-2010-2549</th>
<th style="border:1px solid black;" >Vulnerabilidade de layout de teclado do Win32k - CVE-2010-2743</th>
<th style="border:1px solid black;" >Vulnerabilidade de classe do Windows Win32k - CVE-2010-2744</th>
...
Vulnerabilidade de contagem de referência do Win32k - CVE-2010-2549  
-------------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio devido à maneira como os drivers do modo do kernel do Windows mantêm a contagem de referência para um objeto. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-2549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549).
  
#### Fatores atenuantes da Vulnerabilidade de contagem de referência do Win32k - CVE-2010-2549
...
#### Soluções alternativas para a Vulnerabilidade de contagem de referência do Win32k - CVE-2010-2549
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade de contagem de referência do Win32k - CVE-2010-2549
...
A vulnerabilidade é causada quando os drivers do modo do kernel do Windows não mantêm adequadamente a contagem de referência para um objeto.
...
Uma contagem de referência é o registro do gerenciador de objetos de quantos ponteiros de objeto ele ofereceu aos processos de sistema operacional. O gerenciador de objetos incrementa uma contagem de referência para um objeto toda vez que ele fornece um ponteiro ao objeto; quando os componentes do modo do kernel terminam de usar o ponteiro, eles chamam o gerenciador de objetos para diminuir a contagem de referência do objeto.
...
A atualização aborda esta vulnerabilidade, corrigindo a maneira como os drivers do modo do kernel do Windows mantêm a contagem de referência para um objeto.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2010-2549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549) da lista Common Vulnerability and Exposure.
  
**Quando este boletim de segurança foi lançado, a Microsoft tinha recebido algum relatório informando que essa vulnerabilidade estava sendo explorada?**  
Não. A Microsoft não recebeu nenhuma informação indicando que essa vulnerabilidade tenha sido usada publicamente para atacar clientes e não testemunhou nenhum exemplo de publicação de código de verificação de conceito, quando este boletim de segurança foi lançado pela primeira vez.
  
Vulnerabilidade de layout de teclado do Win32k - CVE-2010-2743  
--------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio devido à maneira como os drivers do modo do kernel do Windows carrega layouts específicos de teclado. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-2743](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743).
  
#### Fatores atenuantes da Vulnerabilidade de layout de teclado do Win32k - CVE-2010-2743
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a Vulnerabilidade de layout de teclado do Win32k - CVE-2010-2743
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade de layout de teclado do Win32k - CVE-2010-2743
  
**Qual é o escopo da vulnerabilidade?**  
Esta é uma vulnerabilidade de elevação de privilégio. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando os drivers do modo do kernel do Windows não indexam adequadamente uma tabela de ponteiros de funções ao carregar um layout de teclado do disco.
  
**Por que esta vulnerabilidade tem uma classificação de gravidade baixa para todas as edições do Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2 com suporte?**  
Nessas versões do Windows, o código pertencente a esta vulnerabilidade existe, mas não tem como um invasor acessar esse código. No entanto, esta atualização aborda este código como uma medida de defesa profunda caso uma maneira seja encontrada no futuro de aproveitar este código para elevar privilégios.
...
**O que a atualização faz?**  
A atualização aborda esta vulnerabilidade, corrigindo a maneira como os drivers do modo do kernel do Windows indexam uma tabela de ponteiros de funções ao carregar um layout de teclado do disco.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2010-2743](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743) da lista Common Vulnerability and Exposure.
  
**Quando este boletim de segurança foi lançado, a Microsoft tinha recebido algum relatório informando que essa vulnerabilidade estava sendo explorada?**  
Sim. Por ocasião da publicação deste boletim, esta vulnerabilidade estava sendo explorada em escala limitada por malware.
  
Vulnerabilidade de classe do Windows Win32k - CVE-2010-2744  
-----------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio quando os drivers do modo do kernel do Windows não validam adequadamente os dados de classe de janelas. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-2744](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744).
  
#### Fatores atenuantes da Vulnerabilidade na classe de janelas do Win32k - CVE-2010-2744
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a Vulnerabilidade na classe de janelas do Win32k - CVE-2010-2744
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade na classe de janelas do Win32k - CVE-2010-2744
  
**Qual é o escopo da vulnerabilidade?**  
Esta é uma vulnerabilidade de elevação de privilégio. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**  
Esta vulnerabilidade é causada pelos drivers do modo do kernel do Windows por não gerenciarem adequadamente uma classe de janelas.
...
Uma classe de janelas é um conjunto de atributos que o sistema usa como um modelo para criar uma janela. Cada janela é um membro de uma classe de janelas. Todas as classes de janelas são específicas a processos. Existem três tipos de classes de janelas. Uma classe de sistema é uma classe de janelas registrada pelo sistema. Muitas classes de sistema estão disponíveis para todos os processos usarem, enquanto outras são usadas somente internamente pelo sistema. Como o sistema registra essas classes, um processo não pode destruí-las. Uma classe global de aplicativos é uma classe de janelas registrada por um arquivo executável ou DLL que está disponível a todos os outros módulos no processo. Uma classe local de aplicativos é qualquer classe de janelas que um arquivo executável ou .dll registra para seu uso exclusivo. Embora você possa registrar qualquer quantidade de classes locais, é comum registrar somente uma. Essa classe de janela oferece suporte ao procedimento de janelas da janela principal do aplicativo. Para obter mais informações sobre classes de janelas, consulte o artigo do MSDN, [Windows Classes](http://msdn.microsoft.com/en-us/library/ms632596(v=vs.85).aspx) (em inglês).
...
**O que a atualização faz?**  
A atualização aborda esta vulnerabilidade, corrigindo a maneira como os drivers do modo do kernel do Windows validam dados de classe de janelas.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2010-2744](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744) da lista Common Vulnerability and Exposure.
...
Para Windows XP Service Pack 3:windowsxp-kb981957-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><br />
Para Windows XP Service Pack 3:windowsxp-kb981957-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB981957$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/981957">Artigo 981957 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Sergey Golovanov, Alexander Gostev, Maxim Golovkin e Alexey Monastyrsky, do [Kaspersky Lab](http://www.kaspersky.com/), e Vitaly Kiktenko e Alexander Saprykin, do [Design and Test Lab](http://www.dnt-lab.com/), por relatarem a Vulnerabilidade de layout de teclado do Win32K (CVE-2010-2743).  
-   Eric Chien, da [Symantec](http://www.symantec.com/index.jsp), por relatar a Vulnerabilidade de layout de teclado do Win32k (CVE-2010-2743)  
-   Tarjei Mandt, da [Norman](http://www.norman.com), por trabalhar conosco na Vulnerabilidade de classe do Windows Win32k (CVE-2010-2744)
