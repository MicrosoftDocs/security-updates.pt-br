...
ms:assetid: 'ms10-084'
ms:contentKeyID: 61234223
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-084(v=Security.10)'
---
...
A atualização de segurança aborda a vulnerabilidade, modificando a maneira como as mensagens de porta de LRPC são manipuladas dentro do subsistema de RPC. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6049c879-b81a-4d10-b96b-b2837cb24834)                                     | Elevação de privilégio     | Importante                      | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d690846c-5e0b-4216-84cd-d17e366dd16d)            | Elevação de privilégio     | Importante                      | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b31e18b0-da9f-4b3b-82c6-603e08b3b241)                            | Elevação de privilégio     | Importante                      | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1d73f0f1-6ec8-4304-a20e-345d8b6c225a)                | Elevação de privilégio     | Importante                      | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=8fad4f77-7c89-4684-b957-9c00ced248d3) | Elevação de privilégio     | Importante                      | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
...
<th style="border:1px solid black;" >Vulnerabilidade de saturação de buffer de mensagem de LPC - CVE-2010-3222</th>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=?...?">Windows Server 2003 com SP2 para sistemas baseados no Itanium</a></td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Elevação de privilégio</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
...
Vulnerabilidade de saturação de buffer de mensagem de LPC - CVE-2010-3222  
-------------------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio no Subsistema de Chamada de Procedimento Remoto (RPCSS) executando no contexto da conta NetworkService, onde um aplicativo local pode usar LPC para solicitar que o servidor de LPC se conecte novamente ao cliente usando LRPC. Esta solicitação pode conter dados especialmente criados projetados para causar uma saturação de buffer baseada em pilha, permitindo que um usuário autenticado acesse recursos durante uma execução no contexto da conta NetworkService.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3222](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3222).
  
#### Fatores atenuantes da vulnerabilidade de saturação de buffer de mensagem de LPC - CVE-2010-3222
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.
  
#### Soluções alternativas para a Vulnerabilidade de saturação de buffer de mensagem de LPC - CVE-2010-3222
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade de saturação de buffer de mensagem de LPC - CVE-2010-3222
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. Um invasor com credenciais de usuário que explorar esta vulnerabilidade com êxito poderá executar código especialmente criado no contexto da conta NetworkService.
  
**O que provoca a vulnerabilidade?**    
Esta vulnerabilidade é causada por uma saturação de buffer baseada em pilha na troca de mensagens de porta entre LPC e o servidor de LRPC (Mapeador de Ponto de Extremidade RPC) contidos no RPCSS.
  
**Qual componente é afetado pela vulnerabilidade?**    
O componente afetado pela vulnerabilidade é LPC (Chamada de Procedimento Local) da Microsoft, um componente de RPC (Chamada de Procedimento Remoto).
  
**O que é LPC?**  
LPC (Chamada de Procedimento Local) é um serviço de transmissão de mensagens incluído no Windows. Esse serviço permite que segmentos e processos se comuniquem uns com os outros. Quando um processo cliente precisa requisitar um serviço de um processo servidor, é preciso que haja uma forma de comunicação entre os dois processos. É preciso que o processo cliente possa fazer solicitações ao servidor, que o servidor possa enviar respostas ao cliente e que cada um possa determinar seus status. Quando o processo cliente e o processo servidor estão localizados em sistemas diferentes, usa-se o serviço RPC (chamada de procedimento remoto). Quando estão localizados no mesmo sistema, usa-se o LPC.
...
**O que é LRPC?**  
RPC local (LRPC) denota comunicação de RPC que acontece em um sistema local.
  
**Para que um invasor pode usar a vulnerabilidade?**    
Um invasor que explorar esta vulnerabilidade com êxito poderá executar código especialmente criado no contexto da conta do NetworkService, conseguindo acessar recursos ao executar como NetworkService. Alguns desses processos podem ter a capacidade de elevar seus privilégios no LocalSystem, permitindo que qualquer processo NetworkService eleve seus privilégios a LocalSystem também. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**De que forma o invasor pode explorar a vulnerabilidade?**    
Um invasor que fizer logon localmente com credenciais válidas poderá explorar a vulnerabilidade, executando código especialmente criado que envia uma mensagem de LPC ao servidor local de LRPC. A mensagem pode então permitir que um usuário autenticado execute código no contexto da conta NetworkService.
...
A atualização aborda a vulnerabilidade, modificando a maneira como as mensagens de porta de LPC são manipuladas dentro do RPCSS.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2010-3222](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3222) da lista Common Vulnerability and Exposure.
...
Para Windows XP Service Pack 3:WindowsXP-KB2360937-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><br />
Para Windows XP Service Pack 3:WindowsXP-KB2360937-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB2360937$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2360937">Artigo 2360937 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
