...
ms:assetid: 'ms10-085'
ms:contentKeyID: 61234224
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-085(v=Security.10)'
---

Microsoft Security Bulletin MS10-085 - Importante
=================================================

Vulnerabilidade no SChannel pode permitir a negação de serviço (2207566)
------------------------------------------------------------------------

Publicado: terça-feira, 12 de outubro de 2010 | Atualizado: segunda-feira, 18 de outubro de 2010
...
A atualização de segurança aborda a vulnerabilidade mudando a maneira como o SChannel processa solicitações de protocolo enquanto lida com conexões de SSL de entrada. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4af2f6e6-6905-498c-bfba-a565976b3365)                                                                  | Negação de Serviço         | Importante                      | [MS10-049](http://technet.microsoft.com/security/bulletin/ms10-049) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8c56ba29-b2a8-47a8-a605-4c54c0a7fa7c)                                          | Negação de Serviço         | Importante                      | [MS10-049](http://technet.microsoft.com/security/bulletin/ms10-049) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0566915f-2a1b-474b-b5f1-e1a9cedd836a)\*                 | Negação de Serviço         | Importante                      | [MS10-049](http://technet.microsoft.com/security/bulletin/ms10-049) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=74ac2233-02ec-454c-8aa0-64b18071e16a)\*       | Negação de Serviço         | Importante                      | [MS10-049](http://technet.microsoft.com/security/bulletin/ms10-049) |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2fff281a-2221-42a3-a2b7-07b5c5e66ae7) | Negação de Serviço         | Importante                      | [MS10-049](http://technet.microsoft.com/security/bulletin/ms10-049) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=d7a08a66-08b4-421c-afad-f2f367d4a9f0)                                                                                           | Negação de Serviço         | Importante                      | [MS10-049](http://technet.microsoft.com/security/bulletin/ms10-049) |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=50d27c23-5f69-40fa-b517-32c245009467)                                                                                      | Negação de Serviço         | Importante                      | [MS10-049](http://technet.microsoft.com/security/bulletin/ms10-049) |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=d356af2f-eadf-4bf2-82d1-efa0d01ac92d)\*                                                                       | Negação de Serviço         | Importante                      | [MS10-049](http://technet.microsoft.com/security/bulletin/ms10-049) |
| [Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=334d39e6-8e4c-4e83-94c1-1db3d636e865)                                                                     | Negação de Serviço         | Importante                      | [MS10-049](http://technet.microsoft.com/security/bulletin/ms10-049) |
...
**Por que este boletim foi revisado em 18 de outubro de 2010?**   
A Microsoft revisou este boletim para esclarecer que a vulnerabilidade pode ser explorada em sistemas afetados que são configurados para receber conexões de SSL de entrada. Esta é apenas uma alteração informativa. Não houve alterações à lógica de detecção nem aos pacotes de atualização de segurança. Os clientes que já atualizaram seus sistemas com êxito, inclusive clientes com atualização automática habilitada, não precisam fazer mais nada. Os clientes que não instalaram esta atualização anteriormente podem precisar reavaliar se seus sistemas requerem esta atualização com base nas informações sobre a vulnerabilidade conforme revisadas.
...
<th style="border:1px solid black;" >Vulnerabilidade de negação de serviço TLSv1 - CVE-2010-3229</th>
...
Vulnerabilidade de negação de serviço TLSv1 - CVE-2010-3229  
-----------------------------------------------------------
  
Uma vulnerabilidade de negação de serviço existe na maneira como o SChannel processa solicitações de protocolo enquanto lida com conexões de SSL de entrada no Windows Server 2008, Windows Vista, Windows Server 2008 R2 e Windows 7. Um invasor anônimo remoto poderia enviar um pacote de rede especialmente criado ao sistema afetado que faria com que o serviço de LSASS parasse de responder e o sistema fosse reiniciado. Os sistemas só serão afetados se um serviço ou aplicativo for configurado para receber tráfego de rede de SSL.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3229](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3229).
  
#### Fatores atenuantes para a vulnerabilidade de negação de serviço TLSv1 - CVE-2010-3229
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   A vulnerabilidade só pode ser explorada em sistemas em que um aplicativo ou serviço está configurado para receber conexões de SSL de entrada. Os sistemas que somente iniciam conexões de SSL de saída não podem ser explorados com esta vulnerabilidade.  
-   Por padrão, todas as edições com suporte do Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2 não são configuradas para receber tráfego de rede de SSL.
  
#### Soluções alternativas para a vulnerabilidade de negação de serviço TLSv1 - CVE-2010-3229
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de negação de serviço TLSv1 - CVE-2010-3229
  
**Qual é o escopo da vulnerabilidade?**    
Essa é uma vulnerabilidade de negação de serviço (site em inglês). Um invasor que explorar a vulnerabilidade pode fazer com que o serviço LSASS pare e o computador seja reiniciado, criando uma condição de Negação de serviço até que o sistema seja reiniciado com êxito. Um invasor poderá explorar a vulnerabilidade novamente.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada quando o SChannel falha ao verificar uma condição lógica antes de processar uma solicitação de protocolo durante um handshake SSL/TLS.
...
Para obter mais informações, consulte o artigo do MSDN, [Secure Channel](http://msdn.microsoft.com/en-us/library/aa380123(vs.85).aspx).
...
Ao estabelecer uma sessão segura, usar TLS ou SSL, o Protocolo de handshake gerencia o seguinte:
...
O invasor que explorar essa vulnerabilidade com êxito poderá fazer com que um servidor pare de responder e inicie uma reinicialização.
  
**De que forma o invasor pode explorar a vulnerabilidade?**    
Um invasor anônimo remoto pode enviar uma mensagem de pacote especialmente criado a um serviço ou aplicativo habilitado para SSL que estiver sendo executado em um sistema afetado. A vulnerabilidade só pode ser explorada se o serviço ou aplicativo usa SChannel para processar tráfego de SSL. Os exemplos de serviços ou aplicativos habilitados para SSL incluem, mas não se limitam, a IIS (Serviços de Informações da Internet), RDP (Remote Desktop Protocol), e SSTP (Secure Socket Tunneling Protocol), assim como outras implementações de capsulamento, como SMTP-over-SSL ou LDAP-over-SSL. Em todos os casos, o invasor enviaria um pacote especialmente criado como parte do handshake SSL. Uma exploração bem-sucedida faria com que o LSASS parasse de responder e o sistema fosse reinicializado, resultando em uma negação de serviço temporária. Uma vez o sistema é reinicializado com êxito, um invasor pode explorar a vulnerabilidade novamente.
  
**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**    
Esta vulnerabilidade pode ser explorada em sistemas que executam uma versão afetada do Microsoft Windows no qual um aplicativo ou serviço está configurado para receber conexões de SSL de entrada. Os exemplos de sistemas afetados incluem, mas não se limitam, a sistemas que são configurados como servidores da Web que aceitam conexões de SSL, servidores de VPN que aceitam conexões de SSTP de entrada e servidores na função de Serviços de Área de Trabalho. As estações de trabalhos que executam uma versão afetada do Microsoft Windows em que RDP (Remote Desktop Protocol) está habilitado também correm risco.
  
Os sistemas que iniciam mas não recebem conexões de SSL correm menos risco. Os exemplos de sistemas que correm menos risco incluem estações de trabalho em que os usuários navegam na Web ou laptops dos quais os usuários se conectam como um cliente a uma VPN. Observe que tais sistemas clientes também podem ter aplicativos ou serviços em execução que aceitam conexões de SSL de entrada. Nesse caso, esses sistemas também correm risco.
  
**O que a atualização faz?**    
A atualização aborda a vulnerabilidade mudando a maneira como o SChannel processa solicitações de protocolo enquanto lida com conexões de SSL de entrada.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2207566">Artigo 2207566 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
-   A [Mu Test Suite Team](http://www.mudynamics.com/products/mu-test-suite.html) na [Mu Dynamics](http://www.mudynamics.com) por relatar a vulnerabilidade de negação de serviço TLSv1 (CVE-2010-3229)
...
-   V2.0 (18 de outubro de 2010): Corrigido o texto do boletim para esclarecer que a vulnerabilidade pode ser explorada em sistemas afetados que são configurados para receber tráfego de rede de SSL. Esta é apenas uma alteração informativa. Os clientes que já atualizaram seus sistemas com êxito, inclusive clientes com atualização automática habilitada, não precisam fazer mais nada. Os clientes que não instalaram esta atualização anteriormente podem precisar reavaliar se seus sistemas requerem esta atualização com base nas informações sobre a vulnerabilidade conforme revisadas.
