...
ms:assetid: 'ms10-007'
ms:contentKeyID: 61234061
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-007(v=Security.10)'
---

Microsoft Security Bulletin MS10-007 - Crítica
==============================================

Vulnerabilidade no manipulador de Shell do Windows pode permitir a execução remota de código (975713)
-----------------------------------------------------------------------------------------------------
...
A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira como a função ShellExecute API valida os parâmetros de entrada. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade** .
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=92234237-a8eb-4ce4-bc5e-cd86feb7dbd3)                         | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b8e7bf17-a037-4200-9ae2-2280b19766a4)         | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b8d83f30-9cd7-4d6b-b2b9-65d0a483cb9c)            | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5cb2e203-18fb-4887-a1c9-289d86b8ba11)                            | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Microsoft Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=90360537-9311-45e2-8047-9a971f90c3c3)      | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=d695ca9f-a1db-4c0f-94b6-7112861c28da) | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
...
**Como esta atualização de segurança está relacionada ao CVE-2010-0027 descrito no boletim MS10-002?**  
A Vulnerabilidade de validação de URL (CVE-2010-0027) é abordada por esta atualização (MS10-007) e pela [Atualização de segurança cumulativa para o Internet Explorer (MS10-002)](http://technet.microsoft.com/security/bulletin/ms10-002) , dependendo da versão do Microsoft Windows e do Internet Explorer instalada no sistema do usuário.
...
<span></span>
Existe uma vulnerabilidade de execução remota de código nas versões afetadas do Microsoft Windows. A vulnerabilidade resulta da validação incorreta de entrada enviada à função ShellExecute API. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado.
...
Essa é uma vulnerabilidade de execução remota de código. Um invasor que explore com êxito esta vulnerabilidade pode executar ações com os mesmos direitos que o usuário conectado no momento.
  
**O que provoca a vulnerabilidade?**    
Quando um aplicativo, como um navegador da Web, usa a função ShellExecute API para processar dados especialmente criados, ShellExecute pode validar incorretamente o fluxo de dados e executar um binário do sistema cliente local.
...
ShellExecute é parte das funções API do Shell do Windows. Ele executa uma operação em um arquivo especificado. Isso pode, por exemplo, significar chamar o manipulador correto para esse tipo de arquivo específico. Mais informações sobre a função ShellExecute podem ser encontradas no artigo MSDN, [Função ShellExecute](http://msdn.microsoft.com/en-us/library/bb762153(vs.85).aspx) .
  
**O que é uma API (Interface de Programação de Aplicativo)?**    
Uma API é um conjunto de funções que você pode usar para trabalhar com um componente, aplicativo ou sistema operacional. Geralmente, uma API consiste em um ou mais DLLs que fornecem uma funcionalidade específica.
  
**Para que um invasor pode usar a vulnerabilidade?**    
Um invasor que explorar com êxito essa vulnerabilidade pode executar o código arbitrário como o usuário conectado. Se um usuário estiver conectado com direitos administrativos, o invasor poderá assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
**De que forma o invasor pode explorar a vulnerabilidade?**    
Um invasor pode fornecer conteúdo como uma página da Web especialmente criada, o que faria com que um aplicativo analisasse uma sequência de caracteres malformada. Quando esse conteúdo é enviado à chamada ShellExecute API, por exemplo, como um hiperlink, isso pode permitir que um invasor execute um binário a partir do sistema cliente, sem o conhecimento do usuário conectado.
  
**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**    
Os sistemas cliente que procuram conteúdo de Internet não confiável são os que mais correm risco com essa vulnerabilidade, o que pode permitir a exploração no contexto do usuário conectado.
  
**O que a atualização faz?**    
Esta atualização elimina a vulnerabilidade, corrigindo a maneira como a função ShellExecute API valida os parâmetros de entrada nas edições com suporte do Microsoft Windows 2000, Windows XP e Windows Server 2003.
...
| **Implantação**                       |                                                                                                                                                                       |  
| Instalar sem intervenção do usuário   | Windows2000-KB975713-x86-ENU /quiet                                                                                                                                   |  
| Instalar sem reinicializar            | Windows2000-KB975713-x86-ENU /norestart                                                                                                                               |  
| Arquivo de log de atualização         | kb975713.log                                                                                                                                                          |  
...
| **Informações sobre remoção**         | Use a ferramenta **Adicionar ou Remover Programas** no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB975713$\\Spuninst |  
| **Informações sobre o arquivo**       | Consulte o [Artigo 975713 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/975713)                                                            |  
| **Verificação da Chave do Registro**  | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB975713\\Filelist                                                                             |
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB975713$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/975713">Artigo 975713 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
