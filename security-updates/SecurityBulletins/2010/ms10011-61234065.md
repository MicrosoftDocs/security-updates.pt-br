...
ms:assetid: 'ms10-011'
ms:contentKeyID: 61234065
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-011(v=Security.10)'
---
...
Vulnerabilidade no CSRSS (Windows Client/Server Runtime Subsystem) pode permitir elevação de privilégio (978037)
----------------------------------------------------------------------------------------------------------------

Publicado: terça-feira, 9 de fevereiro de 2010 | Atualizado: quarta-feira, 9 de junho de 2010
...
**Problemas conhecidos.** O [Artigo 978037 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/978037) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=456185b5-57d1-4fa5-a4a9-5b2006ede3ad)                         | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b9234b40-1b1c-498b-90d4-0bff347b36ee)         | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1f83bf7a-e16c-404a-89bd-f65843938299)            | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2c8c4eec-255e-41d5-b1e6-f0204edcb46f)                            | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Microsoft Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=de0186f6-27a2-4226-b8eb-f2912710f072)      | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=87732f7a-9339-43bc-a4e8-3da849f35b70) | Elevação de privilégio     | Importante                      | Nenhuma                                    |
...
<th style="border:1px solid black;" >Vulnerabilidade de elevação de privilégio local de CSRSS – CVE-2010-0023</th>
...
Vulnerabilidade de elevação de privilégio local de CSRSS – CVE-2010-0023  
------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégio uma vez que o CSRSS não termina corretamente os processos de usuário quando um usuário faz logout. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0023](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0023).
  
#### Fatores atenuantes da vulnerabilidade de elevação de privilégio local de CSRSS - CVE-2010-0023
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade de elevação de privilégio local de CSRSS - CVE-2010-0023
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de elevação de privilégio local de CSRSS - CVE-2010-0023
...
O CSRSS não termina corretamente os processos de usuário quando um usuário faz logout.
  
**O que é o CSRSS (Client Server RunTime Subsystem)?**    
O CSRSS é a parte do modo de usuário do subsistema Win32. O CSRSS é um subsistema essencial que deve estar em execução todo o tempo. O CSRSS é responsável pelas janelas do console, criando e/ou excluindo segmentos.
  
**Para que um invasor pode usar a vulnerabilidade?**    
O invasor que explorar com êxito esta vulnerabilidade poderá executar o código no nível de privilégio de um usuário que se conecte subsequentemente no sistema. Se um administrador se conectasse ao sistema, o código do invasor seria executado com privilégios elevados. O invasor que explorar com êxito esta vulnerabilidade também poderá executar um código projetado para monitorar as ações de um usuário que se conecte subsequentemente ao sistema. Isso pode permitir a divulgação de informações confidenciais ou acesso a dados nos sistemas afetados acessíveis aos usuário conectado.
  
**De que forma o invasor pode explorar a vulnerabilidade?**    
Para explorar essa vulnerabilidade, primeiro o invasor precisa fazer logon no sistema. Um invasor pode iniciar um aplicativo especialmente criado projetado para continuar executando depois de o usuário fazer logout. Quando um novo usuário se conectar com suas próprias credenciais, o processo do invasor poderá monitorar todas as ações executadas pelo usuário conectado recentemente. Se o usuário conectado recentemente for um administrador, as informações divulgadas poderão ser usadas para tentar comprometer o sistema afetado.
...
A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira pela qual os processos dos usuários são encerrados no logout.
...
| **Implantação**                       |                                                                                                                                                                       |  
| Instalar sem intervenção do usuário   | Windows2000-KB978037-x86-enu /quiet                                                                                                                                   |  
| Instalar sem reinicializar            | Windows2000-KB978037-x86-enu /norestart                                                                                                                               |  
| Arquivo de log de atualização         | KB978037.log                                                                                                                                                          |  
...
| **Informações sobre remoção**         | Use a ferramenta **Adicionar ou Remover Programas** no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB978037$\\Spuninst |  
| **Informações sobre o arquivo**       | Consulte o [Artigo 978037 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/978037)                                                            |  
| **Verificação da Chave do Registro**  | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB978037\\Filelist                                                                             |
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB978037$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/978037">Artigo 978037 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Matthew ‘j00ru' Jurczyk e Gynvael Coldwind, da [Hispasec](http://www.hispasec.com/), por relatarem a vulnerabilidade de elevação de privilégio local de CSRSS (CVE-2010-0023)
...
-   V1.2 (9 de junho de 2010): Um link para o Artigo 978037 (em inglês) da Microsoft Knowledge Base foi adicionado à seção Problemas conhecidos, na Sinopse.
