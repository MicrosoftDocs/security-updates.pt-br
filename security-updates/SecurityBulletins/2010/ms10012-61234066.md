...
ms:assetid: 'ms10-012'
ms:contentKeyID: 61234066
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-012(v=Security.10)'
---
...
Vulnerabilidades no servidor SMB podem permitir a execução remota de código (971468)
------------------------------------------------------------------------------------
...
Esta atualização de segurança elimina várias vulnerabilidades relatadas em particular no Microsoft Windows. A mais severa das vulnerabilidades pode permitir a execução remota de código se um invasor criar um pacote SMB especialmente desenvolvido e o enviar a um sistema afetado. As práticas recomendadas para firewall e as configurações de firewall padrão podem ajudar a proteger as redes contra ataques com origem externa ao perímetro da empresa que tentem explorar estas vulnerabilidades.

Esta atualização de segurança foi classificada como Importante para todas as versões com suporte do Microsoft Windows. Para obter mais informação, consulte a subseção **Software afetado e não afetado** nesta seção.

A atualização de segurança elimina estas vulnerabilidades por corrigir a maneira como o SMB valida solicitações SMB. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.

**Recomendação.**  A maioria dos clientes tem o recurso de atualizações automáticas habilitado e não precisará tomar nenhuma providência porque esta atualização de segurança será baixada e instalada automaticamente. Os clientes que não têm o recurso de atualizações automáticas habilitado precisarão verificar as atualizações e instalar esta atualização manualmente. Para obter informações sobre opções de configuração específicas em atualizações automáticas, consulte o [Artigo 294871 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/294871).

Para instalações feitas por administradores ou empresas, ou por usuários finais que desejam instalar esta atualização de segurança manualmente, a Microsoft recomenda que os clientes apliquem a atualização assim que possível usando software de gerenciamento de atualização ou verificando se há atualizações usando o serviço [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747).
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=267ce982-54a0-418f-ad52-e4963610f714)                                                                                        | Execução Remota de Código  | Importante                      | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=8f7adee3-e68e-41b3-b835-d84691774f31)                                                                        | Execução Remota de Código  | Importante                      | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=91ee57f2-81e5-49bd-bdfc-d3e385efc8a5)                                                                           | Execução Remota de Código  | Importante                      | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3d18cbc4-ac48-458c-8aa3-90708fd854ff)                                                                                           | Execução Remota de Código  | Importante                      | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Microsoft Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7d63c95e-311a-446f-8852-dffd217a89f6)                                                                     | Execução Remota de Código  | Importante                      | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ee7f8cc4-f7fd-4dc7-808c-436204ee80cb)                                                                | Execução Remota de Código  | Importante                      | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Vista, Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=16494dac-553a-4de9-b751-0d6b51cb43f0)                                                   | Execução Remota de Código  | Importante                      | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cec582b3-e37f-448e-a5c3-6abdcee9e57c)               | Execução Remota de Código  | Importante                      | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=597b2310-2cd8-4d0f-8248-781eb8b7450a)\*                 | Execução Remota de Código  | Importante                      | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=67119fb6-e517-46f4-ab0b-2351cdc3d670)\*       | Execução Remota de Código  | Importante                      | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f90fc0c8-babe-4224-be07-614ea7ddf102) | Execução Remota de Código  | Importante                      | [MS09-001](http://technet.microsoft.com/security/bulletin/ms09-001) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=122fc003-0651-4ad2-a5c8-a21536defad8)                                                                                           | Execução Remota de Código  | Importante                      | Nenhuma                                                             |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=3e096468-db6c-45c6-bee5-eaeaa63500b5)                                                                                      | Execução Remota de Código  | Importante                      | Nenhuma                                                             |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=dc757b6d-f0f8-4e71-ab6f-1417233eedf9)\*                                                                       | Execução Remota de Código  | Importante                      | Nenhuma                                                             |
| [Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=d5b0b1eb-24f3-47ec-aba1-c1b95400189e)                                                                     | Execução Remota de Código  | Importante                      | Nenhuma                                                             |
...
**Esta atualização de segurança está relacionada ao boletim MS10-006, lançado no dia 9 de fevereiro de 2010?**  
Não. O Boletim de Segurança da Microsoft [MS10-006](http://technet.microsoft.com/security/bulletin/ms10-006), "Vulnerabilidades no cliente SMB podem permitir a execução remota de código", aborda diferentes componentes SMB. Esta atualização de segurança pode ser aplicada independentemente de qualquer outra atualização.

**Se tiver instalado a atualização MS10-006, ainda precisarei instalar esta atualização? **
Sim. Esta atualização de boletim de segurança elimina vulnerabilidades em componentes do Servidor SMB do Windows, enquanto o [MS10-006](http://technet.microsoft.com/security/bulletin/ms10-006) elimina vulnerabilidades em componentes do Cliente SMB do Windows.
...
<th style="border:1px solid black;" >Vulnerabilidade de estouro de nome de caminho SMB - CVE-2010-0020</th>
<th style="border:1px solid black;" >Vulnerabilidade de corrupção de memória SMB - CVE-2010-0021</th>
<th style="border:1px solid black;" >Vulnerabilidade de ponteiro nulo do SMB - CVE-2010-0022</th>
<th style="border:1px solid black;" >Vulnerabilidade de falta de entropia de autenticação NTLM SMB - CVE-2010-0231</th>
...
Vulnerabilidade de estouro de nome de caminho SMB - CVE-2010-0020  
-----------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o software do protocolo SMB (Server Message Block) da Microsoft manipula pacotes SMB especialmente criados. Um invasor pode explorar a vulnerabilidade enviando uma mensagem de rede especialmente criada a um sistema que esteja executando o serviço Servidor como um usuário autenticado. Ainda que um invasor que explore com êxito essa vulnerabilidade possa assumir o controle total do sistema afetado, é mais provável que as tentativas de explorar essa vulnerabilidade resultem em uma condição de negação de serviço.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0020](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0020).
  
#### Fatores atenuantes da Vulnerabilidade de estouro de nome de caminho SMB - CVE-2010-0020
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   No Windows Vista e Windows 7, se o perfil de rede estiver definido como "Público", o sistema não será afetado por esta vulnerabilidade, visto que, por padrão, pacotes de rede de entrada não solicitados são bloqueados.  
...
#### Soluções alternativas para a Vulnerabilidade de estouro de nome de caminho SMB - CVE-2010-0020
...
#### Perguntas frequentes sobre a Vulnerabilidade de estouro de nome de caminho SMB - CVE-2010-0020
...
A vulnerabilidade é causada pela validação incorreta dos campos em uma solicitação SMB malformada pela implementação do protocolo SMB da Microsoft.
...
Todos os sistemas com o serviço de servidor SMB são afetados por esta vulnerabilidade. Os controladores de domínio correm mais risco de exploração desta vulnerabilidade, visto que, por padrão, esses sistemas têm compartilhamentos de rede abertos a todos os usuários do domínio.
  
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade, corrigindo a maneira como o SMB valida campos em uma solicitação SMB malformada.
...
Vulnerabilidade de corrupção de memória SMB - CVE-2010-0021  
-----------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de negação de serviço na maneira como o software de protocolo SMB (Server Message Block) da Microsoft manipula pacotes SMB especialmente criados. Uma tentativa de explorar a vulnerabilidade não requereria autenticação, permitindo a um invasor explorar a vulnerabilidade enviando uma mensagem de rede especialmente criada a um computador executando o serviço Servidor.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0021](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0021).
  
#### Fatores atenuantes da Vulnerabilidade de corrupção de memória SMB - CVE-2010-0021
...
#### Soluções alternativas para a Vulnerabilidade de corrupção de memória SMB - CVE-2010-0021
...
#### Perguntas frequentes sobre a Vulnerabilidade de corrupção de memória SMB - CVE-2010-0021
...
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada pela manipulação incorreta, pelo software de protocolo SMB (Server Message Block) da Microsoft, de uma condição de corrida que pode ocorrer ao analisar pacotes SMB durante a fase de negociação. Esta vulnerabilidade afeta o SMB versão 1 e o SMB versão 2.
...
**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**    
Todos os sistemas com serviço de servidor SMB são afetados por essa vulnerabilidade. Os controladores de domínio correm mais risco de exploração desta vulnerabilidade, visto que, por padrão, esses sistemas têm compartilhamentos de rede abertos a todos os usuários do domínio.
  
**O que a atualização faz?**    
A atualização de segurança elimina a vulnerabilidade corrigindo a maneira como o SMB analisa pacotes SMB especialmente criados.
...
Vulnerabilidade de ponteiro nulo do SMB - CVE-2010-0022  
-------------------------------------------------------
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0022](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0022).
  
#### Fatores atenuantes da Vulnerabilidade de ponteiro nulo do SMB - CVE-2010-0022
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   No Windows Vista e Windows 7, se o perfil de rede estiver definido como "Público", o sistema não será afetado por esta vulnerabilidade, visto que, por padrão, pacotes de rede de entrada não solicitados são bloqueados.  
-   Essa vulnerabilidade não permite que o invasor execute códigos ou aumente seus direitos de usuário, mas pode fazer o sistema afetado parar de responder até ser reiniciado manualmente.  
-   As práticas recomendadas para firewall e as configurações de firewall padrão podem ajudar a proteger as redes contra ataques com origem externa ao perímetro da empresa. Essas práticas também recomendam que os sistemas conectados à Internet tenham um número mínimo de portas expostas. Nesse caso, as portas SMB devem ser impedidas de acessar a Internet.
  
#### Soluções alternativas para a Vulnerabilidade de ponteiro nulo do SMB - CVE-2010-0022
...
#### Perguntas frequentes sobre a Vulnerabilidade de ponteiro nulo do SMB - CVE-2010-0022
  
**Qual é o escopo da vulnerabilidade?**    
Essa é uma vulnerabilidade de negação de serviço (site em inglês). O invasor que explorar essa vulnerabilidade poderá fazer o sistema afetado parar de responder e exigir que o sistema seja reiniciado manualmente. Observe que a vulnerabilidade de negação de serviço não permite que o invasor execute códigos nem eleve seus direitos de usuário, mas pode fazer o sistema afetado parar de aceitar solicitações.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada pela verificação incorreta dos campos de compartilhamento e nome do servidor pelo software do protocolo SMB da Microsoft em pacotes SMB especialmente criados.
...
**O que a atualização faz?**    
A atualização de segurança elimina a vulnerabilidade validando corretamente os campos dentro dos pacotes SMB.
...
Vulnerabilidade de falta de entropia de autenticação NTLM SMB - CVE-2010-0231  
-----------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade não autenticada de elevação de privilégio na maneira como o software de protocolo SMB (Server Message Block) da Microsoft manipula tentativas de autenticação. Uma tentativa de explorar a vulnerabilidade não requer autenticação, o que permite a um invasor explorar a vulnerabilidade enviando grandes quantidades de solicitações de autenticação para o servidor SMB. O invasor que explorar com êxito essa vulnerabilidade poderá acessar o serviço SMB no usuário de destino com as credenciais de um usuário autorizado.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0231](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0231).
  
#### Fatores atenuantes da Vulnerabilidade de falta de entropia de autenticação NTLM SMB - CVE-2010-0231
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   As práticas recomendadas para firewall e as configurações de firewall padrão podem ajudar a proteger as redes contra ataques com origem externa ao perímetro da empresa. Essas práticas também recomendam que os sistemas conectados à Internet tenham um número mínimo de portas expostas. Nesse caso, as portas SMB devem ser impedidas de acessar a Internet.
  
#### Soluções alternativas para a Vulnerabilidade de falta de entropia de autenticação NTLM SMB - CVE-2010-0231
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade de falta de entropia de autenticação NTLM SMB - CVE-2010-0231
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. Um invasor que explorar com êxito essa vulnerabilidade poderá ser autenticado com êxito em um sistema de destino sem a necessidade de credenciais de autenticação corretas. O invasor poderá então carregar e baixar arquivos acessar recursos de rede SMB disponíveis a esse usuário.
  
**O que provoca a vulnerabilidade?**    
Esta vulnerabilidade é causada por uma falta de entropia criptográfica quando o servidor SMB gera desafios e os apresenta a um cliente que se conecta. Isto pode fazer com que um invasor tente continuamente se autenticar no servidor SMB e, subsequentemente, fazer com que esse servidor gere valores duplicados.
  
**O que é o protocolo SMB (Server Message Block) da Microsoft?**    
O protocolo SMB (Server Message Block) da Microsoft é um protocolo de compartilhamento de arquivos de rede da Microsoft usado no Microsoft Windows. Para obter mais informações sobre o SMB, consulte [Visão geral do Protocolo SMB e Protocolo CIFS da Microsoft](http://msdn.microsoft.com/en-us/library/aa365233(vs.85).aspx).
  
**Para que um invasor pode usar a vulnerabilidade?**    
Um invasor que explorar com êxito essa vulnerabilidade poderá carregar e baixar arquivos e acessar recursos de rede SMB disponíveis ao usuário cuja conta o invasor consegue acessar.
  
**De que forma o invasor pode explorar a vulnerabilidade?**    
Um invasor pode tentar explorar a vulnerabilidade tentando continuamente se autenticar em um servidor e reutilizando as informações dessas conexões fracassadas para falsificar um token de autenticação válido.
  
**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**    
Todos os sistemas com o serviço de servidor SMB são afetados por esta vulnerabilidade. Os controladores de domínio correm mais risco de exploração desta vulnerabilidade, visto que, por padrão, esses sistemas têm compartilhamentos de rede abertos a todos os usuários do domínio.
  
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade assegurando que o servidor SMB use um fornecedor criptográfico com garantias suficientes de entropia.
...
| **Implantação**                       |                                                                                                                                                                       |  
| Instalar sem intervenção do usuário   | Windows2000-KB971468-x86-enu /quiet                                                                                                                                   |  
| Instalar sem reinicializar            | Windows2000-KB971468-x86-enu /norestart                                                                                                                               |  
| Arquivo de log de atualização         | KB971468.log                                                                                                                                                          |  
...
| **Informações sobre remoção**         | Use a ferramenta **Adicionar ou Remover Programas** no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB971468$\\Spuninst |  
| **Informações sobre o arquivo**       | Consulte o [Artigo 971468 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/971468)                                                            |  
| **Verificação da Chave do Registro**  | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB971468\\Filelist                                                                             |
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB971468$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/971468">Artigo 971468 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Joshua Morin, da [Codenomicon](http://www.codenomicon.com/), por relatar a Vulnerabilidade de estouro de nome de caminho SMB (CVE-2010-0020)  
-   Vulnerabilidade de corrupção de memória SMB, da [BSI](http://www.bsi.bund.de/), por relatar a Vulnerabilidade de corrupção de memória SMB (CVE-2010-0021)  
-   Hernan Ochoa (Consultor/Pesquisador independente de segurança de informação) por relatar a Vulnerabilidade de falta de entropia de autenticação NTLM SMB (CVE-2010-0231)
...
-   V1.1 (10 de fevereiro de 2010): Foram corrigidas as **Perguntas frequentes para a Vulnerabilidade de ponteiro nulo do SMB - CVE-2010-0022** para indicar que a vulnerabilidade foi divulgada com responsabilidade. Foram alteradas as entradas na tabela do **Systems Management Server** para o SMS 2003 com ITMU para Windows 7 e Windows Server 2008 R2. Foi corrigida a chave de Registro de verificação para todas as edições baseadas em x64 com suporte do Windows XP. Elas são alterações para fins informativos apenas. Não houve nenhuma alteração à lógica de detecção ou aos arquivos da atualização de segurança.
