...
ms:assetid: 'ms10-025'
ms:contentKeyID: 61234153
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-025(v=Security.10)'
---

Microsoft Security Bulletin MS10-025 - Crítica
==============================================

Vulnerabilidade no Microsoft Windows Media Services pode permitir a execução remota de código (980858)
------------------------------------------------------------------------------------------------------

Publicado: terça-feira, 13 de abril de 2010 | Atualizado: terça-feira, 27 de abril de 2010
...
Esta atualização de segurança é classificada como Crítica para todas as edições com suporte do Microsoft Windows 2000 Server com o Windows Media Services. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança foi relançada em 27 de abril de 2010. A atualização de segurança relançada elimina a vulnerabilidade modificando a maneira como o Windows Media Unicast Service (nsum.exe) manipula pacotes de rede de informações de transporte. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica, localizada na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Microsoft Windows 2000 Server Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=73b3d681-26bb-49c1-849e-1f72484cb978) | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
...
**Por que este boletim foi revisado em 27 de abril de 2010?**  
A Microsoft revisou este boletim para oferecer a atualização de segurança relançada para o Windows Media Services sendo executado no Microsoft Windows 2000 Server Service Pack 4. A atualização de segurança original não protegia os sistemas da vulnerabilidade descrita neste boletim. A Microsoft recomenda que os clientes executando o software afetado apliquem imediatamente a atualização de segurança relançada.

**Preciso remover a atualização de segurança original antes de instalar a atualização de segurança relançada?**  
Não, você não precisa remover a atualização de segurança original antes de instalar a atualização de segurança relançada.

**Por que este boletim foi revisado em 21 de abril de 2010?**  
A Microsoft revisou este boletim para anunciar que a atualização de segurança original para o Microsoft Windows 2000 Server (KB980858) não está mais disponível devido a problemas de qualidade. A atualização de segurança original não protegeu os sistemas da vulnerabilidade descrita neste boletim. A Microsoft recomenda que os clientes apliquem uma das soluções alternativas descritas neste boletim para ajudar a atenuar o impacto nos sistemas afetados até que uma atualização de segurança revisada seja disponibilizada.
...
**Meu sistema não executa o Windows Media Services. Esta atualização será oferecida a mim?**  
Não, os sistemas Microsoft Windows 2000 Server que não executam o Windows Media Services opcional não receberão a oferta desta atualização de segurança. Se o Windows Media Services estiver sendo executado, a atualização de segurança será oferecida.
...
<th style="border:1px solid black;" >Vulnerabilidade de saturação do buffer baseada em pilha do Media Services - CVE-2010-0478</th>
...
Vulnerabilidade de saturação do buffer baseada em pilha do Media Services - CVE-2010-0478  
-----------------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código no Microsoft Windows 2000 Server Service Pack 4 executando o componente opcional Windows Media Services devido à maneira como o Windows Media Unicast Service manipula pacotes de informações de transporte especialmente criados. No Microsoft Windows 2000 Server Service Pack 4, o Windows Media Services é um componente opcional e não é instalado por padrão. Somente sistemas Microsoft Windows 2000 que tenham habilitado o Windows Media Services são afetados por esta vulnerabilidade.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-0478](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0478).
  
#### Fatores atenuantes da vulnerabilidade de saturação do buffer baseada em pilha do Media Services - CVE-2010-0478
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Edições com suporte do Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2 não são afetadas pela vulnerabilidade descrita neste boletim.  
-   Por padrão, o Windows Media Services não é habilitado no Microsoft Windows 2000 Server. Para o Microsoft Windows 2000 Server estar vulnerável, o servidor teria que ser configurado como um servidor de mídia de fluxo adicionando o componente Windows Media Services ao Assistente de Componentes do Windows.
  
#### Soluções alternativas para a vulnerabilidade de saturação do buffer baseada em pilha do Media Services - CVE-2010-0478
  
A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:
  
-   **Interrompa e desabilite o Windows Media Unicast Service**
  
    Como um Administrador, desative o Windows Media Unicast Service usando o seguinte comando no prompt de comando:  
    `sc stop nsunicast & sc config nsunicast start= disabled`
  
    **Impacto da solução alternativa.** As conexões ao servidor de mídia de fluxo através do Windows Media Unicast Service não serão permitidas.
  
    **Como desfazer a solução alternativa.**
  
    Como um Administrador, ative o Windows Media Unicast Service usando o seguinte comando no prompt de comando:  
    `sc config nsunicast start= auto & sc start nsunicast`
  
-   **Desinstale o componente Windows Media Services usando o Assistente de Componentes do Windows**
  
    1.  Faça logon no computador como um administrador ou um membro do grupo Administradores.  
    2.  Clique em **Iniciar**, aponte para **Configurações** e clique em **Painel de Controle**.  
    3.  No Painel de Controle, clique duas vezes em **Adicionar ou Remover Programas**.  
    4.  Clique em **Adicionar/Remover Componentes do Windows**. O Assistente de Componentes do Windows é iniciado e a tela Componentes do Windows é exibida.  
    5.  Desmarque a caixa de seleção **Windows Media Services**. Clique em **Avançar** e siga as instruções do Assistente de Componentes do Windows.
  
    **Impacto da solução alternativa. **O servidor não será mais configurado como um servidor de mídia de fluxo usando o Windows Media Services.
  
    **Como desfazer a solução alternativa. **Instale o Windows Media Services através do Assistente Componentes do Windows.
  
#### Perguntas frequentes sobre a vulnerabilidade de saturação do buffer baseada em pilha do Media Services - CVE-2010-0478
...
Esta vulnerabilidade é causada quando o Windows Media Services que está sendo executado no Microsoft Windows 2000 Server Service Pack 4 manipula pacotes de rede de informações de transporte.
  
**O que é o Windows Media Services?**    
O Microsoft Windows Media Services é uma plataforma de nível industrial para a transmissão ao vivo ou sob demanda de conteúdo de áudio e vídeo na Internet ou em uma intranet. Use o Windows Media Services para configurar e gerenciar um ou mais servidores do Windows Media que fornecem seu conteúdo a clientes.
...
-   Computadores executando o Windows Media Services que executam proxy, cache ou redistribuição de seu conteúdo.  
-   Aplicativos personalizados que foram desenvolvidos usando o Kit de Desenvolvedores de Software (SDK) do Windows Media.
  
**Quais componentes do Windows Media Services são vulneráveis?**    
O código vulnerável existe no Windows Media Unicast Service (nsum.exe).
  
**O que é o Windows Media Unicast Service?**    
O Windows Media Unicast Service é parte do Windows Media Services, uma família de serviços que permite aos fornecedores de conteúdo digital enviar mídia de fluxo a clientes. Há quatro serviços na família:
  
-   O Windows Media Unicast Service, que possibilita que mídia de fluxo seja enviada a um usuário final específico.  
-   O Windows Media Station Service, que possibilita que um único fluxo de mídia seja enviado a múltiplos usuários finais de uma só vez.  
-   O Windows Media Program Service, que controla quantas vezes um grupo de fluxos é reproduzido.  
-   O Windows Media Monitor Service, que possibilita que o fornecedor de conteúdo digital controle usuários finais conectados a pontos de publicação.
  
Somente o Windows Media Unicast Service é afetado por esta vulnerabilidade. A vulnerabilidade não pode ser usada contra os outros três serviços.
...
Para explorar esta vulnerabilidade, o invasor pode enviar um pacote de informações de transporte especialmente criado para um computador executando o Windows Media Services no Microsoft Windows 2000 Server Service Pack 4. Melhores práticas e configurações padrão de firewall podem ajudar a proteger redes contra ataques que se originam fora do perímetro da empresa. Essas práticas também recomendam que os sistemas conectados à Internet tenham um número mínimo de portas expostas.
  
No Microsoft Windows 2000 Server Service Pack 4, o Windows Media Services é um componente opcional e não é instalado por padrão.
  
**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**    
Sistemas Microsoft Windows 2000 Server Service Pack 4 executando Windows Media Services são afetados por esta vulnerabilidade.
  
**O que a atualização faz?**    
Esta atualização elimina a vulnerabilidade modificando a maneira como o Windows Media Unicast Service manipula pacotes de rede de informações de transporte.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**    
Não. Embora o relatório inicial tenha sido fornecido por divulgação responsável, a vulnerabilidade mais tarde foi divulgada publicamente.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB980858$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/980858">Artigo 980858 da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave do Registro</strong></td>
<td style="border:1px solid black;">As três chaves a seguir são criadas:<br />
...
<br />
<strong>Observação</strong> As chaves do Registro são as mesmas criadas pela atualização de segurança original. Você poderá verificar os arquivos instalados pela atualização de segurança relançada da seguinte maneira:<br />
<br />
Versão de arquivo de <strong>nsum.exe</strong> = 4.1.0.3939</td>
</tr>
</tbody>
</table>
...
-   Fabien Perigaud, da [CERT-LEXSI](http://cert.lexsi.com/), por relatar a vulnerabilidade de saturação do buffer baseada em pilha do Media Services (CVE-2010-0478)

A Microsoft [agradece](http://go.microsoft.com/fwlink/?linkid=21127) às seguintes pessoas e empresas por trabalhar conosco e por fornecer detalhes de um problema de qualidade na atualização de segurança original:

-   Fabien Perigaud, da [CERT-LEXSI](http://cert.lexsi.com/)
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/)
-   [TELUS Security Labs](http://telussecuritylabs.com/) Vulnerability Research Team
...
-   V1.1 (14 de abril de 2010): Foi corrigida a necessidade de reinicialização do Microsoft Windows 2000 Server.
-   V2.0 (21 de abril de 2010): Boletim revisado para informar aos clientes que a atualização de segurança original não protegeu os sistemas da vulnerabilidade descrita neste boletim. A Microsoft recomenda que os clientes apliquem uma das soluções alternativas descritas neste boletim para ajudar a atenuar o impacto nos sistemas afetados até que uma atualização de segurança revisada seja disponibilizada.
-   V3.0 (27 de abril de 2010): Boletim revisado para oferecer a atualização de segurança relançada para o Windows Media Services sendo executado no Microsoft Windows 2000 Server Service Pack 4. A Microsoft recomenda que os clientes executando o software afetado apliquem imediatamente a atualização de segurança relançada.
