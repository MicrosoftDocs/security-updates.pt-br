...
ms:assetid: 'ms10-034'
ms:contentKeyID: 61234164
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-034(v=Security.10)'
---

Microsoft Security Bulletin MS10-034 - Crítica
==============================================

Atualização de segurança cumulativa de Kill Bits do ActiveX (980195)
--------------------------------------------------------------------
...
As vulnerabilidades poderão permitir a execução remota de código se um usuário exibir uma página da Web especialmente criada que instancie um controle ActiveX específico usando o Internet Explorer. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos. Esta atualização também inclui kill bits para quatro controles ActiveX de terceiros.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|-------------------------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=d3955983-0079-476e-a488-99713097259c)                                                                                        | Execução Remota de Código  | Crítica                             | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=8c3f2e81-c0ea-494a-a47c-4f8982effb49)                                                                        | Execução Remota de Código  | Crítica                             | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f3e462fb-df95-4b79-a8bc-5359c2967503)                                                                           | Execução Remota de Código  | Crítica                             | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3c0bd349-aa77-47de-ba1d-1fcc72dcad28)                                                                                           | Execução Remota de Código  | Moderada                            | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Microsoft Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4aa0ec4f-5502-4f2a-9732-975518c34444)                                                                     | Execução Remota de Código  | Moderada                            | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=55d9d7f0-f9d9-4833-b5cc-eb87a62da6a8)                                                                | Execução Remota de Código  | Moderada                            | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2ddaa4b3-1a98-4183-94af-ebdae4e7b76a)                                                                  | Execução Remota de Código  | Crítica                             | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ddf55e74-dbaa-45f7-ac5b-ae3da24e0e33)                                          | Execução Remota de Código  | Crítica                             | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a06b9f42-47ac-4ff2-ac32-e4958cdb611e)\*\*               | Execução Remota de Código  | Moderada                            | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6d0a3f7c-2617-4bc6-a4c7-cda26c6471e1)\*\*     | Execução Remota de Código  | Moderada                            | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=38347fa6-5946-4bb5-9fea-a5b2f4e7c1f2) | Execução Remota de Código  | Moderada                            | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=5bce87fe-dcbb-4638-b248-3f0755537b00)                                                                                           | Execução Remota de Código  | Crítica                             | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=ee68ecd0-5b8a-4c1e-bdee-bd8616558d43)                                                                                      | Execução Remota de Código  | Crítica                             | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=901f7c89-02af-4f87-8592-dad318997d77)\*\*                                                                     | Execução Remota de Código  | Moderada                            | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
| [Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=4958b221-2776-43d7-9e1c-1e1cb318a694)                                                                     | Execução Remota de Código  | Moderada                            | [MS10-008](http://technet.microsoft.com/security/bulletin/ms10-008) |
...
Esta atualização define os kill bits para o controle ActiveX Controles de exibição do Outlook previamente abordado no Boletim de Segurança da Microsoft [MS09-060](http://technet.microsoft.com/security/bulletin/ms09-060).

Para obter mais informações sobre esse controle ActiveX e como ele pode ser atualizado, examine o Boletim de Segurança da Microsoft, [Vulnerabilidades nos Controles ActiveX da Microsoft Active Template Library (ATL) para Microsoft Office podem permitir a execução remota de código (973965)](http://technet.microsoft.com/security/bulletin/ms09-060).
...
<th style="border:1px solid black;" >Vulnerabilidade de Ferramentas para Desenvolvedores do Microsoft Internet Explorer 8 - CVE-2010-0811</th>
...
-   Um site mal-intencionado não pode explorar esta vulnerabilidade em sistemas onde o Microsoft Data Analyzer já não esteja instalado. O Microsoft Data Analyser não é instalado nos sistemas Microsoft Office por padrão.
...
|----------------------------------------|-----------------|--------------------------------------------------------|  
| {14FD1463-1F3F-4357-9C03-2080B442F503} | max3activex.dll | Controle ActiveX do Office Excel para análise de dados |  
| {E9CB13DB-20AB-43C5-B283-977C58FB5754} | max3activex.dll | Controle ActiveX do Office Excel para análise de dados |
...
Vulnerabilidade de Ferramentas para Desenvolvedores do Microsoft Internet Explorer 8 - CVE-2010-0811  
----------------------------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código nas Ferramentas para Desenvolvedores do Microsoft Internet Explorer 8. Um invasor pode explorar a vulnerabilidade criando uma página da Web especialmente desenvolvida. Se um usuário exibir a página da Web, a vulnerabilidade poderá permitir a execução remota de código. O invasor que explorar com êxito a vulnerabilidade poderá obter os mesmos direitos que o usuário conectado.
...
#### Fatores atenuantes da vulnerabilidade de Ferramentas para Desenvolvedores do Microsoft Internet Explorer 8 - CVE-2010-0811
...
#### Soluções alternativas para a vulnerabilidade de Ferramentas para Desenvolvedores do Microsoft Internet Explorer 8 - CVE-2010-0811
...
-   **Impeça que objetos COM sejam executados no Internet Explorer**
    ...
    **Observação** Os Identificadores de classe e os arquivos correspondentes nos quais os objetos ActiveX estão contidos estão documentados em "O que a atualização faz?", na seção **Perguntas frequentes sobre a vulnerabilidade de Ferramentas para Desenvolvedores do Microsoft Internet Explorer 8 - CVE-2010-0811**. Substitua {XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX} abaixo pelos Identificadores de classe encontrados nessa seção.
...
#### Perguntas frequentes sobre a vulnerabilidade de Ferramentas para Desenvolvedores do Microsoft Internet Explorer 8 - CVE-2010-0811
...
**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**  
Esta vulnerabilidade no controle Ferramentas para Desenvolvedores do Microsoft Internet Explorer 8 requer que um usuário esteja conectado e visite um site para que qualquer ação mal-intencionada ocorra. Portanto, quaisquer sistemas em que o controle Ferramentas para Desenvolvedores do Microsoft Internet Explorer 8 esteja instalado e onde o Internet Explorer seja usado com frequência, como estações de trabalho ou servidores de terminal, correm mais riscos com essa vulnerabilidade.
...
| Identificador de classe                | Arquivo      | Descrição                                                         |  
|----------------------------------------|--------------|-------------------------------------------------------------------|  
| {8fe85d00-4647-40b9-87e4-5eb8a52f4759} | iedvtool.dll | Ferramentas para Desenvolvedores do Microsoft Internet Explorer 8 |
...
-   O [Danske Bank](http://www.danskebank.dk/) solicitou um kill bit para um controle ActiveX, Danske eSec. Se você tiver alguma pergunta ou dúvida sobre o controle ActiveX Danske eSec, entre em contato com o [Danske Bank](http://www.danskebank.dk/). O identificador de classe (CLSID) deste controle ActiveX é:  
    -   {F6A56D95-A3A3-11D2-AC26-400000058481}  
-   A [CA](http://www.ca.com/us/) lançou um comunicado de segurança a respeito de um comunicado para um controle ActiveX, PSFormX, no produto Pest Scan. Consulte o boletim de segurança da CA para obter mais informações. Este kill bit está sendo definido mediante solicitação do proprietário do controle ActiveX. O identificador de classe (CLSID) deste controle ActiveX é:  
    -   {56393399-041A-4650-94C7-13DFCB1F4665}  
-   A [Eastman Kodak Company](http://www.kodakgallery.com/) solicitou um kill bit para o controle ActiveX do "Ofoto Upload Manager / Kodak Gallery Easy Upload Manager ActiveX Control". A Eastman Kodak Gallery forneceu a seguinte página para oferecer uma variedade de opções de upload: <http://www.kodakgallery.com/gallery/photo-service/upload-photos.jsp>. O controle de substituição para o controle ao qual o kill bit está sendo configurado nesta atualização pode ser encontrado aqui: [http://classic.kodakgallery.com/UploadChoicesAll.jsp](http://classic.kodakgallery.com/uploadchoicesall.jsp). Se você tiver alguma pergunta ou dúvida sobre este kill bit, entre em contato com a Kodak Gallery em [http://www.kodakgallery.com/gallery/footerLinksContent.jsp?pageID=600002](http://www.kodakgallery.com/gallery/footerlinkscontent.jsp?pageid=600002). Os identificadores de classe (CLSID) deste controle ActiveX são:  
    -   {6f750200-1362-4815-a476-88533de61d0c}  
    -   {6f750201-1362-4815-a476-88533de61d0c}  
-   A [Avaya](http://www.avaya.com/) solicitou um kill bit para CallPilot Unified Messaging. Se você tiver alguma pergunta ou dúvida sobre o kill bit para CallPilot Unified Messaging, entre em contato com a Avaya Security em securityalerts@avaya.com. O identificador de classe (CLSID) deste controle ActiveX é:  
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4:<br />
Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB980195$\Spuninst</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB980195$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da Chave do Registro</strong></td>
<td style="border:1px solid black;">Para todas as edições de 32 bits com suporte do Windows XP:<br />
...
-   Chris Ries, dos serviços de computação da Carnegie Mellon University, por relatar a vulnerabilidade de Ferramentas para Desenvolvedores do Microsoft Internet Explorer 8 (CVE-2010-0811)
