...
ms:assetid: 'ms10-057'
ms:contentKeyID: 61234191
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-057(v=Security.10)'
---

Microsoft Security Bulletin MS10-057 - Importante
=================================================

Vulnerabilidade no Microsoft Office Excel pode permitir a execução remota de código (2269707)
---------------------------------------------------------------------------------------------
...
Esta atualização de segurança é atualizada como Importante para todas as edições com suporte do Microsoft Office Excel 2002, Microsoft Office Excel 2003, Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac e Open XML File Format Converter para Mac. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização elimina a vulnerabilidade alterando a maneira como o Microsoft Office Excel analisa arquivos do Excel especialmente criados. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.

**Recomendação.** A Microsoft recomenda que os clientes instalem a atualização o mais rápido possível.

**Problemas conhecidos.** O [Artigo 2269707 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2269707) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
Um programa autônomo do Office é afetado com a mesma classificação de gravidade que o componente correspondente em um Office Suite. Por exemplo, uma instalação autônoma do Microsoft Office Excel é afetada com a mesma classificação de gravidade que uma instalação do Microsoft Office Excel que tenha sido fornecida com um Office Suite.
...
<th style="border:1px solid black;" >
Vulnerabilidade de corrupção de memória do Excel - CVE-2010-2562
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-2562](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2562).

#### Fatores atenuantes da vulnerabilidade de corrupção de memória do Excel - CVE-2010-2562
...
#### Soluções alternativas para a vulnerabilidade de corrupção de memória do Excel - CVE-2010-2562
...
-   **Não abra arquivos do Microsoft Office recebidos de fontes não confiáveis ou recebidos inesperadamente de fontes confiáveis**
...
#### Perguntas frequentes sobre a vulnerabilidade de corrupção de memória do Excel - CVE-2010-2562
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2264397">Artigo 2264397 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2264403">Artigo 2264403 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
-   Damián Frizza, da [Core Security Technologies](http://www.coresecurity.com/), por relatar a vulnerabilidade de corrupção de memória do Excel (CVE-2010-2562)
...
-   V1.1 (11 de agosto de 2010): Um link para o Artigo 2269707 (em inglês) da Microsoft Knowledge Base foi adicionado à seção Problemas conhecidos, na Sinopse.
