...
ms:assetid: 'ms10-066'
ms:contentKeyID: 61234202
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-066(v=Security.10)'
---

Microsoft Security Bulletin MS10-066 - Importante
=================================================

Vulnerabilidade na chamada de procedimento remoto pode permitir a execução remota de código (982802)
----------------------------------------------------------------------------------------------------
...
A atualização de segurança elimina a vulnerabilidade corrigindo a maneira como o cliente de RPC aloca a memória antes de carregar as respostas RPC transmitidas por um servidor remoto. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=1f04f151-330a-4b6c-826e-76def35daa73) | Execução Remota de Código  | Importante                      | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
...
<th style="border:1px solid black;" >Vulnerabilidade de corrupção de memória de RPC - CVE-2010-2567</th>
...
Vulnerabilidade de corrupção de memória de RPC - CVE-2010-2567  
--------------------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código não autenticada na maneira como a implementação do cliente RPC (chamada de procedimento remoto) aloca memória ao analisar respostas RPC especialmente criadas. Uma tentativa de explorar a vulnerabilidade não requer autenticação, o que permite a um invasor explorar a vulnerabilidade enviando uma resposta RPC especialmente criada a uma solicitação RPC iniciada pelo cliente. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-2567](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2567).
  
#### Fatores atenuantes da vulnerabilidade de corrupção de memória de RPC - CVE-2010-2567
...
-   O invasor deve convencer o usuário a iniciar uma conexão de RPC a um servidor mal-intencionado sob o controle do invasor. O invasor não pode explorar remotamente esta vulnerabilidade sem a interação do usuário.  
-   O invasor que explorar com êxito a vulnerabilidade poderá obter os mesmos direitos que o usuário local. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
#### Soluções alternativas para a vulnerabilidade de corrupção de memória de RPC - CVE-2010-2567
...
-   **Bloquear portas associadas ao RPC no firewall**
    ...
    Essas portas são usadas para iniciar uma conexão com RPC. O bloqueio dessas portas no firewall ajudará a proteger os sistemas atrás do firewall contra as tentativas de exploração dessa vulnerabilidade. Certifique-se também de bloquear qualquer outra porta RPC especificamente configurada no sistema remoto. A Microsoft recomenda o bloqueio de todas as comunicações de entrada não solicitadas da Internet para ajudar a evitar os ataques que podem usar outras portas. Para obter mais informações sobre portas, consulte o artigo da TechNet, [Atribuições de portas TCP e UDP](http://go.microsoft.com/fwlink/?linkid=21312).
...
#### Perguntas frequentes sobre a vulnerabilidade de corrupção de memória de RPC - CVE-2010-2567
...
A vulnerabilidade é causada quando a implementação de cliente RPC (Chamada de procedimento remoto) da Microsoft aloca incorretamente memória ao analisar as respostas RPC especialmente criadas.
  
**O que é o RPC (Chamada de procedimento remoto)?**  
A RPC da Microsoft é um padrão de programação de rede originalmente desenvolvido no início dos anos 80. Um recurso RPC é um recurso que permite que um programador crie um aplicativo, composto por qualquer número de procedimentos, alguns que são executados localmente e outros que são executados nos computadores remotos por meio de uma rede.
  
**Para que um invasor pode usar a vulnerabilidade?**    
O invasor que explorar com êxito a vulnerabilidade poderá executar código no contexto de segurança do aplicativo cliente de RPC. Se o aplicativo cliente de RPC for executado em LocalSystem ou em uma conta com privilégios administrativos, o invasor poderá assumir o controle total de um sistema afetado.
  
**De que forma o invasor pode explorar a vulnerabilidade?**    
O invasor pode hospedar um servidor RPC especialmente criado projetado para explorar esta vulnerabilidade e, então, convencer um usuário a iniciar uma chamada RPC com ele. Além disso, um invasor na rede local pode executar um ataque com intervenção humana para responder a uma chamada RPC legítima com uma resposta RPC malformada.
  
**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**    
Todos os sistemas que executam as edições com suporte do Windows XP e Windows Server 2003 correm risco.
  
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade corrigindo a maneira como o cliente de RPC aloca a memória antes de carregar as respostas RPC transmitidas por um servidor remoto.
...
Para Windows XP Service Pack 3:WindowsXP-KB982802-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><br />
Para Windows XP Service Pack 3:WindowsXP-KB982802-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB982802$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/982802">Artigo 982802 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Yamata Li, da [Palo Alto Networks](http://www.paloaltonetworks.com/), por relatar a vulnerabilidade de corrupção de memória de RPC (CVE-2010-2567)
