...
ms:assetid: 'ms10-067'
ms:contentKeyID: 61234203
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-067(v=Security.10)'
---
...
Vulnerabilidade nos conversores de texto do WordPad pode permitir a execução remota de código (2259922)
-------------------------------------------------------------------------------------------------------
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=fc4369ec-864a-42ae-a850-b006872241fe)                                     | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7567986a-261d-4def-9fa5-c667994c7844)            | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3290e7ee-1e4a-464c-abfd-17fc4108601e)                            | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b21570cc-4f90-4ed8-b901-a34584d44a63)                | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=c9c4427d-54c8-4f3c-9a94-818196cd5180) | Execução Remota de Código  | Importante                      | Nenhuma                                    |
...
<th style="border:1px solid black;" >Vulnerabilidade de corrupção de memória do conversor de texto do WordPad Word 97 - CVE-2010-2563</th>
...
Vulnerabilidade de corrupção de memória do conversor de texto do WordPad Word 97 - CVE-2010-2563  
------------------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft WordPad processa memória ao analisar um documento especialmente criado do Word 97. A vulnerabilidade poderá permitir a execução remota de código se um usuário abrir um arquivo do Word especialmente criado que inclua uma estrutura malformada.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-2563](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2563).
  
#### Fatores atenuantes da vulnerabilidade de corrupção de memória do conversor de texto do WordPad Word 97 - CVE-2010-2563
...
#### Soluções alternativas para a vulnerabilidade de corrupção de memória do conversor de texto do WordPad Word 97 - CVE-2010-2563
...
-   Desabilite o conversor de texto do WordPad Word 97, restringindo o acesso ao arquivo do conversor.
    ...
    **Observação** Dependendo da versão do seu sistema operacional e do histórico de service packs e de atualizações do sistema operacional, alguns arquivos mencionados a seguir podem não existir; isso é esperado.
...
#### Perguntas frequentes sobre a vulnerabilidade de corrupção de memória do conversor de texto do WordPad Word 97 - CVE-2010-2563
...
A vulnerabilidade é causada quando o conversor de texto do WordPad analisa incorretamente campos específicos em um documento do Word 97.
...
Para Windows XP Service Pack 3:WindowsXP-KB2259922-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><br />
Para Windows XP Service Pack 3:WindowsXP-KB2259922-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2259922$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2259922">Artigo 2259922 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   S0lute, da [iDefense Labs](http://labs.idefense.com/), por relatar a vulnerabilidade de corrupção de memória do conversor de texto do WordPad Word 97 (CVE-2010-2563)
