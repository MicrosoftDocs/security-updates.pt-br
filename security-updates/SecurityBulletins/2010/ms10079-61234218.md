...
ms:assetid: 'ms10-079'
ms:contentKeyID: 61234218
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-079(v=Security.10)'
---

Microsoft Security Bulletin MS10-079 - Importante
=================================================

Vulnerabilidades no Microsoft Word podem permitir a execução remota de código (2293194)
---------------------------------------------------------------------------------------

Publicado: terça-feira, 12 de outubro de 2010 | Atualizado: quarta-feira, 3 de novembro de 2010
...
Esta atualização de segurança elimina 11 vulnerabilidades relatadas em particular no Microsoft Office. As vulnerabilidades podem permitir a execução remota de código se o usuário abrir um arquivo do Word especialmente criado. O invasor que explorar com êxito qualquer uma destas vulnerabilidades poderá obter os mesmos direitos que o usuário local. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Esta atualização de segurança foi classificada como Importante para todas as edições com suporte do Microsoft Word 2002, Microsoft Word 2003, Microsoft Word 2007, Microsoft Word 2010, Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac e Open XML File Format Converter para Mac e todas as versões com suporte do Microsoft Office Word Viewer e do Pacote de Compatibilidade do Microsoft Office. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização elimina as vulnerabilidades modificando a maneira como o Microsoft Office Word analisa arquivos do Word especialmente criados. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.

**Recomendação.** A Microsoft recomenda que os clientes instalem a atualização o mais rápido possível.

**Problemas conhecidos.** O [Artigo 2293194 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2293194) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas. Quando problemas atualmente conhecidos e soluções recomendadas pertencem somente a lançamentos específicos deste software, este artigo fornece links para outros artigos.
...
Microsoft Office e outros softwares de produtividade
</th>
<th style="border:1px solid black;" >
Componente
</th>
...
<td style="border:1px solid black;">
[MS10-056](http://technet.microsoft.com/pt-br/security/bulletin/ms10-056)
</td>
</tr>
...
<sup>[1]</sup>Para o Microsoft Word 2007 Service Pack 2, além do pacote de atualização de segurança KB2344993, os clientes também precisam instalar a atualização de segurança para o Pacote de compatibilidade do Microsoft Office para formatos de arquivos do Word, Excel e PowerPoint 2007 Service Pack 2 (KB2345043) para se protegerem das vulnerabilidades descritas neste boletim.
  
<sup>[2]</sup>Para Microsoft Office Web Apps, os clientes precisam instalar tanto a atualização de segurança KB2346411 quanto a KB2345015 para ficarem protegidos contra as vulnerabilidades descritas neste boletim.
...
**O boletim MS10-072 também descreve vulnerabilidades no Microsoft Office Web Apps. Como o MS10-072 está relacionado a este boletim (MS10-079)?**    
O pacote de atualização de segurança neste boletim, MS10-079, para Microsoft Office Web Apps (KB2346411) também aborda as vulnerabilidades descritas no MS10-072. Os usuários com o Microsoft Office Web Apps instalado precisarão instalar o pacote de atualização de segurança KB2346411 apenas uma vez.
  
**O boletim MS10-080 também descreve vulnerabilidades no Microsoft Office 2004 para Mac, no Microsoft Office 2008 para Mac e no Open XML File Format Converter para Mac. Como o MS10-080 está relacionado a este boletim (MS10-079)?**    
Os pacotes de atualização de segurança neste boletim, MS10-079, para Microsoft Office 2004 para Mac (KB2422343), Microsoft Office 2008 para Mac (KB2422352) e Open XML File Format Converter para Mac (KB2422398) também abordam as vulnerabilidades descritas no boletim MS10-080. Os usuários com Microsoft Office 2004 para Mac, Microsoft Office 2008 para Mac ou Open XML File Format Converter para Mac instalado precisarão instalar estes pacotes de atualização de segurança somente uma vez.
...
**O que é o Microsoft Word Web App?**    
O Microsoft Word Web App é parte do Microsoft Office Web Apps, disponível em organizações que tiverem configurado o Office Web Apps no Microsoft SharePoint Server 2010. O Word Web App estende sua experiência do Microsoft Word para o navegador da Web, onde você pode trabalhar com documentos diretamente no site onde o documento está armazenado. Para obter mais informações sobre o Word Web App, consulte [Introdução ao Word Web App](http://office.microsoft.com/en-us/web-apps-help/introduction-to-word-web-app-ha010378341.aspx).
...
<th style="border:1px solid black;" >
Vulnerabilidade de ponteiro não inicializado do Word - CVE-2010-2747  
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de verificação de limite do Word - CVE-2010-2748  
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de índice do Word - CVE-2010-2750  
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de estouro de pilha do Word - CVE-2010-3214  
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de retorno de valor do Word - CVE-2010-3215  
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de indicadores do Word - CVE-2010-3216  
</th>
</tr>
<tr>
...
Vulnerabilidade de ponteiro do Word - CVE-2010-3217
</th>
<th colspan="2" style="border:1px solid black;">
Vulnerabilidade de estouro de pilha do Word - CVE-2010-3218
</th>
<th colspan="3" style="border:1px solid black;">
Vulnerabilidade na análise de índice do Word - CVE-2010-3219
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de análise do Word - CVE-2010-3220
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de análise do Word - CVE-2010-3221
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Word lida com um ponteiro não inicializado ao analisar um arquivo do Word especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-2747](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2747).

#### Fatores atenuantes da Vulnerabilidade de ponteiro não inicializado do Word - CVE-2010-2747
...
#### Soluções alternativas para a Vulnerabilidade de ponteiro não inicializado do Word - CVE-2010-2747
...
#### Perguntas frequentes sobre a Vulnerabilidade de ponteiro não inicializado do Word - CVE-2010-2747
...
Quando o Microsoft Word analisa um arquivo do Word especialmente criado, a memória do sistema pode ser corrompida de forma que um invasor possa executar código arbitrário.
...
Esta atualização elimina a vulnerabilidade, modificando a maneira pela qual o Microsoft Word analisa arquivos do Word especialmente criados.
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Word lida com uma verificação de limite incorreta ao analisar um arquivo do Word especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-2748](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2748).

#### Fatores atenuantes da Vulnerabilidade de verificação de limite do Word - CVE-2010-2748
...
#### Soluções alternativas da Vulnerabilidade de verificação de limite do Word - CVE-2010-2748
...
#### Perguntas frequentes sobre a Vulnerabilidade de verificação de limite do Word - CVE-2010-2748

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito essa vulnerabilidade poderá assumir remotamente o controle total de um sistema afetado. O invasor poderá instalar programas ou exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.

**O que provoca a vulnerabilidade?**  
Quando o Microsoft Word analisa um arquivo do Word especialmente criado, uma verificação de limite incorreta pode fazer com que a memória do sistema seja corrompida de forma que um invasor possa executar código arbitrário.
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Word lida com valores de índice contidos em um arquivo do Word especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-2750](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2750).

#### Fatores atenuantes da Vulnerabilidade de índice do Word - CVE-2010-2750
...
#### Soluções alternativas da Vulnerabilidade de índice do Word - CVE-2010-2750
...
#### Perguntas frequentes sobre a Vulnerabilidade de índice do Word - CVE-2010-2750

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito essa vulnerabilidade poderá assumir remotamente o controle total de um sistema afetado. O invasor poderá instalar programas ou exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.

**O que provoca a vulnerabilidade?**  
Quando o Microsoft Word analisa um arquivo do Word especialmente criado que contém um valor de índice malformado, a memória do sistema pode ser corrompida de forma que um invasor possa executar código arbitrário.
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Word lida com a validação de pilha ao analisar um arquivo do Word especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3214](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3214).

#### Fatores atenuantes da Vulnerabilidade de estouro de pilha do Word - CVE-2010-3214
...
#### Soluções alternativas para a Vulnerabilidade de estouro de pilha do Word - CVE-2010-3214
...
#### Perguntas frequentes sobre a Vulnerabilidade de estouro de pilha do Word - CVE-2010-3214
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Word lida com valores de retorno ao analisar um arquivo do Word especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3215](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3215).

#### Fatores atenuantes da Vulnerabilidade de retorno de valor do Word - CVE-2010-3215
...
#### Soluções alternativas para a Vulnerabilidade de retorno de valor do Word - CVE-2010-3215
...
#### Perguntas frequentes sobre a Vulnerabilidade de retorno de valor do Word - CVE-2010-3215
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Word lida com indicadores ao analisar um arquivo do Word especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3216](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3216).

#### Fatores atenuantes da Vulnerabilidade de indicadores do Word - CVE-2010-3216
...
#### Soluções alternativas para a Vulnerabilidade de indicadores do Word - CVE-2010-3216
...
#### Perguntas frequentes sobre a Vulnerabilidade de indicadores do Word - CVE-2010-3216

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito essa vulnerabilidade poderá assumir remotamente o controle total de um sistema afetado. O invasor poderá instalar programas ou exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.

**O que provoca a vulnerabilidade?**  
Quando o Microsoft Word analisa um arquivo do Word especialmente criado que contenha indicadores, a memória do sistema pode ser corrompida de forma que um invasor possa executar código arbitrário.
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Word lida com ponteiros ao analisar um arquivo do Word especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3217](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3217).

#### Fatores atenuantes da Vulnerabilidade de ponteiro do Word - CVE-2010-3217
...
#### Soluções alternativas para a Vulnerabilidade de ponteiro do Word - CVE-2010-3217
...
#### Perguntas frequentes sobre a Vulnerabilidade de ponteiro do Word - CVE-2010-3217
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Word lida com registros malformados contidos em um arquivo do Word especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3218](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3218).

#### Fatores atenuantes da Vulnerabilidade de estouro de pilha do Word - CVE-2010-3218
...
#### Soluções alternativas para a Vulnerabilidade de estouro de pilha do Word - CVE-2010-3218
...
#### Perguntas frequentes sobre a Vulnerabilidade de estouro de pilha do Word - CVE-2010-3218
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Word lida com índices ao analisar um arquivo do Word especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3219](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3219).

#### Fatores atenuantes da Vulnerabilidade na análise de índice do Word - CVE-2010-3219
...
#### Soluções alternativas para a Vulnerabilidade na análise de índice do Word - CVE-2010-3219
...
#### Perguntas frequentes sobre a Vulnerabilidade na análise de índice do Word - CVE-2010-3219
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Word analisa um arquivo do Word especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3220](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3220).

#### Fatores atenuantes da Vulnerabilidade de análise do Word - CVE-2010-3220
...
#### Soluções alternativas para a Vulnerabilidade de análise do Word - CVE-2010-3220
...
#### Perguntas frequentes sobre a Vulnerabilidade de análise do Word - CVE-2010-3220
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Word lida com um registro malformado ao analisar um arquivo do Word especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3221](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3221).

#### Fatores atenuantes da Vulnerabilidade de análise do Word - CVE-2010-3221
...
#### Soluções alternativas para a Vulnerabilidade de análise do Word - CVE-2010-3221
...
#### Perguntas frequentes sobre a Vulnerabilidade de análise do Word - CVE-2010-3221
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2328360">Artigo 2328360 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2344911">Artigo 2344911 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Para Word 2007, consulte o <a href="http://support.microsoft.com/kb/2344993">Artigo 2344993 (em inglês) da Microsoft Knowledge Base</a><br />
<br />
Para Pacote de compatibilidade do Microsoft Office para formatos de arquivo Word, Excel e PowerPoint 2007, consulte o <a href="http://support.microsoft.com/kb/2345043">Artigo 2345043 (em inglês) da Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Para Microsoft Office 2010, consulte o <a href="http://support.microsoft.com/kb/2345000">artigo 2345000 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft Word Web App, consulte o <a href="http://support.microsoft.com/kb/2345015">artigo 2345015 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft Office Web Apps, consulte o <a href="http://support.microsoft.com/kb/2346411">artigo 2346411 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
-   Chaouki Bekrar, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade de ponteiro não inicializado do Word (CVE-2010-2747)  
-   Chaouki Bekrar, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade de verificação de limite do Word (CVE-2010-2748)  
-   Chaouki Bekrar, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade de índice do Word (CVE-2010-2750)  
-   Nicolas Joly, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade de estouro de pilha do Word (CVE-2010-3214)  
-   Chaouki Bekrar, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade de retorno de valor do Word (CVE-2010-3215)  
-   Chaouki Bekrar, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade de indicadores do Word (CVE-2010-3216)  
-   Chaouki Bekrar, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade de ponteiro do Word (CVE-2010-3217)  
-   Chaouki Bekrar, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade de estouro de pilha do Word (CVE-2010-3218)  
-   Chaouki Bekrar, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade na análise de índice do Word (CVE-2010-3219)  
-   Chaouki Bekrar, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade de análise do Word (CVE-2010-3220)  
-   Chaouki Bekrar, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade de análise do Word (CVE-2010-3221)
...
-   V1.1 (13 de outubro de 2010): Corrigido o nome do pacote para a atualização do Pacote de Compatibilidade do Microsoft Office (KB2345043). Esta é apenas uma alteração informativa. Os clientes que já atualizaram seus sistemas com êxito não precisam fazer mais nada.  
-   V1.2 (3 de novembro de 2010): Corrigida a informação de substituição de boletim para a atualização do Microsoft Word Viewer (KB2345009). Esta é apenas uma alteração informativa. Não houve alterações à lógica de detecção nem aos arquivos de atualização.
