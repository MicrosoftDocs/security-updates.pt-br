...
ms:assetid: 'ms10-081'
ms:contentKeyID: 61234220
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-081(v=Security.10)'
---

Microsoft Security Bulletin MS10-081 - Importante
=================================================

Vulnerabilidade na biblioteca de controle comum do Windows permite a execução remota de código (2296011)
--------------------------------------------------------------------------------------------------------
...
A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira pela qual os controles comuns do Windows manipulam mensagens transmitidas de um visualizador de gráficos vetoriais escalonáveis (SVG) de terceiros. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=912a7c20-8177-4f65-b986-43fca6375ec1)                                                                                                    | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6c651bca-adb1-4172-9714-cd5a6e5d2c2a)                                                                           | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3b2eb449-ad55-4dfb-a3c5-aac767de6f45)                                                                                           | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=54fc4bc6-f46c-447c-8307-afd8338e7ffb)                                                                               | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=64f5c311-d74a-4665-9775-ac91c6885ed3)                                                                | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=95ceafc6-e37a-4c77-b16e-c9c94a7d89bd)                                                                  | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dfe7cd18-53a3-433e-9a33-bd96b04b4deb)                                          | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d5f079b0-d8e1-47fe-b9dd-41eeb463a93c)\*\*               | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8e88d9c5-eb57-4d39-a880-a478c5f286da)\*\*     | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=76e46d08-22d9-4a0c-82cd-d2753d07efe6) | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=bdff9057-381a-44e8-b093-84f07d8d7e3c)                                                                                           | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=35a2b1a9-6dd6-4a7e-bc0a-b4fcffa06b28)                                                                                      | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=25fff010-3abc-45e6-979e-21d2bae49418)\*\*                                                                     | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=d0742526-b5ec-4658-82f1-c3680f33a790)                                                                     | Execução Remota de Código  | Importante                      | Nenhuma                                    |
...
<th style="border:1px solid black;" >Vulnerabilidade de estouro de heap Comctl32 - CVE-2010-2746</th>
...
Vulnerabilidade de estouro de heap Comctl32 - CVE-2010-2746  
-----------------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código na maneira como a biblioteca de controles comuns do Windows renderiza sites especialmente criados ao usar um visualizador de gráficos vetoriais escalonáveis (SVG) de terceiros. Essa vulnerabilidade pode permitir a execução de código caso um usuário tenha visitado uma página da Web especialmente criada. Se um usuário tiver feito logon com direitos administrativos, o invasor que explorar com êxito essa vulnerabilidade poderá ter o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-2746](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2746).
  
#### Fatores atenuantes da vulnerabilidade de estouro de heap Comctl32 - CVE-2010-2746
...
-   Esta vulnerabilidade não pode ser explorada na configuração padrão do Windows. Para estar vulnerável ao problema, um aplicativo de terceiros que renderiza os gráficos vetoriais escalonáveis (SVG) deve estar instalado no sistema.
  
#### Soluções alternativas para a vulnerabilidade de estouro de heap Comctl32 - CVE-2010-2746
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de estouro de heap Comctl32 - CVE-2010-2746
...
A biblioteca de controles comuns do Windows não manipula adequadamente determinadas mensagens ao renderizar os gráficos vetoriais escalonáveis transmitidos a partir de um visualizador de gráficos de vetores escalonáveis (SVG) de terceiros.
  
**O que são as Bibliotecas de controles comuns do Windows?**    
Os controles comuns são um conjunto de janelas que são implementadas pela biblioteca de controle comuns, Comctl32.dll, que é uma DLL incluída com o sistema operacional Windows. Como outras janelas de controle, um controle comum é uma janela subjacente que um aplicativo usa junto com outra janela para ativar a interação com o usuário. Para obter mais informações sobre essas bibliotecas, consulte o artigo do MSDN, [About Common Controls](http://msdn.microsoft.com/en-us/library/bb775493(vs.85).aspx) (em inglês).
  
**Este problema pode ser explorado na configuração padrão do Windows?**    
Não. Para estar vulnerável ao problema, um aplicativo de terceiros que renderiza os gráficos vetoriais escalonáveis (SVG) deve estar instalado no sistema. A Microsoft não determinou nenhum vetor de ataque sem que este visualizador de terceiros esteja instalado no sistema. Para obter uma lista de implementações de SVG, consulte a lista do W3C (World Wide Web Consortium) de [Implementações de SVG](http://www.w3.org/graphics/svg/wg/wiki/implementations).
  
**O que são Gráficos vetoriais escalonáveis?**    
Os Gráficos vetoriais escalonáveis (SVG) é um padrão para criar e implementar gráficos de vetores bidimensionais usando documentos XML. É uma recomendação do W3C criada e endossada por uma série de organizações do setor. Um SVG é, em sua essência, um documento XML em conformidade com o esquema definido como parte do processo de ratificação de SVG. Definidas na especificação, há uma variedade de formas geométricas básicas como retângulos, círculos, elipses, linhas, polilinhas, polígonos e elementos de glifo como texto. Formas mais complexas podem ser criadas usando o elemento de caminho, permitindo que você defina as formas como uma sequência de linhas, arcos e curvas complexas de Bezier. Usar essas formas básicas, junto com um pouco de criatividade, é possível criar até mesmo as construções geométricas mais complexas.
...
A atualização elimina a vulnerabilidade, corrigindo a maneira pela qual a biblioteca de controles comuns do Windows manipula mensagens transmitidas de um visualizador de gráficos vetoriais escalonáveis (SVG) de terceiros.
...
Para Windows XP Service Pack 3:WindowsXP-KB2296011-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><br />
Para Windows XP Service Pack 3:WindowsXP-KB2296011-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB2296011$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2296011">Artigo 2296011 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Krystian Kloskowski (h07), que trabalha com a [Secunia](http://secunia.com/), por relatar a Vulnerabilidade de estouro de heap Comctl32 (CVE-2010-2746)
