...
ms:assetid: 'ms10-082'
ms:contentKeyID: 61234221
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-082(v=Security.10)'
---
...
Vulnerabilidade no Windows Media Player pode permitir a execução remota de código (2378111)
-------------------------------------------------------------------------------------------
...
Esta atualização de segurança é classificada como Importante para o Windows Media Player 9 Series, Windows Media Player 10, Windows Media Player 11 e Windows Media Player 12 quando instalados em versões com suprote do Microsoft Windows com exceção do Windows Server 2008 e Windows Server 2008 R2. Para o Windows Media Player 11 e Windows Media Player 12 quando instalados em edições com suporte do Windows Server 2008 e Windows Server 2008 R2, esta atualização de segurança é classificada como Moderada. Todas as edições baseadas no Itanium do Windows Server 2003, Windows Server 2008 e Windows Server 2008 R2 com suporte não são afetadas pela vulnerabilidade. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira na qual o Windows Media Player desaloca os objetos durante uma operação de recarga. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
| Microsoft Windows Server 2003 x64 Edition Service Pack 2                                                                     | Windows Media Player 6.4 |  
...
<th style="border:1px solid black;" >
Vulnerabilidade de corrupção de memória do Windows Media Player - CVE-2010-2745  
</th>
<th style="border:1px solid black;" >
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Player 11 no Windows Server 2008 para Systems de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Moderada**   
Execução Remota de Código
...
-   Edições com suporte do Windows Server 2008 e Windows Server 2008 R2 não são afetados por esse problema a menos que o recurso Experiência de área de trabalho seja instalado. Por padrão, essas plataformas não carregam o componente afetado do Windows Media Player. Para obter mais informações no recurso Experiência de área de trabalho, consulte o artigo de Technet, [Visão geral da experiência da área de trabalho](http://technet.microsoft.com/en-us/library/cc772567.aspx).

#### Soluções alternativas para a vulnerabilidade de corrupção de memória do Windows Media Player - CVE-2010-2745

A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:

-   **Cancelar registro wmp.dll**
    ...
    **Impacto da solução alternativa.** O Windows Media Player não poderá reproduzir formatos de arquivo com suporte.
...
#### Perguntas frequentes sobre a vulnerabilidade de corrupção de memória do Windows Media Player - CVE-2010-2745
...
O Windows Media Player desaloca objetos incorretamente durante uma operação de recarga por meio de um navegador da Web.
...
**A interação do usuário é requerida para esta vulnerabilidade a ser explorada?**  
Sim. Para que um ataque seja bem-sucedido, um usuário deve clicar em uma ou mais caixas de diálogo pop-up ao procurar por uma página da Web. Essa vulnerabilidade não pode ser explorada automaticamente ao visitar uma página da Web especialmente criada.
...
A atualização elimina o problema, corrigindo a maneira na qual o Windows Media Player desaloca os objetos durante uma operação de recarga.
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows Media Player 10 no Windows XP Professional x64 Edition Service Pack 2:<br />
windowsserver2003.windowsxp-kb2378111-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows Media Player 11 no Windows XP Professional x64 Edition Service Pack 2:<br />
windowsmedia11-kb2378111-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalar sem reinicializar</td>
<td style="border:1px solid black;">Para Windows Media Player 9 no Windows XP Service Pack 3:<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows Media Player 10 e Windows Media Player 11 no Windows XP Service Pack 3:<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado nos seguintes locais:<br />
<br />
...
<br />
Para Windows Media Player 10 no Windows XP Professional x64 Edition Service Pack 2:<br />
%Windir%\$NTUninstallKB2378111$\Spuninst folder<br />
<br />
Para Windows Media Player 11 no Windows XP Professional x64 Edition Service Pack 2:<br />
%Windir%\$NTUninstallKB2378111_WM11x64$\Spuninst folder</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2378111">Artigo 2378111 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
<td style="border:1px solid black;">Para Windows Media Player 9, Media Player 10 e Media Player 11 em todas as edições de 32 bits com suporte do Windows XP:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows Media Player 10 em todas as edições baseadas em x64 do Windows XP com suporte:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP Version 2003\SP3\KB2378111\Filelist<br />
<br />
Para Windows Media Player 11 em todas as edições baseadas em x64 do Windows XP com suporte:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2378111$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2378111">Artigo 2378111 (em inglês) da Microsoft Knowledge Base</a></td>
...
-   SkyLined, da [Google Inc.](http://www.google.com/), por relatar a Vulnerabilidade de corrupção de memória do Windows Media Player (CVE-2010-2745)
...
-   V1.1 (13 de outubro de 2010): Corrigido o link para download na tabela de **Softwares afetados** para Windows Media Player 11 no Windows XP Profissional x64 Edition Service Pack 2. Os clientes que instalaram este pacote específico usando atualização automática não precisam tomar nenhuma providência. Os clientes que instalaram manualmente a partir do Centro de Download da Microsoft precisam instalar este novo pacote manualmente.
