...
ms:assetid: 'ms10-091'
ms:contentKeyID: 61234231
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-091(v=Security.10)'
---
...
As vulnerabilidades no driver de fonte OpenType (OTF) podem permitir a execução remota de código (2296199)
----------------------------------------------------------------------------------------------------------
...
Esta atualização de segurança resolve várias vulnerabilidades relatadas em particular no driver de fonte Open Type (OTF) do Windows que podem permitir a execução remota de código. Um invasor pode hospedar uma fonte OpenType especialmente criada em um compartilhamento de rede. O caminho de controle afetado é então acionado quando o usuário navega até o compartilhamento no Windows Explorer, permitindo que a fonte especialmente criada assuma total controle sobre um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
...
A atualização de segurança aborda as vulnerabilidades corrigindo a maneira como o driver de fonte OpenType (OTF) indexa matrizes ao analisar fontes OpenType, redefine ponteiros ao liberar memória e analisa a tabela CMAP ao processar fontes OpenType. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=cdef3358-ad3e-40a6-9ba5-3be220a56a65)                                                                                                    | Elevação de privilégio     | Importante                      | [MS10-078](http://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=070fef8e-ba09-40f4-abaa-9cebf08983c3)                                                                           | Elevação de privilégio     | Importante                      | [MS10-078](http://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9b70334c-490d-446c-988a-a88a75595fd4)                                                                                           | Elevação de privilégio     | Importante                      | [MS10-078](http://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=08328e82-b012-4ea5-bf89-becb4881084f)                                                                               | Elevação de privilégio     | Importante                      | [MS10-078](http://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=15588d6a-f576-4e3d-95e8-d422af8a94de)                                                                | Elevação de privilégio     | Importante                      | [MS10-078](http://technet.microsoft.com/security/bulletin/ms10-078) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2ddb8a06-c9cc-4d33-b6d1-22dbda2d871f)                                                                  | Execução Remota de Código  | Crítica                         | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9a245f3c-ffb6-4ccd-956c-e7d1231fca30)                                          | Execução Remota de Código  | Crítica                         | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=87149ec2-74a8-4dea-b7e3-873558e0103e)\*                 | Execução Remota de Código  | Crítica                         | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=523a47d3-771d-471a-889b-16311c276a00)\*       | Execução Remota de Código  | Crítica                         | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=959146ee-0e70-4e56-9012-72ed59aeb24b) | Execução Remota de Código  | Crítica                         | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=ff590db8-4264-42ba-9e07-88d100e1c4f5)                                                                                           | Execução Remota de Código  | Crítica                         | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=4ea4e339-9db2-4b99-b567-80ee55ecdf92)                                                                                      | Execução Remota de Código  | Crítica                         | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=e52f7869-474a-44c8-a102-e766c576fc01)\*                                                                       | Execução Remota de Código  | Crítica                         | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
| [Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a21d061a-794a-4012-b3cd-c67445c074f5)                                                                     | Execução Remota de Código  | Crítica                         | [MS10-037](http://technet.microsoft.com/security/bulletin/ms10-037) |
...
<th style="border:1px solid black;" >Vulnerabilidade de índice de fonte OpenType - CVE-2010-3956</th>
<th style="border:1px solid black;" >Vulnerabilidade de liberação duplicada de fonte OpenType - CVE-2010-3957</th>
<th style="border:1px solid black;" >Vulnerabilidade de tabela CMAP OpenType - CVE-2010-3959</th>
...
Vulnerabilidade de índice de fonte OpenType - CVE-2010-3956  
-----------------------------------------------------------
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3956](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3956).
  
#### Fatores atenuantes para a Vulnerabilidade de índice de fonte OpenType - CVE-2010-3956
...
#### Soluções alternativas para a Vulnerabilidade de índice de fonte OpenType - CVE-2010-3956
...
#### Perguntas frequentes para a Vulnerabilidade de índice de fonte OpenType - CVE-2010-3956
...
A vulnerabilidade é causada quando o driver de fonte OpenType (OTF) não indexa adequadamente uma matriz ao analisar fontes OpenType.
...
Nos sistemas Windows XP e Windows Server 2003, para explorar essa vulnerabilidade, um invasor primeiro tem que fazer logon no sistema. Em seguida, ele precisa executar um aplicativo especialmente criado capaz de explorar a vulnerabilidade e assumir o controle total do sistema afetado.
...
A atualização aborda a vulnerabilidade corrigindo a maneira como o driver de fonte OpenType (OTF) indexa uma matriz ao analisar fontes OpenType.
...
Vulnerabilidade de liberação duplicada de fonte OpenType - CVE-2010-3957  
------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o driver de fonte OpenType (OTF) analisa inadequadamente fontes OpenType especialmente criadas. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3957](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3957).
  
#### Fatores atenuantes para a Vulnerabilidade de liberação duplicada de fonte OpenType - CVE-2010-3957
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   No cenário de ataque na Web, o invasor terá que hospedar um site contendo uma página da Web usada para explorar essa vulnerabilidade. Além disso, sites comprometidos e sites que aceitem ou hospedem conteúdo fornecido pelo usuário ou anúncios pode conter conteúdo especialmente desenvolvido que pode explorar esta vulnerabilidade. Em todos os casos, entretanto, um invasor não teria como forçar os usuários a visitarem os sites. Em vez disso, o invasor teria que convencer os usuários a visitar o site, geralmente fazendo com que eles cliquem em um link em um email ou mensagem do Instant Messenger que leva o usuário ao site do invasor.
  
#### Soluções alternativas para a Vulnerabilidade de liberação duplicada de fonte OpenType - CVE-2010-3957
...
#### Perguntas frequentes para a Vulnerabilidade de liberação duplicada de fonte OpenType - CVE-2010-3957
  
**Qual é o escopo da vulnerabilidade?**    
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito essa vulnerabilidade poderá assumir remotamente o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada quando o driver de fonte OpenType (OTF) não redefine adequadamente um ponteiro ao liberar memória. Isso resulta em uma condição de "liberação duplicada".
...
**O que a atualização faz?**    
A atualização aborda a vulnerabilidade corrigindo a maneira como o driver de fonte OpenType (OTF) redefine ponteiros ao liberar memória.
...
Vulnerabilidade de tabela CMAP OpenType - CVE-2010-3959  
-------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o driver de fonte OpenType (OTF) analisa inadequadamente fontes OpenType especialmente criadas. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3959](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3959).
  
#### Fatores atenuantes para a Vulnerabilidade de tabela CMAP OpenType - CVE-2010-3959
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   No cenário de ataque na Web, o invasor terá que hospedar um site contendo uma página da Web usada para explorar essa vulnerabilidade. Além disso, sites comprometidos e sites que aceitem ou hospedem conteúdo fornecido pelo usuário ou anúncios pode conter conteúdo especialmente desenvolvido que pode explorar esta vulnerabilidade. Em todos os casos, entretanto, um invasor não teria como forçar os usuários a visitarem os sites. Em vez disso, o invasor teria que convencer os usuários a visitar o site, geralmente fazendo com que eles cliquem em um link em um email ou mensagem do Instant Messenger que leva o usuário ao site do invasor.
  
#### Soluções alternativas para a Vulnerabilidade de tabela CMAP OpenType - CVE-2010-3959
...
#### Perguntas frequentes para a Vulnerabilidade de tabela CMAP OpenType - CVE-2010-3959
  
**Qual é o escopo da vulnerabilidade?**    
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito essa vulnerabilidade poderá assumir remotamente o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada quando o driver de fonte OpenType (OTF) não analisa adequadamente a tabela CMAP ao processar uma OpenType especialmente criada.
...
**Os navegadores da Web de terceiros são afetados por esta vulnerabilidade?**    
Sim. Os navegadores da Web de terceiros são afetados por esta vulnerabilidade se eles processarem originalmente as fontes OpenType. Para esses aplicativos, esta vulnerabilidade pode permitir uma negação remota de serviço se um usuário navegar até um site com uma fonte OpenType incorporada especialmente criada. Por padrão, o Internet Explorer não é afetado por esse problema.
  
**O que a atualização faz?**    
A atualização aborda a vulnerabilidade corrigindo a maneira como o driver de fonte OpenType (OTF) analisa a tabela CMAP ao processar fontes OpenType.
  
**O que é uma tabela CMAP?**    
Esta tabela define o mapeamento de códigos de caractere aos valores de índice de glifo usados na fonte. Ela pode conter mais de uma subtabela para aceitar mais de um esquema de codificação de caractere. O cabeçalho da tabela indica as codificações de caractere para as quais existem subtabelas. Cada subtabela está em um dos sete possíveis formatos e começa com um código de formato que indica o formato usado. Para obter mais informações, consulte o artigo [Character to Glyph Index Mapping Table](http://www.microsoft.com/typography/otspec/cmap.htm) (em inglês).
...
Para Windows XP Service Pack 3:WindowsXP-KB2296199-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><br />
Para Windows XP Service Pack 3:WindowsXP-KB2296199-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2296199$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2296199">Artigo 2296199 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Marc Schoenefeld, da [Red Hat Security Response Team](https://www.redhat.com/security/team/), trabalha com a [Opera Security Team](http://www.opera.com/security/), para relatar a vulnerabilidade OpenType Font Index (CVE-2010-3956)  
-   Marc Schoenefeld do [Red Hat Security Response Team](https://www.redhat.com/security/team/) para relatar a Vulnerabilidade de liberação duplicada de fonte OpenType (CVE-2010-3957)  
-   Paul-Kenji Cahier Furuya para relatar a Vulnerabilidade de Tabela CMAP OpenType (CVE-2010-3959)
