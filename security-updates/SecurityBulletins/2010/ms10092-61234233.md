...
ms:assetid: 'ms10-092'
ms:contentKeyID: 61234233
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-092(v=Security.10)'
---
...
Vulnerabilidade no Agendador de Tarefas pode permitir a elevação de privilégio (2305420)
----------------------------------------------------------------------------------------
...
Esta atualização de segurança elimina uma vulnerabilidade divulgada publicamente no Agendador de Tarefas do Windows. A vulnerabilidade poderá permitir a elevação de privilégio se um invasor se conectar ao sistema afetado e executar um aplicativo especialmente criado. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
...
A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira como o Agendador de Tarefas conduz verificações de integridade para validar que tarefas são executadas com os privilégios de usuário destinados. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=48f10251-34d8-4149-b4b2-bf3ec28f5846)                                                                  | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=099ccc5f-b92f-4d06-bcb5-92e35c49f613)                                          | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=bdc9564a-4091-4cde-963a-239513db6c17)\*                 | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dff39bfe-0799-4912-ae22-392562178ae6)\*       | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cf341a35-32ea-4ff7-aca9-1a4683c100ee) | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=cf85cdb6-58c7-4144-82f6-f01a6a4f9c3a)                                                                                           | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=0597018d-39f5-4ca9-b437-63d9e68f264d)                                                                                      | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=28c832fb-4937-4652-8799-eab6c76d05fb)\*                                                                       | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3ad64d5c-2d81-4ac8-934e-8917b2fcf961)                                                                     | Elevação de privilégio     | Importante                      | Nenhuma                                    |
...
<th style="border:1px solid black;" >Vulnerabilidade do Agendador de Tarefas - CVE-2010-3338</th>
...
Vulnerabilidade do Agendador de Tarefas - CVE-2010-3338  
-------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégio na maneira como o Agendador de Tarefas do Windows valida incorretamente se as tarefas programadas são executadas no conteúdo de segurança pretendido. O invasor que explorar esta vulnerabilidade com êxito poderá executar código arbitrário no contexto de segurança do sistema local. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338).
  
#### Fatores atenuantes da Vulnerabilidade do Agendador de Tarefas - CVE-2010-3338
...
#### Soluções alternativas para a Vulnerabilidade do Agendador de Tarefas - CVE-2010-3338
...
-   **Desativar o serviço do Agendador de Tarefas**
    ...
    **Impacto da solução alternativa.** O usuário não poderá executar tarefas programadas no computador.
...
#### Perguntas frequentes sobre a Vulnerabilidade do Agendador de Tarefas - CVE-2010-3338
...
A vulnerabilidade é causada quando o Agendador de Tarefas do Windows valida incorretamente se as tarefas programadas devem ser executadas no contexto de segurança pretendido, o que permite que um invasor local agende uma tarefa a ser executada no contexto das contas do Sistema ou Administrador.
  
**O que é o Agendador de Tarefas do Windows?**    
O Agendador de Tarefas é um serviço do Windows que habilita a automação de tarefas de rotina em um determinado computador. O Agendador de Tarefas faz isso, monitorando os critérios escolhidos pelo usuário para inicializar as tarefas (os chamados gatilhos) e, em seguida, executando as tarefas quando os critérios são atendidos. Para obter mais informações, consulte a entrada da Biblioteca MSDN, [Task Scheduler](http://msdn.microsoft.com/en-us/library/aa383614(vs.85).aspx) (em inglês).
...
A atualização elimina a vulnerabilidade, corrigindo a maneira como o Agendador de Tarefas conduz verificações de integridade para validar que tarefas são executadas com os privilégios de usuário destinados.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2010-3338](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3338) da lista Common Vulnerability and Exposure.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2305420">Artigo 2305420 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
-   Sergey Golovanov, Alexander Gostev, Maxim Golovkin e Alexey Monastyrsky, do [Kaspersky Lab](http://usa.kaspersky.com/), e Vitaly Kiktenko e Alexander Saprykin, do [Design and Test Lab](http://www.dnt-lab.com/), por relatarem a Vulnerabilidade do Agendador de Tarefas (CVE-2010-3338).  
-   Liam O Murchu, da [Symantec](http://www.symantec.com/index.jsp), por relatar a Vulnerabilidade do Agendador de Tarefas (CVE-2010-3338)  
-   Alexandr Matrosov, Eugene Rodionov, Juraj Malcho e David Harley, da [ESET](http://www.eset.com/), por relatarem a Vulnerabilidade do Agendador de Tarefas (CVE-2010-3338)
