...
ms:assetid: 'ms10-093'
ms:contentKeyID: 61234234
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-093(v=Security.10)'
---

Microsoft Security Bulletin MS10-093 - Importante
=================================================

Vulnerabilidade no Windows Movie Maker pode permitir a execução remota de código (2424434)
------------------------------------------------------------------------------------------
...
Esta atualização de segurança é classificada como Importante para o Windows Movie Maker 2.6 em todas as edições com suporte do Windows Vista. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança elimina a vulnerabilidade corrigindo a maneira como o Windows Movie Maker carrega as bibliotecas externas. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| Windows Vista Service Pack 1 e Windows Vista Service Pack 2                         | [Movie Maker 2.6](http://www.microsoft.com/downloads/details.aspx?familyid=55141a02-3ad3-4691-98b9-80dd8ecb14c5)<sup>[1]</sup> | Execução Remota de Código  | Importante                      | [MS10-050](http://technet.microsoft.com/security/bulletin/ms10-050) |
| Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2 | [Movie Maker 2.6](http://www.microsoft.com/downloads/details.aspx?familyid=5b078136-a492-4a2e-939d-82799f774d82)<sup>[1]</sup> | Execução Remota de Código  | Importante                      | [MS10-050](http://technet.microsoft.com/security/bulletin/ms10-050) |
...
<th style="border:1px solid black;" >Vulnerabilidade no carregamento de biblioteca desprotegida — CVE-2010-3967</th>
...
Vulnerabilidade no carregamento de biblioteca desprotegida — CVE-2010-3967  
--------------------------------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código na maneira como o Windows Movie Maker manipula o carregamento de arquivos DLL. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3967](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3967).
  
#### Fatores atenuantes da vulnerabilidade no carregamento de biblioteca desprotegida — CVE-2010-3967
...
#### Soluções alternativas para a Vulnerabilidade no carregamento de biblioteca desprotegida — CVE-2010-3967
...
#### Perguntas frequentes sobre a Vulnerabilidade no carregamento de biblioteca desprotegida — CVE-2010-3967
...
A vulnerabilidade é causada quando o Windows Movie Maker restringe incorretamente o caminho usado para carregar bibliotecas externas.
  
**O que é o Windows Movie Maker?**    
O Windows Movie Maker é um aplicativo que permite aos usuários criar, editar e adicionar efeitos especiais a filmes domésticos. O Windows Movie Maker é incluído nas versões do Windows XP e Windows Vista. Esta vulnerabilidade só afeta o Movie Maker 2.6, que é um download opcional que pode ser instalado nos sistemas operacionais afetados.
...
Um invasor precisa convencer um usuário a abrir um arquivo legítimo do Windows Movie Maker (.mswmm) localizado na mesma pasta de rede que um arquivo DLL especialmente criado. Em seguida, ao abrir o arquivo, o Windows Movie Maker pode tentar carregar o arquivo DLL e executar o código contido nele.
  
Em um cenário de ataque por email, o invasor pode explorar a vulnerabilidade enviando um arquivo .mswmm legítimo como um anexo a um usuário e convencendo-o a colocar o anexo em um diretório que contém um arquivo DLL especialmente criado e a abrir o arquivo .mswmm. Em seguida, ao abrir o arquivo, o Windows Movie Maker pode tentar carregar o arquivo DLL e executar o código contido nele.
  
Em um cenário de rede, um invasor pode colocar um arquivo .mswmm legítimo, acompanhado por uma DLL especialmente criada em um local de UNC ou WebDAV e convencer o usuário a abrir o arquivo .mswmm.
  
**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**    
Esta vulnerabilidade afeta principalmente as estações de trabalhos nas quais os usuários podem ser esperados a abrir anexos de locais de rede não confiáveis.
  
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade corrigindo a maneira como o Windows Movie Maker carrega as bibliotecas externas.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2010-3967](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3967) da lista Common Vulnerability and Exposure.
...
<td style="border:1px solid black;">Para o Movie Maker 2.6 quando instalado em todas as edições com suporte de 32 bits do Windows Vista:<br />
WindowsMovieMaker2.6-KB2424434.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Movie Maker 2.6 em todas as edições baseadas em x64 com suporte do Windows Vista:<br />
WindowsMovieMaker2.6-KB2424434.exe /q:a</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2424434">Artigo 2424434 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
