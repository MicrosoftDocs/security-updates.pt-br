...
ms:assetid: 'ms10-094'
ms:contentKeyID: 61234235
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-094(v=Security.10)'
---

Microsoft Security Bulletin MS10-094 - Importante
=================================================

Vulnerabilidade no Codificador do Windows Media pode permitir execução remota de código (2447961)
-------------------------------------------------------------------------------------------------
...
Esta atualização de segurança foi classificada como Importante para todas as edições com suporte do Windows XP, Windows Server 2003 (exceto Itanium), Windows Vista e Windows Server 2008 (exceto Itanium). Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança aborda a vulnerabilidade corrigindo a maneira como o Codificador do Windows Media carrega bibliotecas externas. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ef0ada2c-965f-438f-a1d3-bd45db8460c1">Codificador do Windows Media 9 x86</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=dc777e61-e1e3-43bf-a84d-22c4a69c135d">Codificador do Windows Media 9 x86</a><br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=550957c2-ce66-439f-95ea-681237513f75">Codificador do Windows Media 9 x64</a></td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-053">MS08-053</a>,<br />
<a href="http://technet.microsoft.com/security/bulletin/ms10-033">MS10-033</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e8a57950-43cd-486f-bd97-70b0ad360a0b">Codificador do Windows Media 9 x86</a></td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-053">MS08-053</a>,<br />
<a href="http://technet.microsoft.com/security/bulletin/ms10-033">MS10-033</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f98c3b96-acb5-49f1-be42-3dd44d316408">Codificador do Windows Media 9 x86</a><br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=e1054088-f484-4f44-ba0e-5cbd21773c0c">Codificador do Windows Media 9 x64</a></td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-053">MS08-053</a>,<br />
<a href="http://technet.microsoft.com/security/bulletin/ms10-033">MS10-033</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a4ea028f-edfc-4237-8325-7ece11fcf437">Codificador do Windows Media 9 x86</a>&#42;&#42;</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-053">MS08-053</a>,<br />
<a href="http://technet.microsoft.com/security/bulletin/ms10-033">MS10-033</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f468d2b5-f02c-4691-9fb5-a7f69752f126">Codificador do Windows Media 9 x86</a>&#42;&#42;<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=533d91d8-0291-421e-9701-3bd86d18bc45">Codificador do Windows Media 9 x64</a>&#42;&#42;</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-053">MS08-053</a>,<br />
<a href="http://technet.microsoft.com/security/bulletin/ms10-033">MS10-033</a></td>
...
<th style="border:1px solid black;" >
Vulnerabilidade de carregamento não seguro de bibliotecas — CVE-2010-3965  
</th>
<th style="border:1px solid black;" >
...
Codificador do Windows Media 9 x86 no Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
...
<td style="border:1px solid black;">
Codificador do Windows Media 9 x86 no Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Codificador do Windows Media 9 x64 no Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Codificador do Windows Media 9 x86 no Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Codificador do Windows Media 9 x86 no Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Codificador do Windows Media 9 x64 no Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Codificador do Windows Media 9 x86 no Windows Vista Service Pack 1 e no Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Codificador do Windows Media 9 x86 no Windows Vista x64 Edition Service Pack 1 e no Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Codificador do Windows Media 9 x64 no Windows Vista x64 Edition Service Pack 1 e no Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Codificador do Windows Media 9 x86 no Windows Server 2008 para sistemas de 32 bits e no Windows Server 2008 para sistemas de 32 bits Service Pack 2 \*\*
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Codificador do Windows Media 9 x86 no Windows Server 2008 para sistemas baseados em x64 e no Windows Server 2008 para sistemas baseados em x64 Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Codificador do Windows Media 9 x64 no Windows Server 2008 para sistemas baseados em x64 e no Windows Server 2008 para sistemas baseados em x64 Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Office manipula o carregamento de arquivos DLL. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3965](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3965).

#### Fatores atenuantes da Vulnerabilidade de carregamento não seguro de bibliotecas — CVE-2010-3337

A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:

-   Para que um ataque seja bem-sucedido, o usuário deve visitar um local de sistema de arquivos remoto não confiável ou compartilhamento de WebDAV e abrir um arquivo .prx.
...
#### Soluções alternativas para a Vulnerabilidade de carregamento não seguro de bibliotecas — CVE-2010-3337
...
#### Perguntas frequentes para a vulnerabilidade de carregamento não seguro de bibliotecas — CVE-2010-3965
...
A vulnerabilidade é causada quando o Codificador do Windows Media restringe incorretamente o caminho usado para o carregamento de bibliotecas externas.

**O que é Codificador do Windows Media?**  
O Codificador do Microsoft Windows Media é uma ferramenta de produção eficiente e fácil de usar, destinada a converter vídeo e áudio ao vivo e pré-gravados no formato Windows Media.

**O que é arquivo de Perfil do Windows Media (.prx)?**  
Um arquivo PRX contém configurações de codificação para vídeo. Para criar arquivos PRX, aplique configurações de codificação, como taxa de bits e tamanho de vídeo, a seu vídeo no Microsoft Expression Encoder ou Codificador do Microsoft Windows e depois salve essas configurações no seu disco rígido. Se você criou e salvou configurações específicas no Codificador do Windows, também poderá tornar essas configurações disponíveis no Expression Encoder, o que evitará a necessidade de refazer um conjunto complexo e específico de configurações de codificação que você criou no Codificador de Windows. Para obter mais informações sobre arquivos PRX, consulte o artigo [Support of PRX Files](http://msdn.microsoft.com/en-us/library/cc294539.aspx) (em inglês) do MSDN.
...
Um invasor pode convencer um usuário a abrir um arquivo .prx legítimo localizado no mesmo diretório de rede de um arquivo de biblioteca de vínculo dinâmico (DLL) especialmente criado. Então, ao abrir o arquivo .prx, o Codificador do Windows Media pode tentar carregar o arquivo DLL e executar qualquer código contido nele.

Em um cenário de ataque de email, um invasor pode explorar a vulnerabilidade enviando um anexo de arquivo .prx legítimo a um usuário, e convencer o usuário a colocar o anexo em um diretório que contenha um arquivo DLL especialmente criado e a abrir o arquivo .prx. Então, ao abrir o arquivo .prx, o Codificador do Windows Media pode tentar carregar o arquivo DLL e executar qualquer código contido nele.

Em um cenário de rede, um invasor pode colocar um arquivo .prx e um DLL especialmente criado em um UNC ou local WebDAV e então convencer o usuário a abrir o arquivo .prx.
...
A atualização elimina a vulnerabilidade corrigindo a maneira como o Windows Media Encoder carrega as bibliotecas externas.

**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2010-3965](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3965) da lista Common Vulnerability and Exposure.
...
<td style="border:1px solid black;">Para o Codificador do Windows Media 9 x86 no Windows XP Service Pack 3:<br />
windowsmedia9-kb2447961-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Codificador do Windows Media 9 x86 no Windows XP Professional x64 Edition Service Pack 2<br />
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na seguinte pasta:<br />
Para Codificador do Windows Media 9 x86: %Windir%\\$NTUninstallKB2447961_WM9L$\spuninst<br />
Para o Codificador do Windows Media 9 x64: %Windir%\\$NTUninstallKB2447961_WM10L$\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2447961">Artigo 2447961 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Codificador do Windows Media 9 x64 no Windows Server 2003 x64 Edition Service Pack 2:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Media Encoder\KB2447961_WM10L</td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Codificador do Windows Media 9 x64 no Windows Vista x64 Edition Service Pack 1 e no Windows Vista x64 Edition Service Pack 2:<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Codificador do Windows Media 9 x64 no Windows Server 2008 para sistemas baseados em x64 e no Windows Server 2008 para sistemas baseados em x64 Service Pack 2:<br />
wme9-x64-kb2447961.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalar sem reinicializar</td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Codificador do Windows Media 9 x86 no Windows Server 2008 para sistemas baseados em x-64 Service Pack 2:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\KB2447961</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Codificador do Windows Media 9 x64 no Windows Server 2008 para sistemas baseados em x-64 Service Pack 2<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\KB2447961</td>
</tr>
</tbody>
</table>
