...
ms:assetid: 'ms10-095'
ms:contentKeyID: 61234236
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-095(v=Security.10)'
---
...
Vulnerabilidade no Microsoft Windows pode permitir a execução remota de código (2385678)
----------------------------------------------------------------------------------------
...
A atualização de segurança aborda a vulnerabilidade corrigindo a maneira como o Windows BranchCache carrega bibliotecas externas. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=75591d37-2cb8-4cdf-acbb-89cd0d1a9290)                       | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=3a0c4dd0-98b4-4e7a-99ed-22b9d9f76cd1)                  | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=f58a765f-cea9-456d-b0ab-bfc70b109cbf)\*   | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=13a9f838-ac07-43dc-9aee-a77207998e1e) | Execução Remota de Código  | Importante                      | Nenhuma                                    |
...
<th style="border:1px solid black;" >Vulnerabilidade de carregamento não seguro de bibliotecas no BranchCache - CVE-2010-3966</th>
...
Vulnerabilidade de carregamento não seguro de bibliotecas no BranchCache - CVE-2010-3966  
----------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Windows abre arquivos específicos em plataformas que não oferecem suporte à funcionalidade BranchCache. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3966](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3966).
  
#### Fatores atenuantes da Vulnerabilidade de carregamento não seguro de bibliotecas no BranchCache — CVE-2010-3337
...
#### Soluções alternativas da Vulnerabilidade de carregamento não seguro de bibliotecas no BranchCache — CVE-2010-3966
...
#### Perguntas frequentes para a Vulnerabilidade de carregamento não seguro de bibliotecas no BranchCache — CVE-2010-3966
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2385678">Artigo 2385678 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
-   Haifei Li da [Fortinet's FortiGuard Labs](http://www.fortiguard.com/) para relatar a Vulnerabilidade de carregamento não seguro de bibliotecas no BranchCache (CVE-2010-3966)
