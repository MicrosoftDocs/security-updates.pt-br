...
ms:assetid: 'ms10-096'
ms:contentKeyID: 61234237
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-096(v=Security.10)'
---
...
A atualização de segurança elimina a vulnerabilidade corrigindo a maneira como o Catálogo de endereços do Windows carrega as bibliotecas externas. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=46baa431-126c-4fa5-9a7b-525008e2817d)                                                                                                    | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b9ce9d62-2eaa-48d8-bb6d-ea137e63d077)                                                                           | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e0b2837c-019b-419b-954d-5bdc71a3a332)                                                                                           | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4c5cb600-9a39-40a0-be42-1593b1e0b97d)                                                                               | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=9abc8270-f3ac-474d-9ebc-410aaa6262cc)                                                                | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a1c7f1b5-e054-4cd6-857d-2ab0a2fe9f62)                                                                  | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=73624b68-a69d-4517-b971-f0b7d2ccc9d6)                                          | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=118f528f-bd05-49c2-a4a4-78314cd00992)\*\*               | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=77e288fb-b51f-4f57-baac-1443d8fbd37b)\*\*     | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=82f71194-6f1f-4f43-8752-4bf5e5f94a93) | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=4e8ad5cd-af27-4f00-9378-ad778b8ee7b3)                                                                                           | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=35a3e821-b463-411c-858b-d01eb5aed42b)                                                                                      | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=9e2c95f6-9381-4484-b11b-814ab9138118)\*\*                                                                     | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=cb4211f3-1082-4245-8f03-7cbac90e9a31)                                                                     | Execução Remota de Código  | Importante                      | Nenhuma                                    |
...
Sim, esta vulnerabilidade está relacionada à classe de vulnerabilidades, descrita no [Comunicado de Segurança da Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637), que afeta como os aplicativos carregam as bibliotecas externas. Este boletim de segurança elimina uma instância em particular deste tipo de vulnerabilidade.
...
<th style="border:1px solid black;" >Vulnerabilidade no carregamento de biblioteca desprotegida - CVE-2010-3147</th>
...
Vulnerabilidade no carregamento de biblioteca desprotegida - CVE-2010-3147  
--------------------------------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código na maneira como o Catálogo de endereços do Windows manipula o carregamento de arquivos DLL. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3147](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3147).
  
#### Fatores atenuantes da vulnerabilidade no carregamento de biblioteca desprotegida — CVE-2010-3147
...
#### Soluções alternativas para a Vulnerabilidade no carregamento de biblioteca desprotegida — CVE-2010-3147
...
#### Perguntas frequentes sobre a Vulnerabilidade no carregamento de biblioteca desprotegida — CVE-2010-3147
...
Esta vulnerabilidade é causada quando o Catálogo de endereços do Windows restringe incorretamente o caminho usado para carregar bibliotecas externas.
  
**O que é o Catálogo de endereços do Windows?**    
O Windows oferece um catálogo de endereços para armazenar informações de contato. O WAB é um aplicativo e serviço que permite aos usuários controlar seus contatos. O WAB tem um banco de dados local e uma interface do usuário para localizar e editar informações sobre contatos e pode consultar servidores de diretório de rede usando LDAP (Lightweight Directory Access Protocol). Outros aplicativos podem usar o WAB. Por exemplo, o Microsoft Outlook usa o WAB como seu catálogo de endereços de email.
...
Um invasor pode convencer um usuário a abrir um arquivo legítimo legítimo do Windows Address Book (WAB) localizado no mesmo diretório de rede de um arquivo de biblioteca de vínculo dinâmico (DLL) especialmente criado. Em seguida, ao abrir o arquivo, o Catálogo de endereços do Windows pode tentar carregar o arquivo DLL e executar o código contido nele.
  
Em um cenário de ataque por email, o invasor pode explorar a vulnerabilidade enviando um WAB legítimo como um anexo a um usuário e convencendo-o a colocar o WAB em um diretório que contém um arquivo DLL especialmente criado e a abrir o arquivo WAB. Em seguida, ao abrir o arquivo, o Catálogo de endereços do Windows pode tentar carregar o arquivo DLL e executar o código contido nele.
  
Em um cenário de rede, um invasor pode colocar um arquivo WAB e um DLL especialmente criado em um UNC ou local WebDAV e então convencer o usuário a abrir o arquivo WAB.
...
A atualização elimina a vulnerabilidade corrigindo a maneira como o Catálogo de endereços do Windows carrega as bibliotecas externas.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2010-3147](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3147) da lista Common Vulnerability and Exposure.
...
Para Windows XP Service Pack 3:WindowsXP-KB2423089-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><br />
Para Windows XP Service Pack 3:WindowsXP-KB2423089-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB2423089$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2423089">Artigo 2423089 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Simon Raner, da [ACROS Security](http://www.acrossecurity.com/), por relatar a Vulnerabilidade no carregamento de biblioteca desprotegida (CVE-2010-3147)  
-   HD Moore, da [Rapid7](http://www.rapid7.com/), por relatar a Vulnerabilidade no carregamento de biblioteca desprotegida (CVE-2010-3147)  
-   Muhaimin Dzulfakar, da [NGS Software](http://www.ngssoftware.com/), por relatar a Vulnerabilidade no carregamento de biblioteca desprotegida (CVE-2010-3147)
