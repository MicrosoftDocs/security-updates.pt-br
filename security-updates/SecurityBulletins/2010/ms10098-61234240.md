...
ms:assetid: 'ms10-098'
ms:contentKeyID: 61234240
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-098(v=Security.10)'
---

Microsoft Security Bulletin MS10-098 - Importante
=================================================

Vulnerabilidades em drivers no modo kernel do Windows podem permitir a elevação de privilégio (2436673)
-------------------------------------------------------------------------------------------------------
...
A atualização de segurança aborda as vulnerabilidades corrigindo a maneira como os drivers no modo kernel do Windows alocam memória, liberam objetos que não estão mais sendo usados, gerenciam objetos de driver no modo kernel e validam a entrada transmitida do modo de usuário. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=bb9d1657-5beb-4372-b74c-a612a6fff5a8)                                                                                                    | Elevação de privilégio     | Importante                      | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1f277ae4-4f85-4c8a-bfc5-dcdc8afed133)                                                                           | Elevação de privilégio     | Importante                      | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4aa39f59-2177-459f-9b8a-9543330d48ec)                                                                                           | Elevação de privilégio     | Importante                      | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=bca61d61-d5cf-49a4-ab99-b61e50e8f619)                                                                               | Elevação de privilégio     | Importante                      | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=4fce129d-2b4e-4a66-af27-bbbde1e65ba1)                                                                | Elevação de privilégio     | Importante                      | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b824d3b9-2ce1-4abc-ae06-68aef1250be9)                                                                  | Elevação de privilégio     | Importante                      | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f4c42cfe-b7f2-4436-919e-4bd305a3439a)                                          | Elevação de privilégio     | Importante                      | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6e2f572a-4169-47f2-a872-5466997122ed)\*                 | Elevação de privilégio     | Importante                      | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=09a4b646-989d-43ef-a3e8-64af8b380a14)\*       | Elevação de privilégio     | Importante                      | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=46522323-837e-4a74-9cf0-45f69343e776) | Elevação de privilégio     | Importante                      | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=aa7de2e4-ba48-4d58-b034-05349f0eb920)                                                                                           | Elevação de privilégio     | Importante                      | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=b21db627-91c2-4ebf-b7c0-38ac58ae5b6c)                                                                                      | Elevação de privilégio     | Importante                      | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=d417ebce-7841-4bbb-8abc-b15ef5f4b733)\*                                                                       | Elevação de privilégio     | Importante                      | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
| [Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=7eeac1bb-9f86-4ea5-b30f-980d52be5044)                                                                     | Elevação de privilégio     | Importante                      | [MS10-073](http://technet.microsoft.com/security/bulletin/ms10-073) |
...
<th style="border:1px solid black;" >Vulnerabilidade de estouro de buffer do Win32k - CVE-2010-3939</th>
<th style="border:1px solid black;" >Vulnerabilidade de liberação duplicada de ponteiro PFE do Win32k - CVE-2010-3940</th>
<th style="border:1px solid black;" >Vulnerabilidade de liberação duplicada do Win32k - CVE-2010-3941</th>
<th style="border:1px solid black;" >Vulnerabilidade de WriteAV do Win32k - CVE-2010-3942</th>
<th style="border:1px solid black;" >Vulnerabilidade de vínculo de cursor do Win32k - CVE-2010-3943</th>
<th style="border:1px solid black;" >Vulnerabilidade de corrupção de memória do Win32k - CVE-2010-3944</th>
...
Vulnerabilidade de estouro de buffer do Win32k - CVE-2010-3939  
--------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio na maneira como os drivers no modo kernel do Windows alocam inadequadamente memória ao copiar dados do modo do usuário. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3939](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3939).
  
#### Fatores atenuantes da vulnerabilidade de estouro de buffer do Win32k - CVE-2010-1895
...
#### Soluções alternativas para a Vulnerabilidade de estouro de buffer do Win32k - CVE-2010-3939
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes para a Vulnerabilidade de estouro de buffer do Win32k - CVE-2010-3939
...
A vulnerabilidade é causada quando os drivers no modo kernel do Windows não alocam adequadamente memória ao copiar dados do modo de usuário.
  
**Qual é o componente do Windows afetado pela vulnerabilidade?**    
...
Win32k.sys é um driver de dispositivo de modo do kernel e é a parte do kernel do subsistema Windows. Ele contém o gerenciador de janelas, que controla as exibições de janelas; gerencia a saída de tela; coleta entradas do teclado, mouse e outros dispositivos e transmite mensagens do usuário aos aplicativos. Ele também contém a GDI (Graphics Device Interface), que é uma biblioteca de funções para dispositivos de saída de gráficos. Finalmente, serve como um wrapper para suporte do DirectX implementado em outro driver (dxgkrnl.sys).
...
A atualização elimina a vulnerabilidade corrigindo a maneira como os drivers no modo do kernel do Windows alocam memória.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2010-3939](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3939) da lista Common Vulnerability and Exposure.
...
Vulnerabilidade de liberação duplicada de ponteiro PFE do Win32k - CVE-2010-3940  
--------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio devido à maneira como os drivers no modo kernel do Windows liberam objetos que não são mais usados. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3940](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3940).
  
#### Fatores atenuantes para a Vulnerabilidade de liberação duplicada do ponteiro PFE do Win32k - CVE-2010-3940
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a Vulnerabilidade de liberação duplicada do ponteiro PFE do Win32k - CVE-2010-3940
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes para a Vulnerabilidade de liberação duplicada do ponteiro PFE do Win32k - CVE-2010-3940
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada por uma condição de "liberação duplicada" envolvendo um ponteiro para um objeto de driver no modo kernel.
...
**O que a atualização faz?**    
A atualização aborda esta vulnerabilidade corrigindo a maneira como os drivers no modo kernel liberam objetos que não são mais usados.
...
Vulnerabilidade de liberação duplicada do Win32k - CVE-2010-3941  
----------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio devido à maneira como os drivers no modo kernel do Windows liberam objetos que não são mais usados. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3941](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3941).
  
#### Fatores atenuantes para a Vulnerabilidade de liberação duplicada do Win32k - CVE-2010-3941
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.  
-   Um sistema afetado deve poder executar programas de 16 bits para que um invasor possa explorar esta vulnerabilidade. A vulnerabilidade não pode ser explorada em servidores de 64 bits porque eles não podem executar programas de 16 bits.
  
#### Soluções alternativas para a Vulnerabilidade de liberação duplicada do Win32k - CVE-2010-3941
  
A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:
  
-   **Desabilite o subsistema NTVDM editando a diretiva de grupo**
  
    Os usuários que não requerem NTVDM (NT Virtual DOS Mode) podem atenuar a exploração desta vulnerabilidade desabilitando o subsistema NTVDM.
  
    Para desabilitar o subsistema NTVDM em sistemas Windows XP:
  
    1.  Depois de fazer logon com privilégios de administrador, clique em **Iniciar**, **Executar**, digite **gpedit.msc** e clique em **OK**.  
    2.  No painel de navegação do editor de diretiva de grupo, clique duas vezes em **Modelos Administrativos**, **Componentes do Windows** e clique em **Compatibilidade de Aplicativos**.  
    3.  No painel Compatibilidade de Aplicativos, clique duas vezes em **Impedir acesso a aplicativos de 16 bits**, altere a seleção na guia **Habilitado**, clique em **OK** e saia do editor de Diretiva de Grupo.
  
    Para sistemas Windows Server 2003, Windows Server 2008 e Windows Server 2008 R2, essa configuração pode ser implantada por diretiva de grupo com o mesmo modelo usado para sistemas Windows XP.
  
    Para sistemas Windows NT 4.0, consulte o artigo [Disabling the MSDOS and WOWEXEC Subsystems on Terminal Server](http://support.microsoft.com/kb/220159) (em inglês) da Microsoft Knowledge Base.
  
    **Impacto da solução alternativa.**  O acesso a aplicativos de 16 bits será desabilitado.
  
    **Como desfazer a solução alternativa.  **
  
    Para resabilitar o subsistema NTVDM em sistemas Windows XP:
  
    1.  Depois de fazer logon com privilégios de administrador, clique em **Iniciar**, **Executar**, digite **gpedit.msc** e clique em **OK**.  
    2.  No painel de navegação do editor de diretiva de grupo, clique duas vezes em **Modelos Administrativos**, **Componentes do Windows** e clique em **Compatibilidade de Aplicativos**.  
    3.  No painel Compatibilidade de Aplicativos, clique duas vezes em **Impedir acesso a aplicativos de 16 bits**, altere a seleção na guia Configuração para **Não Configurado**, clique em **OK** e saia do editor de Diretiva de Grupo.
  
    Para sistemas Windows Server 2003, Windows Server 2008 e Windows Server 2008 R2, essa configuração pode ser implantada por diretiva de grupo com o mesmo modelo usado para sistemas Windows XP.
  
    Para sistemas Windows NT 4.0, consulte o artigo [Disabling the MSDOS and WOWEXEC Subsystems on Terminal Server](http://support.microsoft.com/kb/220159) (em inglês) da Microsoft Knowledge Base.
  
-   **Desabilite o subsistema NTVDM editando o Registro do sistema**
    ...
    **Observação** É recomendável fazer backup do Registro antes de editá-lo.
    ...
    Para desabilitar o subsistema NTVDM editando o Registro do sistema, execute as seguintes etapas:
  
    1.  Clique em **Iniciar**, **Executar**, digite **regedit** e clique em **OK**.  
    2.  Localize esta chave no Registro do sistema:  
        HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\WOW  
    3.  Adicione uma entrada DWORD chamada **DisallowedPolicyDefault** e defina seu valor como **1** (isso desabilita efetivamente o NTVDM).  
    ...
    **Como desfazer a solução alternativa. **
    ...
    Para reativar o subsistema NTVDM editando o Registro do sistema, siga estas etapas:
  
    1.  Clique em **Iniciar**, **Executar**, digite **regedit** e clique em **OK**.  
    2.  Localize esta chave no Registro do sistema:  
        HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\WOW  
    3.  Altere o valor de **DisallowedPolicyDefault** para **0** (iisso reabilitada eficazmente o NTVDM).  
    4.  Feche o Editor do Registro.
  
#### Perguntas frequentes para a Vulnerabilidade de liberação duplicada do Win32k - CVE-2010-3941
...
Vulnerabilidade de WriteAV do Win32k - CVE-2010-3942  
----------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio na maneira como os drivers no modo kernel do Windows alocam inadequadamente memória ao copiar dados do modo do usuário. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3942](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3942).
  
#### Fatores atenuantes para a Vulnerabilidade de WriteAV do Win32k - CVE-2010-3942
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a Vulnerabilidade de WriteAV do Win32k - CVE-2010-3942
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes para a Vulnerabilidade de WriteAV do Win32k - CVE-2010-3942
...
Vulnerabilidade de vínculo de cursor do Win32k - CVE-2010-3943  
--------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio devido à maneira como drivers no modo kernel do Windows gerenciam objetos de driver nesse modo. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3943](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3943).
  
#### Fatores atenuantes da Vulnerabilidade de vínculo de cursor do Win32k- CVE-2010-3943
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a Vulnerabilidade de vínculo de cursor do Win32k- CVE-2010-3943
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes para a Vulnerabilidade de vínculo de cursor do Win32k- CVE-2010-3943
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada por um erro de lógica que ocorre ao vincular objetos de driver no modo kernel, levando a uma lista vinculada corrompida.
...
**O que a atualização faz?**    
A atualização aborda esta vulnerabilidade corrigindo a maneira como os drivers no modo kernel gerenciam objetos de driver nesse modo.
...
Vulnerabilidade de corrupção de memória do Win32k - CVE-2010-3944  
-----------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio na maneira como os drivers no modo kernel do Windows validam inadequadamente a entrada transmitida do modo de usuário. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3944](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3944).
  
#### Fatores atenuantes para a Vulnerabilidade de corrupção de memória do Win32k - CVE-2010-3944
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a Vulnerabilidade de corrupção de memória do Win32k - CVE-2010-3944
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes para a Vulnerabilidade de corrupção de memória do Win32k - CVE-2010-3944
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada porque os drivers no modo kernel do Windows não validam adequadamente a entrada transmitida do modo de usuário.
...
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade, corrigindo a maneira como os drivers no modo kernel do Windows validam a entrada transmitida do modo do usuário.
...
Para Windows XP Service Pack 3:WindowsXP-KB2436673-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><br />
Para Windows XP Service Pack 3:WindowsXP-KB2436673-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB2436673$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2436673">Artigo 2436673 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb2436673">Artigo 2436673 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave do Registro</strong></td>
...
-   Tarjei Mandt da [Norman](http://www.norman.com) para relatar a Vulnerabilidade de liberação duplicada do Kernel do Windows (CVE-2010-3941)  
-   Tarjei Mandt da [Norman](http://www.norman.com) para relatar a Vulnerabilidade de WriteAV do Kernel do Windows (CVE-2010-3942)  
-   Tarjei Mandt da [Norman](http://www.norman.com) para relatar a Vulnerabilidade de vínculo de cursor do Kernel do Windows (CVE-2010-3943)  
-   Tarjei Mandt da [Norman](http://www.norman.com) para relatar a Vulnerabilidade de corrupção de memória do Kernel do Windows (CVE-2010-3944)  
-   Stéfan Le Berre da [Sysdream](http://www.sysdream.com) para relatar a Vulnerabilidade de corrupção de memória do kernel do Windows (CVE-2010-3944)
