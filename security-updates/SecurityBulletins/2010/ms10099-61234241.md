...
ms:assetid: 'ms10-099'
ms:contentKeyID: 61234241
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-099(v=Security.10)'
---
...
A mais severa destas vulnerabilidades poderá permitir a elevação de privilégio se um invasor se conectar a um sistema afetado e executar um aplicativo especialmente criado. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.

A atualização de segurança elimina a vulnerabilidade corrigindo a validação do componente Roteamento e acesso remoto. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=4d0ae558-a4f2-4048-b5fd-ba072ca35e48)                                     | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=238bb885-eae6-464a-bb3d-679025f1cb50)            | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c87af292-a068-4089-aab8-115c18b4b024)                            | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e17b8878-d065-49cc-bdba-0f24cdf35ea3)                | Elevação de privilégio     | Importante                      | Nenhuma                                    |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ad896d80-167f-4e8f-a448-cac93516f4d0) | Elevação de privilégio     | Importante                      | Nenhuma                                    |
...
<th style="border:1px solid black;" >Vulnerabilidade de estouro de buffer do NDProxy de kernel - CVE-2010-3963</th>
...
Vulnerabilidade de estouro de buffer do NDProxy de kernel - CVE-2010-3963  
-------------------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio no componente NDProxy de roteamento e acesso remoto do kernel do Windows decorrente da validação imprópria de entrada transmitida do modo do usuário através do kernel. A vulnerabilidade pode permitir que um invasor execute código com privilégios elevados. Um invasor local que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3963](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3963).
  
#### Fatores atenuantes da Vulnerabilidade de estouro de buffer do NDProxy de kernel - CVE-2010-3963
...
#### Soluções alternativas para a Vulnerabilidade de estouro de buffer do NDProxy de kernel - CVE-2010-3963
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade de estouro de buffer do NDProxy de kernel - CVE-2010-3963
...
O componente NDProxy de roteamento e acesso remoto não valida corretamente a entrada fornecida pelo usuário ao transmitir dados do modo de usuário para o kernel.
...
Esta atualização elimina a vulnerabilidade, validando corretamente a entrada transmitida ao Kernel do Windows a partir do modo de usuário através do componente Roteamento e acesso remoto.
...
Para Windows XP Service Pack 3:WindowsXP-KB2440591-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><br />
Para Windows XP Service Pack 3:WindowsXP-KB2440591-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB2440591$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2440591">Artigo 2440591 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Honggang Ren, da [Fortinet's FortiGuard Labs](http://www.fortiguard.com/), por relatar a Vulnerabilidade de estouro de buffer do NDProxy de Kernel (CVE-2010-3963)
