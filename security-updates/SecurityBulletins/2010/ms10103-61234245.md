...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3954](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3954).
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2409055">Artigo 2409055 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
-   Chaouki Bekrar, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade de corrupção de heap do tamanho do valor no arquivo pubconv.dll (CVE-2010-2569)  
-   Chaouki Bekrar, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade de saturação de heap no arquivo pubconv.dll (CVE-2010-2570)  
-   Chaouki Bekrar, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade de corrupção de memória decorrente de índice inválido na matriz em pubconv.dll (CVE-2010-2571)  
-   Chaouki Bekrar, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade de corrupção de memória do Microsoft Publisher (CVE-2010-3954)  
-   Chaouki Bekrar, da [VUPEN Vulnerability Research Team](http://www.vupen.com/), por relatar a Vulnerabilidade de corrupção de memória para indexação de matrizes (CVE-2010-3955)
