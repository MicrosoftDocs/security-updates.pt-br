...
ms:assetid: 'ms10-104'
ms:contentKeyID: 61234247
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-104(v=Security.10)'
---
...
Vulnerabilidade no Microsoft SharePoint pode permitir a execução remota de código (2455005)
-------------------------------------------------------------------------------------------
...
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular no Microsoft SharePoint. A vulnerabilidade pode permitir a execução remota de código no contexto de segurança de um usuário convidado se um invasor enviar uma solicitação SOAP especialmente criada ao Serviço inicializador de conversões de documentos em um ambiente do servidor SharePoint que esteja usando o Serviço do balanceador de carga para conversões de documentos. Por padrão, o Serviço do balanceador de carga para conversões de documentos e o Serviço inicializador de conversões de documentos não estão habilitados no Microsoft Office SharePoint Server 2007.

Esta atualização de segurança é classificada como Importante para todas as edições do Microsoft Office SharePoint Server 2007 com suporte. Para obter mais informações, consulte a subseção **Software afetado e não afetado** nesta seção.

A atualização elimina a vulnerabilidade modificando a maneira como o Serviço inicializador de conversões de documentos valida as solicitações SOAP especialmente criadas. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
<th style="border:1px solid black;" >Vulnerabilidade de execução de código de solicitação malformada - CVE-2010-3964</th>
<th style="border:1px solid black;" >Avaliação de gravidade agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de execução de código de solicitação malformada - CVE-2010-3964  
-------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código na maneira como o Serviço inicializador de conversões de documentos valida solicitações SOAP antes do processamento em um servidor SharePoint. O invasor que explorar esta vulnerabilidade com êxito poderá executar código arbitrário em um servidor SharePoint no contexto de segurança de uma conta de convidado.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3964](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3964).
  
#### Fatores atenuantes da Vulnerabilidade de execução de código de solicitação malformada - CVE-2010-3964
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Por padrão, o Serviço do balanceador de carga para conversões de documentos e o Serviço inicializador de conversões de documentos não estão habilitados no Microsoft Office SharePoint Server 2007.  
-   Um invasor que explorar esta vulnerabilidade com êxito pode executar código como uma conta de convidado que só tenha direitos a um diretório temporário específico. O conteúdo deste diretório temporário específico é eliminado regularmente.
  
#### Soluções alternativas para a Vulnerabilidade de execução de código de solicitação malformada - CVE-2010-3964
  
A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:
  
-   **Pare e desabilite o Serviço inicializador de conversões de documentos**
  
    Execute o seguinte comando em um prompt como administrador em cada sistema que esteja executando o Serviço inicializador de conversões de documentos:  
    `sc stop dclauncher`  
    `sc config dclauncher start= disabled`
  
    **Impacto da solução alternativa.** A conversão de documentos do Office está desabilitada.
...
-   **Bloqueie portas usadas pelo Serviço inicializador de conversões de documentos no firewall**
  
    Bloqueie a seguinte porta no firewall:  
    Porta TCP 8082
  
    Essa porta é usada para iniciar uma conexão com o componente afetado. O bloqueio dessa porta no firewall, interno e externo, da empresa ajudará a impedir que os sistemas atrás do firewall sejam alvo de tentativas de exploração dessa vulnerabilidade. A Microsoft recomenda que você bloqueie todas as comunicações de entrada não solicitadas da Internet para ajudar a impedir ataques que talvez usem outras portas. Para obter mais informações sobre portas, consulte o artigo da TechNet, [Atribuições de portas TCP e UDP](http://go.microsoft.com/fwlink/?linkid=21312).
    ...
    **Como desfazer a solução alternativa.**
    ...
    Desbloqueie a porta TCP 8082 no firewall. Para obter mais informações sobre portas, consulte o artigo da TechNet, [Atribuições de portas TCP e UDP](http://go.microsoft.com/fwlink/?linkid=21312).
  
#### Perguntas frequentes sobre a Vulnerabilidade de execução de código de solicitação malformada - CVE-2010-3964
  
**Qual é o escopo da vulnerabilidade?**    
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar esta vulnerabilidade com êxito poderá executar código arbitrário no contexto de segurança de uma conta de convidado no servidor SharePoint afetado.
  
**O que provoca a vulnerabilidade?**    
Esta vulnerabilidade é causada quando o Serviço inicializador de conversões de documentos não valida corretamente as solicitações SOAP especialmente criadas.
  
**O que é o Serviço inicializador de conversões de documentos?**    
O Serviço inicializador de conversões de documentos programa e inicializa as conversões de documentos em um servidor. Quando o Microsoft Office SharePoint Server 2007 transmite uma solicitação de conversão de documento para o serviço, o Serviço inicializador de conversões de documentos chama o conversor apropriado do documento. Na maioria das configurações do farm de servidores, o Serviço inicializador de conversões de documentos e os programas conversores que ele inicia devem estar instalados em um servidor de aplicativos. Cada servidor de aplicativos só pode ter um único Serviço inicializador de conversões de documentos habilitado.
  
Este Serviço é executado na conta HVU\_*ComputerName*. A conta HVU\_*ComputerName* é uma conta de convidado local criada no servidor de aplicativos quando o Serviço inicializador de conversões de documentos está habilitado.
  
**O que é o Serviço do balanceador de carga para conversões de documentos?**    
O Serviço do balanceador de carga para conversões de documentos balanceia as solicitações para conversão de documentos. O Serviço do balanceador de carga para conversões de documentos pode ser configurado em um servidor autônomo ou em um servidor em uma farm. Quando ele recebe uma solicitação de conversor do Microsoft Office SharePoint Server 2007, o Serviço do balanceador de carga para conversões de documentos retorna um URI (Uniform Resource Identifier) apontando para o Serviço inicializador de conversões de documentos adequado. O SharePoint Server 2007 conecta-se ao inicializador especificado por meio de solicitações SOAP e solicita que ele converta o documento especificado.
  
Observe que a desabilitação do Serviço do balanceador de carga para conversões de documentos pára o processo de conversão de documentos e também desabilita o Serviço inicializador de conversões de documentos.
  
**Para que um invasor pode usar a vulnerabilidade?**    
O invasor que explorar esta vulnerabilidade com êxito poderá executar código arbitrário no contexto de segurança de um usuário convidado no servidor de destino.
  
**De que forma o invasor pode explorar a vulnerabilidade?**    
Um invasor pode enviar uma solicitação SOAP especialmente criada ao Serviço inicializador de conversões de documentos em um ambiente do servidor SharePoint que esteja usando o Serviço do balanceador de carga para conversões de documentos. Quando o Serviço do balanceador de carga para conversões de documentos processa a solicitação SOAP especialmente criada, a vulnerabilidade pode permitir a execução remota de código no contexto de segurança de uma conta de convidado no sistema afetado.
  
**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**    
Os ambientes do servidor SharePoint que usam o Serviço do balanceador de carga para conversões de documentos são os que mais correm risco com esta vulnerabilidade. A vulnerabilidade pode permitir a execução remota de código nos servidores que executam o Serviço inicializador de conversões de documentos no ambiente do servidor SharePoint.
  
**O que a atualização faz?**    
Esta atualização elimina a vulnerabilidade modificando a maneira como o Serviço inicializador de conversões de documentos valida as solicitações SOAP especialmente criadas.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2433089">Artigo 2433089 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Oleksandr Mirosh, que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por relatar a Vulnerabilidade de execução de código de solicitação malformada (CVE-2010-3964)
