...
ms:assetid: 'ms11-007'
ms:contentKeyID: 61234344
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-007(v=Security.10)'
---
...
Vulnerabilidade no driver CFF (Compact Font Format) OpenType pode permitir execução remota de código (2485376)
--------------------------------------------------------------------------------------------------------------

Publicado: terça-feira, 8 de fevereiro de 2011 | Atualizado: terça-feira, 9 de julho de 2013
...
A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira como o driver CFF (Compact Font Format) do Windows OpenType valida os valores do parâmetro de fontes OpenType especialmente criadas. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
| Sistema operacional                                                                                                                                                                                                                 | Impacto máximo à segurança | Avaliação de severidade agregada | Boletins substituídos por esta atualização                                |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|----------------------------------|---------------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=f86e9e64-801a-431a-b24e-772011dfa66d)                                                                                                          | Elevação de privilégio     | Importante                       | [MS10-091](http://technet.microsoft.com/pt-br/security/bulletin/ms10-091) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=074396f0-a68c-4190-8dac-0b883d56e3f1)                                                                                 | Elevação de privilégio     | Importante                       | [MS10-091](http://technet.microsoft.com/pt-br/security/bulletin/ms10-091) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a99c2b13-db81-4f18-9cf7-c20614ba0132)                                                                                                 | Elevação de privilégio     | Importante                       | [MS10-091](http://technet.microsoft.com/pt-br/security/bulletin/ms10-091) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aeed45fb-9395-4c2b-a674-e38b04fe0914)                                                                                     | Elevação de privilégio     | Importante                       | [MS10-091](http://technet.microsoft.com/pt-br/security/bulletin/ms10-091) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=bc09e42b-2eed-41b3-a03f-cb8cc94adfee)                                                                      | Elevação de privilégio     | Importante                       | [MS10-091](http://technet.microsoft.com/pt-br/security/bulletin/ms10-091) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d60a2098-7351-4fce-83b2-2c1c3a24faa0)                                                                        | Execução remota de código  | Crítica                          | [MS10-091](http://technet.microsoft.com/pt-br/security/bulletin/ms10-091) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=065ad8fe-1caf-488e-a2e1-96db29f2fa57)                                                | Execução remota de código  | Crítica                          | [MS10-091](http://technet.microsoft.com/pt-br/security/bulletin/ms10-091) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=88ba83b9-c14e-499a-8335-04bac1c49c0c)&#42;                       | Execução remota de código  | Crítica                          | [MS10-091](http://technet.microsoft.com/pt-br/security/bulletin/ms10-091) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c74d7f4-6372-4809-89b8-c79b05e54cdd)&#42;             | Execução remota de código  | Crítica                          | [MS10-091](http://technet.microsoft.com/pt-br/security/bulletin/ms10-091) |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=91d5d34b-9d7e-4e83-89a4-f1aa388dc4e4)       | Execução remota de código  | Crítica                          | [MS10-091](http://technet.microsoft.com/pt-br/security/bulletin/ms10-091) |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1da57fbc-9ea4-4fc4-911d-d5c7825e012c)                                             | Execução remota de código  | Crítica                          | [MS10-091](http://technet.microsoft.com/pt-br/security/bulletin/ms10-091) |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=587adb89-2f6a-4893-9906-b6d6d9ada2bd)                                   | Execução remota de código  | Crítica                          | [MS10-091](http://technet.microsoft.com/pt-br/security/bulletin/ms10-091) |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x-64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=638318ed-4000-4b1a-bb4b-65b795f59784)&#42;      | Execução remota de código  | Crítica                          | [MS10-091](http://technet.microsoft.com/pt-br/security/bulletin/ms10-091) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=4688ea0d-a467-4f24-ac52-104d05c8cae8) | Execução remota de código  | Crítica                          | [MS10-091](http://technet.microsoft.com/pt-br/security/bulletin/ms10-091) |
...
Os clientes da versão de lançamento original do Windows 7 para sistemas de 32 bits, Windows 7 para sistemas x64, Windows Server 2008 R2 para sistemas x64 e Windows Server 2008 R2 para sistemas baseados em Itanium que já aplicaram esta atualização de segurança não devem tomar nenhuma ação. Os clientes que atualizaram esses sistemas operacionais com o Service Pack 1 correspondente devem aplicar esta atualização de segurança.
...
<th style="border:1px solid black;" >Vulnerabilidade de caractere codificado para fonte OpenType - CVE-2011-0033</th>
...
Vulnerabilidade de caractere codificado para fonte OpenType - CVE-2011-0033  
---------------------------------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código na maneira como o driver CFF (Compact Font Format) do Windows OpenType analisa inadequadamente fontes OpenType especialmente criadas. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0033](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0033).
  
#### Fatores atenuantes para a vulnerabilidade de caractere codificado para fonte OpenType - CVE-2011-0033
...
#### Soluções alternativas para a vulnerabilidade de caractere codificado para fonte OpenType - CVE-2011-0033
...
#### Perguntas frequentes sobre a vulnerabilidade de caractere codificado para fonte OpenType - CVE-2011-0033
...
A atualização ellimina a vulnerabilidade, corrigindo a maneira como o driver CFF (Compact Font Format) do Windows OpenType valida os valores do parâmetro de fontes OpenType especialmente criadas.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><strong>Inclusão em Service</strong> <strong>Packs</strong> <strong>futuros</strong></td>
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2485376$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2485376">artigo 2485376 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   V2.0 (8 de março de 2011): Esclarecido que o software afetado inclui o Windows 7 para sistemas Service Pack 1 de 32 bits, Windows 7 para sistemas Service Pack 1 x64, Windows Server 2008 R2 para sistemas Service Pack 1 x64 e Windows Server 2008 R2 para sistemas Service Pack 1 baseados em Itanium. Consulte a entrada à seção **Perguntas frequentes relacionada a essa atualização de segurança**, que explica esta revisão.  
-   V2.1 (9 de julho de 2013): Boletim revisado para anunciar uma alteração de detecção que exclui pacotes de idiomas do Windows 7 da atualização 2485376 para Windows XP Professional x64 Edition Service Pack 2. Essa é apenas uma alteração de detecção. Os clientes que já atualizaram seus sistemas com êxito não precisam fazer mais nada.
