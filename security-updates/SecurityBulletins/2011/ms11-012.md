...
ms:assetid: 'ms11-012'
ms:contentKeyID: 61234349
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-012(v=Security.10)'
---
...
Vulnerabilidades em drivers do modo kernel do Windows podem permitir a elevação de privilégio (2479628)
-------------------------------------------------------------------------------------------------------
...
A atualização elimina as vulnerabilidades, corrigindo a maneira como os drivers no modo kernel do Windows validam a entrada transmitida do modo do usuário. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=56f4f43e-c313-49dc-a278-e3e8a83a907e)                                                                                                          | Elevação de privilégio     | Importante                      | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e80db313-b470-4d71-bc34-70bfbfb6579f)                                                                                 | Elevação de privilégio     | Importante                      | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=54fe2669-8a63-4d96-8b82-5b10f45b293e)                                                                                                 | Elevação de privilégio     | Importante                      | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4632e1ce-6ae8-431c-9104-9a8840e5ac63)                                                                                     | Elevação de privilégio     | Importante                      | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a09c3e6e-c55c-492a-b7ad-3e3d35711643)                                                                      | Elevação de privilégio     | Importante                      | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6fb7ebcc-2052-457b-b5bc-1bbcb17696b9)                                                                        | Elevação de privilégio     | Importante                      | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=88d68757-1ab0-4585-9578-52a474b10882)                                                | Elevação de privilégio     | Importante                      | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=80494972-db45-475f-97cd-dac46b9486a1)&#42;                       | Elevação de privilégio     | Importante                      | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5597d449-17e3-440f-8b0e-56a902a96569)&#42;             | Elevação de privilégio     | Importante                      | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d10eda21-b3c3-4d8e-8596-bc45e4165f93)       | Elevação de privilégio     | Importante                      | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=078fe6c0-1b2c-4896-a345-25cc1b1105e2)                                             | Elevação de privilégio     | Importante                      | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows 7 para sistemas baseados em x-64 e Windows 7 para Sistemas Service Pack 1 baseados em x-64](http://www.microsoft.com/downloads/details.aspx?familyid=b42642b3-fb78-4700-bfe8-bfa997b90c16)                                 | Elevação de privilégio     | Importante                      | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x-64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d2c53f44-12eb-4293-9fa5-2a14075b636e)&#42;      | Elevação de privilégio     | Importante                      | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=8c6bf720-f544-4f58-9b1c-2399957ec43d) | Elevação de privilégio     | Importante                      | [MS10-098](http://technet.microsoft.com/security/bulletin/ms10-098) |
...
**Por que este boletim foi revisado em 18 de março de 2011**  
...
<th style="border:1px solid black;" >Vulnerabilidade de validação imprópria de entrada do usuário do Win32k - CVE-2011-0086</th>
<th style="border:1px solid black;" >Vulnerabilidade de validação de entrada do usuário insuficiente do Win32k - CVE-2011-0087</th>
<th style="border:1px solid black;" >Vulnerabilidade de confusão de ponteiros de classe de janelas do Win32k - CVE-2011-0088</th>
<th style="border:1px solid black;" >Vulnerabilidade de validação de ponteiro imprópria da classe de janelas do Win32k - CVE-2011-0089</th>
<th style="border:1px solid black;" >Vulnerabilidade de corrupção de memória do Win32k - CVE-2011-0090</th>
...
Vulnerabilidade de validação imprópria de entrada do usuário do Win32k - CVE-2011-0086  
--------------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio na maneira que drivers do modo kernel do Windows validam os dados fornecidos de modo de usuário para modo kernel. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0086](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0086).
  
#### Fatores atenuantes da vulnerabilidade de validação imprópria de entrada do usuário do Win32k - CVE-2011-0086
...
#### Soluções alternativas para a vulnerabilidade de validação imprópria de entrada do usuário do Win32k - CVE-2011-0086
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de validação imprópria de entrada do usuário do Win32k - CVE-2011-0086
...
Vulnerabilidade de validação de entrada do usuário insuficiente do Win32k - CVE-2011-0087  
-----------------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio na maneira que drivers do modo kernel do Windows validam os dados fornecidos de modo de usuário para modo kernel. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0087](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0087).
  
#### Fatores atenuantes da vulnerabilidade de validação insuficiente de entrada do usuário do Win32k - CVE-2011-0087
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade de validação insuficiente de entrada do usuário do Win32k - CVE-2011-0087
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de validação insuficiente de entrada do usuário do Win32k - CVE-2011-0087
...
Vulnerabilidade de confusão de ponteiros de classe de janelas do Win32k - CVE-2011-0088  
---------------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio na maneira que drivers do modo kernel do Windows validam os dados fornecidos de modo de usuário para modo kernel. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0088](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0088).
  
#### Fatores atenuantes da vulnerabilidade de confusão de ponteiros de classe de janelas do Win32k - CVE-2011-0088
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade de confusão de ponteiros de classe de janelas do Win32k - CVE-2011-0088
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de confusão de ponteiros de classe de janelas do Win32k - CVE-2011-0088
...
Vulnerabilidade de validação de ponteiro imprópria da classe de janelas do Win32k - CVE-2011-0089  
-------------------------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio na maneira que drivers do modo kernel do Windows validam os dados fornecidos de modo de usuário para modo kernel. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0089](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0089).
  
#### Fatores atenuantes da vulnerabilidade de validação de ponteiro imprópria da classe de janelas do Win32k - CVE-2011-0089
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade de validação de ponteiro imprópria da classe de janelas do Win32k - CVE-2011-0089
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de validação de ponteiro imprópria da classe de janelas do Win32k - CVE-2011-0089
...
Vulnerabilidade de corrupção de memória do Win32k - CVE-2011-0090  
-----------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio na maneira que drivers do modo kernel do Windows validam os dados fornecidos de modo de usuário para modo kernel. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0090](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0090).
  
#### Fatores atenuantes para a vulnerabilidade de corrupção de memória do Win32k - CVE-2011-0090
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a vulnerabilidade de corrupção de memória do Win32k - CVE-2011-0090
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de corrupção de memória do Win32k - CVE-2011-0090
...
Para Windows XP Service Pack 3:WindowsXP-KB2479628-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><br />
Para Windows XP Service Pack 3:WindowsXP-KB2479628-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2479628$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2479628">Artigo 2479628 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Tarjei Mandt, da [Norman](http://www.norman.com), por relatar a Vulnerabilidade de validação imprópria de entrada de usuário do Win32k (CVE-2011-0086)  
-   Tarjei Mandt, da [Norman](http://www.norman.com), por relatar a Vulnerabilidade de validação insuficiente de entrada de usuário do Win32k (CVE-2011-0087)  
-   Tarjei Mandt, da [Norman](http://www.norman.com), por relatar a Vulnerabilidade de confusão do ponteiro da classe de ponteiros do Win32k (CVE-2011-0088)  
-   Tarjei Mandt, da [Norman](http://www.norman.com), por relatar a Vulnerabilidade de validação imprópria da classe de janelas do Win32k (CVE-2011-0089)  
-   Tarjei Mandt, da [Norman](http://www.norman.com), por relatar a Vulnerabilidade de corrupção de memória do Win32k (CVE-2011-0090)
...
-   V2.0 (18 de março de 2011) : Esclarecido que o software afetado inclui o Windows 7 para sistemas Service Pack 1 de 32 bits, Windows 7 para sistemas Service Pack 1 de 64 bits, Windows Server 2008 R2 para sistemas Service Pack 1 de 64 bits e Windows Server 2008 R2 para sistemas Service Pack 1 baseados em Itanium. Consulte a entrada à seção **Perguntas frequentes** relacionada a essa atualização de segurança, que explica esta revisão.
