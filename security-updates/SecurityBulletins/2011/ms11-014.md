...
ms:assetid: 'ms11-014'
ms:contentKeyID: 61234354
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-014(v=Security.10)'
---
...
Vulnerabilidade no LSASS (Local Security Authority Subsystem Service) pode permitir a elevação de privilégio (2478960)
----------------------------------------------------------------------------------------------------------------------

Publicado: terça-feira, 8 de fevereiro de 2011 | Atualizado: quinta-feira, 28 de abril de 2011
...
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular no LSASS (Local Security Authority Subsystem Service) no Windows XP e Windows Server 2003. Esta atualização de segurança é classificada como Importante para todas as edições com suporte desses sistemas operacionais. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A vulnerabilidade pode permitir elevação de privilégio se um invasor fizer logon em um sistema e executar um aplicativo especialmente criado. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.

A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira como o LSASS manipula valores específicos usados no processo de autenticação. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Problemas conhecidos.** O [Artigo 2478960 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2478960) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=541f228f-79b3-402a-8ff9-366c1e595227)                                     | Elevação de privilégio     | Importante                      | Nenhuma                                                             |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=82189bf2-3f34-4949-92da-eea98036d18e)            | Elevação de privilégio     | Importante                      | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e31e6b1-577e-468e-9c94-67227d2273c2)                            | Elevação de privilégio     | Importante                      | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=76e3c229-d812-433c-ad05-7cbd1f9c6a6d)                | Elevação de privilégio     | Importante                      | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a0cde8d8-7c85-4fcb-bcf7-205064970b41) | Elevação de privilégio     | Importante                      | [MS08-002](http://technet.microsoft.com/security/bulletin/ms08-002) |
...
<th style="border:1px solid black;" >Vulnerabilidade de validação de comprimento de LSASS - CVE-2011-0039</th>
...
Vulnerabilidade de validação de comprimento de LSASS - CVE-2011-0039  
--------------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio na maneira que o LSASS (Local Security Authority Subsystem Service) do Microsoft Windows processa as solicitações de autenticação especialmente criadas. A vulnerabilidade pode permitir que um invasor execute código com privilégios elevados. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0039](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0039).
  
#### Fatores atenuantes para a vulnerabilidade de validação de comprimento de LSASS - CVE-2011-0039
...
#### Soluções alternativas para a vulnerabilidade de validação de comprimento de LSASS - CVE-2011-0039
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de validação de comprimento de LSASS - CVE-2011-0039
...
A vulnerabilidade é causada quando o LSASS do Windows processa uma solicitação de autenticação especialmente criada.
...
A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira como o LSASS manipula valores específicos usados no processo de autenticação.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2478960$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2478960">Artigo 2478960 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   O verificador de segurança Jorge Moura da Primavera BSS por relatar a vulnerabilidade de validação de comprimento de LSASS (CVE-2011-0039)
...
-   V1.1 (28 de abril de 2011): Um link para o Artigo 2478960 (em inglês) da Microsoft Knowledge Base foi adicionado à seção Problemas conhecidos, na Sinopse.
