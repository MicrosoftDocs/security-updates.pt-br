...
ms:assetid: 'ms11-038'
ms:contentKeyID: 61234383
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-038(v=Security.10)'
---
...
Vulnerabilidade na automação OLE pode permitir a execução remota de código (2476490)
------------------------------------------------------------------------------------
...
Esta atualização de segurança resolve uma vulnerabilidade reportada em particular no Microsoft Windows Object Linking and Embedding (OLE) Automation. A vulnerabilidade pode permitir execução remota de código se um usuário visitar um site contendo uma imagem do Windows Metafile (WMF) especialmente criado. Não há como o invasor forçar os usuários a visitarem o site mal-intencionado. Em vez disso, o invasor teria que convencer os usuários a visitar o site, geralmente fazendo com que eles cliquem em um link em um email ou mensagem do Instant Messenger que leva o usuário ao site do invasor.
...
A atualização de segurança elimina a vulnerabilidade corrigindo a maneira como a automação OLE analisa arquivos WMF. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=2371079f-fb20-4fd5-999e-e73f3701818c)                                                                                                          | Execução Remota de Código  | Crítica                         | Nenhuma                                                   |
...
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=c194dd35-b9db-44a5-a252-38f9f803802f)                                                                      | Execução Remota de Código  | Crítica                         | [MS08-008](http://go.microsoft.com/fwlink/?linkid=108277) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f33c9e54-c2e5-498d-a798-5bbfe9e4249c)                                                                        | Execução Remota de Código  | Crítica                         | Nenhuma                                                   |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4566528f-62ee-4d78-b3af-131a7cc15e1f)                                                | Execução Remota de Código  | Crítica                         | Nenhuma                                                   |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0c9614d9-6f61-463d-b1fa-bd5eb2c1a5c5)&#42;&#42;                     | Execução Remota de Código  | Crítica                         | Nenhuma                                                   |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=36698775-0e4e-4980-ae4c-43542de424ca)&#42;&#42;           | Execução Remota de Código  | Crítica                         | Nenhuma                                                   |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3edb613f-5bf0-4e28-9835-4afbb6ef0e01)       | Execução Remota de Código  | Crítica                         | Nenhuma                                                   |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=50ae36ff-2406-48a4-97cc-12782b6d30ac)                                             | Execução Remota de Código  | Crítica                         | Nenhuma                                                   |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para Sistemas Service Pack 1 baseados em x-64](http://www.microsoft.com/downloads/details.aspx?familyid=1241f0f8-a5c7-420a-a5b7-b6c3caa9e5e2)                                  | Execução Remota de Código  | Crítica                         | Nenhuma                                                   |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x-64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=8181c359-cd79-438a-87be-093b363d0b04)&#42;&#42;    | Execução Remota de Código  | Crítica                         | Nenhuma                                                   |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=6b63a1eb-445a-4cd3-b357-9a1dd82d7a35) | Execução Remota de Código  | Crítica                         | Nenhuma                                                   |
...
<th style="border:1px solid black;" >Vulnerabilidade de subfluxo da automação OLE - CVE-2011-0658</th>
...
Vulnerabilidade de subfluxo da automação OLE - CVE-2011-0658  
------------------------------------------------------------
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0658](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0658).
  
#### Fatores atenuantes da vulnerabilidade de subfluxo da automação OLE - CVE-2011-0658
...
#### Soluções alternativas para a vulnerabilidade de subfluxo da automação OLE - CVE-2011-0658
  
A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:
  
-   **Restrinja o acesso ao arquivo VBScript.dll**
  
    Para restringir acesso ao VBScript.DLL, execute o seguinte comando de um prompt de comando:
  
    No caso do Windows XP (para sistemas de 32 bits):
  
    `cacls %windir%\system32\vbscript.dll /E /P everyone:N`
  
    No caso do Windows XP (para sistemas de 64 bits):
  
    `cacls %windir%\syswow64\vbscript.dll /E /P everyone:N`
  
    Para Windows Vista e sistemas mais novos (32 bits) :
    ...
    Para Windows Vista e sistemas mais novos (64 bits) :
    ...
    **Impacto da solução alternativa.** As páginas da Web e outros aplicativos que requerem VBScript não podem ser adequadamente exibidos.
  
    **Como desfazer a solução alternativa.**
  
    Para desfazer a solução alternativa, digite o seguinte comando em um prompt de comando:
...
#### Perguntas frequentes sobre a vulnerabilidade de subfluxo da automação OLE - CVE-2011-0658
...
A vulnerabilidade é causada pela forma como a Automação OLE analisa um arquivo WMF especialmente criado.
...
O formato de imagem WMF é um formato de metarquivo de 16 bits que pode conter informações sobre vetores e bitmap. É otimizado para o sistema operacional Windows.
...
Esta atualização de segurança elimina a vulnerabilidade corrigindo a maneira como a automação OLE analisa arquivos WMF.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong>, no Painel de Controle, ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2476490$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2476490">Artigo 2476490 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Yamata Li, da [Palo Alto Networks](http://www.paloaltonetworks.com/), por relatar a vulnerabilidade de subfluxo de automação OLE (CVE-2011-0658)
