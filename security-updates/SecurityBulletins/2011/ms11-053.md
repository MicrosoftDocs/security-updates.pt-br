...
ms:assetid: 'ms11-053'
ms:contentKeyID: 61234398
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-053(v=Security.10)'
---
...
Vulnerabilidade na pilha de Bluetooth pode permitir a execução remota de código (2566220)
-----------------------------------------------------------------------------------------
...
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular na pilha de Bluetooth do Windows. A vulnerabilidade pode permitir a execução remota de código se um invasor enviar pacotes de Bluetooth especialmente criados para um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Esta vulnerabilidade afeta somente sistemas com recurso de Bluetooth

Esta é uma atualização de segurança classificada como Crítica para todas as edições do Windows Vista e do Windows Server 7 com suporte. Para obter mais informações, consulte a subseção **Software afetado e não afetado**, nesta seção.

A atualização de segurança elimina a vulnerabilidade modificando a maneira como a Pilha de Bluetooth do Windows manipula objetos na memória. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Problemas conhecidos.** O [Artigo 2566220 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2566220) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=90b2da71-18f9-46ee-9e3d-b08620ca06aa">Windows 7 para sistemas baseados em x-64 e Windows 7 para Sistemas Service Pack 1 baseados em x-64</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Crítica</td>
<td style="border:1px solid black;">Nenhuma</td>
...
<sup>[1]</sup>O Windows Vista Service Pack 1 só será afetado quando o Pacote opcional de recursos do Windows Vista para conexão sem fio tiver sido instalado. Consulte as Perguntas frequentes de atualização para obter detalhes.
...
**Executo o Windows Vista Service Pack 1.Meu sistema é afetado por esta vulnerabilidade?**    
O Windows Vista Service Pack 1 somente só é afetado em sistemas com suporte para a tecnologia Bluetooth 2.1. Os clientes do Windows Vista Service Pack 1 que instalaram o [Pacote de recursos do Windows Vista para conexão sem fio](http://support.microsoft.com/kb/942567) terão suporte para a tecnologia Bluetooth 2.1 e, portanto, serão afetados por esta vulnerabilidade. Esses clientes precisarão instalar a atualização de segurança KB2561109. Aqueles que não instalaram o Pacote de recursos do Windows Vista para conexão sem fio terão suporte para a tecnologia Bluetooth 2.1 e, portanto, serão afetados por esta vulnerabilidade. Para obter mais informações, consulte o [Artigo 2566220 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2566220).
  
I**nstalei o Pacote de recursos do Windows Vista para conexão sem fio para Windows Vista Service Pack 1, mas atualizei para o Windows Vista Service Pack 2. Quais atualizações eu preciso instalar?**    
Os clientes do Windows Vista Service Pack 1 que instalaram o [Pacote de recursos do Windows Vista para conexão sem fio](http://support.microsoft.com/kb/942567)para Windows Vista Service Pack 1 e que atualizaram com êxito para Windows Vista Service Pack 2 deverão instalar a atualização de segurança KB2532531. Para obter mais informações, consulte [artigo 2566220 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2566220).
...
<th style="border:1px solid black;" >Vulnerabilidade de pilha de Bluetooth - CVE-2011-1265</th>
<th style="border:1px solid black;" >Avaliação de gravidade agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de pilha de Bluetooth - CVE-2011-1265  
-----------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código na pilha do Windows Bluetooth 2.1 devido à maneira que um objeto em memória é acessado quando não foi inicializado corretamente ou foi excluído. Um invasor pode explorar a vulnerabilidade, construindo uma série de pacotes de Bluetooth especialmente criados e enviando-os à máquina de destino. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1265](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1265).
  
#### Fatores atenuantes da Vulnerabilidade de pilha de Bluetooth - CVE-2011-1265
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Esta vulnerabilidade afeta somente sistemas com recurso de Bluetooth instalado.
  
#### Soluções alternativas para a Vulnerabilidade de pilha de Bluetooth - CVE-2011-1265
  
A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:
  
-   **Interrompa e desabilite o driver do Bluetooth**
  
    Você também pode interromper e desabilitar o driver usando o seguinte comando no prompt de comando:
  
    `sc config bthport start= disabled`
  
    **Como desfazer a solução alternativa.**
  
    Você também pode habilitar novamente o driver de Bluetooth usando o seguinte comando no prompt de comando:
  
    `sc config bthport start= demand`
  
#### Perguntas frequentes sobre a Vulnerabilidade de pilha de Bluetooth - CVE-2011-1265
  
**Qual é o escopo da vulnerabilidade?**    
Essa é uma vulnerabilidade de execução remota de código.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada pela maneira como a Pilha de Bluetooth do Windows acessa a memória que não foi inicializada corretamente ou foi excluída.
  
**O que é Bluetooth?**    
Bluetooth é um protocolo padrão do setor que possibilita a conectividade sem fio entre computadores, dispositivos de mão, telefones celulares, entre outros dispositivos. Consulte o artigo do MSDN, [Bluetooth](http://msdn.microsoft.com/en-us/library/aa362932(vs.85).aspx), para obter mais informações.
...
Para explorar esta vulnerabilidade, o invasor deve estar na mesma proximidade que a máquina de destino para enviar e receber transmissões de rádio dentro do espectro de rádio do Bluetooth. Um invasor pode explorar a vulnerabilidade, construindo uma série de pacotes de Bluetooth especialmente criados e enviando-os à máquina de destino.
  
**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**    
Estações de trabalho são as que mais correm risco com essa vulnerabilidade.
  
**Minha estação de trabalho com Windows Vista ou Windows 7 não tem a tecnologia Bluetooth. Sou afetado?**    
Sim. O Windows Vista e Windows 7 oferecem suporte a uma gama de dispositivos de rádio de Bluetooth e instalarão o driver de Bluetooth quando um dispositivo removível de Bluetooth for adicionado ao sistema. Como resultado, todas as versões com suporte do Windows Vista e Windows 7 são afetadas. Para obter mais informações, consultem o artigo de MSDN, [Bluetooth Wireless Technology FAQ - 2010 (em inglês)](http://msdn.microsoft.com/en-us/windows/hardware/gg487349,aspx).
  
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade modificando a maneira como a Pilha de Bluetooth 2.1 do Windows manipula objetos na memória.
...
<td style="border:1px solid black;">Para edições de 32 bits do Windows Vista Service Pack 1 com Pacote de recursos do Windows Vista para conexão sem fio habilitado:<br />
Windows6.0-KB2561109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas as edições de 32 bits com suporte do Windows Vista Service Pack 2:<br />
Windows6.0-KB2532531-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para edições baseadas em x64 do Windows Vista Service Pack 1 com Pacote de recursos do Windows Vista para conexão sem fio habilitado:<br />
Windows6.0-KB2561109-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas as edições baseadas em x64 com suporte do Windows Vista Service Pack 2:<br />
...
<td style="border:1px solid black;">Para o Windows Vista Service Pack 1 com Pacote de recursos do Windows Vista para conexão sem fio habilitado:<br />
Consulte o <a href="http://support.microsoft.com/kb/2561109">Artigo 2561109 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Windows Vista Service Pack 2:<br />
Consulte o <a href="http://support.microsoft.com/kb/2532531">Artigo 2532531 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2532531">Artigo 2532531 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
<td style="border:1px solid black;"><strong>Observação</strong> Não existe uma chave do Registro para validar a presença dessa atualização.</td>
