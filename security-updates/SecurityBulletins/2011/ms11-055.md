...
ms:assetid: 'ms11-055'
ms:contentKeyID: 61234400
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-055(v=Security.10)'
---
...
Vulnerabilidade no Microsoft Visio pode permitir a execução remota de código (2560847)
--------------------------------------------------------------------------------------
...
Esta atualização de segurança é classificada como importante para o Microsoft Visio 2003 Service Pack 3. Para obter mais informações, consulte a subseção **Software afetado e não afetado**, nesta seção.

A atualização de segurança aborda a vulnerabilidade corrigindo a maneira como o Microsoft Visio carrega bibliotecas externas. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Tenho uma versão não vulnerável do Microsoft Office 2003 instalado. Por que eu estou recebendo a oferta desta atualização?**    
Embora o vetor de ataque para explorar a vulnerabilidade descrita em CVE-2010-3148 seja por intermédio do Microsoft Visio 2003, o código vulnerável existe em um componente compartilhado do Microsoft Office. Algum software não afetado, como os programas autônomos do Microsoft Office 2003 Suite e do Microsoft Office 2003, contém o componente compartilhado vulnerável do Microsoft Office, mas como eles não acessam o código vulnerável, não são afetados por esta vulnerabilidade. No entanto, uma vez que o código vulnerável está presente, esta atualização será oferecida.
...
Sim, a Vulnerabilidade de carregamento não seguro de bibliotecas do Microsoft Visio (CVE-2010-3148) eliminada por esta atualização está relacionada à classe de vulnerabilidades, descrita no [Comunicado de Segurança da Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637), que afeta como os aplicativos carregam as bibliotecas externas. Esta atualização de segurança elimina uma instância em particular deste tipo de vulnerabilidade.
...
<th style="border:1px solid black;" >Vulnerabilidade de carregamento não seguro de bibliotecas do Microsoft Visio - CVE-2010-3148</th>
<th style="border:1px solid black;" >Avaliação de gravidade agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de carregamento não seguro de bibliotecas do Microsoft Visio - CVE-2010-3148  
--------------------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Visio manipula o carregamento de arquivos DLL. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3148](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3148).
  
#### Fatores atenuantes da vulnerabilidade de carregamento não seguro de biblioteca do Microsoft Visio - CVE-2010-3148
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Para que um ataque seja bem-sucedido, o usuário deve visitar um local de sistema de arquivos remoto não confiável ou compartilhamento de WebDAV e abrir um arquivo relacionado ao Office (como, por exemplo, um arquivo .vsd, vdx. vst ou vtx).  
...
#### Soluções alternativas para a vulnerabilidade de carregamento não seguro de biblioteca do Microsoft Visio - CVE-2010-3148
...
#### Perguntas frequentes para a vulnerabilidade de carregamento não seguro de biblioteca do Microsoft Visio - CVE-2010-3148
...
A vulnerabilidade é causada quando o componente Microsoft Visio restringe incorretamente o caminho usado para o carregamento de bibliotecas externas.
...
Um invasor pode convencer um usuário a abrir um arquivo legítimo do Visio (como um arquivo .vsd, .vdx, .vst ou .vtx) localizado no mesmo diretório de rede que um arquivo .DLL especialmente criado. Em seguida, ao abrir o arquivo legítimo, o Microsoft Visio pode tentar carregar o arquivo .DLL e executar o código contido nele.
  
Em um cenário de ataque por email, um invasor pode explorar a vulnerabilidade enviando um anexo de arquivo do Visio (como um arquivo .vsd, .vdx ou .vtx) a um usuário e convencendo o usuário a colocar o anexo em um diretório contendo um arquivo .DLL especialmente criado e a abrir o arquivo legítimo. Em seguida, ao abrir o arquivo legítimo, o Microsoft Visio pode tentar carregar o arquivo .DLL e executar o código contido nele.
  
Em um cenário de ataque à rede, um invasor pode colocar um arquivo legítimo do Visio e um arquivo DLL especialmente criado em uma rede compartilhada, em um UNC ou em um local WebDAV, e então convencer o usuário a abrir o arquivo.
...
A atualização elimina a vulnerabilidade, corrigindo a maneira como o Microsoft Visio carrega as bibliotecas externas.
...
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2010-3148](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3148) da lista Common Vulnerability and Exposure.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2493523">Artigo 2493523 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
