...
ms:assetid: 'ms11-081'
ms:contentKeyID: 61234426
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-081(v=Security.10)'
---
...
Atualização de segurança cumulativa para o Internet Explorer (2586448)
----------------------------------------------------------------------

Publicado: terça-feira, 11 de outubro de 2011 | Atualizado: quarta-feira, 2 de novembro de 2011
...
Esta atualização de segurança é classificada como Crítica para o Internet Explorer em clientes Windows e como Moderada para o Internet Explorer em servidores Windows. Para obter mais informações, consulte a subseção **Softwares afetados e não** **afetados**, nesta seção.

A atualização elimina as vulnerabilidades, modificando a maneira como o Internet Explorer controle objetos na memória, aloca e acessa a memória. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Por que este boletim foi revisado em 2 de novembro de 2011?**  
A Microsoft revisou este boletim para anunciar o lançamento de um hotfix para resolver um problema que afeta clientes do Internet Explorer 7, em que algumas listas suspensas e caixas de combinação não aparecem no Internet Explorer 7 depois de instalar a atualização de segurança KB2586448. Para obter mais informações sobre este problema e para obter instruções sobre como aplicar o hotfix e resolver o problema, consulte o [Artigo 2586448 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2586448).
...
Sim. Além das alterações que estão listadas na seção Informação de Vulnerabilidade deste boletim, esta atualização inclui atualizaçções de proteção abrangente para ajudar a aprimorar a proteção da memória, o gerenciamento de frames e cookies, a API do Bing e o Filtro XSS no Internet Explorer.
...
As classificações de gravidade a seguir pressupõem o impacto máximo possível da vulnerabilidade. Para obter informações referentes à probabilidade de exploração da vulnerabilidade em relação à sua classificação de gravidade e ao impacto à segurança, em até 30 dias a partir do lançamento deste boletim de segurança, consulte o Índice de exploração no [resumo de boletins de outubro](http://technet.microsoft.com/security/bulletin/ms11-oct). Para obter mais informações, consulte o [Índice de exploração da Microsoft](http://technet.microsoft.com/en-us/security/cc998259.aspx).
...
<th style="border:1px solid black;" >
Vulnerabilidade de execução remota de código do evento de rolagem - CVE-2011-1993
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de execução remota de código do OLEAuto32.dll - CVE-2011-1995
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de execução remota de código do elemento de opção - CVE-2011-1996
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de execução remota de código do evento OnLoad - CVE-2011-1997
</th>
</tr>
<tr>
<th colspan="6">
...
<th style="border:1px solid black;" >
Vulnerabilidade de execução remota de código do Jscript9.dll - CVE-2011-1998
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de execução remota de código do elemento de seleção - CVE-2011-1999
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de execução remota de código do elemento de corpo - CVE-2011-2000
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de execução remota de código de corrompimento de tabela de função virtual - CVE-2011-2001
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Internet Explorer acessa um objeto que foi excluído. A vulnerabilidade pode corromper memória de forma que um invasor possa executar código arbitrário no contexto do usuário de logon.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1993](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1993).

#### Fatores atenuantes da vulnerabilidade de execução remota de código do evento de rolagem - CVE-2011-1993
...
#### Soluções alternativas para a vulnerabilidade de execução remota de código do evento de rolagem - CVE-2011-1993
...
#### Perguntas frequentes sobre a vulnerabilidade de execução remota de código do evento de rolagem - CVE-2011-1993
...
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer acessa um objeto que não foi iniciado corretamente. A vulnerabilidade pode corromper memória de forma que um invasor possa executar código arbitrário no contexto do usuário de logon.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1995](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1995).

#### Fatores atenuantes da vulnerabilidade de execução remota de código do OLEAuto32.dll - CVE-2011-1995
...
#### Soluções alternativas para a vulnerabilidade de execução remota de código do OLEAuto32.dll - CVE-2011-1995
...
#### Perguntas frequentes sobre a vulnerabilidade de execução remota de código do OLEAuto32.dll - CVE-2011-1995

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito a vulnerabilidade poderá obter os mesmos direitos que o usuário conectado. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

**O que provoca a vulnerabilidade?**  
Quando o Internet Explorer tenta acessar um objeto que não foi iniciado, a memória pode ser corrompida de tal maneira que um invasor pode executar código arbitrário no contexto do usuário conectado.
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1996](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1996).

#### Fatores atenuantes da vulnerabilidade de execução remota de código do elemento de opção - CVE-2011-1996
...
#### Soluções alternativas para a vulnerabilidade de execução remota de código do elemento de opção - CVE-2011-1996
...
#### Perguntas frequentes sobre a vulnerabilidade de execução remota de código do elemento de opção - CVE-2011-1996
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1997](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1997).

#### Fatores atenuantes da vulnerabilidade de execução remota de código do evento OnLoad - CVE-2011-1997
...
#### Soluções alternativas para a vulnerabilidade de execução remota de código do evento OnLoad - CVE-2011-1997
...
#### Perguntas frequentes sobre a vulnerabilidade de execução remota de código do evento OnLoad - CVE-2011-1997
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1998](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1998).

#### Fatores atenuantes da vulnerabilidade de execução remota de código do Jscript9.dll - CVE-2011-1998
...
#### Soluções alternativas para a vulnerabilidade de execução remota de código do Jscript9.dll - CVE-2011-1998
...
#### Perguntas frequentes sobre a vulnerabilidade de execução remota de código do Jscript9.dll - CVE-2011-1998
...
**De que forma o invasor pode explorar a vulnerabilidade?**  
O invasor pode hospedar um site especialmente criado para explorar esta vulnerabilidade através do Internet Explorer e, então, convencer um usuário a exibir o site realizando operações nele. O invasor também pode tirar proveito dos sites comprometidos e de sites que aceitam ou hospedam o conteúdo fornecido pelo usuário ou anúncios. Esses sites podem ter conteúdo especialmente criado para explorar essa vulnerabilidade. Em todos os casos, entretanto, o invasor não tem como forçar os usuários a exibir o conteúdo controlado pelo invasor. Em vez disso, o invasor precisa convencer os usuários a executar uma ação, normalmente clicando em um link em uma mensagem de email ou em uma mensagem do Instant Messenger que leve os usuários ao site do invasor ou abrindo um anexo enviado por email.
...
Existe uma vulnerabilidade de execução remota de código na forma como o Internet Explorer acessa um endereço de memória desreferenciado. A vulnerabilidade pode corromper memória de forma que um invasor possa executar código arbitrário no contexto do usuário de logon.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1999](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1999).

#### Fatores atenuantes da vulnerabilidade de execução remota de código do elemento de seleção - CVE-2011-1999
...
#### Soluções alternativas para a vulnerabilidade de execução remota de código do elemento de seleção - CVE-2011-1999
...
#### Perguntas frequentes sobre a vulnerabilidade de execução remota de código do elemento de seleção - CVE-2011-1999

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito a vulnerabilidade poderá obter os mesmos direitos que o usuário conectado. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

**O que provoca a vulnerabilidade?**  
Quando o Internet Explorer tenta acessar um endereço de memória desreferenciado, a memória pode ser corrompida de tal maneira que um invasor pode executar código arbitrário no contexto do usuário conectado.
...
**O que a atualização faz?**  
A atualização elimina a vulnerabilidade modificando a maneira como o Internet Explorer aloca e acessa a memória.
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-2000](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2000).

#### Fatores atenuantes da vulnerabilidade de execução remota de código do elemento de corpo - CVE-2011-2000
...
#### Soluções alternativas para a vulnerabilidade de execução remota de código do elemento de corpo - CVE-2011-2000
...
#### Perguntas frequentes sobre a vulnerabilidade de execução remota de código do elemento de corpo - CVE-2011-2000
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Internet Explorer acessa uma tabela de função virtual depois de ela ter sido corrompida. A vulnerabilidade pode corromper memória de forma que um invasor possa executar código arbitrário no contexto do usuário de logon.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-2001](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2001).

#### Fatores atenuantes da vulnerabilidade de execução remota de código de corrompimento de tabela de função virtual - CVE-2011-2001
...
#### Soluções alternativas para a vulnerabilidade de execução remota de código de corrompimento de tabela de função virtual - CVE-2011-2001
...
#### Perguntas frequentes sobre a vulnerabilidade de execução remota de código de corrompimento de tabela de função virtual - CVE-2011-2001

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito a vulnerabilidade poderá obter os mesmos direitos que o usuário conectado. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

**O que provoca a vulnerabilidade?**  
Quando o Internet Explorer tenta acessar uma tabela de função virtual corrompida, pode permitir que um invasor execute código arbitrário no contexto do usuário conectado.
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições do Windows XP com suporte:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\ie7updates\KB2586448-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições com suporte do Windows XP:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\ie8updates\KB2586448-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2586448">Artigo 2586448 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 para todas as edições do Windows Server 2003 de 32 bits, edições baseadas em x64 e edições baseadas no Itanium para as quais existe suporte:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2586448$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições do Windows Server 2003 de 32 bits, edições baseadas em x64 e edições baseadas no Itanium para as quais existe suporte:<br />
...
-   Vishwas Sharma, da McAfee Labs, por relatar a Vulnerabilidade de execução remota de código do evento de rolagem (CVE-2011-1993)  
-   David Bloom, da [Greplin](https://www.greplin.com), por relatar a vulnerabilidade de execução remota de código do OLEAuto32.dll (CVE-2011-1995)  
-   Ivan Fratric, que trabalha na [TippingPoint's](http://www.tippingpoint.com)[Zero Day Initiative](http://www.zerodayinitiative.com), por relatar a vulnerabilidade de execução remota de código do elemento de opção (CVE-2011-1996)  
-   [GWSlabs](http://www.gwslabs.com)  
-   , que trabalha no  
-   [VeriSign iDefense Labs](http://labs.idefense.com)  
-   , por relatar a vulnerabilidade de execução remota de código do evento OnLoad (CVE-2011-1997)  
-   David Bloom, da [Greplin](https://www.greplin.com), por relatar a vulnerabilidade de execução remota de código do Jscript9.dll (CVE-2011-1998)  
-   Ivan Fratric, que trabalha na [TippingPoint's](http://www.tippingpoint.com)[Zero Day Initiative](http://www.zerodayinitiative.com), por relatar a vulnerabilidade de execução remota de código do elemento de seleção (CVE-2011-1999)  
-   Sebastian Apelt, que trabalha na [TippingPoint's](http://www.tippingpoint.com)[Zero Day Initiative](http://www.zerodayinitiative.com), por relatar a vulnerabilidade de execução remota de código do elemento de corpo (CVE-2011-2000)  
-   Um pesquisador anônimo, que trabalha com a [TippingPoint's](http://www.tippingpoint.com)[Zero Day Initiative](http://www.zerodayinitiative.com), por relatar a vulnerabilidade de execução remota de código de corrompimento de tabela de função virtual (CVE-2011-2001)  
-   Eduardo Vela Nava, da [Google Inc.](http://www.google.com), e David Bloom, da [Greplin](https://www.greplin.com), por trabalhar conosco nas alterações de proteção abrangente incluídas neste boletim  
-   [Soroush Dalili](http://www.secproject.com)  
-   , por trabalhar conosco em alterações de defesa abrangentes incluídas neste boletim  
-   Billy Rios, da [Google Inc.](http://www.google.com), por trabalhar conosco em alterações de defesa abrangentes incluídas neste boletim
...
-   V1.1 (12 de outubro de 2011): Um link para o Artigo 2586448 (em inglês) da Microsoft Knowledge Base foi adicionado à seção Problemas conhecidos na Sinopse.  
-   V1.2 (2 de novembro de 2011): Anunciado o lançamento de um hotfix para resolver um problema conhecido por afetar clientes do Internet Explorer 7 depois que a atualização de segurança KB2586448 é instalada. Consulte as Perguntas frequentes de atualização para obter detalhes.
