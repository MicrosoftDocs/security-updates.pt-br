...
ms:assetid: 'ms11-006'
ms:contentKeyID: 61234256
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-006(v=Security.10)'
---
...
Vulnerabilidade no processamento de gráficos de Windows Shell pode permitir a execução remota de código (2483185)
-----------------------------------------------------------------------------------------------------------------
...
Esta atualização de segurança é classificada como Crítica para todas as edições com suporte do Windows XP, Windows Server 2003, Windows Vista e Windows Server 2008. As edições com suporte do Windows 7 e Windows Server 2008 R2 não são afetadas pela vulnerabilidade. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira como o processador gráfico do Windows Shell analisa imagens em miniatura. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.

Esta atualização de segurança também elimina a vulnerabilidade descrita pela primeira vez no [Comunicado de Segurança da Microsoft 2490606](http://technet.microsoft.com/security/advisory/2490606).
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=bbea7ead-6c5c-4da8-aa03-a40325fd2de3)                                                                                                    | Execução Remota de Código  | Crítica                         | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=bcb7217e-624a-4d61-86a1-f2440a1afd57)                                                                           | Execução Remota de Código  | Crítica                         | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2aa94528-5063-427b-97f7-2a0a55cbb6bf)                                                                                           | Execução Remota de Código  | Crítica                         | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6e740922-6ce4-46ec-a35e-e94201a9e398)                                                                               | Execução Remota de Código  | Crítica                         | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a4f9ec46-35b2-44c9-abf6-647f7a474b99)                                                                | Execução Remota de Código  | Crítica                         | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0c18ecca-afb9-4738-bc7b-76a0e815dfb8)                                                                  | Execução Remota de Código  | Crítica                         | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=62dc454f-4b1e-4ac0-8ffe-6c73112f8d4d)                                          | Execução Remota de Código  | Crítica                         | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=253c47a0-69ac-437a-ad3e-778c37fa37cb)&#42;&#42;               | Execução Remota de Código  | Crítica                         | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ec7101aa-96c2-4931-a3e4-0c55cbc74d9c)&#42;&#42;     | Execução Remota de Código  | Crítica                         | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e62493cb-8d25-4975-bbe6-a368e039872b) | Execução Remota de Código  | Crítica                         | [MS10-046](http://technet.microsoft.com/security/bulletin/ms10-046) |
...
<th style="border:1px solid black;" >Vulnerabilidade de saturação de processamento gráfico do Windows Shell - CVE-2010-3970</th>
...
Vulnerabilidade de saturação de processamento gráfico do Windows Shell - CVE-2010-3970  
--------------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código na maneira como o processador gráfico do Windows Shell manipula as imagens em miniatura especialmente criadas. O invasor que explorar esta vulnerabilidade com êxito poderá executar código arbitrário no contexto de segurança do usuário conectado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3970](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970).
  
#### Fatores atenuantes da vulnerabilidade de saturação de processamento gráfico do Windows Shell - CVE-2010-3970
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   A vulnerabilidade não pode ser explorada automaticamente por email.  
...
#### Soluções alternativas para a vulnerabilidade de saturação de processamento gráfico do Windows Shell - CVE-2010-3970
  
A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:
  
-   **Modificar Lista de Controle de Acesso (ACL) em shimgvw.DLL em sistemas Windows XP e Windows Server 2003**
  
    **Observação** Consulte o [Artigo 2483185 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2483185) para usar a solução automatizada **Microsoft Fix it** para habilitar ou desabilitar esta solução alternativa.
  
    Para modificar a ACL em shimgvw.dll para ser mais restritiva, execute os seguintes comandos em um prompt de comando com privilégios administrativos:
    ...
    **Impacto da solução alternativa:** Arquivos de mídia geralmente manipulados pelo processador gráfico do Windows Shell não serão exibidos adequadamente.
...
-   **Desabilitar visualização de miniaturas no Windows Explorer do Windows Vista e sistemas Windows Server 2008**
  
    Para desabilitar a visualização de miniaturas no Windows Explorer do Windows Vista e sistemas Windows Server 2008, execute as seguintes etapas:
  
    1.  Abra **Painel de Controle** e selecione **Aparência e Personalização**.  
    2.  Selecione **Opções de pasta** do menu.  
    3.  Selecione a guia **Modo de exibição** e garanta que a opção **Sempre mostrar ícones, nunca miniaturas** esteja selecionada. Clique em **OK** para salvar as configurações.  
    4.  Feche todas as instâncias abertas do Windows Explorer para que a alteração entre em vigor.
  
    **Impacto da solução alternativa:** O Windows Explorer não exibirá imagens em miniatura.
  
    **Como desfazer a solução alternativa:**
  
    Para habilitar as miniaturas no Windows Vista e Windows Server 2008, execute as seguintes etapas:
  
    1.  Abra **Painel de Controle** e selecione **Aparência e Personalização**.  
    2.  Selecione **Opções de pasta** do menu.  
    3.  Selecione a guia **Modo de exibição** e garanta que a opção **Sempre mostrar ícones, nunca miniaturas** não esteja selecionada. Clique em **OK** para salvar as configurações.  
    4.  Feche todas as instâncias abertas do Windows Explorer para que a alteração entre em vigor.
  
#### Perguntas frequentes sobre a vulnerabilidade de saturação de processamento gráfico do Windows Shell - CVE-2010-3970
...
A vulnerabilidade é causada quando o processador gráfico do Windows Shell impropriamente analisa uma imagem em miniatura especialmente criada, resultando em saturação de buffer.
...
Essa vulnerabilidade exige que um usuário visualize um arquivo de imagem em miniatura especialmente criado.
  
Em um cenário de ataque à rede, um invasor poderá colocar uma imagem em miniatura especialmente criada ou um arquivo contendo uma imagem em miniatura especialmente criada em um compartilhamento de rede, tal como um UNC ou local de WebDAV, e então convencer o usuário a pesquisar o local no Windows Explorer. Quando o usuário vai ao compartilhamento, o caminho de controle afetado é disparado pelo processador gráfico do Windows Shell. A imagem em miniatura especialmente criada então poderá explorar a vulnerabilidade e executar o código no contexto de segurança do usuário conectado. Um invasor não teria como forçar os usuários a visitar um compartilhamento de rede, UNC ou local de WebDAV. Em vez disso, o invasor teria que convencê-los a visitar o compartilhamento, geralmente fazendo com que eles clicassem em um link em um email ou mensagem do Instant Messenger que levasse os usuários a um compartilhamento de rede, UNC ou local de WebDAV.
  
**O que é Uniform Naming Convention (UNC)?**  
Uniform naming convention (UNC), ou convenção de nome uniforme, é um método para identificar recursos como nomes de compartilhamento ou arquivos em uma rede. Um nome típico de UNC começa com duas barras invertidas, seguidas por um nome do servidor, tal como \\server\\share\\subdirectory\\filename.
...
A atualização elimina a vulnerabilidade, corrigindo a maneira como o processador gráfico do Windows Shell analisa imagens em miniatura.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**    
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2010-3970](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970) da lista Common Vulnerability and Exposure. Esta vulnerabilidade foi descrita no [Comunicado de Segurança da Microsoft 2490606](http://technet.microsoft.com/security/advisory/2490606).
...
Para Windows XP Service Pack 3:windowsxp-kb2483185-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><br />
Para Windows XP Service Pack 3:windowsxp-kb2483185-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2483185$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2483185">Artigo 2483185 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Kobi Pariente e Yaniv Miron, que trabalha no [VeriSign iDefense Labs](http://labs.idefense.com/), por relatar a Vulnerabilidade de saturação de processamento gráfico do Windows Shell (CVE-2010-3970)
