...
ms:assetid: 'ms11-010'
ms:contentKeyID: 61234347
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-010(v=Security.10)'
---
...
Vulnerabilidade no CSRSS (Windows Client/Server Runtime Subsystem) pode permitir elevação de privilégio (2476687)
-----------------------------------------------------------------------------------------------------------------
...
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular no CSRSS (Microsoft Windows Client/Server Run-time Subsystem) no Windows XP e Windows Server 2003. Esta atualização de segurança é classificada como Importante para todas as edições com suporte destes sistemas operacionais. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A vulnerabilidade pode permitir a elevação de privilégio se um invasor fizer logon em um sistema do usuário e iniciar um aplicativo especialmente criado que continua em execução depois que o invasor fizer logoff para obter as credenciais de logon de usuários subsequentes. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.

A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira pela qual os processos dos usuários são encerrados no logout. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=cfa10178-9859-4e03-bedc-e3f5297a0251)                                     | Elevação de privilégio     | Importante                      | [MS10-011](http://technet.microsoft.com/security/bulletin/ms10-011) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9f0b7b77-5b90-4a4b-97a4-0c1ce6a70126)            | Elevação de privilégio     | Importante                      | [MS10-011](http://technet.microsoft.com/security/bulletin/ms10-011) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aed08b96-24cc-4e23-8fd5-c7e52f8ef41a)                            | Elevação de privilégio     | Importante                      | [MS10-011](http://technet.microsoft.com/security/bulletin/ms10-011) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ca7879e1-e295-445d-a658-0a31be1928cc)                | Elevação de privilégio     | Importante                      | [MS10-011](http://technet.microsoft.com/security/bulletin/ms10-011) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=50855101-a15c-4c81-ad81-a7fe3f1d2026) | Elevação de privilégio     | Importante                      | [MS10-011](http://technet.microsoft.com/security/bulletin/ms10-011) |
...
<th style="border:1px solid black;" >Vulnerabilidade de elevação de privilégio de CSRSS - CVE-2011-0030</th>
...
Vulnerabilidade de elevação de privilégio de CSRSS - CVE-2011-0030  
------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégio uma vez que o CSRSS termina um processo quando um usuário faz logout. O invasor que explorar com êxito esta vulnerabilidade também poderá executar um código projetado para monitorar as ações de um usuário que se conecte subsequentemente ao sistema. Isso pode permitir a divulgação de informações confidenciais ou acesso a dados nos sistemas afetados acessíveis aos usuário conectado. Esses dados confidenciais podem incluir as credenciais de logon de usuários subsequentes, que um invasor talvez possa usar posteriormente para elevação de privilégio ou executar código como um usuário diferente no sistema. Observe que essa vulnerabilidade não permite que um invasor execute códigos ou aumente seus direitos de usuário diretamente. Ela poderia ser usada para coletar informações úteis à tentativa de comprometer ainda mais o sistema afetado. Se um usuário com privilégios administrativos fizer logon posteriormente no sistema, o invasor poderá executar código arbitrário no modo kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de sistema.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0030](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0030).
  
#### Fatores atenuantes da vulnerabilidade de elevação de privilégio de CSRSS - CVE-2011-0030
...
#### Soluções alternativas para a vulnerabilidade de elevação de privilégio de CSRSS - CVE-2011-0030
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de elevação de privilégio de CSRSS - CVE-2011-0030
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de sistema. Para tentar explorar a vulnerabilidade, o invasor precisa fazer logon localmente no sistema e executar um programa.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada quando o CSRSS não terminar corretamente os processos do usuário quando um usuário fizer logoff em um sistema.
  
**O que é o CSRSS (Client Server RunTime Subsystem)?**    
...
O invasor que explorar com êxito esta vulnerabilidade também poderá executar um código projetado para monitorar as ações de um usuário que se conecte subsequentemente ao sistema. Isso pode permitir a divulgação de informações confidenciais ou acesso a dados nos sistemas afetados acessíveis aos usuário conectado. Esses dados confidenciais incluem credenciais que podem ser usadas posteriormente por um invasor para elevar seus privilégios ou executar código como um usuário diferente no sistema. Assim que essas informações confidenciais são expostas, o invasor que explorar com êxito esta vulnerabilidade também poderá executar um código no nível de privilégio de um usuário que se conecte subsequentemente ao sistema. Se um administrador se conectasse ao sistema, o código do invasor seria executado com privilégios elevados.
  
**De que forma o invasor pode explorar a vulnerabilidade?**    
Para explorar essa vulnerabilidade, primeiro o invasor precisa fazer logon no sistema. Um invasor pode iniciar um aplicativo especialmente criado projetado para continuar executando depois de o invasor fizer logoff. Quando um novo usuário se conectar com suas próprias credenciais, o processo do invasor poderá monitorar todas as ações executadas pelo usuário conectado recentemente. Se o usuário conectado recentemente for um administrador, as informações divulgadas poderão ser usadas para tentar comprometer o sistema afetado.
...
A atualização elimina a vulnerabilidade, corrigindo a maneira pela qual os processos dos usuários são encerrados no logoff.
...
Para Windows XP Service Pack 3:WindowsXP-KB2476687-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><br />
Para Windows XP Service Pack 3:WindowsXP-KB2476687-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2476687$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2476687">Artigo 2476687 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Sihan Qing (professor), Wen de Weiping (professor associado), Liang Yi e Husheng Zhou (estudantes formados), do [Departamento de Segurança de Informações da Beijing University](http://www.ss.pku.edu.cn/en/), por relatarem a Vulnerabilidade de elevação de privilégio do CSRSS (CVE-2011-0030)
