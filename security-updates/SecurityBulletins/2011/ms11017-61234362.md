...
ms:assetid: 'ms11-017'
ms:contentKeyID: 61234362
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-017(v=Security.10)'
---
...
Vulnerabilidade no cliente de área de trabalho remota pode permitir a execução remota de código (2508062)
---------------------------------------------------------------------------------------------------------

Publicado: quarta-feira, 3 de agosto de 2011 | Atualizado: segunda-feira, 18 de abril de 2011
...
Esta atualização de segurança é classificada como importante para o Cliente de Conexão da Área de Trabalho Remota 5.3, Cliente de Conexão da Área de Trabalho Remota 6.0, Cliente de Conexão da Área de Trabalho Remota 6.1 e Cliente de Conexão da Área de Trabalho Remota 7.0. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira como o Cliente de Área de Trabalho Remota do Windows carrega bibliotecas externas. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Problemas conhecidos.** O [Artigo 975561 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/897341) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
<tr>
<th colspan="5">
Cliente de Conexão de Área de Trabalho Remota 5.2
</th>
</tr>
<tr>
...
<td style="border:1px solid black;">
[Cliente de Conexão de Área de Trabalho Remota 5.2](http://www.microsoft.com/downloads/details.aspx?familyid=1aed6080-feab-4b5e-9d26-6a3f4b92434d)  
(KB2483618)
</td>
<td style="border:1px solid black;">
...
<tr>
<th colspan="5">
Cliente de Conexão da Área de Trabalho Remota 6.0 e Cliente de Conexão da Área de Trabalho Remota 6.1
</th>
</tr>
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 6.1](http://www.microsoft.com/downloads/details.aspx?familyid=d67e4d8c-aeb9-45e6-9555-7456c5540475)  
(KB2481109)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 6.0](http://www.microsoft.com/downloads/details.aspx?familyid=6d4539ef-4a05-4c7d-9489-436f7b7a3ebe)<sup>[1]</sup>
(KB2481109)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 6.0](http://www.microsoft.com/downloads/details.aspx?familyid=641d5d12-0790-4551-831a-e78febad17a7)<sup>[1]</sup>
(KB2481109)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Interface de Usuário Multilíngue (MUI) do Cliente de Conexão da Área de Trabalho Remota 6.0](http://www.microsoft.com/downloads/details.aspx?familyid=6fec0d06-042d-4e55-9843-009edd7d26ce)<sup>[2]</sup>
(KB2483619)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 6.0](http://www.microsoft.com/downloads/details.aspx?familyid=78dbb9cf-8a18-4f0a-8edf-f1ce0c993c63)<sup>[1]</sup>
(KB2481109)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 6.1](http://www.microsoft.com/downloads/details.aspx?familyid=e3ea7690-386b-4cdf-889f-b3914921c56f)  
(KB2481109)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 6.1](http://www.microsoft.com/downloads/details.aspx?familyid=5735bed6-0e3d-46a4-85d0-14ec34a82edd)  
(KB2481109)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 6.1](http://www.microsoft.com/downloads/details.aspx?familyid=31d790c9-92f9-4a2b-800b-8e8d2b570bb9)\*\*  
(KB2481109)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 6.1](http://www.microsoft.com/downloads/details.aspx?familyid=5b0a8eb5-4bc2-4054-b952-58aa645afcf5)\*\*  
(KB2481109)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 6.1](http://www.microsoft.com/downloads/details.aspx?familyid=25da7e00-745d-4d98-9dd8-52a8a4340404)  
(KB2481109)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=6a01992e-c9a1-4dc9-a3ef-7410b81f17e6)  
(KB2483614)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=3c30f67e-7c31-4553-ba3e-e056df1bf8eb)  
(KB2483614)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=8025482b-f58f-4f5a-a133-5563c65b21f6)  
(KB2483614)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=0768a5f4-da28-4b2e-8aff-d68f890df3e6)  
(KB2483614)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=935adb10-1e7e-4501-b543-8247b88f6d18)  
(KB2483614)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=3fcb2e11-591e-484a-a992-2f1d563e6d17)\*\*  
(KB2483614)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<td style="border:1px solid black;">
[Cliente de Conexão da Área de Trabalho Remota 7.0](http://www.microsoft.com/downloads/details.aspx?familyid=c29b6487-78f0-421c-810c-c5e45d6a2352)  
(KB2483614)
</td>
<td style="border:1px solid black;">
Execução Remota de Código
...
<sup>[1]</sup>Este download atualiza o Cliente de Conexão da Área de Trabalho Remota 6.0 para uma versão não afetada do Cliente de Conexão da Área de Trabalho Remota 6.1.

<sup>[2]</sup>Este download atualiza a Interface de Usuário Multilíngue (MUI) do Cliente de Conexão da Área de Trabalho Remota 6.0 para uma versão não afetada da Interface de Usuário Multilíngue (MUI) do Cliente de Conexão da Área de Trabalho Remota 6.1.

**Softwares não afetados**

| Sistema operacional                                                     | Componente                                        |
|-------------------------------------------------------------------------|---------------------------------------------------|
| Windows XP Professional x64 Edition Service Pack 2                      | Cliente de Conexão de Área de Trabalho Remota 5.2 |
| Windows Server 2003 Service Pack 2                                      | Cliente de Conexão de Área de Trabalho Remota 5.2 |
| Windows Server 2003 x64 Edition Service Pack 2                          | Cliente de Conexão de Área de Trabalho Remota 5.2 |
| Windows Server 2003 com SP2 para sistemas baseados no Itanium           | Cliente de Conexão de Área de Trabalho Remota 5.2 |
| Windows 7 para sistemas de 32 bits Service Pack 1                       | Remote Desktop Connection 7.1 Client              |
| Windows Vista para Sistemas Service Pack 1 baseados em x64              | Remote Desktop Connection 7.1 Client              |
| Windows Server 2008 R2 para Sistemas Service Pack 1 baseados em x64     | Remote Desktop Connection 7.1 Client              |
| Windows Server 2008 R2 para Sistemas Service Pack 1 baseados em Itanium | Remote Desktop Connection 7.1 Client              |
...
<th style="border:1px solid black;" >
Vulnerabilidade de carregamento não seguro da Área de Trabalho Remota - CVE-2011-0029
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
<tr>
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 5.2 no Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 6.1 no Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 6.0 no Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 6.0 no Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Interface de Usuário Multilíngue (MUI) do Cliente de Conexão da Área de Trabalho Remota 6.0 no Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 6.0 no Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 6.1 no Windows Vista Service Pack 1 e Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 6.1 no Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 6.1 no Windows Server 2008 para sistemas de 32 bits e no Windows Server 2008 para sistemas de 32 bits Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 6.1 no Windows Server 2008 para sistemas baseados em x64 e no Windows Server 2008 para sistemas baseados em x64 Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 6.1 no Windows Server 2008 para sistemas baseados no Itanium e no Windows Server 2008 para sistemas baseados no Itanium Service Pack 2\*\*
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 7.0 no Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 7.0 no Windows Vista Service Pack 1 e Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 7.0 no Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 7.0 no Windows 7 para sistemas de 32 bits
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 7.0 no Windows 7 para sistemas baseados em x64
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 7.0 no Windows Server 2008 R2 para sistemas baseados em x64\*\*
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Conexão da Área de Trabalho Remota 7.0 no Windows Server 2008 R2 para sistemas baseados no Itanium
</td>
<td style="border:1px solid black;">
**Importante**   
Execução Remota de Código
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o Cliente da Área de Trabalho Remota do Windows manipula o carregamento de arquivos DLL. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
...
#### Fatores atenuantes da vulnerabilidade de carregamento não seguro de biblioteca da Área de Trabalho Remota - CVE-2011-0029

A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:

-   Para que um ataque seja bem-sucedido, o usuário deve visitar um local de sistema de arquivos remoto não confiável ou compartilhamento de WebDAV e abrir um arquivo .rdp.
...
#### Soluções alternativas para a vulnerabilidade de carregamento não seguro de biblioteca da Área de Trabalho Remota - CVE-2011-0029
...
#### Perguntas frequentes sobre a vulnerabilidade de carregamento não seguro de biblioteca da Área de Trabalho Remota - CVE-2011-0029
...
A vulnerabilidade é causada quando o Cliente da Área de Trabalho Remota do Windows restringe incorretamente o caminho usado para o carregamento de bibliotecas externas.

**O que é o Cliente da Área de Trabalho Remota do Windows?**  
O recurso Área de Trabalho Remota no Windows capacita o acesso a todos os programas, recursos, e acessórios em um computador do usuário de um segundo computador baseado em Windows. Uma vez conectado, a Área de Trabalho Remota dá ao mouse e ao teclado controle sobre o primeiro computador ao mostrar tudo que acontece na tela.
...
Um invasor pode convencer um usuário a abrir um arquivo legítimo da Área de Trabalho Remota (.rdp) localizado no mesmo diretório de rede de um arquivo de biblioteca de vínculo dinâmico (DLL) especialmente criado. Em seguida, ao abrir o arquivo .rdp, o Cliente da Área de Trabalho Remota do Windows pode tentar carregar o arquivo .DLL e executar o código contido nele.

Em um cenário de ataque por email, o invasor pode explorar a vulnerabilidade enviando um arquivo .rdp legítimo como um anexo a um usuário e convencendo-o a colocar o anexo em um diretório que contém um arquivo .DLL especialmente criado e a abrir o arquivo .rdp. Em seguida, ao abrir o arquivo .rdp, o Cliente da Área de Trabalho Remota do Windows pode tentar carregar o arquivo .DLL e executar o código contido nele.

Em um cenário de rede, um invasor pode colocar um arquivo legítimo .rdp e uma .DLL especialmente criada em um UNC ou local WebDAV e então convencer o usuário a abrir o arquivo .rdp.
...
A atualização elimina a vulnerabilidade, corrigindo a maneira como o Cliente de Área de Trabalho Remota do Windows carrega bibliotecas externas.

**Esta vulnerabilidade está relacionada ao Comunicado de Segurança da Microsoft 2269637?**  
Sim, a vulnerabilidade eliminada por esta atualização está relacionada à classe de vulnerabilidades, descrita no [Comunicado de Segurança da Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637), que afeta como os aplicativos carregam as bibliotecas externas. Esta atualização de segurança elimina uma instância em particular deste tipo de vulnerabilidade.

**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2010-0043](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0026) da lista Common Vulnerability and Exposure.
...
| Windows 7 para sistemas de 32 bits Service Pack 1                                                                            | Não     | Não               | Sim               | Sim                        |
...
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 5.2 no Windows XP Service Pack 3:<br />
WindowsXP-KB2286198-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 6.1 no Windows XP Service Pack 3:<br />
WindowsXP-KB2286198-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 7.0 no Windows XP Service Pack 3:<br />
WindowsXP-KB2286198-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 6.0 no Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Para Conexão de Área de Trabalho Remota 5.2:<br />
KB2483618.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 6.0 e Conexão da Área de Trabalho Remota 6.1:<br />
KB2481109.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 7.0:<br />
KB2483614.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Para Conexão de Área de Trabalho Remota 5.2:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB975561$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 6.0 e Conexão da Área de Trabalho Remota 6.1:<br />
...
<td style="border:1px solid black;">Para Conexão de Área de Trabalho Remota 5.2:<br />
Consulte o <a href="http://support.microsoft.com/kb/897341">Artigo 975561 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 6.0 e Conexão da Área de Trabalho Remota 6.1:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 6.0 no Windows Server 2003 Service Pack 2:<br />
WindowsServer2003-KB2286198-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Interface de Usuário Multilíngue (MUI) do Cliente de Conexão da Área de Trabalho Remota 6.0 no Windows Server 2003 Service Pack 2:<br />
WindowsServer2003-KB2286198-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 6.0 no Windows Server 2003 x64 Edition Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB2286198-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalar sem reinicializar</td>
...
<tr class="odd">
<td style="border:1px solid black;">Arquivo de log de atualização</td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 6.0:<br />
KB2481109.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Interface de Usuário Multilíngue (MUI) do Cliente de Conexão da Área de Trabalho Remota 6.0:<br />
KB2483619.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Mais informações</td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 6.1 no Windows Vista Service Pack 1 e Windows Vista Service Pack 2:<br />
Windows6.0-KB2286198-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 7.0 no Windows Vista Service Pack 1 e Windows Vista Service Pack 2:<br />
Windows6.0-KB2286198-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 6.1 no Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 6.1:<br />
Consulte o <a href="http://support.microsoft.com/kb/897341">Artigo 975561 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 6.1 em todas as edições de 32 bits com suporte do Windows Server 2008:<br />
Windows6.0-KB2286198-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 6.1 em todas as edições baseadas em x64 com suporte do Windows Server 2008:<br />
Windows6.0-KB2286198-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Conexão da Área de Trabalho Remota 6.1 em todas as edições baseadas no Itanium com suporte do Windows Server 2008:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/897341">Artigo 975561 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
<td style="border:1px solid black;"><strong>Observação</strong> Não existe uma chave do Registro para validar a presença dessa atualização.</td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para Remote Desktop Connection 7.0 em todas as edições com suporte de 32 bits da versão de lançamento original do Windows 7:<br />
Windows6.1-KB2286198-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Remote Desktop Connection 7.0 em todas as edições com suporte de 64 bits da versão de lançamento original do Windows 7:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para Remote Desktop Connection 7.0 em todas as edições com suporte de 64 bits da versão de lançamento original do Windows Server 2008 R2:<br />
Windows6.1-KB2286198-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Remote Desktop Connection 7.0 em todas as edições com suporte baseadas em Itanium da versão de lançamento original do Windows Server 2008 R2:<br />
...
-   Eyal Gruner, da [Versafe Anti Fraud](http://www.versafe-login.com/), para relatar a Vulnerabilidade de carregamento não seguro da biblioteca da Área de Trabalho Remota (CVE-2011-0029)
...
-   V1.0 (8 de março de 2011) : Corrigidas as entradas de tabela do Servidor de gerenciamento de sistemas para SMS 2.0 e SMS 2003 com SUIT do Windows XP Service Pack 3 e Windows Server 2003 Service Pack 2. Essas são apenas alterações instrutivas. Não houve nenhuma alteração à lógica de detecção ou aos arquivos da atualização de segurança.  
-   V1.1 (9 de março de 2011) : Corrigidas as entradas do componente do **Software não afetado** das versões do Service Pack 1 do Windows 7 e Windows Server 2008 R2 do Remote Desktop Connection 7.0 Client para o Remote Desktop Connection 7.1 Client. Elas são alterações para fins informativos apenas. Não houve nenhuma alteração à lógica de detecção ou aos arquivos da atualização de segurança.  
-   V1.3 (18 de abril, 2011) : Corrigido a informação de substituição de boletim para conexão da Área de Trabalho Remota 6.0 Cliente em edições com suporte de Windows Server 2003 e conexão da Área de Trabalho Remota 6.1 Cliente em edições com suporte de Windows Vista. Esta é apenas uma alteração do boletim. Não houve alterações à lógica de detecção nem aos arquivos de atualização.
