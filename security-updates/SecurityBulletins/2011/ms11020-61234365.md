...
ms:assetid: 'ms11-020'
ms:contentKeyID: 61234365
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-020(v=Security.10)'
---
...
Vulnerabilidade no servidor SMB pode permitir a execução remota de código (2508429)
-----------------------------------------------------------------------------------
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=79aeb3cd-7c73-467b-b91e-02c6ea01e911">Windows Server 2003 com SP2 para sistemas baseados no Itanium</a></td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Crítica</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-054">MS10-054</a></td>
</tr>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b89b8e28-cd98-4bcc-8729-5e51d52d1e92">Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2</a></td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Crítica</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a>,<br />
<a href="http://technet.microsoft.com/security/bulletin/ms10-054">MS10-054</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=0005377b-443f-44ca-a890-620b2dcea6f1">Windows Server 2008 R2 para sistemas baseados no Itanium</a></td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Crítica</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-054">MS10-054</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=0005377b-443f-44ca-a890-620b2dcea6f1">Windows Server 2008 R2 para sistemas baseados no Itanium Service Pack 1</a></td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Crítica</td>
<td style="border:1px solid black;">Nenhuma</td>
</tr>
...
<th style="border:1px solid black;" >Vulnerabilidade de análise da transação SMB - CVE-2011-0661</th>
<th style="border:1px solid black;" >Avaliação de gravidade agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de análise da transação SMB - CVE-2011-0661  
-----------------------------------------------------------
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0661](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0661).
  
#### Fatores atenuantes da Vulnerabilidade de análise da transação SMB - CVE-2011-0661
...
#### Soluções alternativas para a Vulnerabilidade de análise da transação SMB - CVE-2011-0661
...
#### Perguntas frequentes sobre a Vulnerabilidade de análise da transação SMB - CVE-2011-0661
...
A vulnerabilidade é causada quando o software de Protocolo de SMB da Microsoft manipula, de forma insuficiente, as solicitações SMB, incluindo cenários de pré-autenticação. Essa vulnerabilidade afeta o SMB versão 1 e SMB versão 2.
...
Todos os sistemas com o serviço de servidor SMB são afetados por esta vulnerabilidade. Os controladores de domínio correm um grande risco de exploração dessa vulnerabilidade, uma vez que esses sistemas têm compartilhamentos de rede abertos para todos os usuários de domínio por padrão.
  
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade, corrigindo a maneira como o SMB valida campos em solicitações SMB malformadas.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2508429$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2508429">Artigo 2508429 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   V1.1 (27 de abril de 2011): Foram corrigidas as informações de substituição de boletim de todas as edições com suporte do Windows Vista e Windows Server 2008.
