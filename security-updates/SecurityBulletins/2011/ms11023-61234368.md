...
ms:assetid: 'ms11-023'
ms:contentKeyID: 61234368
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-023(v=Security.10)'
---
...
Vulnerabilidades no Microsoft Office podem permitir a execução remota de código (2489293)
-----------------------------------------------------------------------------------------
...
Esta atualização de segurança elimina uma vulnerabilidade divulgada publicamente e uma vulnerabilidade relatada em particular no Microsoft Office. A vulnerabilidade pode permitir a execução remota de código se um usuário abrir um arquivo do Office especialmente criado ou se um usuário abrir um arquivo do Office legítimo localizado no mesmo diretório de rede que um arquivo de biblioteca especialmente criado. O invasor que explorar com êxito qualquer uma destas vulnerabilidades poderá obter os mesmos direitos que o usuário local. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Esta atualização de segurança foi classificada como Importante para todas as edições com suporte do Microsoft Office XP, Microsoft Office 2003, Microsoft Office 2007, Microsoft Office 2004 for Mac e Microsoft Office 2008 for Mac e Open XML File Format Converter for Mac. Para obter mais informações, consulte a subseção **Software afetado e não afetado**, nesta seção.

A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira pela qual o Microsoft Office manipula objetos gráficos em arquivos do Office especialmente criados e corrigindo a maneira pela qual o Microsoft Office carrega bibliotecas externas. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
Sim, a Vulnerabilidade de carregamento não seguro de bibliotecas de componentes (CVE-2011-0107) eliminada por esta atualização está relacionada à classe de vulnerabilidades, descrita no [Comunicado de Segurança da Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637), que afeta como os aplicativos carregam as bibliotecas externas. Esta atualização de segurança elimina uma instância em particular deste tipo de vulnerabilidade.

**Esta atualização contém alterações relacionadas à segurança da funcionalidade?**  
Sim. As atualizações para Microsoft Office 2003 Service Pack 3 (KB2509503) e Microsoft Office 2007 Service Pack 2 (KB2509488) junto com atualizações para Microsoft Word, Microsoft Excel e Microsoft PowerPoint, fornecem suporte para o recurso de Validação de Arquivo do Office. Para obter mais informações sobre o recurso de Validação de Arquivo de Office, consulte o [Comunicado de Segurança da Microsoft 2501584](http://technet.microsoft.com/security/advisory/2501584).

**Como esta atualização de segurança se relaciona com o boletim MS11-029?**  
O pacote de atualização de segurança para Microsoft Office XP (KB2509461) oferecido neste boletim também elimina a vulnerabilidade descrita no boletim de segurança [MS11-029](http://go.microsoft.com/fwlink/?linkid=208524). Os usuários com Microsoft Office XP instalados só precisam instalar o pacote de atualização de segurança.

**Como esta atualização de segurança se relaciona com os boletins MS10-087 e MS10-088?**  
A atualização do Microsoft Office 2004 for Mac (KB2505924) oferecida nesta boletim também aborda as vulnerabilidades descritas nos boletins de segurança [MS10-087](http://technet.microsoft.com/security/bulletin/ms10-087) e [MS10-088](http://technet.microsoft.com/security/bulletin/ms10-088).

**Os boletins MS11-022 e MS11-021 também descrevem as vulnerabilidades no Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac e Open XML File Format Converter for Mac. Como os boletins MS11-022 e MS11-021 estão relacionados a este boletim MS11-023?**  
Os pacotes de atualização de segurança para Microsoft Office 2004 for Mac (KB2505924), Microsoft Office 2008 for Mac (KB2505927) e Open XML File Format Converter for Mac (KB2505935) oferecidos neste boletim também eliminam as vulnerabilidades descritas nos boletins de segurança [MS11-022](http://go.microsoft.com/fwlink/?linkid=210727) e [MS11-021](http://go.microsoft.com/fwlink/?linkid=210121). Os usuários com Microsoft Office 2004 for Mac, Microsoft Office 2008 for Mac ou Open XML File Format Converter for Mac instalados só precisarão instalar esses pacotes de atualização de segurança uma vez.
...
Um programa autônomo do Microsoft Office é afetado com a mesma classificação de gravidade que o pacote do Microsoft Office correspondente. Por exemplo, uma instalação autônoma do Microsoft Excel é afetada com a mesma classificação de gravidade de uma instalação do pacote afetado do Microsoft Office.
...
<th style="border:1px solid black;" >
Vulnerabilidade de carregamento não seguro de biblioteca de componentes do Office - CVE-2011-0107
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de desreferenciação de objeto gráfico do Microsoft Office - CVE-2011-0977
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0107](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107).

#### Fatores atenuantes da Vulnerabilidade de carregamento não seguro de biblioteca de componentes do Office - CVE-2011-0107

A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:

-   Para que um ataque seja bem-sucedido, o usuário deve visitar um local de sistema de arquivos remoto não confiável ou compartilhamento de WebDAV e abrir um arquivo relacionado ao Office (como, por exemplo, um arquivo .docx).
...
#### Soluções alternativas para a Vulnerabilidade de carregamento não seguro de biblioteca de componentes do Office - CVE-2011-0107
...
#### Perguntas frequentes sobre a Vulnerabilidade de carregamento não seguro de biblioteca de componentes do Office - CVE-2011-0107
...
Um invasor pode convencer um usuário a abrir um arquivo legítimo do Office (como um arquivo .docx) localizado no mesmo diretório de rede que um arquivo .DLL especialmente criado. Em seguida, ao abrir o arquivo legítimo, o Microsoft Office pode tentar carregar o arquivo .DLL e executar o código contido nele.

Em um cenário de ataque por email, um invasor pode explorar a vulnerabilidade enviando um anexo de arquivo do Office (como um arquivo .docx) a um usuário e convencendo o usuário a colocar o anexo em um diretório contendo um arquivo .DLL especialmente criado e a abrir o arquivo legítimo. Em seguida, ao abrir o arquivo legítimo, o Microsoft Office pode tentar carregar o arquivo .DLL e executar o código contido nele.
...
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2011-0107](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107) da lista Common Vulnerability and Exposure.
...
Sim. Essa atualização de segurança elimina a vulnerabilidade que poderia ser explorada por meio do uso do código de verificação de conceito publicado. A vulnerabilidade eliminada recebeu o número [CVE-2011-0107](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107) da lista Common Vulnerability and Exposure.

Vulnerabilidade de desreferenciação de objeto gráfico do Microsoft Office - CVE-2011-0977
-----------------------------------------------------------------------------------------

<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Office lida com objetos gráficos ao analisar um arquivo do Office especialmente criado. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0977](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0977).

#### Fatores atenuantes da Vulnerabilidade de desreferenciação de objeto gráfico do Microsoft Office - CVE-2011-0977
...
-   Em um cenário de ataque pela Web, o invasor precisará hospedar um site que contenha um arquivo do Office especialmente criado usado para tentar explorar esta vulnerabilidade. Além disso, sites comprometidos e sites que aceitem ou hospedem conteúdo fornecido pelo usuário podem conter conteúdo especialmente desenvolvido que pode explorar esta vulnerabilidade. Não há como o invasor forçar os usuários a visitarem esses sites. Em vez disso, o invasor teria que persuadir os usuários a visitar o site, geralmente fazendo com que eles cliquem em um link que leva o usuário ao site do invasor e então convencê-los a abrir o arquivo do Office especialmente criado.

#### Soluções alternativas para a Vulnerabilidade de desreferenciação de objeto gráfico do Microsoft Office - CVE-2011-0977
...
#### Perguntas frequentes sobre a Vulnerabilidade de desreferenciação de objeto gráfico do Microsoft Office - CVE-2011-0977
...
**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando o Microsoft Office não manipula corretamente as estruturas de dados de desreferenciação ao analisar um arquivo do Office especialmente criado que contém objetos gráficos.
...
**De que forma o invasor pode explorar a vulnerabilidade?**  
Embora o código vulnerável existe em um componente compartilhado do Microsoft Office, o vetor de ataque conhecido é por meio do Microsoft Excel. A exploração desta vulnerabilidade requer que um usuário abra um arquivo do Excel especialmente criado com uma versão afetada do Microsoft Excel.
...
**O vetor de ataque para a vulnerabilidade é por meio do Microsoft Excel. Por que este é um boletim do Microsoft Office?**  
Embora o vetor de ataque conhecido para exploração da vulnerabilidade seja por meio do Microsoft Excel, o código vulnerável existe em um componente compartilhado do Microsoft Office. A lógica de detecção usada para verificar os sistemas afetados é projetada para procurar pelo componente compartilhado afetado do Microsoft Office e para oferecer as atualizações para um sistema, independentemente de o Microsoft Excel estar ou não instalado.
...
**O que a atualização faz?**  
A atualização elimina a vulnerabilidade, corrigindo a maneira pela qual o Microsoft Office manipula objetos gráficos em arquivos do Office especialmente criados.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2509503">Artigo 2509503 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2509488">Artigo 2509488 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
-   Haifei Li, [da Fortinet's FortiGuard Labs](http://www.fortiguard.com/), por relatar a Vulnerabilidade de carregamento não seguro de biblioteca de componentes do Office (CVE-2011-0107)  
-   Um pesquisador anônimo, que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por relatar a Vulnerabilidade de desreferenciação de objetos gráficos do Microsoft Office (CVE-2011-0979)
