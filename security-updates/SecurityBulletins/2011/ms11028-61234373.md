...
ms:assetid: 'ms11-028'
ms:contentKeyID: 61234373
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-028(v=Security.10)'
---
...
Vulnerabilidade no .NET Framework pode permitir execução remota de código (2484015) 
------------------------------------------------------------------------------------

Publicado: terça-feira, 12 de abril de 2011 | Atualizado: quarta-feira, 30 de novembro de 2011
...
A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira como .NET Framework manipula determinado tipos de chamadas de função. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Problemas conhecidos.** O [Artigo 2484015 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2484015) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
**Por que este boletim foi revisado em 14 de junho de 2011?**  
A Microsoft revisou este boletim de segurança para anunciar uma alteração de detecção no pacote do Windows Update (WU) para o artigo KB2446709. O pacote de WU agora lista corretamente o boletim substituído por esta atualização. Esta é apenas uma alteração de detecção. Os clientes que já atualizaram seus sistemas com êxito não precisam fazer mais nada.

**Por que este boletim foi relançado em 10 de maio de 2011?  ** 
Este boletim foi relançado para oferecer novamente a atualização KB979744 com atualizações de segurança KB2446709 e KB2449742 para resolver um problema conhecido que impactou o SQL Server e o Exchange Server. Este problema é descrito em detalhes no [Artigo 2540222 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2540222). Para os clientes que instalaram a versão original (V1) do hotfix KB979744, esta atualização oferecerá e instalará tanto a atualização de segurança quanto a nova versão do hotfix KB979744 automaticamente. Os clientes que já atualizaram seus sistemas com êxito, mas não têm o hotfix KB979744 instalado, deverão reinstalar esta atualização.
...
<th style="border:1px solid black;" >
Vulnerabilidade de corrupção de pilha do .NET Framework - CVE-2010-3958
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalados no Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Crítica**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalados no Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalados no Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalados no Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalados no Windows Server 2003 com SP2 para sistemas baseados no Itanium
</td>
<td style="border:1px solid black;">
**Crítica**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado no Windows 7 para sistemas baseados em x64 e Windows 7 para Sistemas Service Pack 1 baseados em x64
</td>
<td style="border:1px solid black;">
**Crítica**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 quando instalado em sistemas Windows Server 2008 R2 baseados em x64
</td>
<td style="border:1px solid black;">
**Crítica**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Para Microsoft .NET Framework 4.0 quando instalado em sistemas Windows Server 2008 R2 baseados em x64 Service Pack 1\*
</td>
<td style="border:1px solid black;">
**Crítica**   
Execução Remota de Código
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft .NET Framework manipula determinadas chamadas de função. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-3958](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3958).

#### Fatores atenuantes da vulnerabilidade de corrupção de pilha do .NET Framework - CVE-2010-3958
...
#### Soluções alternativas para a Vulnerabilidade de corrupção de pilha do .NET Framework - CVE-2010-3958
...
#### Perguntas frequentes sobre a Vulnerabilidade de corrupção de pilha do .NET Framework - CVE-2010-3958
...
Esta vulnerabilidade é causada quando o compilador JIT x86 no .NET Framework compila incorretamente determinados tipos de chamadas de função.
...
A atualização elimina a vulnerabilidade, corrigindo a maneira como o compilador JIT x86 no .NET Framework manipula determinado tipos de chamadas de função.

**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2010-3958](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3958) da lista Common Vulnerability and Exposure.
...
<td style="border:1px solid black;">Para Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalado no Windows XP Service Pack 3:<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalado no Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2484015">Artigo 2484015 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalados no Windows Server 2003 Service Pack 2:<br />
NDP20SP2-KB2446704-v2-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4.0 quando instalado no Windows Server 2003 Service Pack 2:<br />
NDP40-KB2446708-x86.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalados no Windows Server 2003 x64 Edition Service Pack 2:<br />
NDP20SP2-KB2446704-v2-x64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4.0 quando instalado no Windows Server 2003 x64 Edition Service Pack 2:<br />
NDP40-KB2446708-x64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 2.0 Service Pack 2 e Microsoft .NET Framework 3.5 Service Pack 1 quando instalados no Windows Server 2003 com SP2 para sistemas baseados no Itanium:<br />
NDP20SP2-KB2446704-v2-IA64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4.0 quando instalado no Windows Server 2003 com SP2 para sistemas baseados em Itanium:<br />
...
-   V2.0 (10 de maio de 2011) : Boletim relançado para oferecer novamente as atualizações KB2446709 e KB2449742. Isso soluciona um problema conhecido no SQL Server e Exchange Server que possuem o hotfix KB979744 instalado.  
-   V2.1 (14 de junho de 2011) : Adicionadas algumas Perguntas frequentes de atualização para anunciar uma alteração de detecção que corrige o boletim substituído do Microsoft .NET Framework 3.5.1 em edições com suporte do Windows 7 e Windows Server 2008 R2. Esta é uma alteração de detecção somente. Não houve nenhuma alteração para os arquivos de atualização de segurança. Os clientes que já atualizaram seus sistemas com êxito não precisam fazer mais nada.  
-   V2.2 (22 de junho de 2011): Foram corrigidas as informações de substituição de boletim. Esta é apenas uma alteração do boletim. Não houve alterações nos arquivos de atualização de detecção ou de segurança.  
-   V2.3 (26 de outubro de 2011): Corrigidas as informações de substituição do boletim do .Net Framework 4 em edições de 32 bits do Microsoft Windows. Esta é apenas uma alteração do boletim. Não houve alterações nos arquivos de atualização de detecção ou de segurança. Corrigida também a aplicação de instalação do Server Core no .NET Framework 4 no Windows Server 2008 R2 para sistemas baseados em x64.  
-   V2.4 (30 de novembro de 2011): Foram corrigidas as informações de substituição de boletim para .Net Framework 4 no Windows 7 para Sistemas Service Pack 1 baseados em x64, Windows Server 2008 R2 para Sistemas baseados em x64 Service Pack 1, e Windows Server 2008 R2 para sistemas baseados no Itanium Service Pack 1. Esta é apenas uma alteração do boletim. Não houve alterações nos arquivos de atualização de detecção ou de segurança.
