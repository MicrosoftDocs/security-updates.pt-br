...
ms:assetid: 'ms11-030'
ms:contentKeyID: 61234375
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-030(v=Security.10)'
---
...
Vulnerabilidade na resolução DNS pode permitir a execução remota de código (2509553)
------------------------------------------------------------------------------------
...
Esta atualização de segurança foi classificada como Crítica para todas as edições com suporte do Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2, e como Importante para todas as edições com suporte do Windows XP e Windows Server 2003. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira como o cliente DNS processa consultas DNS especialmente criadas. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Problemas conhecidos.** O [artigo 2509553 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2509553) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms08-020">MS08-020</a>,<br />
<a href="http://technet.microsoft.com/pt-br/security/bulletin/ms08-037">MS08-037</a>,<br />
<a href="http://technet.microsoft.com/pt-br/security/bulletin/ms08-066">MS08-066</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f5ad6963-2d6a-4d59-9e25-4fc088647fcd">Windows Server 2003 com SP2 para sistemas baseados no Itanium</a></td>
<td style="border:1px solid black;">Elevação de privilégio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms08-020">MS08-020</a>,<br />
<a href="http://technet.microsoft.com/pt-br/security/bulletin/ms08-037">MS08-037</a>,<br />
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c0275df0-10ac-4500-ab86-b7e9a34f8e1d">Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2</a></td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Crítica</td>
<td style="border:1px solid black;">Nenhuma</td>
</tr>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2084c726-187e-41f9-9bea-da18f490d29e">Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x-64 Service Pack 1</a>&#42;</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Crítica</td>
<td style="border:1px solid black;">Nenhuma</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=34d2793e-a2cd-49f6-b524-6598ea86175f">Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados no Itanium</a></td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Crítica</td>
<td style="border:1px solid black;">Nenhuma</td>
</tr>
...
Existe uma vulnerabilidade de execução remota de código na maneira como o serviço do cliente DNS manipula as consultas LLMNR especialmente criadas. O invasor que explorar a vulnerabilidade com êxito poderá executar código arbitrário no contexto da conta NetworkService. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-0657](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0657).
  
#### Fatores atenuantes da Vulnerabilidade de consulta DNS - CVE-2011-0657
...
-   **Bloquear a porta TCP 5355 e a porta UDP 5355 no firewall**
  
    Essas portas são usadas para iniciar uma conexão com o componente afetado. O bloqueio dessas portas no firewall, interno e externo, da empresa ajudará a impedir que os sistemas atrás do firewall sejam alvo de tentativas de exploração dessa vulnerabilidade. A Microsoft recomenda que você bloqueie todas as comunicações de entrada não solicitadas da Internet para ajudar a impedir ataques que talvez usem outras portas. Para obter mais informações sobre as portas, consulte [TCP and UDP Port Assignments](http://go.microsoft.com/fwlink/?linkid=21312). Para obter mais informações sobre o Firewall do Windows, consulte [Como configurar o Firewall do Windows em um único computador](http://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx).
  
    **Impacto da solução alternativa.** O bloqueio da conectividade a essas portas ajudará a impedir que os sistemas protegidos pelo firewall sejam alvo de tentativas de exploração dessa vulnerabilidade.
  
    **Como desfazer a solução alternativa.** Desbloquear a porta TCP 5355 e a porta UDP 5355 no firewall Para obter mais informações sobre as portas, consulte [TCP and UDP Port Assignments](http://go.microsoft.com/fwlink/?linkid=21312).
  
-   **Desabilitar a resolução de nomes multicast local de link usando a diretiva de grupo**
  
    Para desabilitar a resolução de nomes multicast local de link usando a diretiva de grupo, execute as etapas a seguir:
  
    1.  Abra o Editor de diretiva de grupo.  
    2.  Expanda a **Configuração do Computador**, expanda os **Modelos Administrativos**, expanda a **Rede** e o **Cliente DNS**.  
    3.  Clique duas vezes em **Desativar Inicialização por Multicast**, clique em **Habilitado** e, em seguida, em **OK**.
  
    **Impacto da solução alternativa.** O computador pode não estar visível para outros computadores na rede.
  
    **Como desfazer a solução alternativa.**
  
    Para habilitar novamente a resolução de nomes multicast local de link usando a diretiva de grupo, execute as etapas a seguir:
  
    1.  Abra o Editor de diretiva de grupo.  
    2.  Expanda a **Configuração do Computador**, expanda os **Modelos Administrativos**, expanda a **Rede** e o **Cliente DNS**.  
    3.  Clique duas vezes em **Desativar Inicialização por Multicast**, clique em **Desabilitado** e, em seguida, em **OK**.
  
-   **Desabilitar descoberta de rede**
  
    Para desabilitar a Descoberta de Rede, execute as etapas a seguir:
  
    1.  Abra o Painel de Controle.  
    2.  Clique em **Rede e Internet**, clique em **Centro de Redes e Compartilhamento** e, em seguida, clique em **Alterar as configurações de compartilhamento avançadas**.  
    3.  Em Descoberta de Rede, clique em **Desabilitar descoberta de rede** e clique em **Salvar alterações**.
  
    **Impacto da solução alternativa.** O computador pode não estar visível para outros computadores na rede.
  
    **Como desfazer a solução alternativa.**
  
    Para habilitar novamente a Descoberta de Rede, execute as etapas a seguir:
  
    1.  Abra o Painel de Controle.  
    2.  Clique em Rede **e Internet**, clique em **Centro de Redes e Compartilhamento** e, em seguida, clique em **Alterar as configurações de compartilhamento avançadas**.  
    3.  Em Descoberta de Rede, clique em **Habilitar descoberta de rede** e clique em **Salvar alterações**.
  
#### Perguntas frequentes sobre a Vulnerabilidade de consulta DNS - CVE-2011-0657
  
**Qual é o escopo da vulnerabilidade?**   
Nos sistemas Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2, esta é uma vulnerabilidade de execução remota de código. O invasor que explorar a vulnerabilidade com êxito poderá executar código no contexto da conta NetworkService.
  
Nos sistemas Windows XP e Windows Server 2003, esta é uma vulnerabilidade de elevação de privilégio. Um invasor com credenciais de usuário pode explorar a vulnerabilidade, resultando em uma elevação de privilégio que pode permitir que um invasor execute código no contexto da conta NetworkService.
  
**O que provoca a vulnerabilidade?**   
A vulnerabilidade é causada pela maneira como o cliente DNS manipula as consultas LLMNR especialmente criadas.
  
**Qual componente é afetado pela vulnerabilidade?**   
DNSAPI.dll é o componente afetado.
  
**Para que um invasor pode usar a vulnerabilidade?**   
O invasor que explorar a vulnerabilidade com êxito poderá executar código arbitrário no contexto da conta NetworkService. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**De que forma o invasor pode explorar a vulnerabilidade?**   
Nos sistemas Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2, o invasor que exploar com êxito esta vulnerabilidade precisará acessar a rede. O invasor pode criar um programa personalizado para enviar consultas de difusão de LLMNR especialmente criadas para sistemas de destino.
  
Nos sistemas Windows XP e Windows Server 2003, para explorar esta vulnerabilidade, um invasor terá primeiro que se conectar ao sistema. O invasor poderá então executar um aplicativo especialmente criado que pode explorar a vulnerabilidade e elevar privilégios do invasor na conta NetworkService.
  
**Esta vulnerabilidade pode ser explorada remotamente no Windows XP ou Windows Server 2003?**   
Não. Nõa há suporte para LLMNR no Windows XP nem no Windows Server 2003. A vulnerabilidade no cliente DNS ainda existe para esses sistemas e só pode ser explorada localmente executando um aplicativo especialmente criado.
  
**O que é LLMNR?**   
LLMNR (Resolução de Nomes Multicast Local de Link) é um novo protocolo que fornece um método adicional para resolver os nomes de computadores vizinhos. LLMNR é especialmente útil para redes que não possuem um servidor DNS. LLMNR usa uma troca simples de mensagens de solicitação e resposta para resolver nomes de computador para endereços de Protocolo de Internet versão 6 (IPv6) ou IP versão 4 (IPv4). Para obter mais informações sobre LLMNR, consulte o artigo da Microsoft TechNet, [Link-Local Multicast Name Resolution](http://technet.microsoft.com/en-us/library/bb878128.aspx).
...
A atualização elimina a vulnerabilidade, corrigindo a maneira como o cliente DNS processa consultas DNS especialmente criadas.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2509553$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2509553">Artigo 2509553 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Para desinstalar uma atualização instalada pelo WUSA, use a opção de instalação /Uninstall ou clique em <strong>Painel</strong> <strong>de</strong> <strong>Controle</strong> e em <strong>Sistema e Segurança</strong>; depois, no Windows Update, clique em <strong>Exibir atualizações instaladas</strong> e faça sua seleção na lista de atualizações.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2509553">Artigo 2509553 (em inglês) da Microsoft Knowledge Base</a></td>
...
-   Neel Mehta, da [Google Inc.](http://www.google.com/), por relatar a Vulnerabilidade de consulta DNS (CVE-2011-0657)
...
-   V1.1 (13 de março de 2012): Um link para o Artigo 2509553 (em inglês) da Microsoft Knowledge Base foi adicionado à seção Problemas conhecidos na Sinopse.
