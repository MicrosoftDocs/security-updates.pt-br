...
ms:assetid: 'ms11-034'
ms:contentKeyID: 61234379
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-034(v=Security.10)'
---
...
Vulnerabilidades em drivers do modo do kernel do Windows podem permitir a elevação de privilégio (2506223)
----------------------------------------------------------------------------------------------------------
...
A atualização de segurança elimina as vulnerabilidades, corrigindo a maneira como os drivers do modo kernel gerencia os objetos do driver do modo kernel e controla os ponteiros para objetos de driver do modo kernel. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=39e55bbf-c1c5-4696-bfe7-632e997cd98e)                                                                                                          | Elevação de privilégio     | Importante                      | [MS11-012](http://technet.microsoft.com/security/bulletin/ms11-012) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=83771177-284e-4918-86a9-980e8229c7c9)                                                                                 | Elevação de privilégio     | Importante                      | [MS11-012](http://technet.microsoft.com/security/bulletin/ms11-012) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=af320f27-bb3a-4e76-a279-4632267c8761)                                                                                                 | Elevação de privilégio     | Importante                      | [MS11-012](http://technet.microsoft.com/security/bulletin/ms11-012) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9c95f81c-9812-4070-88d7-34422c638e42)                                                                                     | Elevação de privilégio     | Importante                      | [MS11-012](http://technet.microsoft.com/security/bulletin/ms11-012) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=f58cf64a-bf31-4496-be75-5775a123338b)                                                                      | Elevação de privilégio     | Importante                      | [MS11-012](http://technet.microsoft.com/security/bulletin/ms11-012) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b4743167-9614-445a-9e91-10efdac505a8)                                                                        | Elevação de privilégio     | Importante                      | [MS11-012](http://technet.microsoft.com/security/bulletin/ms11-012) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7e410d5c-b9f7-4a63-8300-36b2d57c6128)                                                | Elevação de privilégio     | Importante                      | [MS11-012](http://technet.microsoft.com/security/bulletin/ms11-012) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c6ac26b8-8cc8-40fe-baab-22bf13df1aa8)&#42;                       | Elevação de privilégio     | Importante                      | [MS11-012](http://technet.microsoft.com/security/bulletin/ms11-012) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ac49f5d3-5e2f-4916-99be-a3254278da7e)&#42;             | Elevação de privilégio     | Importante                      | [MS11-012](http://technet.microsoft.com/security/bulletin/ms11-012) |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3b93de4f-01f4-4efd-afc1-31d87b92fad2)       | Elevação de privilégio     | Importante                      | [MS11-012](http://technet.microsoft.com/security/bulletin/ms11-012) |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6e7ff003-ff3f-49bb-8e45-d869885dd8d7)                                             | Elevação de privilégio     | Importante                      | [MS11-012](http://technet.microsoft.com/security/bulletin/ms11-012) |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para Sistemas Service Pack 1 baseados em x-64](http://www.microsoft.com/downloads/details.aspx?familyid=0c0aef7e-501c-4ca3-ae7f-497a8c169121)                                  | Elevação de privilégio     | Importante                      | [MS11-012](http://technet.microsoft.com/security/bulletin/ms11-012) |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=2fc66224-45c6-4e8f-ad00-6a1ec30b4505)&#42;       | Elevação de privilégio     | Importante                      | [MS11-012](http://technet.microsoft.com/security/bulletin/ms11-012) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=485ccf96-27a0-499e-9f52-2836b73d26d2) | Elevação de privilégio     | Importante                      | [MS11-012](http://technet.microsoft.com/security/bulletin/ms11-012) |
...
<th style="border:1px solid black;" >Vulnerabilidade tipo 1:</th>
<th style="border:1px solid black;" >Vulnerabilidade tipo 2:</th>
<th style="border:1px solid black;" >Vulnerabilidade tipo 2:</th>
...
<td style="border:1px solid black;"><strong>Vulnerabilidade de uso após liberação do Win32k</strong><br />
<br />
...
<td style="border:1px solid black;"><strong>Vulnerabilidade de desreferenciação de ponteiro nulo do Win32k</strong><br />
<br />
...
Vulnerabilidade tipo 1: Vulnerabilidade de uso após liberação do Win32k  
-----------------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio devido à maneira como os drivers do modo do kernel do Windows gerencia os objetos de driver do modo kernel. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte:
...
#### Fatores atenuantes da Vulnerabilidade tipo 1: Vulnerabilidade de uso após liberação do Win32k
...
#### Soluções alternativas para a Vulnerabilidade tipo 1: Vulnerabilidade de uso após liberação do Win32k
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade tipo 1: Vulnerabilidade de uso após liberação do Win32k
...
Vulnerabilidade tipo 2: Vulnerabilidade de desreferenciação de ponteiro nulo do Win32k  
--------------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de elevação de privilégio devido à maneira como os drivers do modo do kernel do Windows gerencia ponteiros para os objetos de driver do modo kernel. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
...
#### Fatores atenuantes da Vulnerabilidade tipo 2: Vulnerabilidade de desreferenciação de ponteiro nulo do Win32k
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade. Essa vulnerabilidade não pode ser explorada remotamente por usuários anônimos.
  
#### Soluções alternativas para a Vulnerabilidade tipo 2: Vulnerabilidade de desreferenciação de ponteiro nulo do Win32k
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade tipo 2: Vulnerabilidade de desreferenciação de ponteiro nulo do Win32k
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2506223$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2506223">Artigo 2506223 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Tarjei Mandt, da [Norman](http://www.norman.com/), por relatar a Vulnerabilidade tipo 1: Vulnerabilidade de uso após liberação do Win32k  
    - CVE-2011-0662  
    - CVE-2011-0665  
    - CVE-2011-0666  
    - CVE-2011-0667  
    ...
    - CVE-2011-1241  
    - CVE-2011-1242  
-   Tarjei Mandt, da [Norman](http://www.norman.com/), por relatar a Vulnerabilidade tipo 2: Vulnerabilidade de desreferenciação de ponteiro nulo do Win32k  
    - CVE-2011-0673  
    - CVE-2011-0676  
    - CVE-2011-0677  
    - CVE-2011-1225  
