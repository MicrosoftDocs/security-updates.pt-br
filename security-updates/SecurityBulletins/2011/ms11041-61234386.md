...
ms:assetid: 'ms11-041'
ms:contentKeyID: 61234386
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-041(v=Security.10)'
---
...
Vulnerabilidade em drivers do modo do kernel do Windows podem permitir a execução remota de código (2525694)
------------------------------------------------------------------------------------------------------------
...
Esta atualização de segurança é classificada como Crítica para todas as edições com suporte, com exceção das edições de 32 bits, do Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2; e Importante para todas as edições com suporte, com exceção das edições de 32 bits, do Windows XP e Windows Server 2003. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados** nesta seção.

A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira como o driver do modo de kernel do Windows valida ponteiros ao analisar fontes OpenType. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=035d5115-54b6-41d3-b9f0-890041ead178)                                                                                 | Elevação de privilégio     | Importante                      | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4aa8c003-0353-4a5b-8aea-c01a103af393)                                                                                     | Elevação de privilégio     | Importante                      | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=2e07b5fa-c9fa-495b-9352-c07ce46a7e8b)                                                                      | Elevação de privilégio     | Importante                      | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a519a5d7-bfe3-4e53-99e9-d85f7e34237f)                                                | Execução Remota de Código  | Crítica                         | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cd8f3713-b408-4db6-aecd-7eed2176a715)&#42;             | Execução Remota de Código  | Crítica                         | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5a61f888-c81e-4b8a-8932-2fe67df4b2ad)       | Execução Remota de Código  | Crítica                         | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para Sistemas Service Pack 1 baseados em x-64](http://www.microsoft.com/downloads/details.aspx?familyid=e7f52b13-5b3d-438c-ae14-86da50c8b67a)                                  | Execução Remota de Código  | Crítica                         | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b77e5be6-d3eb-4e3a-9be2-831578f0447c)&#42;       | Execução Remota de Código  | Crítica                         | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=c00a33bc-c874-4693-b0f7-5034c5df9424) | Execução Remota de Código  | Crítica                         | [MS11-034](http://technet.microsoft.com/security/bulletin/ms11-034) |
...
<th style="border:1px solid black;" >Vulnerabilidade de Validação de OTF do Win32k - CVE-2011-1873</th>
...
Vulnerabilidade de Validação de OTF do Win32k - CVE-2011-1873  
-------------------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código devido à maneira como o driver do modo de kernel do Windows analisa incorretamente fontes OpenType especialmente criadas em sistemas baseados em x64 e baseados no Itanium. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1873](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1873).
  
#### Fatores atenuantes da Vulnerabilidade de Validação de OTF do Win32k - CVE-2011-1873
...
#### Soluções alternativas para Vulnerabilidade de Validação de OTF do Win32k - CVE-2011-1873
...
#### Perguntas frequentes sobre a Vulnerabilidade de Validação de OTF do Win32k - CVE-2011-1873
...
A vulnerabilidade é causada quando o driver do modo de kernel do Windows valida ponteiros incorretamente ao analisar fontes OTF.
...
**O que é o formato de Fonte OpenType (OTF)?**  
...
Em um cenário de ataque baseado na Web de ataque, o invasor terá que hospedar um site que aponte para uma fonte OpenType especialmente criada em um compartilhamento de rede. Então, quando o usuário navega até o site, o caminho de controle afetado é disparado pelos painéis de visualização e detalhes no Windows Explorer. A fonte OpenType especialmente criada pode explorar a vulnerabilidade e assumir total controle sobre um sistema afetado. O invasor não tem como forçar um usuário a visitar um site especialmente criado. Em vez disso, o invasor terá de convencer os usuários a visitar o site, normalmente fazendo com que eles cliquem em um link para esse site e, em seguida, convencê-los a abrir o arquivo especialmente criado.
...
**Que tipos de sistemas são afetados por esta vulnerabilidade?**  
Esta vulnerabilidade somente afeta versões baseadas em x64 de sistemas operacionais Windows; versões de 32 bits de sistemas operacionais Windows não são afetadas.
  
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade, corrigindo a maneira como o driver do modo de kernel do Windows valida ponteiros ao analisar fontes OpenType.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong>, no Painel de Controle, ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2525694$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2525694">Artigo 2525694 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
Windows6.1-KB2525694-x64.msu /quite Para todas as edições com suporte</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalar sem reinicializar</td>
<td style="border:1px solid black;">Para todas as edições baseadas em x64 com suporte do Windows 7:<br />
...
-   Koro de [www.korosoft.net](http://www.korosoft.net/) por relatar a Vulnerabilidade de Validação de OTF do Win32k (CVE-2011-1873)
