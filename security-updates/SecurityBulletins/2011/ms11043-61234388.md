...
ms:assetid: 'ms11-043'
ms:contentKeyID: 61234388
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-043(v=Security.10)'
---
...
Vulnerabilidade no cliente SMB pode permitir a execução remota de código (2536276)
----------------------------------------------------------------------------------

Publicado: terça-feira, 14 de junho de 2011 | Atualizado: quarta-feira, 21 de setembro de 2011
...
A atualização de segurança elimina a vulnerabilidade corrigindo a maneira como o cliente SMB manipula respostas SMB especialmente criadas. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Problemas conhecidos.** O [Artigo 2536276 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2536276) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=492310d3-bbb4-4fff-b5fe-3470c17e7681)                                                                                                    | Execução Remota de Código  | Crítica                         | [MS11-019](http://technet.microsoft.com/pt-br/security/bulletin/ms11-019) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e10a4c3c-2ef8-4cfc-ac9b-4d97bfa79ac1)                                                                           | Execução Remota de Código  | Crítica                         | [MS11-019](http://technet.microsoft.com/pt-br/security/bulletin/ms11-019) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2719e0fb-3cfd-47b2-906d-3e07b0e3c978)                                                                                           | Execução Remota de Código  | Crítica                         | [MS11-019](http://technet.microsoft.com/pt-br/security/bulletin/ms11-019) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c962531e-f580-4195-989b-cf348cc96fa7)                                                                               | Execução Remota de Código  | Crítica                         | [MS11-019](http://technet.microsoft.com/pt-br/security/bulletin/ms11-019) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ea18a916-03cf-4eac-bacc-ceb006491f24)                                                                | Execução Remota de Código  | Crítica                         | [MS11-019](http://technet.microsoft.com/pt-br/security/bulletin/ms11-019) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a62edfd8-9016-4bb5-bf48-885498fa0042)                                                                  | Execução Remota de Código  | Crítica                         | [MS10-020](http://technet.microsoft.com/pt-br/security/bulletin/ms10-020) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cb561ba6-af4d-40cc-947c-923f9cca9a7e)                                          | Execução Remota de Código  | Crítica                         | [MS10-020](http://technet.microsoft.com/pt-br/security/bulletin/ms10-020) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8ab9679e-6a69-4ca3-9210-7ca4fb1980c2)&#42;                 | Execução Remota de Código  | Crítica                         | [MS10-020](http://technet.microsoft.com/pt-br/security/bulletin/ms10-020) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=22c63fc3-2c5a-4e50-9026-2e04a6e74210)&#42;       | Execução Remota de Código  | Crítica                         | [MS10-020](http://technet.microsoft.com/pt-br/security/bulletin/ms10-020) |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5bb889de-8ff6-4587-8ef9-ffb13e8d60fd) | Execução Remota de Código  | Crítica                         | [MS10-020](http://technet.microsoft.com/pt-br/security/bulletin/ms10-020) |
| [Windows 7 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=19a15098-1754-4536-a9ca-ff07d16464b7)                                                                                           | Execução Remota de Código  | Crítica                         | [MS10-020](http://technet.microsoft.com/pt-br/security/bulletin/ms10-020) |
| [Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=19a15098-1754-4536-a9ca-ff07d16464b7)                                                                            | Execução Remota de Código  | Crítica                         | Nenhuma                                                                   |
| [Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=b449f23e-b3df-46e5-bfe3-98268d20ad54)                                                                                      | Execução Remota de Código  | Crítica                         | [MS10-020](http://technet.microsoft.com/pt-br/security/bulletin/ms10-020) |
| [Windows 7 para Sistemas Service Pack 1 baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=b449f23e-b3df-46e5-bfe3-98268d20ad54)                                                                       | Execução Remota de Código  | Crítica                         | Nenhuma                                                                   |
| [Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=06008192-3cac-477b-a913-83eed39d8718)&#42;                                                                       | Execução Remota de Código  | Crítica                         | [MS10-020](http://technet.microsoft.com/pt-br/security/bulletin/ms10-020) |
| [Windows Server 2008 R2 para sistemas Service Pack 1 baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=06008192-3cac-477b-a913-83eed39d8718)&#42;                                                        | Execução Remota de Código  | Crítica                         | Nenhuma                                                                   |
| [Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=93a32bd9-7e67-4ace-8c45-116f91b032f9)                                                                     | Execução Remota de Código  | Crítica                         | [MS10-020](http://technet.microsoft.com/pt-br/security/bulletin/ms10-020) |
| [Windows Server 2008 R2 para Sistemas Service Pack 1 baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=93a32bd9-7e67-4ace-8c45-116f91b032f9)                                                      | Execução Remota de Código  | Crítica                         | Nenhuma                                                                   |
...
A Microsoft relançou este boletim para oferecer novamente a atualização de segurança KB2536276 para todos os sistemas operacionais com suporte. A nova oferta desta atualização elimina um problema de estabilidade introduzido pela versão original (V1) da atualização KB2536276. Todos os sistemas operacionais com suporte automaticamente receberão a versão nova desta atualização. Os clientes que já atualizaram seus sistemas devem reinstalar esta atualização.
...
<th style="border:1px solid black;" >Vulnerabilidade de análise de resposta de SMB - CVE-2011-1268</th>
...
Vulnerabilidade de análise de resposta de SMB - CVE-2011-1268  
-------------------------------------------------------------
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1268](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1268).
  
#### Fatores atenuantes da Vulnerabilidade de análise de resposta do SMB - CVE-2011-1268
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   As práticas recomendadas para firewall e as configurações de firewall padrão podem ajudar a proteger as redes contra ataques com origem externa ao perímetro da empresa. Essas práticas também recomendam que os sistemas conectados à Internet tenham um número mínimo de portas expostas. Neste caso, as portas de SMB devem ser bloqueadas para entrada e saída da Internet.
  
#### Soluções alternativas para a vulnerabilidade de análise de resposta do SMB - CVE-2011-1268
...
#### Perguntas frequentes sobre a Vulnerabilidade de análise de resposta do SMB - CVE-2011-1268
...
A vulnerabilidade existe porque a implementação do cliente SMB (Server Message Block) da Microsoft manipula incorretamente respostas SMB especialmente criadas.
...
Todos os sistemas operacionais correm risco.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2536276$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2536276">Artigo 2536276 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da Chave de Registro</strong></td>
<td style="border:1px solid black;">Para todas as versões de 32 bits com suporte do Windows XP:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP\SP4\KB2536276-v2\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas as versões de 64 bits com suporte do Windows XP:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para todas as edições de 32 bits com suporte do Windows Vista:<br />
Windows6.0-KB2536276-v2-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas as edições de 64 bits com suporte do Windows Vista:<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas as edições baseadas em Itanium com suporte do Windows Server 2008:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para todas as edições de 64 bits com suporte do Windows 7:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Para desinstalar uma atualização instalada pelo WUSA, use a opção de instalação /Uninstall ou clique em <strong>Painel</strong> <strong>de Controle</strong> e em <strong>Sistema e Segurança</strong>; depois, no Windows Update, clique em <strong>Exibir atualizações instaladas</strong> e faça sua seleção na lista de atualizações.<strong>OU</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2536276">Artigo 2536276 (em inglês) da Microsoft Knowledge Base</a></td>
...
-   V1.1 (22 de junho de 2011): Um link para o Artigo 2536276 (em inglês) da Microsoft Knowledge Base foi adicionado à seção Problemas conhecidos na Sinopse.  
-   V2.0 (9 de agosto de 2011): Boletim relançado para oferecer novamente a atualização em todos sistemas operacionais com suporte para eliminar um problema de estabilidade. Os clientes que já atualizaram seus sistemas devem reinstalar esta atualização.  
-   V2.1 (21 de setembro de 2011): Foram corrigidas as entradas de verificação de chave do Registro na seção **Implantação de atualização de segurança** para Windows XP e Windows Server 2003.
