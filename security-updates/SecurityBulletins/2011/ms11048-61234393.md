...
ms:assetid: 'ms11-048'
ms:contentKeyID: 61234393
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-048(v=Security.10)'
---
...
Vulnerabilidade no SMB Server pode permitir a negação de serviço (2536275)
--------------------------------------------------------------------------
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5f0007c3-8d11-4940-8766-1112e3777aae)                                                                        | Negação de Serviço         | Importante                      | [MS09-050](http://technet.microsoft.com/security/bulletin/ms09-050) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fadf6f12-1f09-4d49-93b1-8fce01400b4f)                                                | Negação de Serviço         | Importante                      | [MS09-050](http://technet.microsoft.com/security/bulletin/ms09-050) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8960dd62-7cf7-41cb-97b2-b082bd1750aa)\*                       | Negação de Serviço         | Importante                      | [MS09-050](http://technet.microsoft.com/security/bulletin/ms09-050) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0abc6908-ac6a-4da3-843a-af6841ccc1db)\*             | Negação de Serviço         | Importante                      | [MS09-050](http://technet.microsoft.com/security/bulletin/ms09-050) |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=057f1356-9c70-4457-a1df-69334fdab467)       | Negação de Serviço         | Importante                      | [MS09-050](http://technet.microsoft.com/security/bulletin/ms09-050) |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=cf9e5ecd-68f7-4982-b4ed-be80859b757c)                                             | Negação de Serviço         | Importante                      | [MS11-020](http://technet.microsoft.com/security/bulletin/ms11-020) |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para Sistemas Service Pack 1 baseados em x-64](http://www.microsoft.com/downloads/details.aspx?familyid=2707650a-604c-4044-acc4-07a30b5640d8)                                  | Negação de Serviço         | Importante                      | [MS11-020](http://technet.microsoft.com/security/bulletin/ms11-020) |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f9824310-772d-4e1e-980e-11e2db3ac53e)\*       | Negação de Serviço         | Importante                      | [MS11-020](http://technet.microsoft.com/security/bulletin/ms11-020) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=0533d293-e186-4d39-a925-ab3d9ed46290) | Negação de Serviço         | Importante                      | [MS11-020](http://technet.microsoft.com/security/bulletin/ms11-020) |
...
<th style="border:1px solid black;" >Vulnerabilidade de análise de solicitação de SMB - CVE-2011-1267</th>
...
Vulnerabilidade de análise de solicitação de SMB - CVE-2011-1267  
----------------------------------------------------------------
  
<span></span>
Uma vulnerabilidade de negação de serviço existe na maneira como esse software de protocolo SMB (Server Message Block) da Microsoft manipula solicitações de SMB especialmente criadas. Uma tentativa de explorar a vulnerabilidade não requereria autenticação, permitindo a um invasor explorar a vulnerabilidade enviando uma mensagem de rede especialmente criada a um computador executando o serviço Servidor.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1267](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1267).
  
#### Fatores atenuantes para a vulnerabilidade de análise de solicitação de SMB - CVE-2011-1267
...
#### Soluções alternativas para a vulnerabilidade de análise de solicitação de SMB - CVE-2011-1267
...
#### Perguntas frequentes sobre a vulnerabilidade de análise de solicitação de SMB - CVE-2011-1267
...
A vulnerabilidade é causada quando o software de protocolo do Microsoft Server Message Block (SMB) manipula de forma inadequada as solicitações de SMB especialmente criadas.
...
-   Permitindo que uma sessão com um arquivo aberto seja restabelecida depois que uma conexão cliente tornasse temporariamente desconectada.  
...
**Este problema afeta SMBv1 ou SMBv2?**    
Este problema afeta os protocolos SMBv1 e SMBv2.
...
Todos os sistemas com serviço de servidor SMB são afetados por essa vulnerabilidade. Os controladores de domínio correm um grande risco de exploração dessa vulnerabilidade, uma vez que esses sistemas têm compartilhamentos de rede abertos para todos os usuários de domínio por padrão.
  
**O que a atualização faz?**    
A atualização de segurança elimina a vulnerabilidade corrigindo a maneira como o software de protocolo SMB manipula solicitações de SMB especialmente criadas.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2536275">Artigo 2536275 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
