...
ms:assetid: 'ms11-050'
ms:contentKeyID: 61234395
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-050(v=Security.10)'
---
...
Atualização de segurança cumulativa para o Internet Explorer (2530548)
----------------------------------------------------------------------

Publicado: terça-feira, 14 de junho de 2011 | Atualizado: terça-feira, 9 de agosto de 2011
...
Esta atualização de segurança é classificada como Crítica para clientes do Windows, Internet Explorer 6, Internet Explorer 7, Internet Explorer 8, e Internet Explorer 9; e Moderada para Internet Explorer 6 em servidores do Windows. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança aborda as vulnerabilidades modificando o maneira como o Internet Explorer impõe as configurações de conteúdo fornecidas pelo servidor Web, manipula a sanitização do HTML usando toStaticHTML, manipula objetos na memória e script durante determinados processos. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
Sim. Além das alterações que estão listadas na seção **Informação de Vulnerabilidade** deste boletim, esta atualização inclui uma atualização de proteção abrangente para ajudar a aprimorar a proteção da memória no Internet Explorer. Uma das atualizações de defesa abrangente elimina um problema de vazamento de endereço de memória, publicamente referido como [CVE-2011-1346](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1346).
...
<th style="border:1px solid black;" >
Vulnerabilidade de divulgação não autorizada de informações de suspeita de MIME - CVE-2011-1246
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de corrupção de memória no tratamento de propriedades de link - CVE-2011-1250
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de corrupção de memória na manipulação de DOM - CVE-2011-1251
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de divulgação de informações de toStaticHTML - CVE-2011-1252
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de corrupção de memória em arrastar e soltar- CVE-2011-1254
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de corrupção de memória de elemento de tempo - CVE-2011-1255
</th>
</tr>
<tr>
<th colspan="7">
...
<sup>[1]</sup>Classificações de gravidade não se aplicam a esta atualização para o software especificado, porque os vetores de ataque conhecidos para a vulnerabilidade abordada neste boletim são bloqueados em uma configuração padrão. No entanto, como o código vulnerável existe, a Microsoft recomenda que clientes deste software apliquem esta atualização de segurança.
...
<th style="border:1px solid black;" >
Vulnerabilidade de corrupção de memória na modificação de DOM - CVE-2011-1256
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de divulgação de informações de arrastar e soltar- CVE-2011-1258
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de corrupção de memória de layout - CVE-2011-1260
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de corrupção de memória do objeto de seleção - CVE-2011-1261
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de corrupção de memória de redirecionamento de HTTP - CVE-2011-1262
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
<span></span>
Uma vulnerabilidade de divulgação não autorizada de informação existe no Internet Explorer e poderia permitir que um invasor forçasse o navegador a executar ações inesperadas quando um usuário baixasse conteúdo da Web, permitindo a um invasor ver conteúdo de um domínio diferente ou uma zona do Internet Explorer que não seja o domínio ou a zona da página da Web do invasor.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1246](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1246).

#### Fatores atenuantes da Vulnerabilidade de divulgação não autorizada de informações de suspeita de MIME - CVE-2011-1246
...
-   Internet Explorer 6, Internet Explorer 7 e Internet Explorer 9 não são afetados por esta vulnerabilidade.

#### Soluções alternativas para a Vulnerabilidade de divulgação não autorizada de informações de suspeita de MIME - CVE-2011-1246
...
#### Perguntas frequentes sobre a Vulnerabilidade de divulgação não autorizada de informações de suspeita de MIME - CVE-2011-1246

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de divulgação de informações. Um invasor que explorasse a vulnerabilidade quando usuário baixasse conteúdo da Web poderia forçar o navegador a executar ações inesperadas, permitindo que um invasor visse conteúdo de um domínio diferente ou zona do Internet Explorer que não fosse o domínio ou a zona da página da Web do invasor.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando, durante determinados processos, o Internet Explorer incorretamente exibe páginas da Web.

**Para que um invasor pode usar a vulnerabilidade?**  
Um invasor que explorasse com êxito a vulnerabilidade poderia forçar o navegador a executar ações inesperadas, permitindo que um invasor visse conteúdo de um domínio diferente ou zona do Internet Explorer que não fosse o domínio ou a zona da página da Web do invasor.

**De que forma o invasor pode explorar a vulnerabilidade?**  
O invasor pode hospedar um site especialmente criado para explorar esta vulnerabilidade através do Internet Explorer e, então, convencer um usuário a baixar conteúdo do site. O invasor também pode tirar proveito dos sites comprometidos e de sites que aceitam ou hospedam o conteúdo fornecido pelo usuário ou anúncios. Esses sites podem ter conteúdo especialmente criado para explorar essa vulnerabilidade. Em todos os casos, entretanto, um invasor não teria como forçar os usuários a visitarem os sites e baixarem seu conteúdo. Em vez disso, um invasor tem de convencer os usuários a visitar o site e baixar seu conteúdo, geralmente fazendo com que eles cliquem em um link em um email ou por um pedido pelo Instant Messenger que leva o usuário ao site do invasor.
...
Esta vulnerabilidade requer que um usuário faça logon, visitando um site e tentando baixar um conteúdo especificamente criado para que qualquer ação mal-intencionada ocorra. Portanto, os sistemas nos quais o Internet Explorer é usado com frequência, como estações de trabalho ou servidores de terminal, estão mais expostos a essa vulnerabilidade.
...
A atualização aborda a vulnerabilidade modificando a maneira como o Internet Explorer impõe as configurações de conteúdo fornecidas pelo servidor Web.
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1250](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1250).

#### Fatores atenuantes da Vulnerabilidade de corrupção de memória em tratamento de propriedades de link - CVE-2011-1250
...
#### Soluções alternativas da Vulnerabilidade de corrupção de memória em tratamento de propriedades de link - CVE-2011-1250
...
#### Perguntas frequentes sobre a Vulnerabilidade de corrupção de memória em tratamento de propriedades de link - CVE-2011-1250
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1251](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1251).

#### Fatores atenuantes da vulnerabilidade de corrupção de memória de manipulação de DOM - CVE-2011-1251
...
#### Soluções alternativas para a vulnerabilidade de corrupção de memória de manipulação de DOM - CVE-2011-1251
...
#### Perguntas frequentes sobre a vulnerabilidade de corrupção de memória de manipulação de DOM - CVE-2011-1251
...
#### Fatores atenuantes da vulnerabilidade de divulgação de informações de toStaticHTML - CVE-2011-1252
...
-   Por padrão, todas as versões com suporte do Microsoft Outlook, Microsoft Outlook Express e Windows Mail abrem emails em HTML na zona de sites restritos, o que desabilita scripts e controles ActiveX, ajudando a reduzir o risco de um invasor conseguir usar essa vulnerabilidade para executar código mal-intencionado. Se um usuário clicar em um link em uma mensagem de email, ele ainda pode estar vulnerável à exploração dessa vulnerabilidade, por meio do cenário de ataque baseado na Web.
-   Por padrão, o Internet Explorer no Windows Server 2003, Windows Server 2008 e no Windows Server 2008 R2 é executado em um modo restrito, conhecido como [Configuração de Segurança Reforçada](http://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx). Esse modo atenua a vulnerabilidade. Consulte a seção Perguntas frequentes referente a essa vulnerabilidade para obter mais informações sobre a Configuração de Segurança Reforçada do Internet Explorer.
-   O Internet Explorer 6 e o Internet Explorer 9 não são afetados por esta vulnerabilidade.

#### Soluções alternativas para a vulnerabilidade de divulgação de informações de toStaticHTML - CVE-2011-1252
...
#### Perguntas frequentes sobre a vulnerabilidade de divulgação de informações de toStaticHTML - CVE-2011-1252

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de divulgação de informações. Um invasor que explorasse a vulnerabilidade quando o usuário visualizasse uma página da Web que usa o toStaticHTML API poderia executar scripts no contexto de segurança do usuário contra esse site.
...
**Para que um invasor pode usar a vulnerabilidade?**  
Um invasor que com êxito explorasse esta vulnerabilidade poderia executar script no contexto de segurança do usuário contra um site quando um usuário visse HTML no site e a sanitização de dados de usuário executada pelo toStaticHTML API fosse ignorada.
...
**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**  
Esta vulnerabilidade requer que um usuário faça logon e visite um site que usa o toStaticHTML API para sanitizar dados de usuário para que qualquer ação mal-intencionada ocorra. Portanto, os sistemas nos quais o Internet Explorer é usado com frequência, como estações de trabalho ou servidores de terminal, estão mais expostos a essa vulnerabilidade.
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1254](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1254).

#### Fatores atenuantes da Vulnerabilidade de corrupção de memória em arrastar e soltar - CVE-2011-1254

A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:

-   Em um cenário de ataque com base na Web, o invasor pode hospedar um site especialmente projetado para explorar esta vulnerabilidade através do Internet Explorer e, então, convencer um usuário a exibir o site, arrastando e soltando conteúdo nele. O invasor também pode incorporar um controle ActiveX marcado como "seguro para inicialização" em um aplicativo ou documento do Microsoft Office que hospede o mecanismo de processamento do IE. O invasor também pode tirar proveito dos sites comprometidos e de sites que aceitam ou hospedam o conteúdo fornecido pelo usuário ou anúncios. Esses sites podem ter conteúdo especialmente criado para explorar essa vulnerabilidade. Em todos os casos, entretanto, o invasor não tem como forçar os usuários a exibir o conteúdo controlado pelo invasor. Em vez disso, um invasor teria que convencer usuários para tomar medidas, geralmente por clicar em um link em uma mensagem de email ou mensagem do Instant Messenger que leva os usuários ao site do invasor, ou por abrir um anexo enviado por email; além disso, o invasor teria que convencer usuários a executar uma operação de arrastar e soltar.
-   O invasor que explorar com êxito a vulnerabilidade poderá obter os mesmos direitos que o usuário conectado. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
-   Por padrão, todas as versões com suporte do Microsoft Outlook, Microsoft Outlook Express e Windows Mail abrem emails em HTML na zona de sites restritos, o que desabilita scripts e controles ActiveX, ajudando a reduzir o risco de um invasor conseguir usar essa vulnerabilidade para executar código mal-intencionado. Se um usuário clicar em um link em uma mensagem de email, ele ainda pode estar vulnerável à exploração dessa vulnerabilidade, por meio do cenário de ataque baseado na Web.
-   Por padrão, o Internet Explorer no Windows Server 2003, Windows Server 2008 e no Windows Server 2008 R2 é executado em um modo restrito, conhecido como [Configuração de Segurança Reforçada](http://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx). Esse modo atenua a vulnerabilidade. Consulte a seção Perguntas frequentes referente a essa vulnerabilidade para obter mais informações sobre a Configuração de Segurança Reforçada do Internet Explorer.
-   O Internet Explorer 9 não é afetado por esta vulnerabilidade.

#### Soluções alternativas para a Vulnerabilidade de corrupção de memória em arrastar e soltar - CVE-2011-1254
...
#### Perguntas frequentes sobre a Vulnerabilidade de corrupção de memória em arrastar e soltar - CVE-2011-1254
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1255).

#### Fatores atenuantes da Vulnerabilidade de corrupção de memória do elemento de tempo - CVE-2011-1255
...
#### Soluções alternativas para a Vulnerabilidade de corrupção de memória do elemento de tempo - CVE-2011-1255
...
#### Perguntas frequentes sobre a Vulnerabilidade de corrupção de memória do elemento de tempo - CVE-2011-1255
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1256](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1256).

#### Fatores atenuantes da vulnerabilidade de corrupção de memória de modificação de DOM - CVE-2011-1256

A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:

-   Em um cenário de ataque com base na Web, o invasor pode hospedar um site especialmente projetado para explorar esta vulnerabilidade através do Internet Explorer e, então, convencer um usuário a executar operações de copiar e colar enquanto estiver no site do invasor. O invasor também pode incorporar um controle ActiveX marcado como "seguro para inicialização" em um aplicativo ou documento do Microsoft Office que hospede o mecanismo de processamento do IE. O invasor também pode tirar proveito dos sites comprometidos e de sites que aceitam ou hospedam o conteúdo fornecido pelo usuário ou anúncios. Esses sites podem ter conteúdo especialmente criado para explorar essa vulnerabilidade. Em todos os casos, entretanto, o invasor não tem como forçar os usuários a exibir o conteúdo controlado pelo invasor. Em vez disso, o invasor precisa convencer os usuários a executar uma ação, normalmente clicando em um link em uma mensagem de email ou em uma mensagem do Instant Messenger que leve os usuários ao site do invasor ou abrindo um anexo enviado por email.
-   É necessária a interação significativa do usuário para disparar a vulnerabilidade.
-   Por padrão, todas as versões com suporte do Microsoft Outlook, Microsoft Outlook Express e Windows Mail abrem emails em HTML na zona de sites restritos, o que desabilita scripts e controles ActiveX, ajudando a reduzir o risco de um invasor conseguir usar essa vulnerabilidade para executar código mal-intencionado. Se um usuário clicar em um link em uma mensagem de email, ele ainda pode estar vulnerável à exploração dessa vulnerabilidade, por meio do cenário de ataque baseado na Web.
-   Por padrão, o Internet Explorer no Windows Server 2003, Windows Server 2008 e no Windows Server 2008 R2 é executado em um modo restrito, conhecido como [Configuração de Segurança Reforçada](http://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx). Esse modo atenua a vulnerabilidade. Consulte a seção Perguntas frequentes referente a essa vulnerabilidade para obter mais informações sobre a Configuração de Segurança Reforçada do Internet Explorer.
-   O Internet Explorer 9 não é afetado por esta vulnerabilidade.

#### Soluções alternativas para a vulnerabilidade de corrupção de memória de modificação de DOM - CVE-2011-1256
...
#### Perguntas frequentes sobre a vulnerabilidade de corrupção de memória de modificação de DOM - CVE-2011-1256
...
**De que forma o invasor pode explorar a vulnerabilidade?**  
O invasor pode hospedar um site especialmente criado para explorar esta vulnerabilidade através do Internet Explorer e, então, convencer um usuário a executar operações de copiar e colar enquanto estiver no site do invasor. O invasor também pode incorporar um controle ActiveX marcado como "seguro para inicialização" em um aplicativo ou documento do Microsoft Office que hospede o mecanismo de processamento do IE. O invasor também pode tirar proveito dos sites comprometidos e de sites que aceitam ou hospedam o conteúdo fornecido pelo usuário ou anúncios. Esses sites podem ter conteúdo especialmente criado para explorar essa vulnerabilidade. Em todos os casos, entretanto, o invasor não tem como forçar os usuários a exibir o conteúdo controlado pelo invasor. Em vez disso, o invasor precisa convencer os usuários a executar uma ação, normalmente clicando em um link em uma mensagem de email ou em uma mensagem do Instant Messenger que leve os usuários ao site do invasor ou abrindo um anexo enviado por email.

**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**  
Esta vulnerabilidade requer que um usuário faça logon, visitando um site e executando operações de copiar e colar para que qualquer ação mal-intencionada ocorra. Portanto, os sistemas nos quais o Internet Explorer é usado com frequência, como estações de trabalho ou servidores de terminal, estão mais expostos a essa vulnerabilidade.
...
<span></span>
Existe uma vulnerabilidade de divulgação de informações no Internet Explorer que pode permitir que um script obtenha acesso a informações em outro domínio ou zona do Internet Explorer. Um invasor pode explorar esta vulnerabilidade criando uma página da Web especial que pode permitir a divulgação não autorizada de informações se o usuário exibir essa página e realize uma operação de arrastar e soltar. Um invasor que explore com êxito essa vulnerabilidade pode exibir conteúdo de outro domínio ou da zona do Internet Explorer.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1258).

#### Fatores atenuantes da Vulnerabilidade de divulgação de informações em arrastar e soltar - CVE-2011-1258
...
#### Soluções alternativas para a Vulnerabilidade de divulgação de informações em arrastar e soltar - CVE-2011-1258
...
#### Perguntas frequentes sobre a Vulnerabilidade de divulgação de informações em arrastar e soltar - CVE-2011-1258

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de divulgação de informações. Um invasor que explore a vulnerabilidade enquanto um usuário exibe uma página da Web e realize uma operação de arrastar e soltar poderá ver o conteúdo de outro domínio ou zona do Internet Explorer, diferente do domínio ou zona da página da Web do invasor.
...
**De que forma o invasor pode explorar a vulnerabilidade?**  
O invasor pode hospedar um site especialmente projetado para explorar esta vulnerabilidade através do Internet Explorer e, então, convencer um usuário a exibir o site, depois a realizar uma operação de arrastar e soltar. O invasor também pode tirar proveito dos sites comprometidos e de sites que aceitam ou hospedam o conteúdo fornecido pelo usuário ou anúncios. Esses sites podem ter conteúdo especialmente criado para explorar essa vulnerabilidade. Em todos os casos, entretanto, um invasor não teria como forçar os usuários a visitarem os sites. Em vez disso, o invasor teria que persuadir os usuários a visitar o site, geralmente fazendo com que eles cliquem em um link em um email ou em uma mensagem do Instant Messenger que leva o usuário ao site do invasor, e então convencê-los a realizar uma operação de arrastar e soltar. Também é possível exibir conteúdo da Web próprio para a finalidade usando anúncios de banner ou outros métodos para implantar conteúdo da Web nos sistemas afetados.
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1260](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1260).

#### Fatores atenuantes da vulnerabilidade de corrupção de memória de layout - CVE-2011-1260
...
#### Soluções alternativas para a vulnerabilidade de corrupção de memória de layout - CVE-2011-1260
...
#### Perguntas frequentes sobre a vulnerabilidade de corrupção de memória de layout - CVE-2011-1260
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1261](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1261).

#### Fatores atenuantes da vulnerabilidade de corrupção de memória do objeto de seleção - CVE-2011-1261
...
#### Soluções alternativas para a vulnerabilidade de corrupção de memória do objeto de seleção - CVE-2011-1261
...
#### Perguntas frequentes sobre a vulnerabilidade de corrupção de memória do objeto de seleção - CVE-2011-1261
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1262](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1262).

#### Fatores atenuantes da vulnerabilidade de corrupção de memória de redirecionamento de HTTP - CVE-2011-1262
...
#### Soluções alternativas para a vulnerabilidade de corrupção de memória de redirecionamento de HTTP - CVE-2011-1262
...
#### Perguntas frequentes sobre a vulnerabilidade de corrupção de memória de redirecionamento de HTTP - CVE-2011-1262
...
Use a ferramenta <strong>Adicionar ou Remover Programas</strong>, no Painel de Controle, ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2530548$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições do Windows XP com suporte:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\ie7updates\KB2530548-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições com suporte do Windows XP:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\ie8updates\KB2530548-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2530548">Artigo 2530548 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Robert Swiecki, da [Google Inc.](http://www.google.com/), por relatar a Vulnerabilidade de divulgação não autorizada de informação de suspeita de MIME (CVE-2011-1246)  
-   [A Equipe de Segurança da NSFOCUS](http://www.nsfocus.com/) por relatar a Vulnerabilidade de corrupção de memória no tratamento de propriedades de link (CVE-2011-1250)  
-   Um pesquisador anônimo, trabalhando no programa [Beyond Security's SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html), por relatar a Vulnerabilidade de corrupção de memória de manipulação de DOM (CVE-2011-1251)  
-   ADI Cohen, da [IBM Rational Application Security](http://blog.watchfire.com/), por relatar a Vulnerabilidade de divulgação não autorizada de informação de toStaticHTML (CVE-2011-1252)  
-   [Trend Micro](http://www.trendmicro.com/), por trabalhar conosco na Vulnerabilidade de divulgação não autorizada de informação de toStaticHTML (CVE-2011-1252)  
-   Nirmal Singh Bhary, da [Norman](http://www.norman.com), por relatar a Vulnerabilidade de corrupção de memória em arrastar e soltar (CVE-2011-1254)  
-   Um pesquisador anônimo, que trabalha na [VeriSign iDefense Labs](http://labs.idefense.com/), por relatar a Vulnerabilidade de corrupção de memória no elemento de tempo (CVE-2011-1255)  
-   Damian Put, trabalhando com [TippingPoint's](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/), por relatar a vulnerabilidade de corrupção de memória de modificação de DOM (CVE-2011-1256)  
-   Yoel Gluck, Yogesh Badwe e Varun Badhwar, da equipe de Segurança de Produto da [salesforce.com](http://www.salesforce.com/), por relatar a Vulnerabilidade de divulgação de informações de arrastar e soltar (CVE-2011-1258)  
-   Jose Antonio Vazquez Gonzalez, trabalhando na [TippingPoint](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/), por relatar a Vulnerabilidade de corrupção de memória de layout (CVE-2011-1260)  
-   Um pesquisador anônimo, que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [TippingPoint](http://www.tippingpoint.com/), por relatar a vulnerabilidade de corrupção de memória na análise de objeto de seleção (CVE-2011-1261)  
-   Peter Winter-Smith, trabalhando com [TippingPoint](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/), por relatar a Vulnerabilidade de corrupção de memória de redirecionamento de HTTP (CVE-2011-1262)  
-   Stephen Fewer, da [Harmony Security](http://www.harmonysecurity.com/), trabalhando com [TippingPoint](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/), por trabalhar conosco em alterações de proteção abrangente abordadas neste boletim
...
-   V1.1 (9 de agosto de 2011): Esclarecido que uma das alterações de defesa abrangentes incluída nesta atualização de segurança elimina um problema de vazamento de endereço de memória, publicamente referido como CVE-2011-1346. Esta é uma alteração instrutiva apenas.
