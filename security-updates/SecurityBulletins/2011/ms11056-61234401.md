...
ms:assetid: 'ms11-056'
ms:contentKeyID: 61234401
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-056(v=Security.10)'
---
...
Vulnerabilidades no CSRSS (Windows Client/Server Runtime Subsystem) podem permitir elevação de privilégio (2507938)
-------------------------------------------------------------------------------------------------------------------

Publicado: terça-feira, 12 de julho de 2011 | Atualizado: quinta-feira, 21 de julho de 2011
...
Esta atualização de segurança elimina cinco vulnerabilidades relatadas em particular no Microsoft Windows Client/Server Runtime Subsystem (CSRSS). As vulnerabilidades podem permitir elevação de privilégio se um invasor fizer logon em um sistema e executar um aplicativo especialmente criado. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essas vulnerabilidades.
...
A atualização de segurança elimina as vulnerabilidades, não permitindo que vários objetos de console sejam associados a um processo, modificando a maneira como o CSRSS inicializa memória, validando entrada de usuário antes de usá-la como um índice para uma matriz e modificando a verificação de limites para evitar corrupção de memória. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a81c011d-eeea-4383-9efb-df70515ab357">Windows Server 2003 com SP2 para sistemas baseados no Itanium</a></td>
<td style="border:1px solid black;">Elevação de privilégio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms11-010">MS11-010</a><em>,</em><br />
<a href="http://technet.microsoft.com/security/bulletin/ms10-069">MS10-069</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b70209f2-1c51-45af-b3c4-3473aebcdb35">Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2</a></td>
<td style="border:1px solid black;">Elevação de privilégio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhuma</td>
</tr>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=64e5f889-fa46-4884-9b22-3ba4e2fba1b9">Windows 7 para sistemas baseados em x64 e Windows 7 para Sistemas Service Pack 1 baseados em x-64</a></td>
<td style="border:1px solid black;">Elevação de privilégio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhuma</td>
</tr>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=784efc20-3a41-42ab-b48d-51fd59d71523">Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados no Itanium</a></td>
<td style="border:1px solid black;">Elevação de privilégio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhuma</td>
</tr>
...
<th style="border:1px solid black;" >Vulnerabilidade de CSRSS Local EOP AllocConsole - CVE-2011-1281</th>
<th style="border:1px solid black;" >Vulnerabilidade de CSRSS Local EOP SrvSetConsoleLocalEUDC - CVE-2011-1282</th>
<th style="border:1px solid black;" >Vulnerabilidade de CSRSS Local EOP SrvSetConsoleNumberOfCommand - CVE-2011-1283</th>
<th style="border:1px solid black;" >Vulnerabilidade de CSRSS Local EOP SrvWriteConsoleOutput - CVE-2011-1284</th>
<th style="border:1px solid black;" >Vulnerabilidade de CSRSS Local EOP SrvWriteConsoleOutputString - CVE-2011-1870</th>
<th style="border:1px solid black;" >Avaliação de gravidade agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de CSRSS Local EOP AllocConsole - CVE-2011-1281  
---------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégio no Windows CSRSS decorrente da maneira como o CSRSS atribui memória para transações de usuário específicas. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1281](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1281).
  
#### Fatores atenuantes para Vulnerabilidade de CSRSS Local EOP AllocConsole - CVE-2011-1281
...
#### Soluções alternativas para Vulnerabilidade de CSRSS Local EOP AllocConsole - CVE-2011-1281
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre Vulnerabilidade de CSRSS Local EOP AllocConsole - CVE-2011-1281
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Para tentar explorar a vulnerabilidade, o invasor precisa fazer logon localmente no sistema e executar um programa.
  
**O que provoca a vulnerabilidade?**    
Esta vulnerabilidade é causada por uma condição de corrupção de memória que ocorre quando vários objetos de console são associados a um processo. Quando o processo termina, os objetos de console adicionais são abandonados, e este identificador do objeto pode ser obtido por outro processo abandonado com um privilégio mais alto do que o pretendido.
  
**O que é CSRSS (Windows Client/Server Runtime Subsystem)?**    
O CSRSS é a parte do modo do usuário do subsistema Win32 (sendo que o Win32.sys é a parte do modo kernel). É um subsistema essencial que deve ser executado todas as vezes. O CSRSS é responsável pelas janelas do console, criando e/ou excluindo segmentos.
  
**Para que um invasor pode usar a vulnerabilidade?**    
Um invasor que tenha explorado com êxito esta vulnerabilidade pode executar código arbitrário no contexto do sistema. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
...
A atualização elimina esta vulnerabilidade não permitindo que vários objetos de console sejam associados a um processo.
...
Vulnerabilidade de CSRSS Local EOP SrvSetConsoleLocalEUDC - CVE-2011-1282  
-------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégio no Windows CSRSS decorrente da maneira como o CSRSS atribui memória para transações de usuário específicas. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1282](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1282).
  
#### Fatores atenuantes para Vulnerabilidade de CSRSS Local EOP SrvSetConsoleLocalEUDC - CVE-2011-1282
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.
  
#### Soluções alternativas para Vulnerabilidade de CSRSS Local EOP SrvSetConsoleLocalEUDC - CVE-2011-1282
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre Vulnerabilidade de CSRSS Local EOP SrvSetConsoleLocalEUDC - CVE-2011-1282
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Para tentar explorar a vulnerabilidade, o invasor precisa fazer logon localmente no sistema e executar um programa.
  
**O que provoca a vulnerabilidade?**    
Esta é uma vulnerabilidade de corrupção de memória que pode permitir a execução de códigos no contexto do sistema. Um ponteiro NULO é transmitido sem validação a uma função no CSRSS. Isso permite que o CSRSS grave em uma página NULA em seu espaço de processo. Nos sistemas Windows XP, sob determinadas condições, esta página pode ser aproveitada por um invasor para executar código com permissões mais altas.
...
**O que a atualização faz?**    
A atualização elimina esta vulnerabilidade, modificando a maneira que o CSRSS inicializa a memória para impedir a execução de código arbitrário no contexto do sistema.
...
Vulnerabilidade de CSRSS Local EOP SrvSetConsoleNumberOfCommand - CVE-2011-1283  
-------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégio no Windows CSRSS decorrente da maneira como o CSRSS atribui memória para transações de usuário específicas. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1283](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1283).
  
#### Fatores atenuantes para Vulnerabilidade de CSRSS Local EOP SrvSetConsoleNumberOfCommand - CVE-2011-1283
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.
  
#### Soluções alternativas para Vulnerabilidade de CSRSS Local EOP SrvSetConsoleNumberOfCommand - CVE-2011-1283
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre Vulnerabilidade de CSRSS Local EOP SrvSetConsoleNumberOfCommand - CVE-2011-1283
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Para tentar explorar a vulnerabilidade, o invasor precisa fazer logon localmente no sistema e executar um programa.
  
**O que provoca a vulnerabilidade?**    
Esta vulnerabilidade é causada quando a entrada do usuário é usada como um índice para uma matriz, sem verificar primeiro se este é um valor negativo. Isso pode permitir que um invasor leia dados de áreas na memória ou de memória corrompida, de forma que possa permitir execução de códigos.
...
**O que a atualização faz?**    
A atualização elimina essa vulnerabilidade, validando a entrada do usuário antes de usá-la como um índice para uma matriz.
...
Vulnerabilidade de CSRSS Local EOP SrvWriteConsoleOutput - CVE-2011-1284  
------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégio no Windows CSRSS decorrente da maneira como o CSRSS atribui memória para transações de usuário específicas. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1284](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1284).
  
#### Fatores atenuantes para Vulnerabilidade de CSRSS Local EOP SrvWriteConsoleOutput - CVE-2011-1284
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.
  
#### Soluções alternativas para Vulnerabilidade de CSRSS Local EOP SrvWriteConsoleOutput - CVE-2011-1284
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre Vulnerabilidade de CSRSS Local EOP SrvWriteConsoleOutput - CVE-2011-1284
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**    
Esta vulnerabilidade é causada por uma condição de estouro de número inteiro que pode permitir que um invasor execute códigos no contexto da conta de sistema.
...
**O que a atualização faz?**    
A atualização elimina esta vulnerabilidade, modificando a verificação de limites para evitar a corrupção de memória e execução de códigos.
...
Vulnerabilidade de CSRSS Local EOP SrvWriteConsoleOutputString - CVE-2011-1870  
------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégio no Windows CSRSS decorrente da maneira como o CSRSS atribui memória para transações de usuário específicas. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1870).
  
#### Fatores atenuantes para Vulnerabilidade de CSRSS Local EOP SrvWriteConsoleOutputString - CVE-2011-1870
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.
  
#### Soluções alternativas para Vulnerabilidade de CSRSS Local EOP SrvWriteConsoleOutputString - CVE-2011-1870
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre Vulnerabilidade de CSRSS Local EOP SrvWriteConsoleOutputString - CVE-2011-1870
...
**O que a atualização faz?**    
A atualização elimina esta vulnerabilidade, modificando a verificação de limites para evitar a corrupção de memória.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2507938$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2507938">Artigo 2507938 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Matthew ‘j00 ru' Jurczyk, da [Hispasec](http://www.hispasec.com/)[Virustotal](http://www.virustotal.com/), por relatar a Vulnerabilidade de CSRSS Local EOP AllocConsole (CVE-2011-1281)  
-   Matthew ‘j00 ru' Jurczyk, da [Hispasec](http://www.hispasec.com/)[Virustotal](http://www.virustotal.com/), por relatar a Vulnerabilidade de CSRSS Local EOP SrvSetConsoleLocalEUDC (CVE-2011-1282)  
-   Matthew ‘j00 ru' Jurczyk, da [Hispasec](http://www.hispasec.com/)[Virustotal](http://www.virustotal.com/), por relatar a Vulnerabilidade de CSRSS Local EOP SrvSetConsoleNumberOfCommand (CVE-2011-1283)  
-   Matthew ‘j00 ru' Jurczyk, da [Hispasec](http://www.hispasec.com/)[Virustotal](http://www.virustotal.com/), por relatar a Vulnerabilidade de CSRSS Local EOP SrvWriteConsoleOutput (CVE-2011-1284)  
-   Matthew ‘j00 ru' Jurczyk, da [Hispasec](http://www.hispasec.com/)[Virustotal](http://www.virustotal.com/), por relatar a Vulnerabilidade de CSRSS Local EOP SrvWriteConsoleOutputString (CVE-2011-1870)
...
-   V1.1 (21 de julho de 2011): Um link para o Artigo 2507938 (em inglês) da Microsoft Knowledge Base foi adicionado à seção Problemas conhecidos na Sinopse.
