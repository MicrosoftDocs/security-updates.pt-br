...
ms:assetid: 'ms11-059'
ms:contentKeyID: 61234404
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-059(v=Security.10)'
---
...
Vulnerabilidade no Microsoft Data Access Components pode permitir a execução remota de código (2560656)
-------------------------------------------------------------------------------------------------------
...
A atualização de segurança aborda a vulnerabilidade corrigindo a maneira como o componente do Windows Data Access Tracing carrega bibliotecas externas. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6bc168d9-6664-41fb-914f-dbd7514a4b0e)                                             | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para Sistemas Service Pack 1 baseados em x-64](http://www.microsoft.com/downloads/details.aspx?familyid=aafeff2d-db9a-4b3b-b620-be4ec5f5bdcc)                                  | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c29deec3-4672-4658-a550-dce244434cd4)&#42;       | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=1d6b8036-d38f-408a-a36c-027553faefc1) | Execução Remota de Código  | Importante                      | Nenhuma                                    |
...
Sim, a Vulnerabilidade de carregamento não seguro de bibliotecas do Data Access Components (CVE-2011-1975) eliminada por esta atualização está relacionada à classe de vulnerabilidades, descrita no [Comunicado de Segurança da Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637), que afeta como os aplicativos carregam as bibliotecas externas. Esta atualização de segurança elimina uma instância em particular deste tipo de vulnerabilidade.
...
<th style="border:1px solid black;" >Vulnerabilidade de carregamento não seguro de bibliotecas do Data Access Components - CVE-2011-1975</th>
...
Vulnerabilidade de carregamento não seguro de bibliotecas do Data Access Components - CVE-2011-1975  
---------------------------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código na maneira como o Windows Data Access Tracing manipula o carregamento de arquivos DLL. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1975](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1975).
  
#### Fatores atenuantes da Vulnerabilidade de carregamento não seguro de bibliotecas do Data Access Components - CVE-2011-1975
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Para que um ataque seja bem-sucedido, o usuário deve visitar um local de sistema de arquivos remoto não confiável ou compartilhamento de WebDAV e abrir um arquivo do Excel (como, por exemplo, um arquivo .xlsx).  
...
#### Soluções alternativas para a Vulnerabilidade de carregamento não seguro de bibliotecas do Data Access Components - CVE-2011-1975
...
#### Perguntas frequentes sobre a Vulnerabilidade de carregamento não seguro de bibliotecas do Data Access Components - CVE-2011-1975
...
A vulnerabilidade é causada quando o Windows Data Access Components restringe incorretamente o caminho usado para o carregamento de bibliotecas externas.
  
**O que é Windows Data Access Components (Windows DAC)?**    
O Windows Data Access Components (Windows DAC) 6.0 é um conjunto de tecnologias incluídas no Windows Vista, Windows 7, Windows Server 2008 e Windows Server 2008 R2 para fornecer acesso a informações pela empresa. Essas tecnologias incluem Microsoft ActiveX Data Object (ADO), OLE DB e Microsoft Open Database Connectivity (ODBC). Aplicativos de cliente/servidor orientados aos dados e implantados sobre a Web ou uma LAN podem usar estes componentes facilmente para integrar informações de uma variedade de fontes, tanto relacionais (SQL) como não-relacionais. Para obter mais informações, consulte o artigo do MSDN, [Windows Data Access Components SDK](http://msdn.microsoft.com/en-us/library/aa968814(v=vs.85).aspx) (em inglês).
...
Um invasor pode convencer um usuário a abrir um arquivo legítimo do Excel (como um arquivo .xlsx) localizado no mesmo diretório de rede que um arquivo .DLL especialmente criado. Em seguida, ao abrir o arquivo legítimo, o Microsoft Office pode tentar carregar o arquivo .DLL e executar o código contido nele.
  
Em um cenário de ataque por email, um invasor pode explorar a vulnerabilidade enviando um anexo de arquivo do Excel (como um arquivo .xlsx) a um usuário e convencendo o usuário a colocar o anexo em um diretório contendo um arquivo .DLL especialmente criado e a abrir o arquivo legítimo. Em seguida, ao abrir o arquivo legítimo, o Microsoft Office pode tentar carregar o arquivo .DLL e executar o código contido nele.
...
Embora vetores de ataque conhecidos possam aproveitar o software do Microsoft Office, tal como Microsoft Excel, o código vulnerável existe num componente compartilhado do Microsoft Windows.
...
A atualização de segurança aborda a vulnerabilidade corrigindo a maneira como o componente do Windows Data Access Tracing carrega bibliotecas externas.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2560656">Artigo 2560656 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
-   V1.1 (10 de agosto de 2011): Corrigidas as necessidades de reinicialização para a atualização em todos os sistemas operacionais afetados.
