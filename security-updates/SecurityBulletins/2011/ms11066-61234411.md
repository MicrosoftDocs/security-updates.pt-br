...
ms:assetid: 'ms11-066'
ms:contentKeyID: 61234411
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-066(v=Security.10)'
---
...
A vulnerabilidade no Controle de Gráfico da Microsoft pode permitir divulgação não autorizada de informações (2567943)
----------------------------------------------------------------------------------------------------------------------
...
**Problemas conhecidos.** O [Artigo 2567943 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2567943) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=6ca837f7-eda1-4ebe-b48a-8c77f949ebfd">Microsoft .NET Framework 4</a>&#42;&#42;<sup>[1]</sup><br />
(KB2487367)</td>
<td style="border:1px solid black;">Divulgação não autorizada de informação</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhuma</td>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8a80cc03-0db9-4446-9ce6-159ad02cab52">Chart Control para Microsoft .NET Framework 3.5 Service Pack 1</a><br />
(KB2500170)</td>
<td style="border:1px solid black;">Divulgação não autorizada de informação</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhuma</td>
...
**O .NET Framework 3.5 Service Pack 1 afetado por esse problema?**   
Não. Por si mesmo, o .Net Framework 3.5 Service Pack 1 não é afetado por este problema. A vulnerabilidade existe nos Controles de Gráfico da Microsoft que é um complemento para as plataformas do .Net Framework 3.5 Service Pack 1. Os usuários do .Net Framework 3.5 Service Pack 1 que não têm o controle adicional instalado não devem tomar nenhuma providência.
...
**A atualização de segurança está relacionada ao boletim MS11-069?**   
...
<th style="border:1px solid black;" >
Vulnerabilidade de divulgação não autorizada de informações do Controle de Gráfico - CVE-2011-1977  
</th>
<th style="border:1px solid black;" >
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4 no Windows Server 2003 com SP2 para sistemas baseados no Itanium
</td>
<td style="border:1px solid black;">
**Importante**   
Divulgação não autorizada de informação
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4 no Windows Server 2008 para sistemas baseados no Itanium Service Pack 2
</td>
<td style="border:1px solid black;">
**Importante**   
Divulgação não autorizada de informação
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4 no Windows 7 para sistemas baseados em 32 bits e Windows 7 para sistemas baseados em Service Pack 1 com 32 bits
</td>
<td style="border:1px solid black;">
**Importante**   
Divulgação não autorizada de informação
...
<tr>
<td style="border:1px solid black;">
Microsoft .NET Framework 4 no Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados em Itanium\*\*
</td>
<td style="border:1px solid black;">
**Importante**   
Divulgação não autorizada de informação
...
Uma vulnerabilidade de divulgação não autorizada de informações existe quando os Controles de Gráfico da Microsoft manipulam incorretamente os caracteres especiais dentro de um URI especialmente criado. Um invasor que explora com êxito essa vulnerabilidade pode ler o conteúdo de qualquer arquivo no diretório do site ou em seus subdiretórios, como web.config. O arquivo web.config normalmente armazena informações sigilosas. As consequências da divulgação dessas informações dependem da natureza das informações em si. Observe que essa vulnerabilidade não permite que um invasor execute códigos nem aumente seus direitos de usuário diretamente, mas ela pode ser usada para gerar informações úteis que poderiam ser usadas para tentar comprometer ainda mais o sistema afetado.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1977](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1977).

#### Fatores atenuantes para vulnerabilidade de divulgação não autorizada de informações do Controle de Gráficos - CVE-2011-1977

A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:

-   Somente os aplicativos da Web usando o Microsoft Chart Control são afetados por este problema. As instalações padrão do .Net Framework não são afetadas.

#### Soluções alternativas para vulnerabilidade de divulgação não autorizada de informações do Controle de Gráficos - CVE-2011-1977

A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.

#### Perguntas frequentes para vulnerabilidade de divulgação não autorizada de informações do Controle de Gráfico - CVE-2011-1977

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de divulgação de informações. Um invasor que explora com êxito esta vulnerabilidade pode recuperar o conteúdo de qualquer arquivo dentro do aplicativo ASP.NET, incluindo o web.configuração. Observe que esta vulnerabilidade não permite que um invasor execute código nem eleve os direitos de usuário do invasor diretamente, mas pode ser usada para produzir informações que podem ser usadas para tentar comprometer ainda mais o sistema afetado.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade existe porque os Controles de Gráfico verificam incorretamente as funções dentro de URIs especialmente criados.

**O que são os Controles de Gráfico da Microsoft?**  
Os Controles de Gráfico da Microsoft capacitam você a criar páginas ASP.NET ou aplicativos do Windows Forms com gráficos simples, intuitivos e visualmente cativantes para análises estatísticas ou financeiras complexas. Para obter mais informações sobre os Controles de Gráfico, consulta o artigo do MSDN, [Controles de Gráfico](http://msdn.microsoft.com/en-us/library/dd456632.aspx).
...
Um invasor que explora com êxito essa vulnerabilidade pode ler o conteúdo de qualquer arquivo no diretório do site ou em seus subdiretórios, como web.config. O arquivo web.config normalmente armazena informações sigilosas. As consequências da divulgação dessas informações dependem da natureza das informações em si.

**De que forma o invasor pode explorar a vulnerabilidade?**  
Para explorar esta vulnerabilidade, o invasor tem que enviar uma solicitação GET especialmente criada para um servidor afetado hospedando os Controles de Gráfico.

**Quais são os** **sistemas que mais correm riscos com a vulnerabilidade?**  
Os servidores da Web instalado com Controles de Gráfico correm risco com esta vulnerabilidade.

**O que a atualização faz?**  
A atualização aborda a vulnerabilidade corrigindo a maneira com a qual os Controles de Gráfico verificam as funções dentro de URIs especialmente criados.
...
| Chart Control para Microsoft .NET Framework 3.5 Service Pack 1                                                                     | Sim  |
...
| Chart Control para Microsoft .NET Framework 3.5 Service Pack 1                                                                     | Sim               | Sim                        |
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft .NET Framework 4 no Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2487367">Artigo 2487367 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4 em todas as edições de 32 bits com suporte do Windows Server 2003:<br />
NDP40-KB2487367-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4 em todas as edições baseadas em x64 com suporte do Windows Server 2003:<br />
NDP40-KB2487367-x64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4 em todas as edições baseadas no Itanium com suporte do Windows Server 2003:<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4 em todas as edições baseadas em x-64 com suporte do Windows Server 2003 e todas as edições baseadas no Itanium com suporte do Windows Server 2003:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Updates\Microsoft .NET Framework 4 Extended\KB2487367<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</td>
</tr>
</tbody>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4 em todas as edições baseadas em x64 com suporte do Windows Vista:<br />
NDP40-KB2487367-x64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Instalar sem reinicializar</td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4 em todas as edições de 32 bits com suporte do Windows Server 2008:<br />
NDP40-KB2487367-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4 em todas as edições baseadas em x64 com suporte do Windows Server 2008:<br />
NDP40-KB2487367-x64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4 em todas as edições baseadas no Itanium com suporte do Windows Server 2008:<br />
NDP40-KB2487367-IA64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalar sem reinicializar</td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4 em todas as edições baseadas em x-64 com suporte do Windows Server 2008 e todas as edições baseadas no Itanium com suporte do Windows Server 2008:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Updates\Microsoft .NET Framework 4 Extended\KB2487367<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</td>
</tr>
</tbody>
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4 em todas as edições de 32 bits com suporte do Windows 7:<br />
NDP40-KB2487367-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4 em todas as edições baseadas em x64 com suporte do Windows 7:<br />
NDP40-KB2487367-x64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Instalar sem reinicializar</td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4 em todas as edições baseadas em x64 com suporte do Windows Server 2008 R2:<br />
NDP40-KB2487367-x64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft .NET Framework 4 em todas as edições baseadas no Itanium com suporte do Windows Server 2008 R2:<br />
NDP40-KB2487367-IA64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Instalar sem reinicializar</td>
...
| **Implantação**                       |                                                                                                                                                                                                                                                                                                                                                                                                            |
| Instalar sem intervenção do usuário   | MSChart\_KB2500170.exe /q                                                                                                                                                                                                                                                                                                                                                                                  |
| Instalar sem reinicializar            | MSChart\_KB2500170.exe /q /norestart                                                                                                                                                                                                                                                                                                                                                                       |
...
| **Informações sobre o arquivo**       | Consulte o [Artigo 2500170 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2500170)                                                                                                                                                                                                                                                                                               |
| **Verificação da Chave de Registro**  | HKEY\_LOCAL\_MACHINE\\Software\\Microsoft\\NET Framework Chart Setup\\NDP\\v3.5\\Version                                                                                                                                                                                                                                                                                                                   |
...
-   Nico Leidecker e James Forshaw da Context Information Security por relatar a vulnerabilidade de divulgação não autorizada de informações do Controle de Gráfico (CVE-2011-1977)
