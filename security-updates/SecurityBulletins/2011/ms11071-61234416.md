...
ms:assetid: 'ms11-071'
ms:contentKeyID: 61234416
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-071(v=Security.10)'
---
...
Vulnerabilidade nos componentes do Windows pode permitir execução remota de código (2570947)
--------------------------------------------------------------------------------------------

Publicado: terça-feira, 13 de setembro de 2011 | Atualizado: terça-feira, 8 de novembro de 2011
...
A atualização de segurança aborda a vulnerabilidade corrigindo a maneira como os componentes do Windows carregam bibliotecas externas. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=70f944b0-9bf0-4168-b150-67d2ff68df2d)                                                                                                          | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4b9debed-edbb-43e1-b755-0faf01980289)                                                                                 | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d44274d2-0401-4fd8-bc4f-c59f6d81c34f)                                                                                                 | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=935720ee-cee0-42c2-965e-ce1b07e95e1a)                                                                                     | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=78c2ac72-da89-42a4-bff9-79551b5d3c4e)                                                                      | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=15840336-4886-4a1b-8c1e-2c535c3938f7)                                                                                                       | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e80739b4-89bb-4317-8381-991244a71cb8)                                                                                           | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=05c39ab3-7b57-4147-8913-df5df6005799)&#42;                                                                      | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1499d988-fd55-4317-b859-ec170907d547)&#42;                                                                 | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6e2d2ea9-0af6-4d23-875d-3211722cd62f)                                                               | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=76b99ab2-7e99-4aad-a419-7996bae05c48)                                             | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas baseados em x-64 e Windows 7 para Sistemas Service Pack 1 baseados em x-64](http://www.microsoft.com/downloads/details.aspx?familyid=0f6d32de-d3ff-4af9-9b26-a4f12581f5fe)                                 | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x-64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=a8a451bd-3e5c-4845-9941-daabd9418776)&#42;      | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=0fdfb1f9-20b3-4d61-8019-33d1003290c8) | Execução Remota de Código  | Importante                      | Nenhuma                                    |
...
**Por que este boletim foi relançado em 8 de novembro de 2011? ** 
A Microsoft relançou este boletim para anunciar a disponibilização de uma atualização para o Windows 7 Embedded. Recomendamos que os clientes que estejam executando essa plataforma baixem e apliquem a atualização em seus sistemas. As atualizações de segurança estão disponíveis no [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) e no [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130). Nenhum outro pacote de atualização é afetado por este relançamento.
...
Sim, a Vulnerabilidade de carregamento não seguro de bibliotecas dos componentes do Windows (CVE-2011-1991) eliminada por esta atualização está relacionada à classe de vulnerabilidades descrita no [Comunicado de Segurança da Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637), que afeta como os aplicativos carregam as bibliotecas externas. Esta atualização de segurança elimina uma instância em particular deste tipo de vulnerabilidade.
...
<th style="border:1px solid black;" >Vulnerabilidade de carregamento não seguro de bibliotecas de componentes do Windows - CVE-2011-1991</th>
...
Vulnerabilidade de carregamento não seguro de bibliotecas de componentes do Windows - CVE-2011-1991  
---------------------------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de execução remota de código na maneira como certos componentes do Windows controlam o carregamento de arquivos DLL. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1991](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1991).
  
#### Fatores atenuantes da Vulnerabilidade de carregamento não seguro de bibliotecas de componentes do Windows - CVE-2011-1991
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Para que um ataque seja bem-sucedido, o usuário deve visitar um local de sistema de arquivos remotos não confiáveis ou compartilhamento WebDAV e abrir um arquivo em formato rich text (.rtf), um arquivo de texto (.txt) ou um documento do Word (.doc).  
...
#### Soluções alternativas para a Vulnerabilidade de carregamento não seguro de bibliotecas de componentes do Windows - CVE-2011-1991
...
#### Perguntas frequentes sobre a Vulnerabilidade de carregamento não seguro de bibliotecas de componentes do Windows - CVE-2011-1991
...
A vulnerabilidade é causada quando componentes específicos do Windows restringem incorretamente o caminho usado para o carregamento de bibliotecas externas.
  
**Que componentes são abordados pela vulnerabilidade?**   
O Display Panning CPL Extension (deskpan.dll), Microsoft EAPHost Authenticator Service, Microsoft Management Console (MMC), Folder Redirection, Japanese Input Method Editor (IME) e HyperTerminal são componentes abordados por essa atulização.
  
**O que é Display Panning Control Panel Application (CPL) Extension?**   
Display Panning CPL Extension (deskpan.dll) é um módulo relacionado às configurações de exibição de imagens que aparecem numa tela do usuário. Junto com DLLs associadas, essa extensão permite que usuários ajustem as propriedades avançadas de adaptador de vídeo e propriedades do monitor de exibição.
  
**O que é o Microsoft EAPHost Authenticator Service?**   
EAPHost é um componente de conexão em rede do Microsoft Windows que fornece uma infraestrutura de EAP (Protocolo de autenticação extensível) para a autenticação de implementações de protocolo "suplicante", tal como 802.1X e Point-to-Point (PPP). Ele também permite a autenticação com as tecnologias de "autenticador", tal como o servidor de diretiva de rede da Microsoft (NPS). Para obter mais informações, consulte o artigo do MSDN [Extensible Authentication Protocol Host](http://msdn.microsoft.com/en-us/library/aa364249(v=vs.85).aspx) (em inglês).
  
**O que é o Microsoft Management Console (MMC)?**   
O Microsoft Management Console (MMC) é um serviço de apresentação comum extensível para aplicativos de gerenciamento. O MMC fornece um ambiente comum de host para snap-ins, fornecido pela Microsoft e fornecedores de software de terceiros. Os snap-ins fornecem o comportamento real de gerenciamento; o MMC em si não fornece nenhuma funcionalidade de gerenciamento. O ambiente de MMC fornece uma integração uniforme entre snap-ins. Para obter mais informações, consulte o artigo do TechNet (em inglês), [Microsoft Management Console - Overview](http://technet.microsoft.com/en-us/library/bb742441.aspx).
  
**O que é o componente Folder Redirection (Redirecionamento de pastas)?**   
O Redirecionamento de pastas é um recurso da Intellmirror que permite que usuários e administradores redirecionem o caminho de uma pasta para um novo local. O novo local pode ser uma pasta no computador local ou um diretório num compartilhamento de rede. Os usuários têm a capacidade de trabalhar com documentos num servidor como se os documentos fossem baseados na unidade local. Por exemplo, você pode redirecionar a pasta Meus documentos, que geralmente é armazenada no disco rígido local do computador, para um local de rede. Os documentos na pasta estão disponíveis ao usuário de qualquer computador na rede. Para obter mais informações, consulte o artigo do TechNet (em inglês), [Folder Redirection Overview](http://technet.microsoft.com/en-us/library/cc778976(ws.10).aspx).
  
**O que é o componente Input Method Editor (Japanese)?**   
O Japanese Input Method Editor (IME) permite que usuários digitem texto em japonês em seus documentos, planilhas, apresentações, mensagens, publicações e páginas da Web. Para obter mais informações sobre este e outros IMEs disponíveis, consulte o artigo do MSDN (em inglês), [Installing and Using Input Method Editors](http://msdn.microsoft.com/en-us/library/ee418266%28v=vs.85%29.aspx).
  
**O que é HyperTerminal?**   
HyperTerminal é um programa que você pode usar para conectar-se a outros computadores, sites da Telnet, sistemas de quadro de avisos (BBSs), serviços online e computadores host, usando seu modem, um cabo neutro de modem ou conexão Ethernet.
  
**Por que múltiplos componentes são listados para esta vulnerabilidade?**   
Embora múltiplos componentes sejam listados para esta única vulnerabilidade, a causa raiz do problema é compartilhada entre todos os componentes.
...
Um invasor pode convencer um usuário a abrir um arquivo legítimo em formato rich text (.rtf), um arquivo de texto (.txt) ou um documento do Word (.doc) localizado no mesmo diretório de rede que um arquivo de biblioteca de link dinâmico (DLL) especialmente criado. Em seguida, ao abrir o arquivo, o componente afetado pode tentar carregar o arquivo DLL e executar qualquer código contido nele.
  
Em um cenário de ataque de email, um invasor pode explorar a vulnerabilidade enviando um anexo em formato rich text (.rtf), um arquivo de texto (.txt) ou um documento do Word (.doc) a um usuário, convencendo-o a colocar o anexo em um diretório que contenha um arquivo DLL especialmente criado e a abrir o arquivo legítimo. Em seguida, ao abrir o arquivo, o componente afetado pode tentar carregar o arquivo DLL e executar qualquer código contido nele.
  
Em um cenário de ataque à rede, um invasor pode colocar um arquivo em formato rich text (.rtf), um arquivo de texto (.txt) ou um documento do Word (.doc) e um arquivo DLL especialmente criado em uma rede compartilhada, em um UNC ou em um local WebDAV, e então convencer o usuário a abrir o arquivo.
...
A atualização aborda a vulnerabilidade corrigindo a maneira como os componentes do Windows carregam bibliotecas externas. A atualização também corrige entradas de chave do Registro para restringir o carregamento de bibliotecas externas.
...
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2011-1991](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1991) da lista Common Vulnerability and Exposure.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover</strong> <strong>Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2570947$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Informações sobre o arquivo</td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2570947">Artigo 2570947 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Verificação da Chave de Registro</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2570947$\Spuninst</td>
</tr>
<tr class="odd">
...
-   V2.0 (8 de novembro de 2011): Boletim relançado para anunciar a disponibilização de uma atualização para o Windows 7 Embedded. Nenhum outro pacote de atualização é afetado por este relançamento.
