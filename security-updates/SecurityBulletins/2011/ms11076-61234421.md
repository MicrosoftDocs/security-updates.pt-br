...
<sup>[1]</sup>Consulte a observação <sup>[2]</sup> abaixo sobre o Windows Media Center TV Pack para Windows Vista.
...
Vulnerabilidade de carregamento não seguro de biblioteca do Media Center - CVE-2011-2009  
----------------------------------------------------------------------------------------
