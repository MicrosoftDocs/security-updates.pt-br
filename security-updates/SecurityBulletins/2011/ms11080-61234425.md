...
ms:assetid: 'ms11-080'
ms:contentKeyID: 61234425
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-080(v=Security.10)'
---
...
Vulnerabilidade no Ancillary Function Driver pode permitir elevação de privilégio (2592799)
-------------------------------------------------------------------------------------------
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=f1b2dceb-5bef-4522-9001-8dff0545d805)                                     | Elevação de privilégio     | Importante                      | [MS11-046](http://technet.microsoft.com/pt-br/security/bulletin/ms11-046) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9a37864e-8543-4c52-aa73-e3c190860d76)            | Elevação de privilégio     | Importante                      | [MS11-046](http://technet.microsoft.com/pt-br/security/bulletin/ms11-046) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=29228167-b811-43d7-b4a0-91e385b598a5)                            | Elevação de privilégio     | Importante                      | [MS11-046](http://technet.microsoft.com/pt-br/security/bulletin/ms11-046) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0816d729-6769-4ca6-a14e-71750eca8d29)                | Elevação de privilégio     | Importante                      | [MS11-046](http://technet.microsoft.com/pt-br/security/bulletin/ms11-046) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=42465652-2664-4fd5-9a22-ae847b08e7c8) | Elevação de privilégio     | Importante                      | [MS11-046](http://technet.microsoft.com/pt-br/security/bulletin/ms11-046) |
...
<th style="border:1px solid black;" >Vulnerabilidade de elevação de privilégio do Ancillary Function Driver - CVE-2011-2005</th>
...
Vulnerabilidade de elevação de privilégio do Ancillary Function Driver - CVE-2011-2005  
--------------------------------------------------------------------------------------
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte CVE-2011-2005.
  
#### Fatores atenuantes da vulnerabilidade de elevação de privilégio do Ancillary Function Driver - CVE-2011-2005
...
#### Soluções alternativas da vulnerabilidade de elevação de privilégio do Ancillary Function Driver - CVE-2011-2005
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a vulnerabilidade de elevação de privilégio do Ancillary Function Driver - CVE-2011-2005
...
Para o SMS 2003, a ferramenta Inventário do SMS 2003 para Microsoft Updates pode ser usada pelo SMS para detectar as atualizações de segurança oferecidas pelo Microsoft Update e que tenham suporte do [Windows Server Update Services](http://go.microsoft.com/fwlink/?linkid=50120). Para obter mais informações sobre a ITMU do SMS 2003, consulte Inventory Tool do SMS 2003 para Microsoft Updates. Para obter mais informações sobre as ferramentas de varredura de SMS, consulte SMS 2003 Software Update Scanning Tools. Consulte também Downloads para Systems Management Server 2003.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2592799$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaçõessobre</strong> <strong>o</strong> <strong>arquivo</strong></td>
<td style="border:1px solid black;">Consulte o Artigo 2592799 (em inglês) da Microsoft Knowledge Base</td>
</tr>
<tr class="even">
...
-   Bo Zhou, da National University of Defense Technology, por relatar a Vulnerabilidade de elevação de privilégio do Ancillary Function Driver (CVE-2011-2005)
