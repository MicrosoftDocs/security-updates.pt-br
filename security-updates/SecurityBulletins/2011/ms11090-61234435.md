...
-   **no Windows XP e Windows Server 2003**
    ...
    **Aviso** O uso incorreto do Editor do Registro pode causar problemas graves e exigir a reinstalação do sistema operacional. A Microsoft não garante a solução de problemas resultantes do uso incorreto do Editor do Registro. Você é responsável pelo uso do Editor do Registro.
    ...
    1.  Crie uma cópia de backup das chaves do registro, executando os seguintes comandos em um prompt de comando elevado:  
        `Regedit.exe /e Disable_datime_backup1,reg HKEY_CLASSES_ROOT\CLSID\{33FDA1EA-80DF-11d2-B263-00A0C90D6111}Regedit.exe /e Disable_datim``e_backup2,reg HKEY_CLASSES_ROOT\CLSID\{476c391c-3e0d-11d2-b948-00c04fa32195}`

    2.  Depois, salve o seguinte em um arquivo com a extensão .REG como, por exemplo, **Disable\_Time.reg**:  
        `Windows Registry Editor Versão 5.00[-HKEY_CLASSES_ROOT\CLSID\{33FDA1EA-80DF-11d2-B26``3-00A0C90D6111}][-HKEY_CLASSES_ROOT\CLSID\{476c391c-3e0d-11d2-b948-00c04fa32195}]`  
