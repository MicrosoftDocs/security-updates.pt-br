...
ms:assetid: 'ms11-099'
ms:contentKeyID: 61234444
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-099(v=Security.10)'
---
...
Atualização de segurança cumulativa para o Internet Explorer (2618444)
----------------------------------------------------------------------

Publicado: terça-feira, 13 de dezembro de 2011 | Atualizado: terça-feira, 10 de janeiro de 2012
...
Esta atualização de segurança resolve três vulnerabilidades relatadas em particular no Internet Explorer. A vulnerabilidade mais severa pode permitir a execução remota de código se um usuário abrir um arquivo legítimo de HTML (Hypertext Markup Language) localizado no mesmo diretório de um arquivo DLL (biblioteca de vínculo dinâmico) especialmente criado.

Esta atualização de segurança é classificada como Importante para o Internet Explorer 7, Internet Explorer 8 e Internet Explorer 9 em clientes Windows e para o Internet Explorer 9 para Windows Server 2008 R2. Essa atualização de segurança também é classificada como Moderada para o Internet Explorer 6 em todas as edições com suporte do Windows XP. Esta atualização de segurança também é classificada como Baixa para o Internet Explorer em servidores Windows (exceto Windows Server 2008 R2). Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização elimina as vulnerabilidades modificando o comportamento do Filtro de XSS no Internet Explorer, corrigindo a maneira como o Internet Explorer carrega bibliotecas externas e corrigindo a maneira como o Internet Explorer impõe as configurações de conteúdo fornecidas pelo servidor da Web. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Problemas conhecidos.** O [Artigo 2618444 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2618444) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
**Por que este boletim foi revisado em 10 de janeiro de 2012?**  
A Microsoft revisou este boletim a fim de anunciar que esta atualização, MS11-099, capacita as proteções fornecidas na atualização da [Vulnerabilidade no SSL/TLS pode permitir divulgação não autorizada de informações](http://go.microsoft.com/fwlink/?linkid=232510), MS12-006, para o Internet Explorer. Para obter mais informações, consulte [MS12-006](http://go.microsoft.com/fwlink/?linkid=232510).

**Como esta atualização de segurança está relacionada a MS12-006** **e CVE-2011-3389?**  
A [Vulnerabilidade no SSL/TLS pode permitir divulgação não autorizada de informações](http://go.microsoft.com/fwlink/?linkid=232510), MS12-006, aborda a Vulnerabilidade de protocolos SSL e TLS ([CVE-2011-3389](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3389)) que afeta o WinHTTP e possibilita a ativação da proteção em todo o sistema. Esta atualização, MS11-099, ativa essas proteções para o Internet Explorer. Para obter mais informações, consulte [MS12-006](http://go.microsoft.com/fwlink/?linkid=232510).
...
<th style="border:1px solid black;" >
Vulnerabilidade de divulgação não autorizada de informações do filtro XSS - CVE-2011-1992
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de carregamento não seguro de biblioteca do Internet Explorer - CVE-2011-2019
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de divulgação não autorizada de informações de Content-Disposition - CVE-2011-3404
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Existe uma vulnerabilidade de divulgação não autorizada de informações no Internet Explorer. Um invasor pode explorar a vulnerabilidade criando uma página da Web especialmente desenvolvida que contém código JavaScript mal-intencionada. Um invasor que explore com êxito essa vulnerabilidade pode exibir conteúdo de outro domínio ou da zona do Internet Explorer.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1992](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1992).

#### Fatores atenuantes da Vulnerabilidade de divulgação não autorizada de informações do filtro XSS - CVE-2011-1992
...
#### Soluções alternativas para a Vulnerabilidade de divulgação não autorizada de informações do filtro XSS - CVE-2011-1992
...
-   **Disativar filtro** **XSS**

    **Aviso** O uso incorreto do Editor do Registro pode causar problemas graves e exigir a reinstalação do sistema operacional. A Microsoft não garante a solução de problemas resultantes do uso incorreto do Editor do Registro. Você é responsável pelo uso do Editor do Registro.

    1.  Salve o seguinte em um arquivo com uma extensão .REG como, por exemplo **Disable\_XSS\_Filter.reg**:

        `Windows Registry Editor Versão 5.00[HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Internet Explorer\MAIN\FeatureControl\FEATURE_XSSFILTER]"iexplorer.exe"=dword:00000000[HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Internet Explorer\MAIN\FeatureControl\FEATURE_XSSFILTER]"iexplorer.exe"=dword:00000000`

    2.  Execute o arquivo **Disable\_XSS\_Filter.reg** com o comando a seguir em um prompt de comando elevado:

        `Regedit.exe /s Disable_XSS_Filter.reg`

    **Impacto da solução alternativa.** Proteções fornecidas pelo Filtro XSS do Internet Explorer 8 e Internet Explorer 9 estão desabilitadas.

    **Como desfazer a solução alternativa.**

    Restaure o estado original, executando os seguintes comandos em um prompt de comando elevado:

    1.  Salve o seguinte em um arquivo com uma extensão .REG como, por exemplo, **Enable\_XSS\_Filter.reg**:

        `Windows Registry Editor Versão 5.00[HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Internet Explorer\MAIN\FeatureControl\FEATURE_XSSFILTER]"iexplorer.exe"=dword:00000001[HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Internet Explorer\MAIN\FeatureControl\FEATURE_XSSFILTER]"iexplorer.exe"=dword:00000001`

    2.  Execute o comando **Enable\_XSS\_Filter.reg** com o comando a seguir em um prompt de comando elevado:

        `Regedit.exe /s Enable_XSS_Filter.reg`

#### Perguntas frequentes sobre a Vulnerabilidade de divulgação não autorizada de informações do filtro XSS - CVE-2011-1992
...
Esta vulnerabilidade requer que um usuário visite um site para que uma ação mal-intencionada ocorra. Portanto, os sistemas nos quais o Internet Explorer é usado com frequência, como estações de trabalho ou servidores de terminal, estão mais expostos a essa vulnerabilidade.
...
A atualização elimina a vulnerabilidade, modificando o comportamento do Filtro XSS do Internet Explorer.
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-2019](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2019).

#### Fatores atenuantes da Vulnerabilidade de carregamento não seguro de biblioteca do Internet Explorer - CVE-2011-2019
...
#### Soluções alternativas para a Vulnerabilidade de carregamento não seguro de biblioteca do Internet Explorer - CVE-2011-2019
...
#### Perguntas frequentes sobre a Vulnerabilidade de carregamento não seguro de biblioteca do Internet Explorer - CVE-2011-2019
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-3404](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3404).

#### Fatores atenuantes da Vulnerabilidade de divulgação de informações de Content-Disposition - CVE-2011-3404
...
#### Soluções alternativas para a Vulnerabilidade de divulgação de informações de Content-Disposition - CVE-2011-3404
...
-   **Ler emails em texto sem formatação**
    ...
    Microsoft Outlook 2003, 2007 de Microsoft Outlook e Microsoft Outlook 2010 fornecem uma opção para ler mensagens de email em formato de texto sem formatação. Para obter mais informações sobre **Ler todas as mensagens-padrão em texto sem formatação**, consulte o [artigo 831607 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/831607).
...
#### Perguntas frequentes sobre a Vulnerabilidade de divulgação de informações de Content-Disposition - CVE-2011-3404

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de divulgação de informações. Um invasor que explorar a vulnerabilidade quando usuário visitar um site poderá forçar o navegador a executar ações inesperadas, permitindo que um invasor visualize conteúdo de um domínio diferente ou zona do Internet Explorer que não seja o domínio ou a zona da página da Web do invasor.
...
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2618444$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições do Windows XP com suporte:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\ie7updates\KB2618444-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições com suporte do Windows XP:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\ie8updates\KB2618444-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2618444">Artigo 2618444 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Thomas Stehle por relatar a Vulnerabilidade de divulgação não autorizada de informações do Filtro XSS (CVE-2011-1992)  
-   Andy Cooper, da [Citrix Security Team](http://www.citrix.com), por relatar a Vulnerabilidade de carregamento não seguro de biblioteca do Internet Explorer (CVE-2011-2019)  
-   [Robert Swiecki](http://www.swiecki.net), da [Google Inc.](http://www.google.com/), por relatar a Vulnerabilidade de divulgação de informações de Content-Disposition (CVE-2011-3404)  
-   [Yosuke Hasegawa](http://utf-8.jp/) por trabalhar conosco na Vulnerabilidade de divulgação não autorizada de informações de Content-Disposition (CVE-2011-3404)  
-   [Jan Schejbal](http://janschejbal.wordpress.com/) por trabalhar conosco em alterações de defesa abrangentes incluídas neste boletim.
...
-   V1.1 (13 de dezembro de 2011): Foram corrigidos fatores atenuantes da vulnerabilidade CVE-2011-1992. Foram corrigidas as classificações de gravidade da vulnerabilidade CVE-2011-3404. Estas são apenas alterações instrutivas. Não houve nenhuma alteração à lógica de detecção ou aos arquivos da atualização de segurança.  
-   V1.2 (10 de janeiro de 2012): Anunciado que esta atualização, MS11-099, capacita as proteções fornecidas na atualização da Vulnerabilidade no SSL/TLS pode permitir divulgação não autorizada de informações, MS12-006, para o Internet Explorer. Para obter mais informações, consulte as Perguntas frequentes de atualização.
