...
ms:assetid: 'ms12-001'
ms:contentKeyID: 61234446
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-001(v=Security.10)'
---
...
Vulnerabilidade no kernel do Windows pode permitir o desvio do recurso de segurança (2644615)
---------------------------------------------------------------------------------------------

Publicado: terça-feira, 10 de janeiro de 2012 | Atualizado: quarta-feira, 22 de fevereiro de 2012
...
**Problemas conhecidos.** O [artigo 2644615 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2644615) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|---------------------------------|--------------------------------------------|
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=46386269-6e37-4710-bfef-cedfe60d881c)                                                                                 | Desvio de recurso de segurança | Importante                      | Nenhuma                                    |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9cdfc0fe-8f43-4e13-8a1f-2b48ff9ff472)                                                                                                 | Desvio de recurso de segurança | Importante                      | Nenhuma                                    |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e5783aa-6847-404c-9b75-621fa14ebbb8)                                                                                     | Desvio de recurso de segurança | Importante                      | Nenhuma                                    |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=cdf8208c-d55b-428f-bdd3-26e291dfb08d)                                                                      | Desvio de recurso de segurança | Importante                      | Nenhuma                                    |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=44eeb0a2-ae17-4971-8a7e-e25b260c582c)                                                                                                       | Desvio de recurso de segurança | Importante                      | Nenhuma                                    |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=79ceba86-59a1-4138-a5de-8df20ad81b02)                                                                                           | Desvio de recurso de segurança | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ab87c6c-5802-4454-bce4-12501e5b816d)\*                                                                      | Desvio de recurso de segurança | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=726ff17e-ac90-4832-91e7-46f71ad2f868)\*                                                                 | Desvio de recurso de segurança | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ba2c3d57-1bdd-44f2-9233-86c7ea6f0ddb)                                                               | Desvio de recurso de segurança | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0ee22036-b7f4-40f5-8f40-a77e8faf48b2)                                             | Desvio de recurso de segurança | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7444e20c-9821-4c91-9779-2728c537dd6a)                                   | Desvio de recurso de segurança | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x-64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4c73a16d-e9fa-48de-9dca-a6360ce3d029)\*      | Desvio de recurso de segurança | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=1cc14ee8-f035-4bfc-bf38-33c6b9a2e776) | Desvio de recurso de segurança | Importante                      | Nenhuma                                    |
...
<th style="border:1px solid black;" >Vulnerabilidade de desvio de SafeSEH do kernel do Windows - CVE-2012-0001</th>
...
Vulnerabilidade de desvio de SafeSEH do kernel do Windows - CVE-2012-0001  
-------------------------------------------------------------------------
  
 
Existe uma vulnerabilidade de desvio de recurso de segurança no Windows devido à maneira como o kernel carrega as tabelas de manuseio de exceção estruturadas. Um invasor que explorar com êxito esta vulnerabilidade pode ignorar o mecanismo de proteção abrangente do SafeSEH para facilitar a exploração de outras vulnerabilidades.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0001](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0001).
  
#### Fatores atenuantes da Vulnerabilidade de desvio de SafeSEH do kernel do Windows - CVE-2012-0001
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Somente aplicativos de software que foram compilados usando Microsoft Visual C++ .NET 2003 poderão ser usados para explorar esta vulnerabilidade. **Observação**
  
#### Soluções alternativas para a Vulnerabilidade de desvio de SafeSEH do kernel do Windows - CVE-2012-0001
...
-   **software**  
-   **usando**  
-   **uma versão mais atual do**  
-   **Microsoft Visua**  
-   **l**  
-   **C++**
  
    Somente aplicativos de software que foram compilados usando Microsoft Visual C++ .NET 2003 poderão ser usados para explorar esta vulnerabilidade. Para solucionar este problema, recompile o modelo usando o Microsoft Visual C++ 2005, Microsoft Visual C++ 2008 ou Microsoft Visual C++ 2010.
...
-   **)**
    ...
    Para os sistemas Windows Vista, Windows 7, Windows Server 2008 e Windows Server 2008 R2, consulte [How to enable Structured Exception Handling Overwrite Protection (SEHOP) in Windows operating systems](http://support.microsoft.com/kb/956607) (pode estar em inglês) para obter instruções sobre como ativar o SEHOP nos aplicativos existentes.
  
#### Perguntas frequentes sobre a Vulnerabilidade de desvio de SafeSEH do kernel do Windows - CVE-2012-0001
  
**Qual é o escopo da vulnerabilidade?**   
Esta é uma vulnerabilidade de desvio de recurso de segurança. Um invasor que explorar com êxito esta vulnerabilidade pode ignorar o recurso de segurança do SafeSEH para facilitar a exploração de outras vulnerabilidades.
  
**O que provoca a vulnerabilidade?**   
A vulnerabilidade é causada quando o kernel do Windows carrega uma tabela de manuseio de exceção estruturada no cabeçalho PE "Load Configuration" durante a execução binária.
...
Ntdll.dll é o componente afetado pela vulnerabilidade.
  
**Para que um invasor pode usar a vulnerabilidade?**   
Um invasor que explorar com êxito esta vulnerabilidade pode ignorar o recurso de segurança do SafeSEH em um aplicativo de software. Um invasor pode usar outras vulnerabilidades para aproveitar o manipulador de exceção estruturado para executar código arbitrário.
  
**De que forma o invasor pode explorar a vulnerabilidade?**   
Para usar esta vulnerabilidade para executar código arbitrário, um invasor primeiro tem que ignorar o recurso de segurança do SafeSEH e tirar proveito desta condição de desvio de segurança para explorar outra vulnerabilidade para executar código arbitrário.
  
**O que** **é Structured** **Exception Handler?**   
O Structured Exception Handler (SEH) é um mecanismo em um aplicativo de software para manipular exceções de hardware e software. O SEH permite que os programadores tenham total controle sobre o manuseio de exceções, fornece suporte para depuradores e pode ser usado em todas as linguagens de programação e máquinas.
  
**O que é SafeSEH?**   
SafeSEH é um recurso de segurança que impede o Structured Exception Handler de ser corrompido ou sequestrado no caso de um estouro de buffer.
  
**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**   
Estações de trabalho e servidores correm riscos com essa vulnerabilidade.
  
**O que a atualização faz?**   
A atualização elimina a vulnerabilidade, modificando a maneira como o kernel do Windows carrega tabelas de manuseio de exceção estruturada.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2644615$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2644615">Artigo 2644615 Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Joshua J. Drake, da [Accuvant LABS](http://www.accuvant.com/), por relatar a Vulnerabilidade de desvio de SafeSEH do kernel do Windows (CVE-2012-0001)
...
-   V1.1 (22 de fevereiro de 2012): Um link para o Artigo 2644615 (em inglês) da Microsoft Knowledge Base foi adicionado à seção Problemas conhecidos na Sinopse.
