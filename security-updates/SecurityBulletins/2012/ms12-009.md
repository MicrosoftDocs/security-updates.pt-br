...
ms:assetid: 'ms12-009'
ms:contentKeyID: 61234531
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-009(v=Security.10)'
---
...
Vulnerabilidades no Ancillary Function Driver pode permitir elevação de privilégio (2645640)
--------------------------------------------------------------------------------------------
...
Esta atualização de segurança elimina duas vulnerabilidades relatadas em particular no Microsoft Windows. As vulnerabilidades podem permitir elevação de privilégio se um invasor fizer logon em um sistema e executar um aplicativo especialmente criado. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essas vulnerabilidades.

Esta atualização de segurança foi classificada como Importante para todas as edições com suporte do Windows XP (exceto as edições baseadas em x86), Windows Server 2003, Windows Vista (exceto as edições baseadas em x86), Windows Server 2008 (exceto as edições baseadas em x86), Windows 7 (exceto as edições baseadas em x86)e Windows Server 2008 R2. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança resolve as vulnerabilidades corrigindo a maneira como o AFD valida a entrada antes de passar a entrada de modo de usuário ao kernel do Windows. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.

**Recomendação.** A maioria dos clientes tem o recurso de atualizações automáticas habilitado e não precisará tomar nenhuma providência porque esta atualização de segurança será baixada e instalada automaticamente. Os clientes que não têm o recurso de atualizações automáticas habilitado precisarão verificar as atualizações e instalar esta atualização manualmente. Para obter informações sobre opções específicas de configuração na atualização automática, consulte o [Artigo 294871 da Microsoft Knowledge Base](http://support.microsoft.com/kb/294871). A Microsoft recomenda que os clientes apliquem a atualização assim que possível usando software de gerenciamento de atualização ou verificando se há atualizações no serviço [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747).
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------------|
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=82f5c503-d2ea-4fed-8f9d-f30bee2f60b3)                                                                                 | Elevação de privilégio     | Importante                      | [MS11-080](http://technet.microsoft.com/pt-br/security/bulletin/ms11-080) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ee4bef7-b355-4aae-8bba-834a16d44744)                                                                                                 | Elevação de privilégio     | Importante                      | [MS11-080](http://technet.microsoft.com/pt-br/security/bulletin/ms11-080) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b53cf810-0ea3-4cb0-91f9-de1406ccfc96)                                                                                     | Elevação de privilégio     | Importante                      | [MS11-080](http://technet.microsoft.com/pt-br/security/bulletin/ms11-080) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3b18d22d-e192-498b-a105-b946a5f5bfad)                                                                      | Elevação de privilégio     | Importante                      | [MS11-080](http://technet.microsoft.com/pt-br/security/bulletin/ms11-080) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=73e240a6-2d5e-4ceb-8500-8dacca0e4a43)                                                                                           | Elevação de privilégio     | Importante                      | [MS11-046](http://technet.microsoft.com/pt-br/security/bulletin/ms11-046) |
| [Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0e06e77d-7e5d-4d57-98b2-0817f68a1ebb)\*                                                                 | Elevação de privilégio     | Importante                      | [MS11-046](http://technet.microsoft.com/pt-br/security/bulletin/ms11-046) |
| [Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=56cbeba9-0c39-4418-9042-7244ac9d03db)                                                               | Elevação de privilégio     | Importante                      | [MS11-046](http://technet.microsoft.com/pt-br/security/bulletin/ms11-046) |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=299d107d-ab9f-42b6-8f94-a2f1d242c127)                                   | Elevação de privilégio     | Importante                      | [MS11-046](http://technet.microsoft.com/pt-br/security/bulletin/ms11-046) |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x-64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=576192d3-f050-4718-a7da-c84fce6bf744)\*      | Elevação de privilégio     | Importante                      | [MS11-046](http://technet.microsoft.com/pt-br/security/bulletin/ms11-046) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=d6a9b2c9-7582-4953-8ab1-a55c63fcc8dc) | Elevação de privilégio     | Importante                      | [MS11-046](http://technet.microsoft.com/pt-br/security/bulletin/ms11-046) |
...
**Por que o Windows Server 2003 Service Pack 2 é a única versão de 32 bits do Windows afetada neste boletim?**  
Esta atualização de segurança elimina duas vulnerabilidades, CVE-2012-0148 e CVE-2012-0149. A primeira não afeta nenhuma edição de 32 bits do Windows, enquanto a outra afeta as edições com suporte do Windows Server 2003, inclusive as edições de 32 bits. Portanto, o Windows Server 2003 Service Pack 2 é a única edição de 32 bits do Windows incluída como software afetado neste boletim.
...
<th style="border:1px solid black;" >Vulnerabilidade de elevação de privilégio do AfdPoll - CVE-2012-0148</th>
<th style="border:1px solid black;" >Vulnerabilidade de elevação de privilégio do Ancillary Function Driver - CVE-2012--0149</th>
...
Vulnerabilidade de elevação de privilégio do AfdPoll - CVE-2012-0148  
--------------------------------------------------------------------
  
 
Existe uma vulnerabilidade de elevação de privilégios no Ancillary Function Driver (afd.sys) devido à validação incorreta da entrada transmitida do modo de usuário para o kernel do Windows. A vulnerabilidade pode permitir que um invasor execute código com privilégios elevados. Um invasor local que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. Um invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0148](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0148).
  
#### Fatores atenuantes da Vulnerabilidade de elevação de privilégio do AfdPoll - CVE-2012-0148
...
#### Soluções alternativas para a Vulnerabilidade de elevação de privilégio do AfdPoll - CVE-2012-0148
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade de elevação de privilégio do AfdPoll - CVE-2012-0148
...
A vulnerabilidade é causada quando o driver afd.sys valida impropriamente a entrada ao passar receber dados do modo de usuário.
...
Vulnerabilidade de elevação de privilégio do Ancillary Function Driver - CVE-2012--0149  
---------------------------------------------------------------------------------------
  
 
Existe uma vulnerabilidade de elevação de privilégios no Ancillary Function Driver (afd.sys) devido à validação incorreta da entrada transmitida do modo de usuário para o kernel do Windows. A vulnerabilidade pode permitir que um invasor execute código com privilégios elevados. Um invasor local que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. Um invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0149](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0149).
  
#### Fatores atenuantes da vulnerabilidade de elevação de privilégio do Ancillary Function Driver - CVE-2012-0149
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.
  
#### Soluções alternativas para a Vulnerabilidade de elevação de privilégio do Ancillary Function Driver - CVE-2012-0149
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade de elevação de privilégio do Ancillary Function Driver - CVE-2012-0149
...
<td style="border:1px solid black;">Use o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB2645640$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2645640">Artigo 2645640 da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Tarjei Mandt da [Azimuth Security](http://www.azimuthsecurity.com/) por relatar a Vulnerabilidade de elevação de privilégio de AdfPoll (CVE-2012-0148)  
-   Tarjei Mandt da [Azimuth Security](http://www.azimuthsecurity.com/) por relatar a Vulnerabilidade de elevação de privilégio de AdfPoll (CVE-2012-0149)
