...
ms:assetid: 'ms12-018'
ms:contentKeyID: 61234540
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-018(v=Security.10)'
---
...
Vulnerabilidade nos drivers do modo do kernel do Windows pode permitir a elevação de privilégio (2641653)
---------------------------------------------------------------------------------------------------------
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=2922411c-9755-461b-9904-f6940322af19)                                                                                                          | Elevação de privilégio     | Importante                      | [MS12-008](http://technet.microsoft.com/pt-br/security/bulletin/ms12-008) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e72b6b1f-68f5-4e1a-878e-290a5f03ca30)                                                                                 | Elevação de privilégio     | Importante                      | [MS12-008](http://technet.microsoft.com/pt-br/security/bulletin/ms12-008) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=599e5db1-3bf1-4d44-bc7c-81bc545c58ec)                                                                                                 | Elevação de privilégio     | Importante                      | [MS12-008](http://technet.microsoft.com/pt-br/security/bulletin/ms12-008) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=482c2890-8d4c-4e13-820f-d5ff256b6a3a)                                                                                     | Elevação de privilégio     | Importante                      | [MS12-008](http://technet.microsoft.com/pt-br/security/bulletin/ms12-008) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ccd0f116-73c2-4471-a6d9-e07d1dbdd406)                                                                      | Elevação de privilégio     | Importante                      | [MS12-008](http://technet.microsoft.com/pt-br/security/bulletin/ms12-008) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f4e73a92-583b-4352-b19d-7a8e3ef162b7)                                                                                                       | Elevação de privilégio     | Importante                      | [MS12-008](http://technet.microsoft.com/pt-br/security/bulletin/ms12-008) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ead9d29b-becf-448e-bff4-d5bb12d02c64)                                                                                           | Elevação de privilégio     | Importante                      | [MS12-008](http://technet.microsoft.com/pt-br/security/bulletin/ms12-008) |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dd547364-f6bb-453c-9e4d-6b80dfc47fbb)\*                                                                      | Elevação de privilégio     | Importante                      | [MS12-008](http://technet.microsoft.com/pt-br/security/bulletin/ms12-008) |
| [Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=%205ff65fc2-5969-4d7e-9c72-9a2096dafdcf)\*                                                              | Elevação de privilégio     | Importante                      | [MS12-008](http://technet.microsoft.com/pt-br/security/bulletin/ms12-008) |
| [Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=eeb5385c-fb81-4d33-af2a-986e6cf14ee2)                                                               | Elevação de privilégio     | Importante                      | [MS12-008](http://technet.microsoft.com/pt-br/security/bulletin/ms12-008) |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=75fd93ff-5be5-42b5-ab00-3378e545c271)                                             | Elevação de privilégio     | Importante                      | [MS12-008](http://technet.microsoft.com/pt-br/security/bulletin/ms12-008) |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=71ffba4c-d816-45a9-abef-131915885bc8)                                   | Elevação de privilégio     | Importante                      | [MS12-008](http://technet.microsoft.com/pt-br/security/bulletin/ms12-008) |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x-64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=22d6a234-6447-4854-8119-4fddd3c6e1bb)\*      | Elevação de privilégio     | Importante                      | [MS12-008](http://technet.microsoft.com/pt-br/security/bulletin/ms12-008) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=cb5ac981-e8e5-4df7-84bb-7a2a916d0ce9) | Elevação de privilégio     | Importante                      | [MS12-008](http://technet.microsoft.com/pt-br/security/bulletin/ms12-008) |
...
Classificação de gravidade e Identificadores de vulne rabilidade
----------------------------------------------------------------
...
<th style="border:1px solid black;" >Vulnerabilidade da função de PostMessage - CVE-2012-0157</th>
...
Vulnerabilidade da função de PostMessage - CVE-2012-0157  
--------------------------------------------------------
  
 
Existe uma vulnerabilidade de elevação de privilégio na maneira como o driver do modo do kernel do Windows gerencia a função de PostMessage. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0157](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0157).
  
#### Fatores atenuantes da Vulnerabilidade da função de PostMessage - CVE-2012-0157
...
#### Soluções alternativas para a Vulnerabilidade da função de PostMessage - CVE-2012-0157
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade da função de PostMessage - CVE-2012-0157
  
**Qual** **é o escopo da vulnerabilidade?**   
Esta é uma vulnerabilidade de elevação de privilégio.
  
**O que provoca a vulnerabilidade?**   
A vulnerabilidade é causada quando o driver do modo de kernel do Windows gerencia incorretamente a entrada transmitida pela função PostMessage.
...
A atualização elimina a vulnerabilidade, corrigindo a maneira como o driver do modo do kernel do Windows gerencia o sistema de mensagens da janela.
...
<td style="border:1px solid black;">Use o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB2641653$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2641653">Artigo 2641653 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   por relatar a Vulnerabilidade da função de PostMessage (CVE-2012-0157)
