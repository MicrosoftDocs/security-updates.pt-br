...
ms:assetid: 'ms12-024'
ms:contentKeyID: 61234546
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-024(v=Security.10)'
---
...
Vulnerabilidade no Windows pode permitir a execução remota de código (2653956)
------------------------------------------------------------------------------

Publicado: terça-feira, 10 de abril de 2012 | Atualizado: terça-feira, 31 de julho de 2012
...
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular no Microsoft Windows. A vulnerabilidade pode permitir a execução remota de código se um usuário ou aplicativo executar ou instalar um arquivo portátil assinado (PE) especialmente criado em um sistema afetado.
...
A atualização de segurança elimina a vulnerabilidade modificando a maneira como a função de Verificação de Assinatura Authenticode do Windows executa a verificação de assinatura do Authenticode do Windows ao verificar arquivos executáveis portáteis. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Problemas conhecidos.** O [artigo 2653956 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2653956) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
<td style="border:1px solid black;">KB978601 em <a href="http://technet.microsoft.com/pt-br/security/bulletin/ms10-019">MS10-019</a> substituído por KB2653956</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=734ff97a-7d72-4bfe-9557-7fac91902f8e">Windows Server 2003 com SP2 para sistemas baseados no Itanium</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Crítica</td>
<td style="border:1px solid black;">KB978601 em <a href="http://technet.microsoft.com/pt-br/security/bulletin/ms10-019">MS10-019</a> substituído por KB2653956</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1ec74522-ec1e-4b3c-bfeb-6a505cc4f11a">Windows Server 2008 para sistemas baseados no Itanium Service Pack 2</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Crítica</td>
<td style="border:1px solid black;">KB978601 em <a href="http://technet.microsoft.com/pt-br/security/bulletin/ms10-019">MS10-019</a> substituído por KB2653956</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=27226e64-266f-499e-8c57-866593fc3430">Windows 7 para Sistemas Service Pack 1 baseados em x64</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Crítica</td>
<td style="border:1px solid black;">Nenhuma</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=54db1495-31bb-4435-a442-74e484630b8a">Windows Server 2008 R2 para sistemas Service Pack 1 baseados em x64</a>\*<br />
(KB2653956)</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Crítica</td>
<td style="border:1px solid black;">Nenhuma</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9a4115bf-028b-4dcc-8995-d3341fdf42f2">Windows Server 2008 R2 para sistemas baseados no Itanium</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Crítica</td>
<td style="border:1px solid black;">KB978601 em <a href="http://technet.microsoft.com/pt-br/security/bulletin/ms10-019">MS10-019</a> substituído por KB2653956</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9a4115bf-028b-4dcc-8995-d3341fdf42f2">Windows Server 2008 R2 para Sistemas Service Pack 1 baseados em Itanium</a><br />
(KB2653956)</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Crítica</td>
<td style="border:1px solid black;">Nenhuma</td>
...
Sim. A atualização KB2653956 está disponível para a versão Windows Developer Preview. Recomendamos que os clientes do Windows Developer Preview apliquem a atualização em seus sistemas. A atualização só está disponível no [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
  
**O Windows8 ConsumerPreview é afetado pela vulnerabilidade abordada neste boletim?**    
Sim. A atualização KB2653956 está disponível para a versão Windows 8 Consumer Preview. Recomendamos que os clientes do Windows Consumer Preview apliquem a atualização em seus sistemas. A atualização só está disponível no [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
  
**Eu apliquei esta atualização e agora a assinatura digital do meu software está inválida. O que devo fazer?**  
Esta atualização faz com que a função de Verificação de Assinatura Authenticode do Windows para executar a verificação estrita de arquivos PE. Os arquivos PE serão considerados "sem assinatura" se o Windows puder identificar o conteúdo que não se conforma com a especificação de Authenticode no arquivo. Isso pode causar impacto em alguns instaladores. Se você estiver usando um instalador que tenha sofrido impacto, a Microsoft recomenda usar um instalador que só extraia conteúdo de porções validadas do arquivo assinado.
  
Os arquivos PE também serão considerados "sem assinatura" se o conteúdo adicional for anexado ao arquivo depois que a assinatura tiver sido aplicada. O aplicativo que está assinando deve ser a etapa final no processo de criação antes do lançamento de binários. Para obter mais informações sobre esses e outros problemas conhecidos nesta atualização de segurança, consulte o [artigo 2653956 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2653956).
  
**Esta atualização contém alterações à funcionalidade relacionadas à segurança?**  
Sim. Além das alterações que estão listadas na seção Informações sobre a vulnerabilidade deste boletim, esta atualização inclui uma atualização de proteção abrangente para ajudar a aprimorar os recursos relacionados à segurança no Windows.
...
<th style="border:1px solid black;" >Vulnerabilidade de validação de assinatura de WinVerifyTrust - CVE-2012-0151</th>
<th style="border:1px solid black;" >Avaliação de gravidade agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de validação de assinatura de WinVerifyTrust - CVE-2012-0151  
----------------------------------------------------------------------------
  
 
Existe uma vulnerabilidade de execução remota de código na função Verificação de Assinatura Authenticode do Windows usada para formatos de arquivos executáveis portáteis (PE). Um invasor anônimo pode explorar a vulnerabilidade modificando um arquivo executável assinado existente para aprimorar partes não verificadas do arquivo de modo a adicionar código mal-intencionado ao arquivo sem invalidar a assinatura. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0151](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0151).
  
#### Fatores atenuantes da Vulnerabilidade de validação de assinatura WinVerifyTrust - CVE-2012-0151
...
#### Perguntas frequentes sobre a Vulnerabilidade de validação de assinatura WinVerifyTrust - CVE-2012-0151
  
**Qual é o escopo da vulnerabilidade?**   
Essa é uma vulnerabilidade de execução remota de código.
  
**O que provoca a vulnerabilidade?**   
A vulnerabilidade é causada quando a função de Verificação de Assinatura Authenticode do Windows valida a síntese de arquivo de um arquivo PE especialmente criado.
  
**O que é a função Verificação de Assinatura Authenticode do Windows?**  
A função Verificação de Assinatura Authenticode do Windows, ou WinVerifyTrust, executa uma ação de verificação de confiança em um objeto especificado. A função passa a consulta para um provedor de confiabilidade que aceita o identificador de ação, caso exista um. A função WinVerifyTrust executa duas ações: assinatura verificando um objeto especificado e uma ação de verificação de confiança. Para obter informações técnicas sobre a função WinVerifyTrust, consulte o artigo de MSDN, [função WinVerifyTrust](http://msdn.microsoft.com/en-us/library/aa388208(vs.85).aspx).
  
Para obter uma apresentação para Authenticode, consulte o artigo de MSDN, [Apresentação para assinatura de código](http://msdn.microsoft.com/en-us/library/ff562046(v=vs.85).aspx).
...
A exploração desta vulnerabilidade requer que um usuário ou um aplicativo seja executado ou instale um arquivo PE assinado especialmente criado. Um invasor pode modificar um arquivo assinado existente para incluir código mal-intencionado, sem invalidar a assinatura. Este código pode ser executado no contexto do privilégio em que ele foi lançado.
...
Em um cenário de ataque com base na Web, o invasor terá que hospedar um site que contenha um arquivo PE especialmente criado. Além disso, sites comprometidos e sites que aceitem ou hospedem conteúdo fornecido pelo usuário podem conter conteúdo especialmente criado que pode ser usado para explorar esta vulnerabilidade. Um invasor não teria como forçar os usuários a visitarem um site hospedando o arquivo PE especialmente criado. Em vez disso, o invasor teria que convencer os usuários a visitar o site, geralmente fazendo com que eles cliquem em um link em um e-mail ou mensagem do Instant Messenger que leva o usuário ao site do invasor.
  
**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**   
Estações de trabalho e servidores são as principais vítimas dessa vulnerabilidade.
  
**O que a atualização faz?**   
A atualização elimina a vulnerabilidade modificando a maneira como a função de Verificação de Assinatura Authenticode do Windows executa a verificação de assinatura do Authenticode do Windows ao verificar arquivos executáveis portáteis.
...
<td style="border:1px solid black;">Use o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB2653956$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaçõessobre</strong> <strong>o</strong> <strong>arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2653956">Artigo 2653956 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Robert Zacek e Igor Glucksmann de [Software Avast](http://www.avast.com/) para relatar a Vulnerabilidade de validação de assinatura WinVerifyTrust (CVE-2012-0151)
...
-   V1.1 (31 de julho de 2012): Boletim revisado para anunciar uma alteração de detecção nos pacotes do Windows Vista para KB2653956 a fim de corrigir um problema de nova oferta do Windows Update. Esta é apenas uma alteração de detecção. Os clientes que já atualizaram seus sistemas com êxito não precisam fazer mais nada.
