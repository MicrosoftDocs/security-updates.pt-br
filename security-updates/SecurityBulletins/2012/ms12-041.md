...
ms:assetid: 'ms12-041'
ms:contentKeyID: 61234563
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-041(v=Security.10)'
---

Microsoft Security Bulletin MS12-041 - Importante
=================================================

Vulnerabilidades nos drivers do modo kernel do Windows podem permitir a elevação de privilégio (2709162)
--------------------------------------------------------------------------------------------------------
...
A atualização de segurança aborda as vulnerabilidades corrigindo a maneira como os drivers do modo kernel do Windows validam a entrada passada do modo de usuário e controlam o tipo de fonte TrueType, introduzindo mais validação de tempo de execução ao mecanismo de criação de threads. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
<td style="border:1px solid black;">
KB2641653 no [MS12-018](http://technet.microsoft.com/pt-br/security/bulletin/ms12-018) substituído por KB2709162
</td>
</tr>
...
<th style="border:1px solid black;" >
Vulnerabilidade de controle de nome da classe atom da string - CVE-2012-1864
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de controle de nome da classe atom da string - CVE-2012-1865
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de controle de nome atom no formato de área de transferência - CVE-2012-1866
</th>
</tr>
<tr>
<td style="border:1px solid black;">
...
<th style="border:1px solid black;" >
Vulnerabilidade de estouro de número inteiro refcount de recurso de fonte - CVE-2012-1867
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de condição forçada Win32k.sys - CVE-2012-1868
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-1864](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1864).

#### Fatores atenuantes da Vulnerabilidade de controle de nome da classe atom da string - CVE-2012-1864
...
#### Soluções alternativas para a Vulnerabilidade de controle de nome da classe atom da string - CVE-2012-1864

A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.

#### Perguntas frequentes sobre a Vulnerabilidade de controle de nome da classe atom da string - CVE-2012-1864
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-1865](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1865).

#### Fatores atenuantes da Vulnerabilidade de controle de nome da classe atom da string - CVE-2012-1865

A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:

-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.

#### Soluções alternativas para a Vulnerabilidade de controle de nome da classe atom da string - CVE-2012-1865

A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.

#### Perguntas frequentes sobre a Vulnerabilidade de controle de nome da classe atom da string - CVE-2012-1865
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-1866](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1866).

#### Fatores atenuantes da Vulnerabilidade de controle de nome atom no formato de área de transferência - CVE-2012-1866

A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:

-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.

#### Soluções alternativas para a Vulnerabilidade de controle de nome atom no formato de área de transferência - CVE-2012-1866

A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.

#### Perguntas frequentes sobre a Vulnerabilidade de controle de nome atom no formato de área de transferência - CVE-2012-1866
...
Existe uma vulnerabilidade de elevação de privilégio uma vez que os drivers do modo do kernel do Windows não alocam corretamente memória ao controlar fontes. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-1867](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1867).

#### Fatores atenuantes da Vulnerabilidade de estouro de número inteiro refcount de recurso de fonte - CVE-2012-1867

A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:

-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.

#### Soluções alternativas para a Vulnerabilidade de estouro de número inteiro refcount de recurso de fonte - CVE-2012-1867

A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.

#### Perguntas frequentes sobre a Vulnerabilidade de estouro de número inteiro refcount de recurso de fonte - CVE-2012-1867

**Qual é o escopo da vulnerabilidade?**   
Esta é uma vulnerabilidade de elevação de privilégio.

**O que provoca a vulnerabilidade?**   
A vulnerabilidade é causada quando um driver do modo kernel do Windows falha ao controlar adequadamente a carga da fonte TrueType.
...
Existe uma vulnerabilidade de elevação de privilégio no kernel do Windows devido à maneira como o kernel lida com tentativas de criação de threads específicas. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-1868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1868).

#### Fatores atenuantes da Vulnerabilidade de condição forçada Win32k.sys - CVE-2012-1868

A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:

-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.

#### Soluções alternativas para a Vulnerabilidade de condição forçada Win32k.sys - CVE-2012-1868

A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.

#### Perguntas frequentes sobre a Vulnerabilidade de condição forçada Win32k.sys - CVE-2012-1868

**Qual é o escopo da vulnerabilidade?**   
Esta é uma vulnerabilidade de elevação de privilégio.

**O que provoca a vulnerabilidade?**   
Esta vulnerabilidade é causada por uma condição de corrida ao criar tipos específicos de threads.
...
<td style="border:1px solid black;">Use o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2709162$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaçõessobre</strong> <strong>o</strong> <strong>arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2709162">Artigo 2709162 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Tarjei Mandt da [Azimuth Security](http://www.azimuthsecurity.com/) por relatar a Vulnerabilidade de controle de nome da classe atom da string (CVE-2012-1864)  
-   Tarjei Mandt da [Azimuth Security](http://www.azimuthsecurity.com/) por relatar a Vulnerabilidade de condição forçada Win32k.sys (CVE-2012-1865)  
-   Tarjei Mandt da [Azimuth Security](http://www.azimuthsecurity.com/) por relatar a Vulnerabilidade de controle de nome atom no formato de área de transferência (CVE-2012-1866)  
-   [Mateusz “j00 ru" Jurczyk](http://j00ru.vexillium.org)  
-   da  
-   [Google Inc.](http://www.google.com)  
-   por relatar a Vulnerabilidade de estouro de número inteiro refcount de recurso de fonte (CVE-2012-1867)
