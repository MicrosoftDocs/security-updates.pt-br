---
TOCTitle: 'MS12-046'
Title: 'Microsoft Security Bulletin MS12-046 - Importante'
ms:assetid: 'ms12-046'
ms:contentKeyID: 61234568
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-046(v=Security.10)'
---

Microsoft Security Bulletin MS12-046 - Importante
=================================================

Vulnerabilidade no Visual Basic for Applications pode permitir a execução remota de código (2707960)
----------------------------------------------------------------------------------------------------

Publicado: terça-feira, 10 de julho de 2012 | Atualizado: terça-feira, 13 de novembro de 2012
...
Esta atualização de segurança elimina uma vulnerabilidade divulgada publicamente no Microsoft Visual Basic for Applications. A vulnerabilidade pode permitir a execução remota de código se um invasor convencer um usuário a abrir um arquivo legítimo do Microsoft Office (como um arquivo .docx) localizado no mesmo diretório que um arquivo de biblioteca de link dinâmico (DLL) especialmente criado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Se um usuário estiver conectado com direitos administrativos, o invasor poderá assumir o controle total do sistema afetado. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Esta atualização de segurança foi classificada como Importante para todas as versões com suporte do Microsoft Visual Basic for Applications SDK e aplicativos de terceiros que usam o Microsoft Visual Basic for Applications. Esta atualização de segurança foi classificada como Importante para todas as edições com suporte do Microsoft Office 2003 SP3, Microsoft Office 2007 SP2 e Microsoft Office 2010. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança aborda a vulnerabilidade corrigindo a maneira como o Microsoft Visual Basic for Applications carrega bibliotecas externas. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
<td style="border:1px solid black;">KB976382 no <a href="http://technet.microsoft.com/pt-br/security/bulletin/ms10-031">MS10-031</a> substituído pelo KB2598361 ou KB2687626[2]</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">KB976321 no <a href="http://technet.microsoft.com/pt-br/security/bulletin/ms10-031">MS10-031</a> substituído por KB2596744</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a7cc8fdc-1c64-434f-87a6-72ddcc356654">Microsoft Office 2010 (edições de 32 bits)</a> <br />
(KB2598243)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=3050c06c-3cfc-4ce7-83cd-017d0922d597">Microsoft Office 2010 (edições de 32 bits)</a> <br />
(KB2553447)</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhuma</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a7cc8fdc-1c64-434f-87a6-72ddcc356654">Microsoft Office 2010 Service Pack 1 (edições de 32 bits)</a> <br />
(KB2598243)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=3050c06c-3cfc-4ce7-83cd-017d0922d597">Microsoft Office 2010 Service Pack 1 (edições de 32 bits)</a> <br />
(KB2553447)</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhuma</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ab442918-8184-4c7c-84b0-5a3635fdb005">Microsoft Office 2010 (64-bit editions)</a> <br />
(KB2598243)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=0a8af868-abf7-4aeb-813a-418a04b31608">Microsoft Office 2010 (64-bit editions)</a> <br />
(KB2553447)</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhuma</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ab442918-8184-4c7c-84b0-5a3635fdb005">Microsoft Office 2010 Service Pack 1 (edições de 64 bits)</a> <br />
(KB2598243)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=0a8af868-abf7-4aeb-813a-418a04b31608">Microsoft Office 2010 Service Pack 1 (edições de 64 bits)</a> <br />
(KB2553447)</td>
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">Nenhuma</td>
...
<sup>[1]</sup>Estas atualizações para o Microsoft Office aplicam-se a todos os Microsoft Office Suites com suporte e outros softwares Microsoft Office que contenham o componente Office compartilhado vulnerável. Incluem, sem limitação, versões com suporte do Microsoft Visio e Microsoft Project. Para obter mais informações, consulte a próxima seção, **Perguntas frequentes relacionadas a esta atualização de segurança**.
  
<sup>[2]</sup>Embora a atualização relançada (KB2687626) substitua a atualização original (KB2598361) no Microsoft Office 2003 Service Pack 3, clientes que instalaram a atualização KB2598361 não precisam instalar a atualização KB2687626. Para obter mais informações, consulte as Perguntas frequentes da atualização.
...
<td style="border:1px solid black;">Execução Remota de Código</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;">KB974945 no <a href="http://technet.microsoft.com/pt-br/security/bulletin/ms10-031">MS10-031</a> substituído por KB2688865</td>
</tr>
<tr class="even">
...
**Observação** Em casos em que a atualização KB2598361 já estiver instalada, e então a atualização KB2687626 for instalada no mesmo sistema, o instalador gerará uma mensagem de que a atualização já está instalada. Depois que a mensagem for gerada, a atualização KB2687626 substituirá a atualização KB2598361 na lista de atualizações instaladas. Para obter mais informações sobre esse comportamento de instalação, consulte o [Artigo 2707960 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2707960).
  
**Esta atualização está relacionada ao Comunicado de Segurança da Microsoft 2269637?**     
Sim, a Vulnerabilidade de carregamento não seguro de bibliotecas do Visual Basic for Applications (CVE-2012-1854) eliminada por esta atualização está relacionada à classe de vulnerabilidades, descrita no [Comunicado de Segurança da Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637), que afeta como os aplicativos carregam as bibliotecas externas. Esta atualização de segurança elimina uma instância em particular deste tipo de vulnerabilidade.
...
Os hashes SHA1 e SHA2 das atualizações de segurança podem ser usados para verificar a autenticidade de pacotes de atualização de segurança baixados. Para informações sobre hashes pertencentes a esta atualização, consulte [artigo 2707960 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2707960).
...
Os desenvolvedores que redistribuem o tempo de execução VBE6.dll do Microsoft Visual Basic for Applications devem baixar uma versão atualizada do Microsoft Visual Basic for Applications SDK da [Summit Software Company](http://www.summsoft.com/). Então, atualize o instalador de aplicativos com o tempo de execução atualizado do VBA. Para obter mais informações sobre as práticas recomendadas ao uso de componentes redistribuíveis, consulte o [Artigo 835322 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/835322) e o artigo [Isolated Applications and Side-by-side Assemblies (em inglês)](http://msdn.microsoft.com/en-us/library/aa375193.aspx) do MSDN.
...
<th style="border:1px solid black;" >
Vulnerabilidade de carregamento não seguro de bibliotecas do Visual Basic for Applications - CVE-2012-1854  
</th>
<th style="border:1px solid black;" >
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-1854](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1854).

#### Fatores atenuantes da Vulnerabilidade de carregamento não seguro de bibliotecas do Visual Basic for Applications - CVE-2012-1854
...
-   Para que um ataque seja bem-sucedido, o usuário deve visitar um local de sistema de arquivos remoto não confiável ou compartilhamento de WebDAV e abrir um arquivo legítimo relacionado ao Office (como, por exemplo, um arquivo .docx).
...
#### Soluções alternativas para a Vulnerabilidade de carregamento não seguro de bibliotecas do Visual Basic for Applications - CVE-2012-1854
...
-   **Bloquear as portas TCP 139 e 445 no firewall**
    ...
    **Impacto da solução alternativa.** Vários serviços Windows usam as portas afetadas. O bloqueio da conectividade nas portas pode impedir o funcionamento de vários aplicativos ou serviços. Segue uma lista de aplicativos ou serviços que podem ser afetados:
...
#### Perguntas frequentes sobre a Vulnerabilidade de carregamento não seguro de bibliotecas do Visual Basic for Applications - CVE-2012-1854

**Qual é o escopo da vulnerabilidade?**   
Esta é uma vulnerabilidade de execução remota de código no Microsoft Visual Basic for Applications (VBA).

**O que provoca a vulnerabilidade?**   
A vulnerabilidade é causada quando o Microsoft Visual Basic for Applications restringe incorretamente o caminho usado para carregar bibliotecas externas.
...
Em um cenário de ataque por email, um invasor pode explorar a vulnerabilidade enviando um arquivo do Microsoft Office (como um arquivo .docx) a um usuário e convencendo o usuário a colocar o anexo em um diretório contendo um arquivo .DLL especialmente criado e a abrir o arquivo legítimo. Em seguida, ao abrir o arquivo legítimo, o Microsoft Office pode tentar carregar o arquivo .DLL e executar o código contido nele.

Em um cenário de ataque à rede, um invasor pode colocar um arquivo legítimo do Microsoft Office e um arquivo DLL especialmente criado em uma rede compartilhada, em um UNC ou em um local WebDAV, e então convencer o usuário a abrir o arquivo.
...
A atualização elimina a vulnerabilidade corrigindo a maneira como o Microsoft Visual Basic for Applications carrega bibliotecas externas.
...
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2012-1854](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1854) da lista Common Vulnerability and Exposure.
...
| Microsoft Visual Basic for Applications                                           | Não               | Não                                 |
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2687626">Artigo B2687626 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">vbe62007-kb2596744-fullfile-x86-glb.exe /passivo</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalar sem reinicializar</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2596744">Artigo 2596744 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2598243">Artigo 2598243 (em inglês)</a> e o <a href="http://support.microsoft.com/kb/2553447">Artigo 2553447 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2688865">Artigo 2688865 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da chave do Registro</strong></td>
...
A versão de arquivo da vbe6.dll é 6.5.10.54</td>
</tr>
</tbody>
</table>
...
-   Bai Haowen, do [Huawei Security Labs](http://www.huawei.com), por relatar a Vulnerabilidade de carregamento não seguro de bibliotecas do Visual Basic for Applications (CVE-2012-1854)
...
-   V2.0 (13 de novembro de 2012): A Microsoft relançou este boletim para substituir a atualização KB2598361 pela KB2687626 do Microsoft Office 2003 Service Pack 3 a fim de solucionar um problema com certificados digitais descrito no Comunicado de Segurança da Microsoft 2749655. Consulte as Perguntas frequentes de atualização para obter detalhes.
