---
TOCTitle: 'MS12-047'
Title: 'Microsoft Security Bulletin MS12-047 - Importante'
ms:assetid: 'ms12-047'
ms:contentKeyID: 61234569
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-047(v=Security.10)'
---

Microsoft Security Bulletin MS12-047 - Importante
=================================================

Vulnerabilidades nos drivers do modo kernel do Windows podem permitir a elevação de privilégio (2718523)
--------------------------------------------------------------------------------------------------------
...
Esta atualização de segurança resolve uma vulnerabilidade divulgada publicamente e uma vulnerabilidade relatada em particular no Microsoft Windows. As vulnerabilidades podem permitir elevação de privilégio se um invasor faz logon no sistema e executar um aplicativo especialmente criado. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.
...
A atualização de segurança elimina as vulnerabilidades corrigindo a maneira como um driver de modo kernel do Windows manipula os arquivos de layout do teclado e valida parâmetros de callback ao criar um procedimento de captura. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
<td style="border:1px solid black;">
KB2709162 no [MS12-041](http://technet.microsoft.com/pt-br/security/bulletin/ms12-041) substituído por KB2718523
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ed201422-7c65-4c20-a825-8cecab1aeebc) (instalação do núcleo do servidor)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8e1a27c9-6495-4030-8a46-264afd78a5a1) (instalação do núcleo do servidor)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (instalação do núcleo do servidor)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (instalação do núcleo do servidor)  
(KB2718523)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
Os hashes SHA1 e SHA2 das atualizações de segurança podem ser usados para verificar a autenticidade de pacotes de atualização de segurança baixados. Para informações sobre hashes pertencentes a esta atualização, consulte [artigo 2718523 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2718523).
...
<th style="border:1px solid black;" >
Vulnerabilidade de layout do teclado - CVE-2012-1890
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de controle de tipo incorreto do Win32k - CVE-2012-1893
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Existe uma vulnerabilidade de elevação de privilégio na maneira como o driver do modo do kernel do Windows controla layouts específicos de teclado. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890).

#### Fatores atenuantes da Vulnerabilidade de layout do teclado - CVE-2012-1890
...
#### Soluções alternativas para a Vulnerabilidade de layout do teclado - CVE-2012-1890

A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.

#### Perguntas frequentes sobre a Vulnerabilidade de layout do teclado - CVE-2012-1890
...
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2012-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890) da lista Common Vulnerability and Exposure.
...
Existe uma elevação de vulnerabilidade de privilégio quando o driver de kernel de modo do Windows valida impropriamente os parâmetros ao criar um procedimento de captura. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-1893](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1893).

#### Fatores atenuantes da Vulnerabilidade de controle de tipo incorreto do Win32k - CVE-2012-1893

A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:

-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.

#### Soluções alternativas para a Vulnerabilidade de controle de tipo incorreto do Win32k - CVE-2012-1893

A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.

#### Perguntas frequentes sobre a Vulnerabilidade de controle de tipo incorreto do Win32k - CVE-2012-1893

**Qual é o escopo da vulnerabilidade?**   
Esta é uma vulnerabilidade de elevação de privilégio.

**O que provoca a vulnerabilidade?**   
A vulnerabilidade é causada quando o driver do modo de kernel do Windows impropriamente os parâmetros ao criar um procedimento de captura.
...
**O que a atualização faz?**   
A atualização elimina a vulnerabilidade corrigindo a maneira como um driver de modo kernel do Windows valida parâmetros de callback ao criar um procedimento de captura.
...
<td style="border:1px solid black;">Use o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2718523$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaçõessobre</strong> <strong>o</strong> <strong>arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2718523">Artigo 2718523 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da c</strong> <strong>have</strong> <strong>do Registro</strong></td>
<td style="border:1px solid black;"><strong>Observação</strong> Não existe uma chave do Registro para validar a presença dessa atualização.</td>
</tr>
</tbody>
</table>
...
-   Nicolas Economou, da [Core Security Technologies](http://www.coresecurity.com/), por relatar a Vulnerabilidade de layout do teclado (CVE-2012-1890)  
-   [Qihoo 360 Security Center](http://www.360.cn/)  
-   , por relatar a Vulnerabilidade de layout do teclado (CVE-2012-1890)  
-   Lufeng Li, da Neusoft Corporation, que trabalha em parceria com a [Secunia Research](http://secunia.com/), por relatar a Vulnerabilidade de controle de tipo incorreto do Win32k (CVE-2012-1893)
