---
TOCTitle: 'MS12-056'
Title: 'Microsoft Security Bulletin MS12-056 - Importante'
ms:assetid: 'ms12-056'
ms:contentKeyID: 61234578
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-056(v=Security.10)'
---

Microsoft Security Bulletin MS12-056 - Importante
=================================================

Vulnerabilidade nos mecanismos JScript e VBScript pode permitir execução remota de código (2706045)
---------------------------------------------------------------------------------------------------
...
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular nos mecanismos de scripts JScript e VBScript em versões de 64 bits do Microsoft Windows. A vulnerabilidade pode permitir a execução remota de código caso um usuário tenha visitado um site especialmente criado. Não há como o invasor forçar os usuários a visitarem o site mal-intencionado. Em vez disso, o invasor teria que persuadir os usuários a visitar o site, geralmente fazendo com que eles cliquem em um link em um e-mail ou mensagem do Instant Messenger que leva o usuário ao site do invasor.

Esta atualização de segurança é classificada como Importante para JScript 5.8 e VBScript 5.8 em clientes do Windows de 64 bits. Esta atualização de segurança também é classificada como Baixa para JScript 5.8 em servidores Windows de 64 bits. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança elimina a vulnerabilidade, modificando a maneira como o JScript e VBScript gerencia objetos na memória. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
<td style="border:1px solid black;">KB2510531 do boletim <a href="http://technet.microsoft.com/pt-br/security/bulletin/ms11-031">MS11-031</a> substituído por KB2706045</td>
</tr>
<tr class="even">
...
Os hashes SHA1 e SHA2 das atualizações de segurança podem ser usados para verificar a autenticidade de pacotes de atualização de segurança baixados. Para informações sobre hashes pertencentes a esta atualização, consulte o [Artigo 2706045 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2706045).
...
**Como esta atualização de segurança se relaciona com o MS12-052?**   
A Vulnerabilidade de execução remota de código de estouro de número inteiro em JavaScript (CVE-2012-2523) descrita neste boletim também é abordada pelo boletim [MS12-052](http://technet.microsoft.com/pt-br/security/bulletin/ms12-052).

Para clientes com Internet Explorer 8 instalado em seus sistemas, instale a atualização KB2706045, descrita neste boletim, para estar protegido da vulnerabilidade descrita em CVE-2012-2523.

Para clientes com Internet Explorer 9 instalado em seus sistemas, instale a atualização KB2722913, descrita no [MS12-052](http://technet.microsoft.com/pt-br/security/bulletin/ms12-052), para estar protegido da vulnerabilidade descrita em CVE-2012-2523.

**Como determinar quais versões dos mecanismos de script** **JScript** **e** **VBScript** **estão instaladas em meu sistema?**   
O Internet Explorer 8, Internet Explorer 9 e Internet Explorer 10 incluem os mecanismos de scripts JScript 5.8 e VBScript 5.8. O pacote de atualização KB2706045 atualiza as versões de JScript e VBScript do Internet Explorer 8. O pacote de atualização KB2722913, descrito em MS12-052, atualiza as versões do Internet Explorer 9. As versões do Internet Explorer 10 já estão atualizadas e não exigem esta atualização".
...
<th style="border:1px solid black;" >Vulnerabilidade de execução remota de código de estouro do número inteiro em JavaScript - CVE-2012-2523</th>
<th style="border:1px solid black;" >Avaliação de gravidade agregada</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 no Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 no Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Baixa</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Baixa</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 no Windows Vista x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 no Windows Server 2008 para Sistemas baseados em x64 Service Pack 2</td>
<td style="border:1px solid black;"><strong>Baixa</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Baixa</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 no Windows 7 para sistemas baseados em x64</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 no Windows 7 para Sistemas baseados em x64 Service Pack 1</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Importante</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 no Windows Server 2008 R2 para sistemas baseados em x64</td>
<td style="border:1px solid black;"><strong>Baixa</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Baixa</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 no Windows Server 2008 R2 para Sistemas baseados em x64 Service Pack 1</td>
<td style="border:1px solid black;"><strong>Baixa</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Baixa</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 no Windows Server 2008 R2 para sistemas baseados no Itanium</td>
<td style="border:1px solid black;"><strong>Baixa</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Baixa</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 no Windows Server 2008 R2 para Sistemas baseados no Itanium Service Pack 1</td>
<td style="border:1px solid black;"><strong>Baixa</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Baixa</strong></td>
</tr>
...
A vulnerabilidade é causada quando o mecanismo JScript calcula inadequadamente o tamanho de um objeto em memória durante uma operação de cópia.
...
Os sistemas nos quais o Internet Explorer 8 e Internet Explorer 9 são usados frequentemente, como estações de trabalhos ou servidores de terminal, são os que mais correm risco com esta vulnerabilidade.
...
A atualização elimina a vulnerabilidade, modificando a maneira como o JScript e VBScript gerencia objetos na memória.
...
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 em todas as edições baseadas em x64 com suporte do Windows XP:<br />
...
<td style="border:1px solid black;">Para JScript 5.8 e VBScript 5.8: KB2706045-IE8.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Para JScript 5.8 e VBScript 5.8 em todas as edições baseadas em x64 com suporte do Windows XP:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\ie8updates\KB2706045-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaçõessobre</strong> <strong>o</strong> <strong>arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2706045">Artigo 2706045 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 em todas as edições baseadas em x64 com suporte do Windows Server 2003:<br />
IE8-WindowsServer2003.WindowsXP-KB2706045-x64-ENU.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalar sem reinicializar</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Para JScript 5.8 e VBScript 5.8 em todas as edições baseadas em x64 com suporte do Windows Server 2003:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\ie8updates\KB2706045-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaçõessobre</strong> <strong>o</strong> <strong>arquivo</strong></td>
...
#### Windows Vista (edições de 64 bits)
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 em todas as edições baseadas em x64 com suporte do Windows Vista:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 em todas as edições baseadas em x64 com suporte do Windows Server 2008:<br />
IE8-Windows6.0-KB2706045-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalar sem reinicializar</td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 em todas as edições baseadas em x64 com suporte do Windows 7:<br />
...
#### Windows Server 2008 R2 (edições de 64 bits)
...
<tr class="odd">
<td style="border:1px solid black;">Instalar sem intervenção do usuário</td>
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 em todas as edições baseadas em x64 com suporte do Windows Server 2008 R2:<br />
Windows6.1-KB2706045-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 e VBScript 5.8 em todas as edições baseadas no Itanium com suporte do Windows Server 2008 R2:<br />
