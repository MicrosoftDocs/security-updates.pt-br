---
TOCTitle: 'MS12-068'
Title: 'Microsoft Security Bulletin MS12-068 - Importante'
ms:assetid: 'ms12-068'
ms:contentKeyID: 61234590
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-068(v=Security.10)'
---


Microsoft Security Bulletin MS12-068 - Importante
=================================================

Vulnerabilidade no Kernel do Windows pode permitir a elevação de privilégio (2724197)
-------------------------------------------------------------------------------------
...
A vulnerabilidade pode permitir elevação de privilégio se um invasor faz logon no sistema e executar um aplicativo especialmente criado. O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.
...
<td style="border:1px solid black;">
KB2707511 no [MS12-042](http://technet.microsoft.com/pt-br/security/bulletin/ms12-042) substituído por KB2724197
</td>
</tr>
...
<td style="border:1px solid black;">
KB971486 no [MS09-058](http://technet.microsoft.com/pt-br/security/bulletin/ms09-058) substituído pelo boletim KB2724197
</td>
</tr>
<tr>
<th style="border:1px solid black;" colspan="4">
...
<td style="border:1px solid black;">
KB979683 no [MS10-021](http://technet.microsoft.com/pt-br/security/bulletin/ms10-021) substituído pelo boletim KB2724197
</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=315cc115-1496-471f-8887-f334a1ca8246)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
<td style="border:1px solid black;">
KB2633171 no [MS11-098](http://technet.microsoft.com/pt-br/security/bulletin/ms11-098) substituído por KB2724197
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2556532 no [MS11-068](http://technet.microsoft.com/pt-br/security/bulletin/ms11-068) substituído por KB2724197
</td>
</tr>
<tr>
<th style="border:1px solid black;" colspan="4">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5697076c-541f-42b7-8dc3-e8bd4a25fda8)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6216b875-c7a6-4d62-8062-49996ac7a478)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
<tr>
<td style="border:1px solid black;">
[Windows 7 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=2d273f99-3460-4e84-9f2d-2a349bfc7ce6)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
<td style="border:1px solid black;">
KB2709715 no [MS12-042](http://technet.microsoft.com/pt-br/security/bulletin/ms12-042) substituído por KB2724197
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7 para Sistemas Service Pack 1 baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=2d273f99-3460-4e84-9f2d-2a349bfc7ce6)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=848af16d-c5f7-4a70-b6a9-39f4e7999f1f)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 para Sistemas Service Pack 1 baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=848af16d-c5f7-4a70-b6a9-39f4e7999f1f)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ded1f351-022a-463c-9f5f-84b6081e6173)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 para Sistemas Service Pack 1 baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ded1f351-022a-463c-9f5f-84b6081e6173)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=526f786b-7aef-4a1f-b03d-587baadf3f5b) (instalação do núcleo do servidor)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5697076c-541f-42b7-8dc3-e8bd4a25fda8) (instalação do núcleo do servidor)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=848af16d-c5f7-4a70-b6a9-39f4e7999f1f) (instalação do núcleo do servidor)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=848af16d-c5f7-4a70-b6a9-39f4e7999f1f) (instalação do núcleo do servidor)  
(KB2724197)
</td>
<td style="border:1px solid black;">
Elevação de privilégio
...
Os hashes SHA1 e SHA2 das atualizações de segurança podem ser usados para verificar a autenticidade de pacotes de atualização de segurança baixados. Para informações sobre hashes pertencentes a esta atualização, consulte o [artigo 2724197 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2724197).
...
<th style="border:1px solid black;" >
Vulnerabilidade de estouro de número inteiro do Kernel do Windows - CVE-2012-2529
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-2529](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2529).

#### Fatores atenuantes da vulnerabilidade de estouro de número inteiro do Kernel do Windows - CVE-2012-2529
...
#### Soluções alternativas para a vulnerabilidade de estouro de número inteiro do Kernel do Windows - CVE-2012-2529

A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.

#### Perguntas frequentes de vulnerabilidade de estouro de número inteiro do Kernel do Windows - CVE-2012-2529
...
<td style="border:1px solid black;">Use o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2724197$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaçõessobre</strong> <strong>o</strong> <strong>arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2724197">Artigo 2724197 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Um pesquisador anônimo, que trabalha na [VeriSign iDefense Labs](http://labs.idefense.com/), por relatar a Vulnerabilidade de estouro de número inteiro do Kernel do Windows (CVE-2012-2529)
