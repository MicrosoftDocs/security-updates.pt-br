---
TOCTitle: 'MS12-080'
Title: 'Microsoft Security Bulletin MS12-080 - Crítica'
ms:assetid: 'ms12-080'
ms:contentKeyID: 61234602
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-080(v=Security.10)'
---


Microsoft Security Bulletin MS12-080 - Crítica
==============================================

Vulnerabilidades no Microsoft Exchange Server podem permitir a execução remota de código (2784126)
--------------------------------------------------------------------------------------------------
...
<td style="border:1px solid black;">
KB2756497 do [MS12-058](http://technet.microsoft.com/pt-br/security/bulletin/ms12-058) substituído por KB2746157
</td>
</tr>
...
<td style="border:1px solid black;">
KB2756496 do [MS12-058](http://technet.microsoft.com/pt-br/security/bulletin/ms12-058) substituído por KB2787763
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2756485 do [MS12-058](http://technet.microsoft.com/pt-br/security/bulletin/ms12-058) substituído por KB2785908
</td>
</tr>
</table>
...
**Há diversas vulnerabilidades abordadas noComunicado importante sobre atualização de patch da Oracle - Outubro de 2012, como as vulnerabilidades são abordadas por esta atualização?**  
O CVE-2012-3214 e CVE-2012-3217 abordados no [Comunicado importante sobre atualização de patch da Oracle - Outubro de 2012](http://www.oracle.com/technetwork/topics/security/cpuoct2012-1515893.html) afetam o Microsoft Exchange Server e são abordados por esta atualização.

**Esta atualização contém quaisquer atualizações relacionadas àfalta de segurança desta funcionalidade?**  
...
-   Para o Conjunto de atualizações 9 do Exchange Server 2007 Service Pack 3 (KB2746157), consulte o [Artigo 2746157 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2746157).
-   Para o Conjunto de atualizações 8 do Exchange 2010 Service Pack 1 (KB2787763), consulte o [Artigo 2787763 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2787763).
-   Para o Conjunto de atualizações 5 do Exchange 2010 Service Pack 2 (KB2785908), consulte o [Artigo 2785908 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2785908).

**Eu instalei o bucket de versãoAlta no hotfix do servidor de caixa de correio do Exchange Server 2010. Preciso instalar esta atualização?**  
Sim. Embora sistemas que já têm o hotfix descrito no [artigo 2786772 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2786772) aplicado a eles sejam protegidos da vulnerabilidade descrita em [CVE-2012-4791](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4791), os sistemas são ainda vulneráveis ao Oracle Outside In abordado por esta atualização.
...
Os hashes SHA1 e SHA2 das atualizações de segurança podem ser usados para verificar a autenticidade de pacotes de atualização de segurança baixados. Para informações sobre hashes relacionados a esta atualização, consulte o [artigo 2784126 (em inglês) da Microsoft Knowledge Base](https://support.microsoft.com/kb/2784126).
...
CVE-2012-3214<br />
CVE-2012-3217</th>
<th style="border:1px solid black;" >Vulnerabilidade RSS feed pode causar Exchange DoS - CVE-2012-4791</th>
...
As vulnerabilidades de execução remota de código existem no Microsoft Exchange Server por meio do recurso Exibição de Documento WebReady. Essas vulnerabilidades podem permitir a execução remota de código como uma conta LocalService se um usuário visualizar um arquivo especialmente criado pelo Outlook Web Access em um navegador. Um invasor que explorar com êxito as vulnerabilidades pode executar o código no servidor afetado, mas somente como uma conta LocalService. A conta LocalService tem privilégios mínimos no computador local e apresenta credenciais anônimas na rede.
...
-   **Desabilite a visualização dedocumentos WebReady**
...
**O que é aVisualização de documentos WebReady?**    
...
**Quando este boletim de segurança foi lançado, a Microsoft tinha recebido algum relatório informando que essas vulnerabilidades estavam sendoexploradas?**    
...
Vulnerabilidade RSS feed pode causar Exchange DoS - CVE-2012-4791  
-----------------------------------------------------------------
  
Uma vulnerabilidade de negação de serviço existe no Microsoft Exchange Server quando o Exchange trata impropriamente RSS feeds. A vulnerabilidade pode fazer com que o Serviço de Armazenamento de Informações no sistema afetado pare de responder até que o processo seja terminado forçadamente. Essa condição de falta de resposta pode fazer com que os bancos de dados do Exchange se rompam, potencialmente levando à corrupção dos bancos de dados, afetando as caixas de correio dos usuários.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-4791](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4791).
  
#### Fatores atenuantes da Vulnerabilidade RSS feed pode causar Exchange DoS - CVE-2012-4791
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Um invasor deve ter uma conta válida de email no servidor afetado do Exchange e pode criar RSS feeds para explorar esta vulnerabilidade.
  
#### Soluções alternativas para a Vulnerabilidade RSS feed pode causar Exchange DoS - CVE-2012-4791
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade RSS feed pode causar Exchange DoS - CVE-2012-4791
  
**Qual é o escopo da v ulnerabilidade?**     
Essa é uma vulnerabilidade de negação de serviço (site em inglês). O invasor que explorar essa vulnerabilidade poderá fazer o sistema afetado parar de responder. Observe que essa vulnerabilidade não permite que um invasor execute códigos nem eleve os direitos de usuário.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada quando o Exchange Server impropriamente trata RSS feeds, resultando numa condição de negação de serviço.
  
**O queé RSS?**    
RSS (Really Simple Syndication) fornece uma maneira conveniente para editores de conteúdo distribuírem informações num formato uniformizado. Um formato uniformizado de arquivo de XML permite que as informações sejam publicadas uma vez e vistas por muitos programas diferentes, tal como Outlook. Os usuários podem assinar RSS feeds que os notifiquem sobre o conteúdo atualizado.
  
**Para que um invasor pode usar a vulnerabilidade?**     
O invasor que explorar essa vulnerabilidade pode fazer com que o Serviço de Armazenamento de Informações no sistema afetado pare de responder até que o processo seja terminado forçadamente. Essa condição de falta de resposta pode fazer com que os bancos de dados do Exchange se rompam, potencialmente levando à corrupção dos bancos de dados, afetando as caixas de correio dos usuários.
  
**De que forma o invasor pode explorar a vulnerabilidade?**     
O invasor com uma conta válida de email no servidor do Exchange pode criar um RSS feed especial, projetado para explorar essa vulnerabilidade e então assinar o RSS feed. Esta vulnerabilidade pode ser explorada quando o servidor afetado do Exchange trata o RSS feed.
  
**Quais são os principais sistemas que *correm riscos com a vulnerabilidade*?**     
Os sistemas Exchange Server são os que mais correm risco com essas vulnerabilidades.
  
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade, corrigindo a maneira como o Exchange Server trata os RSS feeds.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2784126">Artigo 2784126 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
