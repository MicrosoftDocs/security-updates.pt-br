---
TOCTitle: 'MS12-083'
Title: 'Microsoft Security Bulletin MS12-083 - Importante'
ms:assetid: 'ms12-083'
ms:contentKeyID: 61234605
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-083(v=Security.10)'
---


Microsoft Security Bulletin MS12-083 - Importante
=================================================

Vulnerabilidade no IP-HTTPS pode permitir a passagem pelo recurso de segurança (2765809)
----------------------------------------------------------------------------------------
...
Os hashes SHA1 e SHA2 das atualizações de segurança podem ser usados para verificar a autenticidade de pacotes de atualização de segurança baixados. Para informações sobre hashes relacionados a esta atualização, consulte o artigo 2765809 (em inglês) da Microsoft Knowledge Base.
...
<th style="border:1px solid black;" >
Vulnerabilidade de passagem pelo certificado revogado - CVE-2012-2549
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Existe uma vulnerabilidade de passagem pelo recurso de segurança no Windows devido à maneira como o Componente IP-HTTPS lida com os certificados. O invasor que explorar com êxito esta vulnerabilidade poderá passar pelas verificações de validação do certificado.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-2549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2549).

#### Fatores atenuantes da Vulnerabilidade de passagem pelo certificado revogado - CVE-2012-2549

A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:

-   Para explorar a vulnerabilidade, o invasor deve ter um certificado emitido pelo domínio.
-   Fazer logon em um sistema dentro da organização ainda pode exigir credenciais de domínio ou sistema.

#### Soluções alternativas para a Vulnerabilidade de passagem pelo certificado revogado - CVE-2012-2549

A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:

-   **Desabilite as contas do computador de domínioassociadas aos certificados de clientes revogados.**

    Para obter instruções sobre como desabilitar contas de computador no Windows Server 2008 R2 e Windows Server 2012, consulte [Disable or Enable a Computer Account](http://technet.microsoft.com/en-us/library/cc732965.aspx) (em inglês).

    Para obter instruções sobre como usar um script para desabilitar múltiplas contas de computador, consulte [Disable Computer Accounts (em inglês)](http://gallery.technet.microsoft.com/scriptcenter/ac6c44dd-db2f-487a-a51f-3ecb69b9386c).

#### Perguntas frequentes sobre a Vulnerabilidade de passagem pelo certificado revogado - CVE-2012-2549

**Qual é o escopo da vulnerabilidade?**  
Esta é uma vulnerabilidade de desvio de recurso de segurança.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando Windows falha ao verificar adequadamente a validade de certificados.

**Qualcomponente é afetado por esta vulnerabilidade?**  
IP-HTTPS é o componente do Windows afetado pela vulnerabilidade.

**O que é IP-HTTPS?**  
O IP sobre HTTPs (IP-HTTPs) é um protocolo que permite que túnéis seguros de IP sejam estabelecidos usando conexões seguras de HTTP. Ele é comumente usado em implantações do Microsoft DirectAccess. Para obter mais informações, consulte [IP over HTTPS (IP-HTTPS) Tunneling Protocol](http://msdn.microsoft.com/en-us/library/dd358571(v=prot.20).aspx) (em inglês).

**O que é DirectAccess?**  
O DirectAccess, introduzido nos sistemas operacionais Windows 7 e Windows Server 2008 R2, permite aos usuários remotos acessar seguramente compartilhamentos de empresa, sitese e aplicativos usando protocolos seguros, como IP-HTTPs. Para obter mais informações, consulte [DirectAccess](http://technet.microsoft.com/en-us/network/dd420463.aspx).

**Para que um invasor pode usar a vulnerabilidade?**  
Um invasor que explorar com êxito esta vulnerabilidade pode ignorar o recurso de segurança que confere a validade dos certificados.

**De que forma o invasor pode explorar avulnerabilidade?**  
A vulnerabilidade poderá permitir uma passagem pelo recurso de segurança se um invasor apresentar um certificado revogado a um aplicativo ou serviço que usa um componente IP-HTTPS.

**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**  
Os servidores correm mais risco com essa vulnerabilidade.

**O que a atualização faz?**  
A atualização aborda a vulnerabilidade modificando a forma como o Microsoft Windows confere a validade de certificados.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2765809">Artigo 2765809 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
