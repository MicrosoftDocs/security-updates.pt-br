...
ms:assetid: 'ms12-008'
ms:contentKeyID: 61234530
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-008(v=Security.10)'
---
...
Vulnerabilidades em drivers do modo kernel do Windows podem permitir a execução remota de código (2660465)
----------------------------------------------------------------------------------------------------------
...
A atualização de segurança elimina as vulnerabilidades modificando a maneira como um driver de modo kernel do Windows manipula as chamadas de modo do usuário para GDI e manipula erros de layout do teclado. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=832afe5e-d61e-4554-b889-9174df042b32)                                                                                                          | Crítica                    | Execução Remota de Código       | [MS11-087](http://technet.microsoft.com/pt-br/security/bulletin/ms11-087) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ff2c141c-08b4-42c6-9f66-580f8678c01f)                                                                                 | Crítica                    | Execução Remota de Código       | [MS11-087](http://technet.microsoft.com/pt-br/security/bulletin/ms11-087) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f0e6e06d-89db-45ad-9660-7959c6f9b546)                                                                                                 | Crítica                    | Execução Remota de Código       | [MS11-087](http://technet.microsoft.com/pt-br/security/bulletin/ms11-087) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b81decda-9d82-4ffb-baae-78b190e553ea)                                                                                     | Crítica                    | Execução Remota de Código       | [MS11-087](http://technet.microsoft.com/pt-br/security/bulletin/ms11-087) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=8dcd71c8-82ad-4f86-b386-7f1ea09e157f)                                                                      | Crítica                    | Execução Remota de Código       | [MS11-087](http://technet.microsoft.com/pt-br/security/bulletin/ms11-087) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5852118c-fc39-45e2-8b44-ce1401d310e2)                                                                                                       | Crítica                    | Execução Remota de Código       | [MS11-087](http://technet.microsoft.com/pt-br/security/bulletin/ms11-087) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5161d16d-1037-49d5-8d4d-c353288cb41c)                                                                                           | Crítica                    | Execução Remota de Código       | [MS11-087](http://technet.microsoft.com/pt-br/security/bulletin/ms11-087) |
| [Windows Server 2008 Service Pack 2 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=45c6c511-a4fa-4c3b-af26-6c113f6f5f5e)\*\*\*\*                                                                | Crítica                    | Execução Remota de Código       | [MS11-087](http://technet.microsoft.com/pt-br/security/bulletin/ms11-087) |
| [Windows Server 2008 Service Pack 2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=046932cf-0671-49e6-8ddf-98abfc97c5f0)\*\*\*\*                                                           | Crítica                    | Execução Remota de Código       | [MS11-087](http://technet.microsoft.com/pt-br/security/bulletin/ms11-087) |
| [Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=304bd0c5-f4ee-4f8c-89b4-4cbaaf418679)                                                               | Crítica                    | Execução Remota de Código       | [MS11-087](http://technet.microsoft.com/pt-br/security/bulletin/ms11-087) |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=3e5ca1bf-9415-412c-9dff-dd1abc57e74d)                                             | Crítica                    | Execução Remota de Código       | [MS11-087](http://technet.microsoft.com/pt-br/security/bulletin/ms11-087) |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=78cbbe02-a3d3-4cef-9b54-a3e78c1b885a)                                   | Crítica                    | Execução Remota de Código       | [MS11-087](http://technet.microsoft.com/pt-br/security/bulletin/ms11-087) |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 Service Pack 1 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=6b228ad6-d5a4-4b91-8aa8-0874deb22116)\*\*\*   | Crítica                    | Execução Remota de Código       | [MS11-087](http://technet.microsoft.com/pt-br/security/bulletin/ms11-087) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=922b2438-0cfc-49e3-b9a0-52c68b69126a) | Crítica                    | Execução Remota de Código       | [MS11-087](http://technet.microsoft.com/pt-br/security/bulletin/ms11-087) |
...
O Windows Server 2008 e Windows Server 2008 R2, quando instalados usando a opção de instalação do Núcleo de Servidor, são vulneráveis apenas ao local, elevação de privilégio, cenário de ataque para CVE-2011-5046. Os cenários de ataque de compartilhamento de arquivo e baseados na Web não se aplicam.
...
<th style="border:1px solid black;" >Vulnerabilidade de uso de layout do teclado após liberação - CVE-2012-0154</th>
...
#### Fatores atenuantes da Vulnerabilidade de violação de acesso a GDI - CVE-2011-5046
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Em um cenário de ataque baseado na Web, o invasor pode hospedar um site que contenha uma página da Web usada para explorar essa vulnerabilidade. Além disso, sites comprometidos e sites que aceitem ou hospedem conteúdo fornecido pelo usuário ou anúncios podem conter conteúdo especialmente criado que pode explorar esta vulnerabilidade. Em todos os casos, entretanto, um invasor não teria como forçar os usuários a visitarem os sites. Em vez disso, o invasor teria que persuadir os usuários a visitar o site, geralmente fazendo com que eles cliquem em um link em um e-mail ou mensagem do Instant Messenger que leva o usuário ao site do invasor.
...
#### Perguntas frequentes sobre a Vulnerabilidade de violação de acesso a GDI - CVE-2011-5046
...
A vulnerabilidade é causada quando o driver do modo kernel do Windows não executa validação adequada em entrada passada do modo do usuário pelo componente de kernel de GDI.
...
Há vários meios pelos quais o invasor pode explorar esta vulnerabilidade.
...
A atualização elimina a vulnerabilidade, modificando a maneira como um driver de modo kernel do Windows manipula as chamadas do modo do usuário para GDI.
  
**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**   
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2011-5046](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-5046) da lista Common Vulnerability and Exposure.
...
Vulnerabilidade de uso de layout do teclado após liberação - CVE-2012-0154  
--------------------------------------------------------------------------
  
 
Existe uma vulnerabilidade de elevação de privilégio devido à maneira como o driver do modo do kernel do Windows gerencia layouts específicos de teclado. Um invasor que explorar com êxito essa vulnerabilidade poderá executar código arbitrário no modo do kernel. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0154](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0154).
  
#### Fatores atenuantes da Vulnerabilidade de uso de layout do teclado após liberação - CVE-2012-0154
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.
  
#### Soluções alternativas para a Vulnerabilidade de uso de layout do teclado após liberação - CVE-2012-0154
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade de uso de layout do teclado após liberação - CVE-2012-0154
...
**O que provoca a vulnerabilidade?**   
A vulnerabilidade é causada quando o driver do modo kernel do Windows não manipula adequadamente erros de layout de teclado.
...
**O que a atualização faz?**   
A atualização elimina a vulnerabilidade, corrigindo a maneira como o driver do modo do kernel do Windows gerencia os erros de layout do teclado.
...
<td style="border:1px solid black;">Use o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\\$NTUninstallKB2660465$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2660465">Artigo 2660465 da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Tarjei Mandt da [Azimuth Security](http://www.azimuthsecurity.com/) por relatar a Vulnerabilidade de uso de layout do teclado após liberação (CVE-2012-0154)
