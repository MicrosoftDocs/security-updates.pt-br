...
ms:assetid: 'ms12-010'
ms:contentKeyID: 61234532
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-010(v=Security.10)'
---
...
Atualização de segurança cumulativa para o Internet Explorer (2647516)
----------------------------------------------------------------------
...
Esta atualização de segurança foi classificada como Crítica para o Internet Explorer 7, Internet Explorer 8 e Internet Explorer 9 em clientes do Windows; e como Moderada para o Internet Explorer 7, Internet Explorer 8 e Internet Explorer 9 em servidores Windows. Esta atualização de segurança também é classificada como Moderada para o Internet Explorer 6 em todas as edições com suporte do Windows XP. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança elimina as vulnerabilidades, modificando a maneira que o Internet Explorer manipula conteúdo durante os processos de copiar e colar, manipula objetos na memória e cria e inicializa strings. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**O Windows Developer Preview é afetado pela vulnerabilidade abordada neste boletim?  **
Sim. A atualização KB2647516 está disponível para a versão do Windows Developer Preview. Os clientes com Windows Developer Preview são incentivados a aplicar a atualização a seus sistemas. A atualização só está disponível no [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
...
Os clientes que precisarem de suporte adicional para software mais antigo deverão entrar em contato com o representante da equipe de contas da Microsoft, o gerente técnico da conta ou o representante do parceiro Microsoft apropriado para obter opções de suporte personalizadas. Os clientes sem um contrato Alliance, Premier ou Authorized podem entrar em contato com o escritório de vendas local da Microsoft. Para obter informações de contato, visite o site de [Informações internacionais da Microsoft](http://technet.microsoft.com/security/advisory/), selecione o país na lista de informações de contato e, em seguida, clique em **Ir** para ver uma lista de telefones. Ao ligar, peça para falar com o gerente de vendas local de Suporte Premier. Para obter mais informações, consulte as [Perguntas Frequentes sobre a Política do Ciclo de Vida do Suporte da Microsoft](http://support.microsoft.com/kb/887012).
...
<th style="border:1px solid black;" >
Vulnerabilidade na divulgação não autorizada de informações para copiar e colar - CVE-2012-0010
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de execução remota de código de layout de HTML - CVE-2012-0011
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de divulgação nula não autorizada de informações de byte - CVE-2012-0012
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de execução remota de código do VML - CVE-2012-0155
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0010](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0010).

#### Fatores atenuantes da Vulnerabilidade de divulgação de informações para copiar e colar - CVE-2012-0010
...
#### Soluções alternativas para a Vulnerabilidade de divulgação de informações para copiar e colar - CVE-2012-0010

A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:

-   **Ler e**
-   **mails em texto sem formatação**
...
-   Não copiar e colar conteúdo de fontes não confiáveis.

#### Perguntas frequentes sobre a Vulnerabilidade de divulgação de informações para copiar e colar - CVE-2012-0010

**Qual é o escopo da vulnerabilidade?** 
Essa é uma vulnerabilidade de divulgação de informações.

**O que provoca a vulnerabilidade?** 
Durante as operações de copiar e colar, o Internet Explorer não valida de forma suficiente dados, permitindo que invasores acessem e leiam conteúdo de domínios diferentes.
...
O invasor pode hospedar um site especialmente criado para explorar esta vulnerabilidade através do Internet Explorer, convencer um usuário a executar operações de copiar em algum conteúdo exibido neste site e convencer o usuário a colar este conteúdo em um site de destino. O invasor também pode tirar proveito dos sites comprometidos e de sites que aceitam ou hospedam o conteúdo fornecido pelo usuário ou anúncios. Esses sites podem ter conteúdo especialmente criado para ajudar a explorar essa vulnerabilidade. Em todos os casos, entretanto, o invasor não tem como forçar os usuários a visitar esses sites. Em vez disso, um invasor tem que convencer os usuários a visitar o site, geralmente fazendo com que eles cliquem em um link em um email ou por um pedido pelo Instant Messenger que leva o usuário ao site do invasor.
...
A atualização elimina a vulnerabilidade modificando a maneira como o Internet Explorer manipula o conteúdo durante os processos de copiar e colar.
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0011](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0011).

#### Fatores atenuantes da Vulnerabilidade de execução remota de código do layout de HTML - CVE-2012-0011
...
#### Soluções alternativas para a Vulnerabilidade de execução remota de código do layout de HTML - CVE-2012-0011
...
#### Perguntas frequentes sobre a Vulnerabilidade de execução remota de código do layout de HTML - CVE-2012-0011
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0012](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0012).

#### Perguntas frequentes sobre a Vulnerabilidade de divulgação nula não autorizada de informações de byte - CVE-2012-0012
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0155](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0155).

#### Fatores atenuantes para a Vulnerabilidade de execução remota de código de VML - CVE-2012-0155
...
#### Soluções alternativas para a Vulnerabilidade de execução remota de código de VML - CVE-2012-0155
...
#### Perguntas frequentes sobre a Vulnerabilidade de execução remota de código de VML - CVE-2012-0155
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições do Windows XP com suporte:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\ie7updates\KB2647516-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições com suporte do Windows XP:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\ie8updates\KB2647516-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2647516">Artigo 2647516 da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Verificação da c have de registro</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 para todas as edições de 32 bits com suporte do Windows XP:<br />
...
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 para todas as edições do Windows Server 2003 de 32 bits, edições baseadas em x64 e edições baseadas no Itanium para as quais existe suporte:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2647516$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições do Windows Server 2003 de 32 bits, edições baseadas em x64 e edições baseadas no Itanium para as quais existe suporte:<br />
...
-   por relatar a Vulnerabilidade de divulgação nula não autorizada de informações em copiar e colar (CVE-2012-0010)  
-   Stephen Fewer da [Harmony Security](http://www.harmonysecurity.com/), que trabalha na [Zero Day Initiative](http://www.tippingpoint.com/) da [TippingPoint](http://www.zerodayinitiative.com/), por relatar a Vulnerabilidade de execução remota de código de layout de HTML (CVE-2012-0011)  
-   Jason Hullinger da [HP Cloud Services](http://www.hpcloud.com/) por relatar a Vulnerabilidade de divulgação nula de informações de byte (CVE-2012-0012)  
-   Stephen Fewer da [Harmony Security](http://www.harmonysecurity.com/), que trabalha na [Zero Day Initiative](http://www.tippingpoint.com/) da [TippingPoint](http://www.zerodayinitiative.com/), por relatar a Vulnerabilidade de execução remota de código de VML (CVE-2012-0155)
