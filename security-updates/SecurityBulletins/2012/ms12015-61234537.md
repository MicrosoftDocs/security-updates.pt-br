...
ms:assetid: 'ms12-015'
ms:contentKeyID: 61234537
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-015(v=Security.10)'
---
...
Vulnerabilidades no Microsoft Visio Viewer 2010 podem permitir a execução remota de código (2663510)
----------------------------------------------------------------------------------------------------
...
A atualização de segurança elimina as vulnerabilidades, modificando a maneira como o Microsoft Visio Viewer valida dados ao analisar arquivos do Visio especialmente criados. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms11-089">MS11-089</a>[1]</td>
</tr>
<tr class="even">
...
<sup>[1]</sup>A atualização do Microsoft Office, MS11-089, é aplicada a sistemas que executam o Microsoft Visio Viewer 2010 mesmo que este software esteja listado como não afetado no boletim MS11-089.
...
<th style="border:1px solid black;" >Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0019</th>
<th style="border:1px solid black;" >Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0020</th>
<th style="border:1px solid black;" >Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0136</th>
<th style="border:1px solid black;" >Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0137</th>
<th style="border:1px solid black;" >Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0138</th>
<th style="border:1px solid black;" >Avaliação de gravidade agregada</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Visio Viewer 2010 e Microsoft Visio Viewer 2010 Service Pack 1 (edição de 32 bits)</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Visio Viewer 2010 e Microsoft Visio Viewer 2010 Service Pack 1 (edição de 64 bits)</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Execução Remota de Código</td>
<td style="border:1px solid black;"><strong>Importante</strong> <br />
Execução Remota de Código</td>
...
Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0019  
------------------------------------------------------------------------------------
  
 
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Visio Viewer valida os atributos ao manipular arquivos do Visio especialmente criados. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0019](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0019).
  
#### Fatores atenuantes da Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0019
...
#### Soluções alternativas para a Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0019
...
#### Perguntas frequentes sobre a Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0019
  
**Qual é o escopo da vulnerabilidade?**   
Essa é uma vulnerabilidade de execução remota de código.
  
**O que provoca a vulnerabilidade?**   
A vulnerabilidade existe na maneira como o Microsoft Visio Viewer manipula a memória ao analisar arquivos do Visio especialmente criados.
...
Em um cenário de ataque pela Web, o invasor terá que hospedar um site que contenha um arquivo especialmente criado do Visio usado para tentar explorar esta vulnerabilidade. Além disso, sites comprometidos e sites que aceitem ou hospedem conteúdo fornecido pelo usuário podem conter conteúdo especialmente desenvolvido que pode explorar esta vulnerabilidade. Não há como o invasor forçar os usuários a visitarem o site mal intencionado. Em vez disso, o invasor terá de persuadir os usuários a visitar o site, geralmente fazendo com que eles cliquem em um link que os leve ao site do invasor, e então convencê-los a abrir um arquivo do Visio especialmente criado.
...
Esta atualização elimina a vulnerabilidade, corrigindo a maneira como o Microsoft Visio Viewer valida dados ao abrir arquivos do Visio especialmente criados.
...
Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0020  
------------------------------------------------------------------------------------
  
 
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Visio Viewer valida os atributos ao manipular arquivos do Visio especialmente criados. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0020](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0020).
  
#### Fatores atenuantes da Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0020
...
#### Soluções alternativas para a Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0020
...
#### Perguntas frequentes sobre a Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0020
...
Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0136  
------------------------------------------------------------------------------------
  
 
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Visio Viewer valida os atributos ao manipular arquivos do Visio especialmente criados. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0136](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0136).
  
#### Fatores atenuantes da Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0136
...
#### Soluções alternativas para a Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0136
...
#### Perguntas frequentes sobre a Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0136
...
Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0137  
------------------------------------------------------------------------------------
  
 
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Visio Viewer valida os atributos ao manipular arquivos do Visio especialmente criados. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0137](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0137).
  
#### Fatores atenuantes da Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0137
...
#### Soluções alternativas para a Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0137
...
#### Perguntas frequentes sobre a Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0137
...
Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0138  
------------------------------------------------------------------------------------
  
 
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Visio Viewer valida os atributos ao manipular arquivos do Visio especialmente criados. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0138](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0138).
  
#### Fatores atenuantes da Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0138
...
#### Soluções alternativas para a Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0138
...
#### Perguntas frequentes sobre a Vulnerabilidade de corrupção de memória de formato de arquivo de VSD - CVE-2012-0138
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2597170">Artigo 2597170 da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<caption>
Opç ões de instalação da atualização de segurança para as quais há suporte
</caption>
</table>
...
-   Xin Ouyang da [Palo Alto Networks](http://www.paloaltonetworks.com/) por relatar a Corrupção de memória de VSD (CVE-2012-0019)  
-   Xin Ouyang da [Palo Alto Networks](http://www.paloaltonetworks.com/) por relatar a Corrupção de memória de VSD (CVE-2012-0020)  
-   Xin Ouyang da [Palo Alto Networks](http://www.paloaltonetworks.com/) por relatar a Corrupção de memória de VSD (CVE-2012-0136)  
-   Xin Ouyang da [Palo Alto Networks](http://www.paloaltonetworks.com/) por relatar a Corrupção de memória de VSD (CVE-2012-0137)  
-   Xin Ouyang da [Palo Alto Networks](http://www.paloaltonetworks.com/) por relatar a Corrupção de memória de VSD (CVE-2012-0138)
