...
ms:assetid: 'ms12-032'
ms:contentKeyID: 61234554
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-032(v=Security.10)'
---
...
Vulnerabilidade no TCP/IP pode permitir a elevação de privilégio (2688338)
--------------------------------------------------------------------------
...
Esta atualização de segurança resolve uma vulnerabilidade divulgada publicamente e uma vulnerabilidade relatada em particular no Microsoft Windows. A mais rigorosa dessas vulnerabilidades pode permitir elevação de privilégio se um invasor fizer logon em um sistema e executar um aplicativo especialmente criado.
...
A atualização de segurança aborda as vulnerabilidades modificando a maneira como o Firewall do Windows manipula pacotes de transmissão de saída e modificando a maneira como a pilha TCP/IP do Windows manipula a ligação de um endereço IPv6 a uma interface local. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
<td style="border:1px solid black;">
KB2588516 do [MS11-083](http://technet.microsoft.com/pt-br/security/bulletin/ms11-083) substituído por KB2688338
</td>
</tr>
...
<th style="border:1px solid black;" >
Vulnerabilidade de desvio do Firewall do Windows - CVE-2012-0174
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de liberação duplicada do TCP/IP - CVE-2012-0179
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Existe uma vulnerabilidade de desvio do recurso de segurança no Windows devido à maneira como o Firewall do Windows lida com os pacotes de transmissão de saída. Um invasor que explorar com êxito esta vulnerabilidade pode ignorar o mecanismo de proteção abrangente do Firewall do Windows para facilitar a exploração de outras vulnerabilidades.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0174](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0174).

#### Fatores atenuantes da Vulnerabilidade de desvio do Firewall do Windows - CVE-2012-0174

A Microsoft não identificou nenhum fator atenuante para essa vulnerabilidade.

#### Soluções alternativas para a Vulnerabilidade de desvio do Firewall do Windows - CVE-2012-0174

A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.

#### Perguntas frequentes sobre a Vulnerabilidade de desvio do Firewall do Windows - CVE-2012-0174

**Qual é o escopo da vulnerabilidade?**  
Esta é uma vulnerabilidade de desvio de recurso de segurança. Um invasor que explorar com êxito esta vulnerabilidade pode ignorar o Firewall do Windows para facilitar a exploração de outras vulnerabilidades.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando o Firewall do Windows falha em filtrar adequadamente os pacotes de transmissão de saída com uma regra de saída de firewall aplicada.

**Qualcomponente é afetado por esta vulnerabilidade?**  
O componente afetado por esta vulnerabilidade é a pilha TCP/IP (tcpip.sys).
...
Um invasor que explora com êxito esta vulnerabilidade pode passar pelo Firewall do Windows. O invasor pode usar outra vulnerabilidade para adquirir informações sobre o sistema de destino ou executar um código no sistema de destino.

**De que forma o invasor pode explorar avulnerabilidade?**  
Para usar esta vulnerabilidade, o invasor primeiro teria de conseguir acesso à sub-rede local do computador de destino. O invasor pode usar outra vulnerabilidade para adquirir informações sobre o sistema de destino ou executar um código no sistema de destino.

**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**  
Estações de trabalho e servidores são as principais vítimas dessa vulnerabilidade.

**O que a atualização faz?**  
A atualização aborda a vulnerabilidade modificando a maneira como o Firewall do Windows manipula pacotes de transmissão de saída.

**Qual é a diretiva de firewall de saída padrão?**  
A diretiva de firewall de saída padrão é configurada para permitir todo o tráfego de saída da rede pelo host. Para bloquear tráfego indesejado de saída da rede, os clientes deverão criar regras de firewall para bloquear o tráfego. Para obter mais informações sobre como adicionar regras de firewall de saída, consulte o artigo da Technet (em inglês) [Creating Rules that Block Unwanted Outbound Network Traffic](http://technet.microsoft.com/en-us/library/cc732306(v=ws.10).aspx).
...
Uma vulnerabilidade de elevação de privilégio existe na pilha TCP/IP do Windows que afeta o Windows 7 e o Windows Server 2008 R2. Nenhuma edição do Microsoft Windows XP, Windows Server 2003, Windows Vista e Windows Server 2008 é afetada. Esta vulnerabilidade é causada quando a pilha TCP/IP do Windows falha em manipular adequadamente a ligação de endereços IPv6.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0179](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0179).

#### Fatores atenuantes da Vulnerabilidade de liberação duplicada do TCP/IP - CVE-2012-0179
...
#### Soluções alternativas para a Vulnerabilidade de liberação duplicada do TCP/IP - CVE-2012-0179

A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.

#### Perguntas frequentes sobre a Vulnerabilidade de liberação duplicada do TCP/IP - CVE-2012-0179

**Qual é o escopo da vulnerabilidade?**  
Esta é uma vulnerabilidade de elevação de privilégio.

**O que provoca a vulnerabilidade?**  
Esta vulnerabilidade é causada quando a pilha TCP/IP do Windows falha em manipular adequadamente a ligação de endereços IPv6 a uma interface local.
...
**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**  
Servidores e estações de trabalho são afetados por esta vulnerabilidade.

**O que a atualização faz?**  
A atualização corrige a vulnerabilidade modificando a forma como a pilha TCP/IP do Windows manipula a ligação de endereços IPv6 a uma interface local.

**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**  
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2012-0179](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0179) da lista Common Vulnerability and Exposure.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2688338">Artigo 2688338 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
-   Bojan Zdrnja, da [INFIGO IS](http://www.infigo.hr/), por reportar a Vulnerabilidade de desvio do Firewall do Windows (CVE-2012-0174)  
-   Anatoliy Glagolev, da [Genesys Telecommunications](http://www.genesyslab.com/), por trabalhar conosco na Vulnerabilidade de liberação duplicada do TCP/IP (CVE-2012-0179)
...
-   V1.1 (09 de maio de 2012): Corrigidos fatores atenuantes de CVE-2012-0174 e CVE-2012-0179 na seção **Informações sobre a vulnerabilidade**.
