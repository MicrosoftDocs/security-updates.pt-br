---
TOCTitle: 'MS12-045'
Title: 'Microsoft Security Bulletin MS12-045 - Crítica'
ms:assetid: 'ms12-045'
ms:contentKeyID: 61234567
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-045(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-045 - Crítica
==============================================

Vulnerabilidade no Microsoft Data Access Components pode permitir a execução remota de código (2698365)
-------------------------------------------------------------------------------------------------------

Publicado: terça-feira, 10 de julho de 2012 | Atualizado: terça-feira, 11 de setembro de 2012
...
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular no Microsoft Windows. A vulnerabilidade pode permitir a execução remota de código caso um usuário exiba uma página da Web especialmente criada. O invasor que explorar com êxito essa vulnerabilidade poderá obter os mesmos direitos que o usuário atual. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Esta atualização de segurança foi classificada como Crítica para todas as edições com suporte do Windows XP, Windows Vista e Windows 7, e como Moderada para todas as edições com suporte do Windows Server 2003, Windows Server2008 e Windows Server 2008 R2. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança elimina a vulnerabilidade modificando a maneira como o Microsoft Data Access Components manipula objetos na memória. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Problemas conhecidos.** O [artigo 2698365 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2698365) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
<sup>[1]</sup>A atualização KB2698365 também aplica-se ao Windows Data Access Components 6.1. Os clientes que instalaram a atualização [KB2640696](http://www.microsoft.com/download/details.aspx?id=28422) terão o Windows Data Access Components 6.1 instalado em seus sistemas, e deverão instalar a atualização KB2698365 para abordar a vulnerabilidade.

**Softwares não afetados**

| **Sistema operacional** (instalação de Núcleo de Servidor)                                             | **Componente**                     |
|--------------------------------------------------------------------------------------------------------|------------------------------------|
| Windows Server 2008 para sistemas de 32 bits Service Pack 2 (instalação do núcleo do servidor)         | Windows Data Access Components 6.0 |
| Windows Server 2008 para sistemas baseados em x64 Service Pack 2 (instalação do núcleo do servidor)    | Windows Data Access Components 6.0 |
| Windows Server 2008 R2 para sistemas baseados em x64 (instalação do núcleo do servidor)                | Windows Data Access Components 6.0 |
| Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1 (instalação do núcleo do servidor) | Windows Data Access Components 6.0 |
...
<th style="border:1px solid black;" >
Vulnerabilidade de RCE de estouro de heap de tamanho de cache ADO - CVE-2012-1891
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
<tr>
<td style="border:1px solid black;">
Microsoft Data Access Components 2.8 Service Pack 1 no Windows XP Service Pack 3
</td>
<td style="border:1px solid black;">
**Crítica**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Data Access Components 2.8 Service Pack 2 no Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Microsoft Data Access Components 2.8 Service Pack 2 no Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**Moderada**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Data Access Components 2.8 Service Pack 2 no Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Moderada**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Microsoft Data Access Components 2.8 Service Pack 2 no Windows Server 2003 com SP2 para sistemas baseados no Itanium
</td>
<td style="border:1px solid black;">
**Moderada**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Data Access Components 6.0 no Windows Vista Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Windows Data Access Components 6.0 no Windows Vista x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**Crítica**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Data Access Components 6.0 no Windows Server 2008 para sistemas de 32 bits Service Pack 2
</td>
<td style="border:1px solid black;">
**Moderada**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Windows Data Access Components 6.0 no Windows Server 2008 para sistemas de x64 Service Pack 2
</td>
<td style="border:1px solid black;">
**Moderada**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Data Access Components 6.0 no Windows Server 2008 para sistemas baseados em Itanium Service Pack 2
</td>
<td style="border:1px solid black;">
**Moderada**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Windows Data Access Components 6.0 no Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1
</td>
<td style="border:1px solid black;">
**Crítica**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Data Access Components 6.0 no Windows 7 para sistemas x64 e Windows 7 para sistemas x64 Service Pack 1
</td>
<td style="border:1px solid black;">
**Crítica**   
Execução Remota de Código
...
<tr>
<td style="border:1px solid black;">
Windows Data Access Components 6.0 no Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1
</td>
<td style="border:1px solid black;">
**Moderada**   
Execução Remota de Código
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Data Access Components 6.0 no Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas baseados em Itanium Service Pack 1
</td>
<td style="border:1px solid black;">
**Moderada**   
Execução Remota de Código
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft Data Access Components acessa um objeto na memória que foi inicializado incorretamente. O invasor que tenha explorado com êxito esta vulnerabilidade pode executar código arbitrário no sistema de destino. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-1891](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1891).

#### Fatores atenuantes da Vulnerabilidade de RCE de estouro de heap de tamanho de cache ADO - CVE-2012-1891
...
#### Soluções alternativas para a Vulnerabilidade de RCE de estouro de heap de tamanho de cache ADO - CVE-2012-1891
...
#### Perguntas frequentes sobre a Vulnerabilidade de RCE de estouro de heap de tamanho de cache ADO - CVE-2012-1891

**Qual é o escopo da vulnerabilidade?** 
Essa é uma vulnerabilidade de execução remota de código no contexto do usuário atual.

**O que provoca a vulnerabilidade?** 
A vulnerabilidade é causada quando processos do Microsoft Data Access Components especialmente criam código de XML, resultando no acesso de um objeto na memória que não foi inicializado adequadamente.

**O que é o Microsoft Data Access Components?** 
O [Microsoft Data Access Components](http://msdn.microsoft.com/en-us/library/aa968814(v=vs.85).aspx) (MDAC, site em inglês) é um conjunto de componentes que permite aos programas acessar bancos de dados e manipular os dados contidos neles. Bancos de dados modernos podem assumir uma variedade de formas (por exemplo, bancos de dados do SQL Server, bancos de dados do Microsoft Access e arquivos XML) e podem ser hospedados numa variedade de locais (por exemplo, no sistema local ou num servidor de banco de dados remoto). O MDAC fornece um conjunto consolidado de funções para trabalhar com diferentes tipos de fontes de dados de forma consistente. Começando pelo Windows Vista, o MDAC é conhecido como Windows Data Access Components (WDAC).
...
A atualização elimina a vulnerabilidade modificando a maneira como o Microsoft Data Access Components manipula objetos na memória.
...
<td style="border:1px solid black;">Use o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2698365$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2698365">Artigo 2698365 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Um pesquisador anônimo, que trabalha na [Zero Day Iniciative](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/) da [TippingPoint](http://www.zerodayinitiative.com/), por relatar a Vulnerabilidade de RCE de estouro de heap de tamanho de cache ADO (CVE-2012-1891)
...
-   V1.1 (31 de julho de 2012): Boletim revisado para anunciar uma alteração de detecção nos pacotes do Windows Vista para KB2698365 a fim de corrigir um problema de nova oferta do Windows Update. Esta é apenas uma alteração de detecção. Os clientes que já atualizaram seus sistemas com êxito não precisam fazer mais nada.  
-   V1.2 (15 de agosto de 2012): Esclarecido que esta atualização também aplica-se ao Windows Data Access Components 6.1 no Windows 7 Service Pack 1 e Windows Server 2008 R2 Service Pack 1. Esta é apenas uma alteração informativa. Os clientes que já atualizaram seus sistemas com êxito não precisam fazer mais nada.  
-   V1.3 (11 de setembro de 2012): Um link para o artigo 2698365 (em inglês) da Microsoft Knowledge Base foi adicionado à seção Problemas conhecidos na Sinopse.
