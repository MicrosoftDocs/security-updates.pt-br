---
TOCTitle: 'MS12-049'
Title: 'Microsoft Security Bulletin MS12-049 - Importante'
ms:assetid: 'ms12-049'
ms:contentKeyID: 61234571
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-049(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-049 - Importante
=================================================

Vulnerabilidade no TLS pode permitir divulgação de informações (2655992)
------------------------------------------------------------------------
...
Esta atualização de segurança resolve uma vulnerabilidade divulgada publicamente no TLS. A vulnerabilidade pode permitir a divulgação não autorizada de informações se um invasor interceptar tráfego da web criptografado servido de um sistema afetado. Todos os pacotes de criptografia que não usam o modo CBC não são afetados.
...
A atualização de segurança elimina a vulnerabilidade, modificando a maneira como os componentes do Windows Secure Channel (SChannel) e do Cryptography API: Next Generation (CNG) controlam pacotes de rede criptografados. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
<td style="border:1px solid black;">
KB980436 no boletim [MS10-049](http://technet.microsoft.com/pt-br/security/bulletin/ms10-049) substituído pelo KB2655992
</td>
</tr>
...
<td style="border:1px solid black;">
KB2585542 no [MS12-006](http://technet.microsoft.com/pt-br/security/bulletin/ms12-006) substituído por KB2655992
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2207566 no boletim [MS10-085](http://technet.microsoft.com/pt-br/security/bulletin/ms10-085) substituído pelo KB2655992
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=97030267-6b19-46ae-84ce-0bb1f91ab951) (instalação do núcleo do servidor)  
(KB2655992)
</td>
<td style="border:1px solid black;">
Divulgação não autorizada de informação
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8a5f6e84-5e5b-42c3-a5b7-65defdb0665f) (instalação do núcleo do servidor)  
(KB2655992)
</td>
<td style="border:1px solid black;">
Divulgação não autorizada de informação
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=c9ef728f-abef-4076-bb13-7488af471aa4) (instalação do núcleo do servidor)  
(KB2655992)
</td>
<td style="border:1px solid black;">
Divulgação não autorizada de informação
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c9ef728f-abef-4076-bb13-7488af471aa4) (instalação do núcleo do servidor)  
(KB2655992)
</td>
<td style="border:1px solid black;">
Divulgação não autorizada de informação
...
Os hashes SHA1 e SHA2 das atualizações de segurança podem ser usados para verificar a autenticidade de pacotes de atualização de segurança baixados. Para informações sobre hashes pertencentes a esta atualização, consulte [artigo 2655992 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2655992).
...
<th style="border:1px solid black;" >
Vulnerabilidade de protocolo TLS - CVE-2012-1870
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
<span></span>
Existe uma vulnerabilidade de divulgação não autorizada de informações no protocolo de criptografia TLS. Esta vulnerabilidade afeta o protocolo e não é específica do sistema operacional Windows. Esta é uma vulnerabilidade de divulgação de informações que permite a descriptografia de tráfego de TLS criptografado. Esta vulnerabilidade impacta principalmente o tráfego de HTTPS, já que o navegador é o principal vetor de ataque, e todo o tráfego da web servido por HTTPS ou conteúdo misto de HTTP/HTTPS é afetado.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1870).

#### Fatores atenuantes da Vulnerabilidade de protocolo TLS - CVE-2012-1870

A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:

-   Todos os pacotes de criptografia que não usam o modo CBC não são afetados.

#### Soluções alternativas para a Vulnerabilidade de protocolo TLS - CVE-2012-1870
...
#### Perguntas frequentes sobre a Vulnerabilidade de protocolo TLS - CVE-2012-1870

**Qual é o escopo da vulnerabilidade?** 
Essa é uma vulnerabilidade de divulgação de informações.

**O que provoca a vulnerabilidade?** 
A vulnerabilidade é causada por uma falha de projeto no protocolo TLS, quando o modo de operação CBC (Cipher-block chaining) é usado.
...
A atualização modifica a maneira como os componentes do Windows Secure Channel (SChannel) e do Cryptography API: Next Generation (CNG) controlam pacotes de rede criptografados.

**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?** 
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2012-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1870) da lista Common Vulnerability and Exposure.
...
<td style="border:1px solid black;">Use o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2655992$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaçõessobre</strong> <strong>o</strong> <strong>arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2655992">Artigo 2655992 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
