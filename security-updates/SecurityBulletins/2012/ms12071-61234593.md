---
TOCTitle: 'MS12-071'
Title: 'Microsoft Security Bulletin MS12-071 - Crítica'
ms:assetid: 'ms12-071'
ms:contentKeyID: 61234593
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-071(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-071 - Crítica
==============================================

Atualização de segurança cumulativa para o Internet Explorer (2761451)
----------------------------------------------------------------------
...
<td style="border:1px solid black;">
KB2744842 do [MS12-063](http://technet.microsoft.com/pt-br/security/bulletin/ms12-063) substituído por KB2761451
</td>
</tr>
...
Os hashes SHA1 e SHA2 das atualizações de segurança podem ser usados para verificar a autenticidade de pacotes de atualização de segurança baixados. Para informações sobre hashes relacionados a esta atualização, consulte o [artigo 2761451 (em inglês) da Microsoft Knowledge Base](https://support.microsoft.com/kb/2761451).
...
<th style="border:1px solid black;" >
Vulnerabilidade de uso após liberação do CFormElement - CVE-2012-1538
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de uso após liberação do CTreePos - CVE-2012-1539
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de uso após liberação do CTreeNode - CVE-2012-4775
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-1538](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1538).

#### Fatores atenuantes da Vulnerabilidade de uso após liberação do CFormElement - CVE-2012-1538
...
#### Soluções alternativas para a Vulnerabilidade de uso após liberação do CFormElement - CVE-2012-1538
...
#### Perguntas frequentes sobre a Vulnerabilidade de uso após liberação do CFormElement - CVE-2012-1538
...
Esta vulnerabilidade requer que um usuário esteja conectado e visite um site para que uma ação mal-intencionada ocorra. Portanto, os sistemas nos quais o Internet Explorer 9 é usado com frequência, como estações de trabalho ou servidores de terminal, estão mais expostos a essa vulnerabilidade.
...
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-1539](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1539).

#### Fatores atenuantes da Vulnerabilidade de uso após liberação do CTreePos - CVE-2012-1539
...
#### Soluções alternativas para a Vulnerabilidade de uso após liberação do CTreePos - CVE-2012-1539
...
#### Perguntas frequentes sobre a Vulnerabilidade de uso após liberação do CTreePos - CVE-2012-1539
...
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-4775](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4775).

#### Fatores atenuantes da Vulnerabilidade de uso após liberação do CTreeNode - CVE-2012-4775
...
#### Soluções alternativas para a Vulnerabilidade de uso após liberação do CTreeNode - CVE-2012-4775
...
#### Perguntas frequentes sobre a Vulnerabilidade de uso após liberação do CTreeNode - CVE-2012-4775
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2761451">artigo 2761451 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
-   Jose A. Vazquez Gonzalez, do spa-s3c.blogspot.com, que trabalha com a [VeriSign iDefense Labs](http://labs.idefense.com/), por relatar a Vulnerabilidade de uso após liberação do CFormElement (CVE-2012-1538)  
-   [Omair](http://krash.in/)  
-   , por relatar a Vulnerabilidade de uso após liberação do CFormElement (CVE-2012-1538)  
-   Jose A. Vazquez Gonzalez, do spa-s3c.blogspot.com, que trabalha com a [VeriSign iDefense Labs](http://labs.idefense.com/), por relatar a Vulnerabilidade de uso após liberação do CTreePos (CVE-2012-1539)  
-   Cheng-da Tsai (Orange), Sung-ting Tsai e Ming-chieh Pan (Nanika), da [Trend Micro](http://www.trendmicro.com/), por reportarem a Vulnerabilidade de uso após liberação do CTreeNode (CVE-2012-4775)
