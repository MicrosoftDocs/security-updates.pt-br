---
TOCTitle: 'MS13-005'
Title: 'Microsoft Security Bulletin MS13-005 - Importante'
ms:assetid: 'ms13-005'
ms:contentKeyID: 61234610
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms13-005(v=Security.10)'
---


Microsoft Security Bulletin MS13-005 - Importante
=================================================

Vulnerabilidade no driver do modo do kernel do Windows pode permitir a elevação de privilégio (2778930)
-------------------------------------------------------------------------------------------------------

Publicado: terça-feira, 8 de janeiro de 2013 | Atualizado: terça-feira, 12 de fevereiro de 2013
...
**Problemas conhecidos.** O [artigo 2778930 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2778930) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
<td style="border:1px solid black;">
KB2779030 no boletim [MS12-078](http://go.microsoft.com/fwlink/?linkid=271624) substituído por KB2778930
</td>
</tr>
...
Os hashes SHA1 e SHA2 das atualizações de segurança podem ser usados para verificar a autenticidade de pacotes de atualização de segurança baixados. Para obter informações sobre hashes relacionados a esta atualização, consulte o [artigo 2778930 (em inglês) da Microsoft Knowledge Base](https://support.microsoft.com/kb/2778930).
...
<th style="border:1px solid black;" >
Vulnerabilidade no controle de mensagens inadequadas do Win32k - CVE-2013-0008
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Existe uma vulnerabilidade de elevação de privilégio quando o kernel do Windows controla as mensagens de transmissão da janela. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2013-0008](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0008).

#### Fatores atenuantes da Vulnerabilidade de controle de mensagens inadequadas do Win32k - CVE-2013-0008

O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.

#### Soluções alternativas para a Vulnerabilidade de controle de mensagens inadequadas do Win32k - CVE-2013-0008

A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade

#### Perguntas frequentes sobre a Vulnerabilidade de controle de mensagens inadequadas do Win32k - CVE-2013-0008

**Qual é o escopo da vulnerabilidade?**  
Esta é uma vulnerabilidade de elevação de privilégio.

**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando o driver do modo kernel do Windows controla inadequadamente as mensagens de transmissão da janela.
...
Um invasor que explorar com êxito esta vulnerabilidade pode executar o código arbitrário no contexto de um processo de Nível de integridade (IL) mais alto. Se um usuário estiver conectado com direitos administrativos, o invasor poderá assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

**O que é o Mecanismo de Integridade do Windows?**  
O mecanismo de integridade do Windows é um componente essencial de arquitetura de segurança do Windows que usa níveis de integridade (IL) para restringir as permissões de acesso de aplicativos que são executados sob a mesma conta de usuário e que são menos confiáveis. O nível de integridade é uma representação da credibilidade de execução de processos de aplicativos e objetos, como os arquivos criados pelo aplicativo. O mecanismo de integridade fornece aos gerentes de recursos, como o sistema de arquivos, a capacidade de usar políticas predefinidas que impedem processos de integridade mais baixa, ou de menor credibilidade, de ler ou modificar objetos de integridade mais alta. O mecanismo de integridade permite que o modelo de segurança do Windows imponha novas restrições de controle de acesso que não podem ser definidas, concedendo permissões de grupo e usuários em listas de controle de acesso (ACL).

**De que forma o invasor pode explorar a vulnerabilidade?**  
Esta vulnerabilidade requer que um invasor convença um usuário a executar um aplicativo especialmente criado.
...
A atualização elimina a vulnerabilidade, corrigindo a maneira como o driver do modo do kernel do Windows gerencia as mensagens de transmissão da janela.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2778930">artigo 2778930 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
| **Informações sobre o arquivo**       | Consulte o [artigo 2778930 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2778930)                                                   |
...
-   V1.1 (9 de janeiro de 2013): Corrigidas tabelas de resumo de detecção e implantação. Esta é apenas uma alteração informativa. Os clientes que já atualizaram seus sistemas com êxito não precisam fazer mais nada.  
-   V1.2 (12 de fevereiro de 2013): Um link para o artigo 2778930 (em inglês) da Microsoft Knowledge Base foi adicionado à seção Problemas conhecidos na Sinopse.
