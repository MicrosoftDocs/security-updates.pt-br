---
TOCTitle: 'MS13-016'
Title: 'Microsoft Security Bulletin MS13-016 - Importante'
ms:assetid: 'ms13-016'
ms:contentKeyID: 61234621
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms13-016(v=Security.10)'
---


Microsoft Security Bulletin MS13-016 - Importante
=================================================

Vulnerabilidades no driver do modo do kernel do Windows pode permitir a elevação de privilégio (2778344)
--------------------------------------------------------------------------------------------------------
...
Esta atualização de segurança é classificada como Importante para todas as versões com suporte do Microsoft Windows exceto Windows 8, Windows Server 2012 e Windows RT. Para Windows 8, Windows Server 2012 e Windows RT, esta atualização de segurança não tem nenhuma classificação de gravidade. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira como o driver do modo do kernel gerencia os objetos na memória. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Problemas conhecidos.** O [artigo 2778344 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2778344) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
<td style="border:1px solid black;">
KB2779030 no boletim [MS12-078](http://technet.microsoft.com/pt-br/security/bulletin/ms12-078)
</td>
</tr>
...
<td style="border:1px solid black;">
KB2778930 no boletim [MS13-005](http://technet.microsoft.com/pt-br/security/bulletin/ms13-005)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<sup>[2]</sup>As classificações de gravidade não se aplicam a esta atualização para o software especificado uma vez que os vetores de ataque conhecidos para essas vulnerabilidades estão bloqueados. No entanto, como medida de defesa abrangente, a Microsoft recomenda que clientes deste software apliquem esta atualização de segurança.
...
Os hashes SHA1 e SHA2 das atualizações de segurança podem ser usados para verificar a autenticidade de pacotes de atualização de segurança baixados. Para informações sobre hashes relacionados a esta atualização, consulte o [artigo 2778344 (em inglês) da Microsoft Knowledge Base](https://support.microsoft.com/kb/2778344).
...
<th style="border:1px solid black;" >
Vulnerabilidades de condição forçada do Win32k:
CVE-2013-1248
CVE-2013-1249
</th>
<th style="border:1px solid black;" >
...
<p> </p>
<table style="border:1px solid black;">
<caption>Vulnerabilidades de condição forçada do Win32k</caption>
<tbody>
<tr class="odd">
...
#### Fatores atenuantes das Vulnerabilidades de condição forçada do Win32k
...
#### Soluções alternativas para as Vulnerabilidades de condição forçada do Win32k

-   A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.

#### Perguntas frequentes sobre as Vulnerabilidades de condição forçada do Win32k
...
**Quando este boletim de segurança foi lançado, a Microsoft havia recebido algum relatório informando que essa vulnerabilidade estava sendoexplorada?**  
...
<td style="border:1px solid black;">Use o item <strong>Adicionar ou remover programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2778344$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2778344">artigo 2778344 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
| **Informações sobre o arquivo**       | Consulte o [artigo 2778344 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2778344)                                                   |
...
-   da  
-   [Google In](http://www.google.com)  
-   c e  
-   [Tencent Security Team](http://security.tencent.com/)  
-   por relatarem a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1248)  
-   [Mateusz “j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google In](http://www.google.com)  
-   c e  
-   [Tencent Security Team](http://security.tencent.com/)  
-   por relatarem a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1249)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatarem a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1250)  
-   [Gynvael Coldwind](http://gynvael.coldwind.pl)  
-   e  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatarem a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1251)  
-   [Gynvael Coldwind](http://gynvael.coldwind.pl)  
-   e  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatarem a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1252)  
-   [Gynvael Coldwind](http://gynvael.coldwind.pl)  
-   e  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatarem a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1253)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1254)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1255)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1256)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1257)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1258)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1259)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1260)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1261)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1262)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1263)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1264)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1265)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1266)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1267)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1268)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1269)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1270)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1271)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1272)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1273)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1274)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1275)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1276)  
-   [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org/)  
-   da  
-   [Google Inc](http://www.google.com)  
-   por relatar a Vulnerabilidade de condição forçada do Win32k (CVE-2013-1277)
...
-   V1.1 (12 de fevereiro de 2013): Um link para o artigo 2778344 (em inglês) da Microsoft Knowledge Base foi adicionado à seção Problemas conhecidos na Sinopse.
