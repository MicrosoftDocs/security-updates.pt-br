---
TOCTitle: 'MS13-001'
Title: 'Microsoft Security Bulletin MS13-001 - Crítica'
ms:assetid: 'ms13-001'
ms:contentKeyID: 61234606
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms13-001(v=Security.10)'
---


Microsoft Security Bulletin MS13-001 - Crítica
==============================================

Vulnerabilidade nos componentes do Spooler de impressão do Windows pode permitir execução remota de código (2769369)
--------------------------------------------------------------------------------------------------------------------
...
Esta é uma atualização de segurança classificada como Crítica para todas as edições do Windows 7 e Windows Server 2008 R2 com suporte. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados** nesta seção.

A atualização de segurança elimina a vulnerabilidade corrigindo como o Spooler de impressão do Windows controla trabalhos de impressão especialmente criados. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
Os hashes SHA1 e SHA2 das atualizações de segurança podem ser usados para verificar a autenticidade de pacotes de atualização de segurança baixados. Para informações sobre hashes relacionados a esta atualização, consulte o [artigo 2769369 (em inglês) da Microsoft Knowledge Base](https://support.microsoft.com/kb/2769369).

**Eu executo o Windows Server 2008 R2 (Instalação de núcleo de servidor), que está listada na tabela Softwares afetados. Por que está sendo oferecida a atualização KB2769369?**  
A atualização KB2769369 só é oferecida para sistemas que executam uma opção de instalação do núcleo de servidor do Windows Server 2008 R2 quando a configuração Printing-ServerCore-Role está habilitada.
...
<th style="border:1px solid black;" >
Vulnerabilidade nos componentes do Spooler de impressão do Windows - CVE-2013-0011
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Existe uma vulnerabilidade de execução remota de código na maneira como o Spooler de impressão do Microsoft Windows lida com trabalhos de impressão especialmente criados. A vulnerabilidade pode corromper a memória de forma a permitir a um invasor executar um código arbitrário.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2013-0011](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0011).

#### Fatores atenuantes da Vulnerabilidade nos componentes do Spooler de impressão do Windows - CVE-2013-0011
...
#### Soluções alternativas para a Vulnerabilidade nos componentes do Spooler de impressão do Windows - CVE-2013-0011
...
-   **Desabilitar o serviço de Spooler de Impressão**
    ...
    **Usando um script de implantação gerenciado:**
    ...
    3.  Execute o script de Registro criado na etapa 2 no sistema de destino com o seguinte comando:`Regedit /s Disable_spooler.reg`
...
#### Perguntas frequentes sobre a Vulnerabilidade nos componentes do Spooler de impressão do Windows - CVE-2013-0011

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de execução remota de código.

**O que provoca a vulnerabilidade?**  
Esta vulnerabilidade é causada quando o Spooler de impressão do Windows não consegue controlar um trabalho de impressão especialmente criado.
...
Um invasor não autenticado remoto pode explorar a vulnerabilidade enviando um trabalho de impressão especialmente criado ao servidor de impressão.

**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**  
Estações de trabalho e servidores são as principais vítimas dessa vulnerabilidade.

**O que a atualização faz?**  
A atualização elimina a vulnerabilidade corrigindo como o Spooler de impressão do Windows controla trabalhos de impressão especialmente criados.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2769369">artigo 2769369 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
