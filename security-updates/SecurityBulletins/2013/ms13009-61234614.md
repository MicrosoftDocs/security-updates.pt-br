...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2013-0015](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0015).

#### Fatores atenuantes da Vulnerabilidade de codificação de caracteres Shift JIS - CVE-2013-0015
...
#### Soluções alternativas para a Vulnerabilidade de codificação de caracteres Shift JIS - CVE-2013-0015
...
#### Perguntas frequentes sobre a Vulnerabilidade de codificação de caracteres Shift JIS - CVE-2013-0015
...
|-----------------------------------------------------------------------------------|----------------------------------------------------------------------------------|
| Vulnerabilidade de uso de SetCapture do Internet Explorer depois da liberação     | [CVE-2013-0018](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0018) |
| Vulnerabilidade de uso de COmWindowProxy do Internet Explorer depois da liberação | [CVE-2013-0019](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0019) |
| Vulnerabilidade de uso de CMarkup do Internet Explorer depois da liberação        | [CVE-2013-0020](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0020) |
| Vulnerabilidade de uso de vtable do Internet Explorer depois da liberação         | [CVE-2013-0021](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0021) |
| Vulnerabilidade de uso de LsGetTrailInfo do Internet Explorer depois da liberação | [CVE-2013-0022](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0022) |
| Vulnerabilidade de uso de CDispNode do Internet Explorer depois da liberação      | [CVE-2013-0023](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0023) |
| Vulnerabilidade de uso de pasteHTML do Internet Explorer depois da liberação      | [CVE-2013-0024](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0024) |
| Vulnerabilidade de uso de SLayoutRun do Internet Explorer depois da liberação     | [CVE-2013-0025](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0025) |
| Vulnerabilidade de uso de InsertElement do Internet Explorer depois da liberação  | [CVE-2013-0026](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0026) |
| Vulnerabilidade de uso de CPasteCommand do Internet Explorer depois da liberação  | [CVE-2013-0027](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0027) |
| Vulnerabilidade de uso de CObjectElement do Internet Explorer depois da liberação | [CVE-2013-0028](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0028) |
| Vulnerabilidade de uso de CHTML do Internet Explorer depois da liberação          | [CVE-2013-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0029) |

#### Fatores atenuantes da Vulnerabilidade de múltiplos usos no Internet Explorer depois da liberação
...
-   Por padrão, todas as versões com suporte do Microsoft Outlook, Microsoft Outlook Express e Windows Mail abrem emails em HTML na zona de sites restritos. A zona de sites restritos, que desabilita o script e os controles ActiveX, ajuda a reduzir o risco de um invasor ser capaz de usar esta vulnerabilidade para executar código mal-intencionado. Se um usuário clicar em um link em uma mensagem de email, ele ainda pode estar vulnerável à exploração dessa vulnerabilidade, por meio do cenário de ataque baseado na Web.
-   Por padrão, o Internet Explorer no Windows Server 2003, no Windows Server 2008, no Windows Server 2008 R2 e no Windows Server 2012 é executado em um modo restrito, conhecido como [Configuração de Segurança Reforçada](http://technet.microsoft.com/library/dd883248). Esse modo atenua estas vulnerabilidades. Consulte a seção Perguntas frequentes referente a essa vulnerabilidade para obter mais informações sobre a Configuração de Segurança Reforçada do Internet Explorer.

#### Soluções alternativas para a Vulnerabilidade de múltiplos usos no Internet Explorer depois da liberação
...
#### Perguntas frequentes sobre a Vulnerabilidade de múltiplos usos no Internet Explorer depois da liberação
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições do Windows XP com suporte:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\ie7updates\KB2792100-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições com suporte do Windows XP:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\ie8updates\KB2792100-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2792100">artigo 2792100 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 para todas as edições do Windows Server 2003 de 32 bits, edições baseadas em x64 e edições baseadas no Itanium para as quais existe suporte:<br />
Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2792100$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições do Windows Server 2003 de 32 bits, edições baseadas em x64 e edições baseadas no Itanium para as quais existe suporte:<br />
...
| **Informações sobre o arquivo**       | Consulte o [artigo 2792100 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2792100)                                                                                                                                                                   |
...
-   SkyLined, que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [HP,](http://www.hpenterprisesecurity.com/products) por relatar a Vulnerabilidade de uso de COmWindowProxy do Internet Explorer depois da liberação (CVE-2013-0019)  
...
-   Stephen Fewer, da [Harmony Security](http://www.harmonysecurity.com), que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [HP](http://www.hpenterprisesecurity.com/products), por relatar a Vulnerabilidade de uso de CMarkup do Internet Explorer depois da liberação (CVE-2013-0020)  
...
-   Arthur Gerkis, que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [HP](http://www.hpenterprisesecurity.com/products), por relatar a Vulnerabilidade de uso de CDispNode do Internet Explorer depois da liberação (CVE-2013-0023)  
-   Um pesquisador anônimo, que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [HP](http://www.hpenterprisesecurity.com/products), por relatar a Vulnerabilidade de uso de pasteHTML do Internet Explorer depois da liberação (CVE-2013-0024)  
-   Scott Bell, da [Security-Assessment.com](http://www.security-assessment.com), por relatar a Vulnerabilidade de uso de SLayoutRun do Internet Explorer depois da liberação (CVE-2013-0025)  
...
-   Scott Bell, da [Security-Assessment.com](http://www.security-assessment.com), por relatar a Vulnerabilidade de uso de CObjectElement do Internet Explorer depois da liberação (CVE-2013-0028)  
-   Jose A Vazquez, da Yenteasy Security Research, que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [HP](http://www.hpenterprisesecurity.com/products), por relatar a Vulnerabilidade de uso de CObjectElement do Internet Explorer depois da liberação (CVE-2013-0028)  
-   Stephen Fewer, da [Harmony Security](http://www.harmonysecurity.com), que trabalha com a [Zero Day Initiative](http://www.zerodayinitiative.com/) da [HP](http://www.hpenterprisesecurity.com/products), por relatar a Vulnerabilidade de uso de CHTML do Internet Explorer depois da liberação (CVE-2013-0029)  
...
-   Ollie Whitehouse, do [NCC Group,](http://www.nccgroup.com/)por trabalhar conosco em alterações adicionais de proteção abrangente incluídas neste boletim
