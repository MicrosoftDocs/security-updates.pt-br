...
-   **Desabilite a visualização de documentos WebReady**
    ...
    2.  Emita o seguinte comando do PowerShell:`Get-OwaVirtualDirectory | where {$_.OwaVersion -eq 'Exchange2007' -or $_.OwaVersion -eq 'Exchange2010'} | Set-OwaVirtualDirectory -WebReadyDocumentViewingOnPublicComputersEnabled:$False -WebReady``DocumentViewingOnPrivateComputersEnabled:$False`
