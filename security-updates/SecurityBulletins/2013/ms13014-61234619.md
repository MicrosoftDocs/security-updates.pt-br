---
TOCTitle: 'MS13-014'
Title: 'Microsoft Security Bulletin MS13-014 - Importante'
ms:assetid: 'ms13-014'
ms:contentKeyID: 61234619
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms13-014(v=Security.10)'
---


Microsoft Security Bulletin MS13-014 - Importante
=================================================

Vulnerabilidade no servidor NFS pode permitir a negação de serviço (2790978)
----------------------------------------------------------------------------
...
A atualização de segurança aborda a vulnerabilidade corrigindo como o servidor NFS manipula uma operação de arquivo. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
Os hashes SHA1 e SHA2 das atualizações de segurança podem ser usados para verificar a autenticidade de pacotes de atualização de segurança baixados. Para informações sobre hashes relacionados a esta atualização, consulte o [artigo 2790978 (em inglês) da Microsoft Knowledge Base](https://support.microsoft.com/kb/2790978).
...
<th style="border:1px solid black;" >
Vulnerabilidade de desreferência NULL - CVE-2013-1281
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
Existe uma vulnerabilidade de negação de serviço quando o servidor Windows NFS falha ao manipular devidamente uma operação de arquivo em um compartilhamento somente leitura. O invasor que explorar essa vulnerabilidade com êxito pode fazer com que o sistema afetado pare de responder e reinicie.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2013-1281](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1281).

#### Fatores atenuantes da Vulnerabilidade de desreferência NULL - CVE-2013-1281

A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:

-   Um invasor deve ter acesso ao compartilhamento de arquivos para explorar esta vulnerabilidade. Essa vulnerabilidade não pode ser explorada por usuários anônimos.
-   Esta vulnerabilidade somente afeta servidores Windows com a função NFS habilitada.

#### Soluções alternativas para a Vulnerabilidade de desreferência NULL - CVE-2013-1281

A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.

#### Perguntas frequentes sobre a Vulnerabilidade de desreferência NULL - CVE-2013-1281

**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de negação de serviço (site em inglês).

**O que provoca a vulnerabilidade?**  
Esta vulnerabilidade é causada quando o servidor Microsoft NFS falha ao manipular devidamente uma operação de arquivo.

**O que é NFS?**  
O Sistema de Arquivos de Rede (NFS) é um protocolo padrão do mercado, definido em [RFC 1094](http://www.ietf.org/rfc/rfc1094.txt?number=1094), que fornece acesso remoto e transparente a arquivos compartilhados pelas redes. Os Serviços do Sistema de Arquivos de Rede (NFS) fornecem uma solução de compartilhamento de arquivos para empresas que possuem um ambiente misto de Windows e UNIX. Os Serviços do NFS permite que os usuários transfiram arquivos entre computadores executando o sistema operacional Windows e computadores baseados em UNIX usando o protocolo NFS.

**Para que um invasor pode usar a vulnerabilidade?**  
O invasor que explorar com êxito esta vulnerabilidade pode fazer com que o sistema afetado pare de responder e reinicie.

**De que forma o invasor pode explorar a vulnerabilidade?**  
Um invasor pode explorar esta vulnerabilidade tentando renomear um arquivo ou uma pasta em um compartilhamento somente leitura.

**Quais são os principais sistemas que correm riscos com a vulnerabilidade?**  
Os servidores com a função Servidor NFS habilitada correm risco com esta vulnerabilidade.

**O que a atualização faz?**  
A atualização de segurança elimina a vulnerabilidade corrigindo como o servidor NFS manipula uma operação de arquivo.

**Quando esse boletim de segurança foi lançado, essa vulnerabilidade já tinha sido divulgada publicamente?**  
Não. A Microsoft recebeu informações sobre esta vulnerabilidade por meio da divulgação coordenada de vulnerabilidades.

**Quando este boletim de segurança foi lançado, a Microsoft havia recebido algum relatório informando que esta vulnerabilidade estava sendo explorada?**  
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2790978">artigo 2790978 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
