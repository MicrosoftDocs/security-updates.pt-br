---
TOCTitle: 'MS13-021'
Title: 'Microsoft Security Bulletin MS13-021 - Crítica'
ms:assetid: 'ms13-021'
ms:contentKeyID: 61234625
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms13-021(v=Security.10)'
---


Microsoft Security Bulletin MS13-021 - Crítica
==============================================

Atualização de segurança cumulativa para o Internet Explorer (2809289)
----------------------------------------------------------------------
...
| Artigo da Microsoft Knowledge Base: | [2809289](https://support.microsoft.com/kb/2809289) |
|-------------------------------------|-----------------------------------------------------|
...
<td style="border:1px solid black;">
2792100 no [MS13-009](http://technet.microsoft.com/pt-br/security/bulletin/ms13-009)
</td>
</tr>
...
<td style="border:1px solid black;">
2792100 em [MS13-009](http://technet.microsoft.com/pt-br/security/bulletin/ms13-009) e 2797052 em [MS13-010](http://technet.microsoft.com/pt-br/security/bulletin/ms13-010)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Sim. A atualização 2809289 está disponível para o Internet Explorer 10 Release Preview para Windows 7 em sistemas de 32 bits Service Pack 1 e Windows 7 em sistemas baseados em x64 Service Pack 1. Os clientes com Internet Explorer 10 Release Preview para Windows 7 em sistemas de 32 bits Service Pack 1 e Windows 7 em sistemas baseados em x64 Service Pack 1 devem aplicar as atualizações em seus sistemas. As atualizações estão disponíveis no [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130).
...
<th style="border:1px solid black;" >
Vulnerabilidade de uso do OnResize do Internet Explorer depois da liberação - CVE-2013-0087
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de uso do saveHistory do Internet Explorer depois da liberação - CVE-2013-0088
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de uso do CMarkupBehaviorContext do Internet Explorer depois da liberação - CVE-2013-0089
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de uso do CCaret do Internet Explorer depois da liberação - CVE-2013-0090
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de uso do CElement do Internet Explorer depois da liberação - CVE-2013-0091
</th>
</tr>
<tr>
...
<th style="border:1px solid black;" >
Vulnerabilidade de uso do GetMarkupPtr do Internet Explorer depois da liberação - CVE-2013-0092
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de uso do onBeforeCopy do Internet Explorer depois da liberação - CVE-2013-0093
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de uso do removeChild do Internet Explorer depois da liberação - CVE-2013-0094
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de uso do CTreeNode do Internet Explorer depois da liberação - CVE-2013-1288
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
|-------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|
| Vulnerabilidade de uso de OnResize do Internet Explorer depois da liberação               | [CVE-2013-0087](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0087) |
| Vulnerabilidade de uso de OnRsaveHistoryesize do Internet Explorer depois da liberação    | [CVE-2013-0088](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0088) |
| Vulnerabilidade de uso de CMarkupBehaviorContext do Internet Explorer depois da liberação | [CVE-2013-0089](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0089) |
| Vulnerabilidade de uso de CCaret do Internet Explorer depois da liberação                 | [CVE-2013-0090](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0090) |
| Vulnerabilidade de uso de CElement do Internet Explorer depois da liberação               | [CVE-2013-0091](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0091) |
| Vulnerabilidade de uso de GetMarkupPtr do Internet Explorer depois da liberação           | [CVE-2013-0092](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0092) |
| Vulnerabilidade de uso de onBeforeCopy do Internet Explorer depois da liberação           | [CVE-2013-0093](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0093) |
| Vulnerabilidade de uso de removeChild do Internet Explorer depois da liberação            | [CVE-2013-0094](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0094) |
| Vulnerabilidade de uso de CTreeNode do Internet Explorer depois da liberação              | [CVE-2013-1288](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1288) |
...
|----------------------------------------------------------------------------------|-------------------------|
| [CVE-2013-0087](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0087) | Não                     |
| [CVE-2013-0088](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0088) | Não                     |
| [CVE-2013-0089](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0089) | Não                     |
| [CVE-2013-0090](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0090) | Não                     |
| [CVE-2013-0091](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0091) | Não                     |
| [CVE-2013-0092](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0092) | Não                     |
| [CVE-2013-0093](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0093) | Não                     |
| [CVE-2013-0094](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0094) | Não                     |
| [CVE-2013-1288](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1288) | Sim                     |
...
<td style="border:1px solid black;">Internet Explorer 6 para todas as edições com suporte do Windows XP:<br />
Use o item <strong>Adicionar ou remover programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2809289$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 para todas as edições do Windows XP com suporte:<br />
Use o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\ie7updates\KB2809289-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 para todas as edições com suporte do Windows XP:<br />
Use o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\ie8updates\KB2809289-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaçõessobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2809289">artigo 2809289 (em inglês) da Base de dados de conhecimento Microsoft.</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">Para desinstalar uma atualização instalada pelo WUSA, use a opção /Uninstall ou clique em <strong>Painel de Controle</strong>, <strong>Sistema e Segurança</strong>; depois clique no <strong>Windows Update</strong>, clique em <strong>A<em>tualizações instaladas</em></strong> e faça sua seleção na lista de atualizações.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2809289">artigo 2809289 (em inglês) da Base de dados de conhecimento Microsoft.</a></td>
...
| **Informações sobre o arquivo**   | Consulte o [artigo 2809289 (em inglês) da Base de dados de conhecimento Microsoft.](http://support.microsoft.com/kb/2809289)                                                                                                                                                   |
...
-   Stephen Fewer, da [Harmony Security,](http://www.harmonysecurity.com) por relatar a Vulnerabilidade de uso do CCaret do Internet Explorer depois da liberação (CVE-2013-0090)  
-   SkyLined por relatar a Vulnerabilidade de uso do CCaret do Internet Explorer depois da liberação (CVE-2013-0090)  
