---
TOCTitle: 'MS13-049'
Title: 'Microsoft Security Bulletin MS13-049 - Importante'
ms:assetid: 'ms13-049'
ms:contentKeyID: 61234813
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms13-049(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS13-049 - Importante
=================================================

Vulnerabilidade no driver no modo kernel pode permitir negação de serviço (2845690)
-----------------------------------------------------------------------------------
...
Esta atualização de segurança é classificada como Importante para todas as edições com suporte do Windows 8, Windows Server 2012 e Windows RT, e como Moderada para todas as edições com suporte do Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira como o driver do Windows TCP/IP gerencia os pacotes especialmente criados. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
| Artigo da Microsoft Knowledge Base: | [2845690](https://support.microsoft.com/kb/2845690) |
|-------------------------------------|-----------------------------------------------------|
...
<td style="border:1px solid black;">
2790655 em [MS13-018](http://technet.microsoft.com/pt-br/security/bulletin/ms13-018)
</td>
</tr>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0042d190-04b1-4633-bf3e-c6bcf1532e14)  
(2845690)
</td>
<td style="border:1px solid black;">
Negação de Serviço
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4ce94666-91c6-4eb6-b90a-245b37ab2073)  
(2845690)
</td>
<td style="border:1px solid black;">
Negação de Serviço
...
<tr>
<td style="border:1px solid black;">
[Windows 7 para Sistemas Service Pack 1 baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=06041fdb-0e80-4738-bdb6-86c162b84420)  
(2845690)
</td>
<td style="border:1px solid black;">
Negação de Serviço
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 para Sistemas Service Pack 1 baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=90ef15f2-b2f6-4125-9188-9d296c0769c2)  
(2845690)
</td>
<td style="border:1px solid black;">
Negação de Serviço
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2 para Sistemas Service Pack 1 baseados em Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=6f0d6f4a-06e7-4466-bfd8-87fd61e843fd)  
(2845690)
</td>
<td style="border:1px solid black;">
Negação de Serviço
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0042d190-04b1-4633-bf3e-c6bcf1532e14) (instalação do núcleo do servidor)  
(2845690)
</td>
<td style="border:1px solid black;">
Negação de Serviço
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=90ef15f2-b2f6-4125-9188-9d296c0769c2) (instalação do núcleo do servidor)  
(2845690)
</td>
<td style="border:1px solid black;">
Negação de Serviço
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](http://www.microsoft.com/downloads/details.aspx?familyid=f2f59e32-0852-4d50-87e6-762552039a49) (instalação Server Core)  
(2845690)
</td>
<td style="border:1px solid black;">
Negação de Serviço
...
<th style="border:1px solid black;" >
Vulnerabilidade de estouro de número inteiro do TCP/IP - CVE-2013-3138
</th>
<th style="border:1px solid black;" >
Avaliação de severidade agregada
</th>
...
<span></span>
Há uma negação da vulnerabilidade do serviço no modo no qual o driver do Windows TCP/IP inadequadamente controla os pacotes durante a conexão do TCP. Um invasor que explorar essa vulnerabilidade com êxito poderá fazer o sistema de destino parar de responder.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2013-3138](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3138).
...
A vulnerabilidade é causada quando o driver do TCP/IP manipula inadequadamente pacotes durante a conexão do TCP.
...
Um invasor pode explorar esta vulnerabilidade enviando pacotes criados especialmente para o servidor.
...
A atualização elimina a vulnerabilidade, corrigindo a maneira como o driver do Windows TCP/IP gerencia os pacotes especialmente criados.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2845690">Artigo 2845690 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
| **Informações sobre o arquivo**   | Consulte o [Artigo 2845690 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2845690)                                                                           |
