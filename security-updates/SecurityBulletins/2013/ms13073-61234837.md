---
TOCTitle: 'MS13-073'
Title: 'Microsoft Security Bulletin MS13-073 - Importante'
ms:assetid: 'ms13-073'
ms:contentKeyID: 61234837
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms13-073(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS13-073 - Importante
=================================================

Vulnerabilidades no Microsoft Excel podem permitir a execução remota de código (2858300)
----------------------------------------------------------------------------------------
...
Essa atualização de segurança foi classificada como Importante para todas as edições com suporte do Microsoft Excel 2003, Microsoft Excel 2007, Microsoft Excel 2010, Microsoft Excel 2013, Microsoft Excel 2013 RT e Microsoft Office para Mac 2011; ela também é classificada como Importante para as versões com suporte do Microsoft Excel Viewer e do Pacote de Compatibilidade do Microsoft Office. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança aborda as vulnerabilidades corrigindo o modo como o Microsoft Excel e outro software afetado da Microsoft valida dados ao analisar arquivos do Office especialmente criados, e corrigindo a maneira com a qual o analisador de XML usado pelo Excel elimina entidades externas dentro de um arquivo especialmente criado. Para obter mais informação sobre as vulnerabilidades, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
| Artigo da Microsoft Knowledge Base: | [2858300](https://support.microsoft.com/kb/2858300) |
|-------------------------------------|-----------------------------------------------------|
...
<td style="border:1px solid black;">
2687481 em [MS12-076](http://technet.microsoft.com/pt-br/security/bulletin/ms12-076)
</td>
</tr>
...
<td style="border:1px solid black;">
2687307 em [MS12-076](http://technet.microsoft.com/pt-br/security/bulletin/ms12-076)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 Service Pack 1 (edições de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=465d3b7b-b76c-4d8a-a262-bc39e0e0f12d)  
(2760597)
</td>
<td style="border:1px solid black;">
Execução remota de código
...
<td style="border:1px solid black;">
2597126 em [MS12-076](http://technet.microsoft.com/pt-br/security/bulletin/ms12-076)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 Service Pack 2 (edições de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=465d3b7b-b76c-4d8a-a262-bc39e0e0f12d)  
(2760597)
</td>
<td style="border:1px solid black;">
Execução remota de código
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 Service Pack 1 (edições de 64 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=e3129e7c-e075-4e05-ab54-af885a7421d5)  
(2760597)
</td>
<td style="border:1px solid black;">
Execução remota de código
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 Service Pack 2 (edições de 64 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=e3129e7c-e075-4e05-ab54-af885a7421d5)  
(2760597)
</td>
<td style="border:1px solid black;">
Execução remota de código
...
<td style="border:1px solid black;">
[Microsoft Excel 2013 (edições de 32 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=7ed643f2-110c-482f-865f-d52b462b9c60)  
(2768017)
</td>
<td style="border:1px solid black;">
Execução remota de código
...
<td style="border:1px solid black;">
[Microsoft Excel 2013 (edições de 64 bits)](http://www.microsoft.com/downloads/details.aspx?familyid=286789e8-a717-427b-9a9c-b6f6cda6cfdc)  
(2768017)
</td>
<td style="border:1px solid black;">
Execução remota de código
...
<td style="border:1px solid black;">
2848689 em [MS13-051](http://technet.microsoft.com/pt-br/security/bulletin/ms13-051)
</td>
</tr>
<tr>
<th colspan="5">
...
<td style="border:1px solid black;">
2687313 em [MS12-076](http://technet.microsoft.com/pt-br/security/bulletin/ms12-076)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
[Pacote de compatibilidade do Microsoft Office Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=3a9ebaa6-2594-43ee-bb9c-64375b026ab6)  
(2760588)
</td>
<td style="border:1px solid black;">
Não Aplicável
...
<td style="border:1px solid black;">
2687311 em [MS12-076](http://technet.microsoft.com/pt-br/security/bulletin/ms12-076)
</td>
</tr>
</table>
 
<sup>[1]</sup>Para o Microsoft Office Excel 2007, além do pacote de atualização de segurança 2760583, os clientes também precisam instalar a atualização de segurança para o Pacote de compatibilidade do Microsoft Office (2760588) para ficarem protegidos das vulnerabilidades descritas nesse boletim.
...
<th style="border:1px solid black;" >
Vulnerabilidade de corrupção da memória do Microsoft Office - CVE-2013-3158
</th>
<th style="border:1px solid black;" >
Vulnerabilidade de resolução de entidades externas de XML - CVE-2013-3159
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
A vulnerabilidade é causada quando as versões afetadas do Microsoft Excel e de outro software afetado do Microsoft Office não gerenciam adequadamente os objetos na memória ao analisarem arquivos do Office especialmente criados.
...
Essa vulnerabilidade requer que um usuário abra um arquivo do Office criado especialmente com uma versão afetada do Microsoft Excel ou com outro software afetado do Microsoft Office.
...
Para exibir essa vulnerabilidade como uma entrada padrão na lista da Common Vulnerabilities and Exposures, consulte [CVE-2013-3158](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3158).
...
<span></span>
Uma vulnerabilidade de divulgação de informações existe na maneira como o Microsoft Excel analisa arquivos XML especialmente criados que contêm entidades externas.

Para exibir essa vulnerabilidade como uma entrada padrão na lista da Common Vulnerabilities and Exposures, consulte [CVE-2013-3159](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3159).
...
**O que provoca a vulnerabilidade?** 
A vulnerabilidade é causada quando o Microsoft Excel gerencia inadequadamente entidades externas do XML que são eliminadas dentro de outras declarações de entidades externas do XML.
...
Em um cenário de ataque por e-mail, um invasor poderá explorar a vulnerabilidade enviando ao usuário um arquivo especialmente criado e convencendo-o a abrir o arquivo em uma versão afetadas do Microsoft Excel.

Em um cenário de ataque com base na Web, um invasor terá que hospedar um site que contenha um arquivo usado para tentar explorar essa vulnerabilidade. Além disso, sites comprometidos e sites que aceitem ou hospedem conteúdo fornecido pelo usuário podem conter conteúdo especialmente desenvolvido que pode explorar esta vulnerabilidade. Não há como um invasor forçar usuários a visitar o site especialmente criado. Em vez disso, um invasor teria que persuadir os usuários a visitarem o site, geralmente fazendo com que eles cliquem em um link em um e-mail ou em uma mensagem do Instant Messenger que leva os usuários ao site do invasor, e então, convencê-los a abrir o arquivo especialmente criado em uma versão afetada do Microsoft Excel.

**Quais são os principais sistemas que correm riscos com a vulnerabilidade?** 
Esta vulnerabilidade requer que o usuário abra um arquivo especialmente criado com um aplicativo afetado para que qualquer ação mal-intencionada ocorra. Portanto, quaisquer sistemas nos quais os arquivos do Excel são visualizados com frequência, tais como estações de trabalho ou servidores de terminal, estão mais expostos a essa vulnerabilidade.

**O que a atualização faz?** 
A atualização aborda a vulnerabilidade corrigindo a maneira com que o analisador XML usado pelo Excel elimina entidades externas dentro de um arquivo especialmente criado.
...
#### Microsoft Excel 2003 (todas as edições)
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2810048">artigo 2810048 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
#### Microsoft Excel 2007 (todas as edições), Excel Viewer, Pacote de Compatibilidade do Office
...
<td style="border:1px solid black;">Para Microsoft Office 2007 Service Pack 3:<br />
Consulte o <a href="http://support.microsoft.com/kb/2760583">artigo 2760583 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para Microsoft Excel Viewer:<br />
Consulte o <a href="http://support.microsoft.com/kb/2760590">artigo 2760590 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Pacote de compatibilidade do Microsoft Office Service Pack 3:<br />
Consulte o <a href="http://support.microsoft.com/kb/2760588">artigo 2760588 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2760597">artigo 2760597 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Verificação da chave de Registro</strong></td>
<td style="border:1px solid black;">Não Aplicável</td>
...
#### Microsoft Excel 2013 (todas as edições)
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2768017">artigo 2768017 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
Faça download e instale a versão da atualização do Microsoft Office for Mac 2011 14.3.7 no idioma apropriado na [Central de Download da Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=3445fbdc-e092-4530-bf31-d60cecd53ab8).
...
-   Abra o volume da atualização do Microsoft Office for Mac 2011 14.3.7 na sua área de trabalho. Esta etapa pode ter sido executada para você.  
-   Para iniciar o processo de atualização, na janela de volume da atualização do Microsoft Office for Mac 2011 14.3.7, clique duas vezes no aplicativo de atualização do Microsoft Office for Mac 2011 14.3.7 e siga as instruções na tela.  
-   Quando a instalação tiver êxito, você poderá remover o instalador da atualização de seu disco rígido. Para verificar se a instalação foi concluída com êxito, consulte o tópico "Verificando a instalação da atualização". Para remover o instalador da atualização, primeiro arraste o volume da atualização do Microsoft Office 2011 for Mac 14.3.7 até a Lixeira e depois arraste o arquivo que você baixou até a Lixeira.
...
Se o número da Versão da última atualização instalada for **14.3.7**, a atualização foi instalada com êxito.
...
-   V1.1 (13 de setembro de 2013): Boletim revisado para anunciar alterações de detecção na atualização do Microsoft Excel 2003 (2810048), atualização do Microsoft Excel 2007 (2760583), atualização do Microsoft Excel Viewer (2760590), e atualização do Pacote de Compatibilidade do Microsoft Office (2760588). Elas são somente alterações de detecção. Não houve nenhuma alteração nos arquivos de atualização. Os clientes que já instalaram estas atualizações não precisam fazer mais nada. Também atualizamos de "Nenhum" para "Sim" na entrada Problemas conhecidos da seção **Artigo da Microsoft Knowledge Base**.
