...
<sup>[1]</sup>Sistemas clientes só serão afetados se as Remote Server Administration Tools tiverem sido instaladas.  

<sup>[2]</sup>Sistemas de servidor só serão afetados se o Gerenciamento da Diretiva de Grupo for configurado no servidor.  
...
<sup>[4]</sup>Esta atualização é para os sistemas que não têm a atualização 2919355 instalada. Consulte as **Perguntas frequentes de atualização** para obter mais informações.
