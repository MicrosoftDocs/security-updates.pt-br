...
Esta atualização de segurança foi classificada como Importante****para edições com suporte do Microsoft SharePoint Server 2007, Microsoft SharePoint Server 2010, Microsoft SharePoint Foundation 2010, Microsoft SharePoint Server 2013 e Microsoft SharePoint Foundation 2013. Para obter mais informações, consulte a seção **Software Afetado**.
