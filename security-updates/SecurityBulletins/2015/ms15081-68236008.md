...
-   **Remover as políticas de elevação do IE para Word, Excel, PowerPoint e Visio**
    ...
    **Como desfazer a solução alternativa**
    ...
    3.  Para cada um dos quatro arquivos .reg, execute as seguintes etapas:  
        a.  Clique no menu Arquivo e depois selecione **Importar**.  
        b.  Na caixa de diálogo Importar Arquivo do Registro, selecione o arquivo apropriado e clique em **Abrir**.  
        c.  Saia do Editor do Registro.  
