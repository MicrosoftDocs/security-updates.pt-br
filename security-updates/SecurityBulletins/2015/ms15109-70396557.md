...
Para negar acesso a TipBand.dll, digite os seguintes comandos em um prompt de comando administrativo:
...
Para desfazer a solução alternativa, digite o seguinte comando em um prompt de comando administrativo:
