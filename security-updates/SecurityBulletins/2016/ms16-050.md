---
TOCTitle: 'MS16-050'
Title: 'Boletim de Segurança da Microsoft MS16-050 - Crítico'
ms:assetid: 'ms16-050'
ms:contentKeyID: 72785233
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms16-050(v=Security.10)'
---

Boletim de Segurança da Microsoft MS16-050 - Crítico
====================================================
...
Para obter mais informações sobre essa atualização, consulte o [artigo 3154132 da Base de Dados de Conhecimento da Microsoft](https://support.microsoft.com/pt-br/kb/3154132).

Informações sobre a vulnerabilidade
-----------------------------------

<span id="sectionToggle1"></span>
Esta atualização de segurança corrige as seguintes vulnerabilidades, descritas no Boletim de Segurança da Adobe [APSB16-10](https://helpx.adobe.com/pt-br/security/products/flash-player/apsb16-10.html):

CVE-2016-1006, CVE-2016-1011, CVE-2016-1012, CVE-2016-1013, CVE-2016-1014, CVE-2016-1015, CVE-2016-1016, CVE-2016-1017, CVE-2016-1018 e CVE-2016-1019.
...
<td style="border:1px solid black;">
3144756 no [MS16-036](https://technet.microsoft.com/pt-br/library/security/ms16-036)
...
**Observação** O Windows Server 2016 Technical Preview 4 e o Windows Server 2016 Technical Preview 5 são afetados; a classificação de gravidade agregada é Crítica e o impacto é Moderado, execução remota de código. Recomenda-se que os consumidores que estiverem executando esses sistemas operacionais apliquem a atualização, que está disponível no [Windows Update](http://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=pt-br).
...
*Página gerada em 04.04.16 às 13:13:00-07:00.*