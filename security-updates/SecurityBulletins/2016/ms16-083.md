---
TOCTitle: 'MS16-083'
Title: 'Boletim de Segurança da Microsoft MS16-083 – Crítico'
ms:assetid: 'ms16-083'
ms:contentKeyID: 73142231
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms16-083(v=Security.10)'
---
Boletim de Segurança da Microsoft MS16-083 – Crítico
====================================================

Atualização de segurança para o Adobe Flash Player (3167685)
------------------------------------------------------------
...
Para obter mais informações sobre essa atualização, consulte o [artigo 3167685 da Base de Dados de Conhecimento da Microsoft](https://support.microsoft.com/pt-br/kb/3167685).

Informações sobre a vulnerabilidade
-----------------------------------

<span id="sectionToggle1"></span>
Esta atualização de segurança corrige as seguintes vulnerabilidades, descritas no Boletim de Segurança da Adobe [APSB16-18](https://helpx.adobe.com/br/security/products/flash-player/apsb16-18.html):
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/pt-br/download/details.aspx?id=52957)  
(3167685)
...
<td style="border:1px solid black;">
3163207 no [MS16-064](https://technet.microsoft.com/pt-br/library/security/ms16-064)
...
-   V1.0 (16.06.16): Boletim publicado.

*Página gerada em 06.06.16 às 14:43-07:00.*
