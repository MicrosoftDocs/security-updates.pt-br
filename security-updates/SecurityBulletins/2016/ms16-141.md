---
TOCTitle: 'MS16-141'
Title: 'Boletim de Segurança da Microsoft MS16-141 - Crítico'
ms:assetid: 'ms16-141'
ms:contentKeyID: 74240596
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms16-141(v=Security.10)'
---


Boletim de Segurança da Microsoft MS16-141 - Crítica
====================================================

Atualização de segurança para o Adobe Flash Player (3202790)
------------------------------------------------------------
...
Para obter mais informações sobre essa atualização, consulte o [artigo 3202790 da Base de Dados de Conhecimento da Microsoft](https://support.microsoft.com/pt-br/kb/3202790).

Informações sobre a vulnerabilidade
-----------------------------------

<span id="sectionToggle1"></span>
Esta atualização de segurança corrige as seguintes vulnerabilidades, descritas no Boletim de Segurança da Adobe [APSB16-37](http://helpx.adobe.com/br/security/products/flash-player/apsb16-37.html):
...
<td style="border:1px solid black;">
3201860 em [MS16-128](http://go.microsoft.com/fwlink/?linkid=832634)
...
*Página gerada em 07/11/2016 11:51-08:00.*
