net Explorer e, então, convencer um usuário a visualizar o site. O invasor também pode incorporar um controle ActiveX marcado como "seguro para inicialização" em um aplicativo ou documento do Microsoft Office que hospede o mecanismo de processamento do IE. O invasor também pode tirar proveito dos sites comprometidos e de sites que aceitam ou hospedam o conteúdo fornecido pelo usuário ou anúncios. Esses sites---
TOCTitle: 'MS16-154'
Title: 'Boletim de segurança da Microsoft MS16-154 - Crítica'
ms:assetid: 'ms16-154'
ms:contentKeyID: 74262460
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms16-154(v=Security.10)'
---


Boletim de Segurança da Microsoft MS16-154 - Crítica
====================================================
...
Para obter mais informações sobre essa atualização, consulte o [artigo 3209498 da Base de Dados de Conhecimento da Microsoft](https://support.microsoft.com/pt-br/kb/3209498).

Informações sobre a vulnerabilidade
-----------------------------------

<span id="sectionToggle1"></span>
Esta atualização de segurança corrige as seguintes vulnerabilidades, descritas no Boletim de Segurança da Adobe [APSB16-39](http://helpx.adobe.com/br/security/products/flash-player/apsb16-39.html):
...
<td style="border:1px solid black;">
3209498 em [MS16-129](https://go.microsoft.com/fwlink/?linkid=834404)
...
*Página gerada em 2016-12-07 12:31-08:00.*
