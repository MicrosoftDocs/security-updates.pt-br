---
TOCTitle: 'MS17-010'
Title: 'Boletim de Segurança da Microsoft MS17-010 – Crítico'
ms:assetid: 'ms17-010'
ms:contentKeyID: 74419910
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms17-010(v=Security.10)'
---
...
Esta atualização de segurança elimina vulnerabilidades no Microsoft Windows. A mais grave das vulnerabilidades poderá permitir a execução remota de código se um invasor enviar mensagens especialmente criadas para um servidor Windows SMBv1.
...
A atualização de segurança resolve as vulnerabilidades, corrigindo a maneira como o SMBv1 lida com solicitações especialmente criadas.

Para obter mais informações sobre as vulnerabilidades, consulte a seção **Informações sobre a vulnerabilidade**.

 
Para obter mais informações sobre essa atualização, consulte o [artigo 4013389 da Base de Dados de Conhecimento Microsoft](https://support.microsoft.com/pt-br/kb/4013389).
...
<td style="border:1px solid black;">
[**Vulnerabilidade de execução remota de código do Windows SMB – CVE-2017-0143**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0143)

</td>
<td style="border:1px solid black;">
[**Vulnerabilidade de execução remota de código do Windows SMB – CVE-2017-0144**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0144)

</td>
<td style="border:1px solid black;">
[**Vulnerabilidade de execução remota de código do Windows SMB – CVE-2017-0145**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0145)

</td>
<td style="border:1px solid black;">
[**Vulnerabilidade de execução remota de código do Windows SMB – CVE-2017-0146**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0146)

</td>
<td style="border:1px solid black;">
[**Vulnerabilidade de divulgação não autorizada de informações do Windows SMB – CVE-2017-0147**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0147)

</td>
<td style="border:1px solid black;">
[**Vulnerabilidade de execução remota de código do Windows SMB – CVE-2017-0148**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0148)
...
<td style="border:1px solid black;">
3177186 em [MS16-114](http://go.microsoft.com/fwlink/?linkid=824826)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 Service Pack 2 para sistemas de 32 bits](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012598)  
(4012598)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 Service Pack 2 para sistemas com base em x64](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012598)  
(4012598)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 Service Pack 2 para sistemas baseados em Itanium](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012598)  
(4012598)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 Service Pack 2 para sistemas de 32 bits](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012598) (instalação Server Core)  
(4012598)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 Service Pack 2 para sistemas com base em x64](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012598) (instalação Server Core)  
(4012598)
...
Várias vulnerabilidades de execução remota de código do Windows SMB
-------------------------------------------------------------------

Existem vulnerabilidades de execução remota de código na maneira como o servidor Microsoft Server Message Block 1.0 (SMBv1) manipula certas solicitações. Um invasor que conseguir explorar as vulnerabilidades poderá adquirir a capacidade de executar um código no servidor de destino.

Para explorar a vulnerabilidade, na maioria das situações, um invasor não autenticado pode enviar um pacote especialmente criado a um servidor SMBv1 alvo.

A atualização de segurança resolve as vulnerabilidades, corrigindo a maneira como o SMBv1 lida com essas solicitações especialmente criadas.
...
<tr class="even">
<td style="border:1px solid black;">Vulnerabilidade de execução remota de código do Windows SMB</td>
...
Vulnerabilidade de divulgação não autorizada de informações do Windows SMB – CVE-2017-0147  
------------------------------------------------------------------------------------------
  
Existe uma vulnerabilidade de divulgação não autorizada de informações na maneira como o servidor Microsoft Server Message Block 1.0 (SMBv1) manipula certas solicitações. Um invasor que conseguir explorar essa vulnerabilidade poderá criar um pacote especial que, por sua vez, poderá resultar na divulgação não autorizada de informações do servidor.
  
Para explorar a vulnerabilidade, na maioria das situações, um invasor não autenticado pode enviar um pacote especialmente criado a um servidor SMBv1 alvo.
  
A atualização de segurança resolve a vulnerabilidade, corrigindo a maneira como o SMBv1 lida com essas solicitações especialmente criadas.
...
<tr class="even">
<td style="border:1px solid black;">Vulnerabilidade de divulgação não autorizada de informações do Windows SMB</td>
...
*Página gerada em 08/03/2017 às 12:35-08:00.*
