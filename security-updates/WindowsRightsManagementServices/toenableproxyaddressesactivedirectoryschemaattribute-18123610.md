...
ms:contentKeyID: 18123610
ms:mtpsurl: 'https://technet.microsoft.com/pt-br/library/Cc720282(v=WS.10)'
---
...
| ![](images/Cc720282.note(WS.10).gif)Observação                                                                              |
|----------------------------------------------------------------------------------------------------------------------------------------------------------|
...
2.  Insert the Windows Server 2003 product CD and navigate to Support\\Tools.
    ...
    | ![](images/Cc720282.Caution(WS.10).gif)Cuidado                                                               |
    |-------------------------------------------------------------------------------------------------------------------------------------------|
