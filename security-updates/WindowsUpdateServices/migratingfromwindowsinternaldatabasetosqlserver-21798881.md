...
ms:contentKeyID: 21798881
ms:mtpsurl: 'https://technet.microsoft.com/pt-br/library/Dd939918(v=WS.10)'
---
...
13. Verify that the database migration was successful by opening the WSUS administrative console. (Click **Start**, click **Administrative Tools**, and then click **Microsoft Windows Server Update Services 3.0**.)
    ...
    <thead>
    <tr class="header">
    <th style="border:1px solid black;" ><img src="images/Dd939918.note(WS.10).gif" />Observação</th>
    </tr>
    </thead>
    <tbody>
    <tr class="odd">
