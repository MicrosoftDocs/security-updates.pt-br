...
ms:assetid: 'ms08-033'
ms:contentKeyID: 61233776
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms08-033(v=Security.10)'
---
...
Vulnerabilidades no DirectX podem permitir a execução remota de código (951698)
-------------------------------------------------------------------------------

Publicado: terça-feira, 10 de junho de 2008 | Atualizado: terça-feira, 12 de agosto de 2008
...
Este boletim foi revisado para comunicar que o [Artigo 951698 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/951698) foi atualizado para descrever uma correção de um problema conhecido relacionado ao Microsoft Baseline Security Analyzer (MBSA) 2.1 e à detecção desta atualização.

**Por que este boletim foi revisado em 16 de julho de 2008?**  
Este boletim foi revisado para adicionar o DirectX 9.0a como software afetado. O Microsoft Update, o Windows Update, o Microsoft Baseline Security Analyzer (MBSA) e o Microsoft Systems Management Server (SMS) já corrigidos oferecem a atualização aos clientes que têm o DirectX 9.0a instalado. Os clientes com o DirectX 9.0a instalado devem aplicar a atualização para permanecerem seguros.

**Onde estão os detalhes das informações sobre o arquivo?**  
Informações detalhadas sobre o arquivo podem ser encontradas no [Artigo 951698 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/951698).

**Como esta atualização se relaciona com o MS07-064?**  
Esta atualização de segurança modifica os arquivos incluídos no boletim MS07-064. Esta atualização de segurança reúne as correções no MS07-064 e a correção das vulnerabilidades descritas nesta atualização em uma única atualização.
...
<th style="border:1px solid black;" >Vulnerabilidade de decodificador de MJPEG - CVE-2008-0011</th>
<th style="border:1px solid black;" >Vulnerabilidade da análise do formato SAMI - CVE-2008-1444</th>
...
Vulnerabilidade de decodificador de MJPEG - CVE-2008-0011  
---------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o Windows MJPEG Codec lida com fluxos MJPEG em arquivos AVI ou ASF. Um usuário precisa visualizar ou executar um arquivo MJPEG especialmente criado para que a vulnerabilidade seja explorada.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-0011](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0011).
  
#### Fatores atenuantes da Vulnerabilidade de decodificador de MJPEG - CVE-2008-0011
...
#### Soluções alternativas para a Vulnerabilidade de decodificador de MJPEG - CVE-2008-0011
...
-   **Modificar a lista de controle de acesso para quartz.dll**
    ...
    **Como desfazer a solução alternativa:** No Windows XP (todas as edições), execute o seguinte comando a partir de um prompt de comando (exige privilégios administrativos):
...
-   **Desativar o decodificador de MJPEG**
  
    Para modificar a chave do Registro para desativar o codificador de MJPEG, siga estas etapas:
    ...
    **Observação:** o uso incorreto do Editor do Registro pode causar problemas sérios e pode ser necessário reinstalar o sistema operacional. A Microsoft não garante que os problemas resultantes do uso incorreto do Editor do Registro possam ser solucionados. Você é responsável pelo uso do Editor do Registro. Para obter informações sobre como editar o Registro, consulte o tópico da Ajuda "Alterar chaves e valores" do Editor do Registro (Regedit.exe) ou exiba os tópicos da Ajuda "Adicionar e excluir informações no Registro" e "Editar informações do Registro" no Regedt32.exe.
    ...
    3.  Clique com o botão direito do mouse em {301056D0-6DFF-11D2-9EEB-006008039E37} e selecione **Exportar**. Salve o arquivo no disco.  
    4.  Exclua toda a chave {301056D0-6DFF-11D2-9EEB-006008039E37}.  
    5.  Encerre o Editor do Registro.
  
    **Impacto da solução alternativa:** Os usuários não poderão reproduzir arquivos MJPEG.
...
#### Perguntas freqüentes sobre a Vulnerabilidade de decodificador de MJPEG - CVE-2008-0011
...
A vulnerabilidade é causada pela maneira como o Windows executa a verificação de erro em fluxos de vídeo MJPEG incorporados a arquivos de mídia ASF ou AVI.
...
**O que são arquivos AVI e ASF?**    
Arquivos AVI (Audio Video Interleave) e ASF (Advanced Systems Format) são dois tipos de arquivos multimídia comumente usados pelo Windows Media Player.
...
A exploração da vulnerabilidade requer que o usuário abra e exiba um arquivo de mídia com um arquivo MJPEG especialmente criado incorporado.
...
Essa vulnerabilidade exige que um usuário esteja conectado e abra o arquivo especialmente criado. Principalmente as estações de trabalho e os servidores de terminal estão correndo risco. Os servidores correm mais riscos se os administradores permitirem que os usuários façam logon em servidores e executem programas. Entretanto, as práticas recomendadas não recomendam esse procedimento.
  
**O que a atualização faz?**    
A atualização remove a vulnerabilidade, aumentando a validação que o analisador executa em fluxos de vídeo MJPEG.
...
Vulnerabilidade da análise do formato SAMI - CVE-2008-1444  
----------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o DirectX trata os arquivos de formato suportados. Essa vulnerabilidade pode permitir a execução remota de código se o usuário abrir um arquivo especialmente criado.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-1444](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1444).
  
#### Fatores atenuantes da Vulnerabilidade da análise do formato SAMI - CVE-2008-1444
...
#### Soluções alternativas para a Vulnerabilidade da análise do formato SAMI - CVE-2008-1444
...
-   **Modificar a lista de controle de acesso para quartz.dll**
    ...
    **Impacto da solução alternativa:** Não será possível executar arquivos WAV e AVI em aplicativos habilitados para DirectX no Windows XP.
    ...
    **Impacto da solução alternativa:** Arquivos de mídia WAV e AVI não conseguirão reproduzir em aplicativos habilitados para DirectX no Windows Vista.
  
    **Como desfazer a solução alternativa:** Execute o comando a seguir de um prompt de comando elevado:
  
    `Regsvr32.exe %WINDIR%\SYSTEM32\QUARTZ.DLL`
  
#### Perguntas freqüentes sobre a Vulnerabilidade da análise do formato SAMI - CVE-2008-1444
  
**Qual é o escopo da vulnerabilidade?**    
Essa é uma vulnerabilidade de execução remota de código. O invasor que explorar com êxito essa vulnerabilidade poderá assumir remotamente o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**O que provoca a vulnerabilidade?**    
O DirectX não executa análise suficiente dos parâmetros de tipos de arquivo SAMI (Synchronized Accessible Media Interchange).
  
**O que é SAMI?**  
SAMI (Microsoft Synchronized Accessible Media Interchange) é um formato de mídia que permite a um desenvolvedor de conteúdo incluir legendas em arquivos de mídia digital. O SAMI foi projetado e desenvolvido para incluir legendas na mídia digital amplamente disponível em sistemas de PC. Legendas SAMI coexistem com a mídia digital como arquivos de texto simples, em separado. As legendas podem ser facilmente modificadas, mantidas, personalizadas e traduzidas em diferentes idiomas.
  
**Para que um invasor pode usar a vulnerabilidade?**    
Se um usuário tiver feito logon com direitos administrativos, o invasor que explorar com êxito essa vulnerabilidade poderá ter o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário.
  
**De que forma o invasor pode explorar a vulnerabilidade?**    
Para explorar essa vulnerabilidade, o invasor teria que convencer o usuário a abrir um arquivo SAMI especialmente criado. Como a vulnerabilidade está no componente de fluxo do Microsoft Windows, o ataque pode ser iniciado a partir de um site especialmente criado ou de qualquer aplicativo que forneça conteúdo da Web. Não há como um invasor forçar usuários a visitar o site especialmente criado. Em vez disso, o invasor teria que convencê-los a visitar o site, geralmente fazendo com que eles cliquem em um link em um email ou mensagem do Instant Messenger que leva os usuários ao site do invasor.
...
<td style="border:1px solid black;">Em alguns casos, esta atualização não exige a reinicialização. Se os arquivos exigidos estiverem em uso, será necessária uma reinicialização. Se esse comportamento ocorrer, uma mensagem que aconselha a reinicialização será exibida.<br />
<br />
...
Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB951698$\Spuninst<br />
<br />
Microsoft Windows 2000 Service Pack 4 com DirectX 8.1:  
Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB951698_DX8$\Spuninst<br />
<br />
Microsoft Windows 2000 Service Pack 4 com DirectX 9.0, DirectX 9.0a, DirectX 9.0b ou DirectX 9.0c:
Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB951698_DX9$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/951698">Artigo 951698 (em inglês) da Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB951698$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/951698">Artigo 951698 (em inglês) da Microsoft Knowledge Base</a>.</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB951698$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/951698">Artigo 951698 (em inglês) da Microsoft Knowledge Base</a>.</td>
...
<td style="border:1px solid black;">Em alguns casos, esta atualização não exige a reinicialização. Se os arquivos exigidos estiverem em uso, será necessária uma reinicialização. Se esse comportamento ocorrer, uma mensagem que aconselha a reinicialização será exibida.<br />
<br />
Para reduzir a chance de uma reinicialização não ser solicitada, interrompa todos os serviços afetados e feche todos os aplicativos que possam usar os arquivos afetados antes de instalar a atualização de segurança. Para obter mais informações sobre os motivos pelos quais você pode ser solicitado a reiniciar, consulte o <a href="http://support.microsoft.com/kb/887012">Artigo 887012 (em inglês) da Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">HotPatching</td>
<td style="border:1px solid black;">Não Aplicável.</td>
...
-   Mark Dowd, pesquisador da [IBM Internet Security Systems X-Force](http://xforce.iss.net/), por relatar a Vulnerabilidade de decodificador de MJPEG (CVE-2008-0011)  
-   Um pesquisador anônimo que trabalha com a [Tipping Point](http://www.tippingpoint.com/) e a [Zero Day Initiative](http://www.zerodayinitiative.com/) por relatar a vulnerabilidade de análise de formato (CVE-2008-1444)
...
-   V2.0 (16 de julho de 2008): O DirectX 9.0a foi adicionado como software afetado.  
-   V2.1 (12 de agosto de 2008): Foi adicionado um link para problemas conhecidos. Também foi adicionada uma entrada à seção de Perguntas freqüentes relacionadas a esta atualização de segurança sobre os problemas conhecidos e suas soluções. As soluções incluem uma alteração ao Microsoft Baseline Security Analyzer (MBSA) 2.1 para detectar corretamente esta atualização.
