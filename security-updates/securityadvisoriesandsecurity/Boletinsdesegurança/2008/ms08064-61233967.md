...
ms:assetid: 'ms08-064'
ms:contentKeyID: 61233967
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms08-064(v=Security.10)'
---
...
Esta atualização de segurança é classificada como Importante para todas as edições com suporte do Windows XP, Windows Server 2003, Windows Vista e Windows Server 2008. Para obter mais informações, consulte a subseção **Software afetado e não afetado** nesta seção.

A atualização de segurança elimina a vulnerabilidade, modificando a maneira que esse Virtual Address Descriptor manipula variáveis de alocação de memória. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|-------------------------------------------------------------------------------------------|
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=25997b73-a640-49c1-b19e-768a18bbe22c)                                                                                                     | Elevação de privilégio     | Importante                      | [MS07-022](http://technet.microsoft.com/security/bulletin/ms07-022)                       |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=25997b73-a640-49c1-b19e-768a18bbe22c)                                                                                                     | Elevação de privilégio     | Importante                      | Nenhuma                                                                                   |
| [Windows XP Professional x64 Edition e Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=50fae854-0bde-46f8-9444-b9e0d9bfecad)                                      | Elevação de privilégio     | Importante                      | [Comunicado de Segurança da Microsoft (932596) :](http://support.microsoft.com/kb/932596) |
| [Windows Server 2003 Service Pack 1 e Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e8ef3d5f-dd8e-4945-92cd-9d3e30b16667)                                                       | Elevação de privilégio     | Importante                      | [MS07-022](http://technet.microsoft.com/security/bulletin/ms07-022)                       |
| [Windows Server 2003 x64 Edition e Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c2e754f9-086a-494c-bc19-5feed7df8b65)                                              | Elevação de privilégio     | Importante                      | [Comunicado de Segurança da Microsoft (932596) :](http://support.microsoft.com/kb/932596) |
| [Windows Server 2003 com SP1 para sistemas baseados no Itanium e Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=5a3832ec-3f8f-42c1-a603-b1330d527547) | Elevação de privilégio     | Importante                      | Nenhuma                                                                                   |
| [Windows Vista](http://www.microsoft.com/downloads/details.aspx?familyid=b4212db5-093e-497d-b999-2e3780f9f7c2)                                                                                                                 | Elevação de privilégio     | Importante                      | [MS07-066](http://technet.microsoft.com/security/bulletin/ms07-066)                       |
| [Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b4212db5-093e-497d-b999-2e3780f9f7c2)                                                                                                  | Elevação de privilégio     | Importante                      | Nenhuma                                                                                   |
| [Windows Vista x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=c20808cb-c30a-4b53-91e5-810eb6b4b2e3)                                                                                                     | Elevação de privilégio     | Importante                      | [MS07-066](http://technet.microsoft.com/security/bulletin/ms07-066)                       |
| [Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c20808cb-c30a-4b53-91e5-810eb6b4b2e3)                                                                                      | Elevação de privilégio     | Importante                      | Nenhuma                                                                                   |
| [Windows Server 2008 para sistemas de 32 bits](http://www.microsoft.com/downloads/details.aspx?familyid=ec9eeb82-0497-4c55-94bb-9a47cb3521b4)\*                                                                                | Elevação de privilégio     | Importante                      | Nenhuma                                                                                   |
| [Windows Server 2008 para sistemas baseados em x64](http://www.microsoft.com/downloads/details.aspx?familyid=0bc178b8-f8ae-4f41-8f88-fb6a75be1bca)\*                                                                           | Elevação de privilégio     | Importante                      | Nenhuma                                                                                   |
| [Windows Server 2008 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=0af72663-4945-4916-8c55-090ba4d82793)                                                                         | Elevação de privilégio     | Importante                      | Nenhuma                                                                                   |
...
Informações detalhadas sobre o arquivo podem ser encontradas no [Artigo 956841 (em inglês) da Base de Conhecimento Microsoft](http://support.microsoft.com/kb/956841).
...
<th style="border:1px solid black;" >Vulnerabilidade na elevação de privilégios do Virtual Address Descriptor - CVE-2008-4036</th>
...
Vulnerabilidade na elevação de privilégios do Virtual Address Descriptor - CVE-2008-4036  
----------------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de elevação de privilégios na maneira que o Gerenciador de memória manipula a alocação de memória e os VADs (Virtual Address Descriptors). A vulnerabilidade pode permitir a elevação de privilégios se um invasor autenticado executar um programa especialmente criado em um sistema afetado. Um invasor que explore a vulnerabilidade com êxito poderá elevar seus privilégios em um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2008-4036](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4036).
  
#### Fatores atenuantes da Vulnerabilidade na elevação de privilégios do Virtual Address Descriptor - CVE-2008-4036
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Um invasor deve ser autenticado para explorar esta vulnerabilidade.
  
#### Soluções alternativas para a Vulnerabilidade na elevação de privilégios do Virtual Address Descriptor - CVE-2008-4036
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas freqüentes sobre a Vulnerabilidade na elevação de privilégios do Virtual Address Descriptor - CVE-2008-4036
  
**Qual é o escopo da vulnerabilidade?**    
Esta é uma vulnerabilidade de elevação de privilégio. Um invasor que explore a vulnerabilidade com êxito poderá elevar seus privilégios em um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração.
  
**O que provoca a vulnerabilidade?**    
O gerenciador de memória não manipula corretamente uma saturação de número inteiro ao reduzir uma variável, o que causa um erro de mapeamento de alocação de memória.
  
**O que é Virtual Address Descriptor?**    
VAD é uma forma de memória virtual para aplicativos que permite que cada aplicativo tenha o próprio espaço para endereço privado. Para obter mais informações sobre VAD, consulte os artigos do MSDN [Gerenciador de memória virtual no Windows NT](http://msdn.microsoft.com/en-us/library/ms810616.aspx) e [Gerenciando a memória Virtual no Win32](http://msdn.microsoft.com/en-us/library/ms810627.aspx) (podem estar em inglês).
...
Um invasor autenticado pode executar um programa especialmente criado que pode causar uma saturação de número inteiro, corrompendo, assim, a memória, de forma a permitir a execução de códigos.
  
**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**    
Windows XP, Windows Server 2003, Windows Vista e Windows Server 2008 são os que correm mais risco com esta vulnerabilidade.
  
**O que a atualização faz?**    
A vulnerabilidade foi causada por uma saturação de número inteiro. A atualização elimina a vulnerabilidade, adicionando validação adicional sobre parâmetros VAD.
...
<td style="border:1px solid black;">Use a ferramenta Adicionar ou Remover Programas no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB956841$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/956841">Artigo 956841 (em inglês) da Base de Conhecimento Microsoft</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB956841$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/956841">Artigo 956841 (em inglês) da Base de Conhecimento Microsoft</a></td>
...
-   V1.1 (15 de outubro de 2008): Corrigido o link de referência a um artigo do MSDN em **Perguntas freqüentes sobre a Vulnerabilidade de elevação de privilégio do Virtual Address Descriptor - CVE-2008-4036**.
