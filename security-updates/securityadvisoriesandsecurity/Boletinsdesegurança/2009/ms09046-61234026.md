...
ms:assetid: 'ms09-046'
ms:contentKeyID: 61234026
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-046(v=Security.10)'
---
...
Vulnerabilidade no controle ActiveX do componente de edição DHTML pode permitir a execução remota de código (956844)
--------------------------------------------------------------------------------------------------------------------

Publicado: terça-feira, 8 de setembro de 2009 | Atualizado: quarta-feira, 14 de outubro de 2009
...
Esta atualização de segurança foi classificada como Crítica para todas as edições com suporte do Microsoft Windows 2000 e do Windows XP e como Moderada para todas as edições com suporte do Windows Server 2003. Para obter mais informações, consulte a subseção **Software afetado e não afetado**, nesta seção.

Esta atualização de segurança elimina a vulnerabilidade, revisando a maneira como o controle ActiveX formata a marcação de HTML. Para obter mais informações sobre esta vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações da vulnerabilidade**.

**Recomendação.** A maioria dos clientes tem as atualizações automáticas habilitadas e não precisará tomar nenhuma providência porque esta atualização de segurança será baixada e instalada automaticamente. Os clientes que não têm as atualizações automáticas habilitadas precisarão verificar as atualizações e instalar esta atualização manualmente. Para obter informações sobre opções de configuração específicas em atualizações automáticas, consulte o [Artigo 294871 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/294871).
...
**Problemas conhecidos.** O artigo 956844 da Base de Conhecimento Microsoft documenta os problemas conhecidos que clientes podem experimentar ao instalar esta atualização de segurança. O artigo também documenta soluções recomendadas para estes problemas. Quando os problemas e soluções recomendadas estão relacionados a lançamentos específicos do software, o artigo fornece links para outros artigos
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=6dd4b0f8-6b54-49a6-a6df-9420f9fd3333)                         | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows XP Service Pack 2 e Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=8523d5be-88a2-4124-9b02-660f612e2a12)         | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dbc33f6b-61bf-409a-89b5-60002192e0e0)            | Execução Remota de Código  | Crítica                         | Nenhuma                                    |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7478f73f-dd20-4cfa-a650-4c84f37ada2f)                            | Execução Remota de Código  | Moderada                        | Nenhuma                                    |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=88bf502d-1a7c-447a-ac4c-401e1698669b)                | Execução Remota de Código  | Moderada                        | Nenhuma                                    |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=8d881ff8-f51f-4476-8cb6-2bebd5b2047f) | Execução Remota de Código  | Moderada                        | Nenhuma                                    |
...
**Como esta vulnerabilidade está relacionada com as vulnerabilidades descritas no boletim MS09-037?**  
Esta vulnerabilidade não está relacionada com as vulnerabilidades na Microsoft Active Template Library (ATL), abordadas no boletim MS09-037. A vulnerabilidade no Controle ActiveX do Componente de Edição DHTML não decorre do uso de uma versão vulnerável da ATL.
...
<th style="border:1px solid black;" >Vulnerabilidade no controle ActiveX do componente de edição DHTML - CVE-2009-2519</th>
...
Vulnerabilidade no controle ActiveX do componente de edição DHTML - CVE-2009-2519  
---------------------------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código no controle ActiveX do componente de edição DHTML. Um invasor pode explorar a vulnerabilidade criando uma página da Web especialmente desenvolvida. Se um usuário exibir a página da Web, a vulnerabilidade poderá permitir a execução remota de código. O invasor que explorar com êxito a vulnerabilidade poderá obter os mesmos direitos que o usuário conectado.
...
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-2519](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2519).
  
#### Fatores atenuantes da vulnerabilidade no controle ActiveX do componente de edição DHTML - CVE-2009-2519
...
#### Soluções alternativas para a vulnerabilidade no controle ActiveX do componente de edição DHTML - CVE-2009-2519
  
A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:
  
-   **Impeça que o objeto COM do controle ActiveX de DHTML seja executado no Internet Explorer**
    ...
    **Aviso** O uso incorreto do Editor do Registro pode causar problemas graves e exigir a reinstalação do sistema operacional. A Microsoft não garante a solução de problemas resultantes do uso incorreto do Editor do Registro. Você é responsável pelo uso do Editor do Registro.
    ...
    Para configurar o kill bit para o controle ActiveX do DHTML com um CLSID com valor {2D360201-FFF5-11D1-8D03-00A0C959BC0A}, cole o texto a seguir em um editor de texto, como o Bloco de Notas. Em seguida, salve o arquivo usando a extensão de nome de arquivo .reg.
    ...
    **Impacto da solução alternativa:** Não há impacto porque o objeto COM do controle ActiveX de DHTML não se destina a ser usado no Internet Explorer.
...
#### Perguntas frequentes sobre a vulnerabilidade no controle ActiveX do componente de edição DHTML - CVE-2009-2519
...
Quando o controle ActiveX do componente de edição DHTML da Microsoft é instanciado no Internet Explorer, ele pode corromper o estado do sistema de forma a permitir a um invasor executar um código arbitrário.
  
**O que é o controle ActiveX do Componente de Edição DHTML?**    
O Controle ActiveX do Componente de Edição DHTML oferece um editor de HTML que você pode usar para ter suporte à edição de HTML de sites da Web dinâmicos no software. Para obter mais informações sobre o controle ActiveX do Componente de Edição DHTML, consulte "The DHTML Editing Component", no artigo do MSDN [Introduction to MSHTML Editing](http://msdn.microsoft.com/en-us/library/aa753630(vs.85).aspx) (em inglês).
...
Esta atualização de segurança elimina a vulnerabilidade, revisando a maneira como o controle ActiveX formata a marcação de HTML.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB956844$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/956844">Artigo 956844 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Tavis Ormandy, da [Google Inc.](http://www.google.com/), por relatar a Vulnerabilidade do controle ActiveX do componente de edição DHTML (CVE-2009-2519)
...
-   V1.1 (14 de outubro de 2009): Corrigido o identificador de classe do controle ActiveX na solução alternativa "Impeça que o objeto COM do controle ActiveX de DHTML seja executado no Internet Explorer".
-   V1.2 (2 de Dezembro de 2009): Incluído link para artigo 956844 da Base de Conhecimento Microsoft na subseção Problemas Conhecidos, no Sumário Executivo.
