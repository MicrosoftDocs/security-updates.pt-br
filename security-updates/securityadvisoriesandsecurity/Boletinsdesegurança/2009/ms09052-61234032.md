...
ms:assetid: 'ms09-052'
ms:contentKeyID: 61234032
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms09-052(v=Security.10)'
---
...
Vulnerabilidade no Windows Media Player pode permitir a execução remota de código (974112)
------------------------------------------------------------------------------------------
...
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular no Windows Media Player. A vulnerabilidade pode permitir a execução remota de código se um arquivo ASF especialmente criado for reproduzido usando o Microsoft Windows Media Player 6.4. Um invasor que explorar com êxito esta vulnerabilidade pode obter os mesmos direitos de usuário do usuário local. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Esta atualização de segurança é classificada como crítica para o Microsoft Windows Media Player 6.4 quando instalado em todas as edições com suporte do Microsoft Windows 2000, Windows XP e Windows Server 2003. Para obter mais informações, consulte a subseção **Software afetado e não afetado** nesta seção.

A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira como o Windows Media Player 6.4 manipula os arquivos ASF especialmente criados. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas freqüentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|----------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|---------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                    | [Microsoft Windows Media Player 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=13035ef7-7e47-487c-8b7c-7795d33ce7de) | Execução Remota de Código  | Crítica                         | Nenhuma                                                             |
| Windows XP Service Pack 2 e Windows XP Service Pack 3    | [Microsoft Windows Media Player 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=b2efe1ac-d8d7-41bb-b87d-fc5e22afef0f) | Execução Remota de Código  | Crítica                         | [MS08-076](http://technet.microsoft.com/security/bulletin/ms08-076) |
| Windows XP Professional x64 Edition Service Pack 2       | [Microsoft Windows Media Player 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=a9e7dfd8-7ba1-4f14-8e60-92ef00d91467) | Execução Remota de Código  | Crítica                         | [MS08-076](http://technet.microsoft.com/security/bulletin/ms08-076) |
| Windows Server 2003 Service Pack 2                       | [Microsoft Windows Media Player 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=5f82d01c-573e-425e-b9f2-86a54f377b19) | Execução Remota de Código  | Crítica                         | [MS08-076](http://technet.microsoft.com/security/bulletin/ms08-076) |
| Microsoft Windows Server 2003 x64 Edition Service Pack 2 | [Microsoft Windows Media Player 6.4](http://www.microsoft.com/downloads/details.aspx?familyid=65e9036e-2e1b-40ff-a84b-c507107bcce8) | Execução Remota de Código  | Crítica                         | [MS08-076](http://technet.microsoft.com/security/bulletin/ms08-076) |

**Softwares não afetados**

| Sistema operacional                                                                                                          | Componente    |
|------------------------------------------------------------------------------------------------------------------------------|---------------|
| Windows Server 2003 com SP2 para sistemas baseados no Itanium                                                                | Não Aplicável |
...
| Windows Server 2008 para sistemas baseados em x-64 e Windows Server 2008 para sistemas baseados em x-64 Service Pack 2       | Não Aplicável |
...
<span></span>
**Não tenho o Windows Media Player 6.4 no meu sistema. Por que eu estou recebendo a oferta desta atualização?**  
Após a atualização do Microsoft Windows Media Player 6.4 para uma versão posterior do Windows Media Player, determinados componentes relacionados ao Microsoft Windows Media Player 6.4 não são completamente removidos do sistema a fim de que a compatibilidade com versões anteriores seja assegurada. Esses componentes são atualizados por este boletim. Embora versões posteriores do Windows Media Player não sejam afetadas por esta vulnerabilidade, um usuário ainda pode estar vulnerável se um programa chamar explicitamente esses componentes mais antigos ao reproduzir mídia. Se você não aplicar esta atualização depois de atualizar do Microsoft Windows Media Player 6.4, as ferramentas de verificação automatizadas, como o MBSA, detectarão que seu sistema está vulnerável, mesmo que o Microsoft Windows Media Player 6.4 não seja o Media Player padrão no sistema. O Microsoft Windows Media Player 6.4 é a única versão do Windows Media Player afetada pelo problema abordado neste boletim. Entretanto, todos os clientes a quem a atualização for automaticamente oferecida devem aplicá-la para assegurarem-se de estarem protegidos contra esta vulnerabilidade.
...
**Como este boletim está relacionado ao boletim MS09-051, Vulnerabilidade no tempo de execução do Windows Media pode permitir a execução remota de código?**  
Este boletim não está relacionado ao boletim [MS09-051](http://technet.microsoft.com/security/bulletin/ms09-051), Vulnerabilidade no tempo de execução do Windows Media pode permitir a execução remota de código. Os usuários devem instalar ambas as atualizações para garantir que eles estejam totalmente protegidos.
...
<th style="border:1px solid black;" >Vulnerabilidade de estouro de heap do WMP - CVE-2009-2527</th>
...
Vulnerabilidade de estouro de heap do WMP - CVE-2009-2527  
---------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código no Windows Media Player 6.4. Um invasor pode explorar a vulnerabilidade, criando um arquivo ASF especialmente criado que pode permitir a execução remota de código quando executado usando o Windows Media Player 6.4. Um invasor que explorar com êxito esta vulnerabilidade pode assumir o controle total de um sistema afetado.
  
Para exibir essa vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2009-2527](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2527).
  
#### Fatores atenuantes da vulnerabilidade de estouro de heap do WMP - CVE-2009-2527
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor que explorar com êxito a vulnerabilidade poderá obter os mesmos direitos que o usuário local. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.  
-   A vulnerabilidade não pode ser explorada automaticamente por email. Para que um ataque de email seja bem-sucedido, um usuário deve abrir um anexo enviado em uma mensagem de email.  
...
#### Soluções alternativas para a vulnerabilidade de estouro de heap do WMP - CVE-2009-2527
  
A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:
  
-   **Modificar a lista de controle de acesso (ACL) em strmdll.dll**
  
    Para modificar o ACL em strmdll.DLL para ser mais restritivo no Windows XP e Windows Server 2003, execute os seguintes comandos de um prompt de comando com privilégios administrativos:
    ...
    **Impacto da solução alternativa.** O Windows Media Player 6.4 não poderá reproduzir arquivos de mídia.
  
    **Como desfazer a solução alternativa.**
  
    No Windows XP e Windows Server 2003, execute os seguintes comandos de um prompt de comando com privilégios administrativos:
...
-   **Para tipos de pasta que não sejam multimídia, o vetor de ataque no Shell do Windows pode ser atenuado com o uso de Pastas Clássicas do Windows**
    ...
    Para mudar as opções de pasta, execute as seguintes etapas:
...
#### Perguntas frequentes sobre a vulnerabilidade de estouro de heap do WMP - CVE-2009-2527
...
O Windows Media Player 6.4 manipula incorretamente os arquivos ASF especialmente criados.
...
Se um arquivo ASF mal-intencionado estiver hospedado em um computador com o software afetado, ir simplesmente para pasta no Windows Explorer analisará o arquivo o suficiente para acionar a vulnerabilidade.
  
**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**    
Qualquer sistema que use o Windows Media Player 6.4, como estações de trabalho ou servidores de terminal, corre risco com esta vulnerabilidade.
  
**O que a atualização faz?**    
A atualização elimina a vulnerabilidade, corrigindo a maneira como o Windows Media Player 6.4 manipula os arquivos ASF especialmente criados.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB974112_WM41$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/974112">Artigo 974112 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informações sobre remoção</strong></td>
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB974112$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/974112">Artigo 974112 (em inglês) da Microsoft Knowledge Base</a></td>
...
-   Yamata Li, da [Palo Alto Networks](http://www.paloaltonetworks.com/), por relatar a vulnerabilidade de estouro de heap do WMP (CVE-2009-2527)
...
-   V1.1 (29 de outubro de 2009): Uma solução alternativa foi removida. Uma entrada também foi adicionada à seção **Perguntas frequentes relacionadas a esta atualização de segurança** para esclarecer por que esta atualização pode ser oferecida a alguns clientes que não têm o Windows Media Player 6.4 em seus sistemas.
-   V1.2 (12 de janeiro de 2010): Foram corrigidas as chaves do Registro do Windows Media Player 6.4 no Microsoft Windows 2000 Service Pack 4. Esta é apenas uma atualização informativa.
