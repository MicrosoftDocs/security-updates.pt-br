...
ms:assetid: 'ms10-054'
ms:contentKeyID: 61234188
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms10-054(v=Security.10)'
---
...
Vulnerabilidades no servidor SMB podem permitir a execução remota de código (982214)
------------------------------------------------------------------------------------

Publicado: terça-feira, 10 de agosto de 2010 | Atualizado: terça-feira, 9 de novembro de 2010
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e4f4f8b3-7a39-4d77-a46b-02c86ad159c3">Windows Server 2003 com SP2 para sistemas baseados no Itanium</a></td>
<td style="border:1px solid black;">Elevação de privilégio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=155976">MS10-012</a></td>
</tr>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=24d8f0a3-51a9-46c1-b870-a2239bf600e4">Windows Server 2008 para sistemas baseados no Itanium</a></td>
<td style="border:1px solid black;">Elevação de privilégio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=163970">MS09-050</a>,<br />
<a href="http://go.microsoft.com/fwlink/?linkid=132991">MS09-001</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=24d8f0a3-51a9-46c1-b870-a2239bf600e4">Windows Server 2008 para sistemas baseados no Itanium Service Pack 2</a></td>
<td style="border:1px solid black;">Elevação de privilégio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=163970">MS09-050</a></td>
</tr>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=783fb42c-3698-4b1d-a692-3ff319578931">Windows Server 2008 R2 para sistemas baseados no Itanium</a></td>
<td style="border:1px solid black;">Elevação de privilégio</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=155976">MS10-012</a></td>
</tr>
...
<span></span>
**Por que este boletim de segurança foi revisado em 9 de novembro de 2010?**    
A Microsoft revisou este boletim de segurança para anunciar uma alteração de detecção que corrige o boletim substituído, previamente determinado como MS10-012, para o seguinte: para edições compatíveis do Windows Vista Service Pack 1 e Windows Server 2008, esta atualização substitui os boletins de segurança MS09-050 e MS09-001; para edições compatíveis do Windows Vista Service Pack 2 e Windows Server 2008 Service Pack 2, esta atualização substitui o boletim de segurança MS09-050. Esta é apenas uma alteração de detecção. Não houve nenhuma alteração para os arquivos de atualização de segurança. Os clientes que já instalaram a atualização com êxito não necessitam reinstalá-la.
...
<th style="border:1px solid black;" >Vulnerabilidade de estouro de pool do SMB - CVE-2010-2550</th>
<th style="border:1px solid black;" >Vulnerabilidade de validação de variável do SMB - CVE-2010-2551</th>
<th style="border:1px solid black;" >Vulnerabilidade de esgotamento da pilha do SMB - CVE-2010-2552</th>
<th style="border:1px solid black;" >Avaliação de gravidade agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de estouro de pool do SMB - CVE-2010-2550  
---------------------------------------------------------
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-2550](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2550).
  
#### Fatores atenuantes da vulnerabilidade de estouro de pool do SMB - CVE-2010-2550
...
#### Soluções alternativas para a vulnerabilidade de estouro de pool do SMB - CVE-2010-2550
...
#### Perguntas frequentes sobre a vulnerabilidade de estouro de pool do SMB - CVE-2010-2550
...
-   Permitir que uma sessão com um arquivo aberto seja restabelecida depois de uma conexão cliente tornar-se temporariamente desconectada.  
...
Um invasor pode tentar explorar a vulnerabilidade criando um pacote SMB especialmente criado e enviando-o a um sistema afetado. Nas plataformas Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 e Windows Server 2008 R2, um invasor deve ser autenticado para explorar esta vulnerabilidade, a menos que o compartilhamento baseado em senha esteja desabilitado. Se o compartilhamento baseado em senha estiver desabilitado, os invasores poderão explorar essas plataformas sem autenticações.
...
Vulnerabilidade de validação de variável do SMB - CVE-2010-2551  
---------------------------------------------------------------
  
<span></span>
Uma vulnerabilidade de negação de serviço existe na maneira como esse software de protocolo SMB (Server Message Block) da Microsoft manipula pacotes SMB especialmente criados. Uma tentativa de explorar a vulnerabilidade não requereria autenticação, permitindo a um invasor explorar a vulnerabilidade enviando uma mensagem de rede especialmente criada a um computador executando o serviço Servidor.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-2551](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2551).
  
#### Fatores atenuantes da vulnerabilidade de validação de variável do SMB - CVE-2010-2551
...
#### Soluções alternativas para a vulnerabilidade de validação de variável do SMB - CVE-2010-2551
...
#### Perguntas frequentes sobre a vulnerabilidade de validação de variável do SMB - CVE-2010-2551
...
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada quando o software do protocolo SMB da Microsoft valida indevidamente uma variável interna ao analisar pacotes SMB especialmente criados. Esta vulnerabilidade afeta o SMB versão 1 e o SMB versão 2.
...
**O que a atualização faz?**    
A atualização de segurança elimina a vulnerabilidade, corrigindo a maneira como o SMB valida campos internos nos pacotes SMB especialmente criados.
...
Vulnerabilidade de esgotamento da pilha do SMB - CVE-2010-2552  
--------------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de negação de serviço na maneira como o software de protocolo SMB (Server Message Block) da Microsoft manipula solicitações compostas do SMB especialmente criadas. Uma tentativa de explorar a vulnerabilidade não requereria autenticação, permitindo a um invasor explorar a vulnerabilidade enviando uma mensagem de rede especialmente criada a um computador executando o serviço Servidor.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2010-2552](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2552).
  
#### Fatores atenuantes da vulnerabilidade de esgotamento da pilha do SMB - CVE-2010-2552
...
#### Soluções alternativas para a vulnerabilidade de esgotamento da pilha do SMB - CVE-2010-2552
...
#### Perguntas frequentes sobre a vulnerabilidade de esgotamento da pilha do SMB - CVE-2010-2552
  
**Qual é o escopo da vulnerabilidade?**    
Essa é uma vulnerabilidade de negação de serviço (site em inglês). O invasor que explorar essa vulnerabilidade poderá fazer o sistema afetado parar de responder e exigir que o sistema seja reiniciado manualmente. Observe que a vulnerabilidade de negação de serviço não permite que o invasor execute códigos nem eleve seus direitos de usuário, mas pode fazer o sistema afetado parar de aceitar solicitações.
  
**O que provoca a vulnerabilidade?**    
A vulnerabilidade é causada quando o software de protocolo SMB da Microsoft manipula de forma insuficiente as solicitações compostas especialmente criadas.
...
**Este problema afeta o SMB Versão 1 (SMBv1)?**    
Não. Este problema só afeta o SMBv2, já que as solicitações compostas são um novo recurso introduzido no SMBv2.
  
**O que é uma solicitação composta do SMBv2?**    
Uma solicitação composta do SMBv2 é um método de combinar várias solicitações de protocolo SMBv2 ou respostas em uma única solicitação de transmissão para submissão ao transporte subjacente.
...
**O que a atualização faz?**    
A atualização de segurança elimina a vulnerabilidade corrigindo a maneira como o software de protocolo SMB manipula solicitações compostas malformadas.
...
Para Windows XP Service Pack 3:WindowsXP-KB982214-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"><br />
Para Windows XP Service Pack 3:WindowsXP-KB982214-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Para o Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB982214$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/982214">Artigo 982214 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Laurent Gaffié, da [stratsec](http://www.stratsec.net), por relatar a vulnerabilidade de estouro de pool do SMB (CVE-2010-2550)  
-   Todd Wease e Richard Johnson, da [Sourcefire VRT](http://www.sourcefire.com/services/sf_vrt.html), por relatarem a vulnerabilidade de esgotamento da pilha do SMB (CVE-2010-2552)  
-   Riku Hietamaki e Joshua Morin, da [Codenomicon](http://www.codenomicon.com/), por relatarem a vulnerabilidade de esgotamento da pilha do SMB (CVE-2010-2552)
...
-   V1.1 (11 de agosto de 2010): Foi corrigido o impacto de segurança para o Windows Server 2003, Windows 7 e Windows Server 2008 R2 causado pela vulnerabilidade de estouro de pool do SMB - CVE-2010-2550. Esta é apenas uma alteração informativa.  
-   V1.2 (25 de agosto de 2010): Referência incorreta removida para uma solução Microsoft Fix it de soluções alternativas para Vulnerabilidade de Exaustão de Empilhamento SMB - CVE-2010-2552.  
-   V1.3 (9 de novembro de 2010): Atualização de Perguntas Frequentes adicionada para anunciar uma alteração de detecção que corrige o boletim substituído para edições compatíveis do Windows Vista e Windows Server 2008. Esta é apenas uma alteração de detecção. Não houve nenhuma alteração para os arquivos de atualização de segurança.
