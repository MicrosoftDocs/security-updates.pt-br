...
ms:assetid: 'ms11-037'
ms:contentKeyID: 61234382
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-037(v=Security.10)'
---
...
Vulnerabilidade no MHTML pode permitir a divulgação não autorizada de informação (2544893)
------------------------------------------------------------------------------------------

Publicado: terça-feira, 14 de junho de 2011 | Atualizado: terça-feira, 15 de novembro de 2011
...
Esta atualização de segurança elimina uma vulnerabilidade divulgada publicamente no identificador de protocolo MHTML no Microsoft Windows. A vulnerabilidade pode permitir divulgação não autorizada de informação se um usuário abrir um URL especialmente criado do site de um invasor. Um invasor tem que convencer o usuário a visitar o site, normalmente fazendo com que clique em um link em um email ou mensagem do Instant Messenger.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|---------------------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=ce5bc2d7-9438-4bf0-be5e-be9dd00c3286)                                                                                                          | Divulgação não autorizada de informação | Importante                      | [MS11-026](http://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7b211b02-a005-46a3-ad1d-d4baaeec8289)                                                                                 | Divulgação não autorizada de informação | Importante                      | [MS11-026](http://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6427ea5d-05d0-4367-805c-9cb305802b3c)                                                                                                 | Divulgação não autorizada de informação | Baixa                           | [MS11-026](http://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e7f65891-32c0-4817-b3b2-d8be73145df9)                                                                                     | Divulgação não autorizada de informação | Baixa                           | [MS11-026](http://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ca8b1d09-9f80-417b-99b1-8f86e86e1f11)                                                                      | Divulgação não autorizada de informação | Baixa                           | [MS11-026](http://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Vista Service Pack 1 e Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ebea38a7-1fbe-4141-a529-52d7a7326d6a)                                                                        | Divulgação não autorizada de informação | Importante                      | [MS11-026](http://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Vista x64 Edition Service Pack 1 e Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=54833350-a385-4a31-995a-9ddc38798c21)                                                | Divulgação não autorizada de informação | Importante                      | [MS11-026](http://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2008 para sistemas de 32 bits e Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6a3bbd67-94db-40b2-8786-cb39a493ec92)\*\*                     | Divulgação não autorizada de informação | Baixa                           | [MS11-026](http://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2008 para sistemas baseados em x64 e Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4cb870f3-9878-4075-b8fd-2ee90c8e3bc8)\*\*           | Divulgação não autorizada de informação | Baixa                           | [MS11-026](http://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2008 para sistemas baseados no Itanium e Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e1243011-00e6-49f2-a676-c04cb805d36a)       | Divulgação não autorizada de informação | Baixa                           | [MS11-026](http://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c3647646-658a-423b-b0cb-bba7613b67e7)                                             | Divulgação não autorizada de informação | Importante                      | [MS11-026](http://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows 7 para sistemas baseados em x-64 e Windows 7 para Sistemas Service Pack 1 baseados em x-64](http://www.microsoft.com/downloads/details.aspx?familyid=7996511d-4b8e-49c3-a0fa-4da907a6c947)                                 | Divulgação não autorizada de informação | Importante                      | [MS11-026](http://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=40354f73-4f4d-4a4a-abac-f8a3d4c3ae5f)\*\*     | Divulgação não autorizada de informação | Baixa                           | [MS11-026](http://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=22853823-8f63-4258-8991-1ad50e58a0d9) | Divulgação não autorizada de informação | Baixa                           | [MS11-026](http://go.microsoft.com/fwlink/?linkid=212523) |
...
A Microsoft relançou este boletim para oferecer novamente a atualização de segurança KB2544893 para todas as edições com suporte do Windows XP e Windows Server 2003. A nova oferta desta atualização fornece aos sistemas que executam Windows XP ou Windows Server 2003 a mesma proteção cumulativa que é fornecida por esta atualização para todos os outros sistemas operacionais afetados. Os sistemas que executam edições com suporte do Windows XP e Windows Server 2003 automaticamente receberão a nova versão desta atualização. Os clientes que usam estes sistemas operacionais, inclusive os que já instalaram a atualização originalmente oferecida em 14 de junho de 2011, devem instalar a atualização oferecida novamente.
...
<th style="border:1px solid black;" >Vulnerabilidade de solicitação com formatação MIME MHTML - CVE-2011-1894</th>
...
Vulnerabilidade de solicitação com formatação MIME MHTML - CVE-2011-1894  
------------------------------------------------------------------------
  
<span></span>
Existe ma vulnerabilidade de divulgação não autorizada de informação na maneira como o MHTML interpreta solicitações com formatação MIME para conteúdo incorporado em um documento HTML. Assim como as vulnerabilidades do XSS (server-side cross-site scripting), é possível, sob determinadas condições, que esta vulnerabilidade permita que um invasor injete um script do lado cliente na resposta de uma execução de solicitação da Web no contexto de Internet Explorer do usuário.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1894](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1894).
  
#### Fatores atenuantes da Vulnerabilidade de solicitação com formatação MIME MHTML - CVE-2011-1894
...
-   Em um cenário de ataque baseado na Web, o invasor pode hospedar um site que contenha uma página da Web usada para explorar essa vulnerabilidade. Além disso, sites comprometidos e sites que aceitem ou hospedem conteúdo fornecido pelo usuário ou anúncios podem conter conteúdo especialmente criado que pode explorar esta vulnerabilidade. Em todos os casos, entretanto, o invasor não tem como forçar os usuários a visitar esses sites. Em vez disso, o invasor teria que convencer os usuários a visitar o site, geralmente fazendo com que eles cliquem em um link em um email ou mensagem do Instant Messenger que leva o usuário ao site do invasor.
  
#### Soluções alternativas para a Vulnerabilidade de solicitação com formatação MIME MHTML - CVE-2011-1894
...
-   **Desabilite o manipulador de protocolo MHTML**
    ...
    **Método interativo:**
    ...
    Para desabilitar manualmente o manipulador de protocolo MHTML, siga estas etapas:
  
    1.  Abra o Editor do Registro.  
    2.  Navegue até a seguinte chave do Registro:  
        HKEY\_CLASSES\_ROOT\\PROTOCOLS\\Handler\\mhtml  
    3.  Faça backup da chave do Registro mhtml clicando com o botão direito do mouse, selecionando **Exportar** e salvando-a como um arquivo de Registro (isto é, "mhtml pluggable protocol registry backup.reg").  
    4.  Exclua a chave do Registro mhtml clicando com o botão direito nela e selecionando **Excluir**.
  
    **Usando um script de implantação gerenciado:**
  
    Para desabilitar o manipulador de protocolo MHTML usando um script de implantação gerenciado, siga estas etapas:
  
    1.  Faça backup da chave do Registro mhtml usando a seguinte entrada de linha de comando:  
        regedit /e mhtml\_pluggable\_protocol\_registry\_backup.reg HKEY\_CLASSES\_ROOT\\PROTOCOLS\\Handler\\mhtml  
    2.  Crie o script de implantação gerenciado salvando o seguinte em um arquivo com extensão .reg (isto é, disable\_mhtml\_pluggable\_protocol.reg):  
        Windows Registry Editor Versão 5.00  
        \[-HKEY\_CLASSES\_ROOT\\PROTOCOLS\\Handler\\mhtml\]  
    3.  Execute o script de implantação gerenciado em um sistema de destino usando a seguinte entrada de linha de comando:  
    ...
    **Como desfazer a solução alternativa.** Para desfazer esta solução alternativa, clique duas vezes no arquivo de registro de backup criado usando os procedimentos acima.
  
#### Perguntas frequentes sobre a Vulnerabilidade de solicitação com formatação MIME MHTML - CVE-2011-1894
  
**Qual é o escopo da vulnerabilidade?**  
Essa é uma vulnerabilidade de divulgação de informações.
  
**O que provoca a vulnerabilidade?**  
A vulnerabilidade é causada quando o MHTML interpreta solicitações com formatação MIME para conteúdo em um documento, tornando possível que um invasor execute scripts no contexto de segurança errado (por exemplo, alguns scripts podem ser executados na zona de segurança incorreta do Internet Explorer).
  
**O que é MHTML?**  
MHTML (MIME Encapsulation of Aggregate HTML) é um padrão de Internet que define a estrutura MIME usada para encapsular conteúdo HTML. O manipulador de protocolo de MHTML no Windows fornece um protocolo fácil de instalar (MHTML:) Isso permite que os documentos codificados do MHTML sejam processados em aplicativos. Para obter mais informações, consulte o artigo de MSDN, [About Asynchronous Pluggable Protocols](http://msdn.microsoft.com/en-us/library/aa767916(v=vs.85).aspx).
  
**O que é script entre sites (XSS)?**  
O script entre sites (XSS) é uma classe de vulnerabilidade de segurança que pode permitir que um invasor injete scripts na resposta a uma solicitação de página da Web. Este script é executado pelo aplicativo solicitante, geralmente um navegador da Web. O script pode falsificar conteúdo, divulgar informações ou efetuar todas as ações que o usuário pode realizar no site afetado, em nome do usuário visado.
  
**Para que um invasor pode usar a vulnerabilidade?**  
Um invasor que explorar a vulnerabilidade com êxito poderá injetar um script do lado do cliente na instância do Internet Explorer do usuário. O script pode falsificar conteúdo, divulgar informações ou efetuar todas as ações que o usuário pode realizar no site afetado, em nome do usuário visado.
  
**De que forma o invasor pode explorar a vulnerabilidade?**  
Um invasor que consegue explorar esta vulnerabilidade pode criar um site que incorpora um script mal-intencionado na página usando a tag HTML &lt;EMBED&gt;. O invasor então pode convencer um usuário a visitar o site, permitindo assim que um invasor execute um script do lado do cliente no contexto de segurança errado. O script pode falsificar conteúdo, divulgar informações ou efetuar todas as ações que o usuário pode realizar no site afetado.
...
Sim. Essa vulnerabilidade foi divulgada publicamente. Ela recebeu o número [CVE-2011-1894](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1894) da lista Common Vulnerability and Exposure.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong>, no Painel de Controle, ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2544893-v2$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2544893">Artigo 2544893 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<br />
<strong>Observação</strong> Em sistemas onde a versão inicial do arquivo de atualização foi instalada, a seguinte chave do Registro também estará presente:<br />
...
-   Billy Rios e Eduardo Vela Nava, da [Equipe de segurança do Google](http://www.google.com/), por trabalhar conosco nas modificações deste boletim.
...
-   V2.0 (8 de novembro de 2011): Boletim relançado para oferecer novamente a atualização em todas as edições com suporte do Windows XP e Windows Server 2003. Os clientes usando o Windows XP ou o Windows Server 2003, inclusive os que já instalaram a atualização originalmente oferecida em 14 de junho de 2011, devem instalar a atualização oferecida novamente. Consulte as Perguntas frequentes de atualização para obter detalhes.  
-   V2.1 (15 de novembro de 2011): Foram corrigidos as chaves do Registro de verificação de instalação, o nome do arquivo de log de atualização e informações sobre remoção do Windows XP e Windows Server 2003. Esta é apenas uma alteração informativa.
