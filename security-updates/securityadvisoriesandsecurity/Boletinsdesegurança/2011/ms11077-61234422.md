...
ms:assetid: 'ms11-077'
ms:contentKeyID: 61234422
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms11-077(v=Security.10)'
---
...
<td style="border:1px solid black;">
[MS11-054](http://technet.microsoft.com/pt-br/security/bulletin/ms11-054)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<th style="border:1px solid black;" >Vulnerabilidade de desreferenciação de ponteiro nulo do Win32k - CVE-2011-1985</th>
<th style="border:1px solid black;" >Vulnerabilidade de tradução de fonte TrueType do Win32k - CVE-2011-2002</th>
<th style="border:1px solid black;" >Vulnerabilidade de saturação de buffer do arquivo de biblioteca da fonte - CVE-2011-2003</th>
<th style="border:1px solid black;" >Vulnerabilidade de uso após liberação de Win32k - CVE-2011-2011</th>
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-1985](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1985).
  
#### Fatores atenuantes da Vulnerabilidade de desreferenciação de ponteiro nulo do Win32k - CVE-2011-1985
...
#### Soluções alternativas para a Vulnerabilidade de desreferenciação de ponteiro nulo do Win32k - CVE-2011-1985
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade de desreferenciação de ponteiro nulo do Win32k - CVE-2011-1985
  
**Qual é o escopo da vulnerabilidade?**   
Em sistemas operacionais de 32 bits, esta é uma vulnerabilidade de elevação de privilégio. Um invasor que explore com êxito esta vulnerabilidade pode causar a execução de código arbitrário e assumir o controle total do sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de administração. Em sistemas operacionais baseados em x-64 e Itanium, esta é uma vulnerabilidade de negação de serviço.
...
<span></span>
Existe uma vulnerabilidade de negação de serviço nas implementações do Microsoft Windows quando o sistema processa impropriamente um arquivo de fonte de TrueType especialmente criado. O invasor que explorar essa vulnerabilidade com êxito poderá fazer o sistema afetado parar de responder.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-2002](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2002).
  
#### Fatores atenuantes da vulnerabilidade de tradução de fonte TrueType do Win32k - CVE-2011-2002
...
#### Soluções alternativas para a vulnerabilidade de tradução de fonte TrueType do Win32k - CVE-2011-2002
...
#### Perguntas frequentes sobre a vulnerabilidade de tradução de fonte TrueType do Win32k - CVE-2011-2002
  
**Qual é o escopo da vulnerabilidade?**   
Essa é uma vulnerabilidade de negação de serviço (site em inglês).
  
**O que provoca a vulnerabilidade?**   
A vulnerabilidade é causada quando um driver do modo kernel do Windows falha ao controlar adequadamente o tipo de fonte TrueType.
...
<span></span>
Existe uma vulnerabilidade de execução remota de código no kernel do Windows devido ao controle impróprio de um arquivo de fonte .fon especialmente criado. A vulnerabilidade pode permitir que um invasor execute códigos no modo kernel e instale programas; exiba, altere ou exclua dados; ou crie novas contas com direitos administrativos totais.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-2003](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2003).
  
#### Fatores atenuantes da vulnerabilidade de saturação de buffer do arquivo de biblioteca da fonte - CVE-2011-2003
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   Para um ataque remoto ser bem-sucedido, o usuário deve visitar um local de sistema de arquivos remotos não confiável ou compartilhamento WebDAV e abrir o arquivo de fonte especialmente criado (como um arquivo .fon), ou abrir o arquivo como um anexo de email.  
-   O protocolo de compartilhamento de arquivos SMB frequentemente fica desabilitado no firewall de perímetro. Isso limita os possíveis vetores de ataque remoto dessa vulnerabilidade.
  
#### Soluções alternativas para a vulnerabilidade de saturação de buffer do arquivo de biblioteca da fonte - CVE-2011-2003
...
#### Perguntas frequentes sobre a vulnerabilidade de saturação de buffer do arquivo de biblioteca da fonte - CVE-2011-2003
...
**De que forma o invasor pode explorar a vulnerabilidade?**   
Em um cenário de ataque à rede, um invasor pode colocar um arquivo de fonte especialmente criado (como um arquivo .fon) em uma rede compartilhada, em um UNC ou em um local WebDAV, e então convencer o usuário a abrir o arquivo.
  
Em um cenário de ataque por email, um invasor pode explorar a vulnerabilidade enviando um arquivo de fonte especialmente criado (como um arquivo .fon) a um usuário e convencendo o usuário a abrir o arquivo.
  
**Quais são os sistemas que mais correm riscos com a vulnerabilidade?**   
Principalmente as estações de trabalho e os servidores de terminal estão correndo risco. Os servidores correm mais riscos se os administradores permitirem que os usuários façam logon em servidores e executem programas. Entretanto, as práticas recomendadas não recomendam esse procedimento.
  
**O que a atualização faz?**   
A atualização elimina a vulnerabilidade, corrigindo a maneira como os drivers do modo kernel do Windows alocam o tamanho adequado de buffer ao gravar na memória.
...
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2011-2011](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2011).
  
#### Fatores atenuantes da Vulnerabilidade de uso após liberação de Win32k - CVE-2011-2011
  
A atenuação refere-se a uma configuração, configuração comum ou prática recomendada geral, existindo num estado padrão, que possa reduzir a gravidade de exploração de uma vulnerabilidade. Os fatores de atenuação a seguir podem ser úteis em sua situação:
  
-   O invasor precisa ter credenciais de logon válidas e poder fazer logon localmente para explorar essa vulnerabilidade.
  
#### Soluções alternativas para a Vulnerabilidade de uso após liberação de Win32k - CVE-2011-2011
  
A Microsoft não identificou nenhuma solução alternativa para esta vulnerabilidade.
  
#### Perguntas frequentes sobre a Vulnerabilidade de uso após liberação de Win32k - CVE-2011-2011
...
**O que provoca a vulnerabilidade?**   
A vulnerabilidade é causada quando os drivers do modo kernel gerenciam impropriamente os objetos de driver do modo kernel.
...
**O que a atualização faz?**   
A atualização elimina as vulnerabilidades, corrigindo a maneira como os drivers do modo kernel do Windows gerenciam os objetos de driver do modo kernel.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2567053$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2567053">Artigo 2567053 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Andrei Lutas, da [BitDefender](http://www.bitdefender.com/), por relatar a Vulnerabilidade de desreferenciação de ponteiro nulo do Win32k (CVE-2011-1985)  
-   Tarjei Mandt, da [Norman](http://www.norman.com/), por relatar a Vulnerabilidade de desreferenciação de ponteiro nulo do Win32k (CVE-2011-1985)  
-   Maik Wellmann, por relatar a Vulnerabilidade de tradução de fonte TrueType do Win32k (CVE-2011-2002)  
-   Will Dorman, da [CERT/CC](http://www.cert.org/), por relatar a Vulnerabilidade de saturação de buffer do arquivo de biblioteca da fonte (CVE-2011-2003)
