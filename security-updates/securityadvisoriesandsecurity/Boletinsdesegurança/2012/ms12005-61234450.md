...
ms:assetid: 'ms12-005'
ms:contentKeyID: 61234450
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-005(v=Security.10)'
---
...
Vulnerabilidade no Microsoft Windows pode permitir a execução remota de código (2584146)
----------------------------------------------------------------------------------------
...
A atualização de segurança elimina a vulnerabilidade, mudando a maneira como o Windows Packager analisa os arquivos não seguros. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------|--------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=1bcb1d1e-9261-4a36-9256-90d3df9bd4fb)                                                                                                          | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2c687796-4c41-4d17-b738-511d2fbfc126)                                                                                 | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2c39be84-1eab-4794-b3ed-e529643aca21)                                                                                                 | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3cf29dfd-239e-4707-92e6-952133c1c1c2)                                                                                     | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2003 com SP2 para sistemas baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=623c1c7d-6902-4876-9614-1b6e1ef80831)                                                                      | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=038970b6-aeec-4e18-8dfe-887b260a7c87)                                                                                                       | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=23abeb12-f2fe-43fd-9c4a-4d3d244832f8)                                                                                           | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas de 32 bits Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d089d9cb-382c-4e64-94c5-69b9864010b1)\*\*                                                                    | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados em x64 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1ac8a368-4298-4c1d-9cfd-924d6df563af)\*\*                                                               | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 para sistemas baseados no Itanium Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3e08b242-2516-4cf6-b38e-35ec2b8b788d)                                                               | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas de 32 bits e Windows 7 para sistemas de 32 bits Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7422605b-7a02-4161-b7f8-92b3ccffef64)                                             | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows 7 para sistemas baseados em x64 e Windows 7 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4ba46bc7-af7a-445a-84f2-b0c13674409b)                                   | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x64 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=db3a4814-a409-4def-944d-4eaa540b83b0)\*\*     | Execução Remota de Código  | Importante                      | Nenhuma                                    |
| [Windows Server 2008 R2 para sistemas baseados em Itanium e Windows Server 2008 R2 para sistemas Service Pack 1 baseados no Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=2101663a-ed3d-4850-b79a-16960ab56b45) | Execução Remota de Código  | Importante                      | Nenhuma                                    |
...
**Esta atualização de segurança está relacionada ao boletim MS12-002?** 
Não. Embora as duas atualizações de segurança afetem o Windows Packager, as atualizações afetam componentes diferentes e não estão relacionadas. Estas atualizações podem ser aplicadas em qualquer ordem.

**Esta atualização contém alterações relacionadas à segurança** **da funcionalidade?** 
Sim, esta atualização altera a maneira como o Windows Packager identifica arquivos não seguros.
...
<th style="border:1px solid black;" >Vulnerabilidade de execução de montagem - CVE-2012-0013</th>
...
Vulnerabilidade de execução de montagem - CVE-2012-0013  
-------------------------------------------------------
  
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o Windows Packager carrega os aplicativos ClickOnce incorporados nos arquivos Microsoft Office.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0013](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0013).
  
#### Fatores atenuantes da Vulnerabilidade de execução de montagem - CVE-2012-0013
...
-   Para ser implementado por uma rede, o manifesto de implantação e o manifesto de aplicativo de uma implantação de ClickOnce devem ser assinados com um certificado digital.
  
#### Soluções alternativas para a Vulnerabilidade de execução de montagem - CVE-2012-0013
  
A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:
  
-   **Remova a associação de aplicativos**  
-   **.application**  
-   **Observação** O uso incorreto do Editor do Registro pode causar problemas graves e exigir a reinstalação do sistema operacional. A Microsoft não garante a solução de problemas resultantes do uso incorreto do Editor do Registro. Você é responsável pelo uso do Editor do Registro. Para obter informações sobre como editar o Registro, consulte o tópico da Ajuda "Changing Keys and Values" (Alterar chaves e valores) do Editor do Registro (Regedit.exe) ou exiba os tópicos da Ajuda "Add and Delete Information in the Registry" (Adicionar e excluir informações no Registro) e "Edit Registry Data" (Editar dados do Registro) no Regedt32.exe.
    ...
    Para remover a associação de arquivo .application, execute as seguintes etapas:
  
    **Usando o método interativo**
  
    1.  Clique em **Iniciar**, **Executar**, digite **regedit** e clique em **OK.**  
    2.  Expanda **HKEY\_CLASSES\_ROOT**, clique em **.application** e, em seguida, clique no menu **Arquivo** e selecione **Exportar.**  
    3.  Na caixa de diálogo **Exportar Arquivo de Registro**, digite **application HKCR file association registry backup.reg** e clique em **Salvar**.  
    ...
    6.  Clique em **.application** e, em seguida, clique no menu **Arquivo** e selecione **Exportar.**  
    7.  Na caixa de diálogo **Exportar Arquivo de Registro**, digite **application HKCU** **file association registry backup.reg** e clique em **Salvar**.  
        **Observação** Isso criará um backup desta chave do Registro na pasta Meus Documentos por padrão**.**  
    ...
    **Usando um script de implantação gerenciado**
    ...
    1.  Faça uma cópia de backup das chaves de Registro usando o seguinte comando:`Regedit.exe /e application_HKCR_registry_backup.reg HKEY_CLASSES_ROOT\.applicationRegedit.exe /e applicat``ion_HKCU_registry_backup.reg HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.application`  
    2.  Salve o seguinte em um arquivo com extensão .REG (por exemplo, Delete\_Application\_File\_Association.reg):`Windows Registry Editor Versão 5``.00[-HKEY_CLASSES_ROOT\.application][-HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.application]`  
    3.  Execute o script de Registro criado na etapa anterior com o seguinte comando:`Regedit.exe /s Delete_Application_File_Associatio``n.reg`
  
    **Impacto da solução alternativa.** Esta solução alternativa remove a associação de arquivo .application. Clicar duas vezes em um arquivo de aplicativo não irá mais inicializá-lo.
    ...
    **Como desfazer a solução alternativa.**
    ...
    3.  Na caixa de diálogo Importar Arquivo de Registro, selecione **application HKCR file association registry backup.reg** e clique em **Abrir**.  
    4.  Clique no menu **Arquivo** e selecione **Importar.**  
    5.  Na caixa de diálogo Importar Arquivo de Registro, selecione **application HKCU file association registry backup.reg** e clique em **Abrir**.
...
#### Perguntas frequentes sobre a Vulnerabilidade de execução de montagem - CVE-2012-0013
...
Esta vulnerabilidade é causada por tipos de arquivo do aplicativo ClickOnce não sendo uma parte da lista de tipo de arquivos não seguros do Windows Packager, permitindo que aplicativos ClickOnce sejam incorporados em documentos do Microsoft Office.
  
**O que é ClickOnce?**   
ClickOnce é uma tecnologia de implantação que permite que desenvolvedores criem aplicativos com base no Windows Windows de atualização automática que podem ser instalados e executados com interação mínima do usuário. Um aplicativo ClickOnce é qualquer solução do Windows Presentation Foundation (.xbap), Windows Forms (.exe), aplicativo de console (.exe) ou do Office (.dll) publicada usando a tecnologia ClickOnce. Os aplicativos ClickOnce podem ser publicados em três maneiras diferentes: de uma página da Web, de um compartilhamento de arquivos de rede ou de mídia tal como um CD-ROM. Para obter mais informações, consulte o artigo de MSDN, [ClickOnce Security and Deployment](http://msdn.microsoft.com/en-us/library/t71a733d.aspx).
  
**Para que um invasor pode usar a vulnerabilidade?**   
Esta vulnerabilidade permite que invasores incorporem instaladores do aplicativo ClickOnce em documentos do Microsoft Office e executem código sem interação do usuário.
  
**De que forma o invasor pode explorar a vulnerabilidade?**   
A exploração dessa vulnerabilidade exige que um usuário abra um arquivo do Microsoft Office especialmente criado.
  
Em um cenário de ataque por email, o invasor pode explorar a vulnerabilidade, enviando para o usuário um arquivo do Microsoft Office especialmente criado com um aplicativo ClickOnce incorporado e convencendo-o a abrir o arquivo.
  
Em um cenário de ataque com base na Web, um invasor terá que hospedar um site que contenha o arquivo do Office usado para tentar explorar essa vulnerabilidade. Além disso, sites comprometidos e sites que aceitem ou hospedem conteúdo fornecido pelo usuário podem conter conteúdo especialmente desenvolvido que pode explorar esta vulnerabilidade. Não há como um invasor forçar usuários a visitar o site especialmente criado. Em vez disso, o invasor terá de convencer os usuários a visitar o site, normalmente fazendo com que eles cliquem em um link para esse site e, em seguida, convencê-los a abrir o arquivo especialmente criado.
...
A atualização muda a maneira como o Windows Packager analisa os arquivos não seguros.
...
<td style="border:1px solid black;">Use a ferramenta <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2584146$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informações sobre o arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2584146">Artigo 2584146 Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Yorick Koster, que trabalha no programa [Beyond Security's SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html), por relatar a Vulnerabilidade de execução de montagem - (CVE-2012-0013)
