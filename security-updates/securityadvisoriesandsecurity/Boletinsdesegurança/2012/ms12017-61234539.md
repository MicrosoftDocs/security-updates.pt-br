...
ms:assetid: 'ms12-017'
ms:contentKeyID: 61234539
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-017(v=Security.10)'
---
...
Vulnerabilidade no servidor DNS pode permitir a negação de serviço (2647170)
----------------------------------------------------------------------------

Publicado: terça-feira, 13 de março de 2012 | Atualizado: quarta-feira, 18 de abril de 2012
...
Esta atualização de segurança elimina uma vulnerabilidade relatada em particular no Microsoft Windows. A vulnerabilidade pode permitir a negação de serviço se um invasor não autenticado remoto enviar uma consulta DNS especialmente criada ao servidor DNS de destino.

Esta atualização de segurança é classificada como Importante para todas as edições com suporte do Windows Server 2003, edições baseadas em x64 e de 32 bits do Windows Server 2008 e edições baseadas em x64 do Windows Server 2008 R2. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança elimina a vulnerabilidade modificando a maneira como o servidor DNS manipula objetos na memória. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
**Problemas conhecidos.** O [artigo 2647170 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2647170) documenta os problemas atualmente conhecidos que os clientes podem enfrentar ao instalar esta atualização de segurança. O artigo também documenta as soluções recomendadas para esses problemas.
...
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms11-058">MS11-058</a>,<br />
<a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-009">MS12-009</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=92f3af60-9a9b-4419-9e95-55f5cb54cf00">Windows Server 2003 com SP2 para sistemas baseados no Itanium</a></td>
<td style="border:1px solid black;">Negação de Serviço</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms11-058">MS11-058</a>,<br />
<a href="http://technet.microsoft.com/pt-br/security/bulletin/ms12-009">MS12-009</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=19a4f3d1-24d2-41af-a41a-e5cc2c6232e8">Windows Server 2008 R2 para sistemas baseados em x64 e Windows Server 2008 R2 para sistemas baseados em x-64 Service Pack 1</a>*</td>
<td style="border:1px solid black;">Negação de Serviço</td>
<td style="border:1px solid black;">Importante</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/pt-br/security/bulletin/ms11-058">MS11-058</a></td>
</tr>
...
A atualização pode ser instalada somente se o DNS estiver habilitado nos sistemas operacionais listados na tabela de Softwares afetados. Por padrão, o DNS não é habilitado nesses sistemas operacionais; sendo assim, a atualização não será oferecida, a menos que o DNS tenha sido habilitado.
...
<th style="border:1px solid black;" >Vulnerabilidade de negação de serviço de DNS - CVE-2012-0006</th>
<th style="border:1px solid black;" >Avaliação de gravidade agregada</th>
</tr>
</thead>
<tbody>
...
Vulnerabilidade de negação de serviço de DNS - CVE-2012-0006  
------------------------------------------------------------
  
<span></span>
Uma vulnerabilidade de negação de serviço existe na maneira como o servidor de DNS manipula impropriamente objetos na memória ao pesquisar o registro de recurso de um domínio. O invasor que explorar com êxito esta vulnerabilidade poderá fazer com que o servidor DNS no sistema de destino pare de responder e se reinicie automaticamente.
  
Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0006](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0006).
  
#### Fatores atenuantes para a vulnerabilidade de negação de serviço de DNS - CVE-2012-0006
  
A Microsoft não identificou nenhum fator atenuante para essa vulnerabilidade.
  
#### Soluções alternativas para a vulnerabilidade de negação de serviço de DNS - CVE-2012-0006
  
A solução alternativa refere-se a uma configuração ou alteração de configuração que não corrige a vulnerabilidade subjacente mas que ajudaria a bloquear vetores de ataque conhecidos antes de aplicar a atualização. A Microsoft testou as soluções alternativas e estados a seguir como parte do cenário que implica se uma solução alternativa reduziria funcionalidade:
  
-   **Limpe o cache de DNS periodicamente**
  
    Execute o seguinte comando dnscmd conforme descrito no artigo (em inglês), [Dnscmd Syntax](http://technet.microsoft.com/en-us/library/cc756116(v=ws.10).aspx):
  
    `dnscmd`` [``ServerName``] /``clearcache`
  
    Pode ser executado como uma tarefa programada ou conforme necessário.
  
    **Impacto da solução alternativa.** Limpa a memória do cache de DNS dos registros de recurso no servidor DNS especificado.
  
    **Como desfazer a solução alternativa.**
  
    Exclua ou desabilite qualquer tarefa programada que esteja executando o comando dnscmd.
  
#### Perguntas frequentes sobre a vulnerabilidade de negação de serviço de DNS - CVE-2012-0006
  
**Qual é o escopo da vulnerabilidade?**   
Essa é uma vulnerabilidade de negação de serviço (site em inglês).
  
**O que provoca a vulnerabilidade?**   
A vulnerabilidade é causada quando o servidor DNS manipula impropriamente objetos na memória ao pesquisar um registro de recurso.
  
**O que éum registro de recurso DNS?**   
Um registro de recurso de DNS (RR) identifica um recurso específico dentro de um domínio. Para obter mais informações, consulte o artigo do TechNet [How DNS Works](http://technet.microsoft.com/en-us/library/dd197446(ws.10).aspx)(em inglês).
...
Um invasor não autenticado remoto pode explorar esta vulnerabilidade enviando uma consulta DNS especialmente criada ao servidor DNS de destino.
...
A atualização elimina a vulnerabilidade modificando a maneira como o servidor DNS manipula objetos na memória.
...
<td style="border:1px solid black;">Use o item <strong>Adicionar ou Remover Programas</strong> no Painel de Controle ou o utilitário Spuninst.exe, localizado na pasta %Windir%\$NTUninstallKB2647170$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informaçõessobre</strong> <strong>o</strong> <strong>arquivo</strong></td>
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2647170">Artigo 2647170 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   V1.1 (18 de abril de 2012): Adicionado um link para o artigo 2647170 (em inglês) da Microsoft Knowledge Base na seção Problemas conhecidos na Sinopse e corrigidas as informações de substituição de boletim referentes ao Windows Server 2003 Service Pack 2, Windows Server 2003 x64 Edition Service Pack 2 e Windows Server 2003 com SP2 para sistemas baseados no Itanium. Esta é apenas uma alteração do boletim. Não houve alterações nos arquivos de atualização de detecção ou de segurança.
