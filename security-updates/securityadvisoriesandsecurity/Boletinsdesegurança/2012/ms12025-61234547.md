...
ms:assetid: 'ms12-025'
ms:contentKeyID: 61234547
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms12-025(v=Security.10)'
---
...
Vulnerabilidade no .NET Framework pode permitir execução remota de código (2671605)
-----------------------------------------------------------------------------------

Publicado: terça-feira, 10 de abril de 2012 | Atualizado: terça-feira, 12 de junho de 2012
...
Esta atualização de segurança é classificada como Crítica para o Microsoft .NET Framework 1.0 Service Pack 3, Microsoft .NET Framework 1.1 Service Pack 1, Microsoft .NET Framework 2.0 Service Pack 2, Microsoft .NET Framework 3.5.1 e Microsoft .NET Framework 4 em todas as edições com suporte do Microsoft Windows. Para obter mais informações, consulte a subseção **Softwares afetados e não afetados**, nesta seção.

A atualização de segurança elimina a vulnerabilidade corrigindo a maneira pela qual o Microsoft .NET Framework valida parâmetros ao passar dados para uma função. Para obter mais informações sobre a vulnerabilidade, consulte a subseção Perguntas frequentes relacionada à entrada da vulnerabilidade específica presente na próxima seção, **Informações sobre a vulnerabilidade**.
...
<span></span>
**Por que este boletimfoi relançado em 12 de junho de 2012?  
**Microsoft relançou este boletim para oferecer novamente a atualização de segurança para todo o software afetado. A atualização oferecida novamente aborda um problema conhecido com a impressão de um aplicativo do Windows Forms. Instalar a atualização originalmente oferecida em 10 de abril de 2012 pode fazer com que determinados aplicativos do Windows Forms não imprimam nem respeitem configurações especificadas da impressora; não há nenhum impacto em sistemas que não usam funcionalidades de impressão de um aplicativo do .NET Framework Windows Forms. Os clientes que já instalaram a atualização original devem instalar a atualização oferecida novamente.

**O** **Microsoft .NET Framework 3.5 e Microsoft .NET Framework 4.5 no Windows** **DeveloperPreview** **e Microsoft .NET Framework 4.5** **DeveloperPreview** **são afetados por esta vulnerabilidade?**
...
|-----------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| Microsoft .NET Framework 3.5 no Windows Developer Preview                                                 | [Artigo 2656380 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2656380) |
| Microsoft .NET Framework 4.5 no Windows Developer Preview                                                 | [Artigo 2656371 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2656371) |
| Microsoft .NET Framework 4.5 Developer Preview no Windows Server 2008, Windows 7 e Windows Server 2008 R2 | [Artigo 2656381 (em inglês) da Microsoft Knowledge Base](http://support.microsoft.com/kb/2656381) |
...
Este boletim descreve uma vulnerabilidade na camada de recurso do .Net Framework 2.0. O instalador do .NET Framework 3.0 Service Pack 2 incorpora a configuração do .NET Framework 2.0 Service Pack 2, por isso a instalação do primeiro também instala o segundo. Portanto, os clientes que têm o .NET Framework 3.0 Service Pack 2 instalados precisam instalar as atualizações de segurança para o .NET Framework 2.0 Service Pack 2. Para obter mais informações, consulte o [Artigo 2695500 (em inglês) da Microsoft Knowledge Base](http://go.microsoft.com/fwlink/?linkid=247462).

**Eu tenho** **o .NET Framework 3.5 Service Pack 1 instalado. Devo instalar alguma atualização?** 
Este boletim descreve uma vulnerabilidade na camada de recurso do .Net Framework 2.0. O instalador do .NET Framework 3.5 Service Pack 1 incorpora tanto a configuração do .NET Framework 2.0 Service Pack 2 quanto a do .NET Framework 3.0 Service Pack 2. Portanto, os clientes que têm o .NET Framework 3.5 Service Pack 1 instalados precisam instalar as atualizações de segurança para o .NET Framework 2.0 Service Pack 2. Para obter mais informações, consulte o [Artigo 2695500 (em inglês) da Microsoft Knowledge Base](http://go.microsoft.com/fwlink/?linkid=247462).
...
<th style="border:1px solid black;" >
Vulnerabilidade de validação de parâmetro do .NET Framework - CVE-2012-0163
</th>
<th style="border:1px solid black;" >
Avaliação de gravidade agregada
</th>
...
<span></span>
Existe uma vulnerabilidade de execução remota de código na maneira como o Microsoft .NET Framework valida parâmetros ao analisar dados para uma função. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. Os usuários cujas contas são configuradas com poucos direitos de usuário no sistema correm menos riscos do que aqueles que possuem direitos administrativos.

Para exibir esta vulnerabilidade como uma entrada padrão na lista Common Vulnerabilities and Exposures, consulte [CVE-2012-0163](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0163).

#### Fatores atenuantes para a Vulnerabilidade de validação de parâmetro de .NET Framework - CVE-2012-0163
...
#### Soluções alternativas para a Vulnerabilidade de validação de parâmetro de .NET Framework - CVE-2012-0163
...
#### Perguntas frequentes sobre a Vulnerabilidade de validação de parâmetro de .NET Framework - CVE-2012-0163
...
A vulnerabilidade é o resultado do .NET Framework validar inadequadamente os parâmetros ao passar dados para uma função.
...
A atualização elimina a vulnerabilidade, corrigindo a maneira como o .NET Framework valida os parâmetros.
...
<td style="border:1px solid black;">Consulte o <a href="http://support.microsoft.com/kb/2671605">Artigo 2671605 (em inglês) da Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
-   Vitaliy Toropov, que trabalha no [VeriSign iDefense Labs](http://labs.idefense.com/), por relatar a Vulnerabilidade de validação de parâmetro de .NET Framework (CVE-2012-0163)
...
-   V1.1 (13 de abril de 2012): Um link para o Artigo 2671605 (em inglês) da Microsoft Knowledge Base foi adicionado à seção Problemas conhecidos na Sinopse.
-   V2.0 (12 de junho de 2012): A Microsoft relançou este boletim para oferecer novamente a atualização de segurança para todo o software afetado. Os clientes que já instalaram a atualização original, oferecida em 12 de abril de 2012, devem instalar a atualização oferecida novamente. Consulte as Perguntas frequentes de atualização para obter detalhes.
