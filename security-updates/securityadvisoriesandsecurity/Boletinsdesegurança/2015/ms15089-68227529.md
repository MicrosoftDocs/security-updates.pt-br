...
Esta atualização de segurança foi classificada como Importante****para todas as versões com suporte do Microsoft Windows, exceto os servidores Itanium e Windows 10, que não foram afetados. Para obter mais informações, consulte a seção **Software Afetado**.
