---
TOCTitle: 'MS06-OCT'
Title: Resumo do Boletim de Segurança da Microsoft de outubro 2006
ms:assetid: 'ms06-oct'
ms:contentKeyID: 61233620
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms06-oct(v=Security.10)'
---

Security Bulletin Summary

Resumo do Boletim de Segurança da Microsoft de outubro 2006
===========================================================
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-057                                                                                                            |
|---------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no Shell do Windows pode permitir a execução remota de código (923191)**](http://technet.microsoft.com/security/bulletin/ms06-057) |
| **Sinopse**                           | Esta atualização elimina uma vulnerabilidade no Windows que pode permitir a execução remota de código.                                                |
...
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-058                                                                                                                  |
|---------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidades no Microsoft PowerPoint podem permitir a execução remota de código (924163)**](http://technet.microsoft.com/security/bulletin/ms06-058) |
| **Sinopse**                           | Esta atualização elimina vulnerabilidades no PowerPoint que podem permitir a execução remota de código.                                                     |
| **Classificação máxima de gravidade** | [Crítica](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                    |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                                   |
| **Software afetado**                  | **Office, PowerPoint.** Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                            |

| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-059                                                                                                             |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidades no Microsoft Excel podem permitir a execução remota de código (924164)**](http://technet.microsoft.com/security/bulletin/ms06-059) |
| **Sinopse**                           | Esta atualização elimina vulnerabilidades no Excel que podem permitir a execução remota de código.                                                     |
| **Classificação máxima de gravidade** | [Crítica](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                               |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                              |
| **Software afetado**                  | **Office, Excel.** Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                            |

| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-060                                                                                                            |
|---------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidades no Microsoft Word podem permitir a execução remota de código (924554)**](http://technet.microsoft.com/security/bulletin/ms06-060) |
| **Sinopse**                           | Esta atualização elimina várias vulnerabilidades no Microsoft Word, das quais a mais grave pode permitir a execução remota de código.                 |
| **Classificação máxima de gravidade** | [Crítica](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                              |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                             |
| **Software afetado**                  | **Office, Word.** Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                            |

| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-061                                                                                                              |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidades no Microsoft XML Core Services podem permitir a execução remota de código (924191)**](http://go.microsoft.com/fwlink/?linkid=73836) |
| **Sinopse**                           | Esta atualização elimina várias vulnerabilidades no Windows que podem permitir a execução remota de código.                                             |
| **Classificação máxima de gravidade** | [Crítica](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                               |
| **Software afetado**                  | **Windows** Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                                    |

| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-062                                                                                                              |
|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidades no Microsoft Office podem permitir a execução remota de código (922581)**](http://technet.microsoft.com/security/bulletin/ms06-062) |
| **Sinopse**                           | Esta atualização elimina vulnerabilidades no Office que podem permitir a execução remota de código.                                                     |
| **Classificação máxima de gravidade** | [Crítica](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                               |
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-063                                                                                                                                   |
|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no serviço Servidor pode permitir a negação de serviço e a execução remota de código (923414)**](http://technet.microsoft.com/security/bulletin/ms06-063) |
| **Sinopse**                           | Esta atualização elimina vulnerabilidades no Windows que podem permitir a negação de serviço e a execução remota de código.                                                  |
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-056                                                                                                      |
|---------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no ASP.NET pode permitir a divulgação não autorizada de informação (922770)**](http://go.microsoft.com/fwlink/?linkid=67168) |
| **Sinopse**                           | Esta atualização elimina uma vulnerabilidade no ASP.NET que pode permitir a divulgação não autorizada de informação.                            |
...
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-065                                                                                                                   |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidade no Windows Object Packager pode permitir a execução remota de código (924496)**](http://technet.microsoft.com/security/bulletin/ms06-065) |
| **Sinopse**                           | Esta atualização elimina uma vulnerabilidade no Object Packager que pode permitir a execução remota de código.                                               |
| **Classificação máxima de gravidade** | [Moderada](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                                                    |
| **Impacto da vulnerabilidade**        | Execução Remota de Código                                                                                                                                    |
| **Software afetado**                  | **Windows** Para obter mais informações, consulte as seções Softwares afetados e Locais de download.                                                         |
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS06-064                                                                                           |
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|
| **Título do boletim**                 | [**Vulnerabilidades no TCP/IP podem permitir negação de serviço (922819)**](http://technet.microsoft.com/security/bulletin/ms06-064) |
| **Sinopse**                           | Esta atualização elimina várias vulnerabilidades no Windows, das quais a mais grave pode permitir negação de serviço.                |
| **Classificação máxima de gravidade** | [Baixa](http://www.microsoft.com/brasil/security/boletins/rating.mspx)                                                               |
...
Por exemplo, o boletim de segurança **MS06-061** fornece várias atualizações de segurança que podem ser necessárias dependendo dos softwares e dos componentes afetados que você instalou.

#### Softwares afetados e locais de download dos boletins MS06-056 a MS06-061
...
<tr class="even">
<td style="border:1px solid black;">O PowerPoint 2003</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
#### Softwares afetados e locais de download dos boletins MS06-062 a MS06-065
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/brasil/security/boletins/rating.mspx"><strong>Baixa</strong></a></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/brasil/security/boletins/rating.mspx"><strong>Moderada</strong></a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Softwares do Windows afetados:</strong></td>
...
-   Jaswinder Hayre por relatar um problema descrito no boletim [MS06-056](http://go.microsoft.com/fwlink/?linkid=67168).  
-   Arnaud Dovi, que trabalha na [TippingPoint](http://www.tippingpoint.com/) e na [Zero Day Initiative](http://www.zerodayinitiative.com/), por reportar um problema descrito no boletim [MS06-058](http://technet.microsoft.com/security/bulletin/ms06-058).  
-   Chris Ries, da [VigilantMinds Inc.](http://www.vigilantminds.com), or relatar um problema descrito no boletim [MS06-058](http://technet.microsoft.com/security/bulletin/ms06-058).  
-   Dejun Meng, da [Fortinet Inc.](http://www.fortinet.com/), por relatar um problema descrito no boletim [MS06-058](http://technet.microsoft.com/security/bulletin/ms06-058).  
-   A [NSFocus Security Team](mailto:security@nsfocus.com) por relatar um problema descrito no boletim [MS06-059](http://technet.microsoft.com/security/bulletin/ms06-059).  
-   Manuel Santamarina Suarez, que trabalha na [TippingPoint](http://www.tippingpoint.com/) e na [Zero Day Initiative](http://www.zerodayinitiative.com/), por reportar um problema descrito no boletim [MS06-059](http://technet.microsoft.com/security/bulletin/ms06-059).  
-   Chen Xiaobo, da [McAfee Avert Labs](http://www.avertlabs.com/), por relatar um problema descrito no boletim [MS06-060.](http://technet.microsoft.com/security/bulletin/ms06-060)  
-   Cu Fang por relatar um problema descrito no boletim [MS06-060](http://technet.microsoft.com/security/bulletin/ms06-060).  
-   Dejun Meng, da [Fortinet Inc.](http://www.fortinet.com/), por relatar um problema descrito no boletim [MS06-062](http://technet.microsoft.com/security/bulletin/ms06-062).  
-   Arnaud Dovi, que trabalha na [TippingPoint](http://www.tippingpoint.com/) e na [Zero Day Initiative](http://www.zerodayinitiative.com/), por reportar um problema descrito no boletim [MS06-062](http://technet.microsoft.com/security/bulletin/ms06-062).  
-   Sowhat, da [Nevis Labs](http://www.nevisnetworks.com/), por relatar um problema descrito no boletim [MS06-062](http://technet.microsoft.com/security/bulletin/ms06-062).  
-   Gerardo Richarte, da [Core Security Technologies](http://www.coresecurity.com/), por informar um problema descrito no [MS06-063](http://technet.microsoft.com/security/bulletin/ms06-063).  
-   [Fortinet Inc.](http://www.fortinet.com/) por relatar um problema descrito no boletim [MS06-063](http://technet.microsoft.com/security/bulletin/ms06-063).  
-   Matthew Amdur, da [VMware](http://www.vmware.com/), por relatar um problema descrito no boletim [MS06-063](http://technet.microsoft.com/security/bulletin/ms06-063).  
-   Andreas Sandblad, da [Secunia](http://www.secunia.com), por informar um problema descrito no [MS06-065](http://technet.microsoft.com/security/bulletin/ms06-065).
...
-   V1.1 (11 de outubro de 2006): O boletim foi revisado para esclarecer que o impacto associado ao boletim MS06-063 é de negação de serviço e execução remota de código.
