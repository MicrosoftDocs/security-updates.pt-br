---
TOCTitle: 'MS08-JAN'
Title: Resumo do Boletim de Segurança da Microsoft de janeiro 2008
ms:assetid: 'ms08-jan'
ms:contentKeyID: 61233638
ms:mtpsurl: 'https://technet.microsoft.com/pt-BR/library/ms08-jan(v=Security.10)'
---

Security Bulletin Summary

Resumo do Boletim de Segurança da Microsoft de janeiro 2008
===========================================================

Publicado: terça-feira, 8 de janeiro de 2008 | Atualizado: sexta-feira, 25 de janeiro de 2008

**Versão:** 1.2

Este resumo do boletim lista boletins de segurança lançados para janeiro de 2008.

Com o lançamento dos boletins de janeiro de 2008, este resumo do boletim substitui a notificação antecipada de boletim lançada originalmente em 3 de janeiro de 2008. Para obter mais informações sobre o serviço de notificação antecipada de boletim, consulte [Notificação antecipada do Boletim de Segurança da Microsoft](http://technet.microsoft.com/security/bulletin/advance).

Para obter informações sobre como receber notificações automáticas sempre que os boletins de segurança da Microsoft são emitidos, consulte as [notificações de segurança técnica da Microsoft](http://go.microsoft.com/fwlink/?linkid=21163).

A Microsoft realizará um webcast para solucionar dúvidas dos clientes sobre esses boletins no dia 9 de janeiro de 2008, às 11 horas - Hora do Pacífico (EUA e Canadá). [Registre-se agora para participar do Webcast do boletim de segurança de janeiro.](http://msevents.microsoft.com/cui/webcasteventdetails.aspx?eventid=1032357213&eventcategory=4&culture=en-us&countrycode=us) Depois dessa data, este webcast estará disponível sob demanda. Para obter mais informações, consulte [Webcasts e resumos dos boletins de segurança da Microsoft.](http://technet.microsoft.com/security/bulletin/summary)
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS08-001                                                                                                                                                                                                                                                                                                                                  |
|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidades no Windows TCP/IP podem permitir a execução remota de código (941644)**](http://go.microsoft.com/fwlink/?linkid=104919)                                                                                                                                                                                                                                 |
| **Sinopse**                           | Esta atualização de segurança crítica elimina duas vulnerabilidades relatadas em particular no processamento de protocolo TCP/IP. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. |
...
<span></span>
| Identificador do Boletim              | Boletim de Segurança da Microsoft MS08-002                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Título do Boletim**                 | [**Vulnerabilidade no LSASS pode permitir elevação de privilégio local (943485)**](http://go.microsoft.com/fwlink/?linkid=104921)                                                                                                                                                                                                                                                                                                                                                                    |
| **Sinopse**                           | Essa atualização importante elimina uma vulnerabilidade relatada em particular no Microsoft Windows LSASS (Local Security Authority Subsystem Service). A vulnerabilidade pode permitir que um invasor execute código arbitrário com privilégios elevados. O invasor que explorar com êxito essa vulnerabilidade poderá assumir o controle total de um sistema afetado. O invasor poderá instalar programas; exibir, alterar ou excluir dados; ou criar novas contas com direitos totais de usuário. |
...
-   A Microsoft lançou cinco atualizações de alta prioridade que **não são de segurança** no Microsoft Update (MU) e no WSUS (Windows Server Update Services).
...
-   [IBM Internet Security Systems X-Force](http://www.iss.net/) por Alex Wheeler e Ryan Smith por relatar um problema descrito no boletim [MS08-001](http://go.microsoft.com/fwlink/?linkid=104919)
-   [IBM Internet Security Systems X-Force](http://www.iss.net/) por Alex Wheeler e Ryan Smith por relatar um problema descrito no boletim [MS08-001](http://go.microsoft.com/fwlink/?linkid=104919)
-   Thomas Garnier da [SkyRecon](http://www.skyrecon.com/) por relatar um problema descrito no boletim [MS08-002](http://go.microsoft.com/fwlink/?linkid=104921)
...
-   V1.0 (8 de janeiro de 2008): Resumo do boletim publicado.
-   V1.1 (23 de janeiro de 2008) : O resumo do boletim foi atualizado para adicionar o Windows Small Business Server 2003 Service Pack 2 como software afetado no boletim MS08-001.
-   V1.2 (25 de janeiro de 2008): Resumo de boletim atualizado para adicionar o Windows Small Business Server 2003 Service Pack 1, Windows Small Business Server 2003 R2, Windows Small Business Server 2003 R2 Service Pack 2 e Windows Home Server como softwares afetados para o boletim MS08-001.
